...
&Scoped-define QUERY-STRING-Query-Main FOR EACH filial-cliente NO-LOCK INDEXED-REPOSITION
&Scoped-define OPEN-QUERY-Query-Main OPEN QUERY Query-Main FOR EACH filial-cliente NO-LOCK INDEXED-REPOSITION.
&Scoped-define TABLES-IN-QUERY-Query-Main filial-cliente
&Scoped-define FIRST-TABLE-IN-QUERY-Query-Main filial-cliente
