...
*******************************************************************************/
{include/i-prgvrs.i Q64IN172 2.00.00.001}  /*** 010001 ***/
...
/* ***************** Support for Change Query to Find ***************** */
&Scoped-define CHANGE-QUERY-TO-FIND TRUE
&Scoped-define WHERE-FIRST-TABLE-IN-QUERY-Query-Main item.politica = 6
&Scoped-define JOIN-SECOND-TABLE-IN-QUERY-Query-Main TRUE
&Scoped-define WHERE-SECOND-TABLE-IN-QUERY-Query-Main TRUE
&Scoped-define JOIN-THIRD-TABLE-IN-QUERY-Query-Main TRUE
&Scoped-define WHERE-THIRD-TABLE-IN-QUERY-Query-Main TRUE
...
&Scoped-define QUERY-STRING-Query-Main FOR EACH item NO-LOCK INDEXED-REPOSITION
&Scoped-define OPEN-QUERY-Query-Main OPEN QUERY Query-Main FOR EACH item NO-LOCK INDEXED-REPOSITION.
...
cod-estabel||y|mgind.item.cod-estabel
...
RUN set-attribute-list (
    'Keys-Accepted = ,
     Keys-Supplied = "class-fiscal,cod-comprado,fm-codigo,ge-codigo,it-codigo,nr-linha,cod-estabel,cd-tag,nat-despesa,cd-planejado,cod-refer,un"':U).
