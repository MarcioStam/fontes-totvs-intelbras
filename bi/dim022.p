/**
 * Extrator para BI
 * Dimens∆o: Cliente x Unidade Comercial x Categoria x Representante
 *
...
&scoped-define TEMP_TABLE  ttDimRelacionamentoCliente
&scoped-define ARQUIVO_TXT DimRelacionamentoCliente
&scoped-define EXTRATOR    dim022
