...
DEF TEMP-TABLE ttHierarquiaItem
    ...
    FIELD CD_UnidMedida       AS CHARACTER
    FIELD NM_AnoExtracao      AS INTEGER
    FIELD TX_DescItem         AS CHARACTER
    FIELD TX_Moeda            AS CHARACTER
    FIELD TX_UnidMedida       AS CHARACTER
    FIELD TX_FamiliaComercial AS CHARACTER
    FIELD TX_Mercado          AS CHARACTER
    FIELD TX_Empresa          AS CHARACTER
    INDEX idx_item AS PRIMARY UNIQUE
            CD_MasterExterno   
            NM_AnoExtracao
            CD_Empresa         
            CD_Estabelecimeto  
