...
&scoped-define TEMP_TABLE  ttFactLimiteCredito
&scoped-define ARQUIVO_TXT FactLimiteCredito
&scoped-define EXTRATOR    fact007
...
/** Caso online... **/
   ...
   log-manager:write-message('Execu‡Æo online') no-error.
