...
{include/i-prgvrs.i PRM1102 1.00.00.000}
...
&IF "{&EMSFND_VERSION}" >= "1.00" &THEN
    {include/i-license-manager.i PRM1102 MFT}
&ENDIF
...
DEFINE VARIABLE ed-mensagem AS CHARACTER INITIAL "Programa para geraá∆o de notas fiscais dos integradores" 
     VIEW-AS EDITOR NO-WORD-WRAP SCROLLBAR-HORIZONTAL SCROLLBAR-VERTICAL
     SIZE 75 BY 2 NO-UNDO.

DEFINE VARIABLE tg-cancela AS LOGICAL INITIAL no 
     LABEL "Cancelamento" 
     VIEW-AS TOGGLE-BOX
...
DEFINE VARIABLE tg-remessa AS LOGICAL INITIAL no 
     LABEL "Remessa" 
     VIEW-AS TOGGLE-BOX
     SIZE 25 BY .83 NO-UNDO.

DEFINE VARIABLE tg-retorno AS LOGICAL INITIAL no 
     LABEL "Retorno" 
     VIEW-AS TOGGLE-BOX
     SIZE 25 BY .83 NO-UNDO.

DEFINE VARIABLE tg-venda AS LOGICAL INITIAL no 
     LABEL "Venda" 
     VIEW-AS TOGGLE-BOX
     SIZE 25 BY .83 NO-UNDO.
...
DEFINE FRAME f-pg-sel
     ...
     tg-venda AT ROW 3.5 COL 3 WIDGET-ID 4
     tg-retorno AT ROW 3.5 COL 38 WIDGET-ID 8
     tg-remessa AT ROW 4.5 COL 3 WIDGET-ID 6
     tg-devolucao AT ROW 4.5 COL 38 WIDGET-ID 10
     tg-cancela AT ROW 5.5 COL 3 WIDGET-ID 12
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 3 ROW 2.85
         SIZE 76.86 BY 10.62
...
{utp/ut9000.i "PRM1102" "1.00.00.000"}
...
------------------------------------------------------------------------------*/
  ...
  DISPLAY ed-mensagem tg-venda tg-retorno tg-remessa tg-devolucao tg-cancela 
      WITH FRAME f-pg-sel IN WINDOW w-relat.
  ENABLE ed-mensagem tg-venda tg-retorno tg-remessa tg-devolucao tg-cancela 
      WITH FRAME f-pg-sel IN WINDOW w-relat.
...
DO ON ERROR UNDO, RETURN ERROR ON STOP  UNDO, RETURN ERROR:
    ...
    ASSIGN tt-param.l-venda     = INPUT FRAME f-pg-sel tg-venda
           tt-param.l-remessa   = INPUT FRAME f-pg-sel tg-remessa
           tt-param.l-cancela   = INPUT FRAME f-pg-sel tg-cancela
           tt-param.l-retorno   = INPUT FRAME f-pg-sel tg-retorno
           tt-param.l-devolucao = INPUT FRAME f-pg-sel tg-devolucao.
    ...
    {include/i-rprun.i prmp/prm1102rp.p}
