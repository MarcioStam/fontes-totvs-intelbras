...
*******************************************************************************/
{include/i-prgvrs.i prm1105 2.00.00.000}
...
DEFINE VARIABLE EDITOR-1 AS CHARACTER INITIAL "Impress∆o de etiqueta ZPL via arquivo" 
     VIEW-AS EDITOR
...
DEFINE FRAME f-pg-sel
     ...
     btInputFile AT ROW 4.46 COL 51 HELP
          "Escolha do nome do arquivo" WIDGET-ID 30
     cInputFile AT ROW 4.5 COL 11 HELP
          "Nome do arquivo de destino do relat¢rio" NO-LABEL WIDGET-ID 24
     text-entrada AT ROW 3.5 COL 11 NO-LABEL WIDGET-ID 28
     RECT-13 AT ROW 3.75 COL 9 WIDGET-ID 26
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 3 ROW 2.85
         SIZE 76.86 BY 10.62
...
ON CHOOSE OF btInputFile IN FRAME f-pg-sel
DO:
    DEFINE VARIABLE cConvFile AS CHARACTER   NO-UNDO.

    ASSIGN cConvFile = REPLACE(INPUT FRAME f-pg-sel cInputFile, "/":U, "~\":U).

    SYSTEM-DIALOG GET-FILE cConvFile
        FILTERS "Arquivo ZPL (*.zpl)":U "*.zpl":U,
                "Todos os arquivos (*.*)":U "*.*":U
        DEFAULT-EXTENSION "zpl":U
        INITIAL-DIR "spool":U
        USE-FILENAME
        UPDATE l-ok.
...
{utp/ut9000.i "prm1105" "2.00.00.000"}
...
------------------------------------------------------------------------------*/
  ...
  DISPLAY EDITOR-1 cInputFile 
      WITH FRAME f-pg-sel IN WINDOW w-relat.
  ENABLE RECT-13 btInputFile cInputFile 
      WITH FRAME f-pg-sel IN WINDOW w-relat.
...
do on error undo, return error on stop  undo, return error:
    ...
    assign tt-param.usuario         = c-seg-usuario
           ...
           tt-param.arquivo-etiqueta  = INPUT FRAME f-pg-sel cInputFile.
    ...
    {include/i-rprun.i prmp/prm1105rp.p}
