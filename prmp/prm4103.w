...
*******************************************************************************/
{include/i-prgvrs.i PRM4103 1.00.00.000}
...
DEFINE VARIABLE h_q01prm4103 AS HANDLE NO-UNDO.
DEFINE VARIABLE h_v01prm4103 AS HANDLE NO-UNDO.
DEFINE VARIABLE h_v02prm4103 AS HANDLE NO-UNDO.
DEFINE VARIABLE h_v03prm4103 AS HANDLE NO-UNDO.
DEFINE VARIABLE h_v04prm4103 AS HANDLE NO-UNDO.
...
DEFINE FRAME f-cad
    ...
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         ...
         AT COL 1 ROW 1
         SIZE 93.14 BY 22.54 WIDGET-ID 100.
    ...
    WHEN 0 THEN DO:
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Edge-Pixels = 0,
                     ...
                     Right-to-Left = First-On-Left':U ,
             OUTPUT h_p-exihel ).
       RUN set-position IN h_p-exihel ( 1.33 , 77.14 ) NO-ERROR.
       /* Size in UIB:  ( 1.25 , 16.00 ) */

       RUN init-object IN THIS-PROCEDURE (
             INPUT  'prmvwr/v01prm4103.w':U ,
             INPUT  FRAME f-cad:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_v01prm4103 ).
       RUN set-position IN h_v01prm4103 ( 2.83 , 1.57 ) NO-ERROR.
       /* Size in UIB:  ( 2.25 , 92.00 ) */

       RUN init-object IN THIS-PROCEDURE (
             INPUT  'adm/objects/folder.w':U ,
             INPUT  FRAME f-cad:HANDLE ,
             INPUT  'FOLDER-LABELS = ':U + 'Servi‡os|Nat. Oper.|Parƒmetros' + ',
                     FOLDER-TAB-TYPE = 1':U ,
             OUTPUT h_folder ).
       RUN set-position IN h_folder ( 5.33 , 1.72 ) NO-ERROR.
       RUN set-size IN h_folder ( 18.00 , 91.86 ) NO-ERROR.

       RUN init-object IN THIS-PROCEDURE (
             INPUT  'prmqry/q01prm4103.w':U ,
             INPUT  FRAME f-cad:HANDLE ,
             INPUT  'ProgPesquisa = prmzoom/z01prm4103.w,
                     ProgVaPara = prmgo/g01prm4103.w,
                     ProgIncMod = ,
                     Implantar = no':U ,
             OUTPUT h_q01prm4103 ).
       RUN set-position IN h_q01prm4103 ( 1.00 , 40.00 ) NO-ERROR.
       ...
       /* Links to SmartViewer h_v01prm4103. */
       RUN add-link IN adm-broker-hdl ( h_p-cadsim , 'TableIO':U , h_v01prm4103 ).
       RUN add-link IN adm-broker-hdl ( h_q01prm4103 , 'Record':U , h_v01prm4103 ).

       /* Links to SmartFolder h_folder. */
       RUN add-link IN adm-broker-hdl ( h_folder , 'Page':U , THIS-PROCEDURE ).

       /* Links to SmartQuery h_q01prm4103. */
       RUN add-link IN adm-broker-hdl ( h_p-exihel , 'State':U , h_q01prm4103 ).
       RUN add-link IN adm-broker-hdl ( h_p-navega , 'Navigation':U , h_q01prm4103 ).
       RUN add-link IN adm-broker-hdl ( h_p-navega , 'State':U , h_q01prm4103 ).
       ...
       RUN adjust-tab-order IN adm-broker-hdl ( h_p-exihel ,
             h_p-cadsim , 'AFTER':U ).
       RUN adjust-tab-order IN adm-broker-hdl ( h_v01prm4103 ,
             h_p-exihel , 'AFTER':U ).
       RUN adjust-tab-order IN adm-broker-hdl ( h_folder ,
             h_v01prm4103 , 'AFTER':U ).
    END. /* Page 0 */
    WHEN 1 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'prmvwr/v02prm4103.w':U ,
             INPUT  FRAME f-cad:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_v02prm4103 ).
       RUN set-position IN h_v02prm4103 ( 6.92 , 4.29 ) NO-ERROR.
       /* Size in UIB:  ( 15.83 , 86.29 ) */

       /* Links to SmartViewer h_v02prm4103. */
       RUN add-link IN adm-broker-hdl ( h_q01prm4103 , 'Record':U , h_v02prm4103 ).
       RUN add-link IN adm-broker-hdl ( h_v01prm4103 , 'Group-Assign':U , h_v02prm4103 ).

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_v02prm4103 ,
             h_folder , 'AFTER':U ).
    END. /* Page 1 */
    WHEN 2 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'prmvwr/v03prm4103.w':U ,
             INPUT  FRAME f-cad:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_v03prm4103 ).
       RUN set-position IN h_v03prm4103 ( 6.58 , 2.00 ) NO-ERROR.
       /* Size in UIB:  ( 15.63 , 90.43 ) */

       /* Links to SmartViewer h_v03prm4103. */
       RUN add-link IN adm-broker-hdl ( h_q01prm4103 , 'Record':U , h_v03prm4103 ).
       RUN add-link IN adm-broker-hdl ( h_v01prm4103 , 'Group-Assign':U , h_v03prm4103 ).

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_v03prm4103 ,
             h_folder , 'AFTER':U ).
    END. /* Page 2 */
    WHEN 3 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'prmvwr/v04prm4103.w':U ,
             INPUT  FRAME f-cad:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_v04prm4103 ).
       RUN set-position IN h_v04prm4103 ( 6.92 , 2.14 ) NO-ERROR.
       /* Size in UIB:  ( 12.50 , 89.72 ) */

       /* Links to SmartViewer h_v04prm4103. */
       RUN add-link IN adm-broker-hdl ( h_q01prm4103 , 'Record':U , h_v04prm4103 ).
       RUN add-link IN adm-broker-hdl ( h_v01prm4103 , 'Group-Assign':U , h_v04prm4103 ).

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_v04prm4103 ,
             h_folder , 'AFTER':U ).
    END. /* Page 3 */
...
------------------------------------------------------------------------------*/
  ...
  {utp/ut9000.i "PRM4103" "1.00.00.000"}
