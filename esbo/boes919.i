...
"DBO Temp-Table File Template.
 
Include que cont‚m defini‡Æo da temptable RowObject."
*/
&ANALYZE-RESUME
...
DEFINE TEMP-TABLE {1} NO-UNDO LIKE int-cond-pag-cli-det
