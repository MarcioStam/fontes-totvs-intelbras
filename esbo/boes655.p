...
&GLOBAL-DEFINE DBOName BOES655
&GLOBAL-DEFINE DBOVersion 
&GLOBAL-DEFINE DBOCustomFunctions 
&GLOBAL-DEFINE TableName item-falha
...
/*------------------------------------------------------------------------------
  ...
  Notes:       
------------------------------------------------------------------------------*/
    DEFINE OUTPUT PARAMETER pit-codigo LIKE item-falha.it-codigo NO-UNDO.
...
/*------------------------------------------------------------------------------
  ...
  Notes:       
------------------------------------------------------------------------------*/
    DEFINE INPUT PARAMETER pit-codigo LIKE item-falha.it-codigo NO-UNDO.
    DEFINE INPUT PARAMETER pcod-falha LIKE item-falha.cod-falha NO-UNDO.

    FIND FIRST bfitem-falha WHERE 
        bfitem-falha.it-codigo = pit-codigo AND 
        bfitem-falha.cod-falha = pcod-falha NO-LOCK NO-ERROR.

    /*--- Verifica se registro foi encontrado, em caso de erro ser† retornada flag "NOK":U ---*/
    IF NOT AVAILABLE bfitem-falha THEN 
        RETURN "NOK":U.

    /*--- Reposiciona query atravÇs de rowid e verifica a ocorrància de erros, caso
          existam erros ser† retornada flag "NOK":U ---*/
    RUN repositionRecord IN THIS-PROCEDURE (INPUT ROWID(bfitem-falha)).
...
------------------------------------------------------------------------------*/
    ...
    IF pType = "Create" OR pType = "Update" THEN DO:
        ...
        IF NOT CAN-FIND(FIRST falha-mqa
                        WHERE falha-mqa.cod-falha = RowObject.cod-falha) THEN DO:
