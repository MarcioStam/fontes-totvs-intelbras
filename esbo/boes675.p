...
&GLOBAL-DEFINE DBOName BOES675
&GLOBAL-DEFINE DBOVersion 
&GLOBAL-DEFINE DBOCustomFunctions 
&GLOBAL-DEFINE TableName auditoria-anexo
...
------------------------------------------------------------------------------*/
    ...
    CASE pFieldName:
        ...
        WHEN "det-anexo":U THEN ASSIGN pFieldValue = RowObject.det-anexo.
...
------------------------------------------------------------------------------*/
    ...
    CASE pFieldName:
        ...
        WHEN "nr-seq-anexo":U THEN ASSIGN pFieldValue = RowObject.nr-seq-anexo.
...
/*------------------------------------------------------------------------------
  ...
  Parameters:  
               ...
               retorna valor do campo nr-seq-anexo
  Notes:       
------------------------------------------------------------------------------*/
    DEFINE OUTPUT PARAMETER pnr-seq-auditoria LIKE auditoria-anexo.nr-seq-auditoria NO-UNDO.
    DEFINE OUTPUT PARAMETER pnr-seq-anexo LIKE auditoria-anexo.nr-seq-anexo NO-UNDO.
    ...
    ASSIGN pnr-seq-auditoria = RowObject.nr-seq-auditoria
           pnr-seq-anexo = RowObject.nr-seq-anexo.
...
/*------------------------------------------------------------------------------
  ...
  Parameters:  
               ...
               recebe valor do campo nr-seq-anexo
  Notes:       
------------------------------------------------------------------------------*/
    DEFINE INPUT PARAMETER pnr-seq-auditoria LIKE auditoria-anexo.nr-seq-auditoria NO-UNDO.
    DEFINE INPUT PARAMETER pnr-seq-anexo LIKE auditoria-anexo.nr-seq-anexo NO-UNDO.

    FIND FIRST bfauditoria-anexo WHERE 
        bfauditoria-anexo.nr-seq-auditoria = pnr-seq-auditoria AND 
        bfauditoria-anexo.nr-seq-anexo = pnr-seq-anexo NO-LOCK NO-ERROR.

    /*--- Verifica se registro foi encontrado, em caso de erro ser† retornada flag "NOK":U ---*/
    IF NOT AVAILABLE bfauditoria-anexo THEN 
        RETURN "NOK":U.

    /*--- Reposiciona query atravÇs de rowid e verifica a ocorrància de erros, caso
          existam erros ser† retornada flag "NOK":U ---*/
    RUN repositionRecord IN THIS-PROCEDURE (INPUT ROWID(bfauditoria-anexo)).
...
------------------------------------------------------------------------------*/
    ...
    DEFINE INPUT PARAMETER p-nr-seq-auditoria AS INT NO-UNDO.
