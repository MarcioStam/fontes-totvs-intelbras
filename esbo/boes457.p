...
*******************************************************************************/
{include/i-prgvrs.i BOES457 2.00.00.000}                               
/*--------------------------------------------------------------------------
    File       : 
...
&GLOBAL-DEFINE DBOName  BOES457
&GLOBAL-DEFINE DBOVersion  2.00.00.000
&GLOBAL-DEFINE DBOCustomFunctions 
&GLOBAL-DEFINE TableName  param-vpc
&GLOBAL-DEFINE TableLabel  Parametros VPC                
...
PROCEDURE getCharField :                                                                                                            
    ...
    CASE pFieldName:
        WHEN "aprovadores":U THEN ASSIGN pFieldValue = RowObject.aprovadores.
        WHEN "cod-estabel":U THEN ASSIGN pFieldValue = RowObject.cod-estabel.
        WHEN "email-comerc":U THEN ASSIGN pFieldValue = RowObject.email-comerc.
        WHEN "email-financ":U THEN ASSIGN pFieldValue = RowObject.email-financ.
