...
&GLOBAL-DEFINE DBOName BOAD129
&GLOBAL-DEFINE DBOVersion 
&GLOBAL-DEFINE DBOCustomFunctions 
&GLOBAL-DEFINE TableName gr-cli
...
------------------------------------------------------------------------------*/
    ...
    CASE pFieldName:
        WHEN "atraso-max":U THEN ASSIGN pFieldValue = RowObject.atraso-max.
        ...
        WHEN "ind-aval[1]":U THEN ASSIGN pFieldValue = RowObject.ind-aval[1].
        WHEN "ind-aval[2]":U THEN ASSIGN pFieldValue = RowObject.ind-aval[2].
        WHEN "ind-aval[3]":U THEN ASSIGN pFieldValue = RowObject.ind-aval[3].
        ...
        WHEN "tp-rec-desp":U THEN ASSIGN pFieldValue = RowObject.tp-rec-desp.
        OTHERWISE RETURN "NOK":U.
    END CASE.
...
/*------------------------------------------------------------------------------
  ...
  Notes:       
------------------------------------------------------------------------------*/
    DEFINE OUTPUT PARAMETER pcod-gr-cli LIKE gr-cli.cod-gr-cli NO-UNDO.
    ...
    ASSIGN pcod-gr-cli = RowObject.cod-gr-cli.
...
------------------------------------------------------------------------------*/
    ...
    CASE pFieldName:
        WHEN "gera-aviso":U THEN ASSIGN pFieldValue = RowObject.gera-aviso.
...
/*------------------------------------------------------------------------------
  ...
  Notes:       
------------------------------------------------------------------------------*/
    DEFINE INPUT PARAMETER pcod-gr-cli LIKE gr-cli.cod-gr-cli NO-UNDO.

    FIND FIRST bfgr-cli WHERE 
        bfgr-cli.cod-gr-cli = pcod-gr-cli NO-LOCK NO-ERROR.

    /*--- Verifica se registro foi encontrado, em caso de erro ser† retornada flag "NOK":U ---*/
    IF NOT AVAILABLE bfgr-cli THEN 
        RETURN "NOK":U.

    /*--- Reposiciona query atravÇs de rowid e verifica a ocorrància de erros, caso
          existam erros ser† retornada flag "NOK":U ---*/
    RUN repositionRecord IN THIS-PROCEDURE (INPUT ROWID(bfgr-cli)).
