...
&GLOBAL-DEFINE DBOName BOES659
&GLOBAL-DEFINE DBOVersion 
&GLOBAL-DEFINE DBOCustomFunctions 
&GLOBAL-DEFINE TableName origem-mqa
...
DEFINE VARIABLE i-origem-falha-ini AS INTEGER     NO-UNDO.
DEFINE VARIABLE i-origem-falha-fim AS INTEGER     NO-UNDO.
...
/*------------------------------------------------------------------------------
  ...
  Parameters:  
               retorna valor do campo origem-falha
  Notes:       
------------------------------------------------------------------------------*/
    DEFINE OUTPUT PARAMETER porigem-falha LIKE origem-mqa.origem-falha NO-UNDO.
    ...
    ASSIGN porigem-falha = RowObject.origem-falha.
...
/*------------------------------------------------------------------------------
  ...
  Parameters:  
               recebe valor do campo origem-falha
  Notes:       
------------------------------------------------------------------------------*/
    DEFINE INPUT PARAMETER porigem-falha LIKE origem-mqa.origem-falha NO-UNDO.

    FIND FIRST bforigem-mqa WHERE 
        bforigem-mqa.origem-falha = porigem-falha NO-LOCK NO-ERROR.

    /*--- Verifica se registro foi encontrado, em caso de erro ser† retornada flag "NOK":U ---*/
    IF NOT AVAILABLE bforigem-mqa THEN 
        RETURN "NOK":U.

    /*--- Reposiciona query atravÇs de rowid e verifica a ocorrància de erros, caso
          existam erros ser† retornada flag "NOK":U ---*/
    RUN repositionRecord IN THIS-PROCEDURE (INPUT ROWID(bforigem-mqa)).
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE OpenQueryItemDesc DBOProgram 
PROCEDURE OpenQueryItemDesc :
/*------------------------------------------------------------------------------
  Purpose:     
  Parameters:  <none>
  Notes:       
------------------------------------------------------------------------------*/
    ...
    OPEN QUERY {&QueryName} FOR EACH {&TableName} NO-LOCK 
        WHERE {&TableName}.origem-falha >= i-origem-falha-ini
        AND   {&TableName}.origem-falha <= i-origem-falha-fim
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE SetConstraintItemDesc DBOProgram 
PROCEDURE SetConstraintItemDesc :
/*------------------------------------------------------------------------------
  Purpose:     
  Parameters:  <none>
  Notes:       
------------------------------------------------------------------------------*/
    ...
    DEFINE INPUT PARAMETER p-origem-falha-ini  AS INTEGER      NO-UNDO.
    DEFINE INPUT PARAMETER p-origem-falha-fim  AS INTEGER      NO-UNDO.
    DEFINE INPUT PARAMETER p-descricao-ini  AS CHARACTER    NO-UNDO.
    DEFINE INPUT PARAMETER p-descricao-fim  AS CHARACTER    NO-UNDO.

    ASSIGN i-origem-falha-ini = p-origem-falha-ini
           i-origem-falha-fim = p-origem-falha-fim
