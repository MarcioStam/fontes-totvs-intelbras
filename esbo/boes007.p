...
/*------------------------------------------------------------------------------
  ...
  Notes:       
------------------------------------------------------------------------------*/
    DEFINE OUTPUT PARAMETER pid-etiqueta LIKE {&TableName}.id-etiqueta NO-UNDO.
...
/*------------------------------------------------------------------------------
  ...
  Notes:       
------------------------------------------------------------------------------*/
    DEFINE INPUT PARAMETER pid-etiqueta LIKE {&TableName}.id-etiqueta NO-UNDO.

    FIND FIRST bf{&TableName} WHERE 
        bf{&TableName}.id-etiqueta = pid-etiqueta NO-LOCK NO-ERROR.
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE piAtualizaDataGer DBOProgram 
PROCEDURE piAtualizaDataGer :
/*------------------------------------------------------------------------------
  Purpose: Atualiza data da transaá∆o (wm-box-saldo)    
  Notes:   Carlos Daniel - 02/03/2016
------------------------------------------------------------------------------*/
DEFINE INPUT PARAMETER d-etiqueta AS DECIMAL NO-UNDO.
DEFINE INPUT PARAMETER dt-data    AS DATE    NO-UNDO.

FOR EACH wm-box-saldo-etiqueta
    WHERE wm-box-saldo-etiqueta.id-etiqueta = d-etiqueta NO-LOCK,
    FIRST wm-box-saldo OF wm-box-saldo-etiqueta EXCLUSIVE-LOCK:

    ASSIGN wm-box-saldo.dt-trans = dt-data.
END.
