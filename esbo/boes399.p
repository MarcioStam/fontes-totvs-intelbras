...
&GLOBAL-DEFINE DBOName BOES399
&GLOBAL-DEFINE DBOVersion 
&GLOBAL-DEFINE DBOCustomFunctions 
&GLOBAL-DEFINE TableName param-cat
...
------------------------------------------------------------------------------*/
    ...
    CASE pFieldName:
        WHEN "nat-oper-retorno-de":U THEN ASSIGN pFieldValue = RowObject.nat-oper-retorno-de.
        WHEN "nat-oper-retorno-fe":U THEN ASSIGN pFieldValue = RowObject.nat-oper-retorno-fe.
