...
&GLOBAL-DEFINE DBOName boes512
&GLOBAL-DEFINE DBOVersion 2.00.04.000
&GLOBAL-DEFINE DBOCustomFunctions 
&GLOBAL-DEFINE TableName int-natur-oper
&GLOBAL-DEFINE TableLabel int-natur-oper
...
/*------------------------------------------------------------------------------
  ...
  Notes:       
------------------------------------------------------------------------------*/
    DEFINE OUTPUT PARAMETER pnat-operacao LIKE int-natur-oper.nat-operacao NO-UNDO.
    ...
    ASSIGN pnat-operacao = RowObject.nat-operacao.
...
/*------------------------------------------------------------------------------
  ...
  Notes:       
------------------------------------------------------------------------------*/
    DEFINE INPUT PARAMETER pnat-operacao LIKE int-natur-oper.nat-operacao NO-UNDO.

    FIND FIRST bfint-natur-oper 
         WHERE bfint-natur-oper.nat-operacao = pnat-operacao NO-LOCK NO-ERROR.

    /*--- Verifica se registro foi encontrado, em caso de erro ser† retornada flag "NOK":U ---*/
    IF NOT AVAILABLE bfint-natur-oper THEN 
        RETURN "NOK":U.

    /*--- Reposiciona query atravÇs de rowid e verifica a ocorrància de erros, caso
          existam erros ser† retornada flag "NOK":U ---*/
    RUN repositionRecord IN THIS-PROCEDURE (INPUT ROWID(bfint-natur-oper)).
