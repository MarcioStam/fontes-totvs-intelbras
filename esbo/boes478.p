...
&GLOBAL-DEFINE DBOName BOES478
&GLOBAL-DEFINE DBOVersion 
&GLOBAL-DEFINE DBOCustomFunctions 
&GLOBAL-DEFINE TableName assistente
...
DEF VAR v-ini-cod-assistente LIKE assistente.cod-assistente NO-UNDO.
DEF var v-fim-cod-assistente LIKE assistente.cod-assistente NO-UNDO.
...
PROCEDURE getKey :
/*------------------------------------------------------------------------------
  Purpose:     Retorna valores dos campos do ¡ndice ch_princ
  Parameters:  
               retorna valor do campo cod-assistente
  Notes:       
------------------------------------------------------------------------------*/
    DEFINE OUTPUT PARAMETER pcod-assistente LIKE assistente.cod-assistente NO-UNDO.
    ...
    ASSIGN pcod-assistente = RowObject.cod-assistente.
...
PROCEDURE goToKey :
/*------------------------------------------------------------------------------
  Purpose:     Reposiciona registro com base no ¡ndice ch_princ
  Parameters:  
               recebe valor do campo cod-assistente
  Notes:       
------------------------------------------------------------------------------*/
    DEFINE INPUT PARAMETER pcod-assistente LIKE assistente.cod-assistente NO-UNDO.

    FIND FIRST bfassistente WHERE 
        bfassistente.cod-assistente = pcod-assistente NO-LOCK NO-ERROR.

    /*--- Verifica se registro foi encontrado, em caso de erro ser  retornada flag "NOK":U ---*/
    IF NOT AVAILABLE bfassistente THEN 
        RETURN "NOK":U.

    /*--- Reposiciona query atrav‚s de rowid e verifica a ocorrˆncia de erros, caso
          existam erros ser  retornada flag "NOK":U ---*/
    RUN repositionRecord IN THIS-PROCEDURE (INPUT ROWID(bfassistente)).
...
OPEN QUERY {&QueryName} FOR EACH {&TableName} NO-LOCK
         WHERE {&TableName}.cod-assistente >= v-ini-cod-assistente
           AND {&TableName}.cod-assistente <= v-fim-cod-assistente.
...
/*------------------------------------------------------------------------------
  ...
  Notes:       
------------------------------------------------------------------------------*/
    DEF INPUT PARAM p-ini-cod-assistente LIKE assistente.cod-assistente NO-UNDO.
    DEF INPUT PARAM p-fim-cod-assistente LIKE assistente.cod-assistente NO-UNDO.


    ASSIGN v-ini-cod-assistente = p-ini-cod-assistente
           v-fim-cod-assistente = p-fim-cod-assistente.
