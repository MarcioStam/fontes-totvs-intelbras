...
DEFINE VARIABLE c-nome-abrev-ini AS CHAR NO-UNDO.
DEFINE VARIABLE c-nome-abrev-fim AS CHAR NO-UNDO.
...
------------------------------------------------------------------------------*/
    ...
    CASE pFieldName:
        ...
        WHEN "cod-email-nfe":U THEN ASSIGN pFieldValue = RowObject.cod-email-nfe.
        WHEN "cod-entrega":U THEN ASSIGN pFieldValue = RowObject.cod-entrega.
        WHEN "cod-inscr-inss":U THEN ASSIGN pFieldValue = RowObject.cod-inscr-inss.
        WHEN "cod-pulmao":U THEN ASSIGN pFieldValue = RowObject.cod-pulmao.
        ...
        WHEN "endereco-cob-text":U THEN ASSIGN pFieldValue = RowObject.endereco-cob-text.
        ...
        WHEN "hra-atualiz":U THEN ASSIGN pFieldValue = RowObject.hra-atualiz.
        ...
        WHEN "nom-fantasia":U THEN ASSIGN pFieldValue = RowObject.nom-fantasia.
        ...
        WHEN "short-name":U THEN ASSIGN pFieldValue = RowObject.short-name.
...
------------------------------------------------------------------------------*/
    ...
    CASE pFieldName:
        WHEN "dat-valid-suframa":U THEN ASSIGN pFieldValue = RowObject.dat-valid-suframa.
        ...
        WHEN "dt-atualiza":U THEN ASSIGN pFieldValue = RowObject.dt-atualiza.
...
------------------------------------------------------------------------------*/
    ...
    CASE pFieldName:
        ...
        WHEN "idi-tributac-cofins":U THEN ASSIGN pFieldValue = RowObject.idi-tributac-cofins.
        WHEN "idi-tributac-pis":U THEN ASSIGN pFieldValue = RowObject.idi-tributac-pis.
        ...
        WHEN "modalidade-ap":U THEN ASSIGN pFieldValue = RowObject.modalidade-ap.
        ...
        WHEN "portador-ap":U THEN ASSIGN pFieldValue = RowObject.portador-ap.
...
------------------------------------------------------------------------------*/
    ...
    CASE pFieldName:
        ...
        WHEN "log-calcula-pis-cofins-unid":U THEN ASSIGN pFieldValue = RowObject.log-calcula-pis-cofins-unid.
        WHEN "log-contribt-subst-interm":U THEN ASSIGN pFieldValue = RowObject.log-contribt-subst-interm.
        WHEN "log-controla-val-max-inss":U THEN ASSIGN pFieldValue = RowObject.log-controla-val-max-inss.
        WHEN "log-integr-totvs-colab-vendas":U THEN ASSIGN pFieldValue = RowObject.log-integr-totvs-colab-vendas.
        WHEN "log-nf-eletro":U THEN ASSIGN pFieldValue = RowObject.log-nf-eletro.
        WHEN "log-optan-cr-presmdo-subst":U THEN ASSIGN pFieldValue = RowObject.log-optan-cr-presmdo-subst.
        WHEN "log-optan-suspens-ipi":U THEN ASSIGN pFieldValue = RowObject.log-optan-suspens-ipi.
        WHEN "log-possui-nf-eletro":U THEN ASSIGN pFieldValue = RowObject.log-possui-nf-eletro.
        ...
        WHEN "retem-pagto":U THEN ASSIGN pFieldValue = RowObject.retem-pagto.
...
------------------------------------------------------------------------------*/
    ...
    FIND FIRST bfemitente
        WHERE bfemitente.cod-emitente = pcod-emitente NO-LOCK NO-ERROR.
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE openQueryEmi DBOProgram 
PROCEDURE openQueryEmi :
/*------------------------------------------------------------------------------
  Purpose:     
  Parameters:  <none>
  Notes:       
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE setConstraintEmi DBOProgram 
PROCEDURE setConstraintEmi :
/*------------------------------------------------------------------------------
  Purpose:     
  Parameters:  <none>
  Notes:       
------------------------------------------------------------------------------*/
    ...
    DEFINE INPUT PARAMETER p-cod-emitente-ini AS INT  NO-UNDO.
    DEFINE INPUT PARAMETER p-cod-emitente-fim AS INT  NO-UNDO.
