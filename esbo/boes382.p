...
&GLOBAL-DEFINE DBOName BOES382
&GLOBAL-DEFINE DBOVersion 
&GLOBAL-DEFINE DBOCustomFunctions 
&GLOBAL-DEFINE TableName gerente
...
DEF VAR v-ini-cod-gerente LIKE gerente.cod-gerente NO-UNDO.
DEF var v-fim-cod-gerente LIKE gerente.cod-gerente NO-UNDO.
...
PROCEDURE getKey :
/*------------------------------------------------------------------------------
  Purpose:     Retorna valores dos campos do ¡ndice ch-gerente
  Parameters:  
               retorna valor do campo cod-gerente
  Notes:       
------------------------------------------------------------------------------*/
    DEFINE OUTPUT PARAMETER pcod-gerente LIKE gerente.cod-gerente NO-UNDO.
    ...
    ASSIGN pcod-gerente = RowObject.cod-gerente.
...
PROCEDURE goToKey :
/*------------------------------------------------------------------------------
  Purpose:     Reposiciona registro com base no ¡ndice ch-gerente
  Parameters:  
               recebe valor do campo cod-gerente
  Notes:       
------------------------------------------------------------------------------*/
    DEFINE INPUT PARAMETER pcod-gerente LIKE gerente.cod-gerente NO-UNDO.

    FIND FIRST bfgerente WHERE 
        bfgerente.cod-gerente = pcod-gerente NO-LOCK NO-ERROR.

    /*--- Verifica se registro foi encontrado, em caso de erro ser  retornada flag "NOK":U ---*/
    IF NOT AVAILABLE bfgerente THEN 
        RETURN "NOK":U.

    /*--- Reposiciona query atrav‚s de rowid e verifica a ocorrˆncia de erros, caso
          existam erros ser  retornada flag "NOK":U ---*/
    RUN repositionRecord IN THIS-PROCEDURE (INPUT ROWID(bfgerente)).
...
OPEN QUERY {&QueryName} FOR EACH {&TableName} NO-LOCK
         WHERE {&TableName}.cod-gerente >= v-ini-cod-gerente
           AND {&TableName}.cod-gerente <= v-fim-cod-gerente.
...
/*------------------------------------------------------------------------------
  ...
  Notes:       
------------------------------------------------------------------------------*/
    DEF INPUT PARAM p-ini-cod-gerente LIKE gerente.cod-gerente NO-UNDO.
    DEF INPUT PARAM p-fim-cod-gerente LIKE gerente.cod-gerente NO-UNDO.


    ASSIGN v-ini-cod-gerente = p-ini-cod-gerente
