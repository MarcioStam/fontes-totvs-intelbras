...
&GLOBAL-DEFINE DBOName BOES654
&GLOBAL-DEFINE DBOVersion 
&GLOBAL-DEFINE DBOCustomFunctions 
&GLOBAL-DEFINE TableName falha-mqa
...
DEFINE VARIABLE i-cod-falha-ini AS INTEGER     NO-UNDO.
DEFINE VARIABLE i-cod-falha-fim AS INTEGER     NO-UNDO.
...
/*------------------------------------------------------------------------------
  ...
  Notes:       
------------------------------------------------------------------------------*/
    DEFINE OUTPUT PARAMETER pcod-falha LIKE falha-mqa.cod-falha NO-UNDO.
    ...
    ASSIGN pcod-falha = RowObject.cod-falha.
...
/*------------------------------------------------------------------------------
  ...
  Notes:       
------------------------------------------------------------------------------*/
    DEFINE INPUT PARAMETER pcod-falha LIKE falha-mqa.cod-falha NO-UNDO.

    FIND FIRST bffalha-mqa WHERE 
        bffalha-mqa.cod-falha = pcod-falha NO-LOCK NO-ERROR.

    /*--- Verifica se registro foi encontrado, em caso de erro ser† retornada flag "NOK":U ---*/
    IF NOT AVAILABLE bffalha-mqa THEN 
        RETURN "NOK":U.

    /*--- Reposiciona query atravÇs de rowid e verifica a ocorrància de erros, caso
          existam erros ser† retornada flag "NOK":U ---*/
    RUN repositionRecord IN THIS-PROCEDURE (INPUT ROWID(bffalha-mqa)).
...
------------------------------------------------------------------------------*/
    ...
    OPEN QUERY {&QueryName} FOR EACH {&TableName} NO-LOCK 
        WHERE {&TableName}.cod-falha >= i-cod-falha-ini
        AND   {&TableName}.cod-falha <= i-cod-falha-fim
...
------------------------------------------------------------------------------*/
    ...
    DEFINE INPUT PARAMETER p-cod-falha-ini  AS INTEGER      NO-UNDO.
    DEFINE INPUT PARAMETER p-cod-falha-fim  AS INTEGER      NO-UNDO.
    DEFINE INPUT PARAMETER p-descricao-ini  AS CHARACTER    NO-UNDO.
    DEFINE INPUT PARAMETER p-descricao-fim  AS CHARACTER    NO-UNDO.

    ASSIGN i-cod-falha-ini = p-cod-falha-ini
           i-cod-falha-fim = p-cod-falha-fim
