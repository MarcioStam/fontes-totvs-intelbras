...
*******************************************************************************/
{include/i-prgvrs.i BOES192 2.00.00.000}                               
/*--------------------------------------------------------------------------
    File       : 
...
&GLOBAL-DEFINE DBOName  BOES192
&GLOBAL-DEFINE DBOVersion  2.00.00.000
&GLOBAL-DEFINE DBOCustomFunctions 
&GLOBAL-DEFINE TableName  tipo-pend
&GLOBAL-DEFINE TableLabel Tipos Pendˆncias                     
...
define variable v-tipo as integer no-undo.
define variable v-ini-tipo as integer no-undo.
define variable v-fim-tipo as integer no-undo.
...
DEFINE INPUT PARAMETER pFieldName AS CHARACTER NO-UNDO.
    ...
    CASE pFieldName:
        ...
        WHEN "e-mail-adm":U THEN ASSIGN pFieldValue = RowObject.e-mail-adm.
        WHEN "usuario[1]":U THEN ASSIGN pFieldValue = RowObject.usuario[1].
        WHEN "usuario[2]":U THEN ASSIGN pFieldValue = RowObject.usuario[2].
        WHEN "usuario[3]":U THEN ASSIGN pFieldValue = RowObject.usuario[3].
        WHEN "usuario[4]":U THEN ASSIGN pFieldValue = RowObject.usuario[4].
        WHEN "usuario[5]":U THEN ASSIGN pFieldValue = RowObject.usuario[5].
        WHEN "usuario[6]":U THEN ASSIGN pFieldValue = RowObject.usuario[6].
        WHEN "usuario[7]":U THEN ASSIGN pFieldValue = RowObject.usuario[7].
        WHEN "usuario[8]":U THEN ASSIGN pFieldValue = RowObject.usuario[8].
        WHEN "usuario[9]":U THEN ASSIGN pFieldValue = RowObject.usuario[9].
        WHEN "usuario[10]":U THEN ASSIGN pFieldValue = RowObject.usuario[10].
...
DEFINE INPUT PARAMETER pFieldName AS CHARACTER NO-UNDO.
    ...
    CASE pFieldName:
        WHEN "automatico":U THEN ASSIGN pFieldValue = RowObject.automatico.
        WHEN "e-inclusao":U THEN ASSIGN pFieldValue = RowObject.e-inclusao.
        WHEN "e-prazo":U THEN ASSIGN pFieldValue = RowObject.e-prazo.
        WHEN "e-solucao":U THEN ASSIGN pFieldValue = RowObject.e-solucao.
        WHEN "prioridade-0":U THEN ASSIGN pFieldValue = RowObject.prioridade-0.
        WHEN "usa-andamento":U THEN ASSIGN pFieldValue = RowObject.usa-andamento.
        WHEN "usa-super":U THEN ASSIGN pFieldValue = RowObject.usa-super.
        WHEN "usa-tempos":U THEN ASSIGN pFieldValue = RowObject.usa-tempos.
        OTHERWISE RETURN "NOK":U.
    END CASE.
    RETURN "OK":U.
END PROCEDURE.
...
DEFINE INPUT PARAMETER p-tipo AS integer NO-UNDO.                                                                               
    ...
    FIND bf{&TableName} NO-LOCK
        WHERE bf{&TableName}.tipo = p-tipo                            
        NO-ERROR.
...
OPEN QUERY {&QueryName} FOR EACH {&TableName} NO-LOCK
        WHERE {&TableName}.tipo >= v-ini-tipo                              
...
DEFINE INPUT PARAMETER p-ini-tipo AS integer NO-UNDO.                                                                               
    DEFINE INPUT PARAMETER p-fim-tipo AS integer NO-UNDO.                                                                               
    ...
    CASE pType:
         WHEN "Create" THEN DO:
             IF CAN-FIND(FIRST bf{&TableName} NO-LOCK
                 WHERE bf{&TableName}.tipo = RowObject.tipo) THEN DO:
