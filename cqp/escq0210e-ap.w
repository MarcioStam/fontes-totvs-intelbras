...
c-cod-depos-ent c-cod-localiz-ent bt-confirma d-data-fabric bt-ok ~
bt-cancela 
&Scoped-Define DISPLAYED-OBJECTS c-cod-depos-ent c-desc-dep ~
c-cod-localiz-ent c-desc-local d-data-fabric 
...
DEFINE FRAME F-Main
     ...
     "Processa Alteraá∆o Data Fabricaá∆o:" VIEW-AS TEXT
          SIZE 25 BY .88 AT ROW 5.75 COL 68 WIDGET-ID 40
          FONT 1
     rt-button AT ROW 12 COL 1 WIDGET-ID 10
     RECT-1 AT ROW 1.5 COL 64 WIDGET-ID 20
     RECT-2 AT ROW 6 COL 64 WIDGET-ID 38
     RECT-3 AT ROW 6 COL 64 WIDGET-ID 44
...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW W-Win ASSIGN
         HIDDEN             = YES
         TITLE              = "Retorno Roteiros Aprovados"
         HEIGHT             = 12.71
         WIDTH              = 128.14
         MAX-HEIGHT         = 17
         MAX-WIDTH          = 128.14
...
ON END-ERROR OF W-Win /* Retorno Roteiros Aprovados */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL W-Win W-Win
ON WINDOW-CLOSE OF W-Win /* Retorno Roteiros Aprovados */
DO:
...
if c-cod-depos-ent:load-mouse-pointer("image/lupa.cur") THEN.
...
------------------------------------------------------------------------------*/
  ...
  ENABLE rt-button RECT-1 RECT-2 RECT-3 BROWSE-3 c-cod-depos-ent 
         c-cod-localiz-ent bt-confirma d-data-fabric bt-ok bt-cancela 
      WITH FRAME F-Main IN WINDOW W-Win.
