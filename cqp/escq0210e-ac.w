...
&Scoped-define FIELDS-IN-QUERY-BROWSE-3 tt-gera-transf.nr-ficha tt-gera-transf.dt-fabricacao tt-gera-transf.it-codigo tt-gera-transf.desc-item tt-gera-transf.quantidade tt-gera-transf.lote   
...
DEFINE FRAME F-Main
     ...
     bt-ok AT ROW 12.25 COL 2 HELP
          "Salva e sai" WIDGET-ID 6
     bt-cancela AT ROW 12.25 COL 13 HELP
          "Cancela" WIDGET-ID 4
     "Condiá‰es p/ Aprovaá∆o:" VIEW-AS TEXT
...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW W-Win ASSIGN
         HIDDEN             = YES
         TITLE              = "Retorno Roteiros Aprovados C/ Condiá∆o"
         HEIGHT             = 12.71
         WIDTH              = 128.14
         MAX-HEIGHT         = 17
         MAX-WIDTH          = 128.14
...
ON END-ERROR OF W-Win /* Retorno Roteiros Aprovados C/ Condiá∆o */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL W-Win W-Win
ON WINDOW-CLOSE OF W-Win /* Retorno Roteiros Aprovados C/ Condiá∆o */
DO:
...
/*                                                                                                                                           */
/*         IF AVAIL int-familia THEN ASSIGN tt-gera-transf.dt-fabricacao = tt-gera-transf.dt-fabricacao + (int-familia.meses-validade * 30). */
...
DO:
    ...
    IF AVAIL deposito THEN DO: 
      ...
      IF deposito.ind-dep-cq = YES OR deposito.ind-dep-rej = YES THEN DO:
    
           RUN utp/ut-msgs.p (INPUT 'show',
                              INPUT 17006,
                              INPUT "Dep¢sito de entrada inv†lido!"
                              + "~~" +
                              "Para esta transaá∆o n∆o pode ser utilizado deposito de CQ ou Rejeiá∆o.").
    ...
    IF NOT AVAIL cod-rejeicao THEN DO:
        ...
        RUN utp/ut-msgs.p (INPUT 'show',
                           INPUT 17006,
                           INPUT "Codigo de aprovaá∆o condicional n∆o cadastrado!"
                           + "~~" +
                           "Informe um codigo de aprovaá∆o condicional v†lido.").
    ...
    ELSE DO:
       ...
       IF cod-rejeicao.tipo-rejeicao <> 2 THEN DO:

            RUN utp/ut-msgs.p (INPUT 'show',
                               INPUT 17006,
                               INPUT "Codigo de aprovaá∆o condicional inv†lido!"
                               + "~~" +
                               "Verifique o tipo do codigo de aprovaá∆o informado.").
...
ON F5 OF i-codigo-rejei IN FRAME F-Main /* Motivo Apr. Cond. */
DO:
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL i-codigo-rejei W-Win
ON LEAVE OF i-codigo-rejei IN FRAME F-Main /* Motivo Apr. Cond. */
DO:
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL i-codigo-rejei W-Win
ON MOUSE-SELECT-DBLCLICK OF i-codigo-rejei IN FRAME F-Main /* Motivo Apr. Cond. */
DO:
    apply 'F5' to self.
END.
