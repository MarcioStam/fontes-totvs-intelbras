...
*******************************************************************************/
{include/i-prgvrs.i ESCDP124-Q02 1.00.00.000}
...
&IF "{&EMSFND_VERSION}" >= "1.00" &THEN
    {include/i-license-manager.i ESCDP124-Q02 ESP}
&ENDIF
...
&Scoped-define QUERY-STRING-Query-Main FOR EACH int_param_est_ccusto_uep NO-LOCK INDEXED-REPOSITION
&Scoped-define OPEN-QUERY-Query-Main OPEN QUERY Query-Main FOR EACH int_param_est_ccusto_uep NO-LOCK INDEXED-REPOSITION.
&Scoped-define TABLES-IN-QUERY-Query-Main int_param_est_ccusto_uep
&Scoped-define FIRST-TABLE-IN-QUERY-Query-Main int_param_est_ccusto_uep
...
/* Query rebuild information for QUERY Query-Main
     _TblList          = "mgesp.int_param_est_ccusto_uep"
