...
*******************************************************************************/
{include/i-prgvrs.i ESCDP116 9.99.99.999}
...
DEFINE VARIABLE h_escdp116-q01 AS HANDLE NO-UNDO.
DEFINE VARIABLE h_escdp116-v01 AS HANDLE NO-UNDO.
...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'esp/cdp/escdp116-v01.w':U ,
             INPUT  FRAME f-cad:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_escdp116-v01 ).
       RUN set-position IN h_escdp116-v01 ( 2.71 , 1.57 ) NO-ERROR.
       /* Size in UIB:  ( 3.75 , 88.57 ) */

       RUN init-object IN THIS-PROCEDURE (
             INPUT  'esp/cdp/escdp116-q01.w':U ,
             INPUT  FRAME f-cad:HANDLE ,
             INPUT  'ProgPesquisa = eszoom\z01escdp116.w,
                     ProgVaPara = esp\cdp\escdp116-g01.w,
                     ProgIncMod = ,
                     Implantar = no':U ,
             OUTPUT h_escdp116-q01 ).
       RUN set-position IN h_escdp116-q01 ( 1.00 , 62.00 ) NO-ERROR.
       /* Size in UIB:  ( 2.75 , 9.00 ) */

       /* Links to SmartPanel h_p-exihel. */
       RUN add-link IN adm-broker-hdl ( h_p-cadsim , 'State':U , h_p-exihel ).

       /* Links to SmartViewer h_escdp116-v01. */
       RUN add-link IN adm-broker-hdl ( h_escdp116-q01 , 'Record':U , h_escdp116-v01 ).
       RUN add-link IN adm-broker-hdl ( h_p-cadsim , 'TableIO':U , h_escdp116-v01 ).

       /* Links to SmartQuery h_escdp116-q01. */
       RUN add-link IN adm-broker-hdl ( h_p-exihel , 'State':U , h_escdp116-q01 ).
       RUN add-link IN adm-broker-hdl ( h_p-navega , 'Navigation':U , h_escdp116-q01 ).
       RUN add-link IN adm-broker-hdl ( h_p-navega , 'State':U , h_escdp116-q01 ).
       ...
       RUN adjust-tab-order IN adm-broker-hdl ( h_p-exihel ,
             h_p-cadsim , 'AFTER':U ).
       RUN adjust-tab-order IN adm-broker-hdl ( h_escdp116-v01 ,
             h_p-exihel , 'AFTER':U ).
    END. /* Page 0 */
...
------------------------------------------------------------------------------*/
  ...
  {utp/ut9000.i "ESCDP116" "2.00.00.001"}
