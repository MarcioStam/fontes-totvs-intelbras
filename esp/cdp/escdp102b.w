...
*******************************************************************************/
{include/i-prgvrs.i ESCDP102B 1.00.00.001}
...
DEFINE FRAME f-pg-par
     ...
     tg-salva-log AT ROW 2.17 COL 3 WIDGET-ID 8
...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW C-Win ASSIGN
         HIDDEN             = YES
         TITLE              = "Importaá∆o Cat†logo Grupo Cliente"
         HEIGHT             = 15
         WIDTH              = 81.14
         MAX-HEIGHT         = 28.33
         MAX-WIDTH          = 195.14
...
ON END-ERROR OF C-Win /* Importaá∆o Cat†logo Grupo Cliente */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL C-Win C-Win
ON WINDOW-CLOSE OF C-Win /* Importaá∆o Cat†logo Grupo Cliente */
DO:
...
{utp/ut9000.i "ESCDP102B" "1.00.00.001"}
...
/*     {include/i-immbl.i} */
    ...
    assign c-arq-layout = search("layout/loescdp102b.001")
...
/*     {include/i-imvrf.i &escdp102b &versao-layout=001} */
...
do  on error undo, return error
    ...
    {include/i-imrun.i esp/cdp/escdp102br.p}
