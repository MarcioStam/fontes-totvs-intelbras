...
*******************************************************************************/
{include/i-prgvrs.i ESCDP102 1.00.00.001}
...
DEFINE VARIABLE h_escdp102-b01 AS HANDLE NO-UNDO.
DEFINE VARIABLE h_escdp102-v01 AS HANDLE NO-UNDO.
DEFINE VARIABLE h_folder AS HANDLE NO-UNDO.
DEFINE VARIABLE h_p-exihel AS HANDLE NO-UNDO.
DEFINE VARIABLE h_p-navega AS HANDLE NO-UNDO.
DEFINE VARIABLE h_q01ad129 AS HANDLE NO-UNDO.
...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW w-cadpaifilho-filho ASSIGN
         HIDDEN             = YES
         TITLE              = "Cat†logo por Grupo de Cliente"
         HEIGHT             = 13.08
         WIDTH              = 90
         MAX-HEIGHT         = 40.5
         MAX-WIDTH          = 274.29
...
ON END-ERROR OF w-cadpaifilho-filho /* Cat†logo por Grupo de Cliente */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL w-cadpaifilho-filho w-cadpaifilho-filho
ON WINDOW-CLOSE OF w-cadpaifilho-filho /* Cat†logo por Grupo de Cliente */
DO:
...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'esp/cdp/escdp102-v01.w':U ,
             INPUT  FRAME f-cad:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_escdp102-v01 ).
       RUN set-position IN h_escdp102-v01 ( 2.58 , 1.86 ) NO-ERROR.
       /* Size in UIB:  ( 1.25 , 88.57 ) */

       RUN init-object IN THIS-PROCEDURE (
             INPUT  'adm/objects/folder.w':U ,
             INPUT  FRAME f-cad:HANDLE ,
             INPUT  'FOLDER-LABELS = ':U + 'Extens∆o' + ',
                     FOLDER-TAB-TYPE = 1':U ,
             OUTPUT h_folder ).
       ...
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'adqry/q01ad129.w':U ,
             INPUT  FRAME f-cad:HANDLE ,
             INPUT  'ProgPesquisa = adzoom/z01ad129.r,
                     ProgVaPara = adgo/g01ad129.r,
                     ProgIncMod = ,
                     Implantar = no':U ,
             OUTPUT h_q01ad129 ).
       RUN set-position IN h_q01ad129 ( 1.00 , 49.00 ) NO-ERROR.
       /* Size in UIB:  ( 1.63 , 7.72 ) */

       /* Links to SmartPanel h_p-exihel. */
       RUN add-link IN adm-broker-hdl ( h_p-exihel , 'State':U , THIS-PROCEDURE ).

       /* Links to SmartViewer h_escdp102-v01. */
       RUN add-link IN adm-broker-hdl ( h_q01ad129 , 'Record':U , h_escdp102-v01 ).

       /* Links to SmartFolder h_folder. */
       RUN add-link IN adm-broker-hdl ( h_folder , 'Page':U , THIS-PROCEDURE ).

       /* Links to SmartQuery h_q01ad129. */
       RUN add-link IN adm-broker-hdl ( h_p-exihel , 'State':U , h_q01ad129 ).
       RUN add-link IN adm-broker-hdl ( h_p-navega , 'Navigation':U , h_q01ad129 ).
       RUN add-link IN adm-broker-hdl ( h_p-navega , 'State':U , h_q01ad129 ).

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_p-navega ,
             h_p-exihel , 'AFTER':U ).
       RUN adjust-tab-order IN adm-broker-hdl ( h_escdp102-v01 ,
             h_p-navega , 'AFTER':U ).
       RUN adjust-tab-order IN adm-broker-hdl ( h_folder ,
             h_escdp102-v01 , 'AFTER':U ).
    END. /* Page 0 */
    WHEN 1 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'esp/cdp/escdp102-b01.w':U ,
             INPUT  FRAME f-cad:HANDLE ,
             INPUT  'Initial-Lock = NO-LOCK,
                     ...
                     Create-On-Add = ?,
                     ProgAtributo = ,
                     ProgIncMod = esp/cdp/escdp102a.w,
                     MessageNum = 0,
                     MessageParam = ':U ,
             OUTPUT h_escdp102-b01 ).
       RUN set-position IN h_escdp102-b01 ( 5.50 , 5.00 ) NO-ERROR.
       /* Size in UIB:  ( 7.50 , 69.00 ) */

       /* Links to BrowserCadastro2 h_escdp102-b01. */
       RUN add-link IN adm-broker-hdl ( h_q01ad129 , 'Record':U , h_escdp102-b01 ).

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_escdp102-b01 ,
             h_folder , 'AFTER':U ).
    END. /* Page 1 */
...
------------------------------------------------------------------------------*/
  ...
  {utp/ut9000.i "ESCDP102" "1.00.00.001"}
