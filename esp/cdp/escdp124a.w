...
*******************************************************************************/
{include/i-prgvrs.i ESCDP124A 1.00.00.000}
...
&IF "{&EMSFND_VERSION}" >= "1.00" &THEN
    {include/i-license-manager.i ESCDP124A ESP}
&ENDIF
...
DEFINE FRAME f-cad
     bt-ok AT ROW 7.38 COL 3.72 HELP
          "Salva e sai"
     bt-save AT ROW 7.38 COL 14.72 HELP
          "Salva e cria novo registro"
     bt-cancela AT ROW 7.38 COL 25.72 HELP
          "Cancela"
     bt-ajuda AT ROW 7.38 COL 78.72
     rt-button AT ROW 7.21 COL 2.57
...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW w-incmdp ASSIGN
         HIDDEN             = YES
         TITLE              = "Inclui/Modifica Parƒmetros UEP Estab"
         HEIGHT             = 7.83
         WIDTH              = 90
         MAX-HEIGHT         = 41.33
         MAX-WIDTH          = 274.29
...
ON END-ERROR OF w-incmdp /* Inclui/Modifica Parƒmetros UEP Estab */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL w-incmdp w-incmdp
ON WINDOW-CLOSE OF w-incmdp /* Inclui/Modifica Parƒmetros UEP Estab */
DO:
...
DO:
{include/okpai.i h_escdp124-v01}
END.
...
DO:
{include/salvapai.i h_escdp124-v01}
 END.
...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN set-position IN h_escdp124-v01 ( 1.25 , 2.00 ) NO-ERROR.
       ...
       RUN set-position IN h_escdp124-q01 ( 7.13 , 56.57 ) NO-ERROR.
       ...
       RUN add-link IN adm-broker-hdl ( THIS-PROCEDURE , 'TABLEIO':U , h_escdp124-v01 ).
...
------------------------------------------------------------------------------*/
  ...
  {utp/ut9000.i "ESCDP124A" "1.00.00.000"}
...
/*------------------------------------------------------------------------------
  ...
  Notes:       
------------------------------------------------------------------------------*/
  RUN pi-reposiciona-query IN h_escdp124-q01 (INPUT v-row-table).
