...
*******************************************************************************/
{include/i-prgvrs.i ESCDP022 2.00.00.000}

CREATE WIDGET-POOL.

/* Preprocessors Definitions ---                                      */
&GLOBAL-DEFINE Program        ESCDP022
...
DO  ON ERROR UNDO, RETURN ERROR
    ...
    ASSIGN tt-param.arq-destino = LC(tt-param.arq-destino).
    ...
    {report/imrun.i esp/cdp/escdp022rp.p}
