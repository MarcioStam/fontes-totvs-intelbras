...
RUN set-attribute-list (
    'Keys-Accepted = ,
     Keys-Supplied = "fm-codigo,it-codigo,class-fiscal,cod-comprado,cod-estabel,fm-cod-com,cod-produto,ge-codigo,cod-tax,cod-servico,cd-tag,nr-linha,cd-planejado,cod-refer,un,nat-despesa,cod-pulmao,cod-unid-negoc"':U).
