...
*******************************************************************************/
{include/i-prgvrs.i ESCDP087Z 2.00.00.000}
...
&GLOBAL-DEFINE Program           ESCDP087Z
...
&GLOBAL-DEFINE FieldsRangePage1  mgesp.int-portaria-item.it-codigo,mgesp.int-portaria-item.cod-estabel
&GLOBAL-DEFINE FieldsAnyKeyPage1 NO,NO

&GLOBAL-DEFINE ttTable1          tt-int-portaria-item
&GLOBAL-DEFINE hDBOTable1        h-int-portaria-item
&GLOBAL-DEFINE DBOTable1         hint-portaria-item
...
&Scoped-define INTERNAL-TABLES tt-int-portaria-item

/* Definitions for BROWSE brTable1                                      */
&Scoped-define FIELDS-IN-QUERY-brTable1 tt-int-portaria-item.it-codigo ~
tt-int-portaria-item.cod-estabel tt-int-portaria-item.classifica-atual ~
tt-int-portaria-item.desc-mctic tt-int-portaria-item.desc-nf 
&Scoped-define ENABLED-FIELDS-IN-QUERY-brTable1 
&Scoped-define QUERY-STRING-brTable1 FOR EACH tt-int-portaria-item NO-LOCK
&Scoped-define OPEN-QUERY-brTable1 OPEN QUERY brTable1 FOR EACH tt-int-portaria-item NO-LOCK.
&Scoped-define TABLES-IN-QUERY-brTable1 tt-int-portaria-item
&Scoped-define FIRST-TABLE-IN-QUERY-brTable1 tt-int-portaria-item
...
DEFINE QUERY brTable1 FOR 
      tt-int-portaria-item SCROLLING.
&ANALYZE-RESUME
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS brTable1 wZoom _STRUCTURED
  QUERY brTable1 NO-LOCK DISPLAY
      tt-int-portaria-item.it-codigo FORMAT "x(16)":U WIDTH 10.43
      tt-int-portaria-item.cod-estabel COLUMN-LABEL "Estab" FORMAT "x(3)":U
            WIDTH 6.43
      tt-int-portaria-item.classifica-atual COLUMN-LABEL "Classif. Atual" FORMAT "x(8)":U
            WIDTH 14.43
      tt-int-portaria-item.desc-mctic FORMAT "x(200)":U WIDTH 24.43
      tt-int-portaria-item.desc-nf FORMAT "x(200)":U WIDTH 20
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
...
/* Query rebuild information for BROWSE brTable1
     _TblList          = "Temp-Tables.tt-int-portaria-item"
     _Options          = "NO-LOCK"
     _FldNameList[1]   > Temp-Tables.tt-int-portaria-item.it-codigo
"tt-int-portaria-item.it-codigo" ? ? "character" ? ? ? ? ? ? no ? no no "10.43" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[2]   > Temp-Tables.tt-int-portaria-item.cod-estabel
"tt-int-portaria-item.cod-estabel" "Estab" ? "character" ? ? ? ? ? ? no ? no no "6.43" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[3]   > Temp-Tables.tt-int-portaria-item.classifica-atual
"tt-int-portaria-item.classifica-atual" "Classif. Atual" ? "character" ? ? ? ? ? ? no ? no no "14.43" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[4]   > Temp-Tables.tt-int-portaria-item.desc-mctic
"tt-int-portaria-item.desc-mctic" ? ? "character" ? ? ? ? ? ? no ? no no "24.43" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[5]   > Temp-Tables.tt-int-portaria-item.desc-nf
"tt-int-portaria-item.desc-nf" ? ? "character" ? ? ? ? ? ? no ? no no "20" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _Query            is OPENED
*/  /* BROWSE brTable1 */
&ANALYZE-RESUME
...
------------------------------------------------------------------------------*/
    ...
    IF NOT VALID-HANDLE({&hDBOTable1}) OR
       ...
       {&hDBOTable1}:FILE-NAME <> "esbo\boes042.p":U THEN DO:
       
        {btb/btb008za.i1 esbo\boes042.p YES}
        {btb/btb008za.i2 esbo\boes042.p '' {&hDBOTable1}} 
    END.

    RUN setConstraintint-portaria-item IN {&hDBOTable1} (INPUT "", INPUT "ZZZZZZZ",INPUT "", INPUT "ZZZ") NO-ERROR.
...
------------------------------------------------------------------------------*/
    ...
    {zoom/openqueries.i &Query="int-portaria-item"
                        &PageNumber="1"}
...
------------------------------------------------------------------------------*/
    ...
    IF AVAILABLE {&ttTable1} THEN DO:
        CASE pcField:
            ...
            WHEN "seq":U THEN
                ASSIGN pcFieldValue = STRING({&ttTable1}.seq).
        END CASE.
    END.
...
------------------------------------------------------------------------------*/
    ...
    CASE pPageNumber:
        WHEN 1 THEN
            ...
            RUN setConstraintint-portaria-item IN {&hDBOTable1} (INPUT FnIniRangeCharPage(1,1),INPUT FnEndRangeCharPage(1,1), FnIniRangeCharPage(1,2),INPUT FnEndRangeCharPage(1,2)).
