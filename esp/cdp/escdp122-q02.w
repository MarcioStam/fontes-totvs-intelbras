...
*******************************************************************************/
{include/i-prgvrs.i ESCDP122-Q02 1.00.00.000}
...
&IF "{&EMSFND_VERSION}" >= "1.00" &THEN
    {include/i-license-manager.i ESCDP122-Q02 ESP}
&ENDIF
...
&Scoped-define INTERNAL-TABLES int_param_cta_uep

/* Definitions for QUERY Query-Main                                     */
&Scoped-define QUERY-STRING-Query-Main FOR EACH int_param_cta_uep NO-LOCK
&Scoped-define OPEN-QUERY-Query-Main OPEN QUERY Query-Main FOR EACH int_param_cta_uep NO-LOCK.
&Scoped-define TABLES-IN-QUERY-Query-Main int_param_cta_uep
&Scoped-define FIRST-TABLE-IN-QUERY-Query-Main int_param_cta_uep
...
/* Query rebuild information for QUERY Query-Main
     _TblList          = "mgesp.int_param_cta_uep"
     _Options          = "NO-LOCK"
