...
*******************************************************************************/
{include/i-prgvrs.i Z01ES107 2.00.00.000}
...
DEFINE VARIABLE h_b01di107 AS HANDLE NO-UNDO.
...
DEFINE FRAME f-zoom
     bt-implantar AT ROW 15.42 COL 2.14
     bt-ok AT ROW 17 COL 2.29
     bt-cancela AT ROW 17 COL 13.29
     bt-ajuda AT ROW 17 COL 71.86
     rt-button AT ROW 16.75 COL 1.57
...
ON END-ERROR OF w-pesquisa /* Pesquisa de Supervisor */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL w-pesquisa w-pesquisa
ON WINDOW-CLOSE OF w-pesquisa /* Pesquisa de Supervisor */
DO:
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'FOLDER-LABELS = ':U + 'Pesquisa' + ',
                     FOLDER-TAB-TYPE = 1':U ,
             OUTPUT h_folder ).
       RUN set-position IN h_folder ( 1.17 , 1.29 ) NO-ERROR.
       RUN set-size IN h_folder ( 14.08 , 82.00 ) NO-ERROR.
    ...
    WHEN 1 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'esp/cdp/escdp071-b01.w':U ,
             INPUT  FRAME f-zoom:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_b01di107 ).
       RUN set-position IN h_b01di107 ( 2.79 , 2.29 ) NO-ERROR.
       /* Size in UIB:  ( 11.96 , 80.14 ) */

       /* Links to SmartBrowser h_b01di107. */
       RUN add-link IN adm-broker-hdl ( h_b01di107 , 'State':U , THIS-PROCEDURE ).

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_b01di107 ,
             h_folder , 'AFTER':U ).
    END. /* Page 1 */
...
------------------------------------------------------------------------------*/
  ...
  {utp/ut9000.i "Z01ES107" "2.00.00.000"}
