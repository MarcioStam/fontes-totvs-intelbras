...
*******************************************************************************/
{include/i-prgvrs.i ESCDP124-G01 1.00.00.000}
...
&IF "{&EMSFND_VERSION}" >= "1.00" &THEN
    {include/i-license-manager.i ESCDP124-G01 ESP}
&ENDIF
...
&Scoped-Define ENABLED-OBJECTS rt-button c_cod_estab bt-ok bt-cancela ~
bt-ajuda 
&Scoped-Define DISPLAYED-OBJECTS c_cod_estab 
...
DEFINE FRAME d-vapara
     c_cod_estab AT ROW 1.17 COL 30 COLON-ALIGNED WIDGET-ID 2
     bt-ok AT ROW 2.5 COL 2.14
     bt-cancela AT ROW 2.5 COL 13
     bt-ajuda AT ROW 2.5 COL 58
     rt-button AT ROW 2.25 COL 1
     SPACE(0.13) SKIP(0.11)
    WITH VIEW-AS DIALOG-BOX KEEP-TAB-ORDER 
         SIDE-LABELS NO-UNDERLINE THREE-D  SCROLLABLE 
         FONT 1
         TITLE "V  Para Parƒmetro UEP Estab"
...
ON GO OF FRAME d-vapara /* V  Para Parƒmetro UEP Estab */
DO:
FIND int_param_est_uep NO-LOCK
    WHERE int_param_est_uep.cod_estab EQ INPUT FRAME {&FRAME-NAME} c_cod_estab NO-ERROR.

IF NOT AVAILABLE int_param_est_uep THEN DO:
    {utp/ut-table.i mgesp int_param_est_uep 1}
    RUN utp/ut-msgs.p(INPUT "show",
                      INPUT 2,
                      INPUT "Estabelecimento").
    RETURN NO-APPLY.
END.
ASSIGN p-row-tabela = ROWID(int_param_est_uep).
END.
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL d-vapara d-vapara
ON WINDOW-CLOSE OF FRAME d-vapara /* V  Para Parƒmetro UEP Estab */
DO:  
...
------------------------------------------------------------------------------*/
  DISPLAY c_cod_estab 
      WITH FRAME d-vapara.
  ENABLE rt-button c_cod_estab bt-ok bt-cancela bt-ajuda 
      WITH FRAME d-vapara.
  VIEW FRAME d-vapara.
...
------------------------------------------------------------------------------*/
  ...
  {utp/ut9000.i "ESCDP124-G01" "1.00.00.000"}
