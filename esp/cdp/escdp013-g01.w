...
*******************************************************************************/
{include/i-prgvrs.i ESCDP013-G01 1.00.00.001}
...
DEFINE FRAME d-vapara
     c_nat-operacao AT ROW 2.08 COL 24.57 COLON-ALIGNED WIDGET-ID 2
     bt-ok AT ROW 4.5 COL 2.14
     bt-cancela AT ROW 4.5 COL 13
     bt-ajuda AT ROW 4.5 COL 45.14
...
FIND int-natur-oper NO-LOCK
    WHERE int-natur-oper.nat-operacao EQ INPUT FRAME {&FRAME-NAME} c_nat-operacao NO-ERROR.

IF NOT AVAILABLE int-natur-oper THEN DO:
    {utp/ut-table.i mgesp int-natur-oper 1}
    RUN utp/ut-msgs.p(INPUT "show",
                      INPUT 2,
                      INPUT RETURN-VALUE).
    RETURN NO-APPLY.
END.
ASSIGN p-row-tabela = ROWID(int-natur-oper).
END.
...
------------------------------------------------------------------------------*/
  ...
  {utp/ut9000.i "ESCDP013-G01" "1.00.00.001"}
