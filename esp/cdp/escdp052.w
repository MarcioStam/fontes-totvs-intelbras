...
*******************************************************************************/
{include/i-prgvrs.i ESCDP052 1.00.00.000}
...
&IF "{&EMSFND_VERSION}" >= "1.00" &THEN
    {include/i-license-manager.i ESCDP052 1.00.00.000}
&ENDIF

CREATE WIDGET-POOL.

/* Preprocessors Definitions ---                                      */
&GLOBAL-DEFINE Program        ESCDP052
...
DEFINE VARIABLE text-entrada AS CHARACTER FORMAT "X(256)":U INITIAL "Diret¢rio de Sa°da" 
      VIEW-AS TEXT 
     SIZE 14.86 BY .63
     FONT 1 NO-UNDO.
...
DEFINE FRAME fPage4
     cInputFile AT ROW 5.79 COL 22.14 HELP
          "Nome do arquivo de destino do relat¢rio" NO-LABEL
     btInputFile AT ROW 5.79 COL 62.14 HELP
          "Escolha do nome do arquivo"
     text-entrada AT ROW 4.75 COL 23.14 NO-LABEL
     RECT-12 AT ROW 5 COL 21
...
DO:
    ...
    SYSTEM-DIALOG GET-DIR cINputFile
       INITIAL-DIR "spool":U 
       UPDATE l-ok.
    if  l-ok = yes then do:
        assign cINputFile = replace(cINputFile, "~\":U, "/":U).
...
do on error undo, return error on stop  undo, return error:
    ...
    assign tt-param.usuario         = c-seg-usuario
           ...
           tt-param.dir-xml         = INPUT FRAME fPage4 cInputFile
           .
    ...
    {report/rprun.i esp/cdp/escdp052rp.p}
