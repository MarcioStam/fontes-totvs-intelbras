...
*******************************************************************************/
{include/i-prgvrs.i escdp031d 1.12.00.001}
...
&IF "{&EMSFND_VERSION}" >= "1.00" &THEN
    {include/i-license-manager.i escdp031d cdp}
&ENDIF

CREATE WIDGET-POOL.

/* Preprocessors Definitions ---                                      */
&GLOBAL-DEFINE Program        escdp031d
...
DEF INPUT PARAM p-cod-unid-comerc AS INTEGER NO-UNDO.
DEF INPUT PARAM p-desc-unid-comerc AS CHAR FORMAT "x(40)" NO-UNDO.
DEF INPUT PARAM h-escdp031-chamador AS HANDLE NO-UNDO.
...
DEFINE VARIABLE fi-unid-comerc AS INTEGER FORMAT ">>>>>>9":U INITIAL 0 
...
DEFINE FRAME fPage4
     fi-unid-comerc AT ROW 2.75 COL 19 COLON-ALIGNED WIDGET-ID 2
     fi-desc AT ROW 2.75 COL 25.72 COLON-ALIGNED NO-LABEL WIDGET-ID 12
     " Elimina‡Æo Desconto por Produto, por Unidade Neg¢cio X Grupo Cliente X Categoria" VIEW-AS TEXT
          SIZE 58.72 BY .54 AT ROW 1.5 COL 14.72 WIDGET-ID 14
     RECT-13 AT ROW 1.75 COL 5 WIDGET-ID 16
...
ON CHOOSE OF btOK IN FRAME fpage0 /* Elimina */
DO:
...
ASSIGN fi-unid-comerc:SCREEN-VALUE IN FRAME fpage4 = string(p-cod-unid-comerc)
       fi-desc:SCREEN-VALUE IN FRAME fpage4       = p-desc-unid-comerc.
...
do on error undo, return error on stop  undo, return error:
    ...
    assign tt-param.usuario         = c-seg-usuario
           ...
           tt-param.cd-unid-comerc  = input frame fPage4 fi-unid-comerc
           tt-param.c-desc-unid-com = INPUT FRAME fpage4 fi-desc
    ...
    {report/rprun.i esp/cdp/escdp031d-rp.p}
