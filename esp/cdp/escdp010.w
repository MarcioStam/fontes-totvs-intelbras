...
*******************************************************************************/
{include/i-prgvrs.i escdp010 2.04.00.001}


CREATE WIDGET-POOL.

/* Preprocessors Definitions ---                                      */
&GLOBAL-DEFINE Program        escdp010
...
&GLOBAL-DEFINE ttTable        ttassistente
&GLOBAL-DEFINE hDBOTable      hboassistente
&GLOBAL-DEFINE DBOTable       assistente

&GLOBAL-DEFINE page0KeyFields ttassistente.cod-assistente

&GLOBAL-DEFINE page0Fields    ttassistente.nome ttassistente.e-mail ttassistente.matricula
...
&Scoped-Define ENABLED-FIELDS ttassistente.cod-assistente ttassistente.nome ~
ttassistente.e-mail ttassistente.matricula 
&Scoped-define ENABLED-TABLES ttassistente
&Scoped-define FIRST-ENABLED-TABLE ttassistente
...
&Scoped-Define DISPLAYED-FIELDS ttassistente.cod-assistente ~
ttassistente.nome ttassistente.e-mail ttassistente.matricula 
&Scoped-define DISPLAYED-TABLES ttassistente
&Scoped-define FIRST-DISPLAYED-TABLE ttassistente
...
DEFINE FRAME fpage0
     ...
     btHelp AT ROW 1.13 COL 76 HELP
          "Ajuda"
     ttassistente.cod-assistente AT ROW 3 COL 21 COLON-ALIGNED WIDGET-ID 12
          VIEW-AS FILL-IN 
          SIZE 8.86 BY .79
     ttassistente.nome AT ROW 4.75 COL 21 COLON-ALIGNED WIDGET-ID 14
          VIEW-AS FILL-IN 
          SIZE 58 BY .79
     ttassistente.e-mail AT ROW 5.75 COL 21 COLON-ALIGNED WIDGET-ID 16
          VIEW-AS FILL-IN 
          SIZE 58 BY .79
     ttassistente.matricula AT ROW 6.75 COL 21 COLON-ALIGNED WIDGET-ID 18
          VIEW-AS FILL-IN 
          SIZE 18 BY .79
     rtToolBar AT ROW 1 COL 1
     RECT-44 AT ROW 4.25 COL 1
...
OR CHOOSE OF MENU-ITEM miSearch IN MENU mbMain DO:
    {method/ZoomReposition.i &ProgramZoom="eszoom/z01es478.w"} 
END.
...
------------------------------------------------------------------------------*/
    ...
    DEFINE VAR pcod-assistente LIKE {&ttTable}.cod-assistente NO-UNDO.
    

    DEFINE FRAME fGoToRecord
        /* pcd-oper        AT ROW 1.21 COL 17.72 COLON-ALIGNED VIEW-AS FILL-IN SIZE 3 BY .88 */
        pcod-assistente AT ROW 1.31 COL 17.72 COLON-ALIGNED VIEW-AS FILL-IN SIZE 4  BY .88
    ...
    ON "CHOOSE":U OF btGoToOK IN FRAME fGoToRecord DO:
        ASSIGN pcod-assistente.
        
        RUN goToKey IN {&hDBOTable} (INPUT pcod-assistente).
        IF RETURN-VALUE = "NOK":U THEN DO:
            RUN utp/ut-msgs.p (INPUT "SHOW":U, INPUT 2, INPUT "assistente":U).            
            RETURN NO-APPLY.
        END.
...
------------------------------------------------------------------------------*/
    ...
    IF NOT VALID-HANDLE({&hDBOTable}) OR
       ...
       {&hDBOTable}:FILE-NAME <> "boes478.p":U THEN DO:
        {btb/btb008za.i1 esbo\boes478.p YES}
        {btb/btb008za.i2 esbo\boes478.p '' {&hDBOTable}}
    END.
