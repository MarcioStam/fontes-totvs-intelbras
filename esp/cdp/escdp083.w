...
DEFINE TEMP-TABLE tt-item-cest NO-UNDO
    FIELD cod-item       LIKE sit-tribut-relacto.cod-item
    FIELD cdn-sit-tribut LIKE sit-tribut-relacto.cdn-sit-tribut FORMAT "99,999,99".
...
&Scoped-define INTERNAL-TABLES tt-item-cest

/* Definitions for BROWSE br-item                                       */
&Scoped-define FIELDS-IN-QUERY-br-item tt-item-cest.cdn-sit-tribut   
&Scoped-define ENABLED-FIELDS-IN-QUERY-br-item   
&Scoped-define SELF-NAME br-item
&Scoped-define QUERY-STRING-br-item FOR EACH tt-item-cest
&Scoped-define OPEN-QUERY-br-item OPEN QUERY {&SELF-NAME} FOR EACH tt-item-cest.
&Scoped-define TABLES-IN-QUERY-br-item tt-item-cest
&Scoped-define FIRST-TABLE-IN-QUERY-br-item tt-item-cest
...
&Scoped-Define ENABLED-OBJECTS rt-button RECT-1 RECT-2 bt-confirma ~
c-it-codigo br-item bt-ok bt-cancela bt-ajuda 
...
DEFINE VARIABLE c-desc-item AS CHARACTER FORMAT "X(80)":U 
     VIEW-AS FILL-IN 
...
DEFINE QUERY br-item FOR 
      tt-item-cest SCROLLING.
&ANALYZE-RESUME

/* Browse definitions                                                   */
DEFINE BROWSE br-item
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br-item w-cadsim _FREEFORM
  QUERY br-item DISPLAY
      tt-item-cest.cdn-sit-tribut FORMAT "9999999"
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ROW-MARKERS SEPARATORS SIZE 76 BY 7.5
         FONT 7 ROW-HEIGHT-CHARS .46 FIT-LAST-COLUMN.


/* ************************  Frame Definitions  *********************** */

DEFINE FRAME f-cad
     bt-confirma AT ROW 1.71 COL 72 WIDGET-ID 10
     c-it-codigo AT ROW 1.75 COL 7 COLON-ALIGNED WIDGET-ID 2
     c-desc-item AT ROW 1.75 COL 21.14 COLON-ALIGNED NO-LABEL WIDGET-ID 6
     br-item AT ROW 3.75 COL 3 WIDGET-ID 200
     ...
     RECT-2 AT ROW 3.5 COL 2 WIDGET-ID 8
...
/* Query rebuild information for BROWSE br-item
     _START_FREEFORM
OPEN QUERY {&SELF-NAME} FOR EACH tt-item-cest.
     _END_FREEFORM
     _Query            is OPENED
*/  /* BROWSE br-item */
&ANALYZE-RESUME
...
DO:
    FIND FIRST ITEM NO-LOCK
         WHERE ITEM.it-codigo = INPUT FRAME f-cad c-it-codigo NO-ERROR.
...
------------------------------------------------------------------------------*/
  ...
  ENABLE rt-button RECT-1 RECT-2 bt-confirma c-it-codigo br-item bt-ok 
         bt-cancela bt-ajuda 
      WITH FRAME f-cad IN WINDOW w-cadsim.
...
------------------------------------------------------------------------------*/
  ...
  {utp/ut9000.i "ESCDP083" "2.00.00.000"}
...
/*------------------------------------------------------------------------------
  ...
  Notes:       
------------------------------------------------------------------------------*/
EMPTY TEMP-TABLE tt-item-cest.

FOR EACH sit-tribut-relacto 
   WHERE sit-tribut-relacto.cod-item = INPUT FRAME f-cad c-it-codigo NO-LOCK:

    IF NOT CAN-FIND (FIRST tt-item-cest
                     WHERE tt-item-cest.cdn-sit-tribut = sit-tribut-relacto.cdn-sit-tribut) THEN DO:
    
        CREATE tt-item-cest.
        ASSIGN tt-item-cest.cod-item       = sit-tribut-relacto.cod-item
               tt-item-cest.cdn-sit-tribut = sit-tribut-relacto.cdn-sit-tribut.
    END.
...
------------------------------------------------------------------------------*/
  ...
  {src/adm/template/snd-list.i "tt-item-cest"}
