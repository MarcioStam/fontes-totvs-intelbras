...
DEFINE TEMP-TABLE ttgerente NO-UNDO LIKE gerente
...
*******************************************************************************/
{include/i-prgvrs.i escdp011 2.04.00.001}


CREATE WIDGET-POOL.

/* Preprocessors Definitions ---                                      */
&GLOBAL-DEFINE Program        escdp011
...
&GLOBAL-DEFINE ttTable        ttgerente
&GLOBAL-DEFINE hDBOTable      hbogerente
&GLOBAL-DEFINE DBOTable       gerente

&GLOBAL-DEFINE page0KeyFields ttgerente.cod-gerente
...
&Scoped-Define ENABLED-FIELDS ttgerente.cod-gerente ttgerente.nome ~
ttgerente.e-mail ttgerente.matricula 
&Scoped-define ENABLED-TABLES ttgerente
&Scoped-define FIRST-ENABLED-TABLE ttgerente
&Scoped-Define ENABLED-OBJECTS rtToolBar RECT-44 RECT-45 btFirst btPrev ~
...
&Scoped-Define DISPLAYED-FIELDS ttgerente.cod-gerente ttgerente.nome ~
ttgerente.e-mail ttgerente.matricula 
&Scoped-define DISPLAYED-TABLES ttgerente
&Scoped-define FIRST-DISPLAYED-TABLE ttgerente
...
DEFINE FRAME fpage0
     ...
     btHelp AT ROW 1.13 COL 76 HELP
          "Ajuda"
     ttgerente.cod-gerente AT ROW 3 COL 19 COLON-ALIGNED WIDGET-ID 24
          VIEW-AS FILL-IN 
          SIZE 8.86 BY .79
     ttgerente.nome AT ROW 4.75 COL 19 COLON-ALIGNED WIDGET-ID 26
          VIEW-AS FILL-IN 
          SIZE 60 BY .79
     ttgerente.e-mail AT ROW 5.75 COL 19 COLON-ALIGNED WIDGET-ID 28
          VIEW-AS FILL-IN 
          SIZE 60 BY .79
     ttgerente.matricula AT ROW 6.75 COL 19 COLON-ALIGNED WIDGET-ID 30
          VIEW-AS FILL-IN 
          SIZE 14 BY .79
     rtToolBar AT ROW 1 COL 1
     RECT-44 AT ROW 3.75 COL 1
...
/* Settings for THIS-PROCEDURE
   ...
   Temp-Tables and Buffers:
      TABLE: ttgerente T "?" NO-UNDO mgesp gerente
      ADDITIONAL-FIELDS:
          field r-rowid as rowid
      END-FIELDS.
   END-TABLES.
...
OR CHOOSE OF MENU-ITEM miSave IN MENU mbMain DO:
     ...
     FIND FIRST usuar_mestre
        where usuar_mestre.cod_usuar = ttgerente.matricula:SCREEN-VALUE in frame fpage0 no-lock no-error.
            If not Available(usuar_mestre) then do:                            
                 ASSIGN ttgerente.matricula:screen-value in frame fpage0 = "".
                 MESSAGE "Matricula inv lida."
                     VIEW-AS ALERT-BOX INFO BUTTONS OK.
                 Apply "entry" to ttgerente.matricula.
                 RETURN NO-APPLY.
            End.
            ELSE DO:
...
OR CHOOSE OF MENU-ITEM miSearch IN MENU mbMain DO:
    {method/ZoomReposition.i &ProgramZoom="eszoom/z01es382.w"} 
END.
...
&Scoped-define SELF-NAME ttgerente.matricula
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL ttgerente.matricula wMaintenance
ON LEAVE OF ttgerente.matricula IN FRAME fpage0 /* Matricula */
DO:
   FIND FIRST usuar_mestre 
        where usuar_mestre.cod_usuar = ttgerente.matricula:SCREEN-VALUE in frame fpage0 no-lock no-error.
            If not Available(usuar_mestre) then do:                            
...
------------------------------------------------------------------------------*/
    ...
    DEFINE VAR pcod-gerente LIKE {&ttTable}.cod-gerente NO-UNDO.
    

    DEFINE FRAME fGoToRecord
        /* pcd-oper        AT ROW 1.21 COL 17.72 COLON-ALIGNED VIEW-AS FILL-IN SIZE 3 BY .88 */
        pcod-gerente AT ROW 1.31 COL 17.72 COLON-ALIGNED VIEW-AS FILL-IN SIZE 4  BY .88
    ...
    ON "CHOOSE":U OF btGoToOK IN FRAME fGoToRecord DO:
        ...
        RUN goToKey IN {&hDBOTable} (INPUT pcod-gerente).
        IF RETURN-VALUE = "NOK":U THEN DO:
            RUN utp/ut-msgs.p (INPUT "SHOW":U, INPUT 2, INPUT "gerente":U).            
            RETURN NO-APPLY.
        END.
...
------------------------------------------------------------------------------*/
    ...
    IF NOT VALID-HANDLE({&hDBOTable}) OR
       ...
       {&hDBOTable}:FILE-NAME <> "boes382.p":U THEN DO:
        {btb/btb008za.i1 esbo\boes382.p YES}
        {btb/btb008za.i2 esbo\boes382.p '' {&hDBOTable}}
    END.
