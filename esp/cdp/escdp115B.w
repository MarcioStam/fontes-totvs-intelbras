...
DEFINE VARIABLE h_escdp115-q02 AS HANDLE NO-UNDO.
DEFINE VARIABLE h_escdp115-v02 AS HANDLE NO-UNDO.
...
DEFINE FRAME f-cad
     bt-ok AT ROW 10.92 COL 3 HELP
          "Salva e sai"
     bt-save AT ROW 10.92 COL 13.43 HELP
          "Salva e cria novo"
     bt-cancela AT ROW 10.92 COL 24 HELP
          "Cancela"
     bt-ajuda AT ROW 10.92 COL 68.43
     rt-button AT ROW 10.75 COL 2
...
DO:
{include/okfil.i h_escdp115-v02}
END.
...
DO:
{include/salvafil.i h_escdp115-v02}
END.
...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN set-size IN h_folder ( 8.96 , 78.00 ) NO-ERROR.

       RUN init-object IN THIS-PROCEDURE (
             INPUT  'esp/cdp/escdp115-v02.w':U ,
             INPUT  FRAME f-cad:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_escdp115-v02 ).
       RUN set-position IN h_escdp115-v02 ( 3.25 , 4.00 ) NO-ERROR.
       /* Size in UIB:  ( 5.25 , 70.00 ) */

       RUN init-object IN THIS-PROCEDURE (
             INPUT  'esp/cdp/escdp115-q02.w':U ,
             INPUT  FRAME f-cad:HANDLE ,
             INPUT  '':U ,
             OUTPUT h_escdp115-q02 ).
       RUN set-position IN h_escdp115-q02 ( 1.00 , 38.00 ) NO-ERROR.
       /* Size in UIB:  ( 1.63 , 7.72 ) */

       /* Links to SmartFolder h_folder. */
       RUN add-link IN adm-broker-hdl ( h_folder , 'Page':U , THIS-PROCEDURE ).

       /* Links to SmartViewer h_escdp115-v02. */
       RUN add-link IN adm-broker-hdl ( h_escdp115-q02 , 'Record':U , h_escdp115-v02 ).
       RUN add-link IN adm-broker-hdl ( THIS-PROCEDURE , 'TableIO':U , h_escdp115-v02 ).

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_folder ,
             bt-ok:HANDLE IN FRAME f-cad , 'BEFORE':U ).
       RUN adjust-tab-order IN adm-broker-hdl ( h_escdp115-v02 ,
             h_folder , 'AFTER':U ).
    END. /* Page 0 */
...
------------------------------------------------------------------------------*/
  ...
  {utp/ut9000.i "ESCDP115B" "2.00.00.001"}

  /* Dispatch standard ADM method.                             */
  RUN dispatch IN THIS-PROCEDURE ( INPUT 'initialize':U ) .

  run pi-atualiza-parent in h_escdp115-v02 (input v-row-parent).
...
/*------------------------------------------------------------------------------
  ...
  Notes:       
------------------------------------------------------------------------------*/
  RUN pi-reposiciona-query IN h_escdp115-q02 (input v-row-table).
