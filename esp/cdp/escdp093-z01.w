...
*******************************************************************************/
{include/i-prgvrs.i ESCDP093-Z01 1.00.00.001}
...
DEFINE VARIABLE h_escdp093-b01 AS HANDLE NO-UNDO.
...
DEFINE FRAME f-zoom
     bt-implantar AT ROW 10.75 COL 1
     bt-ok AT ROW 12.38 COL 2.14
     bt-cancela AT ROW 12.38 COL 13.14
     bt-ajuda AT ROW 12.38 COL 69.14
     rt-button AT ROW 12.13 COL 1.14
  ...
  CASE adm-current-page: 
    ...
    WHEN 1 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'esp/cdp/escdp093-b01.w':U ,
             INPUT  FRAME f-zoom:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_escdp093-b01 ).
       RUN set-position IN h_escdp093-b01 ( 1.00 , 1.00 ) NO-ERROR.
       /* Size in UIB:  ( 9.75 , 80.14 ) */

       /* Links to SmartBrowser h_escdp093-b01. */
       RUN add-link IN adm-broker-hdl ( h_escdp093-b01 , 'State':U , THIS-PROCEDURE ).

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_escdp093-b01 ,
...
------------------------------------------------------------------------------*/
  ...
  {utp/ut9000.i "ESCDP093-Z01" "1.00.00.001"}
