...
*******************************************************************************/
{include/i-prgvrs.i escdp049 2.04.00.001}

CREATE WIDGET-POOL.

/* Preprocessors Definitions ---                                      */
&GLOBAL-DEFINE Program        escdp049
...
&GLOBAL-DEFINE page0Widgets   btOk ~
                              btCancel ~
                              btHelp2
&GLOBAL-DEFINE page2Widgets   fi-ini-it-codigo fi-fim-it-codigo ~
                              fi-fm-codigo-ini fi-fm-codigo-fim i-faturavel i-lei-informatica ~
                              fl-fm-cod-ini fl-fm-cod-fim fl-classi-fiscal-ini fl-classi-fiscal-fim tg-narrativa
...
DEFINE VARIABLE fl-classi-fiscal-fim AS CHARACTER FORMAT "X(256)":U INITIAL "ZZZZZZZZZZZZZZZZZ" 
     VIEW-AS FILL-IN 
     SIZE 13 BY .88 NO-UNDO.

DEFINE VARIABLE fl-classi-fiscal-ini AS CHARACTER FORMAT "X(256)":U 
     LABEL "Classificaá∆o Fiscal" 
     VIEW-AS FILL-IN 
     SIZE 11 BY .88 NO-UNDO.

DEFINE VARIABLE fl-fm-cod-fim AS CHARACTER FORMAT "X(8)":U INITIAL "ZZZZZZZZZZZZZZZZZZZZZZZZZZ" 
     VIEW-AS FILL-IN 
     SIZE 13 BY .88 NO-UNDO.

DEFINE VARIABLE fl-fm-cod-ini AS CHARACTER FORMAT "X(8)":U 
...
DEFINE VARIABLE i-faturavel AS INTEGER 
...
DEFINE VARIABLE i-lei-informatica AS INTEGER 
     VIEW-AS RADIO-SET HORIZONTAL
     RADIO-BUTTONS 
          "Lei de Informatica", 1,
"N∆o Ç Lei de Informatica", 2,
"Ambos", 3
...
DEFINE VARIABLE tg-narrativa AS LOGICAL INITIAL no 
...
DEFINE FRAME fPage2
     fi-ini-it-codigo AT ROW 2.25 COL 24 COLON-ALIGNED WIDGET-ID 20
     fi-fim-it-codigo AT ROW 2.25 COL 53 COLON-ALIGNED NO-LABEL WIDGET-ID 22
     fi-fm-codigo-ini AT ROW 3.25 COL 24 COLON-ALIGNED WIDGET-ID 26
     fi-fm-codigo-fim AT ROW 3.25 COL 53 COLON-ALIGNED NO-LABEL WIDGET-ID 24
     fl-fm-cod-ini AT ROW 4.25 COL 24 COLON-ALIGNED WIDGET-ID 56
     fl-fm-cod-fim AT ROW 4.25 COL 53 COLON-ALIGNED NO-LABEL WIDGET-ID 60
     fl-classi-fiscal-ini AT ROW 5.25 COL 24 COLON-ALIGNED WIDGET-ID 64
     fl-classi-fiscal-fim AT ROW 5.25 COL 53 COLON-ALIGNED NO-LABEL WIDGET-ID 68
     i-lei-informatica AT ROW 7.75 COL 8 NO-LABEL WIDGET-ID 50
     tg-narrativa AT ROW 7.75 COL 61 HELP
          "Mostra narrativa do item." WIDGET-ID 72
     i-faturavel AT ROW 9.75 COL 24 NO-LABEL WIDGET-ID 46
     RECT-10 AT ROW 1 COL 3
     RECT-11 AT ROW 9.5 COL 3
     IMAGE-11 AT ROW 2.25 COL 52 WIDGET-ID 6
     IMAGE-12 AT ROW 2.25 COL 38 WIDGET-ID 8
     IMAGE-15 AT ROW 3.25 COL 52 WIDGET-ID 28
     IMAGE-16 AT ROW 3.25 COL 38 WIDGET-ID 30
     RECT-12 AT ROW 7.5 COL 3 WIDGET-ID 54
     IMAGE-17 AT ROW 4.25 COL 38 WIDGET-ID 58
     IMAGE-18 AT ROW 4.25 COL 52 WIDGET-ID 62
     IMAGE-19 AT ROW 5.25 COL 38 WIDGET-ID 66
     IMAGE-20 AT ROW 5.25 COL 52 WIDGET-ID 70
...
do on error undo, return error on stop  undo, return error:
    ...
    assign tt-param.usuario          = c-seg-usuario
           ...
           tt-param.faturavel            = INPUT FRAME fpage2 i-faturavel
           tt-param.lei-informatica      = INPUT FRAME fpage2 i-lei-informatica
           tt-param.familia-cod-ini      = INPUT FRAME fpage2 fl-fm-cod-ini
           tt-param.familia-cod-fim      = INPUT FRAME fpage2 fl-fm-cod-fim
           tt-param.classi-fiscal-ini    = INPUT FRAME fpage2 fl-classi-fiscal-ini
           tt-param.classi-fiscal-fim    = INPUT FRAME fpage2 fl-classi-fiscal-fim
           tt-param.narrativa            = INPUT FRAME fpage2 tg-narrativa.
    ...
    {report/rprun.i esp/cdp/escdp049rp.p}
