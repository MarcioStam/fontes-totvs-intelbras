...
*******************************************************************************/
{include/i-prgvrs.i ESCDP098a 2.00.00.000}

CREATE WIDGET-POOL.

/* Preprocessors Definitions ---                                      */
&GLOBAL-DEFINE Program        ESCDP098a
...
DEFINE BUFFER bf-int-logistica-ecommerce FOR int-logistica-ecommerce.
...
DO:
    ...
    FOR EACH bf-int-logistica-ecommerce NO-LOCK
        WHERE bf-int-logistica-ecommerce.cod-trans     >= INPUT FRAME fPage2 iTransIni 
          AND bf-int-logistica-ecommerce.cod-trans     <= INPUT FRAME fPage2 iTransFim
          AND bf-int-logistica-ecommerce.cod-estabel   >= INPUT FRAME fPage2 cEstabOrigemIni 
          AND bf-int-logistica-ecommerce.cod-estabel   <= INPUT FRAME fPage2 cEstabOrigemFim 
          AND bf-int-logistica-ecommerce.estado        >= INPUT FRAME fPage2 cEstadoIni 
          AND bf-int-logistica-ecommerce.estado        <= INPUT FRAME fPage2 cEstadoFim 
          AND bf-int-logistica-ecommerce.cidade        >= INPUT FRAME fPage2 cCidadeIni
          AND bf-int-logistica-ecommerce.cidade        <= INPUT FRAME fPage2 cCidadeFim 
          AND bf-int-logistica-ecommerce.cep-inicial   >= INPUT FRAME fPage2 cCepInicial
          AND bf-int-logistica-ecommerce.cep-final     <= INPUT FRAME fPage2 cCepFinal:

        CREATE tt-digita.
        BUFFER-COPY bf-int-logistica-ecommerce TO tt-digita.
...
do on error undo, return error on stop  undo, return error:
    ...
    {report/rprun.i esp/cdp/escdp098arp.p}
