...
*******************************************************************************/
{include/i-prgvrs.i ESCDP034 2.00.00.001}

CREATE WIDGET-POOL.

/* Preprocessors Definitions ---                                      */
&GLOBAL-DEFINE Program        ESCDP034
...
&Scoped-define INTERNAL-TABLES crm-desc-ped-prog

/* Definitions for BROWSE brSon                                         */
&Scoped-define FIELDS-IN-QUERY-brSon ~
fnDsGrCli(crm-desc-ped-prog.cod-gr-cli) @ c-ds-gr-cli ~
fnDsCategoria(crm-desc-ped-prog.cd-categoria) @ c-ds-categoria ~
crm-desc-ped-prog.fm-cod-com crm-desc-ped-prog.dt-vigencia-ini ~
crm-desc-ped-prog.dt-vigencia-fim crm-desc-ped-prog.pc-desconto 
&Scoped-define ENABLED-FIELDS-IN-QUERY-brSon 
&Scoped-define QUERY-STRING-brSon FOR EACH crm-desc-ped-prog ~
      WHERE crm-desc-ped-prog.cd-unid-negoc = INPUT FRAME fPage0 tt-unid-comerc.cd-unid-comerc NO-LOCK
&Scoped-define OPEN-QUERY-brSon OPEN QUERY brSon FOR EACH crm-desc-ped-prog ~
      WHERE crm-desc-ped-prog.cd-unid-negoc = INPUT FRAME fPage0 tt-unid-comerc.cd-unid-comerc NO-LOCK.
&Scoped-define TABLES-IN-QUERY-brSon crm-desc-ped-prog
&Scoped-define FIRST-TABLE-IN-QUERY-brSon crm-desc-ped-prog
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS brSon wMaintenance _STRUCTURED
  QUERY brSon NO-LOCK DISPLAY
      fnDsGrCli(crm-desc-ped-prog.cod-gr-cli) @ c-ds-gr-cli COLUMN-LABEL "Gr Cli" FORMAT "x(30)":U
            WIDTH 18.43
      fnDsCategoria(crm-desc-ped-prog.cd-categoria) @ c-ds-categoria COLUMN-LABEL "Categoria" FORMAT "x(30)":U
            WIDTH 18.43
      crm-desc-ped-prog.fm-cod-com FORMAT "x(8)":U WIDTH 19.43
      crm-desc-ped-prog.dt-vigencia-ini FORMAT "99/99/9999":U WIDTH 15.43
      crm-desc-ped-prog.dt-vigencia-fim FORMAT "99/99/9999":U WIDTH 14.43
      crm-desc-ped-prog.pc-desconto COLUMN-LABEL "% Desc Max" FORMAT ">>9.99":U
            WIDTH 10.43
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
...
DEFINE FRAME fPage0
     btFirst AT ROW 1.13 COL 1.57 HELP
          "Primeira ocorrˆncia" WIDGET-ID 22
     btPrev AT ROW 1.13 COL 5.57 HELP
          "Ocorrˆncia anterior" WIDGET-ID 28
     btNext AT ROW 1.13 COL 9.57 HELP
          "Pr¢xima ocorrˆncia" WIDGET-ID 26
     btLast AT ROW 1.13 COL 13.57 HELP
          "éltima ocorrˆncia" WIDGET-ID 24
...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW wMaintenance ASSIGN
         HIDDEN             = YES
         TITLE              = "Desconto para Pedido Programado"
         HEIGHT             = 17
         WIDTH              = 111
         MAX-HEIGHT         = 27.54
         MAX-WIDTH          = 182.86
...
/* Query rebuild information for BROWSE brSon
     _TblList          = "mgesp.crm-desc-ped-prog"
     _Options          = "NO-LOCK"
     _Where[1]         = "mgesp.crm-desc-ped-prog.cd-unid-negoc = INPUT FRAME fPage0 tt-unid-comerc.cd-unid-comerc"
     _FldNameList[1]   > "_<CALC>"
"fnDsGrCli(crm-desc-ped-prog.cod-gr-cli) @ c-ds-gr-cli" "Gr Cli" "x(30)" ? ? ? ? ? ? ? no ? no no "18.43" yes no no "U" "" ""
     _FldNameList[2]   > "_<CALC>"
"fnDsCategoria(crm-desc-ped-prog.cd-categoria) @ c-ds-categoria" "Categoria" "x(30)" ? ? ? ? ? ? ? no ? no no "18.43" yes no no "U" "" ""
     _FldNameList[3]   > mgesp.crm-desc-ped-prog.fm-cod-com
"crm-desc-ped-prog.fm-cod-com" ? ? "character" ? ? ? ? ? ? no ? no no "19.43" yes no no "U" "" ""
     _FldNameList[4]   > mgesp.crm-desc-ped-prog.dt-vigencia-ini
"crm-desc-ped-prog.dt-vigencia-ini" ? ? "date" ? ? ? ? ? ? no ? no no "15.43" yes no no "U" "" ""
     _FldNameList[5]   > mgesp.crm-desc-ped-prog.dt-vigencia-fim
"crm-desc-ped-prog.dt-vigencia-fim" ? ? "date" ? ? ? ? ? ? no ? no no "14.43" yes no no "U" "" ""
     _FldNameList[6]   > mgesp.crm-desc-ped-prog.pc-desconto
"crm-desc-ped-prog.pc-desconto" "% Desc Max" ? "decimal" ? ? ? ? ? ? no ? no no "10.43" yes no no "U" "" ""
     _Query            is OPENED
*/  /* BROWSE brSon */
&ANALYZE-RESUME
...
ON END-ERROR OF wMaintenance /* Desconto para Pedido Programado */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL wMaintenance wMaintenance
ON WINDOW-CLOSE OF wMaintenance /* Desconto para Pedido Programado */
DO:
...
DO:
    ...
    RUN esp/cdp/escdp034a.w (INPUT "Create":U,
...
DO:
    ...
    RUN esp/cdp/escdp034a.w (INPUT "Copy":U,
                             INPUT tt-unid-comerc.cd-unid-comerc,
                             INPUT IF AVAIL crm-desc-ped-prog THEN ROWID(crm-desc-ped-prog) ELSE ?).
...
DO:
    ...
    IF  RETURN-VALUE = "YES" THEN DO:
        FIND CURRENT crm-desc-ped-prog EXCLUSIVE-LOCK NO-ERROR.
        IF  AVAIL  crm-desc-ped-prog THEN
            DELETE crm-desc-ped-prog.
    END.
...
DO:
    ...
    RUN esp/cdp/escdp034a.w (INPUT "Update":U,
                             INPUT tt-unid-comerc.cd-unid-comerc,
                             INPUT IF AVAIL crm-desc-ped-prog THEN ROWID(crm-desc-ped-prog) ELSE ?).
...
------------------------------------------------------------------------------*/
    ...
    IF  CAN-FIND(FIRST crm-desc-ped-prog NO-LOCK
                 WHERE crm-desc-ped-prog.cd-unid-negoc = STRING(tt-unid-comerc.cd-unid-comerc)) THEN DO:
        ENABLE btCopySon
               btUpdateSon
               btDeleteSon
            WITH FRAME fPage1.
