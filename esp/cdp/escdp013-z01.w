...
*******************************************************************************/
{include/i-prgvrs.i ESCD013-Z01 1.00.00.001}
...
DEFINE VARIABLE h_escdp013-b01 AS HANDLE NO-UNDO.
...
DEFINE FRAME f-zoom
     bt-implantar AT ROW 12.5 COL 1
     bt-ok AT ROW 14.21 COL 2.43
     bt-cancela AT ROW 14.21 COL 13.43
     bt-ajuda AT ROW 14.21 COL 86.86
  ...
  CASE adm-current-page: 
    ...
    WHEN 1 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'esp/cdp/escdp013-b01.w':U ,
             INPUT  FRAME f-zoom:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_escdp013-b01 ).
       RUN set-position IN h_escdp013-b01 ( 1.00 , 1.00 ) NO-ERROR.
       /* Size in UIB:  ( 11.50 , 98.00 ) */

       /* Links to SmartBrowser h_escdp013-b01. */
       RUN add-link IN adm-broker-hdl ( h_escdp013-b01 , 'State':U , THIS-PROCEDURE ).

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_escdp013-b01 ,
...
------------------------------------------------------------------------------*/
  ...
  {utp/ut9000.i "ESCD013-Z01" "1.00.00.001"}
