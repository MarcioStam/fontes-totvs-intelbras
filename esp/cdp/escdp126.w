...
*******************************************************************************/
{include/i-prgvrs.i ESCDP126 2.12.00.000}
...
&IF "{&EMSFND_VERSION}" >= "1.00" &THEN
    {include/i-license-manager.i ESCDP126 ESP}
&ENDIF
...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW C-Win ASSIGN
         HIDDEN             = YES
         TITLE              = "Eliminaá∆o Gr Maq Patrimìnio x UEP"
         HEIGHT             = 15
         WIDTH              = 81.14
         MAX-HEIGHT         = 36
         MAX-WIDTH          = 219.43
...
ON END-ERROR OF C-Win /* Eliminaá∆o Gr Maq Patrimìnio x UEP */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL C-Win C-Win
ON WINDOW-CLOSE OF C-Win /* Eliminaá∆o Gr Maq Patrimìnio x UEP */
DO:
...
{utp/ut9000.i "ESCDP126" "2.12.00.000"}
...
/*     {include/i-immbl.i} */
    ...
    assign c-arq-layout = search("layout/loescdp126.001")
...
do  on error undo, return error
    ...
    {include/i-imrun.i esp/cdp/escdp126rp.p}
