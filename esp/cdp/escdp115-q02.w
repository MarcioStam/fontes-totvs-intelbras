...
&Scoped-define INTERNAL-TABLES int-segmento-item

/* Definitions for QUERY Query-Main                                     */
&Scoped-define QUERY-STRING-Query-Main FOR EACH int-segmento-item NO-LOCK INDEXED-REPOSITION
&Scoped-define OPEN-QUERY-Query-Main OPEN QUERY Query-Main FOR EACH int-segmento-item NO-LOCK INDEXED-REPOSITION.
&Scoped-define TABLES-IN-QUERY-Query-Main int-segmento-item
&Scoped-define FIRST-TABLE-IN-QUERY-Query-Main int-segmento-item
...
/* Query rebuild information for QUERY Query-Main
     _TblList          = "TMGESP.int-segmento-item"
