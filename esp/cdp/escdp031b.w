...
DEFINE INPUT-OUTPUT PARAMETER p-cod-gr-cli-ini   LIKE crm-desc-prod.cod-gr-cli      NO-UNDO.
DEFINE INPUT-OUTPUT PARAMETER p-cod-gr-cli-fim   LIKE crm-desc-prod.cod-gr-cli      NO-UNDO.
DEFINE INPUT-OUTPUT PARAMETER p-cd-categoria-ini LIKE crm-desc-prod.cd-categoria    NO-UNDO.
DEFINE INPUT-OUTPUT PARAMETER p-cd-categoria-fim LIKE crm-desc-prod.cd-categoria    NO-UNDO.
DEFINE INPUT-OUTPUT PARAMETER p-it-codigo-ini    LIKE crm-desc-prod.it-codigo       NO-UNDO.
DEFINE INPUT-OUTPUT PARAMETER p-it-codigo-fim    LIKE crm-desc-prod.it-codigo       NO-UNDO.
...
IMAGE-17 IMAGE-18 i-cod-gr-cli-ini i-cod-gr-cli-fim i-cd-categoria-ini ~
i-cd-categoria-fim c-it-codigo-ini c-it-codigo-fim btOK btCancel btHelp2 
&Scoped-Define DISPLAYED-OBJECTS i-cod-gr-cli-ini i-cod-gr-cli-fim ~
i-cd-categoria-ini i-cd-categoria-fim c-it-codigo-ini c-it-codigo-fim 
...
DEFINE VARIABLE c-it-codigo-fim AS CHARACTER FORMAT "x(16)" 
     VIEW-AS FILL-IN 
...
DEFINE FRAME fPage0
     i-cod-gr-cli-ini AT ROW 1.5 COL 20 COLON-ALIGNED HELP
     ...
     i-cd-categoria-ini AT ROW 2.5 COL 20 COLON-ALIGNED HELP
     ...
     c-it-codigo-ini AT ROW 3.5 COL 20 COLON-ALIGNED HELP
          "C¢digo Item" WIDGET-ID 24
     c-it-codigo-fim AT ROW 3.5 COL 50.43 COLON-ALIGNED HELP
          "C¢digo Item" NO-LABEL WIDGET-ID 22
     btOK AT ROW 4.96 COL 2
     btCancel AT ROW 4.96 COL 13
     btHelp2 AT ROW 4.96 COL 80
     ...
     IMAGE-17 AT ROW 3.5 COL 41.14 WIDGET-ID 26
     IMAGE-18 AT ROW 3.5 COL 48.43 WIDGET-ID 28
...
DO:
    ASSIGN INPUT FRAME fPage0 i-cod-gr-cli-ini
           ...
           INPUT FRAME fPage0 c-it-codigo-ini
           INPUT FRAME fPage0 c-it-codigo-fim.
    ...
    ASSIGN p-cod-gr-cli-ini   = i-cod-gr-cli-ini
           ...
           p-it-codigo-ini    = c-it-codigo-ini
           p-it-codigo-fim    = c-it-codigo-fim.
