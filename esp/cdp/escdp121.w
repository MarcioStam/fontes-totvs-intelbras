...
*******************************************************************************/
{include/i-prgvrs.i ESCDP121 1.00.00.001}
...
DEFINE VARIABLE dt-emis-ini AS DATE FORMAT "99/99/9999" INITIAL 01/01/00 
     LABEL "Dt Emiss∆o OP" 
     VIEW-AS FILL-IN 
     SIZE 16 BY .88 NO-UNDO.

DEFINE VARIABLE dt-movto-fim AS DATE FORMAT "99/99/9999":U INITIAL 12/31/9999 
     VIEW-AS FILL-IN 
     SIZE 16 BY .88 NO-UNDO.

DEFINE VARIABLE dt-movto-ini AS DATE FORMAT "99/99/9999" INITIAL 01/01/00 
     LABEL "Dt.Movto OP" 
     VIEW-AS FILL-IN 
     SIZE 16 BY .88 NO-UNDO.
...
DEFINE VARIABLE fi-item-fim AS CHARACTER FORMAT "X(16)":U INITIAL "ZZZZZZZZZZZZZZZ" 
     VIEW-AS FILL-IN 
     SIZE 16 BY .88 NO-UNDO.
...
DEFINE VARIABLE fi-op-fim AS INTEGER FORMAT ">>>,>>>,>>9":U INITIAL 99999999 
     VIEW-AS FILL-IN 
     SIZE 16 BY .88 NO-UNDO.

DEFINE VARIABLE fi-op-ini AS INTEGER FORMAT ">>>,>>>,>>9" INITIAL 0 
     LABEL "Ord.Produá∆o" 
     VIEW-AS FILL-IN 
     SIZE 16 BY .88 NO-UNDO.
...
DEFINE VARIABLE fi-reporte-ggf AS INTEGER 
...
DEFINE FRAME f-pg-sel
     fi-estab-ini AT ROW 1.42 COL 24.86 COLON-ALIGNED WIDGET-ID 38
     fi-estab-fim AT ROW 1.42 COL 46 COLON-ALIGNED NO-LABEL WIDGET-ID 36
     fi-item-ini AT ROW 2.42 COL 13.86 COLON-ALIGNED
     fi-item-fim AT ROW 2.42 COL 46 COLON-ALIGNED NO-LABEL
     fi-op-ini AT ROW 3.42 COL 13.86 COLON-ALIGNED HELP
          "N£mero da Ordem de Produá∆o" WIDGET-ID 24
     fi-op-fim AT ROW 3.42 COL 46 COLON-ALIGNED NO-LABEL WIDGET-ID 22
     dt-emis-ini AT ROW 4.42 COL 13.86 COLON-ALIGNED HELP
          "N£mero da Ordem de Produá∆o" WIDGET-ID 54
     dt-emis-fim AT ROW 4.42 COL 46 COLON-ALIGNED NO-LABEL WIDGET-ID 52
     dt-movto-ini AT ROW 5.42 COL 14 COLON-ALIGNED HELP
          "N£mero da Ordem de Produá∆o" WIDGET-ID 62
     dt-movto-fim AT ROW 5.42 COL 48.14 NO-LABEL WIDGET-ID 60
     rs-tipo AT ROW 7.96 COL 13.57 NO-LABEL WIDGET-ID 2
     fi-reporte-ggf AT ROW 7.96 COL 43.29 NO-LABEL WIDGET-ID 44
     "  Buscar" VIEW-AS TEXT
          SIZE 6 BY .67 AT ROW 6.96 COL 13 WIDGET-ID 34
     " Reporte GGF" VIEW-AS TEXT
          SIZE 11 BY .67 AT ROW 6.92 COL 42.72 WIDGET-ID 50
     IMAGE-1 AT ROW 2.42 COL 32
     IMAGE-2 AT ROW 2.42 COL 45.14
     IMAGE-7 AT ROW 3.42 COL 32 WIDGET-ID 26
     IMAGE-8 AT ROW 3.42 COL 45.14 WIDGET-ID 28
     RECT-10 AT ROW 7.21 COL 11 WIDGET-ID 30
     IMAGE-9 AT ROW 1.42 COL 32 WIDGET-ID 40
     IMAGE-10 AT ROW 1.42 COL 45.14 WIDGET-ID 42
     RECT-11 AT ROW 7.21 COL 41.29 WIDGET-ID 48
     IMAGE-11 AT ROW 4.42 COL 32 WIDGET-ID 56
     IMAGE-12 AT ROW 4.42 COL 45.14 WIDGET-ID 58
     IMAGE-13 AT ROW 5.42 COL 32.14 WIDGET-ID 64
     IMAGE-14 AT ROW 5.42 COL 45.29 WIDGET-ID 66
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 3 ROW 2.85
...
/* SETTINGS FOR FRAME f-pg-sel
                                                                        */
/* SETTINGS FOR FILL-IN dt-movto-fim IN FRAME f-pg-sel
   ALIGN-L                                                              */
...
{utp/ut9000.i "ESCDP121" "1.00.00.001"}
...
------------------------------------------------------------------------------*/
  ...
  DISPLAY fi-estab-ini fi-estab-fim fi-item-ini fi-item-fim fi-op-ini fi-op-fim 
          dt-emis-ini dt-emis-fim dt-movto-ini dt-movto-fim rs-tipo 
          fi-reporte-ggf 
      WITH FRAME f-pg-sel IN WINDOW w-relat.
  ENABLE IMAGE-1 IMAGE-2 IMAGE-7 IMAGE-8 RECT-10 IMAGE-9 IMAGE-10 RECT-11 
         IMAGE-11 IMAGE-12 IMAGE-13 IMAGE-14 fi-estab-ini fi-estab-fim 
         fi-item-ini fi-item-fim fi-op-ini fi-op-fim dt-emis-ini dt-emis-fim 
         dt-movto-ini dt-movto-fim rs-tipo fi-reporte-ggf 
      WITH FRAME f-pg-sel IN WINDOW w-relat.
...
do on error undo, return error on stop  undo, return error:
    ...
    assign tt-param.usuario         = c-seg-usuario
           ...
           tt-param.item-ini        = input frame f-pg-sel fi-item-ini 
           tt-param.item-fim        = input frame f-pg-sel fi-item-fim
           tt-param.op-ini          = input frame f-pg-sel fi-op-ini
           tt-param.op-fim          = input frame f-pg-sel fi-op-fim
           tt-param.tipo            = input frame f-pg-sel rs-tipo  
           tt-param.reporte-ggf     = input frame f-pg-sel fi-reporte-ggf

           tt-param.dt-emis-ini     = input frame f-pg-sel dt-emis-ini  
           tt-param.dt-emis-fim     = input frame f-pg-sel dt-emis-fim  
           tt-param.dt-movto-ini    = input frame f-pg-sel dt-movto-ini 
           tt-param.dt-movto-fim    = input frame f-pg-sel dt-movto-fim 
    ...
    {include/i-rprun.i esp/cdp/escdp121rp.p}
