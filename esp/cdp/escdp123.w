...
*******************************************************************************/
{include/i-prgvrs.i escdp123 1.00.00.001}
...
DEFINE VARIABLE c-ncm-fim AS CHARACTER FORMAT "9999.99.99":U INITIAL "99999999" 
     VIEW-AS FILL-IN 
     SIZE 15 BY .88 NO-UNDO.

DEFINE VARIABLE c-ncm-ini AS CHARACTER FORMAT "9999.99.99":U INITIAL "00000000" 
     LABEL "Ncm" 
     VIEW-AS FILL-IN 
     SIZE 15 BY .88 NO-UNDO.
...
DEFINE FRAME f-pg-sel
     c-ncm-ini AT ROW 1.25 COL 15 COLON-ALIGNED
     c-ncm-fim AT ROW 1.25 COL 48.14 COLON-ALIGNED NO-LABEL
     rs-tipo AT ROW 3.46 COL 17 NO-LABEL WIDGET-ID 2
     "Tipo Impress∆o:" VIEW-AS TEXT
          SIZE 11 BY .67 AT ROW 2.5 COL 18 WIDGET-ID 8
     IMAGE-1 AT ROW 1.25 COL 31.86
     IMAGE-2 AT ROW 1.25 COL 47.29
     RECT-10 AT ROW 2.75 COL 16 WIDGET-ID 6
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 3 ROW 2.85
         SIZE 76.86 BY 10.62
...
{utp/ut9000.i "escdp123" "1.00.00.001"}
...
------------------------------------------------------------------------------*/
  ...
  DISPLAY c-ncm-ini c-ncm-fim rs-tipo 
      WITH FRAME f-pg-sel IN WINDOW w-relat.
  ENABLE IMAGE-1 IMAGE-2 RECT-10 c-ncm-ini c-ncm-fim rs-tipo 
      WITH FRAME f-pg-sel IN WINDOW w-relat.
...
do on error undo, return error on stop  undo, return error:
    ...
    */
    ...
    {include/i-rprun.i esp/cdp/escdp123rp.p}
