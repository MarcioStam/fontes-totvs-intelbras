...
*******************************************************************************/
{include/i-prgvrs.i ESCDP038 2.00.00.001}

CREATE WIDGET-POOL.

/* Preprocessors Definitions ---                                      */
&GLOBAL-DEFINE Program        ESCDP038
...
DEFINE FRAME fPage0
     ...
     btHelp AT ROW 1.13 COL 86.72 HELP
          "Ajuda"
     tt-unid-comerc.cd-unid-comerc AT ROW 2.88 COL 24.72 COLON-ALIGNED WIDGET-ID 2
          VIEW-AS FILL-IN 
          SIZE 5 BY .88
     tt-unid-comerc.ds-unid-comerc AT ROW 4.08 COL 24.72 COLON-ALIGNED WIDGET-ID 4
          VIEW-AS FILL-IN 
          SIZE 42.86 BY .88
...
------------------------------------------------------------------------------*/
    ...
    DEFINE FRAME fGoToRecord
        i-cd-unid-comerc  AT ROW 1.21 COL 17.72 COLON-ALIGNED
