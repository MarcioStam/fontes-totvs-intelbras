...
*******************************************************************************/
{include/i-prgvrs.i escdp081 1.00.00.000}
...
&GLOBAL-DEFINE Program          escdp081
&GLOBAL-DEFINE Version          1.00.00.000

&GLOBAL-DEFINE Folder           YES
&GLOBAL-DEFINE InitialPage      1
&GLOBAL-DEFINE FolderLabels     Responsavel
...
&GLOBAL-DEFINE ttSon1           tt-grp-usuar-resp
&GLOBAL-DEFINE hDBOSon1         boes912
&GLOBAL-DEFINE DBOSon1Table     grp-usuar-resp
...
&Scoped-define INTERNAL-TABLES tt-grp-usuar-resp

/* Definitions for BROWSE brSon1                                        */
&Scoped-define FIELDS-IN-QUERY-brSon1 tt-grp-usuar-resp.cod-usuario ~
fnNomeUsuario(tt-grp-usuar-resp.cod-usuario) @ c-nome-usuario 
&Scoped-define ENABLED-FIELDS-IN-QUERY-brSon1 
&Scoped-define QUERY-STRING-brSon1 FOR EACH tt-grp-usuar-resp NO-LOCK
&Scoped-define OPEN-QUERY-brSon1 OPEN QUERY brSon1 FOR EACH tt-grp-usuar-resp NO-LOCK.
&Scoped-define TABLES-IN-QUERY-brSon1 tt-grp-usuar-resp
&Scoped-define FIRST-TABLE-IN-QUERY-brSon1 tt-grp-usuar-resp
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS brSon1 wMasterDetail _STRUCTURED
  QUERY brSon1 NO-LOCK DISPLAY
      tt-grp-usuar-resp.cod-usuario FORMAT "x(12)":U
      fnNomeUsuario(tt-grp-usuar-resp.cod-usuario) @ c-nome-usuario COLUMN-LABEL "Nome Usuario" FORMAT "x(100)":U
            WIDTH 69.29
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
...
DEFINE FRAME fPage0
     ...
     tt-grp_usuar.cod_grp_usuar AT ROW 3.5 COL 29 COLON-ALIGNED WIDGET-ID 2
          VIEW-AS FILL-IN 
          SIZE 4 BY .88
     tt-grp_usuar.des_grp_usuar AT ROW 3.5 COL 34 COLON-ALIGNED NO-LABEL WIDGET-ID 4
          VIEW-AS FILL-IN 
          SIZE 31 BY .88
...
/* Query rebuild information for BROWSE brSon1
     _TblList          = "Temp-Tables.tt-grp-usuar-resp"
     _Options          = "NO-LOCK"
     _TblOptList       = ","
     _FldNameList[1]   = Temp-Tables.tt-grp-usuar-resp.cod-usuario
     _FldNameList[2]   > "_<CALC>"
"fnNomeUsuario(tt-grp-usuar-resp.cod-usuario) @ c-nome-usuario" "Nome Usuario" "x(100)" ? ? ? ? ? ? ? no ? no no "69.29" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _Query            is OPENED
*/  /* BROWSE brSon1 */
&ANALYZE-RESUME
...
DO:
   {masterdetail/addson.i &ProgramSon="esp/cdp/escdp081a.w"
                           &PageNumber="1"}
END.
...
------------------------------------------------------------------------------*/
    ...
    IF NOT VALID-HANDLE({&hDBOSon1}) OR 
       ...
       {&hDBOSon1}:FILE-NAME <> "esbo/boes912.p":U THEN DO:
        {btb/btb008za.i1 esbo/boes912.p YES}
        {btb/btb008za.i2 esbo/boes912.p '' {&hDBOSon1}} 
    END.
...
------------------------------------------------------------------------------*/
    ...
    {masterdetail/openqueriesson.i &Parent="GrpResp"
                                   &Query="GrpResp"
                                   &PageNumber="1"} 
