...
*******************************************************************************/
{include/i-prgvrs.i ESCPD101A 1.00.00.001}
...
DEFINE VARIABLE h_escdp101-q01 AS HANDLE NO-UNDO.
DEFINE VARIABLE h_escdp101-v02 AS HANDLE NO-UNDO.
...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW w-cadsim ASSIGN
         HIDDEN             = YES
         TITLE              = "Inclui/Modifica Desconto-Acr‚scimo Cliente"
         HEIGHT             = 9.75
         WIDTH              = 80.72
         MAX-HEIGHT         = 26.75
         MAX-WIDTH          = 146.29
...
ON END-ERROR OF w-cadsim /* Inclui/Modifica Desconto-Acr‚scimo Cliente */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL w-cadsim w-cadsim
ON WINDOW-CLOSE OF w-cadsim /* Inclui/Modifica Desconto-Acr‚scimo Cliente */
DO:
...
DO:
{include/okfil.i h_escdp101-v02}
END.
...
DO:
{include/salvafil.i h_escdp101-v02}
END.
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'esp/cdp/escdp101-v02.w':U ,
             INPUT  FRAME f-cad:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_escdp101-v02 ).
       RUN set-position IN h_escdp101-v02 ( 1.25 , 1.72 ) NO-ERROR.
       /* Size in UIB:  ( 7.75 , 79.29 ) */

       RUN init-object IN THIS-PROCEDURE (
             INPUT  'esp/cdp/escdp101-q01.w':U ,
             INPUT  FRAME f-cad:HANDLE ,
             INPUT  '':U ,
             OUTPUT h_escdp101-q01 ).
       RUN set-position IN h_escdp101-q01 ( 9.00 , 45.00 ) NO-ERROR.
       /* Size in UIB:  ( 1.63 , 7.72 ) */

       /* Links to SmartViewer h_escdp101-v02. */
       RUN add-link IN adm-broker-hdl ( h_escdp101-q01 , 'Record':U , h_escdp101-v02 ).
       RUN add-link IN adm-broker-hdl ( THIS-PROCEDURE , 'TABLEIO':U , h_escdp101-v02 ).

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_escdp101-v02 ,
...
------------------------------------------------------------------------------*/
  ...
  {utp/ut9000.i "ESCPD101A" "1.00.00.000"}

  /* Dispatch standard ADM method.                             */
  RUN dispatch IN THIS-PROCEDURE ( INPUT 'initialize':U ) .

  run pi-atualiza-parent in h_escdp101-v02 (input v-row-parent).
...
/*------------------------------------------------------------------------------
  ...
  Notes:       
------------------------------------------------------------------------------*/
  RUN pi-reposiciona-query IN h_escdp101-q01 (input v-row-table).
