...
*******************************************************************************/
{include/i-prgvrs.i ESCDP070 2.00.00.000}
...
bt-config-impr c-arquivo rs-execucao text-modelo-rtf 
...
DEFINE VARIABLE c-fim-usuario AS CHARACTER FORMAT "X(12)":U INITIAL "ZZZZZZZZZZZZZ" 
     VIEW-AS FILL-IN 
     SIZE 15 BY .88 NO-UNDO.

DEFINE VARIABLE c-ini-usuario AS CHARACTER FORMAT "X(12)":U 
     LABEL "Usu†rio" 
     VIEW-AS FILL-IN 
     SIZE 15 BY .88 NO-UNDO.
...
DEFINE FRAME f-pg-sel
     c-ini-usuario AT ROW 1.25 COL 15 COLON-ALIGNED
     c-fim-usuario AT ROW 1.25 COL 48.14 COLON-ALIGNED NO-LABEL
...
{utp/ut9000.i "ESCDP070" "2.00.00.000"}
...
------------------------------------------------------------------------------*/
  ...
  DISPLAY c-ini-usuario c-fim-usuario 
      WITH FRAME f-pg-sel IN WINDOW w-relat.
  ENABLE IMAGE-1 IMAGE-2 c-ini-usuario c-fim-usuario 
      WITH FRAME f-pg-sel IN WINDOW w-relat.
  {&OPEN-BROWSERS-IN-QUERY-f-pg-sel}
  DISPLAY rs-destino c-arquivo rs-execucao text-modelo-rtf 
...
do on error undo, return error on stop  undo, return error:
    ...
    assign tt-param.usuario         = c-seg-usuario
           ...
           &endif
           tt-param.cod_usuario_ini = INPUT FRAME f-pg-sel c-ini-usuario
           tt-param.cod_usuario_fim = INPUT FRAME f-pg-sel c-fim-usuario
           .
    ...
    {include/i-rprun.i esp/cdp//escdp070rp.p}
