...
*******************************************************************************/
{include/i-prgvrs.i ESCDP035 2.00.00.001}

CREATE WIDGET-POOL.

/* Preprocessors Definitions ---                                      */
&GLOBAL-DEFINE Program        ESCDP035
...
&Scoped-define INTERNAL-TABLES crm-desc-ped-minimo

/* Definitions for BROWSE brSon                                         */
&Scoped-define FIELDS-IN-QUERY-brSon ~
fnDsGrCli(crm-desc-ped-minimo.cod-gr-cli) @ c-ds-gr-cli ~
fnDsCategoria(crm-desc-ped-minimo.cd-categoria) @ c-ds-categoria ~
crm-desc-ped-minimo.dt-vigencia-ini crm-desc-ped-minimo.dt-vigencia-fim ~
crm-desc-ped-minimo.vl-minimo 
&Scoped-define ENABLED-FIELDS-IN-QUERY-brSon 
&Scoped-define QUERY-STRING-brSon FOR EACH crm-desc-ped-minimo ~
      WHERE crm-desc-ped-minimo.cd-unid-negoc = INPUT FRAME fPage0 tt-unid-comerc.cd-unid-comerc NO-LOCK
&Scoped-define OPEN-QUERY-brSon OPEN QUERY brSon FOR EACH crm-desc-ped-minimo ~
      WHERE crm-desc-ped-minimo.cd-unid-negoc = INPUT FRAME fPage0 tt-unid-comerc.cd-unid-comerc NO-LOCK.
&Scoped-define TABLES-IN-QUERY-brSon crm-desc-ped-minimo
&Scoped-define FIRST-TABLE-IN-QUERY-brSon crm-desc-ped-minimo
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS brSon wMaintenance _STRUCTURED
  QUERY brSon NO-LOCK DISPLAY
      fnDsGrCli(crm-desc-ped-minimo.cod-gr-cli) @ c-ds-gr-cli COLUMN-LABEL "Gr Cli" FORMAT "x(30)":U
            WIDTH 24.43
      fnDsCategoria(crm-desc-ped-minimo.cd-categoria) @ c-ds-categoria COLUMN-LABEL "Categoria" FORMAT "x(30)":U
            WIDTH 20.43
      crm-desc-ped-minimo.dt-vigencia-ini FORMAT "99/99/9999":U
            WIDTH 16.43
      crm-desc-ped-minimo.dt-vigencia-fim FORMAT "99/99/9999":U
            WIDTH 15.43
      crm-desc-ped-minimo.vl-minimo FORMAT ">,>>>,>>>,>>9.99":U
            WIDTH 19.43
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW wMaintenance ASSIGN
         HIDDEN             = YES
         TITLE              = "Desconto M¡nimo por Grupo de Cliente x Categoria"
         HEIGHT             = 17
         WIDTH              = 111
         MAX-HEIGHT         = 27.54
         MAX-WIDTH          = 182.86
...
/* Query rebuild information for BROWSE brSon
     _TblList          = "mgesp.crm-desc-ped-minimo"
     _Options          = "NO-LOCK"
     _Where[1]         = "mgesp.crm-desc-ped-minimo.cd-unid-negoc = INPUT FRAME fPage0 tt-unid-comerc.cd-unid-comerc"
     _FldNameList[1]   > "_<CALC>"
"fnDsGrCli(crm-desc-ped-minimo.cod-gr-cli) @ c-ds-gr-cli" "Gr Cli" "x(30)" ? ? ? ? ? ? ? no ? no no "24.43" yes no no "U" "" ""
     _FldNameList[2]   > "_<CALC>"
"fnDsCategoria(crm-desc-ped-minimo.cd-categoria) @ c-ds-categoria" "Categoria" "x(30)" ? ? ? ? ? ? ? no ? no no "20.43" yes no no "U" "" ""
     _FldNameList[3]   > mgesp.crm-desc-ped-minimo.dt-vigencia-ini
"crm-desc-ped-minimo.dt-vigencia-ini" ? ? "date" ? ? ? ? ? ? no ? no no "16.43" yes no no "U" "" ""
     _FldNameList[4]   > mgesp.crm-desc-ped-minimo.dt-vigencia-fim
"crm-desc-ped-minimo.dt-vigencia-fim" ? ? "date" ? ? ? ? ? ? no ? no no "15.43" yes no no "U" "" ""
     _FldNameList[5]   > mgesp.crm-desc-ped-minimo.vl-minimo
"crm-desc-ped-minimo.vl-minimo" ? ? "decimal" ? ? ? ? ? ? no ? no no "19.43" yes no no "U" "" ""
     _Query            is OPENED
*/  /* BROWSE brSon */
&ANALYZE-RESUME
...
ON END-ERROR OF wMaintenance /* Desconto M¡nimo por Grupo de Cliente x Categoria */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL wMaintenance wMaintenance
ON WINDOW-CLOSE OF wMaintenance /* Desconto M¡nimo por Grupo de Cliente x Categoria */
DO:
...
DO:
    ...
    RUN esp/cdp/escdp035a.w (INPUT "Create":U,
...
DO:
    ...
    RUN esp/cdp/escdp035a.w (INPUT "Copy":U,
                             INPUT tt-unid-comerc.cd-unid-comerc,
                             INPUT IF AVAIL crm-desc-ped-minimo THEN ROWID(crm-desc-ped-minimo) ELSE ?).
...
DO:
    ...
    IF  RETURN-VALUE = "YES" THEN DO:
        FIND CURRENT crm-desc-ped-minimo EXCLUSIVE-LOCK NO-ERROR.
        IF  AVAIL  crm-desc-ped-minimo THEN
            DELETE crm-desc-ped-minimo.
    END.
...
DO:
    ...
    RUN esp/cdp/escdp035a.w (INPUT "Update":U,
                             INPUT tt-unid-comerc.cd-unid-comerc,
                             INPUT IF AVAIL crm-desc-ped-minimo THEN ROWID(crm-desc-ped-minimo) ELSE ?).
...
------------------------------------------------------------------------------*/
    ...
    IF  CAN-FIND(FIRST crm-desc-ped-minimo NO-LOCK
                 WHERE crm-desc-ped-minimo.cd-unid-negoc = STRING(tt-unid-comerc.cd-unid-comerc)) THEN DO:
        ENABLE btCopySon
               btUpdateSon
               btDeleteSon
            WITH FRAME fPage1.
