...
*******************************************************************************/
{include/i-prgvrs.i ESCDP124 1.00.00.000}
...
&IF "{&EMSFND_VERSION}" >= "1.00" &THEN
    {include/i-license-manager.i ESCDP124 ESP}
&ENDIF
...
DEFINE VARIABLE h_escdp124-b02 AS HANDLE NO-UNDO.
DEFINE VARIABLE h_escdp124-q01 AS HANDLE NO-UNDO.
DEFINE VARIABLE h_escdp124-v01 AS HANDLE NO-UNDO.
...
DEFINE FRAME f-cad
    ...
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         ...
         AT COL 1 ROW 1
         SIZE 90 BY 18.13 WIDGET-ID 100.
...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW w-cadpaifilho-ambos ASSIGN
         HIDDEN             = YES
         TITLE              = "Manuten‡Æo Parƒmetros UEP Estab"
         HEIGHT             = 18.21
         WIDTH              = 90
         MAX-HEIGHT         = 40.5
         MAX-WIDTH          = 274.29
...
ON END-ERROR OF w-cadpaifilho-ambos /* Manuten‡Æo Parƒmetros UEP Estab */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL w-cadpaifilho-ambos w-cadpaifilho-ambos
ON WINDOW-CLOSE OF w-cadpaifilho-ambos /* Manuten‡Æo Parƒmetros UEP Estab */
DO:
...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'esp/cdp/escdp124-v01.w':U ,
             INPUT  FRAME f-cad:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_escdp124-v01 ).
       RUN set-position IN h_escdp124-v01 ( 2.63 , 1.86 ) NO-ERROR.
       /* Size in UIB:  ( 4.75 , 88.57 ) */

       RUN init-object IN THIS-PROCEDURE (
             INPUT  'adm/objects/folder.w':U ,
             INPUT  FRAME f-cad:HANDLE ,
             INPUT  'FOLDER-LABELS = ':U + 'Centros Custo' + ',
                     FOLDER-TAB-TYPE = 1':U ,
             OUTPUT h_folder ).
       RUN set-position IN h_folder ( 8.63 , 1.43 ) NO-ERROR.
       RUN set-size IN h_folder ( 10.50 , 89.29 ) NO-ERROR.

       RUN init-object IN THIS-PROCEDURE (
             INPUT  'esp/cdp/escdp124-q01.w':U ,
             INPUT  FRAME f-cad:HANDLE ,
             INPUT  'ProgPesquisa = esp/cdp/escdp124-z01.w,
                     ProgVaPara = esp/cdp/escdp124-g01.w,
                     ProgIncMod = esp/cdp/escdp124a.w,
                     Implantar = no':U ,
             OUTPUT h_escdp124-q01 ).
       RUN set-position IN h_escdp124-q01 ( 1.00 , 55.00 ) NO-ERROR.
       /* Size in UIB:  ( 1.63 , 7.72 ) */

       /* Links to SmartPanel h_p-exihel. */
       RUN add-link IN adm-broker-hdl ( h_p-exihel , 'State':U , THIS-PROCEDURE ).

       /* Links to SmartViewer h_escdp124-v01. */
       RUN add-link IN adm-broker-hdl ( h_escdp124-q01 , 'Record':U , h_escdp124-v01 ).
       RUN add-link IN adm-broker-hdl ( h_p-cadpai , 'TableIO':U , h_escdp124-v01 ).

       /* Links to SmartFolder h_folder. */
       RUN add-link IN adm-broker-hdl ( h_folder , 'Page':U , THIS-PROCEDURE ).

       /* Links to SmartQuery h_escdp124-q01. */
       RUN add-link IN adm-broker-hdl ( h_p-cadpai , 'State':U , h_escdp124-q01 ).
       RUN add-link IN adm-broker-hdl ( h_p-exihel , 'State':U , h_escdp124-q01 ).
       RUN add-link IN adm-broker-hdl ( h_p-navega , 'Navigation':U , h_escdp124-q01 ).
       RUN add-link IN adm-broker-hdl ( h_p-navega , 'State':U , h_escdp124-q01 ).
       ...
       RUN adjust-tab-order IN adm-broker-hdl ( h_p-exihel ,
             h_p-cadpai , 'AFTER':U ).
       RUN adjust-tab-order IN adm-broker-hdl ( h_escdp124-v01 ,
             h_p-exihel , 'AFTER':U ).
       RUN adjust-tab-order IN adm-broker-hdl ( h_folder ,
             h_escdp124-v01 , 'AFTER':U ).
    END. /* Page 0 */
    WHEN 1 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'esp/cdp/escdp124-b02.w':U ,
             INPUT  FRAME f-cad:HANDLE ,
             INPUT  'Initial-Lock = NO-LOCK,
                     ...
                     Create-On-Add = ?,
                     ProgAtributo = ,
                     ProgIncMod = esp/cdp/escdp124b.w,
                     MessageNum = 0,
                     MessageParam = ':U ,
             OUTPUT h_escdp124-b02 ).
       RUN set-position IN h_escdp124-b02 ( 10.08 , 3.00 ) NO-ERROR.
       /* Size in UIB:  ( 8.50 , 66.00 ) */

       /* Links to BrowserCadastro2 h_escdp124-b02. */
       RUN add-link IN adm-broker-hdl ( h_escdp124-q01 , 'Record':U , h_escdp124-b02 ).

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_escdp124-b02 ,
             h_folder , 'AFTER':U ).
    END. /* Page 1 */
...
------------------------------------------------------------------------------*/
  ...
  {utp/ut9000.i "ESCDP124" "1.00.00.000"}
