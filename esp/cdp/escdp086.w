...
*******************************************************************************/
{include/i-prgvrs.i ESCDP086 1.00.00.000}
...
&GLOBAL-DEFINE Program          ESCDP086
&GLOBAL-DEFINE Version          1.00.00.000

&GLOBAL-DEFINE Folder           YES
&GLOBAL-DEFINE InitialPage      1
&GLOBAL-DEFINE FolderLabels     Centro Custo
...
&GLOBAL-DEFINE ttSon1           tt-int-item-cc
&GLOBAL-DEFINE hDBOSon1         h-boes922
&GLOBAL-DEFINE DBOSon1Table     int-item-cc
...
DEFINE VARIABLE c-desc-cc AS CHARACTER   NO-UNDO.
...
&Scoped-define INTERNAL-TABLES tt-int-item-cc

/* Definitions for BROWSE brSon1                                        */
&Scoped-define FIELDS-IN-QUERY-brSon1 tt-int-item-cc.cc-codigo ~
f-desc-cc(tt-int-item-cc.cc-codigo) @ c-desc-cc 
&Scoped-define ENABLED-FIELDS-IN-QUERY-brSon1 
&Scoped-define QUERY-STRING-brSon1 FOR EACH tt-int-item-cc NO-LOCK
&Scoped-define OPEN-QUERY-brSon1 OPEN QUERY brSon1 FOR EACH tt-int-item-cc NO-LOCK.
&Scoped-define TABLES-IN-QUERY-brSon1 tt-int-item-cc
&Scoped-define FIRST-TABLE-IN-QUERY-brSon1 tt-int-item-cc
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _FUNCTION-FORWARD f-desc-cc wMasterDetail 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS brSon1 wMasterDetail _STRUCTURED
  QUERY brSon1 NO-LOCK DISPLAY
      tt-int-item-cc.cc-codigo COLUMN-LABEL "Centro Custo" FORMAT "x(8)":U
      f-desc-cc(tt-int-item-cc.cc-codigo) @ c-desc-cc COLUMN-LABEL "Descri‡Æo" FORMAT "x(60)":U
            WIDTH 20
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
...
DEFINE FRAME fPage0
     ...
     btHelp AT ROW 1.13 COL 86.86 HELP
          "Ajuda"
     tt-item.it-codigo AT ROW 3 COL 13 COLON-ALIGNED WIDGET-ID 2
          VIEW-AS FILL-IN 
          SIZE 13 BY .88
     tt-item.desc-item AT ROW 3 COL 26 COLON-ALIGNED NO-LABEL WIDGET-ID 6
          VIEW-AS FILL-IN 
          SIZE 54 BY .88
...
DEFINE FRAME fPage1
     ...
     btDeleteSon1 AT ROW 10.33 COL 12.29
...
/* Query rebuild information for BROWSE brSon1
     _TblList          = "Temp-Tables.tt-int-item-cc"
     _Options          = "NO-LOCK"
     _FldNameList[1]   > Temp-Tables.tt-int-item-cc.cc-codigo
"cc-codigo" "Centro Custo" ? "character" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[2]   > "_<CALC>"
"f-desc-cc(tt-int-item-cc.cc-codigo) @ c-desc-cc" "Descri‡Æo" "x(60)" ? ? ? ? ? ? ? no ? no no "20" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _Query            is OPENED
*/  /* BROWSE brSon1 */
&ANALYZE-RESUME
...
DO:
    {masterdetail/addson.i &ProgramSon="esp/cdp/escdp086a.w"
                           &PageNumber="1"}
END.
...
------------------------------------------------------------------------------*/
    ...
    IF NOT VALID-HANDLE({&hDBOSon1}) OR 
       ...
       {&hDBOSon1}:FILE-NAME <> "esbo/boes922.p":U THEN DO:
        {btb/btb008za.i1 esbo/boes922.p YES}
        {btb/btb008za.i2 esbo/boes922.p '' {&hDBOSon1}} 
    END.
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _FUNCTION f-desc-cc wMasterDetail 
FUNCTION f-desc-cc RETURNS CHARACTER
...
------------------------------------------------------------------------------*/
    ...
    FOR FIRST emscad.ccusto NO-LOCK
        WHERE emscad.ccusto.cod_empresa      = "1"
          ...
          AND emscad.ccusto.cod_ccusto       = p-cc-codigo:
