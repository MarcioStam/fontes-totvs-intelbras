...
*******************************************************************************/
{include/i-prgvrs.i ESCDP089 2.00.00.000}
{esp/es0018.i}
...
&GLOBAL-DEFINE Program        ESCDP089
...
&GLOBAL-DEFINE page2Widgets   bt-arquivo rs-tipo
...
&GLOBAL-DEFINE page2Fields    c-arquivo ed-arquivo
...
DEFINE VARIABLE ed-arquivo AS CHARACTER INITIAL "Item~;Estabel~;NCM Base~;Produto Base~;Descriá∆o MCTIC~;Portaria PPB~;Dt Publi PPB~;Valid Ini PPB~;Valid Fim PPB~;Observ PPB~;Portaria Prov~;Valid Ini Prov~;Valid Fim Prov~;Observ Prov~;Portaria Def~;Dt Portaria Def;Valid Ini Def~;" 
     VIEW-AS EDITOR SCROLLBAR-VERTICAL
     SIZE 73.86 BY 3 NO-UNDO.
...
DEFINE FRAME fpage0
     btOK AT ROW 17.5 COL 2
     btCancel AT ROW 17.5 COL 13
     btHelp2 AT ROW 17.5 COL 80
...
DEFINE FRAME fPage2
     bt-arquivo AT ROW 1.75 COL 58 WIDGET-ID 66
     c-arquivo AT ROW 2 COL 3.14 NO-LABEL WIDGET-ID 68
     ed-arquivo AT ROW 5.75 COL 3.14 NO-LABEL WIDGET-ID 72
     rs-tipo AT ROW 9.75 COL 24 NO-LABEL WIDGET-ID 92
     c-exemplo-batch AT ROW 3.96 COL 40.29 COLON-ALIGNED NO-LABEL WIDGET-ID 64
     "Arquivo:" VIEW-AS TEXT
          SIZE 5.72 BY .67 AT ROW 1.25 COL 4.29 WIDGET-ID 60
     "Caminhos (Arquivo sempre em formato .CSV):" VIEW-AS TEXT
          SIZE 31 BY .67 AT ROW 3.25 COL 3.43 WIDGET-ID 88
     "Exemplo Online: c:~\temp~\arquivo.csv   |  Exemplo Batch:" VIEW-AS TEXT
          SIZE 39 BY .67 AT ROW 3.96 COL 3.43 WIDGET-ID 86
     "Layout do Arquivo:" VIEW-AS TEXT
          SIZE 13.86 BY .67 AT ROW 5.04 COL 3.14 WIDGET-ID 84
     RECT-10 AT ROW 5.29 COL 2 WIDGET-ID 74
     RECT-12 AT ROW 1.54 COL 2 WIDGET-ID 78
     RECT-13 AT ROW 3.63 COL 2 WIDGET-ID 80
     RECT-14 AT ROW 9.5 COL 2 WIDGET-ID 90
    WITH 1 DOWN KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 3.57 ROW 2.79
         SIZE 84.43 BY 12.46
...
/* SETTINGS FOR FRAME fPage2
                                                                        */
/* SETTINGS FOR FILL-IN c-arquivo IN FRAME fPage2
   ALIGN-L                                                              */
ASSIGN 
       c-exemplo-batch:READ-ONLY IN FRAME fPage2        = TRUE.

ASSIGN 
       ed-arquivo:READ-ONLY IN FRAME fPage2        = TRUE.
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL bt-arquivo wReport
ON CHOOSE OF bt-arquivo IN FRAME fPage2 /* Busca Arquivo */
DO:
    ...
    IF l-ok THEN DO:
        ...
        display c-arquivo with frame fPage2.
    END.
...
IF AVAIL tt-prog-ponto THEN
    ASSIGN c-exemplo-batch:SCREEN-VALUE IN FRAME fPage2 = tt-prog-ponto.conteudo + "/usuario".
...
do on error undo, return error on stop  undo, return error:
    ...
    assign tt-param.usuario          = c-seg-usuario
           ...
           tt-param.c-arq-import     = INPUT FRAME fPage2 c-arquivo
           tt-param.tp-execucao      = INPUT FRAME fPage6 rsExecution
           tt-param.tipo             = INPUT FRAME fPage2 rs-tipo
           .
    
    /*:T Coloque aqui a lΩgica de gravaªío dos demais campos que devem ser passados
    ...
    {report/rprun.i esp/cdp/escdp089rp.p}
