...
*******************************************************************************/
{include/i-prgvrs.i ESCDP002 2.04.00.000}

CREATE WIDGET-POOL.

/* Preprocessors Definitions ---                                      */
&GLOBAL-DEFINE Program        ESCDP002
...
&GLOBAL-DEFINE hDBOTable      hDBOint-item
&GLOBAL-DEFINE DBOTable       int-item

&GLOBAL-DEFINE page0KeyFields tt-int-item.it-codigo
&GLOBAL-DEFINE page0Fields    
&GLOBAL-DEFINE page1Fields    tt-int-item.dt-venc-homologacao
...
&Scoped-Define ENABLED-FIELDS tt-int-item.it-codigo 
&Scoped-define ENABLED-TABLES tt-int-item
&Scoped-define FIRST-ENABLED-TABLE tt-int-item
...
DEFINE FRAME fpage0
     ...
     btHelp AT ROW 1.13 COL 86.72 HELP
          "Ajuda"
     tt-int-item.it-codigo AT ROW 3.5 COL 26 COLON-ALIGNED WIDGET-ID 4
          VIEW-AS FILL-IN 
          SIZE 15 BY .88
     c-desc-item AT ROW 3.5 COL 42 COLON-ALIGNED NO-LABEL WIDGET-ID 8
...
DEFINE FRAME fPage1
     tt-int-item.dt-venc-homologacao AT ROW 1.5 COL 23 COLON-ALIGNED WIDGET-ID 4
          VIEW-AS FILL-IN 
          SIZE 13 BY .88
...
OR CHOOSE OF MENU-ITEM miCancel IN MENU mbMain DO:
    ...
    ASSIGN tt-int-item.dt-venc-homologacao:SENSITIVE IN FRAME fPage1 = NO
           btCancel:SENSITIVE IN FRAME {&FRAME-NAME} = NO
           btSave:SENSITIVE IN FRAME {&FRAME-NAME} = NO
           btUpdate:SENSITIVE IN FRAME {&FRAME-NAME} = YES.

   
    FIND CURRENT tt-int-item NO-LOCK.
    DISP tt-int-item.dt-venc-homologacao WITH FRAME fPage1.
...
OR CHOOSE OF MENU-ITEM miSave IN MENU mbMain DO:
    ...
    FIND FIRST int-item WHERE int-item.it-codigo = tt-int-item.it-codigo EXCLUSIVE-LOCK NO-ERROR.
    IF NOT AVAIL int-item THEN NEXT.

    ASSIGN int-item.dt-venc-homologacao = date(tt-int-item.dt-venc-homologacao:SCREEN-VALUE IN FRAME fPage1).
...
OR CHOOSE OF MENU-ITEM miSearch IN MENU mbMain DO:
    {method/zoomreposition.i &ProgramZoom="eszoom\z01es372.r"}
END.
...
OR CHOOSE OF MENU-ITEM miUpdate IN MENU mbMain DO:
    ...
    ASSIGN tt-int-item.dt-venc-homologacao:SENSITIVE IN FRAME fPage1 = YES
...
------------------------------------------------------------------------------*/
    ...
    find item where item.it-codigo = tt-int-item.it-codigo no-lock no-error.
    if avail item
    then assign c-desc-item:screen-value in frame fPage0 = item.desc-item.
    else assign c-desc-item:screen-value in frame fPage0 = "".
...
------------------------------------------------------------------------------*/
    ...
    DEFINE FRAME fGoToRecord
        pit-codigo        AT ROW 1.21 COL 17.72 COLON-ALIGNED
...
/*tech1139 - FO 1338.917 - 10/07/2006  */
    ...
    ON "CHOOSE":U OF btGoToOK IN FRAME fGoToRecord DO:
        ...
        RUN goToKey IN {&hDBOTable} (INPUT pit-codigo).
    ...
    ENABLE pit-codigo btGoToOK btGoToCancel 
