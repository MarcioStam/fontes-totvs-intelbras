...
*******************************************************************************/
{include/i-prgvrs.i ESCDP118-Q01 1.00.00.000}
...
&IF "{&EMSFND_VERSION}" >= "1.00" &THEN
    {include/i-license-manager.i ESCDP118-Q01 ESP}
&ENDIF
...
&Scoped-define QUERY-STRING-Query-Main FOR EACH int_bem_pat ~
      WHERE int_bem_pat.cod_empresa = v_cod_empres_usuar NO-LOCK, ~
      FIRST bem_pat WHERE bem_pat.num_id_bem_pat = int_bem_pat.num_id_bem_pat NO-LOCK
&Scoped-define OPEN-QUERY-Query-Main OPEN QUERY Query-Main FOR EACH int_bem_pat ~
      WHERE int_bem_pat.cod_empresa = v_cod_empres_usuar NO-LOCK, ~
      FIRST bem_pat WHERE bem_pat.num_id_bem_pat = int_bem_pat.num_id_bem_pat NO-LOCK.
&Scoped-define TABLES-IN-QUERY-Query-Main int_bem_pat bem_pat
&Scoped-define FIRST-TABLE-IN-QUERY-Query-Main int_bem_pat
&Scoped-define SECOND-TABLE-IN-QUERY-Query-Main bem_pat
...
/* Query rebuild information for QUERY Query-Main
     ...
     _Options          = "NO-LOCK"
     _TblOptList       = ", FIRST"
     _Where[1]         = "mgesp.int_bem_pat.cod_empresa = v_cod_empres_usuar"
     _JoinCode[2]      = "emsmov.bem_pat.num_id_bem_pat = mgesp.int_bem_pat.num_id_bem_pat"
