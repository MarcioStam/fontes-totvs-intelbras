...
*******************************************************************************/
{include/i-prgvrs.i ESCDP085a 2.00.00.000}

CREATE WIDGET-POOL.

/* Preprocessors Definitions ---                                      */
&GLOBAL-DEFINE Program        ESCDP085a
...
define temp-table tt-digita LIKE int-def-sigla-transp
...
DEFINE BUFFER bf-int-def-sigla-transp FOR int-def-sigla-transp.
...
&Scoped-define FIELDS-IN-QUERY-brDigita tt-digita.l-marca tt-digita.cod-trans tt-digita.cod-estab tt-digita.estado tt-digita.cidade tt-digita.cep-inicial tt-digita.cep-final tt-digita.sigla-trans   
...
DEFINE VARIABLE cCepFinal AS CHARACTER FORMAT "x(12)" INITIAL "ZZZZZZZZZZZZ" 
     VIEW-AS FILL-IN 
     SIZE 17 BY .88 NO-UNDO.

DEFINE VARIABLE cCepInicial AS CHARACTER FORMAT "x(12)" 
     LABEL "Faixa de CEPs" 
     VIEW-AS FILL-IN 
     SIZE 17 BY .88 NO-UNDO.
...
DEFINE VARIABLE iTransFim AS INTEGER FORMAT ">>>>>>>>9" INITIAL 999999999 
     VIEW-AS FILL-IN 
...
DEFINE FRAME fPage2
     iTransIni AT ROW 2.5 COL 26 COLON-ALIGNED HELP
          "Transportadora" WIDGET-ID 48
     iTransFim AT ROW 2.5 COL 55 COLON-ALIGNED HELP
          "Transportadora" NO-LABEL WIDGET-ID 46
     cEstabOrigemIni AT ROW 3.5 COL 16.72 HELP
          "Estabelecimento Origem"
     cEstabOrigemFim AT ROW 3.5 COL 57 HELP
          "Estabelecimento Origem" NO-LABEL WIDGET-ID 18
     cCepInicial AT ROW 4.5 COL 20 COLON-ALIGNED HELP
          "Cliente Destino"
     cCepFinal AT ROW 4.5 COL 55 COLON-ALIGNED HELP
          "Cliente Destino" NO-LABEL WIDGET-ID 30
     cEstadoIni AT ROW 5.5 COL 32.86 COLON-ALIGNED HELP
          "UF Destino" WIDGET-ID 2
     cEstadoFim AT ROW 5.5 COL 55 COLON-ALIGNED HELP
          "UF Destino" NO-LABEL
     cCidadeIni AT ROW 6.5 COL 13 COLON-ALIGNED HELP
          "Cidade Destino" WIDGET-ID 6
     cCidadeFim AT ROW 6.5 COL 55 COLON-ALIGNED HELP
          "Cidade Destino" NO-LABEL
     IMAGE-1 AT ROW 3.54 COL 39.57
     IMAGE-2 AT ROW 3.54 COL 53.14
     IMAGE-19 AT ROW 5.54 COL 39.72 WIDGET-ID 20
     IMAGE-20 AT ROW 5.54 COL 53.29 WIDGET-ID 22
     IMAGE-21 AT ROW 6.54 COL 39.72 WIDGET-ID 26
     IMAGE-22 AT ROW 6.54 COL 53.29 WIDGET-ID 28
     IMAGE-23 AT ROW 4.54 COL 39.72 WIDGET-ID 32
     IMAGE-24 AT ROW 4.54 COL 53.29 WIDGET-ID 34
     IMAGE-29 AT ROW 2.54 COL 39.72 WIDGET-ID 42
     IMAGE-30 AT ROW 2.54 COL 53.29 WIDGET-ID 44
...
DO:
    ...
    FOR EACH bf-int-def-sigla-transp NO-LOCK
        WHERE bf-int-def-sigla-transp.cod-trans     >= INPUT FRAME fPage2 iTransIni 
          AND bf-int-def-sigla-transp.cod-trans     <= INPUT FRAME fPage2 iTransFim
          AND bf-int-def-sigla-transp.cod-estabel   >= INPUT FRAME fPage2 cEstabOrigemIni 
          AND bf-int-def-sigla-transp.cod-estabel   <= INPUT FRAME fPage2 cEstabOrigemFim 
          AND bf-int-def-sigla-transp.estado        >= INPUT FRAME fPage2 cEstadoIni 
          AND bf-int-def-sigla-transp.estado        <= INPUT FRAME fPage2 cEstadoFim 
          AND bf-int-def-sigla-transp.cidade        >= INPUT FRAME fPage2 cCidadeIni
          AND bf-int-def-sigla-transp.cidade        <= INPUT FRAME fPage2 cCidadeFim 
          AND bf-int-def-sigla-transp.cep-inicial   >= INPUT FRAME fPage2 cCepInicial
          AND bf-int-def-sigla-transp.cep-final     <= INPUT FRAME fPage2 cCepFinal:

        CREATE tt-digita.
        BUFFER-COPY bf-int-def-sigla-transp TO tt-digita.
...
do on error undo, return error on stop  undo, return error:
    ...
    IF  NOT can-find(FIRST tt-digita
                        WHERE tt-digita.l-marca) THEN DO:
        run utp/ut-msgs.p (input "show":U, INPUT 17006, input "Os registros para elimina‡Æo devem ser informados na pasta 'Digita‡Æo'":U).
        RETURN ERROR.
    END.
    ...
    then 
     ...
     run utp/ut-msgs.p (input "show", input 27100, input "Aten‡Æo! Elimina‡Æo de Registros" + "~~" +
                        "Os registros de defini‡Æo de Sigla das transportadoras selecionadas serÆo eliminados. Confirma?").
    ...
    ASSIGN tt-param.transp-ini      = INPUT FRAME fPage2 iTransIni 
           tt-param.transp-fim      = INPUT FRAME fPage2 iTransFim
           tt-param.estab-ini       = INPUT FRAME fPage2 cEstabOrigemIni
           ...
           tt-param.Cep-ini         = INPUT FRAME fPage2 cCepInicial
           tt-param.Cep-fim         = INPUT FRAME fPage2 cCepFinal.
    ...
    {report/rprun.i esp/cdp/escdp085arp.p}
