...
*******************************************************************************/
{include/i-prgvrs.i escdp036a 2.00.00.000}
...
DEFINE VARIABLE c-arquivo-batch AS CHARACTER 
...
DEFINE VARIABLE c-arquivo-online AS CHARACTER INITIAL "c:~\temp~\arquivo.csv" 
     VIEW-AS EDITOR NO-WORD-WRAP MAX-CHARS 256
     SIZE 27 BY .88.
...
DEFINE FRAME f-pg-par
     c-arquivo-batch AT ROW 7.63 COL 15 NO-LABEL WIDGET-ID 8
     c-arquivo-online AT ROW 8.67 COL 15 NO-LABEL WIDGET-ID 10
     c-arquivo-entrada AT ROW 9.71 COL 3.29 HELP
          "Nome do arquivo de destino do relat¢rio" NO-LABEL
     bt-arquivo-entrada AT ROW 9.71 COL 43.14 HELP
          "Escolha do nome do arquivo"
     text-entrada AT ROW 6.21 COL 4 NO-LABEL
     "Os arquivos devem ser importados no formato CSV." VIEW-AS TEXT
          SIZE 36 BY .54 AT ROW 6.92 COL 4 WIDGET-ID 2
     "Exemplo Batch:" VIEW-AS TEXT
          SIZE 11 BY .54 AT ROW 7.79 COL 4 WIDGET-ID 4
     "Exemplo Online:" VIEW-AS TEXT
          SIZE 11 BY .54 AT ROW 8.71 COL 4 WIDGET-ID 6
     RECT-8 AT ROW 6.5 COL 2
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 3 ROW 3
         SIZE 76.86 BY 10.46
...
{utp/ut9000.i "escdp036a" "2.00.00.000"}
...
DO  ON ERROR   UNDO MAIN-BLOCK, LEAVE MAIN-BLOCK
    ...
    {include/i-imvrf.i &programa=escdp036a &versao-layout=001}
...
------------------------------------------------------------------------------*/
  ...
  DISPLAY c-arquivo-batch c-arquivo-online c-arquivo-entrada 
      WITH FRAME f-pg-par IN WINDOW C-Win.
  ENABLE RECT-8 c-arquivo-batch c-arquivo-online c-arquivo-entrada 
         bt-arquivo-entrada 
      WITH FRAME f-pg-par IN WINDOW C-Win.
...
do  on error undo, return error
    ...
    {include/i-imrun.i esp/cdp/escdp036arp.p}
