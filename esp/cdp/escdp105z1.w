...
DEFINE TEMP-TABLE tt-int-modelo-placa NO-UNDO LIKE int-modelo-placa
       field r-rowid as rowid.
DEFINE TEMP-TABLE tt-int-modelo-placa-2 NO-UNDO LIKE int-modelo-placa
       field r-rowid as rowid.
...
*******************************************************************************/
{include/i-prgvrs.i escdp105z1 1.00.00.000}
...
&IF "{&EMSFND_VERSION}" >= "1.00" &THEN
    {include/i-license-manager.i escdp105z1 ESP}
&ENDIF

CREATE WIDGET-POOL.

/* Preprocessors Definitions ---                                      */
&GLOBAL-DEFINE Program           escdp105z1
&GLOBAL-DEFINE Version           1.00.00.000

&GLOBAL-DEFINE InitialPage       1
&GLOBAL-DEFINE FolderLabels      Modelo Placa, Descri‡Æo

&GLOBAL-DEFINE Range             NO

&GLOBAL-DEFINE FieldsRangePage1  v-mod-pl-ini,v-mod-pl-fim
&GLOBAL-DEFINE FieldsRangePage2  v-des-ini,v-des-fim

&GLOBAL-DEFINE ttTable1          tt-int-modelo-placa
&GLOBAL-DEFINE hDBOTable1        hDBOImp
&GLOBAL-DEFINE DBOTable1         int-modelo-placa

&GLOBAL-DEFINE ttTable2          tt-int-modelo-placa-2
&GLOBAL-DEFINE hDBOTable2        hDBOImp2
&GLOBAL-DEFINE DBOTable2         int-modelo-placa
...
&Scoped-define INTERNAL-TABLES tt-int-modelo-placa tt-int-modelo-placa-2

/* Definitions for BROWSE brTable1                                      */
&Scoped-define FIELDS-IN-QUERY-brTable1 ~
tt-int-modelo-placa.cod-modelo-placa tt-int-modelo-placa.desc-modelo-placa 
&Scoped-define ENABLED-FIELDS-IN-QUERY-brTable1 
&Scoped-define QUERY-STRING-brTable1 FOR EACH tt-int-modelo-placa NO-LOCK
&Scoped-define OPEN-QUERY-brTable1 OPEN QUERY brTable1 FOR EACH tt-int-modelo-placa NO-LOCK.
&Scoped-define TABLES-IN-QUERY-brTable1 tt-int-modelo-placa
&Scoped-define FIRST-TABLE-IN-QUERY-brTable1 tt-int-modelo-placa


/* Definitions for BROWSE brTable2                                      */
&Scoped-define FIELDS-IN-QUERY-brTable2 ~
tt-int-modelo-placa-2.cod-modelo-placa ~
tt-int-modelo-placa-2.desc-modelo-placa 
&Scoped-define ENABLED-FIELDS-IN-QUERY-brTable2 
&Scoped-define QUERY-STRING-brTable2 FOR EACH tt-int-modelo-placa-2 NO-LOCK
&Scoped-define OPEN-QUERY-brTable2 OPEN QUERY brTable2 FOR EACH tt-int-modelo-placa-2 NO-LOCK.
&Scoped-define TABLES-IN-QUERY-brTable2 tt-int-modelo-placa-2
&Scoped-define FIRST-TABLE-IN-QUERY-brTable2 tt-int-modelo-placa-2
...
DEFINE VARIABLE v-mod-pl-fim AS CHARACTER FORMAT "X(20)" 
     VIEW-AS FILL-IN 
     SIZE 20 BY .79 NO-UNDO.

DEFINE VARIABLE v-mod-pl-ini AS CHARACTER FORMAT "X(20)" 
     LABEL "Modelo Placa" 
     VIEW-AS FILL-IN 
     SIZE 20 BY .79 NO-UNDO.
...
DEFINE QUERY brTable1 FOR 
      tt-int-modelo-placa SCROLLING.

DEFINE QUERY brTable2 FOR 
      tt-int-modelo-placa-2 SCROLLING.
&ANALYZE-RESUME
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS brTable1 wZoom _STRUCTURED
  QUERY brTable1 NO-LOCK DISPLAY
      tt-int-modelo-placa.cod-modelo-placa FORMAT "x(20)":U
      tt-int-modelo-placa.desc-modelo-placa FORMAT "x(60)":U WIDTH 69
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS brTable2 wZoom _STRUCTURED
  QUERY brTable2 NO-LOCK DISPLAY
      tt-int-modelo-placa-2.cod-modelo-placa FORMAT "x(20)":U
      tt-int-modelo-placa-2.desc-modelo-placa FORMAT "x(60)":U
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ROW-MARKERS SEPARATORS SIZE 82 BY 9.5
         FONT 2 FIT-LAST-COLUMN.
...
DEFINE FRAME fPage1
     ...
     v-mod-pl-ini AT ROW 1.75 COL 16.43 COLON-ALIGNED WIDGET-ID 2
     v-mod-pl-fim AT ROW 1.75 COL 45 COLON-ALIGNED NO-LABEL WIDGET-ID 8
...
/* Settings for THIS-PROCEDURE
   ...
   Temp-Tables and Buffers:
      TABLE: tt-int-modelo-placa T "?" NO-UNDO mgesp int-modelo-placa
      ADDITIONAL-FIELDS:
          field r-rowid as rowid
      END-FIELDS.
      TABLE: tt-int-modelo-placa-2 T "?" NO-UNDO mgesp int-modelo-placa
      ADDITIONAL-FIELDS:
          field r-rowid as rowid
      END-FIELDS.
   END-TABLES.
...
/* SETTINGS FOR FRAME fPage1
                                                                        */
/* BROWSE-TAB brTable1 v-mod-pl-fim fPage1 */
...
/* Query rebuild information for BROWSE brTable1
     _TblList          = "Temp-Tables.tt-int-modelo-placa"
     _Options          = "NO-LOCK INDEXED-REPOSITION"
     _FldNameList[1]   = Temp-Tables.tt-int-modelo-placa.cod-modelo-placa
     _FldNameList[2]   > Temp-Tables.tt-int-modelo-placa.desc-modelo-placa
"tt-int-modelo-placa.desc-modelo-placa" ? ? "character" ? ? ? ? ? ? no ? no no "69" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _Query            is OPENED
*/  /* BROWSE brTable1 */
&ANALYZE-RESUME
...
/* Query rebuild information for BROWSE brTable2
     _TblList          = "Temp-Tables.tt-int-modelo-placa-2"
     _Options          = "NO-LOCK INDEXED-REPOSITION"
     _FldNameList[1]   = Temp-Tables.tt-int-modelo-placa-2.cod-modelo-placa
     _FldNameList[2]   = Temp-Tables.tt-int-modelo-placa-2.desc-modelo-placa
     _Query            is OPENED
*/  /* BROWSE brTable2 */
&ANALYZE-RESUME
...
DO:
  ASSIGN INPUT FRAME fPage1 v-mod-pl-ini v-mod-pl-fim.
...
DO:
    {zoom/Implant.i &ProgramImplant="esp/cdp/escdp105.w"
                    &PageNumber="1"}  
END.
...
DO WITH FRAME fPage1:
    ...
    ASSIGN v-mod-pl-ini:SCREEN-VALUE = "":U
           v-mod-pl-fim:SCREEN-VALUE = "ZZZZZZZZZZZZZZZZZZZZ":U
           v-mod-pl-ini:SENSITIVE    = YES
           v-mod-pl-fim:SENSITIVE    = YES
...
------------------------------------------------------------------------------*/
    ...
    IF NOT VALID-HANDLE({&hDBOTable1}) OR
       ...
       {&hDBOTable1}:FILE-NAME <> "esp\cdp\escdp105bo.p":U THEN DO:
       
        {btb/btb008za.i1 esp\cdp\escdp105bo.p YES}
        {btb/btb008za.i2 esp\cdp\escdp105bo.p '' {&hDBOTable1}} 
    END.
    
    RUN setConstraintModPl IN {&hDBOTable1} (INPUT "":U , INPUT "ZZZZZZZZZZZZZZZZZZZZ":U) NO-ERROR.

    IF NOT VALID-HANDLE({&hDBOTable2}) OR
       {&hDBOTable2}:TYPE <> "PROCEDURE":U OR
       {&hDBOTable2}:FILE-NAME <> "esp\cdp\escdp105bo.p":U THEN DO:
       
        {btb/btb008za.i1 esp\cdp\escdp105bo.p YES}
        {btb/btb008za.i2 esp\cdp\escdp105bo.p '' {&hDBOTable2}} 
    END.
    
    RUN setConstraintDes IN {&hDBOTable2} (INPUT "":U , INPUT "ZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZ":U) NO-ERROR.
...
------------------------------------------------------------------------------*/
    ...
    {zoom/openqueries.i &Query="ModPl"
                        &PageNumber="1"}
...
------------------------------------------------------------------------------*/
    ...
    IF AVAILABLE {&ttTable1} THEN DO:
        CASE pcField:
            WHEN "cod-modelo-placa":U  THEN ASSIGN pcFieldValue = STRING({&ttTable1}.cod-modelo-placa).
            WHEN "desc-modelo-placa":U THEN ASSIGN pcFieldValue = STRING({&ttTable1}.desc-modelo-placa).
        END CASE.
    END.
...
------------------------------------------------------------------------------*/
    ...
    IF AVAILABLE {&ttTable2} THEN DO:
        CASE pcField:
            WHEN "cod-modelo-placa":U  THEN ASSIGN pcFieldValue = STRING({&ttTable2}.cod-modelo-placa).
            WHEN "desc-modelo-placa":U THEN ASSIGN pcFieldValue = STRING({&ttTable2}.desc-modelo-placa).
        END CASE.
    END.
...
------------------------------------------------------------------------------*/
    ...
    CASE pPageNumber:
        WHEN 1 THEN
            ...
            RUN setConstraintmodPl IN {&hDBOTable1} (INPUT v-mod-pl-ini, INPUT v-mod-pl-fim).
