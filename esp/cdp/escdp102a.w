...
*******************************************************************************/
{include/i-prgvrs.i ESCPD102A 1.00.00.001}
...
DEFINE VARIABLE h_escdp102-q01 AS HANDLE NO-UNDO.
DEFINE VARIABLE h_escdp102-v02 AS HANDLE NO-UNDO.
...
DEFINE FRAME f-cad
     bt-ok AT ROW 7.33 COL 2 HELP
          "Salva e sai"
     bt-save AT ROW 7.33 COL 12.43 HELP
          "Salva e cria novo"
     bt-cancela AT ROW 7.33 COL 23 HELP
          "Cancela"
     bt-ajuda AT ROW 7.33 COL 70.14
     rt-button AT ROW 7.17 COL 1
...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW w-cadsim ASSIGN
         HIDDEN             = YES
         TITLE              = "Inclui/Modifica Desconto Cliente"
         HEIGHT             = 7.79
         WIDTH              = 80.72
         MAX-HEIGHT         = 26.75
         MAX-WIDTH          = 146.29
...
ON END-ERROR OF w-cadsim /* Inclui/Modifica Desconto Cliente */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL w-cadsim w-cadsim
ON WINDOW-CLOSE OF w-cadsim /* Inclui/Modifica Desconto Cliente */
DO:
...
DO:
{include/okfil.i h_escdp102-v02}
END.
...
DO:
{include/salvafil.i h_escdp102-v02}
END.
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'esp/cdp/escdp102-v02.w':U ,
             INPUT  FRAME f-cad:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_escdp102-v02 ).
       RUN set-position IN h_escdp102-v02 ( 1.25 , 1.72 ) NO-ERROR.
       /* Size in UIB:  ( 5.75 , 79.29 ) */

       RUN init-object IN THIS-PROCEDURE (
             INPUT  'esp/cdp/escdp102-q01.w':U ,
             INPUT  FRAME f-cad:HANDLE ,
             INPUT  '':U ,
             OUTPUT h_escdp102-q01 ).
       RUN set-position IN h_escdp102-q01 ( 7.00 , 44.43 ) NO-ERROR.
       /* Size in UIB:  ( 1.63 , 7.72 ) */

       /* Links to SmartViewer h_escdp102-v02. */
       RUN add-link IN adm-broker-hdl ( h_escdp102-q01 , 'Record':U , h_escdp102-v02 ).
       RUN add-link IN adm-broker-hdl ( THIS-PROCEDURE , 'TABLEIO':U , h_escdp102-v02 ).

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_escdp102-v02 ,
...
------------------------------------------------------------------------------*/
  ...
  {utp/ut9000.i "ESCPD102A" "1.00.00.000"}

  /* Dispatch standard ADM method.                             */
  RUN dispatch IN THIS-PROCEDURE ( INPUT 'initialize':U ) .

  run pi-atualiza-parent in h_escdp102-v02 (input v-row-parent).
...
/*------------------------------------------------------------------------------
  ...
  Notes:       
------------------------------------------------------------------------------*/
  RUN pi-reposiciona-query IN h_escdp102-q01 (input v-row-table).
