...
*******************************************************************************/
{include/i-prgvrs.i escdp068.w 9.99.99.999}
...
&IF "{&EMSFND_VERSION}" >= "1.00" &THEN
    {include/i-license-manager.i <escdp068> <m¢dulo>}
&ENDIF

CREATE WIDGET-POOL.

/* Preprocessors Definitions ---                                      */
&GLOBAL-DEFINE Program        escdp068
&GLOBAL-DEFINE Version        2.00.00.000
&GLOBAL-DEFINE VersionLayout  

&GLOBAL-DEFINE Folder         YES
&GLOBAL-DEFINE InitialPage    1
&GLOBAL-DEFINE FolderLabels   Seleá∆o, Digitaá∆o, Impressao
...
&GLOBAL-DEFINE page2Fields    fi-fam-com-ini fi-fam-com-fim fi-item-ini fi-item-fim 
...
&Scoped-define FIELDS-IN-QUERY-brDigita tt-digita.familia tt-digita.descricao   
&Scoped-define ENABLED-FIELDS-IN-QUERY-brDigita tt-digita.familia tt-digita.descricao   
...
DEFINE VARIABLE fi-fam-com-fim AS CHARACTER FORMAT "x(8)" INITIAL "ZZZZZZZZ" 
     VIEW-AS FILL-IN 
     SIZE 15 BY .88 NO-UNDO.

DEFINE VARIABLE fi-fam-com-ini AS CHARACTER FORMAT "x(8)" 
     LABEL "Familia Comercial" 
     VIEW-AS FILL-IN 
     SIZE 15 BY .88 NO-UNDO.

DEFINE VARIABLE fi-item-fim AS CHARACTER FORMAT "x(16)" INITIAL "ZZZZZZZ" 
     VIEW-AS FILL-IN 
     SIZE 15 BY .88 NO-UNDO.
...
DEFINE FRAME fPage2
     fi-fam-com-ini AT ROW 3.96 COL 15 COLON-ALIGNED HELP
          "Familia Comercial do Item" WIDGET-ID 26
     fi-fam-com-fim AT ROW 3.96 COL 48.14 COLON-ALIGNED HELP
          "Familia Comercial do Item" NO-LABEL WIDGET-ID 24
     fi-item-ini AT ROW 5 COL 15 COLON-ALIGNED HELP
          "C¢digo do Item" WIDGET-ID 34
     fi-item-fim AT ROW 5 COL 48.14 COLON-ALIGNED HELP
          "C¢digo do Item" NO-LABEL WIDGET-ID 32
     IMAGE-1 AT ROW 3.96 COL 31.86 WIDGET-ID 28
     IMAGE-2 AT ROW 3.96 COL 47.29 WIDGET-ID 30
     IMAGE-3 AT ROW 5 COL 31.86 WIDGET-ID 36
     IMAGE-4 AT ROW 5 COL 47.29 WIDGET-ID 38
    WITH 1 DOWN KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 3.57 ROW 2.81
         SIZE 84.43 BY 10.15
...
DO:
    ...
    do transaction on error undo, return no-apply:
        create tt-digita.
        assign input browse brDigita tt-digita.familia
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL brDigita wReport
ON VALUE-CHANGED OF brDigita IN FRAME fPage5
DO:
  /*ON 'LEAVE':U OF tt-digita.descricao IN BROWSE brDigita DO:
    FIND FIRST fam-com-item
      WHERE fam-com-item.fm-cod-com = string(tt-digita.familia) NO-LOCK NO-ERROR.
       IF AVAIL fam-com-item THEN DO:
          assign tt-digita.descricao:screen-value in browse brDigita = STRING(fam-com-item.descricao).
       END.
       ELSE DO:
          ASSIGN tt-digita.descricao:screen-value in browse brDigita = "".
       END.
    RETURN.
  END.*/
END.
...
DO:
    ...
    if num-results("brDigita":U) > 0 then
        ...
        apply "entry":U to tt-digita.familia in browse brDigita. 
    end.
END.
...
DO:
   apply 'entry' to tt-digita.familia in browse brDigita. 
END.
...
do on error undo, return error on stop  undo, return error:
    ...
    for each tt-digita no-lock:
        ...
        find first b-tt-digita 
            where b-tt-digita.familia = tt-digita.familia 
        ...
        if  tt-digita.familia <= 0 then do:
            assign browse brDigita:CURRENT-COLUMN = tt-digita.familia:HANDLE in browse brDigita.
    ...
    assign tt-param.usuario         = c-seg-usuario
           ...
           tt-param.c-fam-com-ini   = INPUT FRAME fPage2 fi-fam-com-ini 
           tt-param.c-fam-com-fim   = INPUT FRAME fPage2 fi-fam-com-fim
           tt-param.c-item-ini      = INPUT FRAME fPage2 fi-item-ini
           tt-param.c-item-fim      = INPUT FRAME fPage2 fi-item-fim
           .
    ...
    {report/rprun.i esp/cdp/escdp068rp.p}
...
do  on error undo, return error
    ...
    {report/imrun.i esp/cdp/escdp068rp.p}
