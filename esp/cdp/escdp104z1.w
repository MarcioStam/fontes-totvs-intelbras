...
DEFINE TEMP-TABLE tt-int-modelo NO-UNDO LIKE int-modelo
       field r-rowid as rowid.
DEFINE TEMP-TABLE tt-int-modelo-2 NO-UNDO LIKE int-modelo
       field r-rowid as rowid.
...
*******************************************************************************/
{include/i-prgvrs.i escdp104z1 1.00.00.000}
...
&IF "{&EMSFND_VERSION}" >= "1.00" &THEN
    {include/i-license-manager.i escdp104z1 ESP}
&ENDIF

CREATE WIDGET-POOL.

/* Preprocessors Definitions ---                                      */
&GLOBAL-DEFINE Program           escdp104z1
&GLOBAL-DEFINE Version           1.00.00.000

&GLOBAL-DEFINE InitialPage       1
&GLOBAL-DEFINE FolderLabels      Modelo, Descri‡Æo

&GLOBAL-DEFINE Range             NO

&GLOBAL-DEFINE ttTable1          tt-int-modelo
&GLOBAL-DEFINE hDBOTable1        hDBOIm
&GLOBAL-DEFINE DBOTable1         int-modelo

&GLOBAL-DEFINE ttTable2          tt-int-modelo-2
&GLOBAL-DEFINE hDBOTable2        hDBOIm2
&GLOBAL-DEFINE DBOTable2         int-modelo
...
&Scoped-define INTERNAL-TABLES tt-int-modelo tt-int-modelo-2

/* Definitions for BROWSE brTable1                                      */
&Scoped-define FIELDS-IN-QUERY-brTable1 tt-int-modelo.cod-modelo ~
tt-int-modelo.desc-modelo tt-int-modelo.log-aps 
&Scoped-define ENABLED-FIELDS-IN-QUERY-brTable1 
&Scoped-define QUERY-STRING-brTable1 FOR EACH tt-int-modelo NO-LOCK INDEXED-REPOSITION
&Scoped-define OPEN-QUERY-brTable1 OPEN QUERY brTable1 FOR EACH tt-int-modelo NO-LOCK INDEXED-REPOSITION.
&Scoped-define TABLES-IN-QUERY-brTable1 tt-int-modelo
&Scoped-define FIRST-TABLE-IN-QUERY-brTable1 tt-int-modelo


/* Definitions for BROWSE brTable2                                      */
&Scoped-define FIELDS-IN-QUERY-brTable2 tt-int-modelo-2.cod-modelo ~
tt-int-modelo-2.desc-modelo tt-int-modelo-2.log-aps 
&Scoped-define ENABLED-FIELDS-IN-QUERY-brTable2 
&Scoped-define QUERY-STRING-brTable2 FOR EACH tt-int-modelo-2 NO-LOCK INDEXED-REPOSITION
&Scoped-define OPEN-QUERY-brTable2 OPEN QUERY brTable2 FOR EACH tt-int-modelo-2 NO-LOCK INDEXED-REPOSITION.
&Scoped-define TABLES-IN-QUERY-brTable2 tt-int-modelo-2
&Scoped-define FIRST-TABLE-IN-QUERY-brTable2 tt-int-modelo-2
...
DEFINE VARIABLE v-mod-fim AS CHARACTER FORMAT "X(20)" 
     VIEW-AS FILL-IN 
     SIZE 20 BY .79 NO-UNDO.

DEFINE VARIABLE v-mod-ini AS CHARACTER FORMAT "X(20)" 
     LABEL "Modelo" 
     VIEW-AS FILL-IN 
     SIZE 20 BY .79 NO-UNDO.
...
DEFINE QUERY brTable1 FOR 
      tt-int-modelo SCROLLING.

DEFINE QUERY brTable2 FOR 
      tt-int-modelo-2 SCROLLING.
&ANALYZE-RESUME
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS brTable1 wZoom _STRUCTURED
  QUERY brTable1 NO-LOCK DISPLAY
      tt-int-modelo.cod-modelo FORMAT "x(20)":U
      tt-int-modelo.desc-modelo COLUMN-LABEL "DescriÃ‡Æo" FORMAT "x(60)":U
            WIDTH 42
      tt-int-modelo.log-aps COLUMN-LABEL "Habilita campos" FORMAT "Sim/NÆo":U
            WIDTH 14
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS brTable2 wZoom _STRUCTURED
  QUERY brTable2 NO-LOCK DISPLAY
      tt-int-modelo-2.cod-modelo FORMAT "x(20)":U
      tt-int-modelo-2.desc-modelo COLUMN-LABEL "DescriÃ‡Æo" FORMAT "x(60)":U
            WIDTH 42
      tt-int-modelo-2.log-aps COLUMN-LABEL "Habilita campos" FORMAT "Sim/NÆo":U
            WIDTH 14
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ROW-MARKERS SEPARATORS SIZE 82 BY 9.5
...
DEFINE FRAME fPage1
     ...
     v-mod-ini AT ROW 1.75 COL 16.43 COLON-ALIGNED WIDGET-ID 2
     v-mod-fim AT ROW 1.75 COL 45 COLON-ALIGNED NO-LABEL WIDGET-ID 8
...
/* Settings for THIS-PROCEDURE
   ...
   Temp-Tables and Buffers:
      TABLE: tt-int-modelo T "?" NO-UNDO mgesp int-modelo
      ADDITIONAL-FIELDS:
          field r-rowid as rowid
      END-FIELDS.
      TABLE: tt-int-modelo-2 T "?" NO-UNDO mgesp int-modelo
      ADDITIONAL-FIELDS:
          field r-rowid as rowid
      END-FIELDS.
   END-TABLES.
...
/* SETTINGS FOR FRAME fPage1
                                                                        */
/* BROWSE-TAB brTable1 v-mod-fim fPage1 */
...
/* Query rebuild information for BROWSE brTable1
     _TblList          = "Temp-Tables.tt-int-modelo"
     _Options          = "NO-LOCK INDEXED-REPOSITION"
     _FldNameList[1]   = Temp-Tables.tt-int-modelo.cod-modelo
     _FldNameList[2]   > Temp-Tables.tt-int-modelo.desc-modelo
"tt-int-modelo.desc-modelo" "DescriÃ‡Æo" ? "character" ? ? ? ? ? ? no ? no no "42" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[3]   > Temp-Tables.tt-int-modelo.log-aps
"tt-int-modelo.log-aps" "Habilita campos" "Sim/NÆo" "logical" ? ? ? ? ? ? no ? no no "14" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _Query            is OPENED
*/  /* BROWSE brTable1 */
&ANALYZE-RESUME
...
/* Query rebuild information for BROWSE brTable2
     _TblList          = "Temp-Tables.tt-int-modelo-2"
     _Options          = "NO-LOCK INDEXED-REPOSITION"
     _FldNameList[1]   = Temp-Tables.tt-int-modelo-2.cod-modelo
     _FldNameList[2]   > Temp-Tables.tt-int-modelo-2.desc-modelo
"tt-int-modelo-2.desc-modelo" "DescriÃ‡Æo" ? "character" ? ? ? ? ? ? no ? no no "42" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[3]   > Temp-Tables.tt-int-modelo-2.log-aps
"tt-int-modelo-2.log-aps" "Habilita campos" "Sim/NÆo" "logical" ? ? ? ? ? ? no ? no no "14" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _Query            is OPENED
*/  /* BROWSE brTable2 */
&ANALYZE-RESUME
...
DO:
  ASSIGN INPUT FRAME fPage1 v-mod-ini v-mod-fim.   
...
DO:
    {zoom/Implant.i &ProgramImplant="esp/cdp/escdp104.w"
                    &PageNumber="1"}  
END.
...
DO WITH FRAME fPage1:
    ...
    ASSIGN v-mod-ini:SCREEN-VALUE = "":U
           v-mod-fim:SCREEN-VALUE = "ZZZZZZZZZZZZZZZZZZZZ":U
           v-mod-ini:SENSITIVE    = YES
           v-mod-fim:SENSITIVE    = YES
...
------------------------------------------------------------------------------*/
    ...
    IF NOT VALID-HANDLE({&hDBOTable1}) OR
       ...
       {&hDBOTable1}:FILE-NAME <> "esp\cdp\escdp104bo.p":U THEN DO:
       
        {btb/btb008za.i1 esp\cdp\escdp104bo.p YES}
        {btb/btb008za.i2 esp\cdp\escdp104bo.p '' {&hDBOTable1}} 
    END.
    
    RUN setConstraintMod IN {&hDBOTable1} (INPUT "":U , INPUT "ZZZZZZZZZZZZZZZZZZZZ":U) NO-ERROR.

    IF NOT VALID-HANDLE({&hDBOTable2}) OR
       {&hDBOTable2}:TYPE <> "PROCEDURE":U OR
       {&hDBOTable2}:FILE-NAME <> "esp\cdp\escdp104bo.p":U THEN DO:
       
        {btb/btb008za.i1 esp\cdp\escdp104bo.p YES}
        {btb/btb008za.i2 esp\cdp\escdp104bo.p '' {&hDBOTable2}} 
    END.
    
    RUN setConstraintDes IN {&hDBOTable2} (INPUT "":U , INPUT "ZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZ":U) NO-ERROR.
...
------------------------------------------------------------------------------*/
    ...
    IF AVAILABLE {&ttTable1} THEN DO:
        CASE pcField:
            WHEN "cod-modelo":U  THEN ASSIGN pcFieldValue = STRING({&ttTable1}.cod-modelo).
            WHEN "desc-modelo":U THEN ASSIGN pcFieldValue = STRING({&ttTable1}.desc-modelo).
            WHEN "log-aps":U THEN ASSIGN pcFieldValue = STRING({&ttTable1}.log-aps).
        END CASE.
    END.
...
------------------------------------------------------------------------------*/
    ...
    IF AVAILABLE {&ttTable2} THEN DO:
        CASE pcField:
            WHEN "cod-modelo":U  THEN ASSIGN pcFieldValue = STRING({&ttTable2}.cod-modelo).
            WHEN "desc-modelo":U THEN ASSIGN pcFieldValue = STRING({&ttTable2}.desc-modelo).
            WHEN "log-aps":U THEN ASSIGN pcFieldValue = STRING({&ttTable2}.log-aps).
        END CASE.
    END.
...
------------------------------------------------------------------------------*/
    ...
    CASE pPageNumber:
        WHEN 1 THEN
            ...
            RUN setConstraintMod IN {&hDBOTable1} (INPUT v-mod-ini, INPUT v-mod-fim).
