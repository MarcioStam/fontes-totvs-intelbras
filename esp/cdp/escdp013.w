...
*******************************************************************************/
{include/i-prgvrs.i ESCDP013 1.00.00.001}
...
DEFINE VARIABLE h_escdp013-q01 AS HANDLE NO-UNDO.
DEFINE VARIABLE h_escdp013-v01-2 AS HANDLE NO-UNDO.
...
DEFINE FRAME f-cad
    ...
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         ...
         AT COL 1 ROW 1
         SIZE 89.29 BY 6.71 WIDGET-ID 100.
...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'esp/cdp/escdp013-v01.w':U ,
             INPUT  FRAME f-cad:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_escdp013-v01-2 ).
       RUN set-position IN h_escdp013-v01-2 ( 2.71 , 1.57 ) NO-ERROR.
       /* Size in UIB:  ( 5.00 , 88.57 ) */

       RUN init-object IN THIS-PROCEDURE (
             INPUT  'esp/cdp/escdp013-q01.w':U ,
             INPUT  FRAME f-cad:HANDLE ,
             INPUT  'ProgPesquisa = esp/cdp/escdp013-z01.w,
                     ProgVaPara = esp/cdp/escdp013-g01.w,
                     ProgIncMod = ,
                     Implantar = no':U ,
             OUTPUT h_escdp013-q01 ).
       RUN set-position IN h_escdp013-q01 ( 1.25 , 61.00 ) NO-ERROR.
       /* Size in UIB:  ( 1.63 , 7.72 ) */

       /* Links to SmartPanel h_p-exihel. */
       RUN add-link IN adm-broker-hdl ( h_p-cadsi2 , 'State':U , h_p-exihel ).

       /* Links to SmartViewer h_escdp013-v01-2. */
       RUN add-link IN adm-broker-hdl ( h_escdp013-q01 , 'Record':U , h_escdp013-v01-2 ).
       RUN add-link IN adm-broker-hdl ( h_p-cadsi2 , 'TableIO':U , h_escdp013-v01-2 ).

       /* Links to SmartQuery h_escdp013-q01. */
       RUN add-link IN adm-broker-hdl ( h_p-exihel , 'State':U , h_escdp013-q01 ).
       RUN add-link IN adm-broker-hdl ( h_p-navega , 'Navigation':U , h_escdp013-q01 ).
       RUN add-link IN adm-broker-hdl ( h_p-navega , 'State':U , h_escdp013-q01 ).
       ...
       RUN adjust-tab-order IN adm-broker-hdl ( h_p-exihel ,
             h_p-cadsi2 , 'AFTER':U ).
       RUN adjust-tab-order IN adm-broker-hdl ( h_escdp013-v01-2 ,
             h_p-exihel , 'AFTER':U ).
    END. /* Page 0 */
...
------------------------------------------------------------------------------*/
  ...
  {utp/ut9000.i "ESCDP013" "1.00.00.001"}
