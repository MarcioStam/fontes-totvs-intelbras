...
DEFINE VARIABLE h_escdp127-b01 AS HANDLE NO-UNDO.
...
DEFINE FRAME f-zoom
     bt-implantar AT ROW 16.75 COL 3
     bt-ok AT ROW 19.5 COL 3
     bt-cancela AT ROW 19.5 COL 14
     bt-ajuda AT ROW 19.5 COL 79
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'FOLDER-LABELS = ':U + 'Dpara' + ',
                     FOLDER-TAB-TYPE = 1':U ,
             OUTPUT h_folder ).
       RUN set-position IN h_folder ( 1.17 , 1.57 ) NO-ERROR.
       RUN set-size IN h_folder ( 17.58 , 88.43 ) NO-ERROR.
    ...
    WHEN 1 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'esp/cdp/escdp127-b01.w':U ,
             INPUT  FRAME f-zoom:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_escdp127-b01 ).
       RUN set-position IN h_escdp127-b01 ( 2.50 , 3.00 ) NO-ERROR.
       /* Size in UIB:  ( 14.00 , 80.00 ) */

       /* Links to SmartBrowser h_escdp127-b01. */
       RUN add-link IN adm-broker-hdl ( h_escdp127-b01 , 'State':U , THIS-PROCEDURE ).

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_escdp127-b01 ,
             h_folder , 'AFTER':U ).
    END. /* Page 1 */
