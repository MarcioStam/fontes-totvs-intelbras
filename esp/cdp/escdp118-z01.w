...
*******************************************************************************/
{include/i-prgvrs.i ESCDP118-Z01 1.00.00.000}
...
DEFINE VARIABLE h_escdp118-b01 AS HANDLE NO-UNDO.
...
DEFINE FRAME f-zoom
     bt-implantar AT ROW 16.75 COL 1.57
     bt-ok AT ROW 18.46 COL 3
     bt-cancela AT ROW 18.46 COL 14
     bt-ajuda AT ROW 18.46 COL 79
     rt-button AT ROW 18.21 COL 2
...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW w-pesquisa ASSIGN
         HIDDEN             = YES
         TITLE              = "Pesquisa de Bem Patrimonial"
         HEIGHT             = 18.67
         WIDTH              = 90
         MAX-HEIGHT         = 41.33
         MAX-WIDTH          = 274.29
...
ON END-ERROR OF w-pesquisa /* Pesquisa de Bem Patrimonial */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL w-pesquisa w-pesquisa
ON WINDOW-CLOSE OF w-pesquisa /* Pesquisa de Bem Patrimonial */
DO:
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'FOLDER-LABELS = ':U + 'Bem' + ',
                     FOLDER-TAB-TYPE = 1':U ,
             OUTPUT h_folder ).
       RUN set-position IN h_folder ( 1.17 , 1.57 ) NO-ERROR.
       RUN set-size IN h_folder ( 15.58 , 88.57 ) NO-ERROR.
    ...
    WHEN 1 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'esp/cdp/escdp118-b01.w':U ,
             INPUT  FRAME f-zoom:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_escdp118-b01 ).
       RUN set-position IN h_escdp118-b01 ( 2.75 , 5.00 ) NO-ERROR.
       /* Size in UIB:  ( 13.25 , 80.14 ) */

       /* Links to SmartBrowser h_escdp118-b01. */
       RUN add-link IN adm-broker-hdl ( h_escdp118-b01 , 'State':U , THIS-PROCEDURE ).

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_escdp118-b01 ,
             h_folder , 'AFTER':U ).
    END. /* Page 1 */
