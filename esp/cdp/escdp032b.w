...
DEFINE INPUT-OUTPUT PARAMETER p-cod-emitente-ini LIKE crm-desc-cli.cod-emitente     NO-UNDO.
DEFINE INPUT-OUTPUT PARAMETER p-cod-emitente-fim LIKE crm-desc-cli.cod-emitente     NO-UNDO.
DEFINE INPUT-OUTPUT PARAMETER p-it-codigo-ini    LIKE crm-desc-cli.it-codigo       NO-UNDO.
DEFINE INPUT-OUTPUT PARAMETER p-it-codigo-fim    LIKE crm-desc-cli.it-codigo       NO-UNDO.
...
i-cod-emitente-ini i-cod-emitente-fim c-it-codigo-ini c-it-codigo-fim btOK ~
btCancel btHelp2 
...
DEFINE FRAME fPage0
     i-cod-emitente-ini AT ROW 1.5 COL 24.14 COLON-ALIGNED HELP
          "C¢digo do Cliente" WIDGET-ID 2
     i-cod-emitente-fim AT ROW 1.5 COL 50.43 COLON-ALIGNED HELP
          "C¢digo do Cliente" NO-LABEL WIDGET-ID 4
     c-it-codigo-ini AT ROW 2.5 COL 24.14 COLON-ALIGNED HELP
          "C¢digo do Item" WIDGET-ID 6
     c-it-codigo-fim AT ROW 2.5 COL 50.43 COLON-ALIGNED HELP
          "C¢digo do Item" NO-LABEL WIDGET-ID 8
