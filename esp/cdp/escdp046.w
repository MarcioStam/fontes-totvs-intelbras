...
*******************************************************************************/
{include/i-prgvrs.i ESCDP046 2.00.00.000}

CREATE WIDGET-POOL.

/* Preprocessors Definitions ---                                      */
&GLOBAL-DEFINE Program        ESCDP046
...
&GLOBAL-DEFINE page2Fields   c-estab-ini c-estab-fim c-dep-ini c-dep-fim 
...
DEFINE FRAME fPage2
     c-estab-ini AT ROW 2.5 COL 32 COLON-ALIGNED HELP
          "Estabelecimento Inicial"
     c-estab-fim AT ROW 2.5 COL 51.14 COLON-ALIGNED HELP
          "Estabelecimento Final" NO-LABEL
     c-dep-ini AT ROW 3.5 COL 32 COLON-ALIGNED HELP
          "Dep¢sito Inicial"
     c-dep-fim AT ROW 3.5 COL 51.14 COLON-ALIGNED HELP
          "Dep¢sito Final" NO-LABEL
     IMAGE-19 AT ROW 2.5 COL 39 WIDGET-ID 8
     IMAGE-20 AT ROW 2.5 COL 50.14 WIDGET-ID 10
     IMAGE-21 AT ROW 3.5 COL 39 WIDGET-ID 12
     IMAGE-22 AT ROW 3.5 COL 50.14 WIDGET-ID 14
...
do on error undo, return error on stop  undo, return error:
    ...
    ASSIGN tt-param.estab-ini   = INPUT FRAME fPage2 c-estab-ini
           tt-param.estab-fim   = INPUT FRAME fPage2 c-estab-fim
           tt-param.dep-ini     = INPUT FRAME fPage2 c-dep-ini
           tt-param.dep-fim     = INPUT FRAME fPage2 c-dep-fim
          .
    ...
    {report/rprun.i esp/cdp/escdp046rp.p}
