...
*******************************************************************************/
{include/i-prgvrs.i ESCDP103-Q01 1.00.00.000}
...
&IF "{&EMSFND_VERSION}" >= "1.00" &THEN
    {include/i-license-manager.i ESCDP103-Q01 ESP}
&ENDIF
...
&Scoped-define QUERY-STRING-Query-Main FOR EACH int-cor NO-LOCK INDEXED-REPOSITION
&Scoped-define OPEN-QUERY-Query-Main OPEN QUERY Query-Main FOR EACH int-cor NO-LOCK INDEXED-REPOSITION.
&Scoped-define TABLES-IN-QUERY-Query-Main int-cor
&Scoped-define FIRST-TABLE-IN-QUERY-Query-Main int-cor
