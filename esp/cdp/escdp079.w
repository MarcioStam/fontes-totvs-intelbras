...
*******************************************************************************/
{include/i-prgvrs.i escdp079 1.00.00.000}
...
&GLOBAL-DEFINE Program        escdp079
...
DEFINE VARIABLE e-layout AS CHARACTER INITIAL "Atená∆o! Os arquivos de importaá∆o devem estar em formato CSV, separado por ponto e virgula. Ex.: Item~;Cod.Familia" 
     VIEW-AS EDITOR
...
do on error undo, return error on stop  undo, return error:
    ...
    {report/rprun.i esp/cdp/escdp079rp.p}
