...
*******************************************************************************/
{include/i-prgvrs.i ESCDP087B 2.00.00.000}
...
&GLOBAL-DEFINE Program           ESCDP087B
...
&GLOBAL-DEFINE page0Fields       tt-int-portaria-movto.dt-publicacao tt-int-portaria-movto.dt-ini tt-int-portaria-movto.dt-fim tt-int-portaria-movto.observacao
...
tt-int-portaria-movto.dt-publicacao tt-int-portaria-movto.dt-ini ~
tt-int-portaria-movto.dt-fim tt-int-portaria-movto.observacao 
...
DEFINE FRAME fpage0
     ...
     tt-int-portaria-movto.codigo AT ROW 3.75 COL 17 COLON-ALIGNED WIDGET-ID 10
          ...
          VIEW-AS FILL-IN 
          SIZE 11.72 BY .88
     tt-int-portaria-movto.dt-publicacao AT ROW 4.75 COL 17 COLON-ALIGNED WIDGET-ID 16
          VIEW-AS FILL-IN 
          SIZE 10 BY .88
     tt-int-portaria-movto.dt-ini AT ROW 5.75 COL 17 COLON-ALIGNED WIDGET-ID 12
          VIEW-AS FILL-IN 
          SIZE 10 BY .88
     tt-int-portaria-movto.dt-fim AT ROW 6.75 COL 17 COLON-ALIGNED WIDGET-ID 14
          VIEW-AS FILL-IN 
          SIZE 10 BY .88
     tt-int-portaria-movto.observacao AT ROW 7.75 COL 19 NO-LABEL WIDGET-ID 18
