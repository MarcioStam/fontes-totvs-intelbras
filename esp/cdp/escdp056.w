...
*******************************************************************************/
{include/i-prgvrs.i escdp056 2.00.00.003}  /*** 010003 ***/

&IF "{&EMSFND_VERSION}" >= "1.00" &THEN
{include/i-license-manager.i escdp056 MCD}
&ENDIF
...
&GLOBAL-DEFINE Program        escdp056
...
&Scoped-Define ENABLED-OBJECTS RECT-18 RECT-7 RECT-9 rs-destino ~
bt-config-impr bt-arquivo c-arquivo rs-execucao 
...
DEFINE FRAME f-pg-sel
     c-nat-operacao-ini AT ROW 4.25 COL 25 COLON-ALIGNED HELP
          "C¢digo do Natureza inicial"
     c-nat-operacao-fim AT ROW 4.25 COL 48.29 COLON-ALIGNED HELP
          "C¢digo do Natureza final" NO-LABEL
     RECT-10 AT ROW 1 COL 1
     IMAGE-1 AT ROW 4.25 COL 39.43
     IMAGE-2 AT ROW 4.25 COL 47.29
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 3 ROW 2.85
         SIZE 76.86 BY 10.62.
...
{utp/ut9000.i "escdp056" "2.00.00.003"}
...
------------------------------------------------------------------------------*/
  ...
  DISPLAY c-nat-operacao-ini c-nat-operacao-fim 
      WITH FRAME f-pg-sel IN WINDOW w-relat.
  ENABLE RECT-10 IMAGE-1 IMAGE-2 c-nat-operacao-ini c-nat-operacao-fim 
      WITH FRAME f-pg-sel IN WINDOW w-relat.
...
do on error undo, return error on stop  undo, return error:
    ...
    if input frame f-pg-sel c-nat-operacao-ini > input frame f-pg-sel c-nat-operacao-fim then do:
       {utp/ut-field.i mgind item it-codigo 1}
       run utp/ut-msgs.p (input "SHOW",
                          input 515, 
                          input return-value).                        
       apply 'mouse-select-click' to im-pg-sel in frame f-relat.
       apply 'entry' to c-nat-operacao-ini in frame f-pg-sel.
       return 'adm-error'.       
     end.    
    ...
    then assign tt-param.arquivo = "".
     ...
     assign tt-param.c-nat-operacao-ini     = input frame f-pg-sel  c-nat-operacao-ini
    ...
    {include/i-rprun.i esp/cdp/escdp056rp.p}
