...
&Scoped-define QUERY-STRING-Query-Main FOR EACH categoria-produto NO-LOCK INDEXED-REPOSITION
&Scoped-define OPEN-QUERY-Query-Main OPEN QUERY Query-Main FOR EACH categoria-produto NO-LOCK INDEXED-REPOSITION.
&Scoped-define TABLES-IN-QUERY-Query-Main categoria-produto
&Scoped-define FIRST-TABLE-IN-QUERY-Query-Main categoria-produto
...
/* Query rebuild information for QUERY Query-Main
     _TblList          = "mgesp.categoria-produto"
