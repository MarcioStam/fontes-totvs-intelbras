...
*******************************************************************************/
{include/i-prgvrs.i escdp077 1.00.00.000}
...
&GLOBAL-DEFINE Program        escdp077
...
&GLOBAL-DEFINE page2Widgets   b-busca-arq e-layout
...
&GLOBAL-DEFINE page2Fields    c-arquivo-entrada 
...
DEFINE VARIABLE e-layout AS CHARACTER INITIAL "Atená∆o! Os arquivos de importaá∆o devem estar em formato CSV, separado por ponto e virgula. Ex.: Aá∆o I ou E (Incluir/alterar ou Excluir)~;010~;012~;Observaá∆o" 
     VIEW-AS EDITOR
     SIZE 46 BY 2 NO-UNDO.
...
DEFINE FRAME fPage2
     c-arquivo-entrada AT ROW 3.25 COL 4 COLON-ALIGNED NO-LABEL WIDGET-ID 2
     b-busca-arq AT ROW 3.25 COL 46 WIDGET-ID 14
     e-layout AT ROW 5.5 COL 5 NO-LABEL WIDGET-ID 10
     "Arquivo de Entrada" VIEW-AS TEXT
          SIZE 14 BY .54 AT ROW 2.5 COL 7 WIDGET-ID 12
...
/* SETTINGS FOR FRAME fPage2
                                                                        */
ASSIGN 
       e-layout:READ-ONLY IN FRAME fPage2        = TRUE.
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL b-busca-arq wReport
ON CHOOSE OF b-busca-arq IN FRAME fPage2
DO:
    ...
    DISP c-arquivo-entrada WITH FRAME fPage2.
...
do on error undo, return error on stop  undo, return error:
    ...
    assign tt-param.usuario       = c-seg-usuario
           ...
           tt-param.arq-entrada   = INPUT FRAME fPage2 c-arquivo-entrada
    ...
    {report/rprun.i esp\cdp\escdp077rp.p}
