...
*******************************************************************************/
{include/i-prgvrs.i ESCPD101-V01 1.00.00.001}
...
DEFINE FRAME f-main
     emitente.cod-emitente AT ROW 1.17 COL 8 COLON-ALIGNED WIDGET-ID 2
          LABEL "Cliente":R8
          VIEW-AS FILL-IN 
          SIZE 10 BY .88
     emitente.nome-emit AT ROW 1.17 COL 18.57 COLON-ALIGNED NO-LABEL WIDGET-ID 4
          VIEW-AS FILL-IN 
          SIZE 67 BY .88
...
/* SETTINGS FOR FILL-IN emitente.cod-emitente IN FRAME f-main
   NO-ENABLE EXP-LABEL                                                  */
/* SETTINGS FOR FILL-IN emitente.nome-emit IN FRAME f-main
   NO-ENABLE                                                            */
