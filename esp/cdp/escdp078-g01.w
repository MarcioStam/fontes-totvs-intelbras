...
*******************************************************************************/
{include/i-prgvrs.i ESCDP078-G01 1.00.00.001}
...
&Scoped-Define ENABLED-OBJECTS rt-button c_cod-categoria bt-ok bt-cancela ~
bt-ajuda 
&Scoped-Define DISPLAYED-OBJECTS c_cod-categoria 
...
DEFINE VARIABLE c_cod-categoria AS CHARACTER FORMAT "x(24)":U 
     LABEL "Categoria" 
     VIEW-AS FILL-IN 
...
DEFINE FRAME d-vapara
     c_cod-categoria AT ROW 2 COL 18.14 WIDGET-ID 2
    ...
    WITH VIEW-AS DIALOG-BOX KEEP-TAB-ORDER 
         ...
         TITLE "V  Para - Categoria do Produto"
...
/* SETTINGS FOR FILL-IN c_cod-categoria IN FRAME d-vapara
   ALIGN-L                                                              */
...
ON GO OF FRAME d-vapara /* V  Para - Categoria do Produto */
DO:
FIND categoria-produto NO-LOCK
    WHERE categoria-produto.cod-categoria EQ INPUT FRAME {&FRAME-NAME} c_cod-categoria NO-ERROR.

IF NOT AVAILABLE categoria-produto THEN DO:
    {utp/ut-table.i mgesp categoria-produto 1}
    RUN utp/ut-msgs.p(INPUT "show",
                      INPUT 2,
                      INPUT RETURN-VALUE).
    RETURN NO-APPLY.
END.
ASSIGN p-row-tabela = ROWID(categoria-produto).
END.
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL d-vapara d-vapara
ON WINDOW-CLOSE OF FRAME d-vapara /* V  Para - Categoria do Produto */
DO:  
...
------------------------------------------------------------------------------*/
  DISPLAY c_cod-categoria 
      WITH FRAME d-vapara.
  ENABLE rt-button c_cod-categoria bt-ok bt-cancela bt-ajuda 
      WITH FRAME d-vapara.
  VIEW FRAME d-vapara.
...
------------------------------------------------------------------------------*/
  ...
  {utp/ut9000.i "ESCDP078-G01" "1.00.00.001"}
