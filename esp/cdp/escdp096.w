...
*******************************************************************************/
{include/i-prgvrs.i ESCDP096 1.00.00.001}
...
DEFINE VARIABLE c-classif-fim AS CHARACTER FORMAT "x(15)" INITIAL "ZZZZZZZZZZZZ" 
     VIEW-AS FILL-IN 
     SIZE 15 BY .88 NO-UNDO.

DEFINE VARIABLE c-classif-ini AS CHARACTER FORMAT "x(15)" 
...
DEFINE VARIABLE c-uf-destino-fim AS CHARACTER FORMAT "X(15)":U INITIAL "ZZZZZ" 
     VIEW-AS FILL-IN 
     SIZE 7 BY .88 NO-UNDO.

DEFINE VARIABLE c-uf-destino-ini AS CHARACTER FORMAT "X(5)":U 
     LABEL "Estado Destino" 
     VIEW-AS FILL-IN 
     SIZE 7 BY .88 NO-UNDO.

DEFINE VARIABLE c-uf-origem-fim AS CHARACTER FORMAT "X(5)":U INITIAL "ZZZZZ" 
     VIEW-AS FILL-IN 
     SIZE 7 BY .88 NO-UNDO.

DEFINE VARIABLE c-uf-origem-ini AS CHARACTER FORMAT "X(5)":U 
     LABEL "Estado Origem" 
     VIEW-AS FILL-IN 
     SIZE 7 BY .88 NO-UNDO.
...
DEFINE FRAME f-pg-sel
     c-uf-origem-ini AT ROW 1.75 COL 21.86 COLON-ALIGNED
     c-uf-origem-fim AT ROW 1.75 COL 47.14 COLON-ALIGNED NO-LABEL
     c-uf-destino-ini AT ROW 2.75 COL 21.86 COLON-ALIGNED WIDGET-ID 4
     c-uf-destino-fim AT ROW 2.75 COL 47.14 COLON-ALIGNED NO-LABEL WIDGET-ID 2
     c-item-ini AT ROW 3.75 COL 14 COLON-ALIGNED HELP
          "C¢digo do Item" WIDGET-ID 12
     c-item-fim AT ROW 3.75 COL 47.14 COLON-ALIGNED NO-LABEL WIDGET-ID 10
     c-classif-ini AT ROW 4.75 COL 14 COLON-ALIGNED WIDGET-ID 20
     c-classif-fim AT ROW 4.75 COL 47.14 COLON-ALIGNED NO-LABEL WIDGET-ID 18
     IMAGE-1 AT ROW 1.75 COL 30.86
     IMAGE-2 AT ROW 1.75 COL 46.29
     IMAGE-3 AT ROW 2.75 COL 30.86 WIDGET-ID 6
     IMAGE-4 AT ROW 2.75 COL 46.29 WIDGET-ID 8
     IMAGE-5 AT ROW 3.75 COL 30.86 WIDGET-ID 14
     IMAGE-6 AT ROW 3.75 COL 46.29 WIDGET-ID 16
     IMAGE-7 AT ROW 4.75 COL 30.86 WIDGET-ID 22
     IMAGE-8 AT ROW 4.75 COL 46.29 WIDGET-ID 24
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 3 ROW 2.85
...
&Scoped-define SELF-NAME c-classif-fim
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL c-classif-fim w-relat
ON F5 OF c-classif-fim IN FRAME f-pg-sel
DO:
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL c-classif-fim w-relat
ON MOUSE-SELECT-DBLCLICK OF c-classif-fim IN FRAME f-pg-sel
DO:
   APPLY 'f5' TO SELF.
END.
...
&Scoped-define SELF-NAME c-classif-ini
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL c-classif-ini w-relat
ON F5 OF c-classif-ini IN FRAME f-pg-sel /* Classif.Fiscal */
DO:
    {include/zoomvar.i &prog-zoom="inzoom/z01in046.w"
                       &campo="c-classif-ini"
                       &campozoom="class-fiscal"
                       &campo2="c-classif-fim"
                       &campozoom2="class-fiscal"}   
END.
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL c-classif-ini w-relat
ON MOUSE-SELECT-DBLCLICK OF c-classif-ini IN FRAME f-pg-sel /* Classif.Fiscal */
DO:
   APPLY 'f5' TO SELF.
END.
...
&Scoped-define SELF-NAME c-item-fim
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL c-item-fim w-relat
ON F5 OF c-item-fim IN FRAME f-pg-sel
DO:
    {include/zoomvar.i &prog-zoom="inzoom/z01in172"
                       &campo="c-item-fim"
                       &campozoom="it-codigo"}   
END.
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL c-item-fim w-relat
ON MOUSE-SELECT-DBLCLICK OF c-item-fim IN FRAME f-pg-sel
DO:
   APPLY 'f5' TO SELF.
END.
...
&Scoped-define SELF-NAME c-item-ini
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL c-item-ini w-relat
ON F5 OF c-item-ini IN FRAME f-pg-sel /* Item */
DO:
    {include/zoomvar.i &prog-zoom="inzoom/z01in172"
                     &campo="c-item-ini"
                     &campozoom="it-codigo"
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL c-item-ini w-relat
ON MOUSE-SELECT-DBLCLICK OF c-item-ini IN FRAME f-pg-sel /* Item */
DO:
   APPLY 'f5' TO SELF.
END.
...
&Scoped-define SELF-NAME c-uf-destino-fim
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL c-uf-destino-fim w-relat
ON F5 OF c-uf-destino-fim IN FRAME f-pg-sel
DO:
    {include/zoomvar.i &prog-zoom="unzoom/z01un007.w"
                       &campo="c-uf-destino-fim"
                       &campozoom="estado"}    
END.
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL c-uf-destino-fim w-relat
ON MOUSE-SELECT-DBLCLICK OF c-uf-destino-fim IN FRAME f-pg-sel
DO:
   APPLY 'f5' TO SELF.
END.
...
&Scoped-define SELF-NAME c-uf-destino-ini
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL c-uf-destino-ini w-relat
ON F5 OF c-uf-destino-ini IN FRAME f-pg-sel /* Estado Destino */
DO:
    {include/zoomvar.i &prog-zoom="unzoom/z01un007.w"
                     &campo="c-uf-destino-ini"
                     &campozoom="estado"
                     &campo2="c-uf-destino-fim"
                     &campozoom2="estado"}   
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL c-uf-destino-ini w-relat
ON MOUSE-SELECT-DBLCLICK OF c-uf-destino-ini IN FRAME f-pg-sel /* Estado Destino */
DO:
  APPLY 'f5' TO SELF.
END.
...
&Scoped-define SELF-NAME c-uf-origem-fim
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL c-uf-origem-fim w-relat
ON F5 OF c-uf-origem-fim IN FRAME f-pg-sel
DO:
   {include/zoomvar.i &prog-zoom="unzoom/z01un007.w"
                     &campo="c-uf-origem-fim"
                     &campozoom="estado"}   
END.
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL c-uf-origem-fim w-relat
ON MOUSE-SELECT-DBLCLICK OF c-uf-origem-fim IN FRAME f-pg-sel
DO:
  APPLY 'f5' TO SELF.
END.
...
&Scoped-define SELF-NAME c-uf-origem-ini
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL c-uf-origem-ini w-relat
ON F5 OF c-uf-origem-ini IN FRAME f-pg-sel /* Estado Origem */
DO:
     
      {include/zoomvar.i &prog-zoom="unzoom/z01un007.w"
                     &campo="c-uf-origem-ini"
                     &campozoom="estado"
                     &campo2="c-uf-origem-fim"
                     &campozoom2="estado"}   
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL c-uf-origem-ini w-relat
ON MOUSE-SELECT-DBLCLICK OF c-uf-origem-ini IN FRAME f-pg-sel /* Estado Origem */
DO:
   APPLY 'f5' TO SELF.
END.
...
{utp/ut9000.i "ESCDP096" "1.00.00.001"}

IF c-uf-origem-ini   :LOAD-MOUSE-POINTER ("image/lupa.cur") IN FRAME f-pg-sel  THEN.
IF c-uf-origem-fim   :LOAD-MOUSE-POINTER ("image/lupa.cur") IN FRAME f-pg-sel  THEN.
IF c-uf-destino-ini  :LOAD-MOUSE-POINTER ("image/lupa.cur") IN FRAME f-pg-sel  THEN.
IF c-uf-destino-fim  :LOAD-MOUSE-POINTER ("image/lupa.cur") IN FRAME f-pg-sel  THEN.

IF c-item-ini   :LOAD-MOUSE-POINTER ("image/lupa.cur") IN FRAME f-pg-sel  THEN.
IF c-item-fim   :LOAD-MOUSE-POINTER ("image/lupa.cur") IN FRAME f-pg-sel  THEN.
IF c-classif-ini:LOAD-MOUSE-POINTER ("image/lupa.cur") IN FRAME f-pg-sel  THEN.
IF c-classif-fim:LOAD-MOUSE-POINTER ("image/lupa.cur") IN FRAME f-pg-sel  THEN.
...
------------------------------------------------------------------------------*/
  ...
  DISPLAY c-uf-origem-ini c-uf-origem-fim c-uf-destino-ini c-uf-destino-fim 
          c-item-ini c-item-fim c-classif-ini c-classif-fim 
      WITH FRAME f-pg-sel IN WINDOW w-relat.
  ENABLE IMAGE-1 IMAGE-2 IMAGE-3 IMAGE-4 IMAGE-5 IMAGE-6 IMAGE-7 IMAGE-8 
         c-uf-origem-ini c-uf-origem-fim c-uf-destino-ini c-uf-destino-fim 
         c-item-ini c-item-fim c-classif-ini c-classif-fim 
      WITH FRAME f-pg-sel IN WINDOW w-relat.
...
do on error undo, return error on stop  undo, return error:
    ...
    */
    ...
    assign tt-param.usuario         = c-seg-usuario
           ...
           tt-param.uf-origem-ini   = input frame f-pg-sel c-uf-origem-ini
           tt-param.uf-origem-fim   = input frame f-pg-sel c-uf-origem-fim
           tt-param.uf-destino-ini  = input frame f-pg-sel c-uf-destino-ini  
           tt-param.uf-destino-fim  = input frame f-pg-sel c-uf-destino-fim  
           
           tt-param.item-ini        = input frame f-pg-sel c-item-ini     
           tt-param.item-fim        = input frame f-pg-sel c-item-fim     
           tt-param.classif-ini     = input frame f-pg-sel c-classif-ini  
           tt-param.classif-fim     = input frame f-pg-sel c-classif-fim  
    ...
    {include/i-rprun.i esp/cdp/escdp096rp.p}
