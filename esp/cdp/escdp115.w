...
*******************************************************************************/
{include/i-prgvrs.i ESCDP115 9.99.99.999}
...
&Scoped-Define ENABLED-OBJECTS rt-button bt-importacao 
...
DEFINE VARIABLE h_escdp115-b01 AS HANDLE NO-UNDO.
DEFINE VARIABLE h_escdp115-q01 AS HANDLE NO-UNDO.
DEFINE VARIABLE h_escdp115-v01 AS HANDLE NO-UNDO.
...
DEFINE FRAME f-cad
     bt-importacao AT ROW 1.21 COL 42 WIDGET-ID 2
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL bt-importacao w-cadpaifilho-filho
ON CHOOSE OF bt-importacao IN FRAME f-cad /* Importa‡Æo */
DO:
  RUN esp\cdp\escdp115c.w.
END.
...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'esp/cdp/escdp115-v01.w':U ,
             INPUT  FRAME f-cad:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_escdp115-v01 ).
       RUN set-position IN h_escdp115-v01 ( 2.75 , 1.57 ) NO-ERROR.
       /* Size in UIB:  ( 1.25 , 88.57 ) */

       RUN init-object IN THIS-PROCEDURE (
             INPUT  'adm/objects/folder.w':U ,
             INPUT  FRAME f-cad:HANDLE ,
             INPUT  'FOLDER-LABELS = ':U + 'Segmenta‡Æo' + ',
                     FOLDER-TAB-TYPE = 1':U ,
             OUTPUT h_folder ).
       RUN set-position IN h_folder ( 4.25 , 1.00 ) NO-ERROR.
       RUN set-size IN h_folder ( 13.00 , 90.00 ) NO-ERROR.

       RUN init-object IN THIS-PROCEDURE (
             INPUT  'esp/cdp/escdp115-b01.w':U ,
             INPUT  FRAME f-cad:HANDLE ,
             INPUT  'Initial-Lock = NO-LOCK,
                     ...
                     Create-On-Add = ?,
                     ProgAtributo = ,
                     ProgIncMod = esp\cdp\escdp115b.w,
                     MessageNum = 0,
                     MessageParam = ':U ,
             OUTPUT h_escdp115-b01 ).
       RUN set-position IN h_escdp115-b01 ( 5.75 , 2.00 ) NO-ERROR.
       /* Size in UIB:  ( 10.71 , 86.00 ) */

       RUN init-object IN THIS-PROCEDURE (
             INPUT  'esp/cdp/escdp115-q01.w':U ,
             INPUT  FRAME f-cad:HANDLE ,
             INPUT  'ProgPesquisa = inzoom/z01in172.w,
                     ProgVaPara = ingo/g01in172.w,
                     ProgIncMod = ,
                     Implantar = no':U ,
             OUTPUT h_escdp115-q01 ).
       RUN set-position IN h_escdp115-q01 ( 1.25 , 62.00 ) NO-ERROR.
       /* Size in UIB:  ( 1.63 , 7.72 ) */

       /* Links to SmartPanel h_p-exihel. */
       RUN add-link IN adm-broker-hdl ( h_p-exihel , 'State':U , THIS-PROCEDURE ).

       /* Links to SmartViewer h_escdp115-v01. */
       RUN add-link IN adm-broker-hdl ( h_escdp115-q01 , 'Record':U , h_escdp115-v01 ).

       /* Links to SmartFolder h_folder. */
       RUN add-link IN adm-broker-hdl ( h_folder , 'Page':U , THIS-PROCEDURE ).

       /* Links to BrowserCadastro2 h_escdp115-b01. */
       RUN add-link IN adm-broker-hdl ( h_escdp115-q01 , 'Record':U , h_escdp115-b01 ).

       /* Links to SmartQuery h_escdp115-q01. */
       RUN add-link IN adm-broker-hdl ( h_p-exihel , 'State':U , h_escdp115-q01 ).
       RUN add-link IN adm-broker-hdl ( h_p-navega , 'Navigation':U , h_escdp115-q01 ).
       RUN add-link IN adm-broker-hdl ( h_p-navega , 'State':U , h_escdp115-q01 ).

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_p-exihel ,
             bt-importacao:HANDLE IN FRAME f-cad , 'BEFORE':U ).
       RUN adjust-tab-order IN adm-broker-hdl ( h_p-navega ,
             h_p-exihel , 'AFTER':U ).
       RUN adjust-tab-order IN adm-broker-hdl ( h_escdp115-v01 ,
             bt-importacao:HANDLE IN FRAME f-cad , 'AFTER':U ).
       RUN adjust-tab-order IN adm-broker-hdl ( h_folder ,
             h_escdp115-v01 , 'AFTER':U ).
       RUN adjust-tab-order IN adm-broker-hdl ( h_escdp115-b01 ,
             h_folder , 'AFTER':U ).
    END. /* Page 0 */
...
------------------------------------------------------------------------------*/
  ENABLE rt-button bt-importacao 
...
------------------------------------------------------------------------------*/
  ...
  {utp/ut9000.i "ESCDP115" "2.00.00.001"}
