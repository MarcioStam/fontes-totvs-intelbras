...
*******************************************************************************/
{include/i-prgvrs.i ESCDP054 2.00.00.000}

CREATE WIDGET-POOL.

/* Preprocessors Definitions ---                                      */
&GLOBAL-DEFINE Program        ESCDP054
...
&GLOBAL-DEFINE page7Widgets   rs-atualiza ~
                              rsDestiny ~
                              btConfigImprDest ~
                              btDestinyFile ~
                              rsExecution
...
DEFINE VARIABLE text-entrada AS CHARACTER FORMAT "X(256)":U INITIAL "Diret¢rio de Entrada" 
      VIEW-AS TEXT 
     SIZE 14.86 BY .63
     FONT 1 NO-UNDO.
...
DEFINE FRAME fPage7
     rs-atualiza AT ROW 2.25 COL 3.14 NO-LABEL
     rsDestiny AT ROW 4.25 COL 3.14 HELP
          "Destino de ImpressÆo do Relat¢rio" NO-LABEL
     btDestinyFile AT ROW 5.46 COL 43.14 HELP
          "Escolha do nome do arquivo"
     btConfigImprDest AT ROW 5.46 COL 43.14 HELP
          "Configura‡Æo da impressora"
     cDestinyFile AT ROW 5.5 COL 3.14 HELP
          "Nome do arquivo de destino do relat¢rio" NO-LABEL
     rsExecution AT ROW 7.75 COL 3.14 HELP
          "Modo de Execu‡Æo" NO-LABEL
     text-imprime AT ROW 1.5 COL 2 COLON-ALIGNED NO-LABEL
     text-destino AT ROW 3.5 COL 1.86 COLON-ALIGNED NO-LABEL
     text-modo AT ROW 7 COL 1.14 COLON-ALIGNED NO-LABEL
     rect-8 AT ROW 7.29 COL 2
     RECT-11 AT ROW 1.75 COL 2
     rect-rtf-2 AT ROW 3.79 COL 2
...
DO:
    ...
    assign cArqConv = replace(input frame fpage4 cInputFile, "/":U, "\":U).
    ...
    if  l-ok = yes then do:
        assign cInputFile = replace(cArqConv, "\":U, "/":U).
...
/*                       OUTPUT l-cancel).                         */
/*                                                                 */
/*     IF NOT(l-cancel) THEN                                       */
/*         ASSIGN cInputFile:SCREEN-VALUE IN FRAME fPage4 = c-dir. */
/*     ELSE                                                        */
/*         ASSIGN cInputFile:SCREEN-VALUE IN FRAME fPage4 = "":U.  */
END.
...
DO  ON ERROR UNDO, RETURN ERROR
    ...
    ASSIGN tt-param.usuario         = c-seg-usuario
           ...
           tt-param.atualiza        = INPUT FRAME fPage7 rs-atualiza
           tt-param.dir-entrada     = INPUT FRAME fPage4 cInputFile
    ...
    then 
        ...
        then assign tt-param.arquivo = input frame fPage7 cDestinyFile.
    ...
    {report/imrun.i esp/cdp/escdp054rp.p}
