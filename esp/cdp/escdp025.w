...
*******************************************************************************/
{include/i-prgvrs.i ESCDP025 2.00.00.001}

CREATE WIDGET-POOL.

/* Preprocessors Definitions ---                                      */
&GLOBAL-DEFINE Program        ESCDP025
&GLOBAL-DEFINE Version        2.00.00.001

&GLOBAL-DEFINE Folder         YES
&GLOBAL-DEFINE InitialPage    1
&GLOBAL-DEFINE FolderLabels   Categorias
...
&Scoped-define INTERNAL-TABLES crm-categ-un

/* Definitions for BROWSE brSon                                         */
&Scoped-define FIELDS-IN-QUERY-brSon crm-categ-un.cd-categoria ~
fnDsCategoria(crm-categ-un.cd-categoria) @ c-ds-categoria 
&Scoped-define ENABLED-FIELDS-IN-QUERY-brSon 
&Scoped-define QUERY-STRING-brSon FOR EACH crm-categ-un ~
      WHERE crm-categ-un.cd-unid-negoc = INPUT FRAME fPage0 tt-unid-comerc.cd-unid-comerc NO-LOCK
&Scoped-define OPEN-QUERY-brSon OPEN QUERY brSon FOR EACH crm-categ-un ~
      WHERE crm-categ-un.cd-unid-negoc = INPUT FRAME fPage0 tt-unid-comerc.cd-unid-comerc NO-LOCK.
&Scoped-define TABLES-IN-QUERY-brSon crm-categ-un
&Scoped-define FIRST-TABLE-IN-QUERY-brSon crm-categ-un
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS brSon wMaintenance _STRUCTURED
  QUERY brSon NO-LOCK DISPLAY
      crm-categ-un.cd-categoria COLUMN-LABEL "C¢d" FORMAT ">>9":U
            WIDTH 6.43
      fnDsCategoria(crm-categ-un.cd-categoria) @ c-ds-categoria COLUMN-LABEL "Descri‡Æo" FORMAT "x(30)":U
            WIDTH 92.43
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
...
DEFINE FRAME fPage1
     ...
     btDeleteSon AT ROW 10.33 COL 12.14
...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW wMaintenance ASSIGN
         HIDDEN             = YES
         TITLE              = "Categoria x Unidade Comercial"
         HEIGHT             = 17
         WIDTH              = 111
         MAX-HEIGHT         = 27.54
         MAX-WIDTH          = 182.86
...
/* Query rebuild information for BROWSE brSon
     _TblList          = "mgesp.crm-categ-un"
     _Options          = "NO-LOCK"
     _Where[1]         = "mgesp.crm-categ-un.cd-unid-negoc = INPUT FRAME fPage0 tt-unid-comerc.cd-unid-comerc"
     _FldNameList[1]   > mgesp.crm-categ-un.cd-categoria
"crm-categ-un.cd-categoria" "C¢d" ? "integer" ? ? ? ? ? ? no ? no no "6.43" yes no no "U" "" ""
     _FldNameList[2]   > "_<CALC>"
"fnDsCategoria(crm-categ-un.cd-categoria) @ c-ds-categoria" "Descri‡Æo" "x(30)" ? ? ? ? ? ? ? no ? no no "92.43" yes no no "U" "" ""
     _Query            is OPENED
*/  /* BROWSE brSon */
&ANALYZE-RESUME
...
ON END-ERROR OF wMaintenance /* Categoria x Unidade Comercial */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL wMaintenance wMaintenance
ON WINDOW-CLOSE OF wMaintenance /* Categoria x Unidade Comercial */
DO:
...
------------------------------------------------------------------------------*/
    ...
    DEFINE FRAME fGoToRecord
        ...
        WITH VIEW-AS DIALOG-BOX KEEP-TAB-ORDER SIDE-LABELS NO-UNDERLINE 
             THREE-D SCROLLABLE TITLE "V  Para Unidade de Comercial" FONT 1
