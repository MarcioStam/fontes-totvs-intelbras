...
*******************************************************************************/
{include/i-prgvrs.i ESCDP111-Q01 1.00.00.000}
...
&IF "{&EMSFND_VERSION}" >= "1.00" &THEN
    {include/i-license-manager.i ESCDP111-Q01 ESP}
&ENDIF
...
&Scoped-define INTERNAL-TABLES int-gm-recurso

/* Definitions for QUERY Query-Main                                     */
&Scoped-define QUERY-STRING-Query-Main FOR EACH int-gm-recurso NO-LOCK ~
    ~{&SORTBY-PHRASE} INDEXED-REPOSITION
&Scoped-define OPEN-QUERY-Query-Main OPEN QUERY Query-Main FOR EACH int-gm-recurso NO-LOCK ~
    ~{&SORTBY-PHRASE} INDEXED-REPOSITION.
&Scoped-define TABLES-IN-QUERY-Query-Main int-gm-recurso
&Scoped-define FIRST-TABLE-IN-QUERY-Query-Main int-gm-recurso
