...
&Scoped-Define DISPLAYED-FIELDS item.it-codigo item.desc-item 
...
<FOREIGN-KEYS>
it-codigo|y|y|mgcad.item.it-codigo
...
RUN set-attribute-list (
    'Keys-Accepted = "it-codigo",
     Keys-Supplied = "it-codigo,fm-codigo,class-fiscal,cod-comprado,cod-estabel,fm-cod-com,cod-produto,ge-codigo,cod-tax,cod-servico,cd-tag,nr-linha,cd-planejado,cod-refer,un,nat-despesa,cod-pulmao,cod-unid-negoc"':U).
/**************************
</EXECUTING-CODE> */
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
...
DEFINE FRAME f-main
     item.it-codigo AT ROW 1.17 COL 3.86 COLON-ALIGNED WIDGET-ID 4
          VIEW-AS FILL-IN 
          SIZE 17.14 BY .88
     item.desc-item AT ROW 1.17 COL 21.14 COLON-ALIGNED NO-LABEL WIDGET-ID 2
          VIEW-AS FILL-IN 
          SIZE 61.14 BY .88
...
/* SETTINGS FOR FILL-IN item.desc-item IN FRAME f-main
   NO-ENABLE                                                            */
/* SETTINGS FOR FILL-IN item.it-codigo IN FRAME f-main
   NO-ENABLE                                                            */
  ...
  CASE RETURN-VALUE:
    WHEN 'it-codigo':U THEN
       {src/adm/template/find-tbl.i
           &TABLE = item
           &WHERE = "WHERE item.it-codigo eq key-value"
       }
  END CASE.
