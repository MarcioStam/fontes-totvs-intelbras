...
*******************************************************************************/
{include/i-prgvrs.i ESCPD102-Q01 1.00.00.001}
...
&Scoped-define QUERY-STRING-Query-Main FOR EACH int-gr-cli-catalogo NO-LOCK
&Scoped-define OPEN-QUERY-Query-Main OPEN QUERY Query-Main FOR EACH int-gr-cli-catalogo NO-LOCK.
&Scoped-define TABLES-IN-QUERY-Query-Main int-gr-cli-catalogo
&Scoped-define FIRST-TABLE-IN-QUERY-Query-Main int-gr-cli-catalogo
...
Cod-emitente|||mgesp.int-gr-cli-catalogo.Cod-emitente
</FOREIGN-KEYS> 
<EXECUTING-CODE>
**************************
...
/* Query rebuild information for QUERY Query-Main
     _TblList          = "mgesp.int-gr-cli-catalogo"
     _Options          = "NO-LOCK"
