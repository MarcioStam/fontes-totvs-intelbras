...
*******************************************************************************/
{include/i-prgvrs.i escdp005 1.00.00.000}

CREATE WIDGET-POOL.

/* Preprocessors Definitions ---                                      */
&GLOBAL-DEFINE Program        escdp005
...
&GLOBAL-DEFINE page2Widgets   editor-1 fi-grp-cli-ini fi-grp-cli-fim rs-tipo
...
&Scoped-Define ENABLED-OBJECTS rtToolBar IMAGE-6 btOK btCancel btHelp2 
...
DEFINE VARIABLE EDITOR-1 AS CHARACTER 
     VIEW-AS EDITOR
     SIZE 78 BY 6.25 NO-UNDO.

DEFINE VARIABLE fi-grp-cli-fim AS CHARACTER FORMAT "X(256)":U INITIAL "zz" 
     VIEW-AS FILL-IN 
     SIZE 7 BY .88 NO-UNDO.

DEFINE VARIABLE fi-grp-cli-ini AS CHARACTER FORMAT "X(256)":U 
     LABEL "Grupo Cliente" 
     VIEW-AS FILL-IN 
     SIZE 7 BY .88 NO-UNDO.
...
DEFINE FRAME fpage0
     ...
     IMAGE-6 AT ROW 4.96 COL 47.86 WIDGET-ID 2
...
DEFINE FRAME fPage2
     EDITOR-1 AT ROW 1.25 COL 5 NO-LABEL WIDGET-ID 2 NO-TAB-STOP 
     fi-grp-cli-ini AT ROW 8 COL 12 COLON-ALIGNED WIDGET-ID 8
     fi-grp-cli-fim AT ROW 8 COL 28 COLON-ALIGNED NO-LABEL WIDGET-ID 10
     rs-tipo AT ROW 9.5 COL 15 NO-LABEL WIDGET-ID 4
     IMAGE-9 AT ROW 8 COL 22 WIDGET-ID 12
     IMAGE-8 AT ROW 8 COL 27 WIDGET-ID 14
    WITH 1 DOWN KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 3.57 ROW 2.81
         SIZE 84.43 BY 10.15
...
------------------------------------------------------------------------------*/
    assign EDITOR-1:screen-value in frame fPage2 = 
        'Este programa ir† Ler todos os clientes e' + chr(10) + chr(10) +
        'verificar se houve faturamento nos ultimos 200 dias ' +
        '' + chr(10) + chr(10) +
        'Caso n∆o houve dever† desativar o cliente'.
END PROCEDURE.
...
do on error undo, return error on stop  undo, return error:
    ...
    assign tt-param.usuario         = c-seg-usuario
           ...
           tt-param.grupo-cli-ini   = input frame fPage2 fi-grp-cli-ini
           tt-param.grupo-cli-fim   = input frame fPage2 fi-grp-cli-fim
    ...
    {report/rprun.i esp/cdp/escdp005rp.p}
