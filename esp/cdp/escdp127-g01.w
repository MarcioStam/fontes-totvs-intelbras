...
*******************************************************************************/
{include/i-prgvrs.i ESCDP127-G01 9.99.99.999}
...
&Scoped-Define ENABLED-OBJECTS rt-button RECT-1 c_nat-operacao-cte ~
c_nat-operacao-nfs c_nat-operacao-para bt-ok bt-cancela bt-ajuda 
&Scoped-Define DISPLAYED-OBJECTS c_nat-operacao-cte c_nat-operacao-nfs ~
c_nat-operacao-para 
...
DEFINE VARIABLE c_nat-operacao-cte AS CHARACTER FORMAT "x(06)":U 
     LABEL "Nat Opera‡Æo Cte" 
     VIEW-AS FILL-IN 
     SIZE 12 BY .88 NO-UNDO.

DEFINE VARIABLE c_nat-operacao-nfs AS CHARACTER FORMAT "x(06)":U 
     LABEL "Nat Opera‡Æo Nfs" 
     VIEW-AS FILL-IN 
     SIZE 12 BY .88 NO-UNDO.

DEFINE VARIABLE c_nat-operacao-para AS CHARACTER FORMAT "x(06)":U 
     LABEL "Nat Opera‡Æo Para" 
     VIEW-AS FILL-IN 
     SIZE 12 BY .88 NO-UNDO.
...
DEFINE FRAME d-vapara
     c_nat-operacao-cte AT ROW 1.17 COL 29.57 COLON-ALIGNED WIDGET-ID 2
     c_nat-operacao-nfs AT ROW 2.17 COL 29.57 COLON-ALIGNED WIDGET-ID 4
     c_nat-operacao-para AT ROW 3.17 COL 29.57 COLON-ALIGNED WIDGET-ID 6
     bt-ok AT ROW 5 COL 2.14
     bt-cancela AT ROW 5 COL 13
     bt-ajuda AT ROW 5 COL 58
     rt-button AT ROW 4.75 COL 1
     RECT-1 AT ROW 1 COL 1 WIDGET-ID 8
     SPACE(0.13) SKIP(1.99)
...
DO:
FIND int-natur-oper-cte NO-LOCK
    WHERE int-natur-oper-cte.nat-operacao-cte EQ INPUT FRAME {&FRAME-NAME} c_nat-operacao-cte
      AND int-natur-oper-cte.nat-operacao-nfs EQ INPUT FRAME {&FRAME-NAME} c_nat-operacao-nfs
      AND int-natur-oper-cte.nat-operacao-para EQ INPUT FRAME {&FRAME-NAME} c_nat-operacao-para NO-ERROR.

IF NOT AVAILABLE int-natur-oper-cte THEN DO:
    {utp/ut-table.i mgesp int-natur-oper-cte 1}
    RUN utp/ut-msgs.p(INPUT "show",
                      INPUT 2,
                      INPUT RETURN-VALUE).
    RETURN NO-APPLY.
END.
ASSIGN p-row-tabela = ROWID(int-natur-oper-cte).
END.
...
------------------------------------------------------------------------------*/
  DISPLAY c_nat-operacao-cte c_nat-operacao-nfs c_nat-operacao-para 
      WITH FRAME d-vapara.
  ENABLE rt-button RECT-1 c_nat-operacao-cte c_nat-operacao-nfs 
         c_nat-operacao-para bt-ok bt-cancela bt-ajuda 
      WITH FRAME d-vapara.
  VIEW FRAME d-vapara.
...
------------------------------------------------------------------------------*/
  ...
  {utp/ut9000.i "ESCDP127-G01" "9.99.99.999"}
