...
*******************************************************************************/
{include/i-prgvrs.i ESCDP111B 1.00.00.000}
...
&IF "{&EMSFND_VERSION}" >= "1.00" &THEN
    {include/i-license-manager.i ESCDP111B ESP}
&ENDIF
...
DEFINE VARIABLE h_escdp111-q01 AS HANDLE NO-UNDO.
DEFINE VARIABLE h_escdp111-v02 AS HANDLE NO-UNDO.
...
DEFINE FRAME f-cad
     bt-ok AT ROW 5.33 COL 2.57 HELP
          "Salva e sai"
     bt-save AT ROW 5.33 COL 13 HELP
          "Salva e cria novo"
     bt-cancela AT ROW 5.33 COL 23.57 HELP
          "Cancela"
     bt-ajuda AT ROW 5.33 COL 70.72
     rt-button AT ROW 5.17 COL 1.57
...
ON END-ERROR OF w-cadsim /* Inclui/Modifica Recurso */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL w-cadsim w-cadsim
ON WINDOW-CLOSE OF w-cadsim /* Inclui/Modifica Recurso */
DO:
...
DO:
{include/okfil.i h_escdp111-v02}
END.
...
DO:
{include/salvafil.i h_escdp111-v02}
END.
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'esp/cdp/escdp111-v02.w':U ,
             INPUT  FRAME f-cad:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_escdp111-v02 ).
       RUN set-position IN h_escdp111-v02 ( 1.25 , 1.00 ) NO-ERROR.
       /* Size in UIB:  ( 3.75 , 79.29 ) */

       RUN init-object IN THIS-PROCEDURE (
             INPUT  'esp/cdp/escdp111-q01.w':U ,
             INPUT  FRAME f-cad:HANDLE ,
             INPUT  '':U ,
             OUTPUT h_escdp111-q01 ).
       RUN set-position IN h_escdp111-q01 ( 5.00 , 48.00 ) NO-ERROR.
       /* Size in UIB:  ( 1.63 , 7.72 ) */

       /* Links to SmartViewer h_escdp111-v02. */
       RUN add-link IN adm-broker-hdl ( h_escdp111-q01 , 'Record':U , h_escdp111-v02 ).
       RUN add-link IN adm-broker-hdl ( THIS-PROCEDURE , 'TABLEIO':U , h_escdp111-v02 ).

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_escdp111-v02 ,
...
------------------------------------------------------------------------------*/
  ...
  {utp/ut9000.i "ESCDP111B" "1.00.00.000"}

  /* Dispatch standard ADM method.                             */
  RUN dispatch IN THIS-PROCEDURE ( INPUT 'initialize':U ) .

  run pi-atualiza-parent in h_escdp111-v02 (input v-row-parent).
...
/*------------------------------------------------------------------------------
  ...
  Notes:       
------------------------------------------------------------------------------*/
  RUN pi-reposiciona-query IN h_escdp111-q01 (input v-row-table).
