...
*******************************************************************************/
{include/i-prgvrs.i ESCDP117 1.00.00.001}
...
DEFINE VARIABLE fi-data-ini AS DATE FORMAT "99/99/9999":U INITIAL 07/01/22 
     LABEL "Data Hist¢rico" 
     VIEW-AS FILL-IN 
     SIZE 16 BY .88 NO-UNDO.
...
DEFINE FRAME f-pg-sel
     fi-item-ini AT ROW 1.54 COL 12.72 COLON-ALIGNED
     fi-item-fim AT ROW 1.54 COL 46 COLON-ALIGNED NO-LABEL
     fi-data-ini AT ROW 2.54 COL 12.72 COLON-ALIGNED WIDGET-ID 8
     fi-data-fim AT ROW 2.54 COL 46 COLON-ALIGNED NO-LABEL WIDGET-ID 6
     rs-tipo AT ROW 4.25 COL 24 NO-LABEL WIDGET-ID 2
     IMAGE-1 AT ROW 1.54 COL 30.86
     IMAGE-2 AT ROW 1.54 COL 45.14
     IMAGE-3 AT ROW 2.54 COL 30.86 WIDGET-ID 10
     IMAGE-4 AT ROW 2.54 COL 45.14 WIDGET-ID 12
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 3 ROW 2.85
...
{utp/ut9000.i "ESCDP117" "1.00.00.001"}
...
------------------------------------------------------------------------------*/
  ...
  DISPLAY fi-item-ini fi-item-fim fi-data-ini fi-data-fim rs-tipo 
      WITH FRAME f-pg-sel IN WINDOW w-relat.
  ENABLE IMAGE-1 IMAGE-2 IMAGE-3 IMAGE-4 fi-item-ini fi-item-fim fi-data-ini 
         fi-data-fim rs-tipo 
      WITH FRAME f-pg-sel IN WINDOW w-relat.
...
do on error undo, return error on stop  undo, return error:
    ...
    {include/i-rprun.i esp/cdp/escdp117rp.p}
