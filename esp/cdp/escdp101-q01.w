...
*******************************************************************************/
{include/i-prgvrs.i ESCPD101-Q01 1.00.00.001}
...
&Scoped-define QUERY-STRING-Query-Main FOR EACH int-emitente-desc NO-LOCK
&Scoped-define OPEN-QUERY-Query-Main OPEN QUERY Query-Main FOR EACH int-emitente-desc NO-LOCK.
&Scoped-define TABLES-IN-QUERY-Query-Main int-emitente-desc
&Scoped-define FIRST-TABLE-IN-QUERY-Query-Main int-emitente-desc
...
/* Query rebuild information for QUERY Query-Main
     _TblList          = "mgesp.int-emitente-desc"
     _Options          = "NO-LOCK"
