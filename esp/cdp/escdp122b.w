...
*******************************************************************************/
{include/i-prgvrs.i ESCDP122B 1.00.00.000}
...
&IF "{&EMSFND_VERSION}" >= "1.00" &THEN
    {include/i-license-manager.i ESCDP122B ESP}
&ENDIF
...
DEFINE VARIABLE h_escdp122-q02 AS HANDLE NO-UNDO.
DEFINE VARIABLE h_escdp122-v02 AS HANDLE NO-UNDO.
...
DEFINE FRAME f-cad
     bt-ok AT ROW 3.92 COL 2 HELP
          "Salva e sai"
     bt-save AT ROW 3.92 COL 12.43 HELP
          "Salva e cria novo"
     bt-cancela AT ROW 3.92 COL 23 HELP
          "Cancela"
     bt-ajuda AT ROW 3.92 COL 70.14
     rt-button AT ROW 3.75 COL 1
...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW w-cadsim ASSIGN
         HIDDEN             = YES
         TITLE              = "Inclui/Modifica Conta Pat UEP"
         HEIGHT             = 4.38
         WIDTH              = 80.72
         MAX-HEIGHT         = 41.33
         MAX-WIDTH          = 274.29
...
ON END-ERROR OF w-cadsim /* Inclui/Modifica Conta Pat UEP */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL w-cadsim w-cadsim
ON WINDOW-CLOSE OF w-cadsim /* Inclui/Modifica Conta Pat UEP */
DO:
...
DO:
{include/okfil.i h_escdp122-v02}
END.
...
DO:
{include/salvafil.i h_escdp122-v02}
END.
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'esp/cdp/escdp122-v02.w':U ,
             INPUT  FRAME f-cad:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_escdp122-v02 ).
       RUN set-position IN h_escdp122-v02 ( 1.25 , 1.00 ) NO-ERROR.
       /* Size in UIB:  ( 2.25 , 79.29 ) */

       RUN init-object IN THIS-PROCEDURE (
             INPUT  'esp/cdp/escdp122-q02.w':U ,
             INPUT  FRAME f-cad:HANDLE ,
             INPUT  '':U ,
             OUTPUT h_escdp122-q02 ).
       RUN set-position IN h_escdp122-q02 ( 3.75 , 45.00 ) NO-ERROR.
       /* Size in UIB:  ( 1.63 , 7.72 ) */

       /* Links to SmartViewer h_escdp122-v02. */
       RUN add-link IN adm-broker-hdl ( h_escdp122-q02 , 'Record':U , h_escdp122-v02 ).
       RUN add-link IN adm-broker-hdl ( THIS-PROCEDURE , 'TableIO':U , h_escdp122-v02 ).

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_escdp122-v02 ,
...
------------------------------------------------------------------------------*/
  ...
  {utp/ut9000.i "ESCDP122B" "1.00.00.000"}

  /* Dispatch standard ADM method.                             */
  RUN dispatch IN THIS-PROCEDURE ( INPUT 'initialize':U ) .

  run pi-atualiza-parent in h_escdp122-v02 (input v-row-parent).
...
/*------------------------------------------------------------------------------
  ...
  Notes:       
------------------------------------------------------------------------------*/
  RUN pi-reposiciona-query IN h_escdp122-q02 (input v-row-table).
