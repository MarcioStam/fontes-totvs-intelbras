...
DEFINE TEMP-TABLE tt-crm-desc-gc-cat NO-UNDO LIKE crm-desc-gc-cat
...
*******************************************************************************/
{include/i-prgvrs.i ESCDP029 2.00.00.001}

CREATE WIDGET-POOL.

/* Preprocessors Definitions ---                                      */
&GLOBAL-DEFINE Program        ESCDP029
...
&Scoped-define INTERNAL-TABLES crm-desc-gc-cat

/* Definitions for BROWSE brSon                                         */
&Scoped-define FIELDS-IN-QUERY-brSon ~
fnDsGrCli(crm-desc-gc-cat.cod-gr-cli) @ c-ds-gr-cli ~
fnDsCategoria(crm-desc-gc-cat.cd-categoria) @ c-ds-categoria ~
crm-desc-gc-cat.dt-vigencia-ini crm-desc-gc-cat.dt-vigencia-fim ~
crm-desc-gc-cat.pc-desconto 
&Scoped-define ENABLED-FIELDS-IN-QUERY-brSon 
&Scoped-define QUERY-STRING-brSon FOR EACH crm-desc-gc-cat ~
      WHERE crm-desc-gc-cat.cd-unid-negoc = INPUT FRAME fPage0 tt-unid-comerc.cd-unid-comerc NO-LOCK
&Scoped-define OPEN-QUERY-brSon OPEN QUERY brSon FOR EACH crm-desc-gc-cat ~
      WHERE crm-desc-gc-cat.cd-unid-negoc = INPUT FRAME fPage0 tt-unid-comerc.cd-unid-comerc NO-LOCK.
&Scoped-define TABLES-IN-QUERY-brSon crm-desc-gc-cat
&Scoped-define FIRST-TABLE-IN-QUERY-brSon crm-desc-gc-cat
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS brSon wMaintenance _STRUCTURED
  QUERY brSon NO-LOCK DISPLAY
      fnDsGrCli(crm-desc-gc-cat.cod-gr-cli) @ c-ds-gr-cli COLUMN-LABEL "Gr Cli" FORMAT "x(30)":U
            WIDTH 32.72
      fnDsCategoria(crm-desc-gc-cat.cd-categoria) @ c-ds-categoria COLUMN-LABEL "Categoria" FORMAT "x(30)":U
            WIDTH 20.57
      crm-desc-gc-cat.dt-vigencia-ini FORMAT "99/99/9999":U WIDTH 16.57
      crm-desc-gc-cat.dt-vigencia-fim FORMAT "99/99/9999":U WIDTH 15.72
      crm-desc-gc-cat.pc-desconto FORMAT ">>9.99":U WIDTH 11.43
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
...
/* Settings for THIS-PROCEDURE
   ...
   Temp-Tables and Buffers:
      TABLE: tt-crm-desc-gc-cat T "?" NO-UNDO mgesp crm-desc-gc-cat
      ADDITIONAL-FIELDS:
          field r-rowid as rowid
      END-FIELDS.
...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW wMaintenance ASSIGN
         HIDDEN             = YES
         TITLE              = "Desconto por Unidade de Neg¢cio x Grupo de Cliente x Categoria"
         HEIGHT             = 17
         WIDTH              = 111
         MAX-HEIGHT         = 27.54
         MAX-WIDTH          = 182.86
...
/* Query rebuild information for BROWSE brSon
     _TblList          = "mgesp.crm-desc-gc-cat"
     _Options          = "NO-LOCK"
     _Where[1]         = "mgesp.crm-desc-gc-cat.cd-unid-negoc = INPUT FRAME fPage0 tt-unid-comerc.cd-unid-comerc"
     _FldNameList[1]   > "_<CALC>"
"fnDsGrCli(crm-desc-gc-cat.cod-gr-cli) @ c-ds-gr-cli" "Gr Cli" "x(30)" ? ? ? ? ? ? ? no ? no no "32.72" yes no no "U" "" ""
     _FldNameList[2]   > "_<CALC>"
"fnDsCategoria(crm-desc-gc-cat.cd-categoria) @ c-ds-categoria" "Categoria" "x(30)" ? ? ? ? ? ? ? no ? no no "20.57" yes no no "U" "" ""
     _FldNameList[3]   > mgesp.crm-desc-gc-cat.dt-vigencia-ini
"crm-desc-gc-cat.dt-vigencia-ini" ? ? "date" ? ? ? ? ? ? no ? no no "16.57" yes no no "U" "" ""
     _FldNameList[4]   > mgesp.crm-desc-gc-cat.dt-vigencia-fim
"crm-desc-gc-cat.dt-vigencia-fim" ? ? "date" ? ? ? ? ? ? no ? no no "15.72" yes no no "U" "" ""
     _FldNameList[5]   > mgesp.crm-desc-gc-cat.pc-desconto
"crm-desc-gc-cat.pc-desconto" ? ? "decimal" ? ? ? ? ? ? no ? no no "11.43" yes no no "U" "" ""
     _Query            is OPENED
*/  /* BROWSE brSon */
&ANALYZE-RESUME
...
ON END-ERROR OF wMaintenance /* Desconto por Unidade de Neg¢cio x Grupo de Cliente x Categoria */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL wMaintenance wMaintenance
ON WINDOW-CLOSE OF wMaintenance /* Desconto por Unidade de Neg¢cio x Grupo de Cliente x Categoria */
DO:
...
DO:
    ...
    RUN esp/cdp/escdp029a.w (INPUT "Create":U,
...
DO:
    ...
    RUN esp/cdp/escdp029a.w (INPUT "Copy":U,
                             INPUT tt-unid-comerc.cd-unid-comerc,
                             INPUT IF AVAIL crm-desc-gc-cat THEN ROWID(crm-desc-gc-cat) ELSE ?).
...
DO:
    ...
    IF  RETURN-VALUE = "YES" THEN DO:
        FIND CURRENT crm-desc-gc-cat EXCLUSIVE-LOCK NO-ERROR.
        IF  AVAIL  crm-desc-gc-cat THEN
            DELETE crm-desc-gc-cat.
    END.
...
DO:
    ...
    RUN esp/cdp/escdp029a.w (INPUT "Update":U,
                             INPUT tt-unid-comerc.cd-unid-comerc,
                             INPUT IF AVAIL crm-desc-gc-cat THEN ROWID(crm-desc-gc-cat) ELSE ?).
...
------------------------------------------------------------------------------*/
    ...
    IF  CAN-FIND(FIRST crm-desc-gc-cat
                 WHERE crm-desc-gc-cat.cd-unid-negoc = STRING(tt-unid-comerc.cd-unid-comerc)) THEN DO:
        ENABLE btCopySon
               btUpdateSon
               btDeleteSon
            WITH FRAME fPage1.
