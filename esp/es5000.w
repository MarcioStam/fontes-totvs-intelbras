...
*******************************************************************************/
{include/i-prgvrs.i ES5000 2.00.00.000}
...
/*     {include/i-license-manager.i es5000 fgl} */
/* &ENDIF                                       */
...
&Scoped-define ENABLED-FIELDS-IN-QUERY-br-digita */ /* tt-digita.ordem ~
*/ /* tt-digita.exemplo   */   
...
DEFINE VARIABLE c-empresa AS CHARACTER FORMAT "X(3)":U 
     LABEL "Empresa" 
     VIEW-AS FILL-IN 
     SIZE 8.57 BY .88 NO-UNDO.

DEFINE VARIABLE c-plano-cc AS CHARACTER FORMAT "X(8)":U 
     LABEL "Plano Ccustos" 
     VIEW-AS FILL-IN 
     SIZE 14 BY .88 NO-UNDO.

DEFINE VARIABLE c-plano-cta AS CHARACTER FORMAT "X(8)":U 
     LABEL "Plano Contas" 
     VIEW-AS FILL-IN 
     SIZE 14 BY .88 NO-UNDO.
...
DEFINE VARIABLE cb-periodo AS CHARACTER FORMAT "X(256)":U INITIAL "1" 
     LABEL "Per°odo Atualizaá∆o" 
     VIEW-AS COMBO-BOX INNER-LINES 5
     LIST-ITEM-PAIRS "Atual","1",
                     "Anterior","2",
                     "Per°odo Informado","3"
     DROP-DOWN-LIST
...
DEFINE FRAME f-relat
     ...
     im-pg-cla AT ROW 1.5 COL 18.14
...
DEFINE FRAME f-pg-par
     c-empresa AT ROW 1.46 COL 15 COLON-ALIGNED WIDGET-ID 2
     c-cenario-ctbl AT ROW 2.58 COL 15 COLON-ALIGNED WIDGET-ID 6
     c-plano-cc AT ROW 3.71 COL 15 COLON-ALIGNED WIDGET-ID 8
     c-plano-cta AT ROW 4.79 COL 15 COLON-ALIGNED WIDGET-ID 4
     RECT-11 AT ROW 1.25 COL 2 WIDGET-ID 10
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 3 ROW 3
...
DEFINE FRAME f-pg-sel
     cb-periodo AT ROW 1.5 COL 20 COLON-ALIGNED WIDGET-ID 12
     da-data-fim AT ROW 3.21 COL 35.29 COLON-ALIGNED NO-LABEL WIDGET-ID 16
     da-data-ini AT ROW 3.25 COL 9.43 COLON-ALIGNED WIDGET-ID 14
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 3 ROW 2.85
...
/* SETTINGS FOR FRAME f-pg-par
                                                                        */
/* SETTINGS FOR FILL-IN c-cenario-ctbl IN FRAME f-pg-par
   NO-ENABLE                                                            */
/* SETTINGS FOR FILL-IN c-empresa IN FRAME f-pg-par
   NO-ENABLE                                                            */
/* SETTINGS FOR FILL-IN c-plano-cc IN FRAME f-pg-par
   NO-ENABLE                                                            */
/* SETTINGS FOR FILL-IN c-plano-cta IN FRAME f-pg-par
   NO-ENABLE                                                            */
...
&Scoped-define SELF-NAME cb-periodo
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL cb-periodo w-relat
ON VALUE-CHANGED OF cb-periodo IN FRAME f-pg-sel /* Per°odo Atualizaá∆o */
DO:
  IF  INPUT FRAME f-pg-sel cb-periodo = "1" 
  OR  INPUT FRAME f-pg-sel cb-periodo = "2" THEN DO:
       ASSIGN  da-data-ini:SCREEN-VALUE IN FRAME f-pg-sel = ""
               da-data-fim:SCREEN-VALUE IN FRAME f-pg-sel = "".

       ASSIGN da-data-ini:SENSITIVE IN FRAME f-pg-sel = NO
             da-data-fim:SENSITIVE IN FRAME f-pg-sel = NO.
  END.      
  ELSE DO:
      ASSIGN da-data-ini:SENSITIVE IN FRAME f-pg-sel = YES
             da-data-fim:SENSITIVE IN FRAME f-pg-sel = YES.

      ASSIGN  da-data-ini:SCREEN-VALUE IN FRAME f-pg-sel = string(TODAY)
...
{utp/ut9000.i "ES5000" "2.00.00.000"}
...
DO  ON ERROR   UNDO MAIN-BLOCK, LEAVE MAIN-BLOCK
    ...
    ASSIGN c-empresa:SCREEN-VALUE IN FRAME f-pg-par = v_cdn_empres_usuar
           c-cenario-ctbl:SCREEN-VALUE IN FRAME f-pg-par = "Fiscal"
           c-plano-cc:SCREEN-VALUE IN FRAME f-pg-par = "Padrao"
           c-plano-cta:SCREEN-VALUE IN FRAME f-pg-par = "Padrao".

    ASSIGN da-data-ini:SENSITIVE IN FRAME f-pg-sel = NO
         da-data-fim:SENSITIVE IN FRAME f-pg-sel   = NO.

    APPLY "VALUE-CHANGED" TO cb-periodo IN FRAME f-pg-sel.
...
------------------------------------------------------------------------------*/
  ...
  DISPLAY cb-periodo da-data-fim da-data-ini 
      WITH FRAME f-pg-sel IN WINDOW w-relat.
  ENABLE cb-periodo da-data-fim da-data-ini 
      WITH FRAME f-pg-sel IN WINDOW w-relat.
  ...
  DISPLAY c-empresa c-cenario-ctbl c-plano-cc c-plano-cta 
...
/*     end.                                                                                         */
    ...
    ASSIGN tt-param.c-periodo = INPUT FRAME f-pg-sel cb-periodo
           tt-param.c-emp     = v_cdn_empres_usuar.
           
    ASSIGN tt-param.c-cod-cenar-ctbl = INPUT FRAME f-pg-par c-cenario-ctbl 
           tt-param.c-cod-plano-cc   = INPUT FRAME f-pg-par c-plano-cc
           tt-param.c-cod-plano-cta  = INPUT FRAME f-pg-par c-plano-cta
    ...
    {include/i-rprun.i esp/es5000rp.p}
