...
{include/i-prgvrs.i esapb038 2.01.00.000}

CREATE WIDGET-POOL.

/* Preprocessors Definitions ---                                      */
&GLOBAL-DEFINE Program        esapb038
...
&GLOBAL-DEFINE page6Text      text-destino text-modo v_val_margem
...
DEFINE VARIABLE v_val_margem AS DEC FORMAT ">>9.99" 
     LABEL "Vl Margem" 
     VIEW-AS FILL-IN 
     SIZE 12 BY .79 TOOLTIP "Valor da margem entre o saldo do t°tulo e o valor a ser pago." NO-UNDO.
...
DEFINE FRAME fPage6
     v_val_margem AT ROW 8.00 COL 13 COLON-ALIGNED WIDGET-ID 32
     rsDestiny AT ROW 11 COL 3 HELP
          "Destino de Impress∆o do Relat¢rio" NO-LABEL
     btConfigImpr AT ROW 12.33 COL 37.70 HELP
          "Configuraá∆o da impressora"
     btFile AT ROW 12.33 COL 37.70 HELP
          "Escolha do nome do arquivo"
     cFile AT ROW 12.38 COL 2.3 HELP
     ...
     " Margem (Moeda Estrangeira)" VIEW-AS TEXT
          SIZE 20 BY .54 AT ROW 7 COL 3 WIDGET-ID 30
     RECT-7 AT ROW 10.50 COL 1.3
     RECT-9 AT ROW 10.50 COL 45
     RECT-15 AT ROW 7.25 COL 1.3 WIDGET-ID 28
...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW wReport ASSIGN
         HIDDEN             = YES
         TITLE              = "Baixa Autom†tica de Saldos"
         HEIGHT             = 17
         WIDTH              = 90
         MAX-HEIGHT         = 40.83
         MAX-WIDTH          = 182.86
         VIRTUAL-HEIGHT     = 40.83
...
ASSIGN v_val_margem:SENSITIVE IN FRAME fPage6 = YES.
...
do on error undo, return error on stop  undo, return error:
    ...
    assign tt-param.usuario         = c-seg-usuario
           tt-param.destino         = 2 /*input frame fPage6 rsDestiny*/
           tt-param.data-exec       = today
           tt-param.hora-exec       = time
           tt-param.margem          = INPUT FRAME fPage6 v_val_margem.
    ...
    then 
        assign tt-param.arquivo = "":U.
         ...
         else assign tt-param.arquivo = c-dir-arquivo-session + c-programa-mg97 + ".tmp":U.
    
    {report/rpexb.i}
    
    SESSION:SET-WAIT-STATE("GENERAL":U).
    
    {report/rprun.i esp/apb/esapb038rp.p}
    {report/rpexc.i}
...
do  on error undo, return error
    ...
    create tt-param.
    assign tt-param.usuario         = c-seg-usuario
           tt-param.destino         = 2 /*input frame fPage7 rsDestiny*/
    ...
    if  tt-param.destino = 2 then 
        ...
        assign tt-param.arq-destino = c-dir-arquivo-session + c-programa-mg97 + ".txt":U.

    {report/imexb.i}

    if  session:set-wait-state("GENERAL":U) then.

    {report/imrun.i esp/apb/esapb038rp.p}
