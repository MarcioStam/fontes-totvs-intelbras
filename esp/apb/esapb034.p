...
def new global shared var v_arq_import_esapb034    as CHARACTER format "x(80)":U view-as editor max-chars 250 NO-WORD-WRAP size 40 by .88 bgcolor 15 font 2 label "Nome Arquivo" column-label "Arquivo" no-undo.
...
def frame f_bas_importa_APB
    ...
    v_arq_import_esapb034 at row 03.30 col 18.00 colon-aligned label "Nome Arquivo" help "Arquivo com os dados para importaá∆o" view-as editor max-chars 250 no-word-wrap size 46 by .88 bgcolor 15 font 2
    bt_get_file2_264936 at row 03.25 col 66.10 help "Buscar Arquivo"
    v_dat_transacao_esapb034 at row 04.30 col 18.00 colon-aligned help "Data de transaá∆o utilizada para geraá∆o dos movimentos"
    /*v_val_total_esapb034 at row 04.80 col 18.00 colon-aligned help "Valor total do arquivo de importaá∆o" */
    with 1 down side-labels no-validate keep-tab-order three-d
         size-char 80.72 by 06.29
         at row 02.25 col 01.00
         font 1 fgcolor ? bgcolor 8
         title "Geraá∆o de Antecipaá‰es Contas a Pagar - ESAPB034 - ".
    ...
    assign v_arq_import_esapb034:return-inserted in frame f_bas_importa_APB = yes.
    ...
    assign bt_rnl1:private-data                  in frame f_bas_importa_APB = "HLP=000008794":U
           ...
           v_arq_import_esapb034:private-data    in frame f_bas_importa_APB = "HLP=000017147":U
...
OR  CHOOSE OF MENU-ITEM mi_run IN MENU m_10 DO:
    assign v_arq_import_esapb034   
           v_dat_transacao_esapb034
           /*v_val_total_esapb034*/.   

    if  v_arq_import_esapb034    = "" THEN DO:
        RUN utp/ut-msgs.p (INPUT "show":U,
                           INPUT 17006,
                           INPUT "Arquivo de importaá∆o n∆o pode ficar em branco.":U +
                                 "~~":U +
                                 "Informe um <caminho>/<arquivo> v†lido para importaá∆o.":U).
        APPLY "ENTRY":U TO v_arq_import_esapb034 IN FRAME f_bas_importa_APB.
        RETURN NO-APPLY.
    END.
    
    IF  v_dat_transacao_esapb034 = ? THEN DO:
        RUN utp/ut-msgs.p (INPUT "show":U,
                           INPUT 17006,
                           INPUT "Data de Transaá∆o n∆o pode ficar em branco.":U +
                                 "~~":U +
                                 "Informe uma data v†lida para criaá∆o dos movimentos.":U).
        APPLY "ENTRY":U TO v_dat_transacao_esapb034 IN FRAME f_bas_importa_APB.
        RETURN NO-APPLY.
    END.

    /*
    IF  v_val_total_esapb034 = 0 THEN DO:
        RUN utp/ut-msgs.p (INPUT "show":U,
                           INPUT 17006,
        ...
        APPLY "ENTRY":U TO v_val_total_esapb034 IN FRAME f_bas_importa_APB.
        RETURN NO-APPLY.
    END.
    */
    
    run esp/apb/esapb034rp.p.
END.
...
OR F5 OF v_arq_import_esapb034 IN FRAME f_bas_importa_APB 
OR MOUSE-SELECT-DBLCLICK OF v_arq_import_esapb034 IN FRAME f_bas_importa_APB DO:
    /************************* Variable Definition Begin ************************/
    ...
    if  v_log_pressed = yes then do:
        assign v_arq_import_esapb034:screen-value in frame f_bas_importa_APB = v_cod_get_file.
        apply "entry" to v_arq_import_esapb034 in frame f_bas_importa_APB.
    end /* if */.
...
ASSIGN v_dat_transacao_esapb034 = TODAY.

disp v_arq_import_esapb034
     v_dat_transacao_esapb034
     /*v_val_total_esapb034*/
...
do on endkey undo main_block, leave main_block on error undo main_block, leave main_block:
    ...
    assign v_arq_import_esapb034:read-only    in frame f_bas_importa_APB = no
           v_dat_transacao_esapb034:read-only in frame f_bas_importa_APB = no
           /*v_val_total_esapb034:read-only     in frame f_bas_importa_APB = no*/.
