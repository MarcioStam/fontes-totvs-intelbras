...
&GLOBAL-DEFINE Program        ESAPB036
...
&GLOBAL-DEFINE page4Fields    rs-opcao
...
DEFINE VARIABLE ctext1 AS CHARACTER FORMAT "X(14)":U INITIAL "Op‡Æo Execu‡Æo" 
      VIEW-AS TEXT 
     SIZE 12 BY .63
     FONT 1 NO-UNDO.
...
DEFINE FRAME fpage4
     rs-opcao AT ROW 3.5 COL 10 NO-LABEL WIDGET-ID 82
     ctext1 AT ROW 2.21 COL 5 COLON-ALIGNED NO-LABEL
     RECT-139 AT ROW 2.5 COL 2.57 WIDGET-ID 80
...
ON END-ERROR OF wReport /* Baixa Autom tica APB */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL wReport wReport
ON WINDOW-CLOSE OF wReport /* Baixa Autom tica APB */
DO:
...
{report/mainblock.i}
  ...
  ASSIGN ctext1:SCREEN-VALUE IN FRAME fpage4 = "Op‡Æo Execu‡Æo".
...
do on error undo, return error on stop  undo, return error:                                  
    ...
    {report/rprun.i esp/apb/esapb036rp.p}                                                    
