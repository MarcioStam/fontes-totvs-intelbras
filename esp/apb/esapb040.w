...
*******************************************************************************/
{include/i-prgvrs.i esapb040 2.00.00.000}
...
DEFINE VARIABLE EDITOR-1 AS CHARACTER INITIAL "Integra‡Æo de Repasse e Conta Contabil do Compra F cil" 
     VIEW-AS EDITOR
...
{utp/ut9000.i "esapb040" "2.00.00.000"}
...
do on error undo, return error on stop  undo, return error:
    ...
    {include/i-rprun.i esp/apb/esapb040rp.p}
