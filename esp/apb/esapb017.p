...
** Versao................:  5.00.00.000
** Nome Externo..........: esp/apb/esapb017.p
...
def frame f_bas_10_histor_fornec_import_ems
    ...
    v_cdn_fornec_imp
         at row 03.20 col 48.00 COLON-ALIGNED
    v_num_fatura_imp 
         at row 04.20 col 18.00 COLON-ALIGNED
    v_dat_fatura_imp 
         at row 04.20 col 48.00 COLON-ALIGNED
    v_cod_portador_imp
         at row 05.20 col 18.00 COLON-ALIGNED
    v_dat_bordero_imp
         at row 05.20 col 48.00 COLON-ALIGNED
    v_val_bordero_imp
         at row 06.20 col 18.00 COLON-ALIGNED
    v_val_outros_imp 
         at row 06.20 col 48.00 COLON-ALIGNED
    ...
    with 1 down side-labels no-validate keep-tab-order three-d
         ...
         title "Importaá∆o Seguro MAPFRE (ESAPB017) - ".
...
DISP v_cod_estab_imp 
     ...
     v_dat_bordero_imp
     v_val_bordero_imp
     v_val_outros_imp WITH FRAME f_bas_10_histor_fornec_import_ems.
