...
**  Programa: esapb037 - Andrey M Oliveira - 19/05/2022
**            Importa‡Æo ITïs de embarque via csv.
**
*******************************************************************************/
{include/i-prgvrs.i esapb037 1.00.00.000}
{utp/ut-glob.i}
{cdp/cdcfgmat.i}
...
&GLOBAL-DEFINE Program        esapb037
...
&GLOBAL-DEFINE page2Fields    fi-arquivo fi_dat_trans
...
DEFINE VARIABLE fi_dat_trans AS DATE FORMAT "99/99/9999":U 
     LABEL "Dt Transa‡Æo" 
     VIEW-AS FILL-IN 
     SIZE 12 BY .88 TOOLTIP "Data de Transa‡Æo" NO-UNDO.
...
DEFINE FRAME fPage2
     bt-pesquisa AT ROW 4.5 COL 76.14 WIDGET-ID 4 NO-TAB-STOP 
     fi-arquivo AT ROW 4.58 COL 16 COLON-ALIGNED WIDGET-ID 2
     fi_dat_trans AT ROW 5.75 COL 16 COLON-ALIGNED WIDGET-ID 8
    WITH 1 DOWN KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 3.57 ROW 2.81
         SIZE 84.43 BY 10.15
...
ASSIGN fi_dat_trans:SCREEN-VALUE IN FRAME fPage2 = string(TODAY).
...
do on error undo, return error on stop  undo, return error:
    ...
    IF  INPUT FRAME fPage2 fi-arquivo = "" THEN DO:
        RUN utp/ut-msgs.p(INPUT "show",
                          INPUT 17006,
                          INPUT "Arquivo de importa‡Æo deve ser informado.").
        RETURN 'adm-error'.
    END.
    ...
    ASSIGN tt-param.usuario   = c-seg-usuario
           ...
           tt-param.fi_dat_trans   = INPUT FRAME fPage2 fi_dat_trans.
    ...
    {report/rprun.i esp/apb/esapb037rp.p}
