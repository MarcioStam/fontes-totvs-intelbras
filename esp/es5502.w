...
*******************************************************************************/
{include/i-prgvrs.i es5502 2.00.00.000}
...
define temp-table tt-digita no-undo
    field cod-ccusto       as character format "x(5)" COLUMN-LABEL "C.Custos"
    index id COD-CCUSTO.
...
&Scoped-define FIELDS-IN-QUERY-br-digita tt-digita   
&Scoped-define ENABLED-FIELDS-IN-QUERY-br-digita tt-digita.COD-CCUSTO   
...
DEFINE VARIABLE c-centro-fim AS CHARACTER FORMAT "X(256)":U INITIAL "ZZZZZ" 
     VIEW-AS FILL-IN 
     SIZE 14 BY .88 NO-UNDO.

DEFINE VARIABLE c-centro-ini AS CHARACTER FORMAT "X(256)":U 
     LABEL "Centro Custos" 
     VIEW-AS FILL-IN 
     SIZE 14 BY .88 NO-UNDO.

DEFINE VARIABLE c-cod-estab-f AS CHARACTER FORMAT "X(3)":U INITIAL "ZZZ" 
     VIEW-AS FILL-IN 
     SIZE 8 BY .88 NO-UNDO.

DEFINE VARIABLE c-cod-estab-i AS CHARACTER FORMAT "X(3)":U 
     LABEL "Estab" 
     VIEW-AS FILL-IN 
     SIZE 8 BY .88 NO-UNDO.

DEFINE VARIABLE c-cta-fim AS CHARACTER FORMAT "9.9.9.99.999":U INITIAL "49999999" 
     VIEW-AS FILL-IN 
     SIZE 14 BY .88 NO-UNDO.

DEFINE VARIABLE c-cta-ini AS CHARACTER FORMAT "9.9.9.99.999":U INITIAL "40000000" 
     LABEL "Conta" 
     VIEW-AS FILL-IN 
     SIZE 14 BY .88 NO-UNDO.

DEFINE VARIABLE c-exercicio-fim AS CHARACTER FORMAT "X(4)":U
     VIEW-AS FILL-IN 
     SIZE 11.86 BY .88 NO-UNDO.

DEFINE VARIABLE c-exercicio-ini AS CHARACTER FORMAT "X(4)":U
     LABEL "Exerc¡cio" 
     VIEW-AS FILL-IN 
     SIZE 11.86 BY .88 NO-UNDO.

ASSIGN c-exercicio-fim = STRING(YEAR(TODAY))
       c-exercicio-ini = STRING(YEAR(TODAY)).

DEFINE VARIABLE i-nr-per-fim AS INTEGER FORMAT ">9":U INITIAL 12 
     VIEW-AS FILL-IN 
     SIZE 5 BY .88 NO-UNDO.

DEFINE VARIABLE i-nr-per-ini AS INTEGER FORMAT ">9":U INITIAL 1 
     LABEL "Per¡odo" 
     VIEW-AS FILL-IN 
     SIZE 5 BY .88 NO-UNDO.
...
DEFINE FRAME f-relat
     ...
     im-pg-dig AT ROW 1.5 COL 18
     im-pg-imp AT ROW 1.5 COL 34
     im-pg-par AT ROW 1.5 COL 33.72
...
DEFINE FRAME f-pg-sel
     c-cod-estab-i AT ROW 1.25 COL 22 COLON-ALIGNED WIDGET-ID 2
     c-cod-estab-f AT ROW 1.25 COL 48.57 COLON-ALIGNED NO-LABEL WIDGET-ID 4
     c-cta-ini AT ROW 2.25 COL 16 COLON-ALIGNED WIDGET-ID 14
     c-cta-fim AT ROW 2.25 COL 48.57 COLON-ALIGNED NO-LABEL WIDGET-ID 16
     c-centro-ini AT ROW 3.33 COL 16 COLON-ALIGNED WIDGET-ID 22
     c-centro-fim AT ROW 3.33 COL 48.57 COLON-ALIGNED NO-LABEL WIDGET-ID 24
     c-exercicio-ini AT ROW 4.25 COL 18 COLON-ALIGNED WIDGET-ID 32
     c-exercicio-fim AT ROW 4.25 COL 49 COLON-ALIGNED NO-LABEL WIDGET-ID 30
     i-nr-per-ini AT ROW 5.25 COL 25 COLON-ALIGNED WIDGET-ID 38
     i-nr-per-fim AT ROW 5.25 COL 49 COLON-ALIGNED NO-LABEL WIDGET-ID 40
     IMAGE-1 AT ROW 1.25 COL 31.86
     IMAGE-2 AT ROW 1.25 COL 47.29
     IMAGE-5 AT ROW 2.33 COL 32 WIDGET-ID 18
     IMAGE-6 AT ROW 2.33 COL 47.43 WIDGET-ID 20
     IMAGE-7 AT ROW 3.42 COL 32 WIDGET-ID 26
     IMAGE-8 AT ROW 3.42 COL 47.43 WIDGET-ID 28
     IMAGE-3 AT ROW 4.25 COL 32 WIDGET-ID 34
     IMAGE-4 AT ROW 4.29 COL 47.57 WIDGET-ID 36
     IMAGE-9 AT ROW 5.25 COL 32 WIDGET-ID 42
     IMAGE-10 AT ROW 5.25 COL 47.57 WIDGET-ID 44
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 3 ROW 2.85
...
DEFINE FRAME f-pg-par
     l-apb AT ROW 1.5 COL 2 WIDGET-ID 2
     l-acr AT ROW 2.33 COL 2 WIDGET-ID 4
     l-fgl AT ROW 3.17 COL 2 WIDGET-ID 6
     l-cep AT ROW 4 COL 2 WIDGET-ID 8
     l-ativo AT ROW 4.88 COL 2 WIDGET-ID 10
     l-cmg AT ROW 5.75 COL 2 WIDGET-ID 12
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 3 ROW 3
...
ASSIGN 
       ...
       FRAME f-pg-par:SENSITIVE        = FALSE.
...
ON END-ERROR OF w-relat /* Relat¢rio Or‡amento */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL w-relat w-relat
ON WINDOW-CLOSE OF w-relat /* Relat¢rio Or‡amento */
DO:
...
DO:
    if  br-digita:new-row in frame f-pg-dig then do:
        ...
        display tt-digita.COD-CCUSTO with browse br-digita. 
    end.
    return no-apply.
END.
...
DO:
    ...
    do transaction on error undo, return no-apply:
        create tt-digita.
        assign input browse br-digita tt-digita.COD-CCUSTO.
...
DO:
   apply 'entry':U to tt-digita.COD-CCUSTO in browse br-digita. 
END.
...
{utp/ut9000.i "ES5502" "2.00.00.000"}
...
DO  ON ERROR   UNDO MAIN-BLOCK, LEAVE MAIN-BLOCK
    ...
    APPLY "CHOOSE" TO im-pg-sel IN FRAME f-relat .
...
------------------------------------------------------------------------------*/
  ...
  DISPLAY c-cod-estab-i c-cod-estab-f c-cta-ini c-cta-fim c-centro-ini 
          c-centro-fim c-exercicio-ini c-exercicio-fim i-nr-per-ini i-nr-per-fim 
      WITH FRAME f-pg-sel IN WINDOW w-relat.
  ENABLE IMAGE-1 IMAGE-2 IMAGE-5 IMAGE-6 IMAGE-7 IMAGE-8 IMAGE-3 IMAGE-4 
         IMAGE-9 IMAGE-10 c-cod-estab-i c-cod-estab-f c-cta-ini c-cta-fim 
         c-centro-ini c-centro-fim c-exercicio-ini c-exercicio-fim i-nr-per-ini 
         i-nr-per-fim 
      WITH FRAME f-pg-sel IN WINDOW w-relat.
  ...
  DISPLAY l-apb l-acr l-fgl l-cep l-ativo l-cmg 
      WITH FRAME f-pg-par IN WINDOW w-relat.
  ENABLE l-apb l-acr l-fgl l-cep l-ativo l-cmg 
      WITH FRAME f-pg-par IN WINDOW w-relat.
  {&OPEN-BROWSERS-IN-QUERY-f-pg-par}
  FRAME f-pg-par:SENSITIVE = NO.
...
do on error undo, return error on stop  undo, return error:
    ...
    for each tt-digita no-lock:
        ...
        find first b-tt-digita 
            where  B-tt-digita.COD-CCUSTO = tt-digita.COD-CCUSTO
    ...
    ASSIGN tt-param.c-exerc-ini     = INPUT FRAME f-pg-sel c-exercicio-ini
           tt-param.c-exerc-fim     = INPUT FRAME f-pg-sel c-exercicio-fim
           tt-param.nr-periodo-ini  = INPUT FRAME f-pg-sel i-nr-per-ini
           tt-param.nr-periodo-fim  = INPUT FRAME f-pg-sel i-nr-per-fim
           tt-param.c-cod-estab-ini = INPUT FRAME f-pg-sel c-cod-estab-i
           tt-param.c-cod-estab-fim = INPUT FRAME f-pg-sel c-cod-estab-f
           tt-param.c-conta-ini     = INPUT frame f-pg-sel c-cta-ini 
           tt-param.c-conta-fim     = INPUT frame f-pg-sel c-cta-fim
           tt-param.c-ccusto-ini    = INPUT FRAME f-pg-sel c-centro-ini
           tt-param.c-ccusto-fim    = INPUT FRAME f-pg-sel c-centro-fim
           tt-param.l-apb           = l-apb:CHECKED IN FRAME f-pg-par
           tt-param.l-acr           = l-acr:CHECKED IN FRAME f-pg-par
           tt-param.l-fgl           = l-fgl:CHECKED IN FRAME f-pg-par
           tt-param.l-cep           = l-cep:CHECKED IN FRAME f-pg-par
           tt-param.l-ativo         = l-ativo:CHECKED IN FRAME f-pg-par
           tt-param.l-cmg           = l-cmg:CHECKED IN FRAME f-pg-par.
    ...
    {include/i-rprun.i esp/es5502rp.p}
