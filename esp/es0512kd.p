/*****************************************************************************
** Programa..............: sea_grp_usuar
** Versao................: 1.00.00.001
** Nome Externo..........: esp/es0512kd.p
** Criado por............: Estevan Krger - Sensus
** Criado em.............: 12/12/2013
*****************************************************************************/
...
def browse br_sea_grp_clien query qr_sea_grp_clien display  
    ...
    width-chars 07.43 
        column-label "Grupo Usu rio" format "x(10)":U
...
def frame f_sea_01_grp_clien 
    ...
    with 1 down side-labels no-validate keep-tab-order three-d 
         ...
         title "Pesquisa Grupo Usu rios - ES0512KD - 1.00.00.001". 
...
DO: 
    if  avail grp_usuar then do: 
        assign v_rec_grp_usuar = recid(grp_usuar). 
    end /* if */. 
END.
        ...
        when "Por Descri‡Æo" then block_2: 
         do: 
            assign v_cod_dat_type = "character" 
                   ...
                   v_cod_initial  = string("":U) 
                   v_cod_final    = string("ZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZ":U). 
...
assign v_rec_table = v_rec_grp_usuar. 
    ...
    case input frame f_sea_01_grp_clien rs_sea_grp_clien: 
        when "Por C¢digo" then 
            ...
            do: 
                open query qr_sea_grp_clien for 
                    ...
                    where grp_usuar.cod_grp_usuar >= v_cod_initial 
                      and grp_usuar.cod_grp_usuar <= v_cod_final 
        ...
        when "Por Descri‡Æo" then 
            ...
            do: 
                open query qr_sea_grp_clien for 
                    each grp_usuar no-lock 
                    where grp_usuar.des_grp_usuar >= v_cod_initial 
                      and grp_usuar.des_grp_usuar <= v_cod_final 
                    by grp_usuar.des_grp_usuar. 
            end /* do name_block */. 
    end /* case case_block */. 
END PROCEDURE.
