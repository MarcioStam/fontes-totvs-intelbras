...
DEFINE INPUT  PARAMETER TABLE FOR tt-ean.
DEFINE OUTPUT PARAMETER pcod-ean13 AS CHARACTER NO-UNDO.
DEFINE OUTPUT PARAMETER pit-codigo AS CHARACTER NO-UNDO.
DEFINE OUTPUT PARAMETER pdesc-item AS CHARACTER NO-UNDO.
...
&Scoped-define INTERNAL-TABLES tt-ean

/* Definitions for BROWSE brItem                                        */
&Scoped-define FIELDS-IN-QUERY-brItem tt-ean.it-codigo tt-ean.desc-item   
&Scoped-define ENABLED-FIELDS-IN-QUERY-brItem   
&Scoped-define SELF-NAME brItem
&Scoped-define QUERY-STRING-brItem FOR EACH tt-ean
&Scoped-define OPEN-QUERY-brItem OPEN QUERY {&SELF-NAME} FOR EACH tt-ean.
&Scoped-define TABLES-IN-QUERY-brItem tt-ean
&Scoped-define FIRST-TABLE-IN-QUERY-brItem tt-ean
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS brItem Dialog-Frame2 _FREEFORM
  QUERY brItem DISPLAY
      tt-ean.it-codigo  COLUMN-LABEL "Item"      FORMAT "x(16)"
      tt-ean.desc-item  COLUMN-LABEL "Descricao"
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
...
/* Query rebuild information for BROWSE brItem
     _START_FREEFORM
OPEN QUERY {&SELF-NAME} FOR EACH tt-ean.
     _END_FREEFORM
     _Query            is OPENED
*/  /* BROWSE brItem */
&ANALYZE-RESUME
...
ON WINDOW-CLOSE OF FRAME Dialog-Frame2 /* Consulta C¢digo EAN */
DO:
...
DO:
    ASSIGN pcod-ean13 = tt-ean.cod-ean13
           pit-codigo = tt-ean.it-codigo
           pdesc-item = tt-ean.desc-item.
