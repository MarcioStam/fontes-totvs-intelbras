...
*******************************************************************************/
{include/i-prgvrs.i ESAQP013 1.00.00.000}
...
&GLOBAL-DEFINE Program        ESAQP013
...
&GLOBAL-DEFINE page2Fields    fi-auditor cb-turno-ini cb-turno-fim datIniAdicional datFimAdicional c-cod-estabel iNr-linha c-it-codigo c-unid-negoc i-nr-seq-tipo-lote tg-diarios-revisados tg-reinspecionados tg-bloqueado siglaIni siglaFim
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _FUNCTION-FORWARD fn-turno wReport 
FUNCTION fn-turno RETURNS INTEGER
...
DEFINE VARIABLE cb-turno-fim AS CHARACTER FORMAT "X(20)" INITIAL "3§ Turno" 
     VIEW-AS COMBO-BOX INNER-LINES 4
     LIST-ITEMS "Geral","1§ Turno","2§ Turno","3§ Turno" 
     DROP-DOWN-LIST
     SIZE 15 BY 1 NO-UNDO.

DEFINE VARIABLE cb-turno-ini AS CHARACTER FORMAT "X(20)" INITIAL "Geral" 
     LABEL "Turno" 
     VIEW-AS COMBO-BOX INNER-LINES 4
     LIST-ITEMS "Geral","1§ Turno","2§ Turno","3§ Turno" 
     DROP-DOWN-LIST
...
DEFINE VARIABLE fi-auditor AS CHARACTER FORMAT "X(30)":U 
     LABEL "Auditor" 
     VIEW-AS FILL-IN 
...
DEFINE VARIABLE siglaFim AS CHARACTER FORMAT "X(2)":U INITIAL "ZZ" 
     VIEW-AS FILL-IN 
     SIZE 5 BY .88
     FONT 1 NO-UNDO.

DEFINE VARIABLE siglaIni AS CHARACTER FORMAT "X(2)":U 
     LABEL "C‚lula" 
     VIEW-AS FILL-IN 
     SIZE 5 BY .88
     FONT 1 NO-UNDO.
...
DEFINE VARIABLE tg-diarios-revisados AS LOGICAL INITIAL yes 
     LABEL "Lotes Di rios Recusados" 
     VIEW-AS TOGGLE-BOX
     SIZE 20 BY .83 NO-UNDO.

DEFINE VARIABLE tg-reinspecionados AS LOGICAL INITIAL no 
     LABEL "Lotes Reinspecionados" 
     VIEW-AS TOGGLE-BOX
     SIZE 20 BY .83 NO-UNDO.
...
DEFINE FRAME fPage2
     datIniAdicional AT ROW 1.5 COL 21.86 HELP
          "Data de amostragem adicional inicial"
     datFimAdicional AT ROW 1.5 COL 51 HELP
          "Data final de amostragem adicional" NO-LABEL
     cb-turno-ini AT ROW 2.5 COL 24 COLON-ALIGNED WIDGET-ID 68
     cb-turno-fim AT ROW 2.5 COL 49 COLON-ALIGNED NO-LABEL WIDGET-ID 70
     siglaIni AT ROW 3.5 COL 31 HELP
          "Sigla Inicial" WIDGET-ID 74
     siglaFim AT ROW 3.5 COL 51 HELP
          "Sigla Final" NO-LABEL WIDGET-ID 72
     c-cod-estabel AT ROW 4.88 COL 23 COLON-ALIGNED WIDGET-ID 46
     c-desc-estabel AT ROW 4.88 COL 29.43 COLON-ALIGNED NO-LABEL WIDGET-ID 48
     iNr-linha AT ROW 5.88 COL 24 COLON-ALIGNED HELP
          "Numero da Linha de Produ‡Æo" WIDGET-ID 8
     cDescricaoLinProd AT ROW 5.88 COL 29.43 COLON-ALIGNED NO-LABEL WIDGET-ID 6
     c-it-codigo AT ROW 6.88 COL 11 COLON-ALIGNED HELP
          "C¢digo do Item" WIDGET-ID 2
     cDesc-item AT ROW 6.88 COL 29.43 COLON-ALIGNED NO-LABEL WIDGET-ID 4
     c-unid-negoc AT ROW 7.88 COL 22 COLON-ALIGNED WIDGET-ID 24
     v_des_unid_negoc AT ROW 7.88 COL 29.43 COLON-ALIGNED NO-LABEL WIDGET-ID 26
     i-nr-seq-tipo-lote AT ROW 8.88 COL 21 COLON-ALIGNED WIDGET-ID 44
     fi-desc-tipo-lote AT ROW 8.88 COL 29.43 COLON-ALIGNED NO-LABEL WIDGET-ID 42
     fi-auditor AT ROW 9.88 COL 21 COLON-ALIGNED WIDGET-ID 50
     tg-diarios-revisados AT ROW 11.08 COL 34 WIDGET-ID 52
     tg-reinspecionados AT ROW 11.96 COL 34 WIDGET-ID 54
     tg-bloqueado AT ROW 12.75 COL 34 WIDGET-ID 58
     IMAGE-1 AT ROW 1.5 COL 41.43
     IMAGE-2 AT ROW 1.5 COL 47.72
     RECT-13 AT ROW 1 COL 1 WIDGET-ID 12
     RECT-14 AT ROW 4.75 COL 1 WIDGET-ID 14
     RECT-16 AT ROW 11 COL 1 WIDGET-ID 56
     IMAGE-3 AT ROW 2.54 COL 41.43 WIDGET-ID 60
     IMAGE-4 AT ROW 2.54 COL 47.72 WIDGET-ID 62
     IMAGE-5 AT ROW 3.5 COL 41.43 WIDGET-ID 76
     IMAGE-6 AT ROW 3.5 COL 47.72 WIDGET-ID 78
    WITH 1 DOWN KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
...
/* SETTINGS FOR FILL-IN datIniAdicional IN FRAME fPage2
   ALIGN-L                                                              */
/* SETTINGS FOR FILL-IN siglaFim IN FRAME fPage2
   ALIGN-L                                                              */
/* SETTINGS FOR FILL-IN siglaIni IN FRAME fPage2
   ALIGN-L                                                              */
...
ON F5 OF i-nr-seq-tipo-lote IN FRAME fPage2 /* Tipo de Lote */
DO:
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL i-nr-seq-tipo-lote wReport
ON LEAVE OF i-nr-seq-tipo-lote IN FRAME fPage2 /* Tipo de Lote */
DO:
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL i-nr-seq-tipo-lote wReport
ON MOUSE-SELECT-DBLCLICK OF i-nr-seq-tipo-lote IN FRAME fPage2 /* Tipo de Lote */
DO:
  APPLY "F5" TO SELF.
END.
...
&Scoped-define FRAME-NAME fPage2
&Scoped-define SELF-NAME siglaFim
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL siglaFim wReport
ON F5 OF siglaFim IN FRAME fPage2
DO:
    {method/zoomfields.i &ProgramZoom="eszoom/z01es244.w"
                         &FieldZoom1="sigla"        
                         &FieldScreen1="siglaFim"
                         &Frame1="fPage2"}
END.
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL siglaFim wReport
ON MOUSE-SELECT-DBLCLICK OF siglaFim IN FRAME fPage2
DO:
    APPLY "f5" TO SELF.
END.
...
&Scoped-define SELF-NAME siglaIni
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL siglaIni wReport
ON F5 OF siglaIni IN FRAME fPage2 /* C‚lula */
DO:
    {method/zoomfields.i &ProgramZoom="eszoom/z01es244.w"
                         &FieldZoom1="sigla"        
                         &FieldScreen1="siglaIni"
                         &Frame1="fPage2"}
END.
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL siglaIni wReport
ON MOUSE-SELECT-DBLCLICK OF siglaIni IN FRAME fPage2 /* C‚lula */
DO:
    APPLY "f5" TO SELF.
END.
...
siglaIni:LOAD-MOUSE-POINTER("image/lupa.cur":U) IN FRAME fPage2.
siglaFim:LOAD-MOUSE-POINTER("image/lupa.cur":U) IN FRAME fPage2.
...
do on error undo, return error on stop  undo, return error:
    ...
    assign tt-param.usuario                 = c-seg-usuario
           ...
           tt-param.i-turno-ini             = fn-turno(INPUT FRAME fpage2 cb-turno-ini)
           tt-param.i-turno-fim             = fn-turno(INPUT FRAME fpage2 cb-turno-fim)
           tt-param.cod-estabel             = INPUT FRAME fpage2 c-cod-estabel
           tt-param.nr-linha                = input frame fPage2 iNr-linha
           tt-param.sigla-ini               = input frame fPage2 siglaIni
           tt-param.sigla-fim               = input frame fPage2 siglaFim
           tt-param.it-codigo               = input frame fPage2 c-it-codigo
           tt-param.cod-uneg                = input frame fPage2 c-unid-negoc
           tt-param.tip-lote                = int(input frame fPage2 i-nr-seq-tipo-lote)
           tt-param.lotes-diarios-revisados = INPUT FRAME fPage2 tg-diarios-revisados
           tt-param.lotes-reinspecionados   = INPUT FRAME fPage2 tg-reinspecionados
           &if "{&RTF}":U = "YES":U &then
           tt-param.modelo                  = input frame fPage6 cModelRTF
           tt-param.l-habilitaRtf           = input frame fPage6 ll-habilitaRtf
           &endif
           tt-param.log-bloqueado           = INPUT FRAME fPage2 tg-bloqueado
           tt-param.auditor                 = INPUT FRAME fpage2 fi-auditor.
    ...
    {report/rprun.i esp/aqp/esaqp013rp.p}
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _FUNCTION fn-turno wReport 
FUNCTION fn-turno RETURNS INTEGER
