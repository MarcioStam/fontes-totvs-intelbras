...
*******************************************************************************/
{include/i-prgvrs.i ESAQP018 1.00.00.000}
...
&GLOBAL-DEFINE Program        ESAQP018
...
&GLOBAL-DEFINE page2Fields    datIniAdicional datFimAdicional iNr-linha c-it-codigo c-unid-negoc i-nr-seq-orig-prob i-nr-seq-tipo-lote     
...
DEFINE FRAME fPage2
     ...
     iNr-linha AT ROW 4.5 COL 24 COLON-ALIGNED HELP
          "Numero da Linha de Produ‡Æo" WIDGET-ID 8
     cDescricaoLinProd AT ROW 4.5 COL 29.43 COLON-ALIGNED NO-LABEL WIDGET-ID 6
     c-it-codigo AT ROW 5.5 COL 11 COLON-ALIGNED HELP
          "C¢digo do Item" WIDGET-ID 2
     cDesc-item AT ROW 5.5 COL 29.43 COLON-ALIGNED NO-LABEL WIDGET-ID 4
     c-unid-negoc AT ROW 6.5 COL 22 COLON-ALIGNED WIDGET-ID 24
     v_des_unid_negoc AT ROW 6.5 COL 29.43 COLON-ALIGNED NO-LABEL WIDGET-ID 26
     i-nr-seq-orig-prob AT ROW 7.5 COL 21 COLON-ALIGNED WIDGET-ID 28
     v_des_origem_prob AT ROW 7.5 COL 29.43 COLON-ALIGNED NO-LABEL WIDGET-ID 30
     i-nr-seq-tipo-lote AT ROW 8.5 COL 21 COLON-ALIGNED WIDGET-ID 44
     fi-desc-tipo-lote AT ROW 8.5 COL 29.43 COLON-ALIGNED NO-LABEL WIDGET-ID 42
...
do on error undo, return error on stop  undo, return error:
    ...
    {report/rprun.i esp/aqp/esaqp018rp.p}
