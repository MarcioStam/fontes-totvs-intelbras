...
*******************************************************************************/
{include/i-prgvrs.i ESAQP016 1.00.00.000}
...
&GLOBAL-DEFINE Program        ESAQP016
...
&GLOBAL-DEFINE page0Widgets   btOk ~
                              btCancel ~
                              btHelp2
&GLOBAL-DEFINE page2Widgets   rs-tip-relat 
...
&GLOBAL-DEFINE page2Fields    datIniAdicional datFimAdicional c-des-auditor i-nr-seq-procedimento i-nr-seq-setor c-unid-negoc      
...
DEFINE FRAME fPage2
     ...
     c-unid-negoc AT ROW 7.5 COL 17 COLON-ALIGNED WIDGET-ID 24
     v_des_unid_negoc AT ROW 7.5 COL 29.43 COLON-ALIGNED NO-LABEL WIDGET-ID 26
     rs-tip-relat AT ROW 9.5 COL 31 NO-LABEL WIDGET-ID 18
     "Tipo Sa¡da Relat¢rio" VIEW-AS TEXT
          SIZE 14 BY .54 AT ROW 8.75 COL 30 WIDGET-ID 22
     ...
     RECT-15 AT ROW 9 COL 28 WIDGET-ID 16
    WITH 1 DOWN KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
...
do on error undo, return error on stop  undo, return error:
    ...
    assign tt-param.usuario         = c-seg-usuario
           ...
           tt-param.tip-relat       = int(input frame fPage2 rs-tip-relat)
           &if "{&RTF}":U = "YES":U &then
    ...
    {report/rprun.i esp/aqp/esaqp016rp.p}
