define temp-table tt-param no-undo
    ...
    FIELD i-turno-ini      AS INTEGER
    FIELD i-turno-fim      AS INTEGER
    FIELD cod-estabel      AS CHAR
    FIELD nr-linha         AS INTEGER
    FIELD sigla-ini        AS CHAR
    FIELD sigla-fim        AS CHAR
    FIELD it-codigo        AS CHAR
    field cod-uneg         as char format "x(05)"
    FIELD tip-lote         AS INT 
    FIELD lotes-diarios-revisados  AS LOGICAL
    FIELD lotes-reinspecionados    AS LOGICAL
    /*Alterado 15/02/2005 - tech1007 - Criado campo l¢gico para verificar se o RTF foi habilitado*/
    field l-habilitaRtf    as LOG
    FIELD log-bloqueado    AS LOG
    FIELD auditor          AS CHAR FORMAT "x(30)".
