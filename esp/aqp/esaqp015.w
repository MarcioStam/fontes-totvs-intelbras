...
*******************************************************************************/
{include/i-prgvrs.i ESAQP015 1.00.00.000}
...
&GLOBAL-DEFINE Program        ESAQP015
...
&GLOBAL-DEFINE page2Fields    cb-turno-ini cb-turno-fim datIniAdicional datFimAdicional siglaIni siglaFim c-cod-estabel iNr-linha c-it-codigo c-unid-negoc i-nr-seq-tipo-lote fi-auditor tg-diarios-revisados tg-reinspecionados tg-bloqueado
...
DEFINE VARIABLE tg-reinspecionados AS LOGICAL INITIAL yes 
...
DEFINE FRAME fPage2
     datIniAdicional AT ROW 1.5 COL 20.15 HELP
          "Data de amostragem adicional inicial"
     datFimAdicional AT ROW 1.5 COL 49.29 HELP
          "Data final de amostragem adicional" NO-LABEL
     cb-turno-ini AT ROW 2.5 COL 22.29 COLON-ALIGNED WIDGET-ID 68
     cb-turno-fim AT ROW 2.5 COL 47.29 COLON-ALIGNED NO-LABEL WIDGET-ID 70
     siglaIni AT ROW 3.5 COL 29.29 HELP
          "Sigla Inicial" WIDGET-ID 74
     siglaFim AT ROW 3.5 COL 49.29 HELP
          "Sigla Final" NO-LABEL WIDGET-ID 72
     c-cod-estabel AT ROW 4.88 COL 27.86 COLON-ALIGNED WIDGET-ID 46
     c-desc-estabel AT ROW 4.88 COL 34.29 COLON-ALIGNED NO-LABEL WIDGET-ID 48
     iNr-linha AT ROW 5.88 COL 28.86 COLON-ALIGNED HELP
          "Numero da Linha de Produ‡Æo" WIDGET-ID 8
     cDescricaoLinProd AT ROW 5.88 COL 34.29 COLON-ALIGNED NO-LABEL WIDGET-ID 6
     c-it-codigo AT ROW 6.88 COL 15.86 COLON-ALIGNED HELP
          "C¢digo do Item" WIDGET-ID 2
     cDesc-item AT ROW 6.88 COL 34.29 COLON-ALIGNED NO-LABEL WIDGET-ID 4
     c-unid-negoc AT ROW 7.88 COL 26.86 COLON-ALIGNED WIDGET-ID 24
     v_des_unid_negoc AT ROW 7.88 COL 34.29 COLON-ALIGNED NO-LABEL WIDGET-ID 26
     i-nr-seq-tipo-lote AT ROW 8.88 COL 25.86 COLON-ALIGNED WIDGET-ID 44
     fi-desc-tipo-lote AT ROW 8.88 COL 34.29 COLON-ALIGNED NO-LABEL WIDGET-ID 42
     fi-auditor AT ROW 9.88 COL 25.86 COLON-ALIGNED WIDGET-ID 50
     ...
     IMAGE-1 AT ROW 1.5 COL 39.72
     IMAGE-2 AT ROW 1.5 COL 45.86
     RECT-13 AT ROW 1 COL 1 WIDGET-ID 12
     RECT-14 AT ROW 4.63 COL 1 WIDGET-ID 14
     IMAGE-3 AT ROW 2.54 COL 39.72 WIDGET-ID 60
     IMAGE-4 AT ROW 2.54 COL 46 WIDGET-ID 62
     IMAGE-5 AT ROW 3.5 COL 39.72 WIDGET-ID 76
     IMAGE-6 AT ROW 3.5 COL 45.86 WIDGET-ID 78
    WITH 1 DOWN KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
...
siglaIni:load-mouse-pointer("image/lupa.cur") IN FRAME fPage2.
siglaFim:load-mouse-pointer("image/lupa.cur") IN FRAME fPage2.
...
do on error undo, return error on stop  undo, return error:
    ...
    {report/rprun.i esp/aqp/esaqp015rp.p}
