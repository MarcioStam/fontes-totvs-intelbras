...
*******************************************************************************/
{include/i-prgvrs.i ESAQP014 1.00.00.000}
...
&GLOBAL-DEFINE Program        ESAQP014
...
&GLOBAL-DEFINE page2Fields    fi-auditor datIniAdicional datFimAdicional c-cod-estabel iNr-linha c-it-codigo c-unid-negoc i-nr-seq-tipo-lote rs-tipo-lote
...
DEFINE VARIABLE rs-tipo-lote AS INTEGER 
     VIEW-AS RADIO-SET HORIZONTAL
     RADIO-BUTTONS 
          "Somente Revisados", 1,
"Somente Bloqueados", 2,
"Ambos", 3
     SIZE 49 BY 1.5 NO-UNDO.
...
DEFINE FRAME fPage2
     datIniAdicional AT ROW 1.75 COL 21.86 HELP
          "Data de amostragem adicional inicial"
     datFimAdicional AT ROW 1.75 COL 51 HELP
     ...
     i-nr-seq-tipo-lote AT ROW 8 COL 21 COLON-ALIGNED WIDGET-ID 44
     fi-desc-tipo-lote AT ROW 8 COL 29.43 COLON-ALIGNED NO-LABEL WIDGET-ID 42
     fi-auditor AT ROW 9 COL 21 COLON-ALIGNED WIDGET-ID 58
     rs-tipo-lote AT ROW 11.5 COL 19.43 NO-LABEL WIDGET-ID 54
     "Tipo Lote" VIEW-AS TEXT
          SIZE 7 BY .54 AT ROW 10.46 COL 2 WIDGET-ID 52
     IMAGE-1 AT ROW 1.75 COL 40.86
     IMAGE-2 AT ROW 1.75 COL 48
     RECT-13 AT ROW 1 COL 1 WIDGET-ID 12
     RECT-14 AT ROW 3.75 COL 1 WIDGET-ID 14
     RECT-15 AT ROW 10.75 COL 1 WIDGET-ID 50
...
do on error undo, return error on stop  undo, return error:
    ...
    assign tt-param.usuario         = c-seg-usuario
           ...
           &endif
           tt-param.tipo-lote       = INPUT FRAME fPage2 rs-tipo-lote
    ...
    {report/rprun.i esp/aqp/esaqp014rp.p}
