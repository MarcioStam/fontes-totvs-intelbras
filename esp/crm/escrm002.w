...
*******************************************************************************/
{include/i-prgvrs.i escrm002 2.04.00.001}

CREATE WIDGET-POOL.

/* Preprocessors Definitions ---                                      */
&GLOBAL-DEFINE Program        escrm002
...
&GLOBAL-DEFINE page0Widgets   btOk ~
                              btCancel ~
                              btHelp2
&GLOBAL-DEFINE page6Widgets   rsDestiny fi-cod-estabel ~
                              btConfigImpr ~
                              btFile ~
                              rsExecution
...
DEFINE FRAME fPage6
     fi-cod-estabel AT ROW 1.75 COL 15 COLON-ALIGNED WIDGET-ID 2
     ...
     RECT-10 AT ROW 1.25 COL 2 WIDGET-ID 4
...
do on error undo, return error on stop  undo, return error:
    ...
    */
    ...
    assign tt-param.usuario         = c-seg-usuario
           ...
           tt-param.cod-estabel     = INPUT FRAME fpage6 fi-cod-estabel.
    /*
    ...
    */
    ...
    {report/rprun.i esp/crm/escrm002rp.p}
    {report/rpexc.i}
