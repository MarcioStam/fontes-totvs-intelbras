...
*******************************************************************************/
{include/i-prgvrs.i essec002 1.00.00.000}
...
&GLOBAL-DEFINE Program        essec002
...
&GLOBAL-DEFINE page4Widgets   tg-email 
...
&GLOBAL-DEFINE page2Fields    fl-grupo-ini fl-grupo-fim
...
DEFINE VARIABLE fl-grupo-fim AS CHARACTER FORMAT "X(3)":U INITIAL "ZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZ" 
     VIEW-AS FILL-IN 
     SIZE 4 BY .88 NO-UNDO.

DEFINE VARIABLE fl-grupo-ini AS CHARACTER FORMAT "X(3)":U 
...
DEFINE FRAME fPage4
     tg-email AT ROW 2 COL 5 WIDGET-ID 2
...
DEFINE FRAME fPage2
     fl-grupo-ini AT ROW 1.75 COL 29 COLON-ALIGNED WIDGET-ID 6
     fl-grupo-fim AT ROW 1.75 COL 52 COLON-ALIGNED NO-LABEL WIDGET-ID 8
...
do on error undo, return error on stop  undo, return error:
    ...
    assign tt-param.usuario         = c-seg-usuario
           ...
           tt-param.grupo-ini       = INPUT FRAME fPage2 fl-grupo-ini
           tt-param.grupo-fim       = INPUT FRAME fPage2 fl-grupo-fim
           tt-param.email           = INPUT FRAME fPage4 tg-email.
    ...
    /*Devido a integraá∆o com o ad as execuá‰es em batch devem ser em servidor windows*/
    IF INPUT FRAME fpage6 rsExecution = 2 THEN DO:
        RUN utp/ut-msgs.p (INPUT "show",
                           INPUT 27979,
                           INPUT "ATENÄ«O!" + "~~" + "Este programa possui restriá‰es de execuá∆o, obrigat¢riamente seu agendamento deve ocorrer em servidores Windows.").
    END.
    ...
    {report/rprun.i esp/sec/essec002rp.p}
