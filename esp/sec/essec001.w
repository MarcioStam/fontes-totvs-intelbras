...
*******************************************************************************/
{include/i-prgvrs.i essec001 2.00.00.000}
...
&Scoped-Define ENABLED-OBJECTS RECT-7 RECT-9 bt-arquivo bt-config-impr ~
...
DEFINE VARIABLE c_cod_grp_usuar_fim AS CHARACTER FORMAT "x(3)" INITIAL "ZZZ" 
     VIEW-AS FILL-IN 
     SIZE 4 BY .88 NO-UNDO.

DEFINE VARIABLE c_cod_grp_usuar_ini LIKE usuar_grp_usuar.cod_grp_usuar
     VIEW-AS FILL-IN 
     SIZE 4 BY .88 NO-UNDO.

DEFINE VARIABLE c_cod_usuario_fim AS CHARACTER FORMAT "x(12)" INITIAL "ZZZZZZZZZZZZ" 
     VIEW-AS FILL-IN 
     SIZE 13 BY .88 NO-UNDO.

DEFINE VARIABLE c_cod_usuario_ini LIKE usuar_grp_usuar.cod_usuario
     VIEW-AS FILL-IN 
     SIZE 13 BY .88 NO-UNDO.
...
DEFINE FRAME f-pg-sel
     c_cod_usuario_ini AT ROW 1.25 COL 16.72 COLON-ALIGNED HELP
          "C¢digo Usu†rio"
     c_cod_usuario_fim AT ROW 1.25 COL 43.86 COLON-ALIGNED HELP
          "C¢digo Usu†rio" NO-LABEL WIDGET-ID 2
     c_cod_grp_usuar_ini AT ROW 2.25 COL 25.72 COLON-ALIGNED HELP
          "C¢digo Grupo de Usu†rios" WIDGET-ID 12
     c_cod_grp_usuar_fim AT ROW 2.25 COL 43.86 COLON-ALIGNED HELP
          "C¢digo Grupo de Usu†rios" NO-LABEL WIDGET-ID 14
     IMAGE-1 AT ROW 1.25 COL 31.86
     IMAGE-2 AT ROW 1.25 COL 42.86
     IMAGE-3 AT ROW 2.25 COL 31.86 WIDGET-ID 8
     IMAGE-4 AT ROW 2.25 COL 42.86 WIDGET-ID 10
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 3 ROW 2.85
         SIZE 76.86 BY 10.62
...
/* SETTINGS FOR FRAME f-pg-sel
                                                                        */
/* SETTINGS FOR FILL-IN c_cod_grp_usuar_ini IN FRAME f-pg-sel
   LIKE = emsfnd.usuar_grp_usuar.cod_grp_usuar EXP-SIZE                 */
/* SETTINGS FOR FILL-IN c_cod_usuario_ini IN FRAME f-pg-sel
   LIKE = emsfnd.usuar_grp_usuar.cod_usuario EXP-SIZE                   */
...
{utp/ut9000.i "ESCEP001" "2.00.00.000"}
...
DO  ON ERROR   UNDO MAIN-BLOCK, LEAVE MAIN-BLOCK
    ...
    {include/i-rpmbl.i}
    ASSIGN c-arquivo:SCREEN-VALUE IN FRAME f-pg-imp = session:temp-directory + "essec001.csv".
...
------------------------------------------------------------------------------*/
  ...
  DISPLAY c_cod_usuario_ini c_cod_usuario_fim c_cod_grp_usuar_ini 
          c_cod_grp_usuar_fim 
      WITH FRAME f-pg-sel IN WINDOW w-relat.
  ENABLE IMAGE-1 IMAGE-2 IMAGE-3 IMAGE-4 c_cod_usuario_ini c_cod_usuario_fim 
         c_cod_grp_usuar_ini c_cod_grp_usuar_fim 
      WITH FRAME f-pg-sel IN WINDOW w-relat.
  {&OPEN-BROWSERS-IN-QUERY-f-pg-sel}
  DISPLAY rs-destino c-arquivo rs-execucao 
      WITH FRAME f-pg-imp IN WINDOW w-relat.
  ENABLE RECT-7 RECT-9 bt-arquivo bt-config-impr c-arquivo rs-execucao 
      WITH FRAME f-pg-imp IN WINDOW w-relat.
...
do on error undo, return error on stop  undo, return error:
    ...
    assign tt-param.usuario         = c-seg-usuario
           ...
           &endif
           tt-param.cod_usuario_ini = INPUT FRAME f-pg-sel c_cod_usuario_ini
           tt-param.cod_usuario_fim = INPUT FRAME f-pg-sel c_cod_usuario_fim
           tt-param.cod_grp_usuar_ini = INPUT FRAME f-pg-sel c_cod_grp_usuar_ini
           tt-param.cod_grp_usuar_fim = INPUT FRAME f-pg-sel c_cod_grp_usuar_fim
    ...
    {include/i-rprun.i esp/sec/essec001rp.p}
