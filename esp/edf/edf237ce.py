...
if v_cod_inst_bcia1 = '06' or
   v_cod_inst_bcia2 = '06' then do:
   find tt_param_program_formul
      where tt_param_program_formul.tta_cdn_segment_edi = 292
...
IF p_cdn_element_edi = 4035 THEN DO: /* INSTRUCAO 1*/
  IF v_cod_inst_bcia2 = '06' THEN
     RETURN v_cod_inst_bcia2.
  ELSE 
     RETURN v_cod_inst_bcia1.
END.
IF p_cdn_element_edi = 2391 THEN DO: /* INSTRUCAO 2*/
  IF v_cod_inst_bcia2 = '06' OR
     v_cod_inst_bcia1 = '06' THEN
