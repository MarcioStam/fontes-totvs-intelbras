...
if v_cod_inst_bcia1 = '75' or
   v_cod_inst_bcia2 = '75' then do:
   find tt_param_program_formul
      where tt_param_program_formul.tta_cdn_segment_edi = 292
...
IF p_cdn_element_edi = 2390 THEN DO: /* INSTRUCAO 1*/
   RETURN v_cod_inst_bcia1.
END.
IF p_cdn_element_edi = 2391 THEN DO: /* INSTRUCAO 2*/
