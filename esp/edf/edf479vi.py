...
**
** Programa..............: fnc_vdr_boston
** Descricao.............: Funá‰es
** Versao................:  1.00.00.006
** Procedimento..........: utl_formula_edi
** Nome Externo..........: esp/edf/edf479vi.py
...
then do:
    run pi_version_extract ('fnc_vdr_boston', 'esp/edf/edf479vi.py', '1.00.00.006', 'pro').
end /* if */.
/* End_Include: i_version_extract */
def stream s_acomp.

IF p_cdn_element_edi = 25 THEN DO: /*Valor Db Conta Corrente*/
   find first tt_param_program_formul
        where tt_param_program_formul.tta_cdn_segment_edi = 2
        and   tt_param_program_formul.tta_cdn_element_edi = 10 no-error.
   
   if avail tt_param_program_formul then do:
      FIND FIRST tit_acr NO-LOCK
          WHERE tit_acr.cod_estab      = v_cod_estab_usuar
          AND   tit_acr.num_id_tit_acr = int(entry(2,tt_param_program_formul.ttv_des_contdo,';')) NO-ERROR.
      ...
      if avail parc_vendor then do:
         return string(parc_vendor.val_parc_vendor_orig).
      end.
      else do:
        return '0'.
      end.
...
IF p_cdn_element_edi = 24 THEN DO: /*Valor Pagamento*/
   find first tt_param_program_formul
        where tt_param_program_formul.tta_cdn_segment_edi = 2
        and   tt_param_program_formul.tta_cdn_element_edi = 21 no-error.
   if tt_param_program_formul.ttv_des_contdo <> '98' then do:
      find first tt_param_program_formul
         where tt_param_program_formul.tta_cdn_segment_edi = 2
         and   tt_param_program_formul.tta_cdn_element_edi = 39 no-error.
      return string(tt_param_program_formul.ttv_des_contdo).
   end.
   else do:
      find first tt_param_program_formul
         where tt_param_program_formul.tta_cdn_segment_edi = 2
