/*****************************************************************************
** Programa..............: edf001cb
** Descricao.............: No retorno, inserir o ponto e v°rgula como 
**                         separador da chave.
** Versao................:  1.00.00.001
** Nome Externo..........: esp/edf/edf001cb.py
** Data Geracao..........: 14/06/2022
*****************************************************************************/
...
def var v_chave_banco as char no-undo.
...
then do:
    run pi_version_extract ('fnc_cob_brad_nr_ced', 'esp/edf/edf001cb.py', '1.00.00.001', 'pro').
end /* if */.
/* End_Include: i_version_extract */

/* chave registro */
find tt_param_program_formul
    where tt_param_program_formul.tta_cdn_segment_edi = 296
    and   tt_param_program_formul.tta_cdn_element_edi = 3195 no-error. /* Seu N£mero */

if  avail tt_param_program_formul then
    assign v_chave_banco = replace(tt_param_program_formul.ttv_des_contdo," " , ";").

return v_chave_banco.
