...
**
** Programa..............: fnc_monta_agencia
** Descricao.............: Funá‰es
** Versao................:  1.00.00.006
** Procedimento..........: utl_formula_edi
** Nome Externo..........: prgint/edf/edf902zk.py
** Data Geracao..........: 26/07/2002 - 08:42:54
** Criado por............: bre17191
** Criado em.............: 26/10/1999 16:48:33
** Alterado por..........: bre17906
** Alterado em...........: 25/07/2002 08:30:45
** Gerado por............: bre17906
*****************************************************************************/
...
def var v_num_inic                       as integer         no-undo. /*local*/
...
then do:
    run pi_version_extract ('fnc_monta_agencia', 'prgint/edf/edf902zk.py', '1.00.00.006', 'pro').
end /* if */.
/* End_Include: i_version_extract */

assign v_cod_det = "null" /*l_null_1*/ .
...
if  v_cdn_tip_forma_pagto = 002 or
    v_cdn_tip_forma_pagto = 003 or
    v_cdn_tip_forma_pagto = 004 or
    v_cdn_tip_forma_pagto = 006 or 
    v_cdn_tip_forma_pagto = 007 or 
    v_cdn_tip_forma_pagto = 008 then do:
    ...
    /*if v_cod_usuar_corren = 'FLEITH' then 
       message '1 '  v_cdn_bco skip
                     tt_param_program_formul.ttv_des_contdo skip 
                     substring(tt_param_program_formul.ttv_des_contdo,5,5) skip 
                     dec(substring(tt_param_program_formul.ttv_des_contdo,6,5))
                     view-as alert-box.*/
    /*Mario em 05/01/2005*/
    if  v_cdn_bco = 341 then do:
        assign v_val_cta_arq = dec(substring(tt_param_program_formul.ttv_des_contdo,6,5)).
    end.
    else do:
       assign v_val_cta_arq = dec(substring(tt_param_program_formul.ttv_des_contdo,1,10)).
    end.
    ...
    /*if v_cod_usuar_corren = 'FLEITH' then            
       message ' 2 Banco ' v_cdn_bco skip 
               'Agenc ' v_cdn_agenc skip
               ' *Cta*_  ' v_val_cta_arq skip 
               'Cateudo-> ' tt_param_program_formul.ttv_des_contdo view-as alert-box.*/
    if  v_cdn_bco = 341 then do:
        ...
        if  length(string(v_cod_digito)) = 2 then
            assign v_cod_det = "0" + string(v_cdn_agenc,'9999') +
                               " " + "000000" + string(v_val_cta_arq,'999999') + 
        ...
        if  length(string(v_cod_digito)) = 2 then
            assign v_cod_det = string(v_cdn_agenc,'99999') +
    ...
    /*if v_cod_usuar_corren = 'FLEITH' then 
       message ' 3 Ret '  v_cod_det view-as alert-box.*/
end.
