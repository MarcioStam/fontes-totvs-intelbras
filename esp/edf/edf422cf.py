/*****************************************************************************
** Programa..............: edf422cf
** Descricao.............: Nosso numero na remessa do safra.
** Versao................:  1.00.00.001
** Nome Externo..........: esp/edf/edf422cf.py
** Data Geracao..........: 22/09/2022
*****************************************************************************/
...
def var v_nosso_num      as char format "x(9)"                   no-undo.
...
if  avail tt_param_program_formul then do:
    ...
    IF  AVAIL movto_tit_acr THEN DO:
        ...
        IF  AVAIL tit_acr THEN do:
            assign v_nosso_num = string(tit_acr.cod_tit_acr_bco).
            
            /*
            MESSAGE "tit_acr.cod_estab "       tit_acr.cod_estab       skip
                    ...
                    "p_cdn_element_edi "       p_cdn_element_edi
                    VIEW-AS ALERT-BOX.
            */
        end.
    end.
...
IF  p_cdn_element_edi = 7     /* safra */ 
or  p_cdn_element_edi = 3743  /* itau */ 
or  p_cdn_element_edi = 4028  /* bradesco */ 
or  p_cdn_element_edi = 10    /* Sicredi */ THEN do:
    
    if  p_cdn_element_edi = 10  /* Sicredi */ then
        assign v_nosso_num = substr(v_nosso_num,1,9).

    if  p_cdn_element_edi = 3743  /* itau */ then
        assign v_nosso_num = substr(v_nosso_num,1,8).

    if  p_cdn_element_edi = 4028 /* bradesco */ then do:
        assign v_nosso_num = substr(v_nosso_num,1,12).

        if  v_nosso_num = "" then 
            assign v_nosso_num = "000000000000".
    end.
