...
**
** Programa..............: fnc_vdr_unibanco
** Descricao.............: Funá‰es
** Versao................:  1.00.00.006
** Procedimento..........: utl_formula_edi
** Nome Externo..........: esp/edf/edf409vi.py
...
then do:
    run pi_version_extract ('fnc_vdr_unibanco', 'esp/edf/edf409vi.py', '1.00.00.006', 'pro').
end /* if */.
/* End_Include: i_version_extract */
def stream s_acomp.

IF p_cdn_element_edi = 26 THEN DO: /*Valor Mora Dia*/
   find first tt_param_program_formul
        where tt_param_program_formul.tta_cdn_segment_edi = 3
        and   tt_param_program_formul.tta_cdn_element_edi = 10 no-error.
   
   if avail tt_param_program_formul then do:
      return STRING((((exp( 1.05 , ( 1 / 30)) - 1))  * ( int(tt_param_program_formul.ttv_des_contdo) / 100) * 100),'9999999').
   end.
END.
