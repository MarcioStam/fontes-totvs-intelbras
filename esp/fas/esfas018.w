...
*******************************************************************************/
{include/i-prgvrs.i ESPDP013 2.00.00.001}
...
DEFINE VARIABLE cod_usuar_solic_fim AS CHARACTER FORMAT "X(12)" INITIAL "ZZZZZZZZZZZZ" 
     VIEW-AS FILL-IN 
     SIZE 15 BY .88 TOOLTIP "C¢digo do usu†rio solicitante" NO-UNDO.

DEFINE VARIABLE cod_usuar_solic_ini AS CHARACTER FORMAT "X(12)" 
     LABEL "Cod Usuar Solic" 
     VIEW-AS FILL-IN 
     SIZE 15 BY .88 TOOLTIP "C¢digo do usu†rio solicitante" NO-UNDO.

DEFINE VARIABLE dat_transf_fim AS DATE FORMAT "99/99/9999" INITIAL 12/31/9999 
     VIEW-AS FILL-IN 
     SIZE 11 BY .88 NO-UNDO.

DEFINE VARIABLE dat_transf_ini AS DATE FORMAT "99/99/9999" INITIAL 01/01/001 
     LABEL "Dt Transf" 
     VIEW-AS FILL-IN 
     SIZE 11 BY .88 NO-UNDO.

DEFINE VARIABLE nr_nota_transf_fim AS CHARACTER FORMAT "X(16)" INITIAL "ZZZZZZZZZZZZZZZZ" 
     VIEW-AS FILL-IN 
     SIZE 19 BY .88 TOOLTIP "N£mero nota fiscal de transferància" NO-UNDO.

DEFINE VARIABLE nr_nota_transf_ini AS CHARACTER FORMAT "X(16)" 
     LABEL "Nr Nota Transf" 
     VIEW-AS FILL-IN 
     SIZE 19 BY .88 TOOLTIP "N£mero nota fiscal de transferància" NO-UNDO.

DEFINE VARIABLE num_bem_pat_fim AS INTEGER FORMAT ">>>>>>>>9" INITIAL 999999999 
     VIEW-AS FILL-IN 
     SIZE 15 BY .88 NO-UNDO.

DEFINE VARIABLE num_bem_pat_ini AS INTEGER FORMAT ">>>>>>>>9" INITIAL 0 
     LABEL "Bem Pat" 
     VIEW-AS FILL-IN 
     SIZE 15 BY .88 NO-UNDO.
...
DEFINE FRAME f-pg-sel
     num_bem_pat_ini AT ROW 2.25 COL 22 COLON-ALIGNED HELP
          "N£mero do pedido"
     num_bem_pat_fim AT ROW 2.25 COL 46 COLON-ALIGNED HELP
          "N£mero do pedido" NO-LABEL
     cod_usuar_solic_ini AT ROW 3.25 COL 22 COLON-ALIGNED WIDGET-ID 20
     cod_usuar_solic_fim AT ROW 3.25 COL 46.14 COLON-ALIGNED NO-LABEL WIDGET-ID 18
     nr_nota_transf_ini AT ROW 4.25 COL 18 COLON-ALIGNED WIDGET-ID 48
     nr_nota_transf_fim AT ROW 4.25 COL 46.14 COLON-ALIGNED NO-LABEL WIDGET-ID 46
     dat_transf_ini AT ROW 5.25 COL 26 COLON-ALIGNED HELP
          "Data em que o Pedido foi implantado no sistema" WIDGET-ID 12
     dat_transf_fim AT ROW 5.25 COL 46 COLON-ALIGNED HELP
          "Data em que o Pedido foi implantado no sistema" NO-LABEL WIDGET-ID 10
     rs_status AT ROW 8.25 COL 24 NO-LABEL WIDGET-ID 26
     "Seleá∆o" VIEW-AS TEXT
          SIZE 9 BY .67 AT ROW 1.25 COL 6 WIDGET-ID 54
     "Status das Solicitaá‰es" VIEW-AS TEXT
          SIZE 21 BY .67 AT ROW 7.25 COL 6 WIDGET-ID 32
     IMAGE-1 AT ROW 2.25 COL 40
     IMAGE-12 AT ROW 2.25 COL 44 WIDGET-ID 24
     RECT-17 AT ROW 7.5 COL 2 WIDGET-ID 30
     RECT-19 AT ROW 1.5 COL 2 WIDGET-ID 36
     IMAGE-15 AT ROW 5.25 COL 40 WIDGET-ID 38
     IMAGE-16 AT ROW 3.25 COL 40 WIDGET-ID 40
     IMAGE-17 AT ROW 5.25 COL 44 WIDGET-ID 42
     IMAGE-18 AT ROW 3.25 COL 44 WIDGET-ID 44
     IMAGE-19 AT ROW 4.25 COL 40 WIDGET-ID 50
     IMAGE-20 AT ROW 4.25 COL 44 WIDGET-ID 52
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 3 ROW 2.85
...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW w-relat ASSIGN
         HIDDEN             = YES
         TITLE              = "Listagem de Solicitaá‰es de Transferàncias de Bens"
         HEIGHT             = 15
         WIDTH              = 81.14
         MAX-HEIGHT         = 28.33
         MAX-WIDTH          = 195.14
...
ON END-ERROR OF w-relat /* Listagem de Solicitaá‰es de Transferàncias de Bens */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL w-relat w-relat
ON WINDOW-CLOSE OF w-relat /* Listagem de Solicitaá‰es de Transferàncias de Bens */
DO:
...
{utp/ut9000.i "ESFAS018" "2.00.00.001"}
...
------------------------------------------------------------------------------*/
  ...
  DISPLAY num_bem_pat_ini num_bem_pat_fim cod_usuar_solic_ini 
          cod_usuar_solic_fim nr_nota_transf_ini nr_nota_transf_fim 
          dat_transf_ini dat_transf_fim rs_status 
      WITH FRAME f-pg-sel IN WINDOW w-relat.
  ENABLE IMAGE-1 IMAGE-12 RECT-17 RECT-19 IMAGE-15 IMAGE-16 IMAGE-17 IMAGE-18 
         IMAGE-19 IMAGE-20 num_bem_pat_ini num_bem_pat_fim cod_usuar_solic_ini 
         cod_usuar_solic_fim nr_nota_transf_ini nr_nota_transf_fim 
         dat_transf_ini dat_transf_fim rs_status 
      WITH FRAME f-pg-sel IN WINDOW w-relat.
...
do on error undo, return error on stop  undo, return error:
    ...
    assign tt-param.usuario             = c-seg-usuario
           ...
           tt-param.cod_usuar_solic_ini = input frame f-pg-sel cod_usuar_solic_ini
           tt-param.cod_usuar_solic_fim = input frame f-pg-sel cod_usuar_solic_fim
           tt-param.nr_nota_transf_ini  = input frame f-pg-sel nr_nota_transf_ini
           tt-param.nr_nota_transf_fim  = input frame f-pg-sel nr_nota_transf_fim
           tt-param.dat_transf_ini      = input frame f-pg-sel dat_transf_ini
           tt-param.dat_transf_fim      = input frame f-pg-sel dat_transf_fim
           tt-param.rs_status           = input frame f-pg-sel rs_status.
    ...
    {include/i-rprun.i esp/fas/esfas018rp.p}
