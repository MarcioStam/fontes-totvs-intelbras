...
*******************************************************************************/
{include/i-prgvrs.i ESFAS016 2.00.00.001}
...
DEFINE VARIABLE h_esfas016-q01 AS HANDLE NO-UNDO.
DEFINE VARIABLE h_esfas016-v01 AS HANDLE NO-UNDO.
...
DEFINE FRAME f-cad
    ...
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         ...
         AT COL 1 ROW 1
         SIZE 87 BY 20.08 WIDGET-ID 100.
...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW w-cadsim ASSIGN
         HIDDEN             = YES
         TITLE              = "Solicita‡Æo Transf Imobilizado - ESFAS016"
         HEIGHT             = 20.04
         WIDTH              = 86.86
         MAX-HEIGHT         = 27.04
         MAX-WIDTH          = 195.14
...
ON END-ERROR OF w-cadsim /* Solicita‡Æo Transf Imobilizado - ESFAS016 */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL w-cadsim w-cadsim
ON WINDOW-CLOSE OF w-cadsim /* Solicita‡Æo Transf Imobilizado - ESFAS016 */
DO:
...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'esp/fas/esfas016-v01.w':U ,
             INPUT  FRAME f-cad:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_esfas016-v01 ).
       RUN set-position IN h_esfas016-v01 ( 2.75 , 1.00 ) NO-ERROR.
       /* Size in UIB:  ( 18.25 , 86.57 ) */

       RUN init-object IN THIS-PROCEDURE (
             INPUT  'esp/fas/esfas016-q01.w':U ,
             INPUT  FRAME f-cad:HANDLE ,
             INPUT  'ProgPesquisa = esp/fas/esfas016-z01.w,
                     ProgVaPara = esp/fas/esfas016-g01.w,
                     ProgIncMod = ,
                     Implantar = no':U ,
             OUTPUT h_esfas016-q01 ).
       RUN set-position IN h_esfas016-q01 ( 1.00 , 65.00 ) NO-ERROR.
       /* Size in UIB:  ( 1.63 , 7.72 ) */

       /* Links to SmartPanel h_p-exihel. */
       RUN add-link IN adm-broker-hdl ( h_p-cadsim , 'State':U , h_p-exihel ).

       /* Links to SmartViewer h_esfas016-v01. */
       RUN add-link IN adm-broker-hdl ( h_esfas016-q01 , 'Record':U , h_esfas016-v01 ).
       RUN add-link IN adm-broker-hdl ( h_p-cadsim , 'TableIO':U , h_esfas016-v01 ).

       /* Links to SmartQuery h_esfas016-q01. */
       RUN add-link IN adm-broker-hdl ( h_p-exihel , 'State':U , h_esfas016-q01 ).
       RUN add-link IN adm-broker-hdl ( h_p-navega , 'Navigation':U , h_esfas016-q01 ).
       RUN add-link IN adm-broker-hdl ( h_p-navega , 'State':U , h_esfas016-q01 ).
       ...
       RUN adjust-tab-order IN adm-broker-hdl ( h_p-exihel ,
             h_p-cadsim , 'AFTER':U ).
       RUN adjust-tab-order IN adm-broker-hdl ( h_esfas016-v01 ,
             h_p-exihel , 'AFTER':U ).
    END. /* Page 0 */
...
------------------------------------------------------------------------------*/
  ...
  {utp/ut9000.i "ESFAS016" "2.00.00.001"}
