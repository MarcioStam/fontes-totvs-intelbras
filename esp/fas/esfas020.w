...
*******************************************************************************/
{include/i-prgvrs.i esfas020 2.00.00.000}
...
DEFINE VARIABLE rs-tipo-import AS INTEGER 
     VIEW-AS RADIO-SET VERTICAL
     RADIO-BUTTONS 
          "Documentos de Entrada", 1,
"Bens", 2
...
DEFINE FRAME f-pg-sel
     rs-tipo-import AT ROW 4.5 COL 18 NO-LABEL WIDGET-ID 34
     bt-pesquisa AT ROW 8 COL 68.43 WIDGET-ID 26
     c-arquivo-import AT ROW 8.17 COL 19 COLON-ALIGNED WIDGET-ID 28
     "Tipo de Importaá∆o" VIEW-AS TEXT
          SIZE 18 BY .67 AT ROW 3.5 COL 15 WIDGET-ID 38
     RECT-14 AT ROW 1.38 COL 2.14 WIDGET-ID 30
     RECT-15 AT ROW 3.75 COL 13 WIDGET-ID 40
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 3 ROW 2.85
...
{utp/ut9000.i "esfas020" "2.00.00.000"}
...
------------------------------------------------------------------------------*/
  ...
  DISPLAY rs-tipo-import c-arquivo-import 
      WITH FRAME f-pg-sel IN WINDOW w-relat.
  ENABLE RECT-14 RECT-15 rs-tipo-import bt-pesquisa c-arquivo-import 
      WITH FRAME f-pg-sel IN WINDOW w-relat.
...
do on error undo, return error on stop  undo, return error:
    ...
    assign tt-param.usuario         = c-seg-usuario
           ...
           tt-param.arquivo-import  = INPUT FRAME f-pg-sel c-arquivo-import
           tt-param.tipo-import     = INPUT FRAME f-pg-sel rs-tipo-import.
    ...
    {include/i-rprun.i esp/fas/esfas020rp.p}
