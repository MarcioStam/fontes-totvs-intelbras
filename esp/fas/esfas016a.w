...
*******************************************************************************/
{include/i-prgvrs.i ESCDP071A 2.00.00.000}
{include/i-rpvar.i}
...
DEFINE BUTTON bt-pesquisa-2 
     IMAGE-UP FILE "image/im-joi.bmp":U
     LABEL "Busca Arquivo" 
     SIZE 4.14 BY 1.13.

DEFINE VARIABLE c-arq-import AS CHARACTER FORMAT "X(256)":U 
     VIEW-AS FILL-IN 
     SIZE 63 BY .79 NO-UNDO.

DEFINE IMAGE IMAGE-6
     FILENAME "image\planilha_escdp071.jpg":U
     SIZE 32 BY 4.5.

DEFINE RECTANGLE retangulo-explorador-2
     EDGE-PIXELS 2 GRAPHIC-EDGE  NO-FILL   
     SIZE 74 BY 3.25.
...
DEFINE RECTANGLE retangulo-explorador
     EDGE-PIXELS 2 GRAPHIC-EDGE  NO-FILL   
     SIZE 74 BY 3.25.
...
DEFINE FRAME f-relat
     bt-pesquisa AT ROW 3.83 COL 70 WIDGET-ID 24
     c-arq-import AT ROW 4.08 COL 7 NO-LABEL WIDGET-ID 26 FORMAT "X(256)":U
          VIEW-AS FILL-IN 
          SIZE 63 BY .79
     ...
     bt-ajuda AT ROW 14.54 COL 70 HELP
          "Ajuda"
     "Retirar os cabeáalhos para importar." VIEW-AS TEXT
          SIZE 53 BY .67 AT ROW 7.25 COL 7 WIDGET-ID 54
     "Layout da Planilha de Importaá∆o, arquivo .csv" VIEW-AS TEXT
          SIZE 53 BY .67 AT ROW 6.25 COL 7 WIDGET-ID 28
     ...
     retangulo-explorador AT ROW 2.5 COL 4 WIDGET-ID 50
     IMAGE-5 AT ROW 8.25 COL 6 WIDGET-ID 52
...
DEFINE FRAME f-pg-sel
     bt-pesquisa-2 AT ROW 2.92 COL 68.86 WIDGET-ID 56
     c-arq-import AT ROW 3.17 COL 5.86 NO-LABEL WIDGET-ID 58
     "Retirar os cabeáalhos para importar." VIEW-AS TEXT
          SIZE 53 BY .67 AT ROW 6.13 COL 4.57 WIDGET-ID 64
     "Layout da Planilha de Importaá∆o, arquivo .csv" VIEW-AS TEXT
          SIZE 53 BY .67 AT ROW 5.13 COL 4.57 WIDGET-ID 66
     retangulo-explorador-2 AT ROW 1.58 COL 2.72 WIDGET-ID 62
     IMAGE-6 AT ROW 7 COL 4.14 WIDGET-ID 60
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 3 ROW 2.85
...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW w-relat ASSIGN
         HIDDEN             = YES
         TITLE              = "ESCDP071A - Importaá∆o de Supervisores."
         HEIGHT             = 15
         WIDTH              = 81.14
         MAX-HEIGHT         = 22.33
         MAX-WIDTH          = 114.29
...
/* SETTINGS FOR FRAME f-pg-sel
                                                                        */
/* SETTINGS FOR FILL-IN c-arq-import IN FRAME f-pg-sel
   ALIGN-L                                                              */
/* SETTINGS FOR FRAME f-relat
                                                                        */
/* SETTINGS FOR FILL-IN c-arq-import IN FRAME f-relat
   ALIGN-L                                                              */
...
ON CHOOSE OF bt-pesquisa IN FRAME f-relat /* Busca Arquivo */
DO:
    def var c-arq-conv  as char no-undo.
    ...
    IF l-ok THEN DO:
        assign c-arq-import = c-arq-conv.
        display c-arq-import with frame fPage0.
    END.
END.
...
&Scoped-define SELF-NAME bt-pesquisa-2
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL bt-pesquisa-2 w-relat
ON CHOOSE OF bt-pesquisa-2 IN FRAME f-pg-sel /* Busca Arquivo */
DO:
    def var c-arq-conv  as char no-undo.
    def var l-ok        as logical init no.
    ...
    IF l-ok THEN DO:
        assign c-arq-import = c-arq-conv.
        display c-arq-import with frame f-pg-sel.
    END.
END.
...
{utp/ut9000.i "ESCDP079A" "2.00.00.000"}
...
------------------------------------------------------------------------------*/
  ...
  ENABLE im-pg-imp im-pg-sel retangulo-explorador IMAGE-5 bt-pesquisa 
         c-arq-import bt-executar bt-cancelar bt-ajuda 
      WITH FRAME f-relat IN WINDOW w-relat.
  {&OPEN-BROWSERS-IN-QUERY-f-relat}
  DISPLAY c-arq-import 
      WITH FRAME f-pg-sel IN WINDOW w-relat.
  ENABLE retangulo-explorador-2 IMAGE-6 bt-pesquisa-2 c-arq-import 
      WITH FRAME f-pg-sel IN WINDOW w-relat.
...
do on error undo, return error on stop  undo, return error:
    ...
    assign tt-param.usuario         = c-seg-usuario
           ...
           tt-param.c-arq-import    = c-arq-import:SCREEN-VALUE IN FRAME f-pg-sel
    ...
    {include/i-rprun.i esp/cdp/escdp071arp.p}
