...
&Scoped-define QUERY-STRING-Query-Main FOR EACH int_solic_transf ~
      WHERE int_solic_transf.cod_usuar_solic = v_cod_usuar_corren NO-LOCK
&Scoped-define OPEN-QUERY-Query-Main OPEN QUERY Query-Main FOR EACH int_solic_transf ~
      WHERE int_solic_transf.cod_usuar_solic = v_cod_usuar_corren NO-LOCK.
&Scoped-define TABLES-IN-QUERY-Query-Main int_solic_transf
&Scoped-define FIRST-TABLE-IN-QUERY-Query-Main int_solic_transf
...
/* Query rebuild information for QUERY Query-Main
     ...
     _Options          = "NO-LOCK"
     _Where[1]         = "mgesp.int_solic_transf.cod_usuar_solic = v_cod_usuar_corren"
