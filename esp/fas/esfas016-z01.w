...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 1 THEN DO:
       ...
       RUN set-position IN h_esfas016-b01 ( 2.50 , 2.00 ) NO-ERROR.
       /* Size in UIB:  ( 12.00 , 80.14 ) */

       /* Links to SmartBrowser h_esfas016-b01. */
       RUN add-link IN adm-broker-hdl ( h_esfas016-b01 , 'State':U , THIS-PROCEDURE ).
