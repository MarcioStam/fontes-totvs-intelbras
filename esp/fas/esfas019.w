...
**  Versao..: 1.00.00.000 - Tetra - 04/2012 - Versao Inicial.
*******************************************************************************/
{include/i-prgvrs.i esfas019 1.00.00.000}
{utp/ut-glob.i}
{cdp/cdcfgmat.i}
...
&GLOBAL-DEFINE Program        esfas019
...
&GLOBAL-DEFINE page2Widgets   bt-pesquisa rs-tipo
...
DEFINE VARIABLE text-modo AS CHARACTER FORMAT "X(256)":U INITIAL "Execuªá∆o" 
      VIEW-AS TEXT 
     SIZE 10.86 BY .63
     FONT 1 NO-UNDO.
...
DEFINE FRAME fPage6
     rsDestiny AT ROW 2.38 COL 3.14 HELP
          "Destino de Impressío do RelatΩrio" NO-LABEL
     cFile AT ROW 3.63 COL 3.14 HELP
          "Nome do arquivo de destino do relatΩrio" NO-LABEL
     btFile AT ROW 3.5 COL 43 HELP
          "Escolha do nome do arquivo"
     btConfigImpr AT ROW 3.5 COL 43 HELP
          "Configuraªío da impressora"
...
DEFINE FRAME fPage2
     rs-tipo AT ROW 2.25 COL 21 NO-LABEL WIDGET-ID 8
     bt-pesquisa AT ROW 5.75 COL 71.14 WIDGET-ID 4 NO-TAB-STOP 
     fi-arquivo AT ROW 5.83 COL 11 COLON-ALIGNED WIDGET-ID 2
     ed-descricao AT ROW 7 COL 13 NO-LABEL WIDGET-ID 6
     "Alocaá‰es" VIEW-AS TEXT
          SIZE 8 BY .54 AT ROW 1.5 COL 15 WIDGET-ID 14
     RECT-10 AT ROW 1.75 COL 13 WIDGET-ID 12
    WITH 1 DOWN KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW wReport ASSIGN
         HIDDEN             = YES
         TITLE              = "Inclus∆o/Exclus∆o Alocaá‰es Bens"
         HEIGHT             = 17
         WIDTH              = 90
         MAX-HEIGHT         = 22
         MAX-WIDTH          = 114.14
...
ON END-ERROR OF wReport /* Inclus∆o/Exclus∆o Alocaá‰es Bens */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL wReport wReport
ON WINDOW-CLOSE OF wReport /* Inclus∆o/Exclus∆o Alocaá‰es Bens */
DO:
       ...
       IF INPUT FRAME fPage2 fi-arquivo <> "" THEN DO:
           IF SEARCH(fi-arquivo:SCREEN-VALUE IN FRAME fPage2) = ? THEN DO:
               RUN utp/ut-msgs.p (INPUT "SHOW":U,
                                  INPUT 17006,
                                  INPUT "Arquivo de importaá∆o informado n∆o encontrado.").
           ...
           ELSE DO:
               IF ENTRY(2,fi-arquivo:SCREEN-VALUE IN FRAME fPage2,".") <> "csv" THEN DO:
                   RUN utp/ut-msgs.p (INPUT "SHOW":U,
                                      INPUT 17006,
                                      INPUT "Arquivo de importaá∆o informado deve ser .csv !").
                   APPLY "entry" TO fi-arquivo IN FRAME fPage2.
                   RETURN NO-APPLY.
               END.
           END.
...
do  with frame fPage6:
    case self:screen-value:
        ...
        when "3":U then do:
            ...
            /*Fim alteracao 15/02/2005*/
        END.
        /*Alterado 15/02/2005 - tech1007 - Condiªío removida pois RTF nío ≤ mais um destino
        when "4":U then do:
            assign cFile:sensitive       = no
                   cFile:visible         = yes
                   btFile:visible        = no
...
/*:T--- Logica para inicializacao do programam ---*/
{report/mainblock.i}
...
------------------------------------------------------------------------------*/
    ...
    ASSIGN ed-descricao:SCREEN-VALUE IN FRAME fPage2 = "Informar arquivo csv para exclus∆o ou inclus∆o de alocaá‰es, separados por ponto e v°rgula e conforme a sequància a seguir." + CHR(10) + CHR(10) +
                                                       "Exclus∆o: Conta Patrimonial, Bem e Sequància." + CHR(10) + CHR(10) +
                                                       "Inclus∆o: Conta Patrimonial, Bem, Sequància, Centro de custo, Unidade de neg¢cio e percentual de rateio.".
...
do on error undo, return error on stop  undo, return error:
    ...
    ASSIGN tt-param.usuario        = c-seg-usuario
           ...
           tt-param.ind-tipo       = INPUT FRAME fPage2 rs-tipo.
    ...
    {report/rprun.i esp/fas/esfas019rp.p}
