...
DEFINE VARIABLE c-arquivo AS CHARACTER FORMAT "X(40)":U INITIAL "esfas007.lst" 
     VIEW-AS FILL-IN 
...
DEFINE FRAME f-relat
     v_cod_estab_ini   AT ROW 2.25 COL 13.14 COLON-ALIGNED LABEL "Estabelecimento"   VIEW-AS FILL-IN SIZE-CHARS 4.14 BY .88 FGCOLOR ? BGCOLOR 15 FONT 2
     v_cod_estab_fim   AT ROW 2.25 COL 42    COLON-ALIGNED NO-LABEL                  VIEW-AS FILL-IN SIZE-CHARS 4.14 BY .88 FGCOLOR ? BGCOLOR 15 FONT 2
     v_cod_cta_pat_ini AT ROW 3.25 COL 13.14 COLON-ALIGNED LABEL "Conta Patrimonial" VIEW-AS FILL-IN SIZE-CHARS 19.14 BY .88 FGCOLOR ? BGCOLOR 15 FONT 2
     v_cod_cta_pat_fim AT ROW 3.25 COL 42    COLON-ALIGNED NO-LABEL                  VIEW-AS FILL-IN SIZE-CHARS 19.14 BY .88 FGCOLOR ? BGCOLOR 15 FONT 2
     v_num_bem_pat_ini AT ROW 4.25 COL 13.14 COLON-ALIGNED LABEL "Bem Patrimonial"   VIEW-AS FILL-IN SIZE-CHARS 10.14 BY .88 FGCOLOR ? BGCOLOR 15 FONT 2
     v_num_bem_pat_fim AT ROW 4.25 COL 42    COLON-ALIGNED NO-LABEL                  VIEW-AS FILL-IN SIZE-CHARS 10.14 BY .88 FGCOLOR ? BGCOLOR 15 FONT 2
     rs-destino AT ROW 7.5 COL 2 HELP
          "Destino da Impress∆o" NO-LABEL
     bt-cfimp AT ROW 8.5 COL 46.57 HELP
          "Layout Impress∆o"
     bt-arquivo AT ROW 8.5 COL 46.57 HELP
          "Localiza Arquivo"
     c-arquivo AT ROW 8.58 COL 2.14 HELP
          "Destino" NO-LABEL
     rs-execucao AT ROW 7.5 COL 58 HELP
          "Execuá∆o On Line ou Batch" NO-LABEL
     bt-imprime AT ROW 10.46 COL 2.29
     bt-salva AT ROW 10.46 COL 14
     IMAGE-1 AT ROW 2.3 COL 36
     IMAGE-2 AT ROW 2.3 COL 40
     IMAGE-3 AT ROW 3.3 COL 36
     IMAGE-4 AT ROW 3.3 COL 40
     IMAGE-5 AT ROW 4.3 COL 36
     IMAGE-6 AT ROW 4.3 COL 40
     RECT-2 AT ROW 10.17 COL 1.29
     RECT-29 AT ROW 6.79 COL 57
     RECT-7 AT ROW  6.79 COL 1
     RECT-8 AT ROW 1.25 COL 1
     "  Impress∆o" VIEW-AS TEXT
          SIZE 10.57 BY .54 AT ROW 06.63 COL 2.86
          FONT 6
     " Execuá∆o" VIEW-AS TEXT
          SIZE 9.43 BY .54 AT ROW 06.58 COL 58
          FONT 6
...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW C-Win ASSIGN
         HIDDEN             = YES
         TITLE              = "Relat¢rio Complemento Bem Patrimonial - esfas007"
         COLUMN             = 14.29
         ROW                = 6.54
         HEIGHT             = 11
         WIDTH              = 69
...
ON END-ERROR OF C-Win /* Relat¢rio Prazo MÇdio Fornecedor - esfas007 */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL C-Win C-Win
ON WINDOW-CLOSE OF C-Win /* Relat¢rio Prazo MÇdio Fornecedor - esfas007 */
DO:
...
DO:
  ...
  DO.
    RUN prgtec/btb/btb911za.p (INPUT  "esfas007rp",
                               INPUT  "1.00.000",
                               INPUT  0,
...
DO:
  ...
  if input frame f-relat rs-destino = 2 then do:
      ...
      if input frame f-relat rs-execucao = 1 then
          assign c-arquivo:screen-value in frame f-relat = session:temp-directory + "esfas007.lst"
                 c-impressora                          = ""
                 c-layout                              = "".
      else
          assign c-arquivo:screen-value in frame f-relat = "esfas007.lst"
                 c-impressora                          = ""
                 c-layout                              = "".
...
------------------------------------------------------------------------------*/
  DISPLAY v_cod_estab_ini v_cod_estab_fim v_cod_cta_pat_ini v_cod_cta_pat_fim v_num_bem_pat_ini v_num_bem_pat_fim 
          rs-destino c-arquivo rs-execucao 
      WITH FRAME f-relat IN WINDOW C-Win.
  ENABLE v_cod_estab_ini v_cod_estab_fim v_cod_cta_pat_ini v_cod_cta_pat_fim v_num_bem_pat_ini v_num_bem_pat_fim 
         rs-destino bt-cfimp bt-arquivo c-arquivo 
...
/* */
  ...
  DO WITH FRAME f-relat:
    ASSIGN rs-execucao:SCREEN-VALUE       IN FRAME f-relat = entry( 1,dwb_set_list_param.cod_dwb_parameters,chr(10))
           v_cod_estab_ini:screen-value   in frame f-relat = ENTRY( 2,dwb_set_list_param.cod_dwb_parameters,chr(10))
           v_cod_estab_fim:screen-value   in frame f-relat = ENTRY( 3,dwb_set_list_param.cod_dwb_parameters,chr(10))
           v_cod_cta_pat_ini:screen-value in frame f-relat = ENTRY( 4,dwb_set_list_param.cod_dwb_parameters,chr(10))
           v_cod_cta_pat_fim:screen-value in frame f-relat = ENTRY( 5,dwb_set_list_param.cod_dwb_parameters,chr(10))
           v_num_bem_pat_ini:screen-value in frame f-relat = ENTRY( 6,dwb_set_list_param.cod_dwb_parameters,chr(10))
           v_num_bem_pat_fim:screen-value in frame f-relat = ENTRY( 7,dwb_set_list_param.cod_dwb_parameters,chr(10))
...
do:
  for each ped_exec no-lock
      where ped_exec.cod_prog_dtsul = "esfas007rp"
...
FIND prog_dtsul NO-LOCK
    WHERE prog_dtsul.cod_prog_dtsul = "esfas007" NO-ERROR.
...
DO:
  FOR EACH usuar_grp_usuar NO-LOCK
    ...
    IF NOT CAN-FIND(FIRST prog_dtsul_segur NO-LOCK
                    WHERE  prog_dtsul_segur.cod_prog_dtsul = "esfas007"
...
/* */
  ...
  ASSIGN dwb_set_list_param.Cod_dwb_program          = "esfas007rp"
         ...
         dwb_set_list_param.Cod_dwb_parameters       = STRING(rs-execucao)             + chr(10) + 
                                                              ...
                                                              string(v_cod_cta_pat_ini)           + chr(10) +
                                                              string(v_cod_cta_pat_fim)           + chr(10) +
                                                              string(v_num_bem_pat_ini)         + chr(10) +
                                                              string(v_num_bem_pat_fim)         + chr(10)
