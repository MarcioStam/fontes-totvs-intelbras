...
*******************************************************************************/
{include/i-prgvrs.i Q05IV039 2.00.00.010}  /*** 010010 ***/

&IF "{&EMSFND_VERSION}" >= "1.00"
&THEN
{include/i-license-manager.i Q05IV039 MUT}
&ENDIF
...
&Scoped-define INTERNAL-TABLES usuar_mestre

/* Definitions for QUERY Query-Main                                     */
&Scoped-define SELF-NAME Query-Main
&Scoped-define QUERY-STRING-Query-Main FOR EACH usuar_mestre     WHERE usuar_mestre.cod_usuario = v_cod_usuar_corren NO-LOCK
&Scoped-define OPEN-QUERY-Query-Main OPEN QUERY {&SELF-NAME} FOR EACH usuar_mestre     WHERE usuar_mestre.cod_usuario = v_cod_usuar_corren NO-LOCK.
&Scoped-define TABLES-IN-QUERY-Query-Main usuar_mestre
&Scoped-define FIRST-TABLE-IN-QUERY-Query-Main usuar_mestre
...
<FOREIGN-KEYS>
ep-codigo||y|mginv.sub-div-ordem.ep-codigo
</FOREIGN-KEYS> 
<EXECUTING-CODE>
**************************
...
/* Query rebuild information for QUERY Query-Main
     _START_FREEFORM
OPEN QUERY {&SELF-NAME} FOR EACH usuar_mestre
    WHERE usuar_mestre.cod_usuario = v_cod_usuar_corren NO-LOCK.
     _END_FREEFORM
     _Options          = "NO-LOCK"
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE local-get-last q-tables 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE local-get-next q-tables 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE local-get-prev q-tables 
...
------------------------------------------------------------------------------*/
  ...
  {src/adm/template/sndkycas.i "ep-codigo" "sub-div-ordem" "ep-codigo"}
