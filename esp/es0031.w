...
*******************************************************************************/
{include/i-prgvrs.i es0031 2.04.00.001}

CREATE WIDGET-POOL.

/* Preprocessors Definitions ---                                      */
&GLOBAL-DEFINE Program        es0031
...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW wReport ASSIGN
         HIDDEN             = YES
         TITLE              = "Geraá∆o Valores Oráamento - Ano Todo"
         HEIGHT             = 17
         WIDTH              = 90
         MAX-HEIGHT         = 40.83
         MAX-WIDTH          = 182.86
...
ON END-ERROR OF wReport /* Geraá∆o Valores Oráamento - Ano Todo */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL wReport wReport
ON WINDOW-CLOSE OF wReport /* Geraá∆o Valores Oráamento - Ano Todo */
DO:
