...
*******************************************************************************/
{include/i-prgvrs.i es0022 2.04.00.001}

CREATE WIDGET-POOL.

/* Preprocessors Definitions ---                                      */
&GLOBAL-DEFINE Program        es0022
...
DEFINE VARIABLE i-ano AS INTEGER FORMAT ">>>9":U INITIAL 0 
     LABEL "Ano" 
     VIEW-AS FILL-IN 
     SIZE 8.86 BY .79 NO-UNDO.

DEFINE VARIABLE i-mes AS INTEGER FORMAT ">9":U INITIAL 0 
     LABEL "Màs" 
     VIEW-AS FILL-IN 
     SIZE 8.86 BY .79 NO-UNDO.
...
DEFINE FRAME fPage6
     i-mes AT ROW 2.5 COL 9 COLON-ALIGNED
     i-ano AT ROW 2.5 COL 30 COLON-ALIGNED
     rsDestiny AT ROW 5 COL 3.14 HELP
          "Destino de Impress∆o do Relat¢rio" NO-LABEL
     btFile AT ROW 6.21 COL 43.14 HELP
          "Escolha do nome do arquivo"
     cFile AT ROW 6.25 COL 3.14 HELP
          "Nome do arquivo de destino do relat¢rio" NO-LABEL
     btConfigImpr AT ROW 6.25 COL 43 HELP
          "Configuraá∆o da impressora"
     rsExecution AT ROW 8.38 COL 2.86 HELP
          "Modo de Execuá∆o" NO-LABEL
     text-destino AT ROW 4.25 COL 1.72 COLON-ALIGNED NO-LABEL
     text-modo AT ROW 7.63 COL 1.14 COLON-ALIGNED NO-LABEL
     "Seleá∆o" VIEW-AS TEXT
          SIZE 8 BY .54 AT ROW 1.5 COL 4
     RECT-10 AT ROW 1.75 COL 2
     RECT-7 AT ROW 4.5 COL 2
...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW wReport ASSIGN
         HIDDEN             = YES
         TITLE              = "Geraá∆o Valores Oráamento - Màs Informado"
         HEIGHT             = 17
         WIDTH              = 90
         MAX-HEIGHT         = 40.83
         MAX-WIDTH          = 182.86
...
ON END-ERROR OF wReport /* Geraá∆o Valores Oráamento - Màs Informado */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL wReport wReport
ON WINDOW-CLOSE OF wReport /* Geraá∆o Valores Oráamento - Màs Informado */
DO:
...
do on error undo, return error on stop  undo, return error:
    ...
    */
    ...
    assign tt-param.usuario         = c-seg-usuario
           ...
           tt-param.ano             = input frame fPage6 i-ano
           tt-param.mes             = input frame fPage6 i-mes.
