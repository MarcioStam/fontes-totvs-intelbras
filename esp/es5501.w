...
*******************************************************************************/
{include/i-prgvrs.i ES5501 2.00.00.000}
...
DEFINE VARIABLE h_es5501-q AS HANDLE NO-UNDO.
DEFINE VARIABLE h_es5501-v AS HANDLE NO-UNDO.
...
DEFINE FRAME f-cad
    ...
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         ...
         AT COL 1 ROW 1
         SIZE 89.72 BY 9.88 WIDGET-ID 100.
...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'esp/es5501-v.w':U ,
             INPUT  FRAME f-cad:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_es5501-v ).
       RUN set-position IN h_es5501-v ( 2.83 , 1.72 ) NO-ERROR.
       /* Size in UIB:  ( 7.75 , 88.57 ) */

       RUN init-object IN THIS-PROCEDURE (
             INPUT  'esp/es5501-q.w':U ,
             INPUT  FRAME f-cad:HANDLE ,
             INPUT  '':U ,
             OUTPUT h_es5501-q ).
       RUN set-position IN h_es5501-q ( 1.00 , 57.00 ) NO-ERROR.
       /* Size in UIB:  ( 2.00 , 8.00 ) */

       /* Links to SmartPanel h_p-exihel. */
       RUN add-link IN adm-broker-hdl ( h_p-cadsim , 'State':U , h_p-exihel ).

       /* Links to SmartViewer h_es5501-v. */
       RUN add-link IN adm-broker-hdl ( h_es5501-q , 'Record':U , h_es5501-v ).
       RUN add-link IN adm-broker-hdl ( h_p-cadsim , 'TableIO':U , h_es5501-v ).

       /* Links to SmartQuery h_es5501-q. */
       RUN add-link IN adm-broker-hdl ( h_p-navega , 'Navigation':U , h_es5501-q ).
       ...
       RUN adjust-tab-order IN adm-broker-hdl ( h_p-exihel ,
             h_p-cadsim , 'AFTER':U ).
       RUN adjust-tab-order IN adm-broker-hdl ( h_es5501-v ,
             h_p-exihel , 'AFTER':U ).
    END. /* Page 0 */
...
------------------------------------------------------------------------------*/
  ...
  {utp/ut9000.i "ES5501" "2.00.00.000"}
