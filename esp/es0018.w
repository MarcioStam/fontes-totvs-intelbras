...
*******************************************************************************/
{include/i-prgvrs.i ES0018 2.04.00.000}

CREATE WIDGET-POOL.

/* Preprocessors Definitions ---                                      */
&GLOBAL-DEFINE Program          ES0018
...
&GLOBAL-DEFINE hDBOParent       HDBOttponto-programa
&GLOBAL-DEFINE DBOParentTable   ponto-programa
&GLOBAL-DEFINE DBOParentDestroy NO

&GLOBAL-DEFINE ttSon1           ttconteudo-programa
&GLOBAL-DEFINE hDBOSon1         HDBOttconteudo-programa
&GLOBAL-DEFINE DBOSon1Table     conteudo-programa
&GLOBAL-DEFINE DBOSon1Destroy   YES

&GLOBAL-DEFINE page0Fields      ttponto-programa.descricao ~
                                ttponto-programa.nome-programa ~
                                ttponto-programa.ponto ~
                                ttponto-programa.tipo
...
&Scoped-define INTERNAL-TABLES ttconteudo-programa

/* Definitions for BROWSE brSon1                                        */
&Scoped-define FIELDS-IN-QUERY-brSon1 ttconteudo-programa.sequencia ~
ttconteudo-programa.conteudo 
&Scoped-define ENABLED-FIELDS-IN-QUERY-brSon1 
&Scoped-define QUERY-STRING-brSon1 FOR EACH ttconteudo-programa NO-LOCK
&Scoped-define OPEN-QUERY-brSon1 OPEN QUERY brSon1 FOR EACH ttconteudo-programa NO-LOCK.
&Scoped-define TABLES-IN-QUERY-brSon1 ttconteudo-programa
&Scoped-define FIRST-TABLE-IN-QUERY-brSon1 ttconteudo-programa
...
&Scoped-Define ENABLED-FIELDS ttponto-programa.nome-programa ~
ttponto-programa.ponto ttponto-programa.tipo ttponto-programa.descricao 
&Scoped-define ENABLED-TABLES ttponto-programa
...
&Scoped-Define DISPLAYED-FIELDS ttponto-programa.nome-programa ~
ttponto-programa.ponto ttponto-programa.tipo ttponto-programa.descricao 
&Scoped-define DISPLAYED-TABLES ttponto-programa
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS brSon1 wMasterDetail _STRUCTURED
  QUERY brSon1 NO-LOCK DISPLAY
      ttconteudo-programa.sequencia FORMAT ">>>>>9":U WIDTH 12.43
      ttconteudo-programa.conteudo FORMAT "X(60)":U WIDTH 64.43
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
...
DEFINE FRAME fPage0
     ...
     btHelp AT ROW 1.13 COL 110.29 HELP
          "Ajuda"
     ttponto-programa.nome-programa AT ROW 3 COL 30 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 9.72 BY .88
     ttponto-programa.ponto AT ROW 3 COL 56.29 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 3.29 BY .88
     ttponto-programa.tipo AT ROW 4 COL 32 NO-LABEL
...
"Nat.Opera‡Æo", 6
          SIZE 65 BY .71
     ttponto-programa.descricao AT ROW 5 COL 32 NO-LABEL
...
DEFINE FRAME fPage1
     ...
     btCopySon1 AT ROW 11.75 COL 12
     btUpdateSon1 AT ROW 11.75 COL 22
     btDeleteSon1 AT ROW 11.75 COL 32
    WITH 1 DOWN KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 3.57 ROW 9.63
...
/* Query rebuild information for BROWSE brSon1
     _TblList          = "Temp-Tables.ttconteudo-programa"
     _Options          = "NO-LOCK"
     _FldNameList[1]   > Temp-Tables.ttconteudo-programa.sequencia
"sequencia" ? ">>>>>9" "integer" ? ? ? ? ? ? no ? no no "12.43" yes no no "U" "" ""
     _FldNameList[2]   > Temp-Tables.ttconteudo-programa.conteudo
"conteudo" ? ? "character" ? ? ? ? ? ? no ? no no "64.43" yes no no "U" "" ""
     _Query            is OPENED
*/  /* BROWSE brSon1 */
&ANALYZE-RESUME
...
OR CHOOSE OF MENU-ITEM miAdd IN MENU mbMain DO:
    RUN addRecord IN THIS-PROCEDURE (INPUT "esp/es0018a.w":U).  
END.
...
DO:
    {masterdetail/AddSon.i &ProgramSon="esp/es0018b.w"
                           &PageNumber="1"} 
END.
...
OR CHOOSE OF MENU-ITEM miCopy IN MENU mbMain DO:
    RUN copyRecord (INPUT "esp/es0018a.w":U). 
END.
...
OR CHOOSE OF MENU-ITEM miSearch IN MENU mbMain DO:
    {method/ZoomReposition.i &ProgramZoom="eszoom/z01es350.w"}  
END.
...
OR CHOOSE OF MENU-ITEM miUpdate IN MENU mbMain DO:
    RUN updateRecord IN THIS-PROCEDURE (INPUT "esp/es0018a.w":U). 
END.
...
DO:
    {masterdetail/UpdateSon.i &ProgramSon="esp/es0018b.w"
                              &PageNumber="1"} 
END.
...
------------------------------------------------------------------------------*/
    ...
    DEFINE VARIABLE c-nome-programa LIKE {&ttParent}.nome-programa NO-UNDO.
    DEFINE VARIABLE i-ponto         LIKE {&ttParent}.ponto NO-UNDO.
    
    DEFINE FRAME fGoToRecord
        c-nome-programa   AT ROW 1.21 COL 17.72 COLON-ALIGNED
        i-ponto           AT ROW 2.21 COL 17.72 COLON-ALIGNED
        btGoToOK          AT ROW 3.63 COL 2.14
        btGoToCancel      AT ROW 3.63 COL 13
        rtGoToButton      AT ROW 3.38 COL 1
        SPACE(0.28)
        WITH VIEW-AS DIALOG-BOX KEEP-TAB-ORDER SIDE-LABELS NO-UNDERLINE 
             THREE-D SCROLLABLE TITLE "V  Para Ponto Programa" FONT 1
             DEFAULT-BUTTON btGoToOK CANCEL-BUTTON btGoToCancel.
    
    ON "CHOOSE":U OF btGoToOK IN FRAME fGoToRecord DO:
        ASSIGN c-nome-programa i-ponto.
        
        /*:T Posiciona query, do DBO, atrav‚s dos valores do ¡ndice £nico */
        RUN goToKey IN {&hDBOParent} (INPUT c-nome-programa, INPUT i-ponto).
        IF RETURN-VALUE = "NOK":U THEN DO:
            RUN utp/ut-msgs.p (INPUT "SHOW":U, INPUT 2, INPUT "Ponto Programa":U).
    ...
    ENABLE c-nome-programa i-ponto btGoToOK btGoToCancel 
...
------------------------------------------------------------------------------*/
    ...
    IF NOT VALID-HANDLE({&hDBOParent}) OR
       ...
       {&hDBOParent}:FILE-NAME <> "esbo/boes350.p":U THEN DO:
        {btb/btb008za.i1 esbo/boes350.p YES}
        {btb/btb008za.i2 esbo/boes350.p '' {&hDBOParent}} 
    END.
    ...
    IF NOT VALID-HANDLE({&hDBOSon1}) OR 
       ...
       {&hDBOSon1}:FILE-NAME <> "esbo/boes351.p":U THEN DO:
        {btb/btb008za.i1 esbo/boes351.p YES}
        {btb/btb008za.i2 esbo/boes351.p '' {&hDBOSon1}} 
    END.
...
------------------------------------------------------------------------------*/
    ...
    {masterdetail/OpenQueriesSon.i &Parent="PontoPrograma"
                                   &Query="PontoPrograma"
                                   &PageNumber="1"}
