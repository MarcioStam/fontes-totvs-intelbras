...
*******************************************************************************/
{include/i-prgvrs.i escqp015-z01 3.00.00.000}
...
DEFINE VARIABLE h_escqp015-b02 AS HANDLE NO-UNDO.
...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 1 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'esp/cqp/escqp015-b02.w':U ,
             INPUT  FRAME f-zoom:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_escqp015-b02 ).
       RUN set-position IN h_escqp015-b02 ( 2.75 , 4.00 ) NO-ERROR.
       /* Size in UIB:  ( 10.00 , 84.57 ) */

       /* Links to SmartBrowser h_escqp015-b02. */
       RUN add-link IN adm-broker-hdl ( h_escqp015-b02 , 'State':U , THIS-PROCEDURE ).

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_escqp015-b02 ,
             h_folder , 'AFTER':U ).
    END. /* Page 1 */
...
------------------------------------------------------------------------------*/
  ...
  {utp/ut9000.i "escqp015-z01" "3.00.00.000"}
