...
&Scoped-define INTERNAL-TABLES int-item-fornec

/* Definitions for QUERY Query-Main                                     */
&Scoped-define QUERY-STRING-Query-Main FOR EACH int-item-fornec ~
      WHERE int-item-fornec.cod-emitente = 0 NO-LOCK
&Scoped-define OPEN-QUERY-Query-Main OPEN QUERY Query-Main FOR EACH int-item-fornec ~
      WHERE int-item-fornec.cod-emitente = 0 NO-LOCK.
&Scoped-define TABLES-IN-QUERY-Query-Main int-item-fornec
&Scoped-define FIRST-TABLE-IN-QUERY-Query-Main int-item-fornec
...
<FOREIGN-KEYS>
cod-emitente||y|int-item-fornec.cod-emitente
it-codigo||y|int-item-fornec.it-codigo
</FOREIGN-KEYS> 
<EXECUTING-CODE>
**************************
...
RUN set-attribute-list (
    'Keys-Accepted = ,
     Keys-Supplied = "cod-emitente,it-codigo"':U).
...
/* Query rebuild information for QUERY Query-Main
     _TblList          = "mgesp.int-item-fornec"
     _Options          = "NO-LOCK"
     _Where[1]         = "int-item-fornec.cod-emitente = 0"
