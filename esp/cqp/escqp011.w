...
DEFINE VARIABLE d-periodo-fim AS DATE FORMAT "99/99/9999":U INITIAL ? 
     VIEW-AS FILL-IN 
     SIZE 15 BY .88 NO-UNDO.

DEFINE VARIABLE d-periodo-ini AS DATE FORMAT "99/99/9999":U INITIAL ? 
     LABEL "Per¡odo" 
     VIEW-AS FILL-IN 
     SIZE 15 BY .88 NO-UNDO.
...
DEFINE FRAME f-pg-sel
     ...
     d-periodo-ini AT ROW 2.25 COL 15 COLON-ALIGNED WIDGET-ID 4
     d-periodo-fim AT ROW 2.25 COL 48.14 COLON-ALIGNED NO-LABEL WIDGET-ID 2
...
{utp/ut9000.i "escqp011" "2.00.00.000"}
...
------------------------------------------------------------------------------*/
  ...
  DISPLAY c-cod-estabel-ini c-cod-estabel-fim d-periodo-ini d-periodo-fim 
      WITH FRAME f-pg-sel IN WINDOW w-relat.
  ENABLE IMAGE-1 IMAGE-2 IMAGE-3 IMAGE-4 c-cod-estabel-ini c-cod-estabel-fim 
         d-periodo-ini d-periodo-fim 
      WITH FRAME f-pg-sel IN WINDOW w-relat.
...
do on error undo, return error on stop  undo, return error:
    ...
    assign tt-param.usuario       = c-seg-usuario
           ...
           tt-param.cod-estab-ini = INPUT FRAME f-pg-sel c-cod-estabel-ini 
           tt-param.cod-estab-fim = INPUT FRAME f-pg-sel c-cod-estabel-fim
    ...
    {include/i-rprun.i esp/cqp/escqp011rp.p}
