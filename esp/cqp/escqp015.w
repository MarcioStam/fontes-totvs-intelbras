...
*******************************************************************************/
{include/i-prgvrs.i ESCQP015 3.00.00.000}
...
DEFINE VARIABLE h_escqp015-q01 AS HANDLE NO-UNDO.
DEFINE VARIABLE h_escqp015-v01 AS HANDLE NO-UNDO.
...
DEFINE FRAME f-cad
    ...
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         ...
         AT COL 1 ROW 1
         SIZE 89.86 BY 15.92 WIDGET-ID 100.
...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW w-cadsim ASSIGN
         HIDDEN             = YES
         TITLE              = "Manuten‡Æo SkipLote Item/Fornecedor"
         HEIGHT             = 15.92
         WIDTH              = 89.86
         MAX-HEIGHT         = 17
         MAX-WIDTH          = 90
...
ON END-ERROR OF w-cadsim /* Manuten‡Æo SkipLote Item/Fornecedor */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL w-cadsim w-cadsim
ON WINDOW-CLOSE OF w-cadsim /* Manuten‡Æo SkipLote Item/Fornecedor */
DO:
...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'esp/cqp/escqp015-v01.w':U ,
             INPUT  FRAME f-cad:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_escqp015-v01 ).
       RUN set-position IN h_escqp015-v01 ( 2.67 , 1.00 ) NO-ERROR.
       /* Size in UIB:  ( 14.25 , 89.00 ) */

       RUN init-object IN THIS-PROCEDURE (
             INPUT  'esp/cqp/escqp015-q01.w':U ,
             INPUT  FRAME f-cad:HANDLE ,
             INPUT  'ProgPesquisa = esp/cqp/escqp015-z01.w,
                     ProgVaPara = esp/cqp/escqp015-g01.w,
                     ProgIncMod = ,
                     Implantar = no':U ,
             OUTPUT h_escqp015-q01 ).
       RUN set-position IN h_escqp015-q01 ( 1.25 , 60.00 ) NO-ERROR.
       /* Size in UIB:  ( 1.75 , 6.00 ) */

       /* Links to SmartPanel h_p-exihel. */
       RUN add-link IN adm-broker-hdl ( h_p-cadsim , 'State':U , h_p-exihel ).

       /* Links to SmartViewer h_escqp015-v01. */
       RUN add-link IN adm-broker-hdl ( h_escqp015-q01 , 'Record':U , h_escqp015-v01 ).
       RUN add-link IN adm-broker-hdl ( h_p-cadsim , 'TableIO':U , h_escqp015-v01 ).

       /* Links to SmartQuery h_escqp015-q01. */
       RUN add-link IN adm-broker-hdl ( h_p-exihel , 'State':U , h_escqp015-q01 ).
       RUN add-link IN adm-broker-hdl ( h_p-navega , 'Navigation':U , h_escqp015-q01 ).
       RUN add-link IN adm-broker-hdl ( h_p-navega , 'State':U , h_escqp015-q01 ).
       ...
       RUN adjust-tab-order IN adm-broker-hdl ( h_p-exihel ,
             h_p-cadsim , 'AFTER':U ).
       RUN adjust-tab-order IN adm-broker-hdl ( h_escqp015-v01 ,
             h_p-exihel , 'AFTER':U ).
    END. /* Page 0 */
...
------------------------------------------------------------------------------*/
  ...
  {utp/ut9000.i "ESCQP015" "3.00.00.000"}
  ...
  //RUN piRecebeHandle  IN h_escqp015-v01 ( INPUT h_escqp015-b01).
