...
PROCEDURE pi-esftp016rp:
    ...
    IF AVAIL ped-venda THEN DO:
        ...
        IF ped-venda.cod-priori <> 7 THEN DO:
            ...
            EMPTY TEMP-TABLE tt-prog-ponto.
            RUN esp/es0018p.p (INPUT "wso0003":U, INPUT 13, INPUT 0, INPUT "":U, OUTPUT TABLE tt-prog-ponto).
            FIND FIRST tt-prog-ponto NO-ERROR.

            create tt-param.
            assign tt-param.usuario     = IF AVAIL tt-prog-ponto THEN tt-prog-ponto.conteudo ELSE "integra-mibo"
                   tt-param.destino     = 2
