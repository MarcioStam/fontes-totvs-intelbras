        ...
        FOR EACH wm-docto-itens EXCLUSIVE-LOCK
           ...
           FIND FIRST ttWm-docto-itens USE-INDEX codigo
            ...
            IF AVAIL ttWm-docto-itens THEN DO:
                ...
                FOR EACH wm-box-movto
                   WHERE wm-box-movto.cod-estabel      = wm-docto-itens.cod-estabel
                    ...
                    ELSE DO:
                        ...
                        ELSE DO:
                            FOR EACH RowErrors:
                                RUN utp/ut-msgs.p (INPUT "show", INPUT RowErrors.ErrorNumber, INPUT RowErrors.ErrorDescription).
                            END.
                        END.
                    END.
                END.
                ...
                IF NOT CAN-FIND(FIRST RowErrors) THEN DO:
                    RUN utp/ut-msgs.p (INPUT "show", INPUT 15825, INPUT "Documento Alterado").
                END.
                ELSE DO:
                    FOR EACH RowErrors:
                        RUN utp/ut-msgs.p (INPUT "show", INPUT RowErrors.ErrorNumber, INPUT RowErrors.ErrorDescription).
...
PROCEDURE pi-cria-dev-picking.
    ...
    IF CAN-FIND(FIRST RowErrors NO-LOCK) THEN
        RETURN "NOK":U.
    ELSE DO:
        RUN utp/ut-msgs.p (INPUT "show", INPUT 15825, INPUT "Documento Criado").
    END.
