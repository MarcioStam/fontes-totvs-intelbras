...
*******************************************************************************/
{include/i-prgvrs.i eswmp028 2.06.00.001}
...
&IF "{&EMSFND_VERSION}" >= "1.00" &THEN
    {include/i-license-manager.i eswmp028 wms}
&ENDIF

CREATE WIDGET-POOL.

/* Preprocessors Definitions ---                                      */
&GLOBAL-DEFINE Program        eswmp028
&GLOBAL-DEFINE Version        2.06.00.001
&GLOBAL-DEFINE VersionLayout  

&GLOBAL-DEFINE Folder         YES
&GLOBAL-DEFINE InitialPage    1
//&GLOBAL-DEFINE FolderLabels   Layout,Seleá∆o,Classificaá∆o,ParÉmetro,Digitaá∆o,Impress∆o,Log
...
&GLOBAL-DEFINE page2Fields    cEstab cEstabDepos da-data-ini da-data-fim c-item-ini c-item-fim
...
DEFINE VARIABLE cEstab AS CHARACTER FORMAT "X(15)":U INITIAL "104" 
     LABEL "Estabelecimento" 
     VIEW-AS FILL-IN 
     SIZE 15 BY .88
     FONT 1 NO-UNDO.

DEFINE VARIABLE cEstabDepos AS CHARACTER FORMAT "X(15)":U INITIAL "112" 
     LABEL "Estab CD" 
     VIEW-AS FILL-IN 
     SIZE 15 BY .88
     FONT 1 NO-UNDO.
...
DEFINE VARIABLE da-data-ini AS DATE FORMAT "99/99/9999":U INITIAL 01/01/01 
     LABEL "Dt.Emis. NF" 
     VIEW-AS FILL-IN 
     SIZE 15 BY .88
     FONT 1 NO-UNDO.
...
DEFINE FRAME fPage2
     cEstab AT ROW 1.5 COL 9
     cEstabDepos AT ROW 2.5 COL 13.71 WIDGET-ID 4
     da-data-ini AT ROW 3.5 COL 12.14 WIDGET-ID 12
     da-data-fim AT ROW 3.5 COL 54.14 NO-LABEL WIDGET-ID 10
     c-item-ini AT ROW 4.5 COL 17.28 WIDGET-ID 20
     c-item-fim AT ROW 4.5 COL 54.14 NO-LABEL WIDGET-ID 18
...
/* SETTINGS FOR FILL-IN cEstab IN FRAME fPage2
   ALIGN-L                                                              */
/* SETTINGS FOR FILL-IN cEstabDepos IN FRAME fPage2
   ALIGN-L                                                              */
/* SETTINGS FOR FILL-IN da-data-fim IN FRAME fPage2
   ALIGN-L                                                              */
/* SETTINGS FOR FILL-IN da-data-ini IN FRAME fPage2
   ALIGN-L                                                              */
...
do on error undo, return error on stop  undo, return error:
    ...
    */
    ...
    assign tt-param.usuario         = c-seg-usuario
           ...
           &endif
           tt-param.cEstab           = INPUT FRAME fpage2 cEstab
           tt-param.cEstabDepos      = INPUT FRAME fpage2 cEstabDepos
           tt-param.da-data-ini      = INPUT FRAME fpage2 da-data-ini
           tt-param.da-data-fim      = INPUT FRAME fpage2 da-data-fim
           tt-param.c-item-ini       = INPUT FRAME fpage2 c-item-ini
           tt-param.c-item-fim       = INPUT FRAME fpage2 c-item-fim
           .
    ...
    {report/rprun.i esp/wmp/eswmp028rp.p}
