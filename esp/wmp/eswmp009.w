...
*******************************************************************************/
{include/i-prgvrs.i ESWMP009 2.00.00.001}  /*** 010001 ***/

&IF "{&EMSFND_VERSION}" >= "1.00" &THEN
{include/i-license-manager.i ESWMP009 MWM}
&ENDIF 
...
&GLOBAL-DEFINE Program        ESWMP009
...
&GLOBAL-DEFINE page4Fields    c-cod-local c-nom-local c-cod-estabel c-nom-estabel rsBloqueio tg-end-com-saldo
...
DEFINE VARIABLE rsBloqueio AS INTEGER INITIAL 1 
     ...
     RADIO-BUTTONS 
          "Armazenamento", 1,
"Retirada", 2
     SIZE 15.72 BY 2.33 NO-UNDO.

DEFINE RECTANGLE RECT-10
     EDGE-PIXELS 2 GRAPHIC-EDGE  NO-FILL   
     SIZE 23.57 BY 3.17.

DEFINE VARIABLE tg-end-com-saldo AS LOGICAL INITIAL no 
     LABEL "Considerar Apenas Endere‡os com Saldos" 
     VIEW-AS TOGGLE-BOX
...
DEFINE FRAME fPage4
     ...
     tg-end-com-saldo AT ROW 4 COL 42.43 WIDGET-ID 10
     rsBloqueio AT ROW 4.71 COL 20 NO-LABEL WIDGET-ID 2
     "Endere‡os Bloqueados para:" VIEW-AS TEXT
          SIZE 21.29 BY .54 AT ROW 3.75 COL 16.86 WIDGET-ID 8
     RECT-10 AT ROW 4.04 COL 16.14 WIDGET-ID 6
...
DO ON ERROR UNDO, RETURN ERROR ON STOP  UNDO, RETURN ERROR:
    ...
    {report/rprun.i esp/wmp/eswmp009rp.p} 
