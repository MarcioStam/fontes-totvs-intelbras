...
*******************************************************************************/
{include/i-prgvrs.i ESWMP001 2.00.00.001}
...
DEFINE SUB-MENU mi-arquivo 
       ...
       MENU-ITEM mi-proximo     LABEL "Pr&Â¢ximo"      ACCELERATOR "CTRL-CURSOR-RIGHT"
       MENU-ITEM mi-ultimo      LABEL "&Ã©ltimo"       ACCELERATOR "CTRL-END"
       MENU-ITEM mi-va-para     LABEL "&VÂ  para"      ACCELERATOR "CTRL-T"
       ...
       MENU-ITEM mi-imprimir    LABEL "&RelatÂ¢rios"   ACCELERATOR "CTRL-P"
       RULE
...
DEFINE VARIABLE h_esWMP001-q01 AS HANDLE NO-UNDO.
DEFINE VARIABLE h_esWMP001-v01 AS HANDLE NO-UNDO.
...
DEFINE FRAME f-cad
    ...
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         ...
         AT COL 1 ROW 1
         SIZE 90 BY 11.67 WIDGET-ID 100.
...
ON END-ERROR OF w-cadsim /* Manuten‡Æo Bloco */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL w-cadsim w-cadsim
ON WINDOW-CLOSE OF w-cadsim /* Manuten‡Æo Bloco */
DO:
...
ON CHOOSE OF MENU-ITEM mi-imprimir /* RelatÂ¢rios */
DO:
...
ON CHOOSE OF MENU-ITEM mi-proximo /* PrÂ¢ximo */
DO:
...
ON CHOOSE OF MENU-ITEM mi-ultimo /* Ã©ltimo */
DO:
...
ON CHOOSE OF MENU-ITEM mi-va-para /* VÂ  para */
DO:
...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'esp/wmp/ESWMP001-v01.w':U ,
             INPUT  FRAME f-cad:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_esWMP001-v01 ).
       RUN set-position IN h_esWMP001-v01 ( 3.00 , 1.00 ) NO-ERROR.
       /* Size in UIB:  ( 4.50 , 88.57 ) */

       RUN init-object IN THIS-PROCEDURE (
             INPUT  'esp/wmp/ESWMP001-q01.w':U ,
             INPUT  FRAME f-cad:HANDLE ,
             INPUT  'ProgPesquisa = esp\wmp\ESWMP001-z01.w,
                     ProgVaPara = esp\wmp\ESWMP001-g01.w,
                     ProgIncMod = ,
                     Implantar = no':U ,
             OUTPUT h_esWMP001-q01 ).
       RUN set-position IN h_esWMP001-q01 ( 1.25 , 61.00 ) NO-ERROR.
       ...
       /* Links to SmartViewer h_esWMP001-v01. */
       RUN add-link IN adm-broker-hdl ( h_esWMP001-q01 , 'Record':U , h_esWMP001-v01 ).
       RUN add-link IN adm-broker-hdl ( h_p-cadsim , 'TableIO':U , h_esWMP001-v01 ).

       /* Links to SmartQuery h_esWMP001-q01. */
       RUN add-link IN adm-broker-hdl ( h_p-exihel , 'State':U , h_esWMP001-q01 ).
       RUN add-link IN adm-broker-hdl ( h_p-navega , 'Navigation':U , h_esWMP001-q01 ).
       RUN add-link IN adm-broker-hdl ( h_p-navega , 'State':U , h_esWMP001-q01 ).
       ...
       RUN adjust-tab-order IN adm-broker-hdl ( h_p-exihel ,
             h_p-cadsim , 'AFTER':U ).
       RUN adjust-tab-order IN adm-broker-hdl ( h_esWMP001-v01 ,
             h_p-exihel , 'AFTER':U ).
    END. /* Page 0 */
...
------------------------------------------------------------------------------*/
  ...
  {utp/ut9000.i "ESWMP001" "2.00.00.001"}
