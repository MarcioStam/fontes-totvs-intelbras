...
*******************************************************************************/
{include/i-prgvrs.i eswmp019 2.00.00.000}
...
{utp/ut9000.i "eswmp019" "2.00.00.000"}
...
DO  ON ERROR   UNDO MAIN-BLOCK, LEAVE MAIN-BLOCK
    ...
    {include/i-rpmbl.i}    
        ...
        ASSIGN e-info:SCREEN-VALUE IN FRAME f-pg-sel = "Monitor de Tarefas Pendentes no WMS:"  + CHR(13)
...
do on error undo, return error on stop  undo, return error:
    ...
    {include/i-rprun.i esp/wmp/eswmp019rp.p}
