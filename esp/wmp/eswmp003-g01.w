...
*******************************************************************************/
{include/i-prgvrs.i ESWMP003-G01 2.00.00.001}
...
&Scoped-Define ENABLED-OBJECTS rt-button d_val-etiq-packing bt-ok ~
bt-cancela bt-ajuda 
&Scoped-Define DISPLAYED-OBJECTS d_val-etiq-packing 
...
DEFINE VARIABLE d_val-etiq-packing AS DECIMAL FORMAT ">>>>>>>>>>>>>>9":U 
...
DEFINE FRAME d-vapara
     d_val-etiq-packing AT ROW 2 COL 25 COLON-ALIGNED WIDGET-ID 2
...
DO:
FIND wms-etiq-packing NO-LOCK
    WHERE wms-etiq-packing.val-etiq-packing EQ INPUT FRAME {&FRAME-NAME} d_val-etiq-packing NO-ERROR.

IF NOT AVAILABLE wms-etiq-packing THEN DO:
    {utp/ut-table.i mgscm wms-etiq-packing 1}
    RUN utp/ut-msgs.p(INPUT "show",
                      INPUT 2,
                      INPUT RETURN-VALUE).
    RETURN NO-APPLY.
END.
ASSIGN p-row-tabela = ROWID(wms-etiq-packing).
END.
...
------------------------------------------------------------------------------*/
  DISPLAY d_val-etiq-packing 
      WITH FRAME d-vapara.
  ENABLE rt-button d_val-etiq-packing bt-ok bt-cancela bt-ajuda 
      WITH FRAME d-vapara.
  VIEW FRAME d-vapara.
...
------------------------------------------------------------------------------*/
  ...
  {utp/ut9000.i "ESWMP003-G01" "2.00.00.001"}
