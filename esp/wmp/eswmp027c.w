...
*******************************************************************************/
{include/i-prgvrs.i ESWMP027C 2.00.00.001}
{include/i-license-manager.i ESWMP027C MCD,MCE,MEQ,MFT,MPD,MRE,MWM}

CREATE WIDGET-POOL.

/* Preprocessors Definitions ---                                      */
&GLOBAL-DEFINE Program           ESWMP027C
...
&GLOBAL-DEFINE ttTable           tt-zona-separa-equip
&GLOBAL-DEFINE hDBOTable         h-boes030
&GLOBAL-DEFINE DBOTable          zona-separa-equip

&GLOBAL-DEFINE ttParent          tt-zona-separa
&GLOBAL-DEFINE DBOParentTable    zona-separa

&GLOBAL-DEFINE page0KeyFields    tt-zona-separa-equip.cod-equipamento
&GLOBAL-DEFINE page0Fields       tt-zona-separa-equip.cod-prioridade
&GLOBAL-DEFINE page0ParentFields tt-zona-separa.cod-estabel tt-zona-separa.cod-local tt-zona-separa.cod-zona ~
                                 tt-zona-separa.descricao
...
tt-zona-separa-equip.cod-equipamento tt-zona-separa-equip.cod-prioridade 
&Scoped-define ENABLED-TABLES tt-zona-separa tt-zona-separa-equip
&Scoped-define FIRST-ENABLED-TABLE tt-zona-separa
&Scoped-define SECOND-ENABLED-TABLE tt-zona-separa-equip
&Scoped-Define ENABLED-OBJECTS rtKeys rtToolBar c-desc-estabel c-desc-local ~
c-desc-equipamento btOK btSave btCancel btHelp 
&Scoped-Define DISPLAYED-FIELDS tt-zona-separa.cod-estabel ~
tt-zona-separa.cod-local tt-zona-separa.cod-zona tt-zona-separa.descricao ~
tt-zona-separa-equip.cod-equipamento tt-zona-separa-equip.cod-prioridade 
&Scoped-define DISPLAYED-TABLES tt-zona-separa tt-zona-separa-equip
&Scoped-define FIRST-DISPLAYED-TABLE tt-zona-separa
&Scoped-define SECOND-DISPLAYED-TABLE tt-zona-separa-equip
...
DEFINE VARIABLE c-desc-equipamento AS CHARACTER FORMAT "X(256)":U 
     VIEW-AS FILL-IN 
...
DEFINE FRAME fpage0
     ...
     tt-zona-separa.descricao AT ROW 3.25 COL 29 COLON-ALIGNED NO-LABEL WIDGET-ID 56
          VIEW-AS FILL-IN 
          SIZE 43 BY .88
     tt-zona-separa-equip.cod-equipamento AT ROW 5 COL 22 COLON-ALIGNED WIDGET-ID 58
          VIEW-AS FILL-IN 
          SIZE 10 BY .88
     c-desc-equipamento AT ROW 5 COL 32 COLON-ALIGNED NO-LABEL WIDGET-ID 62
     tt-zona-separa-equip.cod-prioridade AT ROW 6 COL 22 COLON-ALIGNED WIDGET-ID 60
          VIEW-AS FILL-IN 
          SIZE 5 BY .88
     btOK AT ROW 7.75 COL 2
     btSave AT ROW 7.75 COL 13
     btCancel AT ROW 7.75 COL 24
     btHelp AT ROW 7.75 COL 80
...
&Scoped-define SELF-NAME tt-zona-separa-equip.cod-equipamento
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL tt-zona-separa-equip.cod-equipamento wMaintenanceNoNavigation
ON F5 OF tt-zona-separa-equip.cod-equipamento IN FRAME fpage0 /* Equipamento */
DO:
    {method/zoomfields.i &ProgramZoom="sczoom/z01sc092.w"
                         &FieldZoom1="cod-equipamento"
                         &FieldScreen1="tt-zona-separa-equip.cod-equipamento"
                         &Frame1="fPage0"
                         &FieldZoom2="des-equipamento"
                         &FieldScreen2="c-desc-equipamento"
                         &Frame2="fPage0"
                         &EnableImplant="YES"}
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL tt-zona-separa-equip.cod-equipamento wMaintenanceNoNavigation
ON LEAVE OF tt-zona-separa-equip.cod-equipamento IN FRAME fpage0 /* Equipamento */
DO:
    ASSIGN c-desc-equipamento = "".
    FOR FIRST wm-equipamento NO-LOCK
        WHERE wm-equipamento.cod-equipamento = SELF:SCREEN-VALUE:
        ASSIGN c-desc-equipamento = wm-equipamento.des-equipamento.
    END.
    DISP c-desc-equipamento WITH FRAME fPage0.
END.
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL tt-zona-separa-equip.cod-equipamento wMaintenanceNoNavigation
ON MOUSE-SELECT-DBLCLICK OF tt-zona-separa-equip.cod-equipamento IN FRAME fpage0 /* Equipamento */
DO:
    APPLY "F5" TO SELF.
END.
...
------------------------------------------------------------------------------*/
    ...
    tt-zona-separa-equip.cod-equipamento:LOAD-MOUSE-POINTER('image/lupa.cur') IN FRAME fPage0.
...
------------------------------------------------------------------------------*/
    ...
    ASSIGN tt-zona-separa-equip.cod-estabel = tt-zona-separa.cod-estabel
           tt-zona-separa-equip.cod-local   = tt-zona-separa.cod-local
           tt-zona-separa-equip.cod-zona    = tt-zona-separa.cod-zona.
