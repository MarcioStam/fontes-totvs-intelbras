...
*******************************************************************************/
{include/i-prgvrs.i eswmp016 2.00.00.000}
...
DEFINE VARIABLE c-cod-local-ini AS CHARACTER FORMAT "X(5)":U 
     LABEL "Local" 
     VIEW-AS FILL-IN 
     SIZE 7 BY .88 NO-UNDO.

DEFINE VARIABLE c-it-codigo-fim AS CHARACTER FORMAT "X(16)":U INITIAL "4999999" 
     VIEW-AS FILL-IN 
     SIZE 16 BY .88 NO-UNDO.

DEFINE VARIABLE c-it-codigo-ini AS CHARACTER FORMAT "X(16)":U INITIAL "4000000" 
     LABEL "Item" 
     VIEW-AS FILL-IN 
     SIZE 16 BY .88 NO-UNDO.

DEFINE VARIABLE d-periodo-fim AS DATE FORMAT "99/99/9999":U INITIAL 12/31/9999 
     VIEW-AS FILL-IN 
     SIZE 11 BY .88 NO-UNDO.

DEFINE VARIABLE d-periodo-ini AS DATE FORMAT "99/99/9999":U INITIAL 01/01/001 
     LABEL "Per¡odo" 
     VIEW-AS FILL-IN 
     SIZE 11 BY .88 NO-UNDO.
...
DEFINE FRAME f-pg-sel
     c-cod-estabel-ini AT ROW 1.25 COL 22.86 COLON-ALIGNED
     c-cod-local-ini AT ROW 2.25 COL 22.86 COLON-ALIGNED WIDGET-ID 6
     d-periodo-ini AT ROW 3.25 COL 18.86 COLON-ALIGNED WIDGET-ID 14
     d-periodo-fim AT ROW 3.25 COL 38.86 COLON-ALIGNED NO-LABEL WIDGET-ID 12
     c-it-codigo-ini AT ROW 4.25 COL 13.86 COLON-ALIGNED WIDGET-ID 22
     c-it-codigo-fim AT ROW 4.25 COL 38.86 COLON-ALIGNED NO-LABEL WIDGET-ID 20
     IMAGE-5 AT ROW 3.25 COL 31.86 WIDGET-ID 16
     IMAGE-6 AT ROW 3.25 COL 38 WIDGET-ID 18
     IMAGE-7 AT ROW 4.25 COL 31.86 WIDGET-ID 24
     IMAGE-8 AT ROW 4.25 COL 38 WIDGET-ID 26
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 3 ROW 2.85
         SIZE 76.86 BY 10.62
...
{utp/ut9000.i "eswmp016" "2.00.00.000"}
...
------------------------------------------------------------------------------*/
  ...
  DISPLAY c-cod-estabel-ini c-cod-local-ini d-periodo-ini d-periodo-fim 
          c-it-codigo-ini c-it-codigo-fim 
      WITH FRAME f-pg-sel IN WINDOW w-relat.
  ENABLE IMAGE-5 IMAGE-6 IMAGE-7 IMAGE-8 c-cod-estabel-ini c-cod-local-ini 
         d-periodo-ini d-periodo-fim c-it-codigo-ini c-it-codigo-fim 
      WITH FRAME f-pg-sel IN WINDOW w-relat.
...
do on error undo, return error on stop  undo, return error:
    ...
    assign tt-param.usuario         = c-seg-usuario
           ...
           tt-param.cod-local-ini   = input frame f-pg-sel c-cod-local-ini   
    ...
    {include/i-rprun.i esp/wmp/eswmp016rp.p}
