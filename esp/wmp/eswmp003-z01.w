...
*******************************************************************************/
{include/i-prgvrs.i ESWMP003-Z01 2.00.00.001}
...
DEFINE VARIABLE h_es-WM003-b03 AS HANDLE NO-UNDO.
...
DEFINE FRAME f-zoom
     bt-implantar AT ROW 17.83 COL 1.57
     bt-ok AT ROW 19.29 COL 3
     bt-cancela AT ROW 19.29 COL 14
     bt-ajuda AT ROW 19.29 COL 79
     rt-button AT ROW 19.04 COL 2
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'FOLDER-LABELS = ':U + 'Etiquetas' + ',
                     FOLDER-TAB-TYPE = 1':U ,
             OUTPUT h_folder ).
       RUN set-position IN h_folder ( 1.17 , 1.57 ) NO-ERROR.
       RUN set-size IN h_folder ( 16.33 , 88.57 ) NO-ERROR.
    ...
    WHEN 1 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'esp/wmp/ESWMP003-b03.w':U ,
             INPUT  FRAME f-zoom:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_es-WM003-b03 ).
       RUN set-position IN h_es-WM003-b03 ( 3.46 , 4.00 ) NO-ERROR.
       /* Size in UIB:  ( 12.75 , 80.14 ) */

       /* Links to SmartBrowser h_es-WM003-b03. */
       RUN add-link IN adm-broker-hdl ( h_es-WM003-b03 , 'State':U , THIS-PROCEDURE ).

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_folder ,
             bt-implantar:HANDLE IN FRAME f-zoom , 'BEFORE':U ).
       RUN adjust-tab-order IN adm-broker-hdl ( h_es-WM003-b03 ,
             h_folder , 'AFTER':U ).
    END. /* Page 1 */
...
------------------------------------------------------------------------------*/
  ...
  {utp/ut9000.i "ESWMP003-Z01" "2.00.00.001"}
