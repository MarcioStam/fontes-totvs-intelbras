...
*******************************************************************************/
{include/i-prgvrs.i ESWMP005 2.00.00.001}
...
DEFINE VARIABLE h_ESWMP005-q01 AS HANDLE NO-UNDO.
DEFINE VARIABLE h_ESWMP005-v01 AS HANDLE NO-UNDO.
...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'esp/wmp/ESWMP005-v01.w':U ,
             INPUT  FRAME f-cad:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_ESWMP005-v01 ).
       RUN set-position IN h_ESWMP005-v01 ( 2.75 , 1.57 ) NO-ERROR.
       /* Size in UIB:  ( 2.75 , 88.57 ) */

       RUN init-object IN THIS-PROCEDURE (
             INPUT  'esp/wmp/ESWMP005-q01.w':U ,
             INPUT  FRAME f-cad:HANDLE ,
             INPUT  'ProgPesquisa = esp/wmp/ESWMP005-z01.w,
                     ProgVaPara = esp/wmp/ESWMP005-g01.w,
                     ProgIncMod = ':U ,
             OUTPUT h_ESWMP005-q01 ).
       RUN set-position IN h_ESWMP005-q01 ( 1.17 , 61.00 ) NO-ERROR.
       ...
       /* Links to SmartViewer h_ESWMP005-v01. */
       RUN add-link IN adm-broker-hdl ( h_ESWMP005-q01 , 'Record':U , h_ESWMP005-v01 ).
       RUN add-link IN adm-broker-hdl ( h_p-cadsim , 'TableIO':U , h_ESWMP005-v01 ).

       /* Links to SmartQuery h_ESWMP005-q01. */
       RUN add-link IN adm-broker-hdl ( h_p-exihel , 'State':U , h_ESWMP005-q01 ).
       RUN add-link IN adm-broker-hdl ( h_p-navega , 'Navigation':U , h_ESWMP005-q01 ).
       RUN add-link IN adm-broker-hdl ( h_p-navega , 'State':U , h_ESWMP005-q01 ).
       ...
       RUN adjust-tab-order IN adm-broker-hdl ( h_p-exihel ,
             h_p-cadsim , 'AFTER':U ).
       RUN adjust-tab-order IN adm-broker-hdl ( h_ESWMP005-v01 ,
             h_p-exihel , 'AFTER':U ).
    END. /* Page 0 */
...
------------------------------------------------------------------------------*/
  ...
  {utp/ut9000.i "ESWMP005" "2.00.00.001"}
