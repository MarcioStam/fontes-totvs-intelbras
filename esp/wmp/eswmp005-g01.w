...
*******************************************************************************/
{include/i-prgvrs.i ESWMP005-G01 2.00.00.001}
...
&Scoped-Define ENABLED-OBJECTS rt-button i_cod-area-packing bt-ok ~
bt-cancela bt-ajuda 
&Scoped-Define DISPLAYED-OBJECTS i_cod-area-packing 
...
DEFINE VARIABLE i_cod-area-packing AS INTEGER FORMAT ">>>>>>>9":U INITIAL 0 
     LABEL "µrea Packing" 
     VIEW-AS FILL-IN 
...
DEFINE FRAME d-vapara
     i_cod-area-packing AT ROW 2.25 COL 29 COLON-ALIGNED WIDGET-ID 2
...
DO:
FIND es-wm-area-packing NO-LOCK
    WHERE es-wm-area-packing.cod-area-packing EQ INPUT FRAME {&FRAME-NAME} i_cod-area-packing NO-ERROR.

IF NOT AVAILABLE es-wm-area-packing THEN DO:
    {utp/ut-table.i mgesp es-wm-area-packing 1}
    RUN utp/ut-msgs.p(INPUT "show",
                      INPUT 2,
                      INPUT RETURN-VALUE).
    RETURN NO-APPLY.
END.
ASSIGN p-row-tabela = ROWID(es-wm-area-packing).
END.
...
------------------------------------------------------------------------------*/
  DISPLAY i_cod-area-packing 
      WITH FRAME d-vapara.
  ENABLE rt-button i_cod-area-packing bt-ok bt-cancela bt-ajuda 
      WITH FRAME d-vapara.
  VIEW FRAME d-vapara.
...
------------------------------------------------------------------------------*/
  ...
  {utp/ut9000.i "ESWMP005-G01" "2.00.00.001"}
