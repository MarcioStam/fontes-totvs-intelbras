...
*******************************************************************************/
{include/i-prgvrs.i eswmp018 2.00.00.000}
...
DEFINE VARIABLE e-info AS CHARACTER 
     VIEW-AS EDITOR
     SIZE 71 BY 7 NO-UNDO.
...
DEFINE FRAME f-pg-sel
     e-info AT ROW 1.92 COL 3.29 NO-LABEL WIDGET-ID 6
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 3 ROW 2.85
         SIZE 76.86 BY 10.62
...
/* SETTINGS FOR FRAME f-pg-sel
                                                                        */
/* SETTINGS FOR EDITOR e-info IN FRAME f-pg-sel
   NO-ENABLE                                                            */
...
{utp/ut9000.i "eswmp018" "2.00.00.000"}
...
DO  ON ERROR   UNDO MAIN-BLOCK, LEAVE MAIN-BLOCK
    ...
    {include/i-rpmbl.i}    
        ...
        ASSIGN e-info:SCREEN-VALUE IN FRAME f-pg-sel = "Monitor de Saldos Destinados no WMS:"  + CHR(13)
                                                     + "Execu‡Æo via RPW Windows criando HTML" + CHR(13)
                                                     + "***Marcar agendamento autom tico***" .
...
do on error undo, return error on stop  undo, return error:
    ...
    {include/i-rprun.i esp/wmp/eswmp018rp.p}
