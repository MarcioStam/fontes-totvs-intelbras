...
&Scoped-define INTERNAL-TABLES wm-bloco

/* Define KEY-PHRASE in case it is used by any query. */
&Scoped-define KEY-PHRASE TRUE

/* Definitions for BROWSE br-table                                      */
&Scoped-define FIELDS-IN-QUERY-br-table wm-bloco.cod-bloco ~
wm-bloco.des-bloco 
&Scoped-define ENABLED-FIELDS-IN-QUERY-br-table 
&Scoped-define QUERY-STRING-br-table FOR EACH wm-bloco WHERE ~{&KEY-PHRASE} ~
      AND wm-bloco.cod-bloco >= c-inicial and  ~
wm-bloco.cod-bloco <= c-final NO-LOCK ~
    ~{&SORTBY-PHRASE} INDEXED-REPOSITION
&Scoped-define OPEN-QUERY-br-table OPEN QUERY br-table FOR EACH wm-bloco WHERE ~{&KEY-PHRASE} ~
      AND wm-bloco.cod-bloco >= c-inicial and  ~
wm-bloco.cod-bloco <= c-final NO-LOCK ~
    ~{&SORTBY-PHRASE} INDEXED-REPOSITION.
&Scoped-define TABLES-IN-QUERY-br-table wm-bloco
&Scoped-define FIRST-TABLE-IN-QUERY-br-table wm-bloco
...
<FOREIGN-KEYS>
cod-bloco||y|mgscm.wm-bloco.cod-bloco
</FOREIGN-KEYS> 
<EXECUTING-CODE>
**************************
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br-table B-table-Win _STRUCTURED
  QUERY br-table NO-LOCK DISPLAY
      wm-bloco.cod-bloco FORMAT "X(3)":U
      wm-bloco.des-bloco FORMAT "X(40)":U
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
...
/* Query rebuild information for BROWSE br-table
     _TblList          = "mgscm.wm-bloco"
     _Options          = "NO-LOCK INDEXED-REPOSITION KEY-PHRASE SORTBY-PHRASE"
     _Where[1]         = "wm-bloco.cod-bloco >= c-inicial and 
wm-bloco.cod-bloco <= c-final"
     _FldNameList[1]   = mgscm.wm-bloco.cod-bloco
     _FldNameList[2]   = mgscm.wm-bloco.des-bloco
...
DEFINE INPUT PARAMETER P-CAMPO AS CHARACTER NO-UNDO.
    ...
    if  avail wm-bloco then do:
        case p-campo:
            when "cod-bloco" then
                assign p-valor = string(wm-bloco.cod-bloco).
            when "des-bloco" then
                assign p-valor = string(wm-bloco.des-bloco).
        end.
    end.
...
------------------------------------------------------------------------------*/
  ...
  {src/adm/template/sndkycas.i "cod-bloco" "wm-bloco" "cod-bloco"}
...
------------------------------------------------------------------------------*/
  ...
  {src/adm/template/snd-list.i "wm-bloco"}
