...
&Scoped-Define ENABLED-FIELDS es-wm-bloco.cod-bloco 
...
&Scoped-Define DISPLAYED-FIELDS es-wm-bloco.cod-bloco 
...
DEFINE FRAME d-vapara
     es-wm-bloco.cod-bloco AT ROW 2.25 COL 25 COLON-ALIGNED WIDGET-ID 2
          VIEW-AS FILL-IN 
          SIZE 12.14 BY .88
...
DO:
  find es-wm-bloco no-lock 
      where es-wm-bloco.cod-bloco = input frame {&frame-name} es-wm-bloco.cod-bloco no-error.
  if  not avail es-wm-bloco then do:
      {utp/ut-table.i mgesp es-wm-bloco 1}
      run utp/ut-msgs.p (input "show",
                         input 2,
                         input RETURN-VALUE).
      return no-apply.
  end.
  assign p-row-tabela = rowid(es-wm-bloco).
END.
...
------------------------------------------------------------------------------*/
  IF AVAILABLE es-wm-bloco THEN 
    DISPLAY es-wm-bloco.cod-bloco 
      WITH FRAME d-vapara.
  ENABLE rt-button es-wm-bloco.cod-bloco bt-ok bt-cancela bt-ajuda 
      WITH FRAME d-vapara.
  VIEW FRAME d-vapara.
...
------------------------------------------------------------------------------*/
  ...
  {utp/ut9000.i "ESWMP0001-G01" "2.00.00.001"}
