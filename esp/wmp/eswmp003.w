...
*******************************************************************************/
{include/i-prgvrs.i ESWMP003 2.00.00.001}
...
&Scoped-Define ENABLED-OBJECTS rt-button BtHistorico 
...
DEFINE VARIABLE h_eswmp003-b01 AS HANDLE NO-UNDO.
DEFINE VARIABLE h_eswmp003-q01 AS HANDLE NO-UNDO.
DEFINE VARIABLE h_eswmp003-v01 AS HANDLE NO-UNDO.
...
DEFINE BUTTON BtHistorico 
     IMAGE-UP FILE "image\im-autom":U
     IMAGE-INSENSITIVE FILE "image\ii-autom":U
     LABEL "" 
...
DEFINE FRAME f-cad
     BtHistorico AT ROW 1.33 COL 44 HELP
          "Hist¢rico Gera‡Æo" WIDGET-ID 2
     rt-button AT ROW 1.21 COL 1.57
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 1 ROW 1
         SIZE 90 BY 20.33 WIDGET-ID 100.
...
ON END-ERROR OF w-concom /* Consulta Complexa */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL w-concom w-concom
ON WINDOW-CLOSE OF w-concom /* Consulta Complexa */
DO:
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL BtHistorico w-concom
ON CHOOSE OF BtHistorico IN FRAME f-cad
DO:
    RUN pi-retorna-chave IN h_eswmp003-v01 (OUTPUT gr-wms-etiq-packing).
    RUN esp/wmp/eswmp003a.w.
END.
    ...
    WHEN 0 THEN DO:
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'FOLDER-LABELS = ':U + 'Movimentos' + ',
                     FOLDER-TAB-TYPE = 1':U ,
             OUTPUT h_folder ).
       RUN set-position IN h_folder ( 11.67 , 1.57 ) NO-ERROR.
       RUN set-size IN h_folder ( 9.33 , 88.57 ) NO-ERROR.
       ...
       RUN adjust-tab-order IN adm-broker-hdl ( h_p-navega ,
             BtHistorico:HANDLE IN FRAME f-cad , 'BEFORE':U ).
       RUN adjust-tab-order IN adm-broker-hdl ( h_p-exihel ,
             BtHistorico:HANDLE IN FRAME f-cad , 'AFTER':U ).
       RUN adjust-tab-order IN adm-broker-hdl ( h_folder ,
             h_p-exihel , 'AFTER':U ).
    END. /* Page 0 */
    WHEN 1 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'esp/wmp/eswmp003-v01.w':U ,
             INPUT  FRAME f-cad:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_eswmp003-v01 ).
       RUN set-position IN h_eswmp003-v01 ( 3.00 , 2.00 ) NO-ERROR.
       /* Size in UIB:  ( 8.25 , 88.57 ) */

       RUN init-object IN THIS-PROCEDURE (
             INPUT  'esp/wmp/eswmp003-b01.w':U ,
             INPUT  FRAME f-cad:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_eswmp003-b01 ).
       RUN set-position IN h_eswmp003-b01 ( 13.00 , 3.00 ) NO-ERROR.
       /* Size in UIB:  ( 7.25 , 84.00 ) */

       RUN init-object IN THIS-PROCEDURE (
             INPUT  'esp/wmp/eswmp003-q01.w':U ,
             INPUT  FRAME f-cad:HANDLE ,
             INPUT  'ProgPesquisa = esp/wmp/eswmp003-z01.w,
                     ProgVaPara = esp/wmp/eswmp003-g01.w,
                     ProgIncMod = ':U ,
             OUTPUT h_eswmp003-q01 ).
       RUN set-position IN h_eswmp003-q01 ( 1.17 , 55.00 ) NO-ERROR.
       /* Size in UIB:  ( 1.63 , 7.72 ) */

       /* Links to SmartViewer h_eswmp003-v01. */
       RUN add-link IN adm-broker-hdl ( h_eswmp003-q01 , 'Record':U , h_eswmp003-v01 ).

       /* Links to SmartBrowser h_eswmp003-b01. */
       RUN add-link IN adm-broker-hdl ( h_eswmp003-q01 , 'Record':U , h_eswmp003-b01 ).

       /* Links to SmartQuery h_eswmp003-q01. */
       RUN add-link IN adm-broker-hdl ( h_p-navega , 'Navigation':U , h_eswmp003-q01 ).
       RUN add-link IN adm-broker-hdl ( h_p-navega , 'State':U , h_eswmp003-q01 ).

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_eswmp003-v01 ,
             h_p-exihel , 'AFTER':U ).
       RUN adjust-tab-order IN adm-broker-hdl ( h_eswmp003-b01 ,
             h_folder , 'AFTER':U ).
    END. /* Page 1 */
...
------------------------------------------------------------------------------*/
  ...
  {utp/ut9000.i "eswmp003" "2.00.00.001"}
  ...
  ASSIGN btHistorico:SENSITIVE IN FRAME f-cad = YES. 
