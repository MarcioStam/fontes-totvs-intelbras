...
************************************************************************/
{include/i-prgvrs.i ESWMP026 2.00.00.000}

CREATE WIDGET-POOL.

/* Preprocessors Definitions ---                                      */
&GLOBAL-DEFINE Program        ESWMP026
...
&GLOBAL-DEFINE page2Fields    fi-cod-estabel fi-cod-local fi-data-ini fi-data-fim
...
DEFINE FRAME fPage2
     ...
     fi-data-ini AT ROW 3.29 COL 23.28 WIDGET-ID 4
     fi-data-fim AT ROW 3.29 COL 47 NO-LABEL WIDGET-ID 2
     IMAGE-3 AT ROW 3.29 COL 40 WIDGET-ID 6
     IMAGE-4 AT ROW 3.29 COL 43.72 WIDGET-ID 8
...
do on error undo, return error on stop  undo, return error:
    ...
    assign tt-param.usuario      = c-seg-usuario
           ...
           tt-param.DataIni      = INPUT FRAME fPage2 fi-data-ini
           tt-param.Datafim      = INPUT FRAME fPage2 fi-data-fim
           .
    ...
    {report/rprun.i esp/wmp/eswmp026rp.p}
