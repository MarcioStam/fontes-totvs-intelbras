...
&Scoped-define QUERY-STRING-Query-Main FOR EACH wms-etiq-packing NO-LOCK
&Scoped-define OPEN-QUERY-Query-Main OPEN QUERY Query-Main FOR EACH wms-etiq-packing NO-LOCK.
&Scoped-define TABLES-IN-QUERY-Query-Main wms-etiq-packing
&Scoped-define FIRST-TABLE-IN-QUERY-Query-Main wms-etiq-packing
...
RUN set-attribute-list (
    'Keys-Accepted = ,
     Keys-Supplied = "nome-abrev,nr-embarque,cod-estabel,cod-embalagem,val-etiq-packing"':U).
