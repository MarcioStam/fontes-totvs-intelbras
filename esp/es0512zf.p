...
def frame f_sea_01_grp_clien 
    ...
    with 1 down side-labels no-validate keep-tab-order three-d 
         ...
         title "Pesquisa Estabelecimento - ES0512ZF - 1.00.00.001". 
...
ON CHOOSE OF bt_can IN FRAME f_sea_01_grp_clien DO: 

    apply "end-error" to self. 
END.

ON mouse-select-dblclick of br_sea_grp_clien DO:
...
ON VALUE-CHANGED OF rs_sea_grp_clien IN FRAME f_sea_01_grp_clien  DO: 
