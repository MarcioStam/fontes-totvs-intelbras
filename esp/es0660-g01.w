...
c_it-codigo bt-ok bt-cancela bt-ajuda 
...
DEFINE FRAME d-vapara
     ...
     c_cod-depos AT ROW 2.17 COL 30 COLON-ALIGNED WIDGET-ID 4
     c_it-codigo AT ROW 3.17 COL 30 COLON-ALIGNED WIDGET-ID 6
...
FIND reservas-ast NO-LOCK
    WHERE reservas-ast.cod-estabel EQ INPUT FRAME {&FRAME-NAME} c_cod-estabel
      ...
      AND reservas-ast.it-codigo EQ INPUT FRAME {&FRAME-NAME} c_it-codigo NO-ERROR.
...
------------------------------------------------------------------------------*/
  DISPLAY c_cod-estabel c_cod-depos c_it-codigo 
      WITH FRAME d-vapara.
  ENABLE rt-button c_cod-estabel c_cod-depos c_it-codigo bt-ok bt-cancela 
         bt-ajuda 
      WITH FRAME d-vapara.
  VIEW FRAME d-vapara.
