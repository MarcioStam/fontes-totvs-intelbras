...
*******************************************************************************/
{include/i-prgvrs.i esutp008 2.04.00.001}

CREATE WIDGET-POOL.

/* Preprocessors Definitions ---                                      */
&GLOBAL-DEFINE Program        esutp008
...
&GLOBAL-DEFINE page2Widgets   fi-periodo rs-tipo
...
DEFINE VARIABLE rs-tipo AS INTEGER 
     ...
     RADIO-BUTTONS 
          "Per°odo", 1,
"Comparativo 3 meses", 2
     SIZE 23.14 BY 2 NO-UNDO.
...
DEFINE FRAME fPage2
     fi-periodo AT ROW 2.5 COL 12.86 COLON-ALIGNED HELP
          "Per°odo" WIDGET-ID 18
     rs-tipo AT ROW 4.88 COL 14.86 NO-LABEL WIDGET-ID 46
     "Tipo:" VIEW-AS TEXT
          SIZE 4.86 BY .54 AT ROW 4.25 COL 6.14 WIDGET-ID 54
     RECT-10 AT ROW 4.5 COL 5 WIDGET-ID 50
     RECT-11 AT ROW 1.75 COL 5 WIDGET-ID 52
...
do on error undo, return error on stop  undo, return error:
    ...
    {report/rprun.i esp/utp/esutp008rp.p}
