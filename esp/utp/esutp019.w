...
*******************************************************************************/
{include/i-prgvrs.i esutp019 2.04.00.001}

CREATE WIDGET-POOL.

/* Preprocessors Definitions ---                                      */
&GLOBAL-DEFINE Program        esutp019
...
&GLOBAL-DEFINE page2Widgets   fi-periodo-ini fi-periodo-fim ~
                              fi-fornec-ini fi-fornec-fim ~
                              fi-equip-ini fi-equip-fim
...
DEFINE VARIABLE fi-fornec-fim AS INTEGER FORMAT ">>9" INITIAL 999 
     VIEW-AS FILL-IN 
     SIZE 7 BY .88 NO-UNDO.

DEFINE VARIABLE fi-fornec-ini AS INTEGER FORMAT ">>9" INITIAL 0 
     LABEL "Fornecedor":R15 
     VIEW-AS FILL-IN 
     SIZE 7 BY .88 NO-UNDO.

DEFINE VARIABLE fi-periodo-fim AS CHARACTER FORMAT "999999" INITIAL "999999" 
     VIEW-AS FILL-IN 
     SIZE 7 BY .88 NO-UNDO.

DEFINE VARIABLE fi-periodo-ini AS CHARACTER FORMAT "999999" INITIAL "200801" 
     LABEL "Per°odo":R15 
     VIEW-AS FILL-IN 
     SIZE 7 BY .88 NO-UNDO.
...
DEFINE FRAME fPage2
     fi-periodo-ini AT ROW 2.88 COL 27 COLON-ALIGNED HELP
          "Per°odo Inicial" WIDGET-ID 94
     fi-periodo-fim AT ROW 2.88 COL 48.43 COLON-ALIGNED HELP
          "Per°odo Final" NO-LABEL WIDGET-ID 92
     fi-fornec-ini AT ROW 3.92 COL 27 COLON-ALIGNED HELP
          "Fornecedor Inicial" WIDGET-ID 102
     fi-fornec-fim AT ROW 3.92 COL 48.43 COLON-ALIGNED HELP
          "Fornecedor Final" NO-LABEL WIDGET-ID 100
     fi-equip-ini AT ROW 4.92 COL 16.14 COLON-ALIGNED HELP
          "Ramal Inicial" WIDGET-ID 68
     fi-equip-fim AT ROW 4.92 COL 48.43 COLON-ALIGNED HELP
          "Ramal Final" NO-LABEL WIDGET-ID 78
     IMAGE-1 AT ROW 4.92 COL 36.86 WIDGET-ID 70
     IMAGE-2 AT ROW 4.92 COL 47.14 WIDGET-ID 72
     IMAGE-3 AT ROW 2.88 COL 36.86 WIDGET-ID 96
     IMAGE-4 AT ROW 2.88 COL 47.14 WIDGET-ID 98
     IMAGE-5 AT ROW 3.92 COL 36.86 WIDGET-ID 104
     IMAGE-6 AT ROW 3.92 COL 47.14 WIDGET-ID 106
...
do on error undo, return error on stop  undo, return error:
    ...
    {report/rprun.i esp/utp/esutp019rp.p}
