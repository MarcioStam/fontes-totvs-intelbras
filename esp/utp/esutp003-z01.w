...
*******************************************************************************/
{include/i-prgvrs.i ESUTP003-Z01 1.00.00.001}
...
DEFINE VARIABLE h_esutp003-b02 AS HANDLE NO-UNDO.
...
DEFINE FRAME f-zoom
     bt-implantar AT ROW 11.17 COL 1
     bt-ok AT ROW 12.75 COL 2.43
     bt-cancela AT ROW 12.75 COL 13.43
     bt-ajuda AT ROW 12.75 COL 68.57
     rt-button AT ROW 12.5 COL 1.43
  ...
  CASE adm-current-page: 
    ...
    WHEN 1 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'esp/utp/esutp003-b01.w':U ,
             INPUT  FRAME f-zoom:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_esutp003-b02 ).
       RUN set-position IN h_esutp003-b02 ( 1.00 , 1.00 ) NO-ERROR.
       /* Size in UIB:  ( 10.17 , 80.14 ) */

       /* Links to SmartBrowser h_esutp003-b02. */
       RUN add-link IN adm-broker-hdl ( h_esutp003-b02 , 'State':U , THIS-PROCEDURE ).

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_esutp003-b02 ,
...
------------------------------------------------------------------------------*/
  ...
  {utp/ut9000.i "ESUTP003-Z01" "1.00.00.001"}
