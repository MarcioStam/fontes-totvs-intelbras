...
*******************************************************************************/
{include/i-prgvrs.i ESUTP006 1.00.00.001}

CREATE WIDGET-POOL.

/* Preprocessors Definitions ---                                      */
&GLOBAL-DEFINE Program        ESUTP006
...
&GLOBAL-DEFINE page0Widgets   btOk ~
                              btCancel ~
                              btHelp2
&GLOBAL-DEFINE page2Widgets   fi-periodo rs-execucao rs-tipo
&GLOBAL-DEFINE page4Widgets   tg-equipamento tg-fatura tg-rateio tg-contabil 
...
DEFINE VARIABLE tg-contabil AS LOGICAL INITIAL yes 
     LABEL "Relaá∆o da contabilizaá∆o?" 
     VIEW-AS TOGGLE-BOX
     SIZE 43 BY .83 NO-UNDO.

DEFINE VARIABLE tg-equipamento AS LOGICAL INITIAL no 
     LABEL "Relaá∆o Conta/Centro Custo dos equipamentos?" 
     VIEW-AS TOGGLE-BOX
     SIZE 43 BY .83 NO-UNDO.

DEFINE VARIABLE tg-fatura AS LOGICAL INITIAL yes 
     LABEL "Relaá∆o de faturas do equipamentos?" 
     VIEW-AS TOGGLE-BOX
     SIZE 43 BY .83 NO-UNDO.

DEFINE VARIABLE tg-rateio AS LOGICAL INITIAL yes 
     LABEL "Relaá∆o dos c†lculos dos rateios?" 
     VIEW-AS TOGGLE-BOX
     SIZE 43 BY .83 NO-UNDO.
...
DEFINE FRAME fPage2
     fi-periodo AT ROW 2.21 COL 13 COLON-ALIGNED WIDGET-ID 16
     rs-execucao AT ROW 4.63 COL 12 NO-LABEL WIDGET-ID 12
     rs-tipo AT ROW 6.96 COL 12 NO-LABEL WIDGET-ID 26
     "Tipo:" VIEW-AS TEXT
          SIZE 4 BY .54 AT ROW 6.21 COL 10.29 WIDGET-ID 30
     "Execuá∆o:" VIEW-AS TEXT
          SIZE 8.72 BY .54 AT ROW 3.88 COL 10.29 WIDGET-ID 22
     RECT-11 AT ROW 4.13 COL 9 WIDGET-ID 20
     RECT-12 AT ROW 6.46 COL 9 WIDGET-ID 24
...
DEFINE FRAME fPage4
     tg-equipamento AT ROW 2 COL 6 WIDGET-ID 24
     tg-fatura AT ROW 3 COL 6 WIDGET-ID 26
     tg-rateio AT ROW 4 COL 6 WIDGET-ID 28
     tg-contabil AT ROW 5 COL 6 WIDGET-ID 30
     "Imprime:" VIEW-AS TEXT
          SIZE 6.29 BY .54 AT ROW 1.25 COL 4.72 WIDGET-ID 34
     RECT-13 AT ROW 1.5 COL 3 WIDGET-ID 32
    WITH 1 DOWN KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 3.57 ROW 2.81
         SIZE 84.43 BY 10.15
...
do on error undo, return error on stop  undo, return error:
    ...
    IF input frame fPage2 fi-periodo = "000000" OR 
       input frame fPage2 fi-periodo = ""       OR
       input frame fPage2 fi-periodo = ?        THEN DO:

        run utp/ut-msgs.p (input "show":U, input 17006, input "Per°odo inv†lido.~~Informe um per°odo v†lido!":U).
        APPLY "entry" TO fi-periodo IN FRAME fPage2.
        return error.
    END.
    ...
    assign tt-param.usuario         = c-seg-usuario
           ...
           tt-param.execucao        = input frame fPage2 rs-execucao
           tt-param.tipo            = input frame fPage2 rs-tipo
           tt-param.l-equipamento   = input frame fPage4 tg-equipamento
           tt-param.l-fatura        = input frame fPage4 tg-fatura
           tt-param.l-rateio        = input frame fPage4 tg-rateio
           tt-param.l-contabil      = input frame fPage4 tg-contabil.
    ...
    {report/rprun.i esp/utp/esutp006rp.p}
