...
*******************************************************************************/
{include/i-prgvrs.i ESUTP063 1.00.00.001}
...
DEFINE VARIABLE fi-ccusto-fim AS CHARACTER FORMAT "x(8)":U INITIAL "ZZZZZZZZ" 
     VIEW-AS FILL-IN 
     SIZE 10 BY .88 NO-UNDO.

DEFINE VARIABLE fi-ccusto-ini AS CHARACTER FORMAT "x(8)" 
     LABEL "Centro Custo" 
     VIEW-AS FILL-IN 
     SIZE 10 BY .88 NO-UNDO.
...
DEFINE VARIABLE fi-unid-neg-fim AS CHARACTER FORMAT "X(3)":U INITIAL "ZZZ" 
     VIEW-AS FILL-IN 
     SIZE 5 BY .88 NO-UNDO.

DEFINE VARIABLE fi-unid-neg-ini AS CHARACTER FORMAT "x(3)" 
...
DEFINE FRAME f-pg-sel
     fi-unid-neg-ini AT ROW 3.08 COL 24.86 COLON-ALIGNED HELP
          "C¢digo da unidade de n‚gocio" WIDGET-ID 12
     fi-unid-neg-fim AT ROW 3.08 COL 48.29 COLON-ALIGNED NO-LABEL WIDGET-ID 10
     fi-estab-ini AT ROW 4.08 COL 22.86 COLON-ALIGNED
     fi-estab-fim AT ROW 4.08 COL 48.29 COLON-ALIGNED NO-LABEL
     fi-ccusto-ini AT ROW 5.08 COL 19.86 COLON-ALIGNED HELP
          "C¢digo do Centro de Custo" WIDGET-ID 4
     fi-ccusto-fim AT ROW 5.08 COL 48.29 COLON-ALIGNED NO-LABEL WIDGET-ID 2
     IMAGE-1 AT ROW 4.08 COL 32
     IMAGE-2 AT ROW 4.08 COL 47.43
     IMAGE-3 AT ROW 5.08 COL 32 WIDGET-ID 6
     IMAGE-4 AT ROW 5.08 COL 47.43 WIDGET-ID 8
     IMAGE-5 AT ROW 3.08 COL 32 WIDGET-ID 14
     IMAGE-6 AT ROW 3.08 COL 47.43 WIDGET-ID 16
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 3 ROW 2.85
...
{utp/ut9000.i "ESUTP063" "1.00.00.001"}
...
------------------------------------------------------------------------------*/
  ...
  DISPLAY fi-unid-neg-ini fi-unid-neg-fim fi-estab-ini fi-estab-fim 
          fi-ccusto-ini fi-ccusto-fim 
      WITH FRAME f-pg-sel IN WINDOW w-relat.
  ENABLE IMAGE-1 IMAGE-2 IMAGE-3 IMAGE-4 IMAGE-5 IMAGE-6 fi-unid-neg-ini 
         fi-unid-neg-fim fi-estab-ini fi-estab-fim fi-ccusto-ini fi-ccusto-fim 
      WITH FRAME f-pg-sel IN WINDOW w-relat.
...
do on error undo, return error on stop  undo, return error:
    ...
    assign tt-param.usuario         = c-seg-usuario
           ...
           tt-param.ccusto-ini      = input frame f-pg-sel fi-ccusto-ini   
           tt-param.ccusto-fim      = input frame f-pg-sel fi-ccusto-fim   
           tt-param.unid-neg-ini    = input frame f-pg-sel fi-unid-neg-ini 
           tt-param.unid-neg-fim    = input frame f-pg-sel fi-unid-neg-fim 
    ...
    {include/i-rprun.i esp/utp/esutp063rp.p}
