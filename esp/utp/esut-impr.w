...
&Scoped-Define ENABLED-OBJECTS br-impres RECT-16 rt-buttom sl-layout l-arq ~
...
/* SETTINGS FOR DIALOG-BOX D-Dialog
   FRAME-NAME                                                           */
/* BROWSE-TAB br-impres 1 D-Dialog */
ASSIGN 
...
------------------------------------------------------------------------------*/
  DISPLAY sl-layout l-arq c-arq c-label1 
      WITH FRAME D-Dialog.
  ENABLE br-impres RECT-16 rt-buttom sl-layout l-arq bt-ok bt-cancela 
         bt-windows bt-ajuda 
      WITH FRAME D-Dialog.
  VIEW FRAME D-Dialog.
...
/*------------------------------------------------------------------------------
  ...
  Notes:       
------------------------------------------------------------------------------*/
    RUN esp/utp/esut-impr-rpc.p ON SERVER p-proc transaction distinct 
        (INPUT v_cod_usuar_corren,
         OUTPUT TABLE ttimprsor_usuar,
         OUTPUT TABLE ttimpressora,
         OUTPUT TABLE ttlayout_impres)
        no-error.
