...
*******************************************************************************/
{include/i-prgvrs.i ESUTP013 1.00.00.001}

CREATE WIDGET-POOL.

/* Preprocessors Definitions ---                                      */
&GLOBAL-DEFINE Program        ESUTP013
...
&GLOBAL-DEFINE page0Widgets   btOk ~
                              btCancel ~
                              btHelp2
&GLOBAL-DEFINE page2Widgets   rs-execucao
...
DEFINE FRAME fPage2
     rs-execucao AT ROW 2.5 COL 7 NO-LABEL WIDGET-ID 12
     "Execuá∆o:" VIEW-AS TEXT
          SIZE 8.72 BY .54 AT ROW 1.75 COL 5.29 WIDGET-ID 22
     RECT-11 AT ROW 2 COL 4 WIDGET-ID 20
...
DO:
   ...
   do  on error undo, return no-apply:
       IF input frame fPage2 rs-execucao = 2 THEN DO:
           MESSAGE "Ap¢s essa execuá∆o ser† enviado email ao RH para importar cobranáas, sendo que todas as ligaá‰es pendentes ser∆o marcadas como j† cobradas. Deseja realmente gerar integraá∆o?" UPDATE l-executa
               VIEW-AS ALERT-BOX QUESTION BUTTONS YES-NO.
           IF NOT l-executa THEN
               RETURN "NOK".
       END.
       run piExecute.
   end.
...
do on error undo, return error on stop  undo, return error:
    ...
    {report/rprun.i esp/utp/esutp013rp.p}
