...
*******************************************************************************/
{include/i-prgvrs.i GK0004 2.00.00.000}

CREATE WIDGET-POOL.

/* Preprocessors Definitions ---                                      */
&GLOBAL-DEFINE Program        GK0004
...
&GLOBAL-DEFINE page2Fields    dtCtbl
...
DEFINE VARIABLE dtCtbl AS DATE FORMAT "99/99/9999":U INITIAL 01/01/1800 
     LABEL "Data de Contabilizaá∆o" 
     VIEW-AS FILL-IN 
     SIZE 11 BY .88
     FONT 1 NO-UNDO.
...
DEFINE FRAME fPage2
     dtCtbl AT ROW 1.5 COL 27.57 HELP
          "Data de Contabilizaá∆o"
    WITH 1 DOWN KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 3.57 ROW 2.81
         SIZE 84.43 BY 10.15
...
/* SETTINGS FOR FRAME fPage2
                                                                        */
/* SETTINGS FOR FILL-IN dtCtbl IN FRAME fPage2
   ALIGN-L                                                              */
...
------------------------------------------------------------------------------*/
    ...
    &IF "{&RTF}":U = "YES":U &THEN
    IF VALID-HANDLE(hWenController) THEN
    ...
    ASSIGN dtCtbl = DATE(MONTH(TODAY), 01, YEAR(TODAY)) - 1.
...
------------------------------------------------------------------------------*/
    ...
    DO ON ERROR UNDO, RETURN ERROR
       ON STOP  UNDO, RETURN ERROR:
        ...
        &IF DEFINED(PGDIG) AND "{&PGDIG}":U = "YES":U &THEN
        ...
        ASSIGN tt-param.dt-ctbl = INPUT FRAME fPage2 dtCtbl.
        ...
        {report/rprun.i esp/gko/gk0004rp.p}
