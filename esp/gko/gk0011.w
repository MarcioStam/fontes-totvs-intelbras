...
&GLOBAL-DEFINE Program        GK0011
&GLOBAL-DEFINE Version        1.00.00.000
&GLOBAL-DEFINE VersionLayout  

&GLOBAL-DEFINE Folder         YES
&GLOBAL-DEFINE InitialPage    1
&GLOBAL-DEFINE FolderLabels   Impress∆o,LOG
...
DEFINE FRAME fPage6
     rsDestiny AT ROW 4.58 COL 3.14 HELP
          "Destino de Impress∆o do Relat¢rio" NO-LABEL
     cFile AT ROW 5.83 COL 3.14 HELP
          "Nome do arquivo de destino do relat¢rio" NO-LABEL
     btFile AT ROW 5.71 COL 43 HELP
          "Escolha do nome do arquivo"
     btConfigImpr AT ROW 5.71 COL 43 HELP
          "Configuraá∆o da impressora"
     l-habilitaRtf AT ROW 7.79 COL 3.14
     cModelRTF AT ROW 9.5 COL 3 HELP
          "Nome do arquivo de modelo" NO-LABEL
     btModelRtf AT ROW 9.5 COL 43 HELP
          "Escolha o arquivo de modelo"
     rsExecution AT ROW 11.71 COL 2.86 HELP
          "Modo de Execuá∆o" NO-LABEL
     text-destino AT ROW 3.83 COL 1.86 COLON-ALIGNED NO-LABEL
     text-rtf AT ROW 7.21 COL 2 COLON-ALIGNED NO-LABEL
     text-ModelRtf AT ROW 8.75 COL 2 COLON-ALIGNED NO-LABEL
     text-modo AT ROW 10.96 COL 1.14 COLON-ALIGNED NO-LABEL
     rect-rtf AT ROW 7.5 COL 2
     RECT-7 AT ROW 4.13 COL 2.14
     RECT-9 AT ROW 11.21 COL 2
...
do on error undo, return error on stop  undo, return error:
    ...
    {report/rprun.i esp/gko/gk0011rp.p}
...
do  on error undo, return error
    ...
    {report/imrun.i esp/gko/gk0011rp.p}
