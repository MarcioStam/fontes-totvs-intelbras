...
&GLOBAL-DEFINE page4Fields    fi-cod-estabel-ini fi-cod-estabel-fim fi-serie-ini fi-serie-fim fi-nr-nota-fis-ini fi-nr-nota-fis-fim fi-dt-emis-nota-ini fi-dt-emis-nota-fim ~
                              tg-30-dias tg-notas-devolucao tg-dt-saida tg-dt-entrega tg-dt-previsao-entrega
...
DEFINE VARIABLE fi-dt-emis-nota-fim AS DATE FORMAT "99/99/9999":U INITIAL 12/31/9999 
     VIEW-AS FILL-IN 
     SIZE 10 BY .88 NO-UNDO.

DEFINE VARIABLE fi-dt-emis-nota-ini AS DATE FORMAT "99/99/9999":U INITIAL 01/01/001 
     LABEL "Data Emiss∆o" 
     VIEW-AS FILL-IN 
     SIZE 10 BY .88 NO-UNDO.

DEFINE VARIABLE fi-nr-nota-fis-fim AS CHARACTER FORMAT "X(7)":U INITIAL "9999999" 
     VIEW-AS FILL-IN 
     SIZE 10 BY .88 NO-UNDO.

DEFINE VARIABLE fi-nr-nota-fis-ini AS CHARACTER FORMAT "X(7)":U INITIAL "0" 
     LABEL "Nota Fiscal" 
     VIEW-AS FILL-IN 
     SIZE 10 BY .88 NO-UNDO.
...
DEFINE VARIABLE tg-30-dias AS LOGICAL INITIAL no 
     LABEL "30 Dias" 
     VIEW-AS TOGGLE-BOX
...
DEFINE VARIABLE tg-dt-previsao-entrega AS LOGICAL INITIAL no 
     LABEL "Data de Previs∆o de Entrega" 
     VIEW-AS TOGGLE-BOX
     SIZE 29 BY .83 NO-UNDO.

DEFINE VARIABLE tg-dt-saida AS LOGICAL INITIAL no 
     LABEL "Data de Sa°da" 
     VIEW-AS TOGGLE-BOX
     SIZE 29 BY .83 NO-UNDO.

DEFINE VARIABLE tg-notas-devolucao AS LOGICAL INITIAL no 
     LABEL "Notas de Devoluá∆o" 
     VIEW-AS TOGGLE-BOX
...
DEFINE FRAME fPage4
     fi-cod-estabel-ini AT ROW 1.25 COL 28 COLON-ALIGNED WIDGET-ID 64
     fi-cod-estabel-fim AT ROW 1.25 COL 47 COLON-ALIGNED NO-LABEL WIDGET-ID 72
     fi-serie-ini AT ROW 2.25 COL 26 COLON-ALIGNED WIDGET-ID 96
     fi-serie-fim AT ROW 2.25 COL 47 COLON-ALIGNED NO-LABEL WIDGET-ID 94
     fi-nr-nota-fis-ini AT ROW 3.25 COL 24 COLON-ALIGNED WIDGET-ID 66
     fi-nr-nota-fis-fim AT ROW 3.25 COL 47 COLON-ALIGNED NO-LABEL WIDGET-ID 74
     fi-dt-emis-nota-ini AT ROW 4.25 COL 24 COLON-ALIGNED WIDGET-ID 68
     fi-dt-emis-nota-fim AT ROW 4.25 COL 47 COLON-ALIGNED NO-LABEL WIDGET-ID 76
     tg-30-dias AT ROW 4.25 COL 60 WIDGET-ID 84
     tg-notas-devolucao AT ROW 6 COL 11.14 WIDGET-ID 86
     tg-dt-saida AT ROW 7 COL 11 WIDGET-ID 88
     tg-dt-entrega AT ROW 8 COL 11 WIDGET-ID 90
     tg-dt-previsao-entrega AT ROW 9 COL 11 WIDGET-ID 92
     IMAGE-18 AT ROW 1.25 COL 37 WIDGET-ID 80
     IMAGE-27 AT ROW 1.25 COL 45 WIDGET-ID 82
     IMAGE-44 AT ROW 3.25 COL 37 WIDGET-ID 40
     IMAGE-48 AT ROW 4.25 COL 37 WIDGET-ID 48
     IMAGE-46 AT ROW 4.25 COL 45 WIDGET-ID 44
     IMAGE-45 AT ROW 3.25 COL 45 WIDGET-ID 42
     RECT-15 AT ROW 5.75 COL 7.72 WIDGET-ID 36
     IMAGE-49 AT ROW 2.25 COL 37 WIDGET-ID 98
     IMAGE-50 AT ROW 2.25 COL 45 WIDGET-ID 100
    WITH 1 DOWN KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 3.57 ROW 2.81
         SIZE 84.43 BY 10.15
...
&Scoped-define SELF-NAME tg-30-dias
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL tg-30-dias wReport
ON VALUE-CHANGED OF tg-30-dias IN FRAME fPage4 /* 30 Dias */
DO:
    IF tg-30-dias:CHECKED IN FRAME fPage4 = YES THEN DO:
        ASSIGN fi-dt-emis-nota-ini:SENSITIVE IN FRAME fPage4 = NO
               fi-dt-emis-nota-fim:SENSITIVE IN FRAME fPage4 = NO
               fi-dt-emis-nota-ini:SCREEN-VALUE IN FRAME fPage4 = STRING(TODAY - 30)
               fi-dt-emis-nota-fim:SCREEN-VALUE IN FRAME fPage4 = STRING(TODAY).

    END.
    ELSE DO:
        ASSIGN fi-dt-emis-nota-ini:SENSITIVE IN FRAME fPage4 = YES
               fi-dt-emis-nota-fim:SENSITIVE IN FRAME fPage4 = YES.
    END.
END.
...
do on error undo, return error on stop  undo, return error:
    ...
    IF NOT AVAIL conteudo-programa THEN DO:
        run utp/ut-msgs.p(input "show",
                          input 17006,
                          input "Base URL n∆o cadastrada" + "~~" +
                                "Base URL n∆o cadastrada no programa ES0018 para o programa GK0013 Ponto 1, Sequencia 1").
        return error.
    END.
    ...
    assign tt-param.usuario                 = c-seg-usuario
           ...
           tt-param.cod-estabel-ini         = input frame fPage4 fi-cod-estabel-ini 
           tt-param.cod-estabel-fim         = input frame fPage4 fi-cod-estabel-fim 
           tt-param.serie-ini               = input frame fPage4 fi-serie-ini 
           tt-param.serie-fim               = input frame fPage4 fi-serie-fim 
           tt-param.nr-nota-fis-ini         = input frame fPage4 fi-nr-nota-fis-ini 
           tt-param.nr-nota-fis-fim         = input frame fPage4 fi-nr-nota-fis-fim 
           tt-param.dt-emis-nota-ini        = input frame fPage4 fi-dt-emis-nota-ini
           tt-param.dt-emis-nota-fim        = input frame fPage4 fi-dt-emis-nota-fim
           tt-param.l-30-dias               = input frame fPage4 tg-30-dias:CHECKED
           tt-param.l-notas-devolucao       = input frame fPage4 tg-notas-devolucao:CHECKED
           tt-param.l-dt-saida              = input frame fPage4 tg-dt-saida:CHECKED
           tt-param.l-dt-entrega            = input frame fPage4 tg-dt-entrega:CHECKED
           tt-param.l-dt-previsao-entrega   = input frame fPage4 tg-dt-previsao-entrega:CHECKED.
    ...
    {report/rprun.i esp/gko/gk0013rp.p}
...
do  on error undo, return error
    ...
    {report/imrun.i esp/gko/gk0013rp.p}
