/******************************************************************************
** Programa..............: rpt_gera_inf_orc
** Versao................:  1.00.00.000
** Nome Externo..........: esp/es0027rp.p
** Criado por............: Fabiano
** Criado em.............: 30/08/2007
** Objetivo..............: Gerar os arquivos no diret¢rio orcamento para serem
**                         importadas pelo programa es0940.
******************************************************************************/
{esp/es0018.i}
{esp/es0027.i} 
...
assign v_num_ano_refer = year(today)
...
DO i-data = DATE(i-mes,01, i-ano) TO v_dat_refer_fim:
...
FOR EACH tt-cc  NO-LOCK:
    ...
    FOR EACH tt-conta:
        ...
        DO i-data = DATE(i-mes,01, i-ano) TO v_dat_refer_fim:
             ...
             FOR EACH tt-movto FIELDS (dt-trans esp-docto usuario serie-docto it-codigo quantidade nro-docto 
                                          valor-mob-m valor-ggf-m cod-emitente tipo-trans ct-codigo sc-codigo valor-mat-m cod-estabel descricao-db
                                          nat-operacao sequen-nf) USE-INDEX ch-conta
                 WHERE tt-movto.dt-trans  = i-data
                   AND tt-movto.ct-codigo = tt-conta.cod_cta_ctbl
                   AND tt-movto.sc-codigo = tt-cc.centro-custo   
                   NO-LOCK:
                   ...
                   END.
                   ELSE ASSIGN tt-dados.nome_emitente = item.it-codigo + " " + tt-movto.usuario.
                   ...
                   find item-doc-est no-lock
                    ...
                    if avail item-doc-est
                       then assign tt-dados.nome_emitente = tt-dados.nome_emitente + " - Narrativa: " + item-doc-est.narrativa.
