...
*******************************************************************************/
{include/i-prgvrs.i esofp009 2.00.00.000}
...
DEFINE VARIABLE c-nat-operacao-fim AS CHARACTER FORMAT "x(06)":U INITIAL "ZZZZZZZ" 
     VIEW-AS FILL-IN 
     SIZE 15 BY .88 NO-UNDO.

DEFINE VARIABLE c-nat-operacao-ini AS CHARACTER FORMAT "x(06)":U INITIAL "0" 
     LABEL "Natureza" 
     VIEW-AS FILL-IN 
     SIZE 15 BY .88 NO-UNDO.

DEFINE VARIABLE c-nr-doc-fis-fim AS CHARACTER FORMAT "X(16)":U INITIAL "ZZZZZZZZZZZZZZZZ" 
     VIEW-AS FILL-IN 
     SIZE 15 BY .88 NO-UNDO.
...
DEFINE VARIABLE d-dt-emis-doc-fim AS DATE FORMAT "99/99/9999":U 
     VIEW-AS FILL-IN 
     SIZE 15 BY .88 NO-UNDO.

DEFINE VARIABLE d-dt-emis-doc-ini AS DATE FORMAT "99/99/9999":U 
     LABEL "Data Transa‡Æo" 
     VIEW-AS FILL-IN 
     SIZE 15 BY .88 NO-UNDO.

DEFINE VARIABLE i-cod-emitente-fim AS INTEGER FORMAT ">>>>>>>>9":U INITIAL 99999999 
     VIEW-AS FILL-IN 
     SIZE 15 BY .88 NO-UNDO.
...
DEFINE FRAME f-pg-sel
     c-cod-estabel-ini AT ROW 1.25 COL 15 COLON-ALIGNED WIDGET-ID 12
     c-cod-estabel-fim AT ROW 1.25 COL 48.14 COLON-ALIGNED NO-LABEL WIDGET-ID 10
     c-nat-operacao-ini AT ROW 2.25 COL 15 COLON-ALIGNED WIDGET-ID 28
     c-nat-operacao-fim AT ROW 2.25 COL 48.14 COLON-ALIGNED NO-LABEL WIDGET-ID 26
     d-dt-emis-doc-ini AT ROW 3.25 COL 15 COLON-ALIGNED
     d-dt-emis-doc-fim AT ROW 3.25 COL 48.14 COLON-ALIGNED NO-LABEL
     i-cod-emitente-ini AT ROW 4.25 COL 15 COLON-ALIGNED WIDGET-ID 4
     i-cod-emitente-fim AT ROW 4.25 COL 48.14 COLON-ALIGNED NO-LABEL WIDGET-ID 2
     c-nr-doc-fis-ini AT ROW 5.25 COL 15 COLON-ALIGNED WIDGET-ID 36
     c-nr-doc-fis-fim AT ROW 5.25 COL 48.14 COLON-ALIGNED NO-LABEL WIDGET-ID 34
     c-serie-ini AT ROW 6.25 COL 15 COLON-ALIGNED WIDGET-ID 20
     c-serie-fim AT ROW 6.25 COL 48.14 COLON-ALIGNED NO-LABEL WIDGET-ID 18
     tg-nota AT ROW 8 COL 17 WIDGET-ID 42
     IMAGE-1 AT ROW 3.25 COL 31.86
     IMAGE-2 AT ROW 3.25 COL 47.29
     IMAGE-3 AT ROW 4.25 COL 31.86 WIDGET-ID 6
     IMAGE-4 AT ROW 4.25 COL 47.29 WIDGET-ID 8
     IMAGE-5 AT ROW 1.25 COL 31.86 WIDGET-ID 14
     IMAGE-6 AT ROW 1.25 COL 47.29 WIDGET-ID 16
     IMAGE-7 AT ROW 6.25 COL 31.86 WIDGET-ID 22
     IMAGE-8 AT ROW 6.25 COL 47.29 WIDGET-ID 24
     IMAGE-9 AT ROW 2.25 COL 31.86 WIDGET-ID 30
     IMAGE-10 AT ROW 2.25 COL 47.29 WIDGET-ID 32
     IMAGE-11 AT ROW 5.25 COL 31.86 WIDGET-ID 38
     IMAGE-12 AT ROW 5.25 COL 47.29 WIDGET-ID 40
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 3 ROW 2.85
...
{utp/ut9000.i "esofp009" "2.00.00.000"}
...
DO  ON ERROR   UNDO MAIN-BLOCK, LEAVE MAIN-BLOCK
    ...
    ASSIGN d-dt-emis-doc-ini:SCREEN-VALUE IN FRAME f-pg-sel = "01/" + STRING(MONTH(TODAY)) + "/" + STRING(YEAR(TODAY))
           d-dt-emis-doc-fim:SCREEN-VALUE IN FRAME f-pg-sel = STRING(TODAY).
...
------------------------------------------------------------------------------*/
  ...
  DISPLAY c-cod-estabel-ini c-cod-estabel-fim c-nat-operacao-ini 
          c-nat-operacao-fim d-dt-emis-doc-ini d-dt-emis-doc-fim 
          i-cod-emitente-ini i-cod-emitente-fim c-nr-doc-fis-ini 
          c-nr-doc-fis-fim c-serie-ini c-serie-fim tg-nota 
      WITH FRAME f-pg-sel IN WINDOW w-relat.
  ENABLE IMAGE-1 IMAGE-2 IMAGE-3 IMAGE-4 IMAGE-5 IMAGE-6 IMAGE-7 IMAGE-8 
         IMAGE-9 IMAGE-10 IMAGE-11 IMAGE-12 c-cod-estabel-ini c-cod-estabel-fim 
         c-nat-operacao-ini c-nat-operacao-fim d-dt-emis-doc-ini 
         d-dt-emis-doc-fim i-cod-emitente-ini i-cod-emitente-fim 
         c-nr-doc-fis-ini c-nr-doc-fis-fim c-serie-ini c-serie-fim tg-nota 
      WITH FRAME f-pg-sel IN WINDOW w-relat.
...
do on error undo, return error on stop  undo, return error:
    ...
    assign tt-param.usuario          = c-seg-usuario
           ...
           tt-param.dt-emis-doc-ini  = INPUT FRAME f-pg-sel d-dt-emis-doc-ini 
           tt-param.dt-emis-doc-fim  = INPUT FRAME f-pg-sel d-dt-emis-doc-fim 
           ...
           tt-param.nr-doc-fisc-ini  = INPUT FRAME f-pg-sel c-nr-doc-fis-ini 
           tt-param.nr-doc-fisc-fim  = INPUT FRAME f-pg-sel c-nr-doc-fis-fim 
           tt-param.tg-notas         = INPUT FRAME f-pg-sel tg-nota
        .
    ...
    {include/i-rprun.i esp/ofp/esofp009rp.p}
