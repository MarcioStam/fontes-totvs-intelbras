...
&GLOBAL-DEFINE Program        ESOFP002
...
&GLOBAL-DEFINE page0Widgets   btOk ~
                              btCancel ~
                              btHelp2
&GLOBAL-DEFINE page2Widgets   fiDtIni FiDtFim Fi-cod-estabel
...
DEFINE FRAME fPage2
     fi-cod-estabel AT ROW 2.5 COL 10.86
     fiDtIni AT ROW 3.5 COL 17.57
     fiDtFim AT ROW 3.5 COL 51.86 NO-LABEL
     IMAGE-1 AT ROW 3.5 COL 42.43
     IMAGE-2 AT ROW 3.5 COL 49
    ...
    */
    ...
    DO WITH FRAME fPage2:
        ASSIGN tt-param.da-ini          = INPUT fiDtIni      
               ...
               tt-param.c-cod-estabel   = INPUT Fi-cod-estabel.
    END.
    ...
    {report/rprun.i esp\ofp\esofp002rp.p}
