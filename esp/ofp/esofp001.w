...
&GLOBAL-DEFINE Program        ESOFP001
...
&GLOBAL-DEFINE page0Widgets   btOk ~
                              btCancel ~
                              btHelp2
&GLOBAL-DEFINE page2Widgets   ficod_estabel_ini ficod_estabel_fim fiDtIni FiDtFim FiItCodigoIni FiItCodigoFim
...
&GLOBAL-DEFINE page2Fields    ficod_estabel_ini ficod_estabel_fim fiDtIni FiDtFim FiItCodigoIni FiItCodigoFim
...
DEFINE VARIABLE ficod_estabel_fim AS CHARACTER FORMAT "X(3)":U INITIAL "ZZZ" 
     VIEW-AS FILL-IN 
     SIZE 10 BY .88
     FONT 1 NO-UNDO.

DEFINE VARIABLE ficod_estabel_ini AS CHARACTER FORMAT "X(3)":U 
     LABEL "Cod. Estabel" 
     VIEW-AS FILL-IN 
     SIZE 10 BY .88
     FONT 1 NO-UNDO.
...
DEFINE VARIABLE fiItCodigoFim AS CHARACTER FORMAT "X(16)":U INITIAL "ZZZZZZZZZZZZZZZ" 
     VIEW-AS FILL-IN 
     SIZE 16 BY .88
     FONT 1 NO-UNDO.
...
DEFINE FRAME fPage2
     ficod_estabel_ini AT ROW 2.75 COL 15.57 WIDGET-ID 4
     ficod_estabel_fim AT ROW 2.75 COL 50.86 NO-LABEL WIDGET-ID 2
     fiDtIni AT ROW 3.75 COL 16.57
     fiDtFim AT ROW 3.75 COL 50.86 NO-LABEL
     fiItCodigoIni AT ROW 4.75 COL 20.86
     fiItCodigoFim AT ROW 4.75 COL 50.86 NO-LABEL
     IMAGE-1 AT ROW 3.75 COL 41.43
     IMAGE-2 AT ROW 3.75 COL 48
     IMAGE-3 AT ROW 4.75 COL 41.43
     IMAGE-4 AT ROW 4.75 COL 48
     IMAGE-5 AT ROW 2.75 COL 41.43 WIDGET-ID 6
     IMAGE-6 AT ROW 2.75 COL 48 WIDGET-ID 8
...
/* SETTINGS FOR FILL-IN ficod_estabel_ini IN FRAME fPage2
   ALIGN-L                                                              */
/* SETTINGS FOR FILL-IN fiDtFim IN FRAME fPage2
   ALIGN-L                                                              */
/* SETTINGS FOR FILL-IN fiDtIni IN FRAME fPage2
   ALIGN-L                                                              */
...
do on error undo, return error on stop  undo, return error:
    ...
    */
    ...
    DO WITH FRAME fPage2:
        ASSIGN tt-param.da-ini          = INPUT fiDtIni      
               tt-param.da-fim          = INPUT FiDtFim      
               tt-param.c-it-codigo-ini = INPUT FiItCodigoIni
               tt-param.c-it-codigo-fim = INPUT FiItCodigoFim
               tt-param.cod-estabel-ini = INPUT ficod_estabel_ini
    ...
    {report/rprun.i esp\ofp\esofp001rp.p}
