...
*******************************************************************************/
{include/i-prgvrs.i esimp016 2.00.00.000}
...
DEFINE VARIABLE tg-elimina-emb AS LOGICAL INITIAL no 
     LABEL "Elimina embarques vazios" 
     VIEW-AS TOGGLE-BOX
     SIZE 21 BY .83 NO-UNDO.

DEFINE VARIABLE tg-elimina-ped AS LOGICAL INITIAL no 
     LABEL "Elimina pedidos vazios" 
     VIEW-AS TOGGLE-BOX
...
DEFINE FRAME f-pg-sel
     tg-elimina-ped AT ROW 1.75 COL 5 WIDGET-ID 2
     tg-elimina-emb AT ROW 2.5 COL 5 WIDGET-ID 4
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 3 ROW 2.85
         SIZE 76.86 BY 10.62
...
{utp/ut9000.i "esimp016" "2.00.00.000"}
...
------------------------------------------------------------------------------*/
  ...
  DISPLAY tg-elimina-ped tg-elimina-emb 
      WITH FRAME f-pg-sel IN WINDOW w-relat.
  ENABLE tg-elimina-ped tg-elimina-emb 
      WITH FRAME f-pg-sel IN WINDOW w-relat.
...
do on error undo, return error on stop  undo, return error:
    ...
    assign tt-param.usuario         = c-seg-usuario
           ...
           tt-param.l-elimina-ped   = input frame f-pg-sel tg-elimina-ped
           tt-param.l-elimina-emb   = input frame f-pg-sel tg-elimina-emb
           .
    ...
    {include/i-rprun.i esp/imp/esimp016rp.p}
