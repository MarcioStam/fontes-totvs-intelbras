...
*******************************************************************************/
{include/i-prgvrs.i ESIMP015 1.00.00.000}

CREATE WIDGET-POOL.

/* Preprocessors Definitions ---                                      */
&GLOBAL-DEFINE Program        ESIMP015
...
&GLOBAL-DEFINE page4Fields    fi-cotacao fi-cod-estabel
...
DEFINE FRAME fPage4
     fi-cod-estabel AT ROW 2.75 COL 13 COLON-ALIGNED HELP
          "C¢digo do estabelecimento" WIDGET-ID 56
     fi-nome AT ROW 2.75 COL 17.72 COLON-ALIGNED HELP
          "Nome Estabelecimento" NO-LABEL WIDGET-ID 58 NO-TAB-STOP 
     fi-cotacao AT ROW 3.75 COL 13 COLON-ALIGNED WIDGET-ID 50
    WITH 1 DOWN KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 3.57 ROW 2.81
         SIZE 84.43 BY 10.15
...
/*     OVERLAY (tt-param.arquivo,LENGTH(tt-param.arquivo) - 2, 3) = "csv". */
    ...
    {report/rprun.i esp/imp/esimp015rp.p}
