...
&GLOBAL-DEFINE Program        ESIMP007
...
&GLOBAL-DEFINE page2Widgets   fi-fim-it-codigo fi-fim-data fi-ini-it-codigo fi-ini-data
...
DEFINE FRAME fPage2
     fi-ini-it-codigo AT ROW 2.5 COL 35 RIGHT-ALIGNED
     fi-fim-it-codigo AT ROW 2.5 COL 53 COLON-ALIGNED NO-LABEL
     fi-ini-data AT ROW 3.5 COL 29 RIGHT-ALIGNED WIDGET-ID 4
     fi-fim-data AT ROW 3.5 COL 53 COLON-ALIGNED NO-LABEL WIDGET-ID 2
     IMAGE-3 AT ROW 2.5 COL 36.29
     IMAGE-4 AT ROW 2.5 COL 51.72
     IMAGE-35 AT ROW 3.5 COL 36.29 WIDGET-ID 6
     IMAGE-36 AT ROW 3.5 COL 51.72 WIDGET-ID 8
     RECT-18 AT ROW 1.75 COL 4 WIDGET-ID 10
...
do on error undo, return error on stop  undo, return error:
    ...
    {report/rprun.i esp/imp/esimp007rp.p}
