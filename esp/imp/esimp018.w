...
*******************************************************************************/
{include/i-prgvrs.i esimp018 2.00.00.000}
...
&Scoped-define FIELDS-IN-QUERY-br-digita tt-digita.num-pedido tt-digita.numero-ordem tt-digita.parcela tt-digita.dt-entrega tt-digita.dt-chegada   
...
DEFINE VARIABLE EDITOR-2 AS CHARACTER INITIAL "Pedido~;Ordem Compra~;Parcela~;Dt Entrega~;Dt Chegada~;" 
     VIEW-AS EDITOR
...
{utp/ut9000.i "esimp018" "2.00.00.000"}
...
------------------------------------------------------------------------------*/
    ...
    REPEAT:
        ...
        ASSIGN tt-digita.num-pedido   = INT(ENTRY(1, c-linha, ";"))
               ...
               tt-digita.dt-entrega   = DATE(ENTRY(4, c-linha, ";"))
               tt-digita.dt-chegada   = DATE(ENTRY(5, c-linha, ";")).
...
do on error undo, return error on stop  undo, return error:
    ...
    {include/i-rprun.i esp/imp/esimp018rp.p}
