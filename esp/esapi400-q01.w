...
&Scoped-define INTERNAL-TABLES es-agente

/* Definitions for QUERY Query-Main                                     */
&Scoped-define QUERY-STRING-Query-Main FOR EACH es-agente NO-LOCK
&Scoped-define OPEN-QUERY-Query-Main OPEN QUERY Query-Main FOR EACH es-agente NO-LOCK.
&Scoped-define TABLES-IN-QUERY-Query-Main es-agente
&Scoped-define FIRST-TABLE-IN-QUERY-Query-Main es-agente
