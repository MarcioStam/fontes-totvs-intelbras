...
*******************************************************************************/
{include/i-prgvrs.i es0010 1.00.00.000}

CREATE WIDGET-POOL.

/* Preprocessors Definitions ---                                      */
&GLOBAL-DEFINE Program          es0010
...
ttfabricante.nome-abrev ttfabricante.ativo 
...
DEFINE FRAME fPage0
     ...
     btHelp AT ROW 1.13 COL 86.86 HELP
          "Ajuda"
     ttfabricante.cod-fabric AT ROW 2.83 COL 12.72 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 8 BY .79
     ttfabricante.nome-abrev AT ROW 2.83 COL 32.72 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 35 BY .79
     ttfabricante.ativo AT ROW 2.83 COL 73.43 COLON-ALIGNED WIDGET-ID 2
          VIEW-AS FILL-IN 
          SIZE 8.86 BY .79
