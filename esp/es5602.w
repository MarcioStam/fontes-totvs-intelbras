...
{include/i-prgvrs.i es5602 2.00.00.000}
...
DO:
    ...
    FIND FIRST int-cc-benef
        WHERE ROWID(int-cc-benef) = gr-conta-corrente NO-LOCK NO-ERROR.
...
------------------------------------------------------------------------------*/
  ...
  {utp/ut9000.i "ES5602" "2.00.00.000"}
...
------------------------------------------------------------------------------*/
    ...
    FIND FIRST int-cc-benef
         WHERE int-cc-benef.dt-periodo-ini = tt-solicitacao.dt-periodo-ini
         AND   int-cc-benef.dt-periodo-fim = tt-solicitacao.dt-periodo-fim
         AND   int-cc-benef.id-status      = 1
         AND   int-cc-benef.tp-movto       = 2
         AND   int-cc-benef.canal          = tt-solicitacao.cod-emitente
         AND   int-cc-benef.unid-neg       = "ADM"
         AND   int-cc-benef.tipo-beneficio = tt-solicitacao.tipo-beneficio NO-LOCK NO-ERROR. 
...
/*                                                                              */
        ...
        DO WITH FRAME fpage7:
            ...
            ASSIGN fi-periodo-ini:SCREEN-VALUE               = STRING(int-cc-benef.dt-periodo-ini)
                   ...
                   fi-classificacao:SCREEN-VALUE             = int-cc-benef.classificacao
                   ...
                   fi-Finalizada-Stock-Rotation:SCREEN-VALUE = STRING(int-cc-benef.Descarte-Stock-Rotation)
...
------------------------------------------------------------------------------*/
    ...
    FOR EACH int-solicitacao NO-LOCK
        ...
        ,FIRST int-emitente NO-LOCK
            WHERE int-emitente.cod-emit = int-solicitacao.cod-emitente
...
------------------------------------------------------------------------------*/
    ...
    DEF VAR de-pendentes AS DECIMAL NO-UNDO.
     ...
     FOR EACH int-solicitacao NO-LOCK
         WHERE int-solicitacao.cod-emitente                 = p-canal
