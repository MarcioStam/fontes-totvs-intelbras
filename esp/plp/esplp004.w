...
*******************************************************************************/
{include/i-prgvrs.i esplp004 2.00.00.000}
...
DEFINE VARIABLE rs-ativa-desativa AS INTEGER 
     VIEW-AS RADIO-SET HORIZONTAL
     RADIO-BUTTONS 
          "Ativa", 1,
"Desativa", 2
     SIZE 22 BY 1.75 NO-UNDO.
...
DEFINE FRAME f-relat
     ...
     im-pg-sel AT ROW 1.5 COL 2.14 WIDGET-ID 2
...
DEFINE FRAME f-pg-sel
     rs-ativa-desativa AT ROW 2 COL 7 NO-LABEL WIDGET-ID 2
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 3 ROW 2.85
         SIZE 76.86 BY 10.62
...
{utp/ut9000.i "esplp004" "2.00.00.000"}
...
IF AVAIL prog_dtsul AND prog_dtsul.nom_prog_upc = "" THEN
   ASSIGN rs-ativa-desativa = 2.
ELSE 
   ASSIGN rs-ativa-desativa = 1.
...
------------------------------------------------------------------------------*/
  ...
  DISPLAY rs-ativa-desativa 
      WITH FRAME f-pg-sel IN WINDOW w-relat.
  ENABLE rs-ativa-desativa 
      WITH FRAME f-pg-sel IN WINDOW w-relat.
...
do on error undo, return error on stop  undo, return error:
    ...
    assign tt-param.usuario         = c-seg-usuario
           ...
           tt-param.ativa-desativa  = INPUT FRAME f-pg-sel rs-ativa-desativa
           .
    ...
    {include/i-rprun.i esp/plp/esplp004rp.p}
...
IF AVAIL tt-prog-ponto AND
         tt-prog-ponto.conteudo <> "PRODUCAO":U 
THEN DO:
    run utp/ut-msgs.p (input "show", 
                       input 17006 , 
                       input "Programa n∆o pode ser executado em homologaá∆o. " + "~~" + "Na base de homologaá∆o/testes o programa n∆o Ç necess†rio ser executado").   
    
    ASSIGN bt-executar:SENSITIVE IN FRAME f-relat = NO.
END.
