...
&GLOBAL-DEFINE Program        esplp006
...
&GLOBAL-DEFINE page2Fields    c-cod-estabel-ini c-cod-estabel-fim c-it-codigo-ini c-it-codigo-fim 
...
DEFINE VARIABLE c-cod-estabel-fim AS CHARACTER FORMAT "x(16)":U INITIAL "ZZZ" 
     VIEW-AS FILL-IN 
     SIZE 4.43 BY .88
     FONT 1 NO-UNDO.

DEFINE VARIABLE c-cod-estabel-ini AS CHARACTER FORMAT "x(16)":U 
     LABEL "Estab" 
     VIEW-AS FILL-IN 
     SIZE 4.43 BY .88
     FONT 1 NO-UNDO.
...
DEFINE FRAME fPage2
     c-cod-estabel-ini AT ROW 4.13 COL 31.71 HELP
          "C¢digo do Item Inicial" WIDGET-ID 4
     c-cod-estabel-fim AT ROW 4.13 COL 50.57 HELP
          "C¢digo do Item Final" NO-LABEL WIDGET-ID 2
     c-it-codigo-ini AT ROW 5.25 COL 19.28 HELP
          "C¢digo do Item Inicial"
     c-it-codigo-fim AT ROW 5.25 COL 50.57 HELP
          "C¢digo do Item Final" NO-LABEL
     IMAGE-1 AT ROW 5.25 COL 41.29
     IMAGE-2 AT ROW 5.25 COL 47.29
     IMAGE-3 AT ROW 4.13 COL 41.29 WIDGET-ID 6
     IMAGE-4 AT ROW 4.13 COL 47.29 WIDGET-ID 8
...
do on error undo, return error on stop  undo, return error:
    ...
    {report/rprun.i esp/plp/esplp006rp.p}
