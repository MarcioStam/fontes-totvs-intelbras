...
*******************************************************************************/
{include/i-prgvrs.i esplp002 2.00.00.001}  /*** 010001 ***/
/*------------------------------------------------------------------------
...
DEFINE FRAME f-pg-par
     ...
     "Layout Arquivo" VIEW-AS TEXT
          SIZE 18 BY .67 AT ROW 5.5 COL 3 WIDGET-ID 2
     "Estab~;Plano~;Periodo Inicial~;Periodo Final~;Tipo~;Item~;Ano~;Periodo~;Quantidade" VIEW-AS TEXT
          SIZE 70.57 BY .67 AT ROW 6.5 COL 3.43 WIDGET-ID 4
          FGCOLOR 9 
     RECT-8 AT ROW 2.67 COL 2.14
     RECT-10 AT ROW 5.25 COL 2 WIDGET-ID 6
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 3 ROW 3
         SIZE 76.57 BY 10.38.
...
{utp/ut9000.i "ESPLP002" "2.00.00.001"}
...
------------------------------------------------------------------------------*/
  ...
  ENABLE RECT-8 RECT-10 c-arquivo-entrada bt-arquivo-entrada 
      WITH FRAME f-pg-par IN WINDOW C-Win.
...
do  on error undo, return error
    ...
    {include/i-imrun.i esp/plp/esplp002rp.p}
