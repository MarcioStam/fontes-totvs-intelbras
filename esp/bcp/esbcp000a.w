...
*******************************************************************************/
{include/i-prgvrs.i esbcp000a 2.06.00.000}

CREATE WIDGET-POOL.

/* Preprocessors Definitions ---                                      */
&GLOBAL-DEFINE Program        esbcp000a
...
&ANALYZE-RESUME
    WITH NO-ROW-MARKERS SEPARATORS
          &IF '{&WINDOW-SYSTEM}' = 'TTY':U &THEN SIZE 42 BY 10
          &ELSE SIZE-PIXELS 294 BY 240 &ENDIF
...
DEFINE FRAME fpage0
     brTarefas AT Y 10 X 14 WIDGET-ID 200
     bt-sair AT Y 258 X 245 WIDGET-ID 10
