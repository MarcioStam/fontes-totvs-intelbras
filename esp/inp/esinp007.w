...
{include/i-prgvrs.i ESINP007 2.00.00.001}

CREATE WIDGET-POOL.

/* Preprocessors Definitions ---                                      */
&GLOBAL-DEFINE Program        ESINP007
...
&GLOBAL-DEFINE page0Widgets   btOk ~
                              btCancel ~
                              btHelp2
&GLOBAL-DEFINE page2Widgets   c-ncm-ini c-ncm-fim
...
&GLOBAL-DEFINE page2Fields    c-ncm-ini
...
DEFINE FRAME fPage2
     EDITOR-1 AT ROW 1.5 COL 9 NO-LABEL WIDGET-ID 64
     c-ncm-ini AT ROW 8.75 COL 28 COLON-ALIGNED WIDGET-ID 56
     c-ncm-fim AT ROW 8.75 COL 49 COLON-ALIGNED NO-LABEL WIDGET-ID 58
     "Comparar  NCMs/ITENS da base EMS c/ os valores atualizados FISCOSOFT" VIEW-AS TEXT
          SIZE 53 BY .75 AT ROW 7.25 COL 17.29 WIDGET-ID 62
     IMAGE-1 AT ROW 8.75 COL 40.43
     IMAGE-2 AT ROW 8.75 COL 47
     RECT-10 AT ROW 7.63 COL 9 WIDGET-ID 60
...
/* SETTINGS FOR FRAME fPage2
                                                                        */
ASSIGN 
       EDITOR-1:AUTO-INDENT IN FRAME fPage2      = TRUE
...
/*------------------------------------------------------------------------------
  ...
  Notes:       
------------------------------------------------------------------------------*/
    ASSIGN c-ncm-ini:SCREEN-VALUE IN FRAME fpage2 = ""
           c-ncm-ini:SCREEN-VALUE IN FRAME fpage2 = "99999999".
           
    ASSIGN Editor-1:SCREEN-VALUE IN FRAME fpage2 = "O Programa gera um comparativo entre Al¡quotas provenientes da Base Fiscosoft (esinp004), " +
                                                   "comparando os valores com EMS." + CHR(13) + "SerÆo comparados valores de al¡quotas das Classifica‡äes Fiscais e Itens do EMS."  + CHR(13) +
                                                   "OBS: Quando o parƒmetro 'IPI Diferenciado' no CD0903 estiver marcado, nÆo ser  feita nenhuma compara‡Æo entre as Bases.".
...
do on error undo, return error on stop  undo, return error:
    ...
    IF  INPUT FRAME fpage2 c-ncm-ini > INPUT FRAME fpage2 c-ncm-fim THEN DO:
        run utp/ut-msgs.p (input "SHOW":U, input 17006, input "NCM Final deve ser maior que a Inicial.":U).
        apply "ENTRY":U to c-ncm-ini.
    ...
    DO WITH FRAME fPage2:
        ASSIGN tt-param.c-ncm-ini   = INPUT c-ncm-ini
               tt-param.c-ncm-fim   = INPUT c-ncm-fim .
    ...
    {report/rprun.i esp/inp/esinp007rp.p}
