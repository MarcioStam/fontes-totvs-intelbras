...
*******************************************************************************/
{include/i-prgvrs.i ESCEP065 2.00.00.000}

CREATE WIDGET-POOL.

/* Preprocessors Definitions ---                                      */
&GLOBAL-DEFINE Program        ESCEP065
...
&GLOBAL-DEFINE page0Widgets   btOk ~
                              btCancel ~
                              btHelp2
&GLOBAL-DEFINE page4Widgets   fi-cod-estabel fi-cod-depos btInputFile
&GLOBAL-DEFINE page6Widgets   rsDestiny ~
                              btConfigImpr ~
                              btFile ~
                              rsExecution
&GLOBAL-DEFINE page0Text      
&GLOBAL-DEFINE page4Text      text-saida
...
DEFINE FRAME fPage4
     fi-cod-estabel AT ROW 2 COL 37 COLON-ALIGNED WIDGET-ID 2
     fi-cod-depos AT ROW 3 COL 37 COLON-ALIGNED WIDGET-ID 4
     cInputFile AT ROW 6.29 COL 21.14 HELP
          "Nome do arquivo de destino do relat¢rio" NO-LABEL
     btInputFile AT ROW 6.29 COL 61.14 HELP
          "Escolha do nome do arquivo"
     text-saida AT ROW 5.25 COL 22.14 NO-LABEL
     RECT-12 AT ROW 5.5 COL 20
    WITH 1 DOWN KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 3.57 ROW 2.81
         SIZE 84.43 BY 10.15
...
/* SETTINGS FOR FRAME fPage4
                                                                        */
/* SETTINGS FOR FILL-IN text-saida IN FRAME fPage4
   NO-DISPLAY NO-ENABLE ALIGN-L                                         */
ASSIGN 
       text-saida:PRIVATE-DATA IN FRAME fPage4     = 
                "Arquivo de Sa°da".
...
do on error undo, return error on stop  undo, return error:
    ...
    assign tt-param.usuario         = c-seg-usuario
           ...
           tt-param.arq-csv         = INPUT FRAME fPage4 cInputFile
           .
    ...
    {report/rprun.i esp/cep/escep065rp.p}
