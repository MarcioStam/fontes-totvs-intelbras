...
define temp-table tt-digita LIKE int-param-calc-crit
    FIELD l-selected AS LOGICAL FORMAT "*/" INITIAL YES
...
&Scoped-define FIELDS-IN-QUERY-br-calc tt-digita.l-selected tt-digita.cd-plano tt-digita.cod-estabel tt-digita.item-inicial tt-digita.item-final   
&Scoped-define ENABLED-FIELDS-IN-QUERY-br-calc   
&Scoped-define SELF-NAME br-calc
&Scoped-define QUERY-STRING-br-calc FOR EACH tt-digita NO-LOCK INDEXED-REPOSITION
&Scoped-define OPEN-QUERY-br-calc OPEN QUERY {&SELF-NAME} FOR EACH tt-digita NO-LOCK INDEXED-REPOSITION.
&Scoped-define TABLES-IN-QUERY-br-calc tt-digita
&Scoped-define FIRST-TABLE-IN-QUERY-br-calc tt-digita
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br-calc w-relat _FREEFORM
  QUERY br-calc NO-LOCK DISPLAY
      tt-digita.l-selected  COLUMN-LABEL "*"
    tt-digita.cd-plano    COLUMN-LABEL "Plano"
    tt-digita.cod-estabel COLUMN-LABEL "Estab"
    tt-digita.item-inicial
    tt-digita.item-final
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ROW-MARKERS SEPARATORS SIZE 39.14 BY 8.5
         TITLE "C lculo Criticidade" FIT-LAST-COLUMN.
...
DEFINE FRAME f-pg-sel
     br-calc AT ROW 1.75 COL 18.57 WIDGET-ID 200
     bt-todos AT ROW 10.33 COL 18.43 WIDGET-ID 4
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 3 ROW 2.85
...
/* Query rebuild information for BROWSE br-calc
     _START_FREEFORM
OPEN QUERY {&SELF-NAME} FOR EACH tt-digita NO-LOCK INDEXED-REPOSITION.
     _END_FREEFORM
...
&Scoped-define SELF-NAME br-calc
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL br-calc w-relat
ON MOUSE-SELECT-DBLCLICK OF br-calc IN FRAME f-pg-sel /* C lculo Criticidade */
DO:
  ASSIGN tt-digita.l-selected = NOT tt-digita.l-selected.
  DISPLAY tt-digita.l-selected WITH BROWSE br-calc .
END.
...
ON CHOOSE OF bt-todos IN FRAME f-pg-sel /* Todos */
DO:
  IF bt-todos:LABEL IN FRAME f-pg-sel = "Nenhum" THEN DO:
      FOR EACH tt-digita:
          ASSIGN tt-digita.l-selected = NO.
      END.

      ASSIGN bt-todos:LABEL IN FRAME f-pg-sel = "Todos".
  END.
  ELSE DO:
      FOR EACH tt-digita:
          ASSIGN tt-digita.l-selected = YES.
      END.
      ASSIGN bt-todos:LABEL IN FRAME f-pg-sel = "Nenhum".
  END.
...
{utp/ut9000.i "ESCEP082" "2.00.00.000"}
...
FOR EACH int-param-calc-crit NO-LOCK:
    CREATE tt-digita.
    BUFFER-COPY int-param-calc-crit TO tt-digita.
END.
...
do on error undo, return error on stop  undo, return error:
   ...
   END.
    ...
    {include/i-rprun.i esp/cep/escep082rp.p}
