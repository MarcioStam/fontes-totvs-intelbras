...
*******************************************************************************/
{include/i-prgvrs.i ESCEP002A 2.04.00.000}

CREATE WIDGET-POOL.

{esp/cep/escep002tt.i}

DEF INPUT PARAM TABLE FOR tt-saldos.

/* Preprocessors Definitions ---                                      */
&GLOBAL-DEFINE Program        ESCEP002A
&GLOBAL-DEFINE Version        1
&GLOBAL-DEFINE VersionLayout  1

&GLOBAL-DEFINE Folder         YES
&GLOBAL-DEFINE InitialPage    1
&GLOBAL-DEFINE FolderLabels   ImpressÆo
...
EMPTY TEMP-TABLE tt-valor.

FOR EACH tt-saldos:
    CREATE tt-valor.
    ASSIGN tt-valor.it-codigo      = tt-saldos.it-codigo
           tt-valor.desc-item      = tt-saldos.desc-item
           tt-valor.un             = tt-saldos.un
           tt-valor.cod-comprado   = tt-saldos.cod-comprado
           tt-valor.nome-comprado  = tt-saldos.nome-comprado
           tt-valor.nome-abrev     = tt-saldos.nome-fornec
           tt-valor.saldo-atu      = tt-saldos.de-saldo-atu
           tt-valor.depos          = tt-saldos.depos
           tt-valor.local          = tt-saldos.local
           tt-valor.quantidade     = tt-saldos.quantidade
           tt-valor.soma           = tt-saldos.soma.
END.
...
do on error undo, return error on stop  undo, return error:
    ...
    FOR EACH tt-digita:
        MESSAGE "tem valor" tt-digita.it-codigo
            VIEW-AS ALERT-BOX INFO BUTTONS OK.
    END.
    
    {report/rprun.i esp/cep/escep002rp.p}
