...
&Scoped-Define ENABLED-OBJECTS im-pg-lay im-pg-sel im-pg-log bt-executar ~
...
DEFINE VARIABLE rs-tabela AS INTEGER INITIAL 1 
     VIEW-AS RADIO-SET VERTICAL
     RADIO-BUTTONS 
          "Cadastro do Item", 1,
"Previs∆o de Vendas", 2
     SIZE 43 BY 2.5 NO-UNDO.
...
DEFINE FRAME f-pg-sel
     rs-tipo AT ROW 2 COL 5 NO-LABEL WIDGET-ID 2
     rs-tabela AT ROW 2 COL 29 NO-LABEL WIDGET-ID 18
     c-arquivo-entrada AT ROW 9.88 COL 4.29 HELP
          "Nome do arquivo de destino do relat¢rio" NO-LABEL WIDGET-ID 8
     bt-arquivo-entrada AT ROW 9.88 COL 70 HELP
          "Escolha do nome do arquivo" WIDGET-ID 6
     text-entrada AT ROW 8.83 COL 5.14 NO-LABEL WIDGET-ID 12
     RECT-10 AT ROW 9.17 COL 3 WIDGET-ID 10
     RECT-13 AT ROW 1.25 COL 3 WIDGET-ID 16
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 3 ROW 2.85
...
/* SETTINGS FOR FRAME f-import
   FRAME-NAME                                                           */
ASSIGN 
       im-pg-sel:HIDDEN IN FRAME f-import           = TRUE.
...
DO:
    ...
    assign c-arq-conv = replace(input frame f-pg-sel c-arquivo-entrada, "/", "~\").
...
&Scoped-define FRAME-NAME f-pg-sel
&Scoped-define SELF-NAME rs-tabela
...
{utp/ut9000.i "escep087b" "3.00.00.000"}
...
DO  ON ERROR   UNDO MAIN-BLOCK, LEAVE MAIN-BLOCK
    ...
    {include/i-imvrf.i &programa=escep087b &versao-layout=001}
  
    APPLY "value-changed" TO rs-tipo IN FRAME f-pg-sel.
...
------------------------------------------------------------------------------*/
  ENABLE im-pg-lay im-pg-sel im-pg-log bt-executar bt-cancelar bt-ajuda 
      WITH FRAME f-import IN WINDOW C-Win.
  {&OPEN-BROWSERS-IN-QUERY-f-import}
  DISPLAY rs-tipo rs-tabela c-arquivo-entrada 
      WITH FRAME f-pg-sel IN WINDOW C-Win.
  ENABLE RECT-10 RECT-13 rs-tipo rs-tabela c-arquivo-entrada bt-arquivo-entrada 
      WITH FRAME f-pg-sel IN WINDOW C-Win.
...
do  on error undo, return error
    ...
    assign file-info:file-name = input frame f-pg-sel c-arquivo-entrada.
    if  input frame f-pg-sel rs-tipo = 2
    AND file-info:pathname = ? and
       input frame f-pg-log rs-execucao = 1 then do:
        run utp/ut-msgs.p (input "show":U,
                           input 326,
                           input c-arquivo-entrada).                               
        apply 'mouse-select-click':U to im-pg-sel in frame f-import.
        apply 'entry':U to c-arquivo-entrada in frame f-pg-sel.                
        return error.
    end. 
    ...
    assign tt-param.usuario         = c-seg-usuario
           ...
           tt-param.arq-entrada     = input frame f-pg-sel c-arquivo-entrada
           tt-param.rs-tipo         = input frame f-pg-sel rs-tipo
           tt-param.rs-tabela       = input frame f-pg-sel rs-tabela
    ...
    {include/i-imrun.i esp/cep/escep087brp.p}
