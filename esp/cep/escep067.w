...
*******************************************************************************/
{include/i-prgvrs.i ESCEP067 1.00.00.000}

CREATE WIDGET-POOL.

/* Preprocessors Definitions ---                                      */
&GLOBAL-DEFINE Program        ESCEP067
...
DEFINE FRAME fPage2
     ed-texto AT ROW 3.25 COL 16 NO-LABEL WIDGET-ID 4
    WITH 1 DOWN KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 3.57 ROW 2.81
         SIZE 84.43 BY 10.15
...
/* SETTINGS FOR FRAME fPage2
                                                                        */
ASSIGN 
       ed-texto:READ-ONLY IN FRAME fPage2        = TRUE.
...
DO WITH FRAME fPage2:
    ...
    ASSIGN ed-texto:SCREEN-VALUE = 'Este programa ir† rodar a Atualizaá∆o do programa de Regras ESCEP066,' + CHR(10) + 
                                   'no qual Ç alimentado a informaá∆o "Necessita Inspeá∆o na Origem" para' + CHR(10) + 
                                   'os respectivos itens/estabelecimentos/fabricantes, conforme regras' + CHR(10) +
                                   'criadas no programa ESCEP066.'.
...
do on error undo, return error on stop  undo, return error:
    ...
    {report/rprun.i esp/cep/escep067rp.p}
