...
*******************************************************************************/
{include/i-prgvrs.i ESCEP090 9.99.99.999}
...
&IF "{&EMSFND_VERSION}" >= "1.00" &THEN
    {include/i-license-manager.i ESCEP090 esp}
&ENDIF
...
DEFINE VARIABLE c-it-codigo-ate AS CHARACTER FORMAT "X(16)":U INITIAL "ZZZZZZZZZZZZZZZZ" 
     VIEW-AS FILL-IN 
     SIZE 12.14 BY .88 NO-UNDO.

DEFINE VARIABLE c-it-codigo-de AS CHARACTER FORMAT "X(16)":U 
     LABEL "Item" 
     VIEW-AS FILL-IN 
     SIZE 12.14 BY .88 NO-UNDO.

DEFINE VARIABLE dt-fim AS DATE FORMAT "99/99/9999":U INITIAL 12/31/9999 
     VIEW-AS FILL-IN 
...
DEFINE FRAME f-pg-imp
     ...
     bt-modelo-rtf AT ROW 6.96 COL 44.86 HELP
          "Escolha do nome do arquivo"
...
DEFINE FRAME f-pg-sel
     c-cod-estabel-de AT ROW 5.21 COL 26.86 COLON-ALIGNED WIDGET-ID 2
     c-cod-estabel-ate AT ROW 5.21 COL 45 COLON-ALIGNED NO-LABEL WIDGET-ID 8
     c-it-codigo-de AT ROW 6.21 COL 21.86 COLON-ALIGNED WIDGET-ID 28
     c-it-codigo-ate AT ROW 6.21 COL 45 COLON-ALIGNED NO-LABEL WIDGET-ID 26
     dt-ini AT ROW 7.21 COL 21 COLON-ALIGNED WIDGET-ID 36
     dt-fim AT ROW 7.21 COL 45 COLON-ALIGNED NO-LABEL WIDGET-ID 34
     IMAGE-1 AT ROW 5.25 COL 36.72 WIDGET-ID 4
     IMAGE-2 AT ROW 5.25 COL 43.43 WIDGET-ID 6
     IMAGE-19 AT ROW 6.25 COL 36.72 WIDGET-ID 30
     IMAGE-20 AT ROW 6.25 COL 43.43 WIDGET-ID 32
     IMAGE-21 AT ROW 7.25 COL 36.72 WIDGET-ID 38
     IMAGE-22 AT ROW 7.25 COL 43.43 WIDGET-ID 40
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW w-relat ASSIGN
         HIDDEN             = YES
         TITLE              = "Faturamento APS - ESCEP090"
         HEIGHT             = 16.29
         WIDTH              = 83.29
         MAX-HEIGHT         = 27.88
         MAX-WIDTH          = 195.14
...
ON END-ERROR OF w-relat /* Faturamento APS - ESCEP090 */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL w-relat w-relat
ON WINDOW-CLOSE OF w-relat /* Faturamento APS - ESCEP090 */
DO:
...
{utp/ut9000.i "ESCEP090" "9.99.99.999"}
...
------------------------------------------------------------------------------*/
  ...
  DISPLAY c-cod-estabel-de c-cod-estabel-ate c-it-codigo-de c-it-codigo-ate 
          dt-ini dt-fim 
      WITH FRAME f-pg-sel IN WINDOW w-relat.
  ENABLE IMAGE-1 IMAGE-2 IMAGE-19 IMAGE-20 IMAGE-21 IMAGE-22 c-cod-estabel-de 
         c-cod-estabel-ate c-it-codigo-de c-it-codigo-ate dt-ini dt-fim 
      WITH FRAME f-pg-sel IN WINDOW w-relat.
...
do on error undo, return error on stop  undo, return error:
   ...
   /*:T Coloque aqui as validaá‰es das outras p†ginas, lembrando que elas devem 
    ...
    assign tt-param.usuario              = c-seg-usuario
           ...
           tt-param.it-codigo-de         = INPUT FRAME f-pg-sel c-it-codigo-de
           tt-param.it-codigo-ate        = INPUT FRAME f-pg-sel c-it-codigo-ate
           tt-param.dt-de                = INPUT FRAME f-pg-sel dt-ini
           tt-param.dt-ate                = INPUT FRAME f-pg-sel dt-fim
    ...
    {include/i-rprun.i esp/cep/escep090rp.p}
