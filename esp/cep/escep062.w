...
*******************************************************************************/
{include/i-prgvrs.i ESCEP062 2.00.00.001}

CREATE WIDGET-POOL.

/* Preprocessors Definitions ---                                      */
&GLOBAL-DEFINE Program        ESCEP062
...
&GLOBAL-DEFINE page0Widgets   btOk ~
                              btCancel ~
                              btHelp2
&GLOBAL-DEFINE page2Widgets   btInputFile
...
------------------------------------------------------------------------------*/
    ...
    ASSIGN ed-layout = "**** Altera Situaá∆o Item/Item x Estabelecimento ****" + CHR(13) +
                       "Layout do Arquivo: C¢d Item;C¢d Situaá∆o;Motivo Situaá∆o" + CHR(13) +
                       "4000010;2;1" + CHR(13) +
                       "1000039;4;0" + CHR(13) + CHR(13) +
                       "C¢digos da Situaá∆o: " + CHR(13) +
                       "1- Ativo" + CHR(13) +
                       "2- Obsoleto Ordens Autom†ticas" + CHR(13) +
                       "3- Obsoleto Todas as Ordens" + CHR(13) +
                       "4- Totalmente Obsoleto" + CHR(13) + CHR(13) +
                       "Motivos da Situaá∆o: " + CHR(13) +
                       "1- Alteraá∆o de estrutura" + CHR(13) +
                       "2- Phase out produto".
...
DO ON ERROR UNDO, RETURN ERROR ON STOP  UNDO, RETURN ERROR:
    ...
    IF  INPUT FRAME fPage2 cInputFile = "" THEN DO:
        RUN utp/ut-msgs.p (INPUT "show":U, INPUT 17006, INPUT "Arquivo de importaá∆o n∆o foi informado!":U).

        APPLY "ENTRY":U TO cInputFile IN FRAME fPage2.
        RETURN ERROR.
    END.
    ...
    ASSIGN tt-param.usuario        = c-seg-usuario
           ...
           tt-param.arquivo-import = INPUT FRAME fPage2 cInputFile.
    ...
    {report/rprun.i esp/cep/escep062rp.p}
