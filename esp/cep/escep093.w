...
*******************************************************************************/
{include/i-prgvrs.i ESCEP093 1.00.00.000}
...
&IF "{&EMSFND_VERSION}" >= "1.00" &THEN
    {include/i-license-manager.i ESCEP093 ESP}
&ENDIF
...
DEFINE VARIABLE rs-classif AS INTEGER 
     ...
     RADIO-BUTTONS 
          "Por Classifica‡Æo 1", 1,
"Por Classifica‡Æo 2", 2,
"Por Classifica‡Æo 3", 3,
"Por Classifica‡Æo 4", 4
...
DEFINE VARIABLE fi-log-bloq-prod AS CHARACTER FORMAT "X(20)":U INITIAL "Bloqueado Produ‡Æo:" 
      VIEW-AS TEXT 
     SIZE 15 BY .88 NO-UNDO.

DEFINE VARIABLE fi-log-comp-spot AS CHARACTER FORMAT "X(20)":U INITIAL "Permite Compra Spot:" 
      VIEW-AS TEXT 
     SIZE 15 BY .88 NO-UNDO.

DEFINE VARIABLE fi-log-item-rest AS CHARACTER FORMAT "X(20)":U INITIAL "Item Restritivo:" 
      VIEW-AS TEXT 
     SIZE 10.57 BY .88 NO-UNDO.

DEFINE VARIABLE fi-log-mod-aereo AS CHARACTER FORMAT "X(20)":U INITIAL "Permite Modal A‚reo:" 
      VIEW-AS TEXT 
     SIZE 15 BY .88 NO-UNDO.

DEFINE VARIABLE fi-log-phase-in AS CHARACTER FORMAT "X(20)":U INITIAL "Item Phase-in:" 
      VIEW-AS TEXT 
     SIZE 10 BY .88 NO-UNDO.

DEFINE VARIABLE fi-log-phase-out AS CHARACTER FORMAT "X(20)":U INITIAL "Item Phase-out:" 
      VIEW-AS TEXT 
     SIZE 11 BY .88 NO-UNDO.

DEFINE VARIABLE fi-log-requer-aval AS CHARACTER FORMAT "X(20)":U INITIAL "Requer Avalia‡Æo:" 
      VIEW-AS TEXT 
     SIZE 13 BY .88 NO-UNDO.

DEFINE VARIABLE rs-bloq-prod AS INTEGER INITIAL 3 
     VIEW-AS RADIO-SET HORIZONTAL
     RADIO-BUTTONS 
          "Sim", 1,
"NÆo", 2,
"Ambos", 3
     SIZE 27 BY .88 TOOLTIP "Bloqueado Produ‡Æo" NO-UNDO.

DEFINE VARIABLE rs-comp-spot AS INTEGER INITIAL 3 
     VIEW-AS RADIO-SET HORIZONTAL
     RADIO-BUTTONS 
          "Sim", 1,
"NÆo", 2,
"Ambos", 3
     SIZE 27 BY .88 TOOLTIP "Permite Compra Spot" NO-UNDO.

DEFINE VARIABLE rs-item-rest AS INTEGER INITIAL 3 
     VIEW-AS RADIO-SET HORIZONTAL
     RADIO-BUTTONS 
          "Sim", 1,
"NÆo", 2,
"Ambos", 3
     SIZE 27 BY .88 TOOLTIP "Item Restritivo" NO-UNDO.

DEFINE VARIABLE rs-mod-aereo AS INTEGER INITIAL 3 
     VIEW-AS RADIO-SET HORIZONTAL
     RADIO-BUTTONS 
          "Sim", 1,
"NÆo", 2,
"Ambos", 3
     SIZE 27 BY .88 TOOLTIP "Permite Modal A‚reo" NO-UNDO.

DEFINE VARIABLE rs-phase-in AS INTEGER INITIAL 3 
     VIEW-AS RADIO-SET HORIZONTAL
     RADIO-BUTTONS 
          "Sim", 1,
"NÆo", 2,
"Ambos", 3
     SIZE 27 BY .88 TOOLTIP "Item Phase-in" NO-UNDO.

DEFINE VARIABLE rs-phase-out AS INTEGER INITIAL 3 
     VIEW-AS RADIO-SET HORIZONTAL
     RADIO-BUTTONS 
          "Sim", 1,
"NÆo", 2,
"Ambos", 3
     SIZE 27 BY .88 TOOLTIP "Item Phase-out" NO-UNDO.

DEFINE VARIABLE rs-requer-aval AS INTEGER INITIAL 3 
     VIEW-AS RADIO-SET HORIZONTAL
     RADIO-BUTTONS 
          "Sim", 1,
"NÆo", 2,
"Ambos", 3
     SIZE 27 BY .88 TOOLTIP "Requer Avalia‡Æo" NO-UNDO.
...
DEFINE VARIABLE fi-cod-estabel-fim AS CHARACTER FORMAT "X(5)":U INITIAL "ZZZZZ" 
     VIEW-AS FILL-IN 
...
DEFINE VARIABLE fi-cod-modelo-fim AS CHARACTER FORMAT "X(16)":U INITIAL "ZZZZZZZZZZZZZZZZ" 
     VIEW-AS FILL-IN 
     SIZE 17 BY .88 NO-UNDO.

DEFINE VARIABLE fi-cod-modelo-ini AS CHARACTER FORMAT "X(16)":U 
     LABEL "Modelo" 
     VIEW-AS FILL-IN 
     SIZE 17 BY .88 NO-UNDO.
...
DEFINE FRAME f-pg-sel
     fi-cod-estabel-ini AT ROW 2 COL 27 COLON-ALIGNED HELP
          "Estabelecimento inicial" WIDGET-ID 12
     fi-cod-estabel-fim AT ROW 2 COL 42 COLON-ALIGNED HELP
          "Estabelecimento final" NO-LABEL WIDGET-ID 10
     fi-it-codigo-ini AT ROW 3 COL 16 COLON-ALIGNED HELP
          "Item inicial" WIDGET-ID 4
     fi-it-codigo-fim AT ROW 3 COL 42 COLON-ALIGNED HELP
          "Item final" NO-LABEL WIDGET-ID 2
     fi-cod-modelo-ini AT ROW 4 COL 16 COLON-ALIGNED HELP
          "Modelo inicial" WIDGET-ID 20
     fi-cod-modelo-fim AT ROW 4 COL 42 COLON-ALIGNED HELP
          "Modelo final" NO-LABEL WIDGET-ID 18
     cb-obsoleto-ini AT ROW 5 COL 9 COLON-ALIGNED WIDGET-ID 36
     cb-obsoleto-fim AT ROW 5 COL 41.86 COLON-ALIGNED NO-LABEL WIDGET-ID 38
     IMAGE-3 AT ROW 3 COL 35.14 WIDGET-ID 6
     IMAGE-4 AT ROW 3 COL 41 WIDGET-ID 8
     IMAGE-9 AT ROW 2 COL 35.14 WIDGET-ID 14
     IMAGE-10 AT ROW 2 COL 41 WIDGET-ID 16
     IMAGE-11 AT ROW 4 COL 35.14 WIDGET-ID 22
     IMAGE-12 AT ROW 4 COL 41 WIDGET-ID 24
     IMAGE-13 AT ROW 5 COL 35.14 WIDGET-ID 30
     IMAGE-14 AT ROW 5 COL 41 WIDGET-ID 32
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
...
DEFINE FRAME f-pg-par
     rs-comp-spot AT ROW 2.33 COL 24 NO-LABEL WIDGET-ID 98
     rs-mod-aereo AT ROW 3.33 COL 24 NO-LABEL WIDGET-ID 64
     rs-phase-in AT ROW 4.33 COL 24 NO-LABEL WIDGET-ID 70
     rs-phase-out AT ROW 5.33 COL 24 NO-LABEL WIDGET-ID 76
     rs-item-rest AT ROW 6.33 COL 24 NO-LABEL WIDGET-ID 82
     rs-bloq-prod AT ROW 7.33 COL 24 NO-LABEL WIDGET-ID 88
     rs-requer-aval AT ROW 8.33 COL 24 NO-LABEL WIDGET-ID 94
     fi-log-comp-spot AT ROW 2.33 COL 22 RIGHT-ALIGNED NO-LABEL WIDGET-ID 60
     fi-log-mod-aereo AT ROW 3.33 COL 22 RIGHT-ALIGNED NO-LABEL WIDGET-ID 62
     fi-log-phase-in AT ROW 4.33 COL 22 RIGHT-ALIGNED NO-LABEL WIDGET-ID 68
     fi-log-phase-out AT ROW 5.33 COL 22 RIGHT-ALIGNED NO-LABEL WIDGET-ID 74
     fi-log-item-rest AT ROW 6.33 COL 22.14 RIGHT-ALIGNED NO-LABEL WIDGET-ID 80
     fi-log-bloq-prod AT ROW 7.33 COL 22 RIGHT-ALIGNED NO-LABEL WIDGET-ID 86
     fi-log-requer-aval AT ROW 8.33 COL 22 RIGHT-ALIGNED NO-LABEL WIDGET-ID 92
     "APS" VIEW-AS TEXT
          SIZE 3.86 BY .54 AT ROW 1.5 COL 7.14 WIDGET-ID 54
     RECT-12 AT ROW 1.75 COL 3 WIDGET-ID 52
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 3 ROW 3
         SIZE 75 BY 10
...
/* SETTINGS FOR FRAME f-pg-par
   L-To-R                                                               */
/* SETTINGS FOR FILL-IN fi-log-bloq-prod IN FRAME f-pg-par
   ALIGN-R                                                              */
/* SETTINGS FOR FILL-IN fi-log-comp-spot IN FRAME f-pg-par
   ALIGN-R                                                              */
/* SETTINGS FOR FILL-IN fi-log-item-rest IN FRAME f-pg-par
   ALIGN-R                                                              */
/* SETTINGS FOR FILL-IN fi-log-mod-aereo IN FRAME f-pg-par
   ALIGN-R                                                              */
/* SETTINGS FOR FILL-IN fi-log-phase-in IN FRAME f-pg-par
   ALIGN-R                                                              */
/* SETTINGS FOR FILL-IN fi-log-phase-out IN FRAME f-pg-par
   ALIGN-R                                                              */
/* SETTINGS FOR FILL-IN fi-log-requer-aval IN FRAME f-pg-par
   ALIGN-R                                                              */
...
ON END-ERROR OF w-relat /* Exporta‡Æo de Dados APS */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL w-relat w-relat
ON WINDOW-CLOSE OF w-relat /* Exporta‡Æo de Dados APS */
DO:
...
{utp/ut9000.i "ESCEP093" "1.00.00.000"}
...
------------------------------------------------------------------------------*/
  ...
  DISPLAY fi-cod-estabel-ini fi-cod-estabel-fim fi-it-codigo-ini 
          fi-it-codigo-fim fi-cod-modelo-ini fi-cod-modelo-fim cb-obsoleto-ini 
          cb-obsoleto-fim 
      WITH FRAME f-pg-sel IN WINDOW w-relat.
  ENABLE IMAGE-3 IMAGE-4 IMAGE-9 IMAGE-10 IMAGE-11 IMAGE-12 IMAGE-13 IMAGE-14 
         fi-cod-estabel-ini fi-cod-estabel-fim fi-it-codigo-ini 
         fi-it-codigo-fim fi-cod-modelo-ini fi-cod-modelo-fim cb-obsoleto-ini 
         cb-obsoleto-fim 
      WITH FRAME f-pg-sel IN WINDOW w-relat.
  ...
  DISPLAY rs-comp-spot rs-mod-aereo rs-phase-in rs-phase-out rs-item-rest 
          rs-bloq-prod rs-requer-aval fi-log-comp-spot fi-log-mod-aereo 
          fi-log-phase-in fi-log-phase-out fi-log-item-rest fi-log-bloq-prod 
          fi-log-requer-aval 
      WITH FRAME f-pg-par IN WINDOW w-relat.
  ENABLE RECT-12 rs-comp-spot rs-mod-aereo rs-phase-in rs-phase-out 
         rs-item-rest rs-bloq-prod rs-requer-aval fi-log-comp-spot 
         fi-log-mod-aereo fi-log-phase-in fi-log-phase-out fi-log-item-rest 
         fi-log-bloq-prod fi-log-requer-aval 
      WITH FRAME f-pg-par IN WINDOW w-relat.
...
do on error undo, return error on stop  undo, return error:
    ...
    if input frame f-pg-sel fi-cod-estabel-ini > input frame f-pg-sel fi-cod-estabel-fim
    then do:
         ...
         apply 'entry' to fi-cod-estabel-ini in frame f-pg-sel.
         return 'ADM-ERROR'.
    end.
    ...
    if input frame f-pg-sel fi-cod-modelo-ini > input frame f-pg-sel fi-cod-modelo-fim
    then do:
         apply "MOUSE-SELECT-CLICK":U to im-pg-sel in frame f-relat.
         run utp/ut-msgs.p (input "show", input 17567, input "Modelo inicial maior que final!").
         apply 'entry' to fi-cod-modelo-ini in frame f-pg-sel.
         return 'ADM-ERROR'.
    end.

    if input frame f-pg-sel cb-obsoleto-ini > input frame f-pg-sel cb-obsoleto-fim
    then do:
         apply "MOUSE-SELECT-CLICK":U to im-pg-sel in frame f-relat.
         run utp/ut-msgs.p (input "show", input 17567, input "Situa‡Æo inicial maior que final!").
         apply 'entry' to cb-obsoleto-ini in frame f-pg-sel.
         return 'ADM-ERROR'.
    end.
    ...
    do with frame f-pg-sel:
        assign tt-param.cod-estabel-ini  = input fi-cod-estabel-ini
               tt-param.cod-estabel-fim  = input fi-cod-estabel-fim
               tt-param.it-codigo-ini    = input fi-it-codigo-ini   
               tt-param.it-codigo-fim    = input fi-it-codigo-fim
               tt-param.cod-modelo-ini   = input fi-cod-modelo-ini   
               tt-param.cod-modelo-fim   = input fi-cod-modelo-fim
               tt-param.cod-obsoleto-ini = input cb-obsoleto-ini   
               tt-param.cod-obsoleto-fim = input cb-obsoleto-fim.
    end.

    do with frame f-pg-par:
         assign tt-param.comp-spot   = input rs-comp-spot  
                tt-param.mod-aereo   = input rs-mod-aereo  
                tt-param.phase-in    = input rs-phase-in   
                tt-param.phase-out   = input rs-phase-out  
                tt-param.item-rest   = input rs-item-rest  
                tt-param.bloq-prod   = input rs-bloq-prod  
                tt-param.requer-aval = input rs-requer-aval.
    end.
    ...
    {include/i-rprun.i esp/cep/escep093rp.p}
