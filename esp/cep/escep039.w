...
*******************************************************************************/
{include/i-prgvrs.i escep039 1.00.00.000}

CREATE WIDGET-POOL.

/* Preprocessors Definitions ---                                      */
&GLOBAL-DEFINE Program        escep039
...
&GLOBAL-DEFINE page2Fields    cEstini cEstfim cOperini cOperfim cDtini cDtfim fi-estab-ini fi-estab-fim
...
DEFINE VARIABLE cDtfim AS DATE FORMAT "99/99/9999":U 
     VIEW-AS FILL-IN 
     SIZE 9.86 BY .88
     FONT 1 NO-UNDO.

DEFINE VARIABLE cDtini AS DATE FORMAT "99/99/9999":U 
     LABEL "Data Emiss∆o" 
     VIEW-AS FILL-IN 
     SIZE 9.86 BY .88
     FONT 1 NO-UNDO.

DEFINE VARIABLE cEstfim AS CHARACTER FORMAT "X(2)":U INITIAL "ZZ" 
     VIEW-AS FILL-IN 
     SIZE 4.86 BY .88
     FONT 1 NO-UNDO.

DEFINE VARIABLE cEstini AS CHARACTER FORMAT "X(2)":U 
     LABEL "Estado" 
     VIEW-AS FILL-IN 
     SIZE 5 BY .88
     FONT 1 NO-UNDO.

DEFINE VARIABLE cOperfim AS CHARACTER FORMAT "X(6)":U INITIAL "999999" 
     VIEW-AS FILL-IN 
     SIZE 6.86 BY .88
     FONT 1 NO-UNDO.

DEFINE VARIABLE cOperini AS CHARACTER FORMAT "X(6)":U 
     LABEL "Nat Operaá∆o" 
     VIEW-AS FILL-IN 
     SIZE 7 BY .88
     FONT 1 NO-UNDO.
...
DEFINE FRAME fpage2
     fi-estab-ini AT ROW 1.5 COL 21.28 WIDGET-ID 26
     fi-estab-fim AT ROW 1.5 COL 54 NO-LABEL WIDGET-ID 24
     cEstini AT ROW 2.5 COL 20.43
     cEstfim AT ROW 2.5 COL 54.14 NO-LABEL
     cOperini AT ROW 3.5 COL 13.57 WIDGET-ID 10
     cOperfim AT ROW 3.5 COL 54.14 NO-LABEL WIDGET-ID 8
     cDtini AT ROW 4.5 COL 10.86 WIDGET-ID 18
     cDtfim AT ROW 4.5 COL 54.14 NO-LABEL WIDGET-ID 16
     IMAGE-1 AT ROW 2.5 COL 31
     IMAGE-2 AT ROW 2.5 COL 51.14
     IMAGE-7 AT ROW 3.5 COL 31 WIDGET-ID 12
     IMAGE-8 AT ROW 3.5 COL 51.14 WIDGET-ID 14
     IMAGE-9 AT ROW 4.5 COL 31 WIDGET-ID 20
     IMAGE-10 AT ROW 4.5 COL 51.14 WIDGET-ID 22
     IMAGE-11 AT ROW 1.5 COL 31 WIDGET-ID 28
     IMAGE-12 AT ROW 1.5 COL 51 WIDGET-ID 30
...
/* SETTINGS FOR FRAME fpage2
                                                                        */
/* SETTINGS FOR FILL-IN cDtfim IN FRAME fpage2
   ALIGN-L                                                              */
/* SETTINGS FOR FILL-IN cDtini IN FRAME fpage2
   ALIGN-L                                                              */
/* SETTINGS FOR FILL-IN cEstfim IN FRAME fpage2
   ALIGN-L                                                              */
/* SETTINGS FOR FILL-IN cEstini IN FRAME fpage2
   ALIGN-L                                                              */
/* SETTINGS FOR FILL-IN cOperfim IN FRAME fpage2
   ALIGN-L                                                              */
/* SETTINGS FOR FILL-IN cOperini IN FRAME fpage2
   ALIGN-L                                                              */
/* SETTINGS FOR FILL-IN fi-estab-fim IN FRAME fpage2
   ALIGN-L                                                              */
/* SETTINGS FOR FILL-IN fi-estab-ini IN FRAME fpage2
   ALIGN-L                                                              */
...
/*     end. */
    ...
    /*:T Coloque aqui as validaá‰es das outras p†ginas, lembrando que elas devem 
       ...
       IF input frame fpage2 cEstfim < input frame fpage2 cEstini THEN DO:
             run setFolder IN hFolder (INPUT 2).
             RUN UTP/UT-MSGS.P (INPUT "SHOW",
                        INPUT 17567,
                        INPUT "Estado final n∆o pode ser menor que o inicial").
             apply "entry" to cEstfim IN FRAME fpage2.
             return error.
       END.
       
       IF input frame fpage2 cOperfim < input frame fpage2 cOperini THEN DO:
             run setFolder IN hFolder (INPUT 2).
             RUN UTP/UT-MSGS.P (INPUT "SHOW",
                        INPUT 17567,
                        INPUT "Nat. Operaá∆o final n∆o pode ser menor que o inicial").
             apply "entry" to cOperfim IN FRAME fpage2.
             return error.
       END.
        
       IF input frame fpage2 cDtfim < input frame fpage2 cDtini THEN DO:
             run setFolder IN hFolder (INPUT 2).
             RUN UTP/UT-MSGS.P (INPUT "SHOW",
                        INPUT 17567,
                        INPUT "Data Emiss∆o final n∆o pode ser menor que o inicial").
             apply "entry" to cDtfim IN FRAME fpage2.
             return error.
       END.
    ...
    assign tt-param.estini = input frame fpage2 cEstini
           tt-param.estfim = input frame fpage2 cEstfim
           tt-param.operini = input frame fpage2 cOperini
           tt-param.operfim = input frame fpage2 cOperfim
           tt-param.dtini   = input frame fpage2 cDtini
           tt-param.dtfim   = input frame fpage2 cDtfim
/*            tt-param.cod-estabel = v_cod_estab_usuar */
           tt-param.cod-estabel-ini = INPUT FRAME fpage2 fi-estab-ini
           tt-param.cod-estabel-fim = INPUT FRAME fpage2 fi-estab-fim.
    ...
    {report/rprun.i esp/cep/escep039rp.p}
