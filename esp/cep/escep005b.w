...
*******************************************************************************/
{include/i-prgvrs.i ESCEP005B 2.04.00.000}
...
DEF INPUT PARAM c-cod-estabel AS CHAR.
DEF INPUT PARAM TABLE FOR tt-ae.


/* Preprocessors Definitions ---                                      */
&GLOBAL-DEFINE Program        ESCEP005B
&GLOBAL-DEFINE Version        1
&GLOBAL-DEFINE VersionLayout  0
...
&GLOBAL-DEFINE page4Widgets   l-imprime
...
DEFINE VARIABLE l-imprime AS LOGICAL INITIAL no 
     LABEL "Imprime Quantidades" 
     VIEW-AS TOGGLE-BOX
     SIZE 44 BY 1.08
     FONT 1 NO-UNDO.
...
DEFINE FRAME fPage4
     l-imprime AT ROW 1.29 COL 3.29
...
do on error undo, return error on stop  undo, return error:
    ...
    assign tt-param.usuario         = c-seg-usuario
           ...
           tt-param.it-codigo       = p-it-codigo
           tt-param.cod-estabel     = c-cod-estabel
           tt-param.l-imprime       = INPUT FRAME fPage4 l-imprime.
    ...
    {report/rprun.i esp/cep/escep005rp.p}
