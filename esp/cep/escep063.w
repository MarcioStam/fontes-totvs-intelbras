...
*******************************************************************************/
{include/i-prgvrs.i ESCEP063 2.00.00.001}

CREATE WIDGET-POOL.

/* Preprocessors Definitions ---                                      */
&GLOBAL-DEFINE Program        ESCEP063
...
&GLOBAL-DEFINE page2Fields    cInputFile
...
DEFINE FRAME fPage2
     btInputFile AT ROW 2.46 COL 61.29 HELP
          "Escolha do nome do arquivo" WIDGET-ID 22
     cInputFile AT ROW 2.5 COL 20.72 HELP
          "Nome do arquivo de destino do relat¢rio" NO-LABEL WIDGET-ID 24
     ed-layout AT ROW 4.42 COL 15.57 NO-LABEL WIDGET-ID 30
     text-entrada AT ROW 1.42 COL 20.57 NO-LABEL WIDGET-ID 28
     RECT-13 AT ROW 1.75 COL 19.57 WIDGET-ID 26
...
------------------------------------------------------------------------------*/
    ...
    ASSIGN ed-layout = "Alteraá∆o Comprador das Ordens de Compra e Pedidos" + CHR(13) +
                       "Layout do Arquivo: N£mero Pedido;Comprador;" + CHR(13) +
                       "170886;adm;" + CHR(13) +
                       "170889;an046325;".
...
DO ON ERROR UNDO, RETURN ERROR ON STOP  UNDO, RETURN ERROR:
    ...
    {report/rprun.i esp/cep/escep063rp.p}
