...
*******************************************************************************/
{include/i-prgvrs.i ESCEP042 1.00.00.000}

CREATE WIDGET-POOL.

/* Preprocessors Definitions ---                                      */
&GLOBAL-DEFINE Program        ESCEP042
...
&GLOBAL-DEFINE page0Widgets   btOk ~
                              btCancel ~
                              btHelp2
&GLOBAL-DEFINE page4Widgets   rs-itens-com-saldo
...
&GLOBAL-DEFINE page4Text      text-saldo
&GLOBAL-DEFINE page6Text      text-destino text-modo text-rtf text-ModelRtf

&GLOBAL-DEFINE page2Fields    fi-fim-fm-codigo fi-fim-it-codigo~
                              fi-ini-fm-codigo fi-ini-it-codigo
&GLOBAL-DEFINE page4Fields    fi-cod-estabel fi-cod-depos
...
DEFINE VARIABLE fi-fim-fm-codigo AS CHARACTER FORMAT "x(8)" INITIAL "ZZZZZZZZ" 
     VIEW-AS FILL-IN 
...
DEFINE VARIABLE fi-ini-fm-codigo AS CHARACTER FORMAT "x(8)" 
     LABEL "Fam°lia":R9 
     VIEW-AS FILL-IN 
     SIZE 10.29 BY .88 NO-UNDO.
...
DEFINE VARIABLE text-saldo AS CHARACTER FORMAT "X(256)":U INITIAL "Itens com Saldo" 
      VIEW-AS TEXT 
     SIZE 14.86 BY .63
     FONT 1 NO-UNDO.

DEFINE VARIABLE rs-itens-com-saldo AS INTEGER INITIAL 1 
     VIEW-AS RADIO-SET VERTICAL
     RADIO-BUTTONS 
          "Errado", 1,
"Correto em localizaá∆o errada", 2
...
DEFINE FRAME fPage2
     fi-ini-fm-codigo AT ROW 4.5 COL 14.14 COLON-ALIGNED HELP
          "C¢digo da Fam°lia de Material" WIDGET-ID 4
     fi-fim-fm-codigo AT ROW 4.5 COL 52.14 COLON-ALIGNED HELP
          "C¢digo da Fam°lia de Material" NO-LABEL WIDGET-ID 12
     fi-ini-it-codigo AT ROW 5.5 COL 14.14 COLON-ALIGNED HELP
          "C¢digo do Item" WIDGET-ID 8
     fi-fim-it-codigo AT ROW 5.5 COL 52.14 COLON-ALIGNED HELP
          "C¢digo do Item" NO-LABEL WIDGET-ID 14
     IMAGE-1 AT ROW 5.5 COL 35.86
     IMAGE-2 AT ROW 4.5 COL 51.14
     IMAGE-3 AT ROW 4.5 COL 35.86 WIDGET-ID 16
     IMAGE-4 AT ROW 5.5 COL 51.14 WIDGET-ID 18
    WITH 1 DOWN KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 3.57 ROW 2.81
         SIZE 84.43 BY 10.15
...
DEFINE FRAME fPage4
     rs-itens-com-saldo AT ROW 3 COL 7 NO-LABEL WIDGET-ID 2
     fi-cod-depos AT ROW 8 COL 19 COLON-ALIGNED WIDGET-ID 14
     fi-nome-2 AT ROW 8 COL 24.57 COLON-ALIGNED HELP
          "Descriá∆o do Dep¢sito" NO-LABEL WIDGET-ID 16 NO-TAB-STOP 
     fi-cod-estabel AT ROW 9 COL 19 COLON-ALIGNED HELP
          "C¢digo do estabelecimento" WIDGET-ID 10
     fi-nome AT ROW 9 COL 24.57 COLON-ALIGNED HELP
          "Nome Estabelecimento" NO-LABEL WIDGET-ID 12 NO-TAB-STOP 
     text-saldo AT ROW 2 COL 7.14 NO-LABEL
     RECT-12 AT ROW 2.25 COL 5
    WITH 1 DOWN KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 3.57 ROW 2.81
         SIZE 84.43 BY 10.15
...
&Scoped-define SELF-NAME fi-fim-fm-codigo
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL fi-fim-fm-codigo wReport
ON F5 OF fi-fim-fm-codigo IN FRAME fPage2
DO:
    {include/zoomvar.i &prog-zoom=inzoom/z01in122.w
                        &campo=fi-fim-fm-codigo
                        &campozoom=fm-codigo}
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL fi-fim-fm-codigo wReport
ON MOUSE-SELECT-DBLCLICK OF fi-fim-fm-codigo IN FRAME fPage2
DO:
  apply "F5":U to self.
END.
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL fi-ini-fm-codigo wReport
ON F5 OF fi-ini-fm-codigo IN FRAME fPage2 /* Fam°lia */
DO:
    {include/zoomvar.i &prog-zoom=inzoom/z01in122.w
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL fi-ini-fm-codigo wReport
ON MOUSE-SELECT-DBLCLICK OF fi-ini-fm-codigo IN FRAME fPage2 /* Fam°lia */
DO:
  apply "F5":U to self.
END.
...
fi-ini-fm-codigo:LOAD-MOUSE-POINTER("image/lupa.cur":U) IN FRAME fPage2.  
fi-fim-fm-codigo:LOAD-MOUSE-POINTER("image/lupa.cur":U) IN FRAME fPage2.  
...
do on error undo, return error on stop  undo, return error:
    ...
    assign tt-param.usuario         = c-seg-usuario
           ...
           tt-param.ind-itens-com-saldo = input frame fPage4 rs-itens-com-saldo
           tt-param.cod-depos       = input frame fPage4 fi-cod-depos
           tt-param.fm-codigo-ini   = input frame fPage2 fi-ini-fm-codigo
           tt-param.fm-codigo-fim   = input frame fPage2 fi-fim-fm-codigo
    ...
    {report/rprun.i esp/cep/escep042rp.p}
