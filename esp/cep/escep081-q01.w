...
&Scoped-define INTERNAL-TABLES int-param-calc-crit

/* Definitions for QUERY Query-Main                                     */
&Scoped-define QUERY-STRING-Query-Main FOR EACH int-param-calc-crit NO-LOCK INDEXED-REPOSITION
&Scoped-define OPEN-QUERY-Query-Main OPEN QUERY Query-Main FOR EACH int-param-calc-crit NO-LOCK INDEXED-REPOSITION.
&Scoped-define TABLES-IN-QUERY-Query-Main int-param-calc-crit
&Scoped-define FIRST-TABLE-IN-QUERY-Query-Main int-param-calc-crit
...
/* Query rebuild information for QUERY Query-Main
     _TblList          = "mgesp.int-param-calc-crit"
