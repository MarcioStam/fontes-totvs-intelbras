...
&GLOBAL-DEFINE Program        ESCEP026
...
&GLOBAL-DEFINE page0Widgets   btOk ~
                              btCancel ~
                              btHelp2
&GLOBAL-DEFINE page2Widgets   fi-fim-data fi-fim-familia fi-fim-it-codigo fi-fim-rep  fi-ini-data fi-ini-familia fi-ini-it-codigo fi-ini-rep  fi-ini-estab fi-fim-estab fi-ini-UnidadedeNegocio fi-fim-UnidadedeNegocio
&GLOBAL-DEFINE page4Widgets   tb-aca tb-familia tb-blo
...
DEFINE VARIABLE tb-aca AS LOGICAL INITIAL yes 
     LABEL "Considerar dep¢sito ACA?" 
     VIEW-AS TOGGLE-BOX
     SIZE 26 BY .83 NO-UNDO.

DEFINE VARIABLE tb-blo AS LOGICAL INITIAL no 
     LABEL "Considerar dep¢sito BLO?" 
     VIEW-AS TOGGLE-BOX
     SIZE 26 BY .83 NO-UNDO.

DEFINE VARIABLE tb-familia AS LOGICAL INITIAL no 
     LABEL "Totalizar  por Familia?" 
     VIEW-AS TOGGLE-BOX
     SIZE 26 BY .83 NO-UNDO.
...
DEFINE FRAME fPage4
     tb-familia AT ROW 2.5 COL 8
     tb-aca AT ROW 3.5 COL 8
     tb-blo AT ROW 4.5 COL 8 WIDGET-ID 2
...
do on error undo, return error on stop  undo, return error:
    ...
    assign tt-param.usuario                     = c-seg-usuario
           ...
           tt-param.familia                     = input frame fPage4 tb-familia
           tt-param.aca                         = input frame fPage4 tb-aca
           tt-param.blo                         = INPUT FRAME fPage4 tb-blo
    ...
    {report/rprun.i esp/cep/escep026rp.p}
