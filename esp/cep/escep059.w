...
&GLOBAL-DEFINE Program        ESCEP059
...
&GLOBAL-DEFINE page0Widgets   btOk ~
                              btCancel ~
                              btHelp2
&GLOBAL-DEFINE page2Widgets   btFile-2 fi-arq-csv
...
DEFINE FRAME fPage2
     ...
     EDITOR-1 AT ROW 1.75 COL 3 NO-LABEL WIDGET-ID 46
     "Arquivo:" VIEW-AS TEXT
          SIZE 6 BY .54 AT ROW 8 COL 6.43 WIDGET-ID 22
     RECT-10 AT ROW 1.25 COL 1.72 WIDGET-ID 14
...
{report/mainblock.i}
    ...
    ASSIGN editor-1 = "Layout do Arquivo: " + CHR(13) +
                  "Estab;Item;Lote Multiplo;Lote Minimo;Tempo Ressupr;Cod Fornec;Lote Multiplo;Lote Minimo;Comprador"  + CHR(13) +
                  "101;1080001;4;5000;120;114411;4;5000;;" + CHR(13) +
                  "101;1080002;4;800;120;114411;4;800;ru052679;" .
...
DO ON ERROR UNDO, RETURN ERROR ON STOP UNDO, RETURN ERROR:
    ...
    ASSIGN INPUT FRAME fPage2 fi-arq-csv.

    IF SEARCH(fi-arq-csv) = ? THEN DO:
        RUN utp/ut-msgs.p (INPUT "show":U, INPUT 17006, INPUT "Arquivo inv†lido!":U + "~~" +
                                                              "Informe um arquivo v†lido.").
        APPLY "ENTRY":U TO fi-arq-csv IN FRAME fPage2.
        RETURN ERROR.
    END.
    ...
    DO WITH FRAME fPage2:
       ASSIGN tt-param.arq-csv      = INPUT FRAME fPage2 fi-arq-csv.
    END.
    ...
    {report/rprun.i esp/cep/escep059rp.p}
