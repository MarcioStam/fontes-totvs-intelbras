...
**
** Descri‡Æo: Altera‡Æo de AE
*******************************************************************************/
{include/i-prgvrs.i ESCEP032 2.04.00.001}

CREATE WIDGET-POOL.

/* Preprocessors Definitions ---                                      */
&GLOBAL-DEFINE Program        ESCEP032
...
&GLOBAL-DEFINE page0KeyFields ttae-item.nr-ae ttae-item.sequencia
&GLOBAL-DEFINE page0Fields    {&page0KeyFields} ttae-item.nf~
                              ttae-item.quantidade ttae-item.roteiro fiPrinter 
...
ttae-item.quantidade ttae-item.roteiro ttae-item.nf 
&Scoped-define ENABLED-TABLES ttae-item
&Scoped-define FIRST-ENABLED-TABLE ttae-item
&Scoped-Define ENABLED-OBJECTS rtToolBar rtKeys rtKeys-2 rtKeys-3 RECT-4 ~
btFirst btPrev btNext btLast btGoTo btSearch btAdd btCopy btUpdate btDelete ~
btUndo btCancel btSave btQueryJoins btReportsJoins btExit btHelp fiPrinter 
...
&Scoped-Define DISPLAYED-OBJECTS fiPrinter 
...
DEFINE FRAME fpage0
     ...
     btHelp AT ROW 1.13 COL 86.72 HELP
          "Ajuda"
     ttae-item.nr-ae AT ROW 2.83 COL 35 COLON-ALIGNED WIDGET-ID 4
          VIEW-AS FILL-IN 
          SIZE 9.14 BY .88
     ttae-item.sequencia AT ROW 3.83 COL 35 COLON-ALIGNED WIDGET-ID 10
          VIEW-AS FILL-IN 
          SIZE 4.57 BY .88
     ttae-item.quantidade AT ROW 5.17 COL 35 COLON-ALIGNED WIDGET-ID 6
          VIEW-AS FILL-IN 
          SIZE 6.86 BY .88
     ttae-item.roteiro AT ROW 6.17 COL 35 COLON-ALIGNED WIDGET-ID 8
          VIEW-AS FILL-IN 
          SIZE 10.29 BY .88
     ttae-item.nf AT ROW 7.17 COL 35 COLON-ALIGNED WIDGET-ID 2
          VIEW-AS FILL-IN 
          SIZE 8 BY .88
     btConfigImpr AT ROW 11.25 COL 68.57 HELP
          "Configura‡Æo da impressora" WIDGET-ID 32
     fiPrinter AT ROW 11.33 COL 24 NO-LABEL WIDGET-ID 34 NO-TAB-STOP 
     "Destino:" VIEW-AS TEXT
          SIZE 7.29 BY .54 AT ROW 10.46 COL 18.72 WIDGET-ID 28
     rtToolBar AT ROW 1 COL 1
     rtKeys AT ROW 2.67 COL 1
     rtKeys-2 AT ROW 5 COL 1 WIDGET-ID 12
     rtKeys-3 AT ROW 8.25 COL 1 WIDGET-ID 14
     RECT-4 AT ROW 10.67 COL 17 WIDGET-ID 22
...
/* SETTINGS FOR BUTTON btConfigImpr IN FRAME fpage0
   NO-ENABLE                                                            */
ASSIGN 
...
OR CHOOSE OF MENU-ITEM miSave IN MENU mbMain DO:
    ...
    if  RETURN-VALUE = "OK" THEN DO:
        /*
        RUN imprimeAE in this-procedure (input input frame fPage0 cb-impressora,
                                         input input frame fPage0 rs-destino,
                                         input input frame fPage0 ttae-item.nr-ae,
                                         input input frame fPage0 ttae-item.sequencia,
                                         input input frame fPage0 ttae-item.sequencia).
        */

        IF NOT valid-handle(h_esapi020) THEN RUN esapi/esapi020.p PERSISTENT SET h_esapi020.

        RUN pi-imprime-AE IN h_esapi020 (INPUT input frame fPage0 fiPrinter,
...
OR CHOOSE OF MENU-ITEM miSearch IN MENU mbMain DO:
    {method/zoomreposition.i &ProgramZoom="eszoom/z02es010.w"}
END.
...
------------------------------------------------------------------------------*/
    ...
    ASSIGN btConfigImpr:SENSITIVE IN FRAME fPage0 = FALSE.
...
------------------------------------------------------------------------------*/
    ...
    ASSIGN btConfigImpr:SENSITIVE IN FRAME fPage0 = TRUE.
...
------------------------------------------------------------------------------*/
    ...
    DEFINE VARIABLE i-nr-ae LIKE {&ttTable}.nr-ae NO-UNDO.
    DEFINE VARIABLE i-sequencia LIKE {&ttTable}.sequencia NO-UNDO.
    
    DEFINE FRAME fGoToRecord
        i-nr-ae  view-as fill-in size-chars 9.14 by 0.88 AT ROW 1.21 COL 17.72 COLON-ALIGNED 
        i-sequencia view-as fill-in size-chars 4.57 by 0.88 AT ROW 2.21 COL 17.72 COLON-ALIGNED 
        btGoToOK          AT ROW 3.63 COL 2.14
        btGoToCancel      AT ROW 3.63 COL 13
        rtGoToButton      AT ROW 3.38 COL 1
        SPACE(0.28)
        WITH VIEW-AS DIALOG-BOX KEEP-TAB-ORDER SIDE-LABELS NO-UNDERLINE 
             THREE-D SCROLLABLE TITLE "V  Para Aviso Entrada Item" FONT 1
             DEFAULT-BUTTON btGoToOK CANCEL-BUTTON btGoToCancel.
    
/*tech1139 - FO 1338.917 - 10/07/2006  */
    RUN utp/ut-trfrrp.p (input Frame fGoToRecord:Handle).
    {utp/ut-liter.i "V _Para_Aviso_Entrada_Item"}
    ASSIGN FRAME fGoToRecord:TITLE = RETURN-VALUE.
/*tech1139 - FO 1338.917 - 10/07/2006  */

    ON "CHOOSE":U OF btGoToOK IN FRAME fGoToRecord DO:
        ASSIGN i-nr-ae i-sequencia.
        
        RUN findAEBySeq IN {&hDBOTable} (input v_cod_estab_usuar, INPUT i-nr-ae , INPUT i-sequencia ).
        IF RETURN-VALUE = "NOK":U THEN DO:
            RUN utp/ut-msgs.p (INPUT "SHOW":U, INPUT 2, INPUT "Aviso Entrada Item":U).
    ...
    ENABLE i-nr-ae i-sequencia btGoToOK btGoToCancel 
...
------------------------------------------------------------------------------*/
    ...
    run setConstraintPendentes in {&hDBOTable} (input v_cod_estab_usuar).
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE piSelectPrinter wMaintenance 
