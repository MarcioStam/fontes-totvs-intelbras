...
*******************************************************************************/
{include/i-prgvrs.i escep044 1.00.00.000}

CREATE WIDGET-POOL.

/* Preprocessors Definitions ---                                      */
&GLOBAL-DEFINE Program        escep044
&GLOBAL-DEFINE Version        1.00.00.000
&GLOBAL-DEFINE VersionLayout  

&GLOBAL-DEFINE Folder         YES
&GLOBAL-DEFINE InitialPage    1
&GLOBAL-DEFINE FolderLabels   ParÉmetro,Digitaá∆o,Impress∆o
...
&GLOBAL-DEFINE page4Fields    f-num-copias f-num-caixa 
...
&Scoped-define FIELDS-IN-QUERY-brDigita tt-digita.cod-emitente tt-digita.nome-emit   
...
DEFINE VARIABLE f-num-caixa AS INTEGER FORMAT ">>9":U INITIAL 0 
     LABEL "Num. Caixa de Arquivo" 
     VIEW-AS FILL-IN 
     SIZE 4.72 BY .88 NO-UNDO.

DEFINE VARIABLE f-num-copias AS INTEGER FORMAT "99":U INITIAL 3 
     LABEL "Numero C¢pias" 
     VIEW-AS FILL-IN 
...
DEFINE FRAME fPage4
     f-num-copias AT ROW 2.25 COL 16 COLON-ALIGNED WIDGET-ID 2
     f-num-caixa AT ROW 3.25 COL 16 COLON-ALIGNED WIDGET-ID 4
    WITH 1 DOWN KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 3.57 ROW 2.81
         SIZE 84.43 BY 10.15
...
DEFINE FRAME fPage6
     ...
     rsExecution AT ROW 6.5 COL 2.86 HELP
          "Modo de Execuá∆o" NO-LABEL
     text-destino AT ROW 1.63 COL 1.86 COLON-ALIGNED NO-LABEL
     text-modo AT ROW 5.75 COL 1.14 COLON-ALIGNED NO-LABEL
...
DO:
    if  brDigita:new-row in frame fPage5 then do:
        ...
        display tt-digita.cod-emitente
                tt-digita.nome-emit with browse brDigita. 
    end.
    return no-apply.
END.
...
DO:
    ...
    do transaction on error undo, return no-apply:
        ...
        assign input browse brDigita tt-digita.cod-emitente
               input browse brDigita tt-digita.nome-emit.
...
on "leave" of tt-digita.cod-emitente in browse brDigita do:
    find first emitente where emitente.cod-emitente = int(tt-digita.cod-emitente:screen-value in browse brDigita) no-lock no-error.
    if avail emitente then
        assign tt-digita.nome-emit:screen-value in browse brDigita = emitente.nome-emit.
...
/*                                             rsClassif:radio-buttons in frame fPage3) */
    ...
    /*:T Coloque aqui a l¢gica de gravaá∆o dos demais campos que devem ser passados
       como parÉmetros para o programa RP.P, atravÇs da temp-table tt-param */
        assign tt-param.n-copias = input frame fPage4 f-num-copias
               tt-param.n-caixa  = input frame fPage4 f-num-caixa.
    ...
    {report/rprun.i esp/cep/escep044rp.p}
