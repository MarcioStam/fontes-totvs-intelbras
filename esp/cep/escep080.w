...
&GLOBAL-DEFINE Program        ESCEP080
...
&GLOBAL-DEFINE page2Fields    fm-codigo-ini fm-codigo-fim
...
DEFINE VARIABLE fm-codigo-fim AS CHARACTER FORMAT "X(08)":U INITIAL "ZZZZZZZZ" 
     VIEW-AS FILL-IN 
     SIZE 15 BY .88
     FONT 1 NO-UNDO.
...
DEFINE FRAME fPage4
     cInputFile AT ROW 2.54 COL 4.14 HELP
          "Nome do arquivo de destino do relat¢rio" NO-LABEL
     btInputFile AT ROW 2.54 COL 44.14 HELP
          "Escolha do nome do arquivo"
     text-saida AT ROW 1.5 COL 5.14 NO-LABEL
     RECT-12 AT ROW 1.75 COL 3
...
DEFINE FRAME fPage2
     fm-codigo-ini AT ROW 1.5 COL 15.28
     fm-codigo-fim AT ROW 1.5 COL 54.14 NO-LABEL
...
/* SETTINGS FOR FRAME fPage2
                                                                        */
/* SETTINGS FOR FILL-IN fm-codigo-fim IN FRAME fPage2
   ALIGN-L                                                              */
/* SETTINGS FOR FILL-IN fm-codigo-ini IN FRAME fPage2
   ALIGN-L                                                              */
...
DO WITH FRAME fPage4:
    ...
    ASSIGN cInputFile:SCREEN-VALUE = SESSION:TEMP-DIR.

    ASSIGN cInputFile:SCREEN-VALUE = REPLACE(cInputFile:SCREEN-VALUE, "/", "\").

    IF SUBSTRING(cInputFile:SCREEN-VALUE, LENGTH(cInputFile:SCREEN-VALUE), 1) <> "\" THEN
        ASSIGN cInputFile:SCREEN-VALUE = cInputFile:SCREEN-VALUE + "\".
         
    ASSIGN cInputFile:SCREEN-VALUE = cInputFile:SCREEN-VALUE + "escep080-" + STRING(TIME) + ".csv".
...
do on error undo, return error on stop  undo, return error:
    ...
    assign tt-param.usuario         = c-seg-usuario
           ...
           tt-param.fm-codigo-ini   = INPUT FRAME fPage2 fm-codigo-ini
           tt-param.fm-codigo-fim   = INPUT FRAME fPage2 fm-codigo-fim
           tt-param.excel           = INPUT FRAME fPage4 cInputFile
           .
    ...
    {report/rprun.i esp/cep/escep080rp.p}
