...
&GLOBAL-DEFINE Program        ESCEP024
...
&GLOBAL-DEFINE page0Widgets   btOk ~
                              btCancel ~
                              btHelp2
&GLOBAL-DEFINE page2Widgets   fi-fim-nr-requisicao fi-ini-nr-requisicao rs-tipo-relatorio fi-cod-estabel
...
DEFINE VARIABLE fi-fim-nr-requisicao AS INTEGER FORMAT ">>>,>>9" INITIAL 99999 
     VIEW-AS FILL-IN 
     SIZE 8 BY .88 NO-UNDO.

DEFINE VARIABLE fi-ini-nr-requisicao AS INTEGER FORMAT ">>>,>>9" INITIAL 0 
     LABEL "Requisiá∆o":R12 
     VIEW-AS FILL-IN 
     SIZE 8 BY .88 NO-UNDO.
...
DEFINE FRAME fPage2
     fi-cod-estabel AT ROW 2.13 COL 25 COLON-ALIGNED WIDGET-ID 8
     fi-ini-nr-requisicao AT ROW 3.04 COL 25 COLON-ALIGNED HELP
          "Permite informar o numero da requisiá∆o de materiais ao estoque"
     fi-fim-nr-requisicao AT ROW 3.04 COL 43.86 COLON-ALIGNED HELP
          "Permite informar o numero da requisiá∆o de materiais ao estoque" NO-LABEL
     rs-tipo-relatorio AT ROW 5 COL 27 NO-LABEL WIDGET-ID 2
     IMAGE-1 AT ROW 3.04 COL 35.43
     IMAGE-2 AT ROW 3.04 COL 43
     RECT-16 AT ROW 4.5 COL 10 WIDGET-ID 6
...
do on error undo, return error on stop  undo, return error:
    ...
    assign tt-param.usuario         = c-seg-usuario
           ...
           tt-param.ini-nr-requisicao  = input frame fPage2 fi-ini-nr-requisicao        
           tt-param.fim-nr-requisicao  = input frame fPage2 fi-fim-nr-requisicao
           //tt-param.cod-estabel     = v_cod_estab_usuar.
           tt-param.tipo-relatorio  = INT(rs-tipo-relatorio:SCREEN-VALUE IN FRAME fpage2).
   ...
   {report/rprun.i esp/cep/escep024rp.p}
