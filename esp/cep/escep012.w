...
&GLOBAL-DEFINE Program        ESCEP012
...
&GLOBAL-DEFINE page2Widgets   fi-fim-it-codigo fi-ini-it-codigo 
...
&GLOBAL-DEFINE page2Fields    fi-fim-it-codigo fi-ini-it-codigo 
...
&Scoped-Define ENABLED-OBJECTS btOK btCancel btHelp2 IMAGE-13 IMAGE-14 ~
IMAGE-15 IMAGE-16 rtToolBar 
...
DEFINE FRAME fPage2
     fi-ini-it-codigo AT ROW 1.5 COL 34.57 RIGHT-ALIGNED
     fi-fim-it-codigo AT ROW 1.5 COL 52.57 COLON-ALIGNED NO-LABEL
...
do on error undo, return error on stop  undo, return error:
    ...
    {report/rprun.i esp/cep/escep012rp.p}
