...
*******************************************************************************/
{include/i-prgvrs.i ESCEP092 9.99.99.999}
...
&IF "{&EMSFND_VERSION}" >= "1.00" &THEN
    {include/i-license-manager.i ESCEP092 esp}
&ENDIF
...
DEFINE VARIABLE tg-altera-data AS LOGICAL INITIAL no 
     LABEL "Habilita Alterar Data" 
     VIEW-AS TOGGLE-BOX
     SIZE 23 BY .83 NO-UNDO.

DEFINE VARIABLE tg-gera-txt AS LOGICAL INITIAL no 
     LABEL "Gera Somente TXT" 
     VIEW-AS TOGGLE-BOX
     SIZE 23 BY .83 NO-UNDO.
...
DEFINE FRAME f-pg-sel
     dt-ini AT ROW 6.42 COL 21 COLON-ALIGNED WIDGET-ID 36
     dt-fim AT ROW 6.42 COL 45 COLON-ALIGNED NO-LABEL WIDGET-ID 34
     tg-gera-txt AT ROW 8 COL 23 WIDGET-ID 42
     tg-altera-data AT ROW 9.25 COL 23 WIDGET-ID 44
     IMAGE-21 AT ROW 6.46 COL 36.72 WIDGET-ID 38
     IMAGE-22 AT ROW 6.46 COL 43.43 WIDGET-ID 40
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW w-relat ASSIGN
         HIDDEN             = YES
         TITLE              = "Requisiá‰es Ordens Solar - ESCEP092"
         HEIGHT             = 16.29
         WIDTH              = 83.29
         MAX-HEIGHT         = 27.88
         MAX-WIDTH          = 195.14
...
ON END-ERROR OF w-relat /* Requisiá‰es Ordens Solar - ESCEP092 */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL w-relat w-relat
ON WINDOW-CLOSE OF w-relat /* Requisiá‰es Ordens Solar - ESCEP092 */
DO:
...
&Scoped-define SELF-NAME tg-altera-data
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL tg-altera-data w-relat
ON VALUE-CHANGED OF tg-altera-data IN FRAME f-pg-sel /* Habilita Alterar Data */
DO:
    IF tg-altera-data:SCREEN-VALUE = "no" THEN
        ASSIGN dt-ini:VISIBLE IN FRAME f-pg-sel   = NO
               IMAGE-21:VISIBLE IN FRAME f-pg-sel = NO
               IMAGE-22:VISIBLE IN FRAME f-pg-sel = NO
               dt-fim:VISIBLE IN FRAME f-pg-sel   = NO.
    ELSE
        ASSIGN dt-ini:VISIBLE IN FRAME f-pg-sel   = YES
               IMAGE-21:VISIBLE IN FRAME f-pg-sel = YES
               IMAGE-22:VISIBLE IN FRAME f-pg-sel = YES
               dt-fim:VISIBLE IN FRAME f-pg-sel   = YES.      
END.
...
{utp/ut9000.i "ESCEP092" "9.99.99.999"}
...
------------------------------------------------------------------------------*/
  ...
  DISPLAY dt-ini dt-fim tg-gera-txt tg-altera-data 
      WITH FRAME f-pg-sel IN WINDOW w-relat.
  ENABLE IMAGE-21 IMAGE-22 dt-ini dt-fim tg-gera-txt tg-altera-data 
      WITH FRAME f-pg-sel IN WINDOW w-relat.
...
do on error undo, return error on stop  undo, return error:
   ...
   /*:T Coloque aqui as validaá‰es das outras p†ginas, lembrando que elas devem 
    ...
    assign tt-param.usuario              = c-seg-usuario
           ...
           tt-param.log-gera-txt         = INPUT FRAME f-pg-sel tg-gera-txt
           tt-param.log-altera-data      = INPUT FRAME f-pg-sel tg-altera-data
    ...
    {include/i-rprun.i esp/cep/escep092rp.p}
