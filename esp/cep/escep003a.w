...
*******************************************************************************/
{include/i-prgvrs.i ESCEP003a 2.04.00.000}

{esp/cep/escep003tt.i}

DEF INPUT PARAM TABLE FOR tt-itens.
DEF INPUT PARAM p-loc-ini       like item.cod-localiz.
DEF INPUT PARAM p-loc-fim       like item.cod-localiz.
DEF INPUT PARAM p-ge-ini        like item.ge-codigo.
DEF INPUT PARAM p-ge-fim        like item.ge-codigo.
DEF INPUT PARAM p-fm-ini        like item.fm-codigo.
DEF INPUT PARAM p-fm-fim        like item.fm-codigo.
DEF INPUT PARAM p-it-ini        like item.it-codigo.
DEF INPUT PARAM p-it-fim        like item.it-codigo.
DEF INPUT PARAM p-comprador-ini like item.cod-comprado.
DEF INPUT PARAM p-comprador-fim like item.cod-comprado.
DEF INPUT PARAM p-ativo         AS LOGICAL.
DEF INPUT PARAM p-obsoleto-auto AS LOGICAL.
DEF INPUT PARAM p-obsoleto      AS LOGICAL.
DEF INPUT PARAM p-total         AS LOGICAL.
DEF INPUT PARAM p-mat           as INTEGER.
DEF INPUT PARAM p-total-dep     AS DEC FORMAT "->>>,>>>,>>9.99".

CREATE WIDGET-POOL.

/* Preprocessors Definitions ---                                      */
&GLOBAL-DEFINE Program        ESCEP003A
...
do on error undo, return error on stop  undo, return error:
    ...
    assign tt-param.usuario         = c-seg-usuario
           ...
           tt-param.c-loc-ini       = p-loc-ini
           tt-param.c-loc-fim       = p-loc-fim
           tt-param.i-ge-ini        = p-ge-ini
           tt-param.i-ge-fim        = p-ge-fim
           tt-param.c-fm-ini        = p-fm-ini
           tt-param.c-fm-fim        = p-fm-fim
           tt-param.c-it-ini        = p-it-ini
           tt-param.c-it-fim        = p-it-fim
           tt-param.c-comprador-ini = p-comprador-ini
           tt-param.c-comprador-fim = p-comprador-fim
           tt-param.l-ativo         = p-ativo
           tt-param.l-obsoleto-auto = p-obsoleto-auto
           tt-param.l-obsoleto      = p-obsoleto
           tt-param.l-total         = p-total
           tt-param.i-mat           = p-mat
           tt-param.d-total-dep     = p-total-dep.
    ...
    {report/rprun.i esp/cep/escep003rp.p}
