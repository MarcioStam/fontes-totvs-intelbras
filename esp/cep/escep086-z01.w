...
&GLOBAL-DEFINE Program           escep086-z01
&GLOBAL-DEFINE Version           3.00.00.000

&GLOBAL-DEFINE InitialPage       1
&GLOBAL-DEFINE FolderLabels      Pesquisa

&GLOBAL-DEFINE Range             NO

&GLOBAL-DEFINE ttTable1       tt-int-estabel-ressuprimento
&GLOBAL-DEFINE hDBOTable1     hesbo926
&GLOBAL-DEFINE DBOTable1      int-estabel-ressuprimento
...
&Scoped-define INTERNAL-TABLES tt-int-estabel-ressuprimento
...
&Scoped-define QUERY-STRING-brTable1 FOR EACH tt-int-estabel-ressuprimento NO-LOCK INDEXED-REPOSITION
&Scoped-define OPEN-QUERY-brTable1 OPEN QUERY brTable1 FOR EACH tt-int-estabel-ressuprimento NO-LOCK INDEXED-REPOSITION.
&Scoped-define TABLES-IN-QUERY-brTable1 tt-int-estabel-ressuprimento
&Scoped-define FIRST-TABLE-IN-QUERY-brTable1 tt-int-estabel-ressuprimento
...
DEFINE QUERY brTable1 FOR 
      tt-int-estabel-ressuprimento SCROLLING.
&ANALYZE-RESUME
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS brTable1 wZoom _STRUCTURED
  QUERY brTable1 NO-LOCK DISPLAY
      tt-int-estabel-ressuprimento.cod-estabel-ressup FORMAT "x(05)":U
      tt-int-estabel-ressuprimento.cod-depos-ressup FORMAT "x(3)":U
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
...
/* Query rebuild information for BROWSE brTable1
     _TblList          = "Temp-Tables.tt-int-estabel-ressuprimento"
     _Options          = "NO-LOCK INDEXED-REPOSITION"
     _FldNameList[1]   = Temp-Tables.tt-int-estabel-ressuprimento.cod-estabel-ressup
     _FldNameList[2]   = Temp-Tables.tt-int-estabel-ressuprimento.cod-depos-ressup
     _Query            is OPENED
*/  /* BROWSE brTable1 */
&ANALYZE-RESUME
...
DO:
    {zoom/implant.i &ProgramImplant="esp/cep/escep086a.w"
                    &PageNumber="1"}
END.
...
------------------------------------------------------------------------------*/
    IF NOT VALID-HANDLE({&hDBOTable1}) OR
       ...
       {&hDBOTable1}:FILE-NAME <> "esbo/boes930.p":U
    THEN DO:
        {btb/btb008za.i1 esbo/boes930.p YES}
        {btb/btb008za.i2 esbo/boes930.p '' {&hDBOTable1}} 
    END.
...
------------------------------------------------------------------------------*/
    ...
    IF AVAILABLE {&ttTable1} THEN DO:
        CASE pcField:
            WHEN "cod-estabel-ressup":U THEN
                ASSIGN pcFieldValue = STRING({&ttTable1}.cod-estabel-ressup).
            WHEN "cod-depos-ressup":U THEN
                ASSIGN pcFieldValue = STRING({&ttTable1}.cod-depos-ressup).
        END CASE.
    END.
