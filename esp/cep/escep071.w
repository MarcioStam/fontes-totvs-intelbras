...
*******************************************************************************/
{include/i-prgvrs.i ESCEP071 1.00.00.000}
...
&GLOBAL-DEFINE Program        ESCEP071
...
&GLOBAL-DEFINE page2Fields    c-cod-estabel dt-data-ini dt-data-fim c-cod-depos-ini c-cod-depos-fim
...
DEFINE VARIABLE c-cod-depos-fim AS CHARACTER FORMAT "X(03)":U INITIAL "ZZZ" 
     VIEW-AS FILL-IN 
     SIZE 9 BY .88
     FONT 1 NO-UNDO.

DEFINE VARIABLE c-cod-depos-ini AS CHARACTER FORMAT "X(03)":U 
     LABEL "Dep¢sito" 
     VIEW-AS FILL-IN 
     SIZE 9 BY .88
     FONT 1 NO-UNDO.
...
DEFINE FRAME fPage2
     c-cod-estabel AT ROW 1.5 COL 12
     dt-data-ini AT ROW 2.5 COL 16.86 WIDGET-ID 4
     dt-data-fim AT ROW 2.5 COL 54.14 NO-LABEL WIDGET-ID 2
     c-cod-depos-ini AT ROW 3.5 COL 20.14 WIDGET-ID 12
     c-cod-depos-fim AT ROW 3.5 COL 54 NO-LABEL WIDGET-ID 10
...
DO  WITH FRAME fPage2:
    ...
    ASSIGN dt-data-ini:SCREEN-VALUE = STRING(TODAY)
           dt-data-fim:SCREEN-VALUE = STRING(TODAY).
...
do on error undo, return error on stop  undo, return error:
    ...
    assign tt-param.usuario         = c-seg-usuario
           ...
           tt-param.dt-ini          = INPUT FRAME fPage2 dt-data-ini
           tt-param.dt-fim          = INPUT FRAME fPage2 dt-data-fim
    ...
    {report/rprun.i esp/cep/escep071rp.p}
