...
*******************************************************************************/
{include/i-prgvrs.i escep054 2.00.00.001}  /*** 010001 ***/
...
DEFINE VARIABLE c-conta AS CHARACTER FORMAT "X(8)":U 
     LABEL "Conta Perdas" 
     VIEW-AS FILL-IN 
...
DEFINE FRAME f-pg-sel
     c-estab AT ROW 1.5 COL 21 COLON-ALIGNED
     c-conta AT ROW 2.5 COL 21 COLON-ALIGNED
     c-cod-depos-ini AT ROW 3.5 COL 21 COLON-ALIGNED
     c-cod-depos-fim AT ROW 3.5 COL 47 COLON-ALIGNED NO-LABEL
     dt-trans-ini AT ROW 4.5 COL 21 COLON-ALIGNED
     dt-trans-fim AT ROW 4.5 COL 47 COLON-ALIGNED NO-LABEL
     IMAGE-1 AT ROW 3.5 COL 41
     IMAGE-2 AT ROW 3.5 COL 46
     IMAGE-3 AT ROW 4.5 COL 41
     IMAGE-4 AT ROW 4.5 COL 46
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 3 ROW 3
         SIZE 75 BY 10.
...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW C-Win ASSIGN
         HIDDEN             = YES
         TITLE              = "Listagem Itens Requisitados"
         HEIGHT             = 15
         WIDTH              = 81.14
         MAX-HEIGHT         = 22.75
         MAX-WIDTH          = 114.29
...
/*
       run spp\cdp\spcd031.p (INPUT "escep054").
...
{utp/ut9000.i "escep054" "2.00.00.001"}
...
------------------------------------------------------------------------------*/
  ...
  DISPLAY dt-trans-ini dt-trans-fim c-estab c-conta c-cod-depos-ini c-cod-depos-fim
      WITH FRAME f-pg-sel IN WINDOW C-Win.
  ENABLE IMAGE-1 IMAGE-2 IMAGE-3 IMAGE-4 c-estab c-conta 
         c-cod-depos-ini c-cod-depos-fim dt-trans-ini dt-trans-fim
      WITH FRAME f-pg-sel IN WINDOW C-Win.
  {&OPEN-BROWSERS-IN-QUERY-f-pg-sel}
  VIEW C-Win.
END PROCEDURE.
...
-------------------------------------------------------------*/
    DO WITH FRAME f-pg-sel:
        ASSIGN c-estab:SCREEN-VALUE = v_cod_estab_usuar
               c-conta:SCREEN-VALUE = "33370020"
               dt-trans-ini:SCREEN-VALUE = STRING(TODAY)
               dt-trans-fim:SCREEN-VALUE = STRING(TODAY).
    END.
END PROCEDURE.
...
do  on error undo, return error
    ...
    if  (input frame f-pg-sel dt-trans-fim - input frame f-pg-sel dt-trans-ini) > 31 then do:
        run utp/ut-msgs.p ("show", 15825, "Informe um per¡odo menor ou igual a 31 dias").
        return no-apply.
    end.
    ...
    assign tt-param.usuario        = c-seg-usuario
           ...
           tt-param.conta          = INPUT FRAME f-pg-sel c-conta
           ...
           tt-param.cod-estab     = INPUT FRAME f-pg-sel c-estab.
    ...
    {include/i-rprun.i esp/cep/escep054rp.p}
