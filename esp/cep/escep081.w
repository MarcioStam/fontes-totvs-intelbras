...
*******************************************************************************/
{include/i-prgvrs.i ESCEP081 2.00.00.000}
...
DEFINE VARIABLE h_escep081-q01 AS HANDLE NO-UNDO.
DEFINE VARIABLE h_escep081-v01 AS HANDLE NO-UNDO.
...
DEFINE FRAME f-cad
    ...
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         ...
         AT COL 1 ROW 1
         SIZE 89.29 BY 14.83 WIDGET-ID 100.
...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'esp/cep/escep081-v01.w':U ,
             INPUT  FRAME f-cad:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_escep081-v01 ).
       RUN set-position IN h_escep081-v01 ( 2.75 , 1.43 ) NO-ERROR.
       /* Size in UIB:  ( 13.00 , 88.57 ) */

       RUN init-object IN THIS-PROCEDURE (
             INPUT  'esp/cep/escep081-q01.w':U ,
             INPUT  FRAME f-cad:HANDLE ,
             INPUT  '':U ,
             OUTPUT h_escep081-q01 ).
       RUN set-position IN h_escep081-q01 ( 1.00 , 58.00 ) NO-ERROR.
       /* Size in UIB:  ( 1.63 , 7.72 ) */

       /* Links to SmartPanel h_p-exihel. */
       RUN add-link IN adm-broker-hdl ( h_p-cadsim , 'State':U , h_p-exihel ).

       /* Links to SmartViewer h_escep081-v01. */
       RUN add-link IN adm-broker-hdl ( h_escep081-q01 , 'Record':U , h_escep081-v01 ).
       RUN add-link IN adm-broker-hdl ( h_p-cadsim , 'TableIO':U , h_escep081-v01 ).

       /* Links to SmartQuery h_escep081-q01. */
       RUN add-link IN adm-broker-hdl ( h_p-exihel , 'State':U , h_escep081-q01 ).
       RUN add-link IN adm-broker-hdl ( h_p-navega , 'Navigation':U , h_escep081-q01 ).
       RUN add-link IN adm-broker-hdl ( h_p-navega , 'State':U , h_escep081-q01 ).
       ...
       RUN adjust-tab-order IN adm-broker-hdl ( h_p-exihel ,
             h_p-cadsim , 'AFTER':U ).
       RUN adjust-tab-order IN adm-broker-hdl ( h_escep081-v01 ,
             h_p-exihel , 'AFTER':U ).
    END. /* Page 0 */
...
------------------------------------------------------------------------------*/
  ...
  {utp/ut9000.i "ESCEP081" "2.00.00.000"}
