...
*******************************************************************************/
{include/i-prgvrs.i escep088 3.00.00.000}
...
DEFINE VARIABLE dt-data-geracao AS DATE FORMAT "99/99/9999":U 
     LABEL "Data Geraá∆o" 
     VIEW-AS FILL-IN 
...
DEFINE FRAME f-pg-sel
     dt-data-geracao AT ROW 3.5 COL 23 COLON-ALIGNED
...
ON END-ERROR OF C-Win /* Geraá∆o Dados BI */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL C-Win C-Win
ON WINDOW-CLOSE OF C-Win /* Geraá∆o Dados BI */
DO:
...
{utp/ut9000.i "escep088" "3.00.00.000"}
...
DO  ON ERROR   UNDO MAIN-BLOCK, LEAVE MAIN-BLOCK
    ...
    RUN enable_UI.
    ASSIGN dt-data-geracao:SCREEN-VALUE IN FRAME f-pg-sel  = string(TODAY).
...
------------------------------------------------------------------------------*/
  ...
  DISPLAY dt-data-geracao 
      WITH FRAME f-pg-sel IN WINDOW C-Win.
  ENABLE RECT-16 dt-data-geracao 
      WITH FRAME f-pg-sel IN WINDOW C-Win.
...
do  on error undo, return error
    ...
    ASSIGN tt-param.usuario        = c-seg-usuario
           ...
           tt-param.data-geracao   = INPUT FRAME f-pg-sel dt-data-geracao
           tt-param.log-rpw        = IF INT(rs-execucao:SCREEN-VALUE IN FRAME f-pg-imp) = 1 THEN NO ELSE YES.
    ...
    {include/i-rprun.i esp/cep/escep088rp.p}
