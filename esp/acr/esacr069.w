...
*******************************************************************************/
{include/i-prgvrs.i esacr069 2.00.00.000}
...
DEFINE VARIABLE c-dir AS CHARACTER FORMAT "X(256)":U 
     LABEL "Diret¢rio" 
     VIEW-AS FILL-IN 
     SIZE 67.57 BY .79 NO-UNDO.
...
DEFINE VARIABLE tg-atu-clientes AS LOGICAL INITIAL no 
     LABEL "Atualizaá∆o de Clientes (Layout 8.6)" 
     VIEW-AS TOGGLE-BOX
...
DEFINE VARIABLE tg-param-comp AS LOGICAL INITIAL no 
     LABEL "ParÉmetros de Compra (Layout 8.8)" 
     VIEW-AS TOGGLE-BOX
     SIZE 27 BY .75 TOOLTIP "Layout 8.8 - Programa ESACR038" NO-UNDO.

DEFINE VARIABLE tg-transacoes AS LOGICAL INITIAL no 
     LABEL "Upload Outras Transaá‰es (Layout 8.5)" 
     VIEW-AS TOGGLE-BOX
...
DEFINE FRAME f-pg-sel
     tg-up-compras AT ROW 2 COL 5 WIDGET-ID 64
     tg-transacoes AT ROW 3 COL 5 WIDGET-ID 62
     tg-atu-clientes AT ROW 4 COL 5 WIDGET-ID 68
     tg-pagtos AT ROW 5 COL 5 WIDGET-ID 72
     tg-param-comp AT ROW 6 COL 5 WIDGET-ID 80
     tg-motivo AT ROW 7 COL 5 WIDGET-ID 78
     c-dir AT ROW 8.75 COL 7.43 COLON-ALIGNED WIDGET-ID 82
     RECT-10 AT ROW 1.63 COL 3 WIDGET-ID 84
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 3 ROW 2.85
         SIZE 76.86 BY 10.62
...
/* SETTINGS FOR FRAME f-pg-sel
                                                                        */
ASSIGN 
       c-dir:READ-ONLY IN FRAME f-pg-sel        = TRUE.
...
{utp/ut9000.i "esacr069" "2.00.00.000"}
...
DO  ON ERROR   UNDO MAIN-BLOCK, LEAVE MAIN-BLOCK
    ...
    IF  AVAIL int-param-supcard THEN DO:
        ASSIGN c-dir:SCREEN-VALUE IN FRAME f-pg-sel = replace(int-param-supcard.diretorio-retorno,"/","\").
    END.
...
------------------------------------------------------------------------------*/
  ...
  DISPLAY tg-up-compras tg-transacoes tg-atu-clientes tg-pagtos tg-param-comp 
          tg-motivo c-dir 
      WITH FRAME f-pg-sel IN WINDOW w-relat.
  ENABLE RECT-10 tg-up-compras tg-transacoes tg-atu-clientes tg-pagtos 
         tg-param-comp tg-motivo c-dir 
      WITH FRAME f-pg-sel IN WINDOW w-relat.
...
do on error undo, return error on stop  undo, return error:
    ...
    assign tt-param.usuario         = c-seg-usuario
           ...
           &endif                   
           tt-param.up-compras      = INPUT FRAME f-pg-sel tg-up-compras 
           tt-param.transacoes      = INPUT FRAME f-pg-sel tg-transacoes 
           tt-param.atu-clientes    = INPUT FRAME f-pg-sel tg-atu-clientes
           tt-param.pagtos          = INPUT FRAME f-pg-sel tg-pagtos     
           tt-param.param-comp      = INPUT FRAME f-pg-sel tg-param-comp 
           tt-param.motivo          = INPUT FRAME f-pg-sel tg-motivo     
           .
    ...
    {include/i-rprun.i esp/acr/esacr069rp.p}
