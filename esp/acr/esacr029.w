/*****************************************************************************
** Programa..............: esp/esacr029.w
** Descriá∆o.............: Envio arquivo SERASA via EDI7
...
{include/i-prgvrs.i esacr029 2.04.00.000}

CREATE WIDGET-POOL.

/* Preprocessors Definitions ---                                      */
&GLOBAL-DEFINE Program        esacr029
...
do on error undo, return error on stop  undo, return error:
    ...
    {report/rprun.i esp/acr/esacr029rp.p}
    {report/rpexc.i}
...
do  on error undo, return error
    ...
    {report/imrun.i esp/acr/esacr029rp.p}
