/*****************************************************************************
** Programa..............: esp/esacr030.w
** Descriá∆o.............: Retorno arquivo SERASA via EDI7
...
{include/i-prgvrs.i esacr030 2.04.00.000}

CREATE WIDGET-POOL.

/* Preprocessors Definitions ---                                      */
&GLOBAL-DEFINE Program        esacr030
...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW wReport ASSIGN
         HIDDEN             = YES
         TITLE              = "Importaá∆o Retorno SERASA - EDI7"
         HEIGHT             = 17
         WIDTH              = 90
         MAX-HEIGHT         = 40.83
         MAX-WIDTH          = 182.86
...
do on error undo, return error on stop  undo, return error:
    ...
    {report/rprun.i esp/acr/esacr030rp.p}
    {report/rpexc.i}
...
do  on error undo, return error
    ...
    {report/imrun.i esp/acr/esacr030rp.p}
