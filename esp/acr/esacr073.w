...
&GLOBAL-DEFINE Program        ESACR073
...
&GLOBAL-DEFINE page4Fields    fi-dt-emis-ini fi-dt-emis-fim
...
DEFINE VARIABLE fi-dt-emis-ini AS DATE FORMAT "99/99/9999"
     LABEL "Dt Emiss∆o" 
     INIT TODAY
     VIEW-AS FILL-IN 
     SIZE 10 BY .88 NO-UNDO.

DEFINE VARIABLE fi-dt-emis-fim AS DATE FORMAT "99/99/9999"
     LABEL "Dt Emiss∆o"
     INIT TODAY
     VIEW-AS FILL-IN 
     SIZE 10 BY .88.

DEFINE VARIABLE ctext1 AS CHARACTER FORMAT "X(14)":U INITIAL "Faixa de Datas" 
      VIEW-AS TEXT 
     SIZE 12 BY .63
     FONT 1 NO-UNDO.
...
DEFINE FRAME fpage4
     fi-dt-emis-ini AT ROW 4   COL 18 COLON-ALIGNED
     IMAGE-1        AT ROW 4   COL 29 COLON-ALIGNED
     IMAGE-2        AT ROW 4   COL 33 COLON-ALIGNED
     fi-dt-emis-fim AT ROW 4   COL 37 COLON-ALIGNED NO-LABEL
     ctext1         AT ROW 2.2 COL 05 COLON-ALIGNED NO-LABEL
     RECT-139       AT ROW 2.5 COL 2.5 WIDGET-ID 80
...
{report/mainblock.i}
  ...
  ASSIGN ctext1:SCREEN-VALUE IN FRAME fpage4 = "Faixa de Datas".
...
do on error undo, return error on stop  undo, return error:                                  
    ...
    IF  INPUT FRAME fpage4 fi-dt-emis-ini = ? 
    OR  INPUT FRAME fpage4 fi-dt-emis-fim = ? THEN DO:
        run utp/ut-msgs.p (input "show", input 17006, input "Datas de in°cio ou fim n∆o foram informadas.").  
        RETURN NO-APPLY.
    END.
                                                                                             
    IF  INPUT FRAME fpage4 fi-dt-emis-ini > INPUT FRAME fpage4 fi-dt-emis-fim THEN DO:
        run utp/ut-msgs.p (input "show", input 17006, input "Data de in°cio n∆o pode ser posterior a data final informada.").  
        RETURN NO-APPLY.
    END.
    ...
    assign tt-param.usuario         = c-seg-usuario                                          
           ...
           tt-param.dt-emis-ini     = INPUT FRAME fpage4 fi-dt-emis-ini
           tt-param.dt-emis-fim     = INPUT FRAME fpage4 fi-dt-emis-fim.
    ...
    {report/rprun.i esp/acr/esacr073rp.p}                                                    
