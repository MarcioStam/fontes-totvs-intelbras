...
{esinc\es0000.i} /* Define Vari†veis Globais */
...
DEFINE VARIABLE c-arquivo AS CHARACTER FORMAT "X(40)":U INITIAL "esacr009b.lst" 
     VIEW-AS FILL-IN 
...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW C-Win ASSIGN
         HIDDEN             = YES
         TITLE              = "Titulos Recuperados- ESACR009B"
         COLUMN             = 20.14
         ROW                = 18.42
         HEIGHT             = 5.25
         WIDTH              = 57.43
...
ON END-ERROR OF C-Win /* Titulos Recuperados- ESACR009B */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL C-Win C-Win
ON WINDOW-CLOSE OF C-Win /* Titulos Recuperados- ESACR009B */
DO:
...
DO:
  ...
  DO.
    RUN prgtec/btb/btb911za.p (INPUT  "esacr009b",
                               INPUT  "1.00.000",
                               INPUT  0,
  ...
  DO.
    ...
    RUN esp/acr/esacr009brp.p(INPUT da-data-ini,
                              INPUT da-data-fim,
                              INPUT da-vencto,
...
DO:
  ...
  if input frame f-relat rs-destino = 2 then do:
      ...
      if input frame f-relat rs-execucao = 1 then
          assign c-arquivo:screen-value in frame f-relat = session:temp-directory + "esacr009b.lst"
                 c-impressora                          = ""
                 c-layout                              = "".
      else
          assign c-arquivo:screen-value in frame f-relat = "esacr009b.lst"
                 c-impressora                          = ""
                 c-layout                              = "".
...
do:
  for each ped_exec no-lock
      where ped_exec.cod_prog_dtsul = "esacr009b"
...
FIND prog_dtsul NO-LOCK
    WHERE prog_dtsul.cod_prog_dtsul = "esacr009b" NO-ERROR.
...
DO:
  FOR EACH usuar_grp_usuar NO-LOCK
    ...
    IF NOT CAN-FIND(FIRST prog_dtsul_segur NO-LOCK
                    WHERE  prog_dtsul_segur.cod_prog_dtsul = "esacr009b"
...
/* */
  ...
  ASSIGN dwb_set_list_param.Cod_dwb_program          = "esacr009b"
