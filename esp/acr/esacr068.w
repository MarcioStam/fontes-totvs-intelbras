...
*******************************************************************************/
{include/i-prgvrs.i esacr068 2.00.00.000}
...
DEFINE VARIABLE tg-pendencias AS LOGICAL INITIAL no 
     LABEL "Upload Outras Transaá‰es (Layout 8.4)" 
     VIEW-AS TOGGLE-BOX
...
DEFINE FRAME f-pg-sel
     tg-clientes AT ROW 2 COL 4 WIDGET-ID 40
     tg-compras AT ROW 3 COL 4 WIDGET-ID 56
     tg-pendencias AT ROW 4 COL 4 WIDGET-ID 2
     RECT-10 AT ROW 1.42 COL 2 WIDGET-ID 62
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 3 ROW 2.85
         SIZE 76.86 BY 10.62
...
/* SETTINGS FOR FRAME f-pg-sel
                                                                        */
/* SETTINGS FOR TOGGLE-BOX tg-clientes IN FRAME f-pg-sel
   NO-ENABLE                                                            */
...
{utp/ut9000.i "esacr068" "2.00.00.000"}
...
------------------------------------------------------------------------------*/
  ...
  DISPLAY tg-clientes tg-compras tg-pendencias 
      WITH FRAME f-pg-sel IN WINDOW w-relat.
  ENABLE RECT-10 tg-compras tg-pendencias 
      WITH FRAME f-pg-sel IN WINDOW w-relat.
...
do on error undo, return error on stop  undo, return error:
    ...
    assign tt-param.usuario         = c-seg-usuario
           ...
           &endif
           tt-param.clientes        = INPUT FRAME f-pg-sel tg-clientes  
           tt-param.compras         = INPUT FRAME f-pg-sel tg-compras   
           tt-param.pendencias      = INPUT FRAME f-pg-sel tg-pendencias
    ...
    {include/i-rprun.i esp/acr/esacr068rp.p}
