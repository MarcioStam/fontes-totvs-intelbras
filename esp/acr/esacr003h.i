/*********************************************************************************
**    PROGRAMA: {esp/acr/esacr003h.i}
**    DATA....: Fev/2020
**    OBJETIVO: Declaracao de variaveis e temp-table para geracao do titulo no acr
*********************************************************************************/
...
def temp-table tt_relac_refer_alter no-undo
    field tta_cod_estab                    as character format "x(3)" label "Estabelecimento" column-label "Estab"
    field tta_cod_refer_orig_ftp           as character format "x(10)" label "Refer¼ncia" column-label "Refer¼ncia"
    field tta_cod_refer_alter_tit          as character format "x(10)" label "Refer¼ncia" column-label "Refer¼ncia"
    field tta_num_id_tit_acr               as integer format "9999999999" initial 0 label "Token Cta Receber" column-label "Token Cta Receber"
    field tta_dat_transacao                as date format "99/99/9999" initial today label "Data Transa»’o" column-label "Dat Transac"
    .
