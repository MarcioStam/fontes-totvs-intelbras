...
*******************************************************************************/
{include/i-prgvrs.i esacr083 2.00.00.000}
...
DEFINE VARIABLE EDITOR-1 AS CHARACTER INITIAL "Estabelecimento~; Esp‚cie~; S‚rie~; T¡tulo~; Parcela~; Vencimento~; Portador~; Carteira~; Condi‡Æo Cobran‡a" 
     VIEW-AS EDITOR
     SIZE 71 BY 4 NO-UNDO.
...
DEFINE FRAME f-pg-sel
     EDITOR-1 AT ROW 1.75 COL 4 NO-LABEL WIDGET-ID 32
     bt-pesquisa AT ROW 9 COL 68 WIDGET-ID 26
     c-arquivo-import AT ROW 9.17 COL 18.57 COLON-ALIGNED WIDGET-ID 28
...
{utp/ut9000.i "esacr083" "2.00.00.000"}
...
------------------------------------------------------------------------------*/
  ...
  DISPLAY EDITOR-1 c-arquivo-import 
      WITH FRAME f-pg-sel IN WINDOW w-relat.
  ENABLE RECT-14 bt-pesquisa c-arquivo-import 
      WITH FRAME f-pg-sel IN WINDOW w-relat.
...
do on error undo, return error on stop  undo, return error:
    ...
    {include/i-rprun.i esp/acr/esacr083rp.p}
