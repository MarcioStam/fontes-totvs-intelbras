...
def var v_cod_tip_fluxo_financ
    ...
    no-undo.
def var v_cod_tip_fluxo_financ_valid
    as character
    format "x(12)":U
    no-undo.
...
def frame f_adp_01_fedex-rateio
    rt_mold
    ...
    with 1 down side-labels no-validate keep-tab-order three-d
         ...
         title "Inclui Rateio Valores".
    /* adjust size of objects in this frame */
    assign bt_can:width-chars   in frame f_adp_01_fedex-rateio = 10.00
           bt_can:height-chars  in frame f_adp_01_fedex-rateio = 01.00
           bt_ok:width-chars    in frame f_adp_01_fedex-rateio = 10.00
           bt_ok:height-chars   in frame f_adp_01_fedex-rateio = 01.00
           bt_sav:width-chars   in frame f_adp_01_fedex-rateio = 10.00
           bt_sav:height-chars  in frame f_adp_01_fedex-rateio = 01.00
           bt_zoo:width-chars   in frame f_adp_01_fedex-rateio = 04.00
           bt_zoo:height-chars  in frame f_adp_01_fedex-rateio = 00.88
           bt_zoo2:width-chars  in frame f_adp_01_fedex-rateio = 04.00
           bt_zoo2:height-chars in frame f_adp_01_fedex-rateio = 00.88
           rt_001:width-chars   in frame f_adp_01_fedex-rateio = 86.57
           rt_001:height-chars  in frame f_adp_01_fedex-rateio = 01.63
           rt_cxcf:width-chars  in frame f_adp_01_fedex-rateio = 86.57
           rt_cxcf:height-chars in frame f_adp_01_fedex-rateio = 01.42
           rt_mold:width-chars  in frame f_adp_01_fedex-rateio = 86.57
           rt_mold:height-chars in frame f_adp_01_fedex-rateio = 05.
    /* set private-data for the help system */
    assign fedex-rateio.cod_cta_ctbl:private-data         in frame f_adp_01_fedex-rateio = "HLP=000010613":U
           cta_ctbl.des_tit_ctbl:private-data                   in frame f_adp_01_fedex-rateio = "HLP=000025188":U
           bt_zoo2:private-data                                 in frame f_adp_01_fedex-rateio = "HLP=000009432":U
           bt_zoo_67475:private-data                            in frame f_adp_01_fedex-rateio = "HLP=000009431":U
           fedex-rateio.cod_unid_negoc:private-data       in frame f_adp_01_fedex-rateio = "HLP=000010622":U
           unid_negoc.des_unid_negoc:private-data               in frame f_adp_01_fedex-rateio = "HLP=000025189":U
           fedex-rateio.cod_ccusto:private-data           in frame f_adp_01_fedex-rateio = "HLP=000010612":U
           bt_zoo:private-data                                  in frame f_adp_01_fedex-rateio = "HLP=000009431":U
           emscad.ccusto.des_tit_ctbl:private-data                     in frame f_adp_01_fedex-rateio = "HLP=000025191":U
           fedex-rateio.perc_aprop_ctbl:private-data       in frame f_adp_01_fedex-rateio = "HLP=000010628":U
           v_val_sdo_rat_tit_ap:private-data                    in frame f_adp_01_fedex-rateio = "HLP=000010894":U
           v_val_tot_rat:private-data                           in frame f_adp_01_fedex-rateio = "HLP=000010897":U
           bt_ok:private-data                                   in frame f_adp_01_fedex-rateio = "HLP=000010721":U
           bt_sav:private-data                                  in frame f_adp_01_fedex-rateio = "HLP=000011048":U
           bt_can:private-data                                  in frame f_adp_01_fedex-rateio = "HLP=000011050":U
           frame f_adp_01_fedex-rateio:private-data                                            = "HLP=000010611".
    /* enable function buttons */
    assign bt_zoo_67475:sensitive in frame f_adp_01_fedex-rateio = yes.
...
ON CHOOSE OF bt_can IN FRAME f_adp_01_fedex-rateio
DO:

    apply "end-error" to self.
END. /* ON CHOOSE OF bt_can IN FRAME f_adp_01_fedex-rateio */

ON CHOOSE OF bt_ok IN FRAME f_adp_01_fedex-rateio
DO:

    assign v_log_repeat = no.
    /* ix_g20_add_fedex-rateio */

END. /* ON CHOOSE OF bt_ok IN FRAME f_adp_01_fedex-rateio */

ON CHOOSE OF bt_sav IN FRAME f_adp_01_fedex-rateio
DO:

    assign v_log_repeat = yes.
    /* ix_g30_add_fedex-rateio */

END. /* ON CHOOSE OF bt_sav IN FRAME f_adp_01_fedex-rateio */

ON CHOOSE OF bt_zoo IN FRAME f_adp_01_fedex-rateio
DO:

    if input frame f_adp_01_fedex-rateio fedex-rateio.cod_unid_negoc <> "" then do:
            run esp/acr/esacr004n.p (Input input frame f_adp_01_fedex-rateio fedex-rateio.cod_unid_negoc,
    ...
    if v_rec_ccusto <> ? then do:
        ...
        assign fedex-rateio.cod_ccusto:screen-value in frame f_adp_01_fedex-rateio = string(ccusto.cod_ccusto).

        display ccusto.des_tit_ctbl
                with frame f_adp_01_fedex-rateio.
    end.
    apply "Entry" /*l_entry*/  to fedex-rateio.cod_ccusto in frame f_adp_01_fedex-rateio.
END. /* ON CHOOSE OF bt_zoo IN FRAME f_adp_01_fedex-rateio */

ON CHOOSE OF bt_zoo2 IN FRAME f_adp_01_fedex-rateio
DO:
    ...
    then do:
       ...
       assign fedex-rateio.cod_cta_ctbl:screen-value in frame f_adp_01_fedex-rateio =
       ...
       display cta_ctbl.des_tit_ctbl
               with frame f_adp_01_fedex-rateio.
       apply "entry" to fedex-rateio.cod_cta_ctbl in frame f_adp_01_fedex-rateio.
    end /* if */.

END. /* ON CHOOSE OF bt_zoo2 IN FRAME f_adp_01_fedex-rateio */

ON ENTRY OF fedex-rateio.cod_ccusto IN FRAME f_adp_01_fedex-rateio
DO:

    if avail plano_ccusto then
       assign fedex-rateio.cod_ccusto:format in frame f_adp_01_fedex-rateio = plano_ccusto.cod_format_ccusto.
    else
       assign fedex-rateio.cod_ccusto:format in frame f_adp_01_fedex-rateio = 'x(11)'.
END. /* ON ENTRY OF fedex-rateio.cod_ccusto IN FRAME f_adp_01_fedex-rateio */

ON LEAVE OF fedex-rateio.cod_ccusto IN FRAME f_adp_01_fedex-rateio
DO:
...
END. /* ON LEAVE OF fedex-rateio.cod_ccusto IN FRAME f_adp_01_fedex-rateio */

ON ENTRY OF fedex-rateio.cod_cta_ctbl IN FRAME f_adp_01_fedex-rateio
DO:

    assign fedex-rateio.cod_cta_ctbl:format in frame f_adp_01_fedex-rateio = "x(20)" /*l_x20*/ .
END. /* ON ENTRY OF fedex-rateio.cod_cta_ctbl IN FRAME f_adp_01_fedex-rateio */

ON LEAVE OF fedex-rateio.cod_cta_ctbl IN FRAME f_adp_01_fedex-rateio
DO:

    run pi_leave_cod_cta_ctbl (Input p_dat_transacao) /*pi_leave_cod_cta_ctbl*/.

END. /* ON LEAVE OF fedex-rateio.cod_cta_ctbl IN FRAME f_adp_01_fedex-rateio */

ON LEAVE OF fedex-rateio.cod_unid_negoc IN FRAME f_adp_01_fedex-rateio
DO:

    /* Possibilita a utilizaá∆o do n£mero da UN */

    find unid_negoc no-lock
         where unid_negoc.cod_unid_negoc = input frame f_adp_01_fedex-rateio fedex-rateio.cod_unid_negoc
         use-index ndngc_id
          /*cl_frame of unid_negoc*/ no-error.
    if not avail unid_negoc then do:
        find unid_negoc no-lock
             where unid_negoc.cdn_unid_negoc = int(input frame f_adp_01_fedex-rateio fedex-rateio.cod_unid_negoc)
             use-index ndngc_cdn no-error.
        if avail unid_negoc then
            assign fedex-rateio.cod_unid_negoc:screen-value in frame f_adp_01_fedex-rateio = unid_negoc.cod_unid_negoc.
    end.
    display unid_negoc.des_unid_negoc when avail unid_negoc
            "" when not avail unid_negoc @ unid_negoc.des_unid_negoc
            with frame f_adp_01_fedex-rateio.
END. /* ON LEAVE OF fedex-rateio.cod_unid_negoc IN FRAME f_adp_01_fedex-rateio */
...
ON  CHOOSE OF bt_zoo_67475 IN FRAME f_adp_01_fedex-rateio
OR F5 OF fedex-rateio.cod_unid_negoc IN FRAME f_adp_01_fedex-rateio DO:
    ...
    then do:
        ...
        assign fedex-rateio.cod_unid_negoc:screen-value in frame f_adp_01_fedex-rateio =
    ...
    apply "entry" to fedex-rateio.cod_unid_negoc in frame f_adp_01_fedex-rateio.
end. /* ON  CHOOSE OF bt_zoo_67475 IN FRAME f_adp_01_fedex-rateio */

/*************************** Function Trigger End ***************************/

/**************************** Frame Trigger Begin ***************************/

ON END-ERROR OF FRAME f_adp_01_fedex-rateio
DO:

    assign v_rec_fedex-rateio = v_rec_table_sav.
END. /* ON END-ERROR OF FRAME f_adp_01_fedex-rateio */

ON WINDOW-CLOSE OF FRAME f_adp_01_fedex-rateio
DO:

    apply "end-error" to self.
END. /* ON WINDOW-CLOSE OF FRAME f_adp_01_fedex-rateio */
...
***/
assign v_wgh_frame           = frame f_adp_01_fedex-rateio:handle
...
assign frame f_adp_01_fedex-rateio:title = frame f_adp_01_fedex-rateio:title
                            + chr(32)
                            + chr(40)
                            + trim(" 1.00.00.000":U)
                            + chr(41).
...
pause 0 before-hide.
view frame f_adp_01_fedex-rateio.
...
repeat while v_log_repeat:
    /* ix_p10_add_fedex-rateio */
    assign v_log_repeat  = no
           v_log_save_ok = no.

    FIND fedex NO-LOCK
        WHERE fedex.numero = p_numero NO-ERROR.
    IF NOT AVAIL fedex 
    THEN DO:
         MESSAGE "Fedex n∆o localizado !"
             VIEW-AS ALERT-BOX INFO BUTTONS OK.
         RETURN.
    END.

    FIND estabelecimento NO-LOCK
        WHERE estabelecimento.cod_estab = fedex.cod_estab NO-ERROR.

    create fedex-rateio.
    ASSIGN fedex-rateio.numero = p_numero.
    if  not retry
    then do:
        assign v_rec_table_sav = v_rec_table.
        assign ccusto.des_tit_ctbl:screen-value                   in frame f_adp_01_fedex-rateio = ""
               cta_ctbl.des_tit_ctbl:screen-value                 in frame f_adp_01_fedex-rateio = ""
               unid_negoc.des_unid_negoc:screen-value             in frame f_adp_01_fedex-rateio = "".
    ...
    /* Begin_Include: ix_p20_add_fedex-rateio */
    run pi_ix_p20_add_fedex-rateio (Input p_val_tit_ap,
                                    Input p_dat_transacao) /*pi_ix_p20_add_fedex-rateio*/.

    wait_block:
    repeat on endkey undo main_block, leave main_block while v_log_save_ok = no:
        if  valid-handle(v_wgh_focus)
        then do:
            wait-for go of frame f_adp_01_fedex-rateio focus v_wgh_focus.
        end /* if */.
        else do:
            wait-for go of frame f_adp_01_fedex-rateio.
        end /* else */.
        save_block:
        do on error undo save_block, leave save_block:
            /* ix_p25_add_fedex-rateio */
            run pi_save_key /*pi_save_key*/.
            run pi_save_fields /*pi_save_fields*/.

            /* Begin_Include: ix_p27_add_fedex-rateio */
            run pi_ix_p27_add_fedex-rateio (Input p_dat_transacao) /*pi_ix_p27_add_fedex-rateio*/.
            assign v_dat_trans_param           = p_dat_transacao
                   v_val_tit_ap_param          = p_val_tit_ap.
            assign v_cdn_cont = 1.

            /* L¢gica acrescentada para funcionar corretamente em bases progress inglàs */
            assign v_rec_fedex-rateio = recid(fedex-rateio).
            release fedex-rateio.
            find fedex-rateio exclusive-lock
                 where recid(fedex-rateio) = v_rec_fedex-rateio no-error.
            /* End_Include: ix_p27_add_fedex-rateio */

            run pi_vld_fedex-rateio /*pi_vld_fedex-rateio*/.

            assign v_log_save_ok = yes.
        end /* do save_block */.
    end /* repeat wait_block */.
    assign v_rec_table    = recid(fedex-rateio)
           v_rec_fedex-rateio = recid(fedex-rateio).
end /* repeat main_block */.

hide frame f_adp_01_fedex-rateio.
...
PROCEDURE pi_save_key:
    ...
    do on error undo assign_block, return error:
        find b_fedex-rateio_add no-lock
             where b_fedex-rateio_add.numero = p_numero
               and b_fedex-rateio_add.cod_plano_cta_ctbl = "PADRAO"
               and b_fedex-rateio_add.cod_cta_ctbl = input frame f_adp_01_fedex-rateio fedex-rateio.cod_cta_ctbl
               and b_fedex-rateio_add.cod_unid_negoc = input frame f_adp_01_fedex-rateio fedex-rateio.cod_unid_negoc
               and b_fedex-rateio_add.cod_plano_ccusto = "PADRAO"
               and b_fedex-rateio_add.cod_ccusto = input frame f_adp_01_fedex-rateio fedex-rateio.cod_ccusto no-error.
        if  avail b_fedex-rateio_add
        then do:
            if  recid(b_fedex-rateio_add) <> recid(fedex-rateio)
            then do:
                /* &1 j† existente ! */
            ...
            do with frame f_adp_01_fedex-rateio:
            end.
            assign input frame f_adp_01_fedex-rateio fedex-rateio.cod_cta_ctbl
                   input frame f_adp_01_fedex-rateio fedex-rateio.cod_unid_negoc
                   input frame f_adp_01_fedex-rateio fedex-rateio.cod_ccusto no-error.
            ASSIGN fedex-rateio.cod_plano_cta_ctbl = "PADRAO".
...
PROCEDURE pi_save_fields:
    ...
    do on error undo assign_block, return error:
        ...
        assign input frame f_adp_01_fedex-rateio fedex-rateio.perc_aprop_ctbl.
        assign v_wgh_focus = ?.
    end /* do assign_block */.

    /* Foráar a criaá∆o do registro com bases Oracle */    if recid(fedex-rateio) <> ?  then.
END PROCEDURE. /* pi_save_fields */
/*****************************************************************************
** Procedure Interna.....: pi_vld_fedex-rateio
** Descricao.............: pi_vld_fedex-rateio
** Criado por............: rafael
** Criado em.............: // 
** Alterado por..........: src12115
** Alterado em...........: 15/08/2003 11:24:01
*****************************************************************************/
PROCEDURE pi_vld_fedex-rateio:
    ...
    /* **  Verifica se foi informado algum valor para a Apropriaá∆o ***/
        ...
        then do:
            ...
            run pi_integr_apb_cria_msg_erro (Input "fedex-rateio":U + "." + "perc_aprop_ctbl",
        ...
        /* **  Valida Conta Cont†bil e Plano de Contas ***/
        ...
        ***/
        run pi_validar_rateio_ctbl_ap (Input v_dat_trans_param,
                                       Input v_cod_estab_param,
                                       Input v_cod_refer_param,
                                       Input v_num_seq_refer_param,
                                       Input v_val_tit_ap_param,
                                       Input v_rec_impto_impl_pend_param) /*pi_validar_rateio_ctbl_ap*/.
    end /* do vld_block */.
...
PROCEDURE pi_validar_rateio_ctbl_ap:
    ...
    do on error undo validar_block, return error:
        ...
        /* ** Valida Plano de Centro de Custos ***/
                if  v_ind_criter_distrib_ccusto = "N∆o Utiliza" /*l_nao_utiliza*/  
                then do:
...
PROCEDURE pi_leave_cod_cta_ctbl:
    ...
    find cta_ctbl no-lock
        ...
        and   cta_ctbl.cod_cta_ctbl       = input frame f_adp_01_fedex-rateio fedex-rateio.cod_cta_ctbl no-error.
    ...
    then do:
        ...
        assign v_cod_format_cta_ctbl = plano_cta_ctbl.cod_format_cta_ctbl
               fedex-rateio.cod_cta_ctbl:format in frame f_adp_01_fedex-rateio = plano_cta_ctbl.cod_format_cta_ctbl
               v_cod_format = input frame f_adp_01_fedex-rateio fedex-rateio.cod_cta_ctbl no-error.
        ...
        then do:
             assign fedex-rateio.cod_plano_ccusto = ""
                    fedex-rateio.cod_ccusto:screen-value       in frame f_adp_01_fedex-rateio = ""
                    emscad.ccusto.des_tit_ctbl:screen-value      in frame f_adp_01_fedex-rateio = "".
        ...
        find cta_ctbl no-lock
            where cta_ctbl.cod_plano_cta_ctbl  = "PADRAO"
            and   cta_ctbl.cod_altern_cta_ctbl = input frame f_adp_01_fedex-rateio fedex-rateio.cod_cta_ctbl no-error.
        if  avail cta_ctbl
        then do:
            assign v_cod_cta_ctbl = cta_ctbl.cod_cta_ctbl.
            find criter_distrib_cta_ctbl no-lock
            ...
            then do:
                assign fedex-rateio.cod_plano_ccusto = ""
                       fedex-rateio.cod_ccusto:screen-value       in frame f_adp_01_fedex-rateio = ""
                       ccusto.des_tit_ctbl:screen-value           in frame f_adp_01_fedex-rateio = "".
                disable fedex-rateio.cod_ccusto
                        bt_zoo
                        with frame f_adp_01_fedex-rateio.
                assign v_ind_criter_distrib_ccusto = "N∆o Utiliza" /*l_nao_utiliza*/ .
            ...
            run pi_retornar_inic_zero (Input fedex-rateio.cod_cta_ctbl:handle in frame f_adp_01_fedex-rateio,
                                       Input plano_cta_ctbl.cod_format_cta_ctbl) /*pi_retornar_inic_zero*/.
            assign fedex-rateio.cod_cta_ctbl:screen-value in frame f_adp_01_fedex-rateio = cta_ctbl.cod_cta_ctbl.
            display cta_ctbl.des_tit_ctbl when avail cta_ctbl
                    "" when not avail cta_ctbl @ cta_ctbl.des_tit_ctbl
                    with frame f_adp_01_fedex-rateio.
        end /* if */.
        else do:
             assign cta_ctbl.des_tit_ctbl:screen-value in frame f_adp_01_fedex-rateio = "".
             disable fedex-rateio.cod_ccusto
                     bt_zoo
                     with frame f_adp_01_fedex-rateio.
        end /* else */.
...
/*****************************************************************************
** Procedure Interna.....: pi_leave_cod_plano_ccusto
** Descricao.............: pi_leave_cod_plano_ccusto
** Criado por............: bre17230
** Criado em.............: 09/10/1998 15:15:39
** Alterado por..........: src531
** Alterado em...........: 18/03/2004 19:15:05
*****************************************************************************/
PROCEDURE pi_leave_cod_plano_ccusto:

    find plano_ccusto no-lock
         where plano_ccusto.cod_empresa      = estabelecimento.cod_empresa
           and plano_ccusto.cod_plano_ccusto = "PADRAO" NO-ERROR.
    if  avail plano_ccusto
    then do:
        assign v_rec_plano_ccusto = recid(plano_ccusto)
               v_cod_format_ccusto  = plano_ccusto.cod_format_ccusto.

        if  v_cod_plano_ccusto_old <> plano_ccusto.cod_plano_ccusto
        then do:
            run pi_retornar_inic_zero (Input fedex-rateio.cod_ccusto:handle in frame f_adp_01_fedex-rateio,
                                       Input plano_ccusto.cod_format_ccusto) /*pi_retornar_inic_zero*/.
            assign v_cod_plano_ccusto_old = plano_ccusto.cod_plano_ccusto.
        end /* if */.
        find emscad.ccusto no-lock
             where ccusto.cod_empresa      = estabelecimento.cod_empresa
             and   ccusto.cod_plano_ccusto = "PADRAO"
             and   ccusto.cod_ccusto       = fedex-rateio.cod_ccusto:screen-value in frame f_adp_01_fedex-rateio no-error.
        if not avail ccusto then do:
           run pi_retornar_ccusto_inic (Input plano_ccusto.cod_format_ccusto,
                                        output v_cod_ccusto_000) /*pi_retornar_ccusto_inic*/.
           assign fedex-rateio.cod_ccusto:screen-value = v_cod_ccusto_000.
        end.
        assign fedex-rateio.cod_ccusto:format in frame f_adp_01_fedex-rateio = plano_ccusto.cod_format_ccusto.
    end /* if */.
    return "OK" /*l_ok*/ .
END PROCEDURE. /* pi_leave_cod_plano_ccusto */
/*****************************************************************************
...
PROCEDURE pi_leave_cod_ccusto:
    ...
    if avail plano_ccusto then do:
       assign v_cod_format_1 = input frame f_adp_01_fedex-rateio fedex-rateio.cod_ccusto no-error.
    ...
    if  avail plano_ccusto 
    and input frame f_adp_01_fedex-rateio fedex-rateio.cod_ccusto <> "" then do:
        assign v_cod_format_1 = input frame f_adp_01_fedex-rateio fedex-rateio.cod_ccusto
               fedex-rateio.cod_ccusto:format in frame f_adp_01_fedex-rateio = plano_ccusto.cod_format_ccusto
    ...
    find emscad.ccusto no-lock
        where ccusto.cod_empresa = estabelecimento.cod_empresa
        and   ccusto.cod_plano_ccusto = "PADRAO"
        and   ccusto.cod_ccusto = input frame f_adp_01_fedex-rateio fedex-rateio.cod_ccusto
...
/*****************************************************************************
** Procedure Interna.....: pi_ix_p20_add_fedex-rateio
** Descricao.............: pi_ix_p20_add_fedex-rateio
** Criado por............: bre17230
** Criado em.............: 10/10/1998 16:19:07
** Alterado por..........: fut35183
** Alterado em...........: 24/09/2007 09:31:26
*****************************************************************************/
PROCEDURE pi_ix_p20_add_fedex-rateio:
    ...
    assign v_wgh_focus = fedex-rateio.cod_cta_ctbl:handle in frame f_adp_01_fedex-rateio.
    ...
    display v_val_sdo_rat_tit_ap
            v_val_tot_rat
            with frame f_adp_01_fedex-rateio.
    assign fedex-rateio.perc_aprop_ctbl:screen-value in frame f_adp_01_fedex-rateio = string(v_val_sdo_rat_tit_ap).

    assign fedex-rateio.cod_plano_ccusto = v_cod_plano_ccusto_corren
           fedex-rateio.cod_ccusto       = v_cod_ccusto_corren.
    ...
    assign fedex-rateio.cod_plano_cta_ctbl = v_cod_plano_cta_ctbl
           fedex-rateio.cod_plano_ccusto   = "PADRAO".
    ...
    and v_log_return = no then do:
        ...
        then do:
            ...
            if  v_log_return = yes
            then do:
                assign fedex-rateio.cod_unid_negoc:screen-value in frame f_adp_01_fedex-rateio = v_cod_unid_negoc.
                disable fedex-rateio.cod_unid_negoc
                        bt_zoo_67475
                        with frame f_adp_01_fedex-rateio.
            end /* if */.
        ...
        RUN pi_leave_cod_plano_ccusto.
        assign fedex-rateio.cod_ccusto:screen-value in frame f_adp_01_fedex-rateio = "00000000000".
        apply "leave" to fedex-rateio.cod_ccusto in frame f_adp_01_fedex-rateio.
        find plano_cta_ctbl no-lock
             where plano_cta_ctbl.cod_plano_cta_ctbl = "PADRAO" NO-ERROR.
        if  avail plano_cta_ctbl
        then do:
             if  v_cod_plano_cta_ctbl_old <> "PADRAO"
             then do:
                 assign fedex-rateio.cod_cta_ctbl:format in frame f_adp_01_fedex-rateio = plano_cta_ctbl.cod_format_cta_ctbl
                        v_cod_format_cta_ctbl = plano_cta_ctbl.cod_format_cta_ctbl
                        fedex-rateio.cod_cta_ctbl:format in frame f_adp_01_fedex-rateio = plano_cta_ctbl.cod_format_cta_ctbl no-error.
                 assign v_cod_plano_cta_ctbl_old = "PADRAO".
             end /* if */.
        end /* if */.
        else do:
             assign fedex-rateio.cod_cta_ctbl:format in frame f_adp_01_fedex-rateio = 'x(20)'.
        end /* else */.
        assign fedex-rateio.cod_cta_ctbl:screen-value in frame f_adp_01_fedex-rateio = "00000000000000000000".
        apply "leave" to fedex-rateio.cod_cta_ctbl in frame f_adp_01_fedex-rateio.
        ...
        if v_cod_cta_ctbl_2 <> "" 
        and (input frame f_adp_01_fedex-rateio fedex-rateio.cod_cta_ctbl = ""
        or   input frame f_adp_01_fedex-rateio fedex-rateio.cod_cta_ctbl = v_cod_cta_ctbl_3) then do:
        ...
        if v_cod_ccusto_2 <> "" 
        and (input frame f_adp_01_fedex-rateio fedex-rateio.cod_ccusto = "" 
        or   input frame f_adp_01_fedex-rateio fedex-rateio.cod_ccusto = v_cod_ccusto_aux) then do:
        ...
        if  v_cod_unid_negoc_2 <> "" /*l_*/  and input frame f_adp_01_fedex-rateio fedex-rateio.cod_unid_negoc = "" /*l_*/ 
        then do:
            assign fedex-rateio.cod_unid_negoc:screen-value in frame f_adp_01_fedex-rateio = v_cod_unid_negoc_2.
            apply "leave" to fedex-rateio.cod_unid_negoc in frame f_adp_01_fedex-rateio.
        end /* if */.
        find cta_ctbl no-lock
            where cta_ctbl.cod_plano_cta_ctbl = "PADRAO"
            and   cta_ctbl.cod_cta_ctbl = input frame f_adp_01_fedex-rateio fedex-rateio.cod_cta_ctbl no-error.
...
END PROCEDURE. /* pi_ix_p20_add_fedex-rateio */
/*****************************************************************************
