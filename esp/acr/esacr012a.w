...
/*****************************************************************************
**     Programa.........: esp/acr/esacr012a
**     Descricao .......: Relat¢rio 
**     Versao...........: 1.00.000
**     Autor............: Catia Schmach - Gestech
**     Criado...........: 03/02/2004
**     Desc. Atualizaá∆o: 
**     Autor............: 
*******************************************************************************/
...
{esp/acr/esacr012tt.i}   /* Define Temp-table */
...
DEFINE VARIABLE c-arquivo AS CHARACTER FORMAT "X(40)":U INITIAL "esacr012a.lst" 
     VIEW-AS FILL-IN 
...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW C-Win ASSIGN
         HIDDEN             = YES
         TITLE              = "Titulos Recuperados- ESACR012A"
         COLUMN             = 52.57
         ROW                = 4.04
         HEIGHT             = 5.25
         WIDTH              = 57.43
...
ON END-ERROR OF C-Win /* Titulos Recuperados- ESACR012A */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL C-Win C-Win
ON WINDOW-CLOSE OF C-Win /* Titulos Recuperados- ESACR012A */
DO:
...
DO:
  ...
  DO.
    RUN prgtec/btb/btb911za.p (INPUT  "esacr012a",
                               INPUT  "1.00.000",
                               INPUT  0,
  ...
  DO.
    ...
    RUN esp\acr\esacr012arp.p(INPUT TABLE tt_tit_acr,
                             INPUT rs-opcao ).
...
DO:
  ...
  if input frame f-relat rs-destino = 2 then do:
      ...
      if input frame f-relat rs-execucao = 1 then
          assign c-arquivo:screen-value in frame f-relat = session:temp-directory + "esacr012a.lst"
                 c-impressora                          = ""
                 c-layout                              = "".
      else
          assign c-arquivo:screen-value in frame f-relat = "esacr012a.lst"
                 c-impressora                          = ""
                 c-layout                              = "".
...
do:
  for each ped_exec no-lock
      where ped_exec.cod_prog_dtsul = "esacr012a"
...
FIND prog_dtsul NO-LOCK
    WHERE prog_dtsul.cod_prog_dtsul = "esacr012a" NO-ERROR.
...
DO:
  FOR EACH usuar_grp_usuar NO-LOCK
    ...
    IF NOT CAN-FIND(FIRST prog_dtsul_segur NO-LOCK
                    WHERE  prog_dtsul_segur.cod_prog_dtsul = "esacr012a"
...
/* */
  ...
  ASSIGN dwb_set_list_param.Cod_dwb_program          = "esacr012a"
