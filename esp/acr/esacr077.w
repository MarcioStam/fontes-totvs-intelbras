...
{include/i-prgvrs.i esacr077 2.01.00.000}

CREATE WIDGET-POOL.

/* Preprocessors Definitions ---                                      */
&GLOBAL-DEFINE Program        esacr077
...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW wReport ASSIGN
         HIDDEN             = YES
         TITLE              = "Exportaá∆o Envio SERASA - EDI7"
         HEIGHT             = 17
         WIDTH              = 90
         MAX-HEIGHT         = 40.83
         MAX-WIDTH          = 182.86
...
ON END-ERROR OF wReport /* Geraá∆o e-mail AVA - ACR */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL wReport wReport
ON WINDOW-CLOSE OF wReport /* Geraá∆o e-mail AVA - ACR */
DO:
...
do on error undo, return error on stop  undo, return error:
    ...
    {report/rprun.i esp/acr/esacr077rp.p}
    {report/rpexc.i}
...
do  on error undo, return error
    ...
    {report/imrun.i esp/acr/esacr077rp.p}
