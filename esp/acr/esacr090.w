...
*******************************************************************************/
{include/i-prgvrs.i esacr090 1.00.00.000}
...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW w-relat ASSIGN
         HIDDEN             = YES
         TITLE              = "ESACR090 - Liquidacoes Usando Creditos Lucree"
         HEIGHT             = 15
         WIDTH              = 81.14
         MAX-HEIGHT         = 28.92
         MAX-WIDTH          = 146.29
...
ON END-ERROR OF w-relat /* ESACR090 - Liquidacoes Usando Creditos Lucree */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL w-relat w-relat
ON WINDOW-CLOSE OF w-relat /* ESACR090 - Liquidacoes Usando Creditos Lucree */
DO:
...
{utp/ut9000.i "esacr090" "1.00.00.000"}
...
do on error undo, return error on stop  undo, return error:
    ...
    //RUN esp/pdp/espdp102rp.p.
    {include/i-rprun.i esp/acr/esacr090rp.p}
