/*********************************************************************************
**    PROGRAMA: {esp/acr/esacr082.i}
**    DATA....: Jan/2020
**    OBJETIVO: Declaracao de variaveis e temp-table para geracao da liquida‡Æo 
*********************************************************************************/

DEF TEMP-TABLE tt_antecip NO-UNDO
    FIELD v_empresa            LIKE tit_acr.cod_empresa
    FIELD v_estab              LIKE tit_acr.cod_estab       
    FIELD v_espec_docto        LIKE tit_acr.cod_espec_docto 
    FIELD v_ser_docto          LIKE tit_acr.cod_ser_docto   
    FIELD v_tit_acr            LIKE tit_acr.cod_tit_acr     
    FIELD v_parcela            LIKE tit_acr.cod_parcela     
    FIELD v_cliente            LIKE tit_acr.cdn_cliente     
    FIELD v_abrev              LIKE tit_acr.nom_abrev       
    FIELD v_emis_docto         LIKE tit_acr.dat_emis_docto  
    FIELD v_sdo_tit_acr        LIKE tit_acr.val_sdo_tit_acr
    FIELD v_seq                AS   INT
    INDEX id
          v_estab       ASCENDING
          v_espec_docto ASCENDING
          v_ser_docto   ASCENDING
          v_tit_acr     ASCENDING
          v_parcela     ASCENDING
    INDEX cli
          v_empresa     ASCENDING
...
DEF TEMP-TABLE tt_dp_x_an NO-UNDO
    FIELD v_estab              LIKE tit_acr.cod_estab       
    FIELD v_espec_docto        LIKE tit_acr.cod_espec_docto 
    FIELD v_ser_docto          LIKE tit_acr.cod_ser_docto   
    FIELD v_tit_acr            LIKE tit_acr.cod_tit_acr     
    FIELD v_parcela            LIKE tit_acr.cod_parcela     
    FIELD v_abat_an            LIKE tit_acr.val_sdo_tit_acr.

DEF TEMP-TABLE tt_dp_x_an_rel  NO-UNDO
    FIELD v_estab              LIKE tit_acr.cod_estab       
    FIELD v_espec_docto        LIKE tit_acr.cod_espec_docto 
    FIELD v_ser_docto          LIKE tit_acr.cod_ser_docto   
    FIELD v_tit_acr            LIKE tit_acr.cod_tit_acr     
    FIELD v_parcela            LIKE tit_acr.cod_parcela     
    FIELD v_abat_an            LIKE tit_acr.val_sdo_tit_acr
    FIELD v_seq_an             AS   INT
    INDEX seq_an
          v_seq_an ASCENDING.

DEF TEMP-TABLE tt_erros NO-UNDO
    FIELD ttv_cod_message     AS CHAR FORMAT "999999" 
    FIELD ttv_des_msg_erro    AS CHAR FORMAT "x(60)"  
    FIELD ttv_des_msg_ajuda   AS CHAR FORMAT "x(40)"
...
/********************* Temporary Table Definition Begin (API BXA) *********************/
...
def temp-table tt_integr_acr_liquidac_lote no-undo
    ...
    field tta_dat_transacao                as date format "99/99/9999" initial 06/30/2009 label "Data Transa‡Æo" column-label "Dat Transac"
...
DEF VAR v_erro             AS CHAR   FORMAT "X(100)"         NO-UNDO.
DEF VAR v_val_seq          AS INT                    INIT 0  NO-UNDO.     
DEF VAR v_cont_an          AS INT                            NO-UNDO.
DEF VAR v_cont_dp          AS INT                            NO-UNDO.
DEF VAR v_cod_refer        AS CHAR   FORMAT "x(010)"         NO-UNDO.
DEF VAR v_hld_handle       AS HANDLE                         NO-UNDO.
DEF VAR v_espec_antec      AS CHAR   FORMAT "X(200)" INIT "" NO-UNDO.
DEF VAR v_nom_file_name    AS CHAR   FORMAT "x(200)"         NO-UNDO.
DEF VAR v_log_checa_ctbz   AS LOG                            NO-UNDO.
DEF VAR v_log_ctbz_normal  AS LOG                            NO-UNDO.
DEF VAR v_log_ctbz_antecip AS LOG                            NO-UNDO.
DEF VAR v_cod_finalid_econ AS CHAR   FORMAT "x(010)"         NO-UNDO.
                                                                            
DEF VAR v_val_abat         AS DEC FORMAT "->>>,>>>,>>9.99"    DECIMALS 2 INIT 0 NO-UNDO.
DEF VAR v_val_tot_comprtdo AS DEC FORMAT "->>,>>>,>>>,>>9.99" DECIMALS 2        NO-UNDO.
DEF VAR i-sequencia        AS INT INIT 0 NO-UNDO.
...
DEF BUFFER tit_acr_an                       FOR tit_acr.
DEF BUFFER tit_acr_dp                       FOR tit_acr.
DEF BUFFER tit_acr_elimina                  FOR tit_acr.
DEF BUFFER tit_acr_rateio                   FOR tit_acr.
DEF BUFFER b_espec_docto_financ_acr_normal  FOR espec_docto_financ_acr.
DEF BUFFER b_espec_docto_financ_acr_antecip FOR espec_docto_financ_acr.
