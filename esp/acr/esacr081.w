...
*******************************************************************************/
{include/i-prgvrs.i esacr081 1.00.00.000}
{utp/ut-glob.i}
{cdp/cdcfgmat.i}
...
&GLOBAL-DEFINE Program        esacr081
...
DEFINE FRAME fPage2
     rs-tipo AT ROW 3 COL 13 NO-LABEL WIDGET-ID 8
...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW wReport ASSIGN
         HIDDEN             = YES
         TITLE              = "Importar Antecipa‡Æo Concilia‡Æo Financeira"
         HEIGHT             = 17
         WIDTH              = 90
         MAX-HEIGHT         = 22
         MAX-WIDTH          = 114.14
...
ON END-ERROR OF wReport /* Importar Antecipa‡Æo Concilia‡Æo Financeira */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL wReport wReport
ON WINDOW-CLOSE OF wReport /* Importar Antecipa‡Æo Concilia‡Æo Financeira */
DO:
...
DO:
   do  on error undo, return no-apply:
       ...
       IF INPUT FRAME fPage2 fi-arquivo <> "" THEN DO:
           ...
           END.
           ELSE DO:
               IF ENTRY(2,fi-arquivo:SCREEN-VALUE IN FRAME fPage2,".") <> "xlsx" AND 
                  ENTRY(2,fi-arquivo:SCREEN-VALUE IN FRAME fPage2,".") <> "xls"  THEN DO:
                   RUN utp/ut-msgs.p (INPUT "SHOW":U,
                                      INPUT 17006,
                                      INPUT "Arquivo de importa‡Æo informado deve ser .xlsx ou .xls").
                   APPLY "entry" TO fi-arquivo IN FRAME fPage2.
                   RETURN NO-APPLY.
               END.
           END.
...
do on error undo, return error on stop  undo, return error:
    ...
    {report/rprun.i esp/acr/esacr081rp.p}
