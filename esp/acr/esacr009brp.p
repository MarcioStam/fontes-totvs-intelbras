/*****************************************************************************
**     Programa.........: esp/acr/esacr009brp.p
**     Descricao .......: 
**     Versao...........: 1.00.000
...
DEFINE TEMP-TABLE ttRegiao
    ...
    FIELD val_movto_tit_acr LIKE tt-mov-tit.val_movto_tit_acr.
...
DEFINE INPUT PARAM da-baixa-ini AS date format "99/99/9999".
DEFINE INPUT PARAM da-baixa-fim AS date format "99/99/9999".
DEFINE INPUT PARAM da-vencto    AS date format "99/99/9999".
DEFINE INPUT PARAM TABLE FOR tt-mov-tit.
...
DO.
  ...
  DO.
    FIND Dwb_Set_List_Param NO-LOCK
         WHERE Dwb_Set_List_Param.Cod_Dwb_Program = "esacr009b"
...
DO.   /* seta a saida da impressao */
  CASE V_Cod_Dwb_Output:
    ...
    DO.
      ASSIGN V_Cod_Dwb_File   = session:temp-directory + "esacr009b.lst".
...
PROCEDURE piImprimeRelat.
    ...
    disp STREAM Stream_1
         da-baixa-ini label "Data de Baixa Inicial" skip
         da-baixa-fim label "Data de Baixa   Final" skip
         da-vencto    label "   Com Vencimento Ate" 
    ...
    assign de-fones = 0
        ...
        for each tt-mov-tit,
            ...
            WHERE emscad.cliente.cod_empresa = tt-mov-tit.cod_empresa
            AND   emscad.cliente.cdn_cliente = tt-mov-tit.cdn_cliente,
            ...
            break by tt-mov-tit.cdn_cliente
                  by tt-mov-tit.dat_vencto_tit_acr
                  by tt-mov-tit.cod_tit_acr:
            ...
            disp STREAM Stream_1
                 ...
                 /*tt-mov-tit.transacao*/
                 tt-mov-tit.dat_vencto_tit_acr
                 tt-mov-tit.dat_liquidac_tit_acr
                 tt-mov-tit.val_movto_tit_acr (total by tt-mov-tit.cdn_cliente)
                    ...
                    ASSIGN ttRegiao.nome-ab-reg = repres.nome-ab-reg 
                           ttRegiao.nome-regiao = IF AVAIL regiao THEN 
                               regiao.nome-regiao ELSE "Sem Regiao p[" + representante.nom_abrev + "-" + 
                                                                         repres.nome-ab-reg + "]". 
                END.
                ASSIGN ttRegiao.val_movto_tit_acr = ttRegiao.val_movto_tit_acr + tt-mov-tit.val_movto_tit_acr.
            END.
        END.
        ...
        FOR EACH ttRegiao.
            PUT STREAM Stream_1
                ...
                ttRegiao.val_movto_tit_acr SKIP.
        END.
