...
*******************************************************************************/
{include/i-prgvrs.i esacr078 2.00.00.000}
...
DEFINE VARIABLE c-nr-nota-fis-fim AS CHARACTER FORMAT "X(16)":U INITIAL "999999999999999" 
     VIEW-AS FILL-IN 
     SIZE 15 BY .88 NO-UNDO.

DEFINE VARIABLE c-nr-nota-fis-ini AS CHARACTER FORMAT "X(256)":U INITIAL "0"
     LABEL "Nr. Nota" 
     VIEW-AS FILL-IN 
     SIZE 15 BY .88 NO-UNDO.
...
DEFINE VARIABLE d-dt-emis-fim AS DATE FORMAT "99/99/9999":U INITIAL TODAY
     VIEW-AS FILL-IN 
     SIZE 15 BY .88 NO-UNDO.

DEFINE VARIABLE d-dt-emis-ini AS DATE FORMAT "99/99/9999":U INITIAL TODAY 
     LABEL "Emiss∆o" 
     VIEW-AS FILL-IN 
     SIZE 15 BY .88 NO-UNDO.
...
DEFINE FRAME f-pg-sel
     c-cod-estabel-ini AT ROW 1.5 COL 18 COLON-ALIGNED
     c-cod-estabel-fim AT ROW 1.5 COL 45.57 COLON-ALIGNED NO-LABEL WIDGET-ID 32
     c-serie-ini AT ROW 2.5 COL 18 COLON-ALIGNED WIDGET-ID 2
     c-serie-fim AT ROW 2.5 COL 45.57 COLON-ALIGNED NO-LABEL WIDGET-ID 14
     c-nr-nota-fis-ini AT ROW 3.5 COL 18 COLON-ALIGNED WIDGET-ID 4
     c-nr-nota-fis-fim AT ROW 3.5 COL 45.57 COLON-ALIGNED NO-LABEL WIDGET-ID 20
     d-dt-emis-ini AT ROW 4.5 COL 18 COLON-ALIGNED WIDGET-ID 6
     d-dt-emis-fim AT ROW 4.5 COL 45.57 COLON-ALIGNED NO-LABEL WIDGET-ID 26
     IMAGE-9 AT ROW 1.5 COL 44.72 WIDGET-ID 34
     IMAGE-10 AT ROW 2.5 COL 44.72 WIDGET-ID 18
     IMAGE-11 AT ROW 3.5 COL 44.72 WIDGET-ID 24
     IMAGE-12 AT ROW 4.5 COL 44.72 WIDGET-ID 30
     IMAGE-1 AT ROW 1.5 COL 35 WIDGET-ID 36
     IMAGE-13 AT ROW 2.5 COL 35 WIDGET-ID 38
     IMAGE-14 AT ROW 3.5 COL 35 WIDGET-ID 40
     IMAGE-15 AT ROW 4.5 COL 35 WIDGET-ID 42
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 3 ROW 2.85
...
{utp/ut9000.i "esacr078" "2.00.00.000"}
...
------------------------------------------------------------------------------*/
  ...
  DISPLAY c-cod-estabel-ini c-cod-estabel-fim c-serie-ini c-serie-fim 
          c-nr-nota-fis-ini c-nr-nota-fis-fim d-dt-emis-ini d-dt-emis-fim 
      WITH FRAME f-pg-sel IN WINDOW w-relat.
  ENABLE IMAGE-9 IMAGE-10 IMAGE-11 IMAGE-12 IMAGE-1 IMAGE-13 IMAGE-14 IMAGE-15 
...
do on error undo, return error on stop  undo, return error:
    ...
    {include/i-rprun.i esp/acr/esacr078rp.p}
