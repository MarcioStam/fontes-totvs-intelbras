...
*******************************************************************************/
{include/i-prgvrs.i ESACR072 2.00.00.000}
...
DEFINE BUTTON bt-elimina DEFAULT 
     ...
     LABEL "" 
     SIZE 3.86 BY .92 TOOLTIP "Eliminar Exce‡Æo".

DEFINE BUTTON bt-inclui DEFAULT 
     IMAGE-UP FILE "adeicon/check.bmp":U
     LABEL "INCLUI" 
     SIZE 3.86 BY .92 TOOLTIP "Incluir Exce‡Æo".
...
DEFINE VARIABLE tg-efetiva AS LOGICAL INITIAL yes 
     LABEL "Efetivar altera‡äes?" 
     VIEW-AS TOGGLE-BOX
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br-portador w-relat _FREEFORM
...
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ROW-MARKERS SEPARATORS SIZE 44 BY 4.5
         FONT 1
...
DEFINE FRAME f-pg-sel
     tg-efetiva AT ROW 2.25 COL 17 WIDGET-ID 366
     fi-portador AT ROW 4.5 COL 23 COLON-ALIGNED WIDGET-ID 346
     fi-carteira AT ROW 4.5 COL 40.29 COLON-ALIGNED WIDGET-ID 362
     bt-inclui AT ROW 4.46 COL 56 HELP
          "Incluir Exce‡Æo" WIDGET-ID 348
     bt-elimina AT ROW 9.58 COL 61.72 HELP
          "Eliminar Exce‡Æo" WIDGET-ID 350
     br-portador AT ROW 6 COL 16.72 WIDGET-ID 300
     " < Regras Exce‡Æo FLOAT >" VIEW-AS TEXT
          SIZE 19.72 BY .67 AT ROW 3.63 COL 29 WIDGET-ID 4
     RECT-10 AT ROW 1.5 COL 2 WIDGET-ID 2
     RECT-15 AT ROW 4 COL 16.86 WIDGET-ID 364
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 3 ROW 2.85
         SIZE 76.86 BY 10.62
...
/* SETTINGS FOR FRAME f-pg-sel
   Custom                                                               */
/* BROWSE-TAB br-portador RECT-15 f-pg-sel */
ASSIGN 
       br-portador:COLUMN-RESIZABLE IN FRAME f-pg-sel       = TRUE.
...
&Scoped-define SELF-NAME br-portador
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL br-portador w-relat
ON START-SEARCH OF br-portador IN FRAME f-pg-sel /* Portador */
DO:
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL bt-elimina w-relat
ON CHOOSE OF bt-elimina IN FRAME f-pg-sel
DO:
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL bt-inclui w-relat
ON CHOOSE OF bt-inclui IN FRAME f-pg-sel /* INCLUI */
DO:
  
    DEF VAR i-seq AS INTEGER NO-UNDO.

    FIND emscad.portador NO-LOCK
        WHERE emscad.portador.cod_portador = fi-portador:SCREEN-VALUE IN FRAME f-pg-sel NO-ERROR.
    ...
    FIND cart_bcia
        WHERE cart_bcia.cod_cart_bcia = fi-carteira:SCREEN-VALUE IN FRAME f-pg-sel NO-ERROR.
    ...
    FIND tt-portador
        WHERE tt-portador.codigo   = fi-portador:SCREEN-VALUE IN FRAME f-pg-sel 
          AND tt-portador.carteira = fi-carteira:SCREEN-VALUE IN FRAME f-pg-sel NO-ERROR.
    
    IF  AVAIL tt-portador THEN DO:
        RUN utp/ut-msgs.p ("SHOW",
                           17006,
                           "Portador/Carteira j  cadastrados como exce‡Æo Float.").
        RETURN NO-APPLY.
    END.
    ELSE DO TRANS:
        CREATE tt-portador.
        ASSIGN tt-portador.codigo   = fi-portador:SCREEN-VALUE IN FRAME f-pg-sel
               tt-portador.nome     = emscad.portador.nom_pessoa
               tt-portador.carteira = fi-carteira:SCREEN-VALUE IN FRAME f-pg-sel.
        ...
        FIND conteudo-programa EXCLUSIVE-LOCK
            WHERE conteudo-programa.cod-programa = ponto-programa.cod-programa 
              AND ENTRY(1,conteudo-programa.conteudo,";") = fi-portador:SCREEN-VALUE IN FRAME f-pg-sel 
              AND ENTRY(2,conteudo-programa.conteudo,";") = fi-carteira:SCREEN-VALUE IN FRAME f-pg-sel NO-ERROR.
...
{utp/ut9000.i "ESACR072" "2.00.00.000"}
...
------------------------------------------------------------------------------*/
  ...
  DISPLAY tg-efetiva fi-portador fi-carteira 
      WITH FRAME f-pg-sel IN WINDOW w-relat.
  ENABLE tg-efetiva fi-portador fi-carteira bt-inclui bt-elimina RECT-10 
         RECT-15 br-portador 
      WITH FRAME f-pg-sel IN WINDOW w-relat.
...
do on error undo, return error on stop  undo, return error:
    ...
    assign tt-param.usuario                     = c-seg-usuario
           ...
           tt-param.tg-efetiva                  = tg-efetiva:CHECKED IN FRAME f-pg-sel.
    ...
    {include/i-rprun.i esp/acr/esacr072rp.p}
