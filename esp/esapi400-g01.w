...
*******************************************************************************/
{include/i-prgvrs.i esapi400-g01 TOTVS}
...
&Scoped-Define ENABLED-OBJECTS rt-button i_cod-agente bt-ok bt-cancela ~
bt-ajuda 
&Scoped-Define DISPLAYED-OBJECTS i_cod-agente 
...
DEFINE VARIABLE i_cod-agente AS INTEGER FORMAT ">>>,>>>,>>9":U INITIAL 0 
     LABEL "Agente" 
     VIEW-AS FILL-IN 
     SIZE 11 BY 1.25 NO-UNDO.
...
DEFINE FRAME d-vapara
     i_cod-agente AT ROW 1.88 COL 29 COLON-ALIGNED WIDGET-ID 2
    ...
    WITH VIEW-AS DIALOG-BOX KEEP-TAB-ORDER 
         ...
         TITLE "Vÿ Para <insira complemento>"
...
ON GO OF FRAME d-vapara /* Vÿ Para <insira complemento> */
DO:
FIND es-agente NO-LOCK
    WHERE es-agente.cod-agente EQ INPUT FRAME {&FRAME-NAME} i_cod-agente NO-ERROR.

IF NOT AVAILABLE es-agente THEN DO:
    {utp/ut-table.i dbapi es-agente 1}
    RUN utp/ut-msgs.p(INPUT "show",
                      INPUT 2,
                      INPUT RETURN-VALUE).
    RETURN NO-APPLY.
END.
ASSIGN p-row-tabela = ROWID(es-agente).
END.
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL d-vapara d-vapara
ON WINDOW-CLOSE OF FRAME d-vapara /* Vÿ Para <insira complemento> */
DO:  
...
------------------------------------------------------------------------------*/
  DISPLAY i_cod-agente 
      WITH FRAME d-vapara.
  ENABLE rt-button i_cod-agente bt-ok bt-cancela bt-ajuda 
      WITH FRAME d-vapara.
  VIEW FRAME d-vapara.
...
------------------------------------------------------------------------------*/
  ...
  {utp/ut9000.i "ESAPI400-G01" "TOTVS"}
