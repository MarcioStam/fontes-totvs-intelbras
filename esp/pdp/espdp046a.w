...
********************************************************************************/
{include/i-prgvrs.i ESPDP046a 9.99.99.999}
...
&IF "{&EMSFND_VERSION}" >= "1.00" &THEN
    {include/i-license-manager.i espdp046a}
&ENDIF
...
DEFINE NEW GLOBAL SHARED VAR g-nr-tabela-cd1508 AS ROWID NO-UNDO.
...
DEFINE FRAME f-pg-sel
     c-nr-tabpre AT ROW 2.5 COL 29.86 COLON-ALIGNED WIDGET-ID 32
     fi-item-ini AT ROW 5.21 COL 16.29 COLON-ALIGNED WIDGET-ID 84
     fi-item-fim AT ROW 5.21 COL 43.29 COLON-ALIGNED NO-LABEL WIDGET-ID 86
     "   Elimina‡Æo Itens da Tabela por Faixa" VIEW-AS TEXT
          SIZE 27 BY .54 AT ROW 1.5 COL 26.29 WIDGET-ID 82
     "  Faixa de Itens" VIEW-AS TEXT
          SIZE 12 BY .54 AT ROW 4.25 COL 33.29 WIDGET-ID 94
     RECT-12 AT ROW 1.88 COL 2.14 WIDGET-ID 46
     IMAGE-5 AT ROW 5.21 COL 34.29 WIDGET-ID 88
     IMAGE-6 AT ROW 5.21 COL 41.29 WIDGET-ID 90
     RECT-13 AT ROW 4.54 COL 2 WIDGET-ID 92
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
...
ASSIGN 
       c-nr-tabpre:READ-ONLY IN FRAME f-pg-sel        = TRUE.
...
{utp/ut9000.i "ESPDP046a" "9.99.99.999"}
...
DO  ON ERROR   UNDO MAIN-BLOCK, LEAVE MAIN-BLOCK
    ...
    FIND FIRST tb-preco NO-LOCK
        WHERE ROWID(tb-preco) = g-nr-tabela-cd1508 NO-ERROR.

    IF  AVAIL tb-preco THEN
        ASSIGN c-nr-tabpre:SCREEN-VALUE IN FRAME f-pg-sel = tb-preco.nr-tabpre.
...
------------------------------------------------------------------------------*/
  ...
  DISPLAY c-nr-tabpre fi-item-ini fi-item-fim 
      WITH FRAME f-pg-sel IN WINDOW w-relat.
  ENABLE c-nr-tabpre fi-item-ini fi-item-fim RECT-12 IMAGE-5 IMAGE-6 RECT-13 
      WITH FRAME f-pg-sel IN WINDOW w-relat.
...
do on error undo, return error on stop  undo, return error:
    ...
    IF  fi-item-ini:SCREEN-VALUE IN FRAME f-pg-sel > fi-item-fim:SCREEN-VALUE IN FRAME f-pg-sel THEN DO:
        RUN utp/ut-msgs.p (input "show", INPUT 17006, input "Faixa de itens inv lida").
        RETURN.
    END.

    run utp/ut-msgs.p (input "show", input 27100, input "Confirma Elimina‡Æo dos itens da tabela?").
    ...
    assign tt-param.usuario          = c-seg-usuario
           ...
           tt-param.nr-tabpre        = INPUT FRAME f-pg-sel c-nr-tabpre
    ...
    {include/i-rprun.i esp/pdp/espdp046rpA.p}
