...
*******************************************************************************/
{include/i-prgvrs.i ESPDP031a 9.99.99.999}
...
DEFINE FRAME f-relat
     bt-executar AT ROW 13.75 COL 3 HELP
          "Dispara a execuá∆o do relat¢rio"
     bt-cancelar AT ROW 13.75 COL 14 HELP
          "Fechar"
     bt-ajuda AT ROW 13.75 COL 81 HELP
          "Ajuda"
...
DEFINE FRAME f-pg-imp
    ...
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 3 ROW 3
         SIZE 91.14 BY 9.08 WIDGET-ID 100.

DEFINE FRAME f-pg-sel
     bt-pesquisa AT ROW 1.25 COL 82 WIDGET-ID 24
     c-arquivo-imp AT ROW 1.5 COL 8 COLON-ALIGNED WIDGET-ID 26
     "Lay-out do arquivo:" VIEW-AS TEXT
          SIZE 29 BY .75 AT ROW 4.63 COL 2 WIDGET-ID 6
          FONT 0
     "O arquivo dever† ser em formato .csv" VIEW-AS TEXT
          SIZE 42 BY 1 AT ROW 3.67 COL 2 WIDGET-ID 4
     "O campo Aá∆o devera ser I para Inclus∆o ou Alteraá∆o e E para Exclus∆o" VIEW-AS TEXT
          SIZE 59 BY 1 AT ROW 7.46 COL 7.57 WIDGET-ID 12
          FONT 1
     "Aá∆o ~; Repres ~; Data Inicial ~; Data FINAL ~; Valor Inicial ~; Valor FINAL ~; Percen" VIEW-AS TEXT
          SIZE 72.43 BY 1 AT ROW 6.46 COL 7.57 WIDGET-ID 8
          FONT 1
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 3 ROW 3 SCROLLABLE  WIDGET-ID 100.
...
DO:
    ...
    IF l-ok THEN DO:
        assign c-arquivo-imp = c-arq-conv.
        display c-arquivo-imp with frame f-pg-sel.
    END.
...
{utp/ut9000.i "ESPDP031a" "9.99.99.999"}
...
------------------------------------------------------------------------------*/
  ...
  DISPLAY c-arquivo-imp 
      WITH FRAME f-pg-sel IN WINDOW w-relat.
  ENABLE bt-pesquisa c-arquivo-imp 
      WITH FRAME f-pg-sel IN WINDOW w-relat.
...
do on error undo, return error on stop  undo, return error:
   ...
   /*:T Coloque aqui as validaá‰es das outras p†ginas, lembrando que elas devem 
    ...
    assign tt-param.usuario         = c-seg-usuario
           ...
           tt-param.c-arquivo       = INPUT FRAME f-pg-sel c-arquivo-imp
...
/*            &endif                                                                                     */
    ...
    {include/i-rprun.i esp/pdp/espdp031arp.p}
