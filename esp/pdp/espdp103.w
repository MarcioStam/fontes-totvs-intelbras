...
********************************************************************************/
{include/i-prgvrs.i ESPDP103 2.00.00.000}
...
{utp/ut9000.i "ESPDP103" "2.00.00.000"}
...
DO  ON ERROR   UNDO MAIN-BLOCK, LEAVE MAIN-BLOCK
    ...
    ASSIGN c-editor:screen-value in frame f-pg-sel = 
        ...
        "lista-preco;item" + CHR(10) +
        "SOLPR-AC;4830001" + CHR(10) +
        "SOLPR-AL;4830001" + CHR(10) +
        "SOLPR-AM;4830001" + CHR(10) +
        "SOLPR-AP;4830001" + CHR(10) +
        "SOLPR-BA;4830001" + CHR(10) +
        "SOLPR-CE;4830001" + CHR(10) +
        "SOLPR-DF;4830001" + CHR(10) +
        "SOLPR-ES;4830001" + CHR(10) +
        "SOLPR-GO;4830001" + CHR(10) +
        "SOLPR-MA;4830001" + CHR(10) .
...
do on error undo, return error on stop  undo, return error:
   ...
   /*:T Coloque aqui as validaá‰es das outras p†ginas, lembrando que elas devem 
    ...
    {include/i-rprun.i "esp/pdp/espdp103rp.p"}.
