...
*******************************************************************************/
{include/i-prgvrs.i espdp052 2.04.00.000}

CREATE WIDGET-POOL.

/* Preprocessors Definitions ---                                      */
&GLOBAL-DEFINE Program        espdp052
...
DEFINE VARIABLE cCodEstabel AS CHARACTER FORMAT "X(3)":U INITIAL "101" 
...
/* SETTINGS FOR FRAME fPage2
                                                                        */
/* SETTINGS FOR FILL-IN cCodEstabel IN FRAME fPage2
   ALIGN-L                                                              */
...
do on error undo, return error on stop  undo, return error:
    ...
    {report/rprun.i esp/pdp/espdp052rp.p}
