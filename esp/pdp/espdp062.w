...
DEFINE TEMP-TABLE ttcategoria-b2c NO-UNDO LIKE categoria-b2c
       field r-rowid as rowid.
DEFINE TEMP-TABLE ttcategoria-item-b2c NO-UNDO LIKE categoria-item-b2c
       field r-rowid as rowid.
...
*******************************************************************************/
{include/i-prgvrs.i espdp062 2.04.00.001}

CREATE WIDGET-POOL.

/* Preprocessors Definitions ---                                      */
&GLOBAL-DEFINE Program          espdp062
...
&GLOBAL-DEFINE ttParent         ttcategoria-b2c
&GLOBAL-DEFINE hDBOParent       hboes558
&GLOBAL-DEFINE DBOParentTable   categoria-b2c
&GLOBAL-DEFINE DBOParentDestroy yes

&GLOBAL-DEFINE ttSon1           ttcategoria-item-b2c
&GLOBAL-DEFINE hDBOSon1         hboes559
&GLOBAL-DEFINE DBOSon1Table     categoria-item-b2c
&GLOBAL-DEFINE DBOSon1Destroy   yes

&GLOBAL-DEFINE page0Fields      ttcategoria-b2c.cod-categoria ~
                                ttcategoria-b2c.nome ~
                                ttcategoria-b2c.cod-categoria-pai ~
                                ttcategoria-b2c.ativo
...
&Scoped-define INTERNAL-TABLES ttcategoria-item-b2c

/* Definitions for BROWSE brSon1                                        */
&Scoped-define FIELDS-IN-QUERY-brSon1 ttcategoria-item-b2c.it-codigo ~
ttcategoria-item-b2c.ind-aceita-saldao 
&Scoped-define ENABLED-FIELDS-IN-QUERY-brSon1 
&Scoped-define QUERY-STRING-brSon1 FOR EACH ttcategoria-item-b2c NO-LOCK
&Scoped-define OPEN-QUERY-brSon1 OPEN QUERY brSon1 FOR EACH ttcategoria-item-b2c NO-LOCK.
&Scoped-define TABLES-IN-QUERY-brSon1 ttcategoria-item-b2c
&Scoped-define FIRST-TABLE-IN-QUERY-brSon1 ttcategoria-item-b2c
...
&Scoped-Define ENABLED-FIELDS ttcategoria-b2c.cod-categoria ~
ttcategoria-b2c.nome ttcategoria-b2c.cod-categoria-pai ~
ttcategoria-b2c.ativo 
&Scoped-define ENABLED-TABLES ttcategoria-b2c
&Scoped-define FIRST-ENABLED-TABLE ttcategoria-b2c
...
&Scoped-Define DISPLAYED-FIELDS ttcategoria-b2c.cod-categoria ~
ttcategoria-b2c.nome ttcategoria-b2c.cod-categoria-pai ~
ttcategoria-b2c.ativo 
&Scoped-define DISPLAYED-TABLES ttcategoria-b2c
&Scoped-define FIRST-DISPLAYED-TABLE ttcategoria-b2c
...
DEFINE QUERY brSon1 FOR 
      ttcategoria-item-b2c SCROLLING.
&ANALYZE-RESUME
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS brSon1 wMasterDetail _STRUCTURED
  QUERY brSon1 NO-LOCK DISPLAY
      ttcategoria-item-b2c.it-codigo FORMAT "x(16)":U
      ttcategoria-item-b2c.ind-aceita-saldao FORMAT "yes/no":U
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
...
DEFINE FRAME fPage0
     ...
     btHelp AT ROW 1.13 COL 86.86 HELP
          "Ajuda"
     ttcategoria-b2c.cod-categoria AT ROW 3.25 COL 16 COLON-ALIGNED WIDGET-ID 4
          VIEW-AS FILL-IN 
          SIZE 18.29 BY .79
     ttcategoria-b2c.nome AT ROW 3.25 COL 35 COLON-ALIGNED NO-LABEL WIDGET-ID 8
          VIEW-AS FILL-IN 
          SIZE 44 BY .79
     ttcategoria-b2c.cod-categoria-pai AT ROW 4.25 COL 16 COLON-ALIGNED WIDGET-ID 6
          VIEW-AS FILL-IN 
          SIZE 18.29 BY .79
     ttcategoria-b2c.ativo AT ROW 4.25 COL 37 WIDGET-ID 10
          VIEW-AS TOGGLE-BOX
          SIZE 11.57 BY .83
...
/* Settings for THIS-PROCEDURE
   ...
   Temp-Tables and Buffers:
      TABLE: ttcategoria-b2c T "?" NO-UNDO mgesp categoria-b2c
      ADDITIONAL-FIELDS:
          field r-rowid as rowid
      END-FIELDS.
      TABLE: ttcategoria-item-b2c T "?" NO-UNDO mgesp categoria-item-b2c
      ADDITIONAL-FIELDS:
          field r-rowid as rowid
      END-FIELDS.
   END-TABLES.
...
/* SETTINGS FOR FRAME fPage0
   FRAME-NAME                                                           */
/* SETTINGS FOR FILL-IN ttcategoria-b2c.nome IN FRAME fPage0
   EXP-LABEL                                                            */
...
/* Query rebuild information for BROWSE brSon1
     _TblList          = "Temp-Tables.ttcategoria-item-b2c"
     _Options          = "NO-LOCK"
     _FldNameList[1]   = Temp-Tables.ttcategoria-item-b2c.it-codigo
     _FldNameList[2]   = Temp-Tables.ttcategoria-item-b2c.ind-aceita-saldao
     _Query            is OPENED
*/  /* BROWSE brSon1 */
&ANALYZE-RESUME
...
OR CHOOSE OF MENU-ITEM miAdd IN MENU mbMain DO:
    RUN addRecord IN THIS-PROCEDURE (INPUT "esp/pdp/espdp062a.w":U). 
END.
...
DO:
    {masterdetail/addson.i &ProgramSon="esp/pdp/espdp062b.w"
                           &PageNumber="1"}
END.
...
OR CHOOSE OF MENU-ITEM miCopy IN MENU mbMain DO:
    RUN copyRecord (INPUT "esp/pdp/espdp062a.w":U).
END.
...
DO:
    {masterdetail/copyson.i &ProgramSon="esp/pdp/espdp062b.w"
                            &PageNumber="1"}
END.
...
OR CHOOSE OF MENU-ITEM miSearch IN MENU mbMain DO:
    {method/zoomreposition.i &ProgramZoom="eszoom/z01es558.w"}
END.
...
OR CHOOSE OF MENU-ITEM miUpdate IN MENU mbMain DO:
    RUN updateRecord IN THIS-PROCEDURE (INPUT "esp/pdp/espdp062a.w":U).
END.
...
DO:
    {masterdetail/updateson.i &ProgramSon="esp/pdp/espdp062b.w"
                              &PageNumber="1"}
END.
...
------------------------------------------------------------------------------*/
    ...
    DEFINE VARIABLE <c|d|i><campo 1> LIKE {&ttParent}.<campo 1> NO-UNDO.
...
/*tech1139 - FO 1338.917 - 10/07/2006  */
    ...
    ON "CHOOSE":U OF btGoToOK IN FRAME fGoToRecord DO:
        ...
        RUN goToKey IN {&hDBOParent} (INPUT <c|d|i><campo 1> , INPUT <c|d|i><campo 2> ).
...
------------------------------------------------------------------------------*/
    ...
    IF NOT VALID-HANDLE({&hDBOParent}) OR
       ...
       {&hDBOParent}:FILE-NAME <> "esbo/boes558.p":U THEN DO:
        {btb/btb008za.i1 esbo/boes558.p YES}
        {btb/btb008za.i2 esbo/boes558.p '' {&hDBOParent}} 
    END.
    ...
    IF NOT VALID-HANDLE({&hDBOSon1}) OR 
       ...
       {&hDBOSon1}:FILE-NAME <> "esbo/boes559.p":U THEN DO:
        {btb/btb008za.i1 esbo/boes559.p YES}
        {btb/btb008za.i2 esbo/boes559.p '' {&hDBOSon1}} 
    END.
...
------------------------------------------------------------------------------*/
    ...
    {masterdetail/openqueriesson.i &Parent="CategoriaB2C"
                                   &Query="categoria"
                                   &PageNumber="1"}
