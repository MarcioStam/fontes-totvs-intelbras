...
*******************************************************************************/
{include/i-prgvrs.i ESPDP012 2.00.00.001}
...
&IF "{&EMSFND_VERSION}" >= "1.00" &THEN
    {include/i-license-manager.i ESPDP012 MPD}
&ENDIF
...
&Scoped-define FIELDS-IN-QUERY-br-digita tt-digita.nr-pedido tt-digita.it-codigo   
&Scoped-define ENABLED-FIELDS-IN-QUERY-br-digita tt-digita.nr-pedido tt-digita.it-codigo   
...
DEFINE VARIABLE cod-gr-cli-fim AS INTEGER FORMAT ">9" INITIAL 99 
     VIEW-AS FILL-IN 
     SIZE 3 BY .88 NO-UNDO.

DEFINE VARIABLE cod-gr-cli-ini AS INTEGER FORMAT ">9" INITIAL 0 
     LABEL "Grupo" 
     VIEW-AS FILL-IN 
     SIZE 3 BY .88 NO-UNDO.

DEFINE VARIABLE dt-implant-fim AS DATE FORMAT "99/99/9999" INITIAL 12/31/9999 
     VIEW-AS FILL-IN 
     SIZE 11 BY .88 NO-UNDO.

DEFINE VARIABLE dt-implant-ini AS DATE FORMAT "99/99/9999" INITIAL 01/01/001 
     LABEL "Dt Implanta‡Æo" 
     VIEW-AS FILL-IN 
     SIZE 11 BY .88 NO-UNDO.

DEFINE VARIABLE nr-pedcli-fim AS CHARACTER FORMAT "x(12)" INITIAL "ZZZZZZZZZZZZ" 
     VIEW-AS FILL-IN 
     SIZE 15 BY .88 NO-UNDO.

DEFINE VARIABLE nr-pedcli-ini AS CHARACTER FORMAT "x(12)" 
...
DEFINE VARIABLE tp-pedido-fim AS CHARACTER FORMAT "x(2)" INITIAL "ZZ" 
     VIEW-AS FILL-IN 
     SIZE 3 BY .88 NO-UNDO.

DEFINE VARIABLE tp-pedido-ini AS CHARACTER FORMAT "x(2)" 
     LABEL "Atendente" 
     VIEW-AS FILL-IN 
     SIZE 3 BY .88 NO-UNDO.
...
DEFINE FRAME f-pg-sel
     nr-pedido-ini AT ROW 1.25 COL 15 COLON-ALIGNED HELP
          "N£mero do pedido"
     nr-pedido-fim AT ROW 1.25 COL 48.14 COLON-ALIGNED HELP
          "N£mero do pedido" NO-LABEL
     cod-emitente-ini AT ROW 2.21 COL 20 COLON-ALIGNED WIDGET-ID 24
     cod-emitente-fim AT ROW 2.21 COL 48.14 COLON-ALIGNED NO-LABEL WIDGET-ID 22
     nr-pedcli-ini AT ROW 3.21 COL 15 COLON-ALIGNED HELP
          "N£mero do pedido do cliente" WIDGET-ID 4
     nr-pedcli-fim AT ROW 3.21 COL 48.14 COLON-ALIGNED HELP
          "N£mero do pedido do cliente" NO-LABEL WIDGET-ID 2
     dt-implant-ini AT ROW 4.21 COL 19 COLON-ALIGNED HELP
          "Data em que o Pedido foi implantado no sistema" WIDGET-ID 12
     dt-implant-fim AT ROW 4.21 COL 48.14 COLON-ALIGNED HELP
          "Data em que o Pedido foi implantado no sistema" NO-LABEL WIDGET-ID 10
     cod-gr-cli-ini AT ROW 5.17 COL 27 COLON-ALIGNED HELP
          "C¢digo do grupo de cliente" WIDGET-ID 32
     cod-gr-cli-fim AT ROW 5.17 COL 48.14 COLON-ALIGNED HELP
          "C¢digo do grupo de cliente" NO-LABEL WIDGET-ID 30
     tp-pedido-ini AT ROW 6.13 COL 27 COLON-ALIGNED HELP
          "Dispon¡vel para classifica‡Æo/indica‡Æo pr¢pria do usu rio" WIDGET-ID 36
     tp-pedido-fim AT ROW 6.13 COL 48.14 COLON-ALIGNED HELP
          "Dispon¡vel para classifica‡Æo/indica‡Æo pr¢pria do usu rio" NO-LABEL WIDGET-ID 34
     IMAGE-1 AT ROW 1.25 COL 31.86
     IMAGE-2 AT ROW 1.25 COL 47.29
     IMAGE-3 AT ROW 3.21 COL 31.86 WIDGET-ID 6
     IMAGE-4 AT ROW 3.21 COL 47.29 WIDGET-ID 8
     IMAGE-5 AT ROW 4.21 COL 31.86 WIDGET-ID 14
     IMAGE-6 AT ROW 4.21 COL 47.29 WIDGET-ID 16
     IMAGE-7 AT ROW 2.21 COL 31.86 WIDGET-ID 18
     IMAGE-8 AT ROW 2.21 COL 47.29 WIDGET-ID 20
     IMAGE-9 AT ROW 5.17 COL 31.86 WIDGET-ID 26
     IMAGE-10 AT ROW 5.17 COL 47.29 WIDGET-ID 28
     IMAGE-11 AT ROW 6.13 COL 31.86 WIDGET-ID 40
     IMAGE-12 AT ROW 6.13 COL 47.29 WIDGET-ID 38
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 3 ROW 2.85
...
DEFINE FRAME f-relat
     ...
     im-pg-dig AT ROW 1.5 COL 17.86 WIDGET-ID 2
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 1 ROW 1
         SIZE 81 BY 15
...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW w-relat ASSIGN
         HIDDEN             = YES
         TITLE              = "Atualiza/Recalcula Pedido"
         HEIGHT             = 15
         WIDTH              = 81.14
         MAX-HEIGHT         = 28.33
         MAX-WIDTH          = 195.14
...
ON END-ERROR OF w-relat /* Atualiza/Recalcula Pedido */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL w-relat w-relat
ON WINDOW-CLOSE OF w-relat /* Atualiza/Recalcula Pedido */
DO:
...
DO:
    if  br-digita:new-row in frame f-pg-dig then do:
        ...
        display tt-digita.nr-pedido
                tt-digita.it-codigo with browse br-digita. 
    end.
    return no-apply.
END.
...
{utp/ut9000.i "ESPDP012" "2.00.00.001"}
...
------------------------------------------------------------------------------*/
  ENABLE im-pg-imp im-pg-sel im-pg-dig bt-executar bt-cancelar bt-ajuda 
      WITH FRAME f-relat IN WINDOW w-relat.
  {&OPEN-BROWSERS-IN-QUERY-f-relat}
  DISPLAY nr-pedido-ini nr-pedido-fim cod-emitente-ini cod-emitente-fim 
          nr-pedcli-ini nr-pedcli-fim dt-implant-ini dt-implant-fim 
          cod-gr-cli-ini cod-gr-cli-fim tp-pedido-ini tp-pedido-fim 
      WITH FRAME f-pg-sel IN WINDOW w-relat.
  ENABLE IMAGE-1 IMAGE-2 IMAGE-3 IMAGE-4 IMAGE-5 IMAGE-6 IMAGE-7 IMAGE-8 
         IMAGE-9 IMAGE-10 IMAGE-11 IMAGE-12 nr-pedido-ini nr-pedido-fim 
         cod-emitente-ini cod-emitente-fim nr-pedcli-ini nr-pedcli-fim 
         dt-implant-ini dt-implant-fim cod-gr-cli-ini cod-gr-cli-fim 
         tp-pedido-ini tp-pedido-fim 
      WITH FRAME f-pg-sel IN WINDOW w-relat.
...
do on error undo, return error on stop  undo, return error:
    ...
    for each tt-digita no-lock:
        ...
        find first b-tt-digita where b-tt-digita.nr-pedido = tt-digita.nr-pedido and 
        ...
        IF NOT CAN-FIND (FIRST ped-item
                         WHERE ped-item.it-codigo = tt-digita.it-codigo
                           AND ped-item.nr-pedcli = tt-digita.nr-pedido) THEN DO:
            assign browse br-digita:CURRENT-COLUMN = tt-digita.nr-pedido:HANDLE in browse br-digita.
            
            apply "MOUSE-SELECT-CLICK":U to im-pg-dig in frame f-relat.
            reposition br-digita to rowid r-tt-digita.
            
            run utp/ut-msgs.p (input "show":U, input 17006, input "NÆo encontrado pedido " + STRING(tt-digita.nr-pedido) + " com o item " + tt-digita.it-codigo + ".").
            apply "ENTRY":U to tt-digita.nr-pedido in browse br-digita.
    ...
    assign tt-param.usuario           = c-seg-usuario
           ...
           tt-param.nr-pedido-ini     = input frame f-pg-sel nr-pedido-ini  
           tt-param.nr-pedcli-ini     = input frame f-pg-sel nr-pedcli-ini  
           tt-param.dt-implant-ini    = input frame f-pg-sel dt-implant-ini 
           tt-param.nr-pedido-fim     = input frame f-pg-sel nr-pedido-fim  
           tt-param.nr-pedcli-fim     = input frame f-pg-sel nr-pedcli-fim  
           tt-param.dt-implant-fim    = input frame f-pg-sel dt-implant-fim 
           ...
           tt-param.cod-gr-cli-ini    = input frame f-pg-sel cod-gr-cli-ini
           tt-param.cod-gr-cli-fim    = input frame f-pg-sel cod-gr-cli-fim
           tt-param.tp-pedido-ini     = input frame f-pg-sel tp-pedido-ini
           tt-param.tp-pedido-fim     = input frame f-pg-sel tp-pedido-fim
           .
    ...
    {include/i-rprun.i esp/pdp/espdp012rp.p}
