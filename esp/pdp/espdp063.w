...
&GLOBAL-DEFINE Program        espdp063
...
&GLOBAL-DEFINE page2Widgets   tgItem tgCategoria tgCategoriaItem
...
&GLOBAL-DEFINE page2Fields    fiItemIni fiItemEnd fiCategoriaIni fiCategoriaEnd fiCategoriaItemIni fiCategoriaItemEnd
...
DEFINE VARIABLE fiCategoriaEnd AS CHARACTER FORMAT "X(24)":U INITIAL "ZZZZZZZZZZZZZZZ" 
     VIEW-AS FILL-IN 
     SIZE 15 BY .88
     FONT 1 NO-UNDO.

DEFINE VARIABLE fiCategoriaIni AS CHARACTER FORMAT "X(24)":U 
     LABEL "Categoria" 
     VIEW-AS FILL-IN 
     SIZE 15 BY .88
     FONT 1 NO-UNDO.

DEFINE VARIABLE fiCategoriaItemEnd AS CHARACTER FORMAT "X(16)":U INITIAL "ZZZZZZZZZZZZZZZ" 
     VIEW-AS FILL-IN 
     SIZE 15 BY .88
     FONT 1 NO-UNDO.

DEFINE VARIABLE fiCategoriaItemIni AS CHARACTER FORMAT "X(15)":U 
     LABEL "Item" 
     VIEW-AS FILL-IN 
     SIZE 15 BY .88
     FONT 1 NO-UNDO.

DEFINE VARIABLE fiItemEnd AS CHARACTER FORMAT "X(16)":U INITIAL "ZZZZZZZZZZZZZZZ" 
     VIEW-AS FILL-IN 
     SIZE 15 BY .88
     FONT 1 NO-UNDO.

DEFINE VARIABLE fiItemIni AS CHARACTER FORMAT "X(15)":U 
     LABEL "Item" 
     VIEW-AS FILL-IN 
     SIZE 15 BY .88
     FONT 1 NO-UNDO.
...
DEFINE VARIABLE tgCategoria AS LOGICAL INITIAL no 
     LABEL "Integra Categorias" 
     VIEW-AS TOGGLE-BOX
     SIZE 15 BY .83 NO-UNDO.

DEFINE VARIABLE tgCategoriaItem AS LOGICAL INITIAL no 
     LABEL "Integra Itens das Categorias" 
     VIEW-AS TOGGLE-BOX
...
DEFINE FRAME fPage2
     tgItem AT ROW 1.75 COL 12 WIDGET-ID 26
     fiItemIni AT ROW 2.75 COL 17.28 WIDGET-ID 20
     fiItemEnd AT ROW 2.75 COL 54.14 NO-LABEL WIDGET-ID 18
     tgCategoria AT ROW 4 COL 12 WIDGET-ID 28
     fiCategoriaIni AT ROW 5.25 COL 13.71 WIDGET-ID 4
     fiCategoriaEnd AT ROW 5.25 COL 54.14 NO-LABEL WIDGET-ID 2
     tgCategoriaItem AT ROW 6.5 COL 12 WIDGET-ID 30
     fiCategoriaItemIni AT ROW 7.5 COL 17.28 WIDGET-ID 10
     fiCategoriaItemEnd AT ROW 7.5 COL 54.14 NO-LABEL WIDGET-ID 12
     IMAGE-1 AT ROW 5.25 COL 35.86 WIDGET-ID 6
     IMAGE-2 AT ROW 5.25 COL 51.14 WIDGET-ID 8
     IMAGE-3 AT ROW 7.5 COL 35.86 WIDGET-ID 14
     IMAGE-4 AT ROW 7.5 COL 51.14 WIDGET-ID 16
     IMAGE-5 AT ROW 2.75 COL 35.86 WIDGET-ID 22
     IMAGE-6 AT ROW 2.75 COL 51.14 WIDGET-ID 24
...
/* SETTINGS FOR FRAME fPage2
                                                                        */
/* SETTINGS FOR FILL-IN fiCategoriaEnd IN FRAME fPage2
   ALIGN-L                                                              */
/* SETTINGS FOR FILL-IN fiCategoriaIni IN FRAME fPage2
   ALIGN-L                                                              */
/* SETTINGS FOR FILL-IN fiCategoriaItemEnd IN FRAME fPage2
   ALIGN-L                                                              */
/* SETTINGS FOR FILL-IN fiCategoriaItemIni IN FRAME fPage2
   ALIGN-L                                                              */
/* SETTINGS FOR FILL-IN fiItemEnd IN FRAME fPage2
   ALIGN-L                                                              */
/* SETTINGS FOR FILL-IN fiItemIni IN FRAME fPage2
   ALIGN-L                                                              */
...
do on error undo, return error on stop  undo, return error:
    ...
    */
    ...
    assign tt-param.usuario             = c-seg-usuario
           ...
           tt-param.exec-item           = input frame fPage2 tgItem
           tt-param.it-codigo-ini       = input frame fPage2 fiItemIni
           tt-param.it-codigo-fim       = input frame fPage2 fiItemEnd
           tt-param.exec-categoria      = input frame fPage2 tgCategoria
           tt-param.categoria-ini       = input frame fPage2 fiCategoriaIni
           tt-param.categoria-fim       = input frame fPage2 fiCategoriaEnd
           tt-param.exec-categoria-item = input frame fPage2 tgCategoriaItem
           tt-param.categoria-item-ini  = input frame fPage2 fiCategoriaItemIni
           tt-param.categoria-item-fim  = input frame fPage2 fiCategoriaItemEnd.
    ...
    {report/rprun.i esp/pdp/espdp063rp.p}
