...
DEFINE FRAME f-pg-sel
     ...
     dt-implant-ini AT ROW 2.21 COL 19 COLON-ALIGNED HELP
          "Data em que o Pedido foi implantado no sistema" WIDGET-ID 12
     dt-implant-fim AT ROW 2.21 COL 48.14 COLON-ALIGNED HELP
          "Data em que o Pedido foi implantado no sistema" NO-LABEL WIDGET-ID 10
     dt-entrega-ini AT ROW 3.17 COL 19 COLON-ALIGNED HELP
          "Data Previs∆o de Faturamento do Item" WIDGET-ID 20
     dt-entrega-fim AT ROW 3.17 COL 48.14 COLON-ALIGNED HELP
          "Data Previs∆o de Faturamento do Item" NO-LABEL WIDGET-ID 18
     IMAGE-1 AT ROW 1.25 COL 31.86
     IMAGE-2 AT ROW 1.25 COL 47.29
     IMAGE-5 AT ROW 2.21 COL 31.86 WIDGET-ID 14
     IMAGE-6 AT ROW 2.21 COL 47.29 WIDGET-ID 16
     IMAGE-11 AT ROW 3.17 COL 31.86 WIDGET-ID 22
     IMAGE-12 AT ROW 3.17 COL 47.29 WIDGET-ID 24
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 3 ROW 2.85
...
ON END-ERROR OF w-relat /* Cancela Itens do Pedido */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL w-relat w-relat
ON WINDOW-CLOSE OF w-relat /* Cancela Itens do Pedido */
DO:
...
{utp/ut9000.i "ESPDP013" "2.00.00.001"}
...
------------------------------------------------------------------------------*/
  ...
  ENABLE IMAGE-1 IMAGE-2 IMAGE-5 IMAGE-6 IMAGE-11 IMAGE-12 nr-pedido-ini 
         nr-pedido-fim dt-implant-ini dt-implant-fim dt-entrega-ini 
         dt-entrega-fim 
      WITH FRAME f-pg-sel IN WINDOW w-relat.
...
do on error undo, return error on stop  undo, return error:
    ...
    {include/i-rprun.i esp/pdp/espdp013rp.p}
