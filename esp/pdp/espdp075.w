...
*******************************************************************************/
{include/i-prgvrs.i espdp075 9.99.99.999}

CREATE WIDGET-POOL.

/* Preprocessors Definitions ---                                      */
&GLOBAL-DEFINE Program        espdp075
...
&GLOBAL-DEFINE page2Widgets   c-usu-aprov-ini ~
                              c-usu-aprov-fin ~
                              dt-impl-ini ~
                              dt-impl-fin ~
                              dt-aprov-ini ~
...
DEFINE VARIABLE c-usu-aprov-fin AS CHARACTER FORMAT "X(15)":U INITIAL "ZZZZZZZZZZZZZZZ" 
     VIEW-AS FILL-IN 
     SIZE 15 BY .88 NO-UNDO.

DEFINE VARIABLE c-usu-aprov-ini AS CHARACTER FORMAT "X(15)":U 
     LABEL "Usuario Aprovador" 
     VIEW-AS FILL-IN 
     SIZE 15 BY .88 NO-UNDO.

DEFINE VARIABLE dt-aprov-fin AS DATE FORMAT "99/99/9999":U INITIAL 01/01/13 
     VIEW-AS FILL-IN 
     SIZE 15 BY .88 NO-UNDO.

DEFINE VARIABLE dt-aprov-ini AS DATE FORMAT "99/99/9999":U INITIAL 01/01/11 
     LABEL "Data Aprovaá∆o" 
     VIEW-AS FILL-IN 
     SIZE 15 BY .88 NO-UNDO.

DEFINE VARIABLE dt-impl-fin AS DATE FORMAT "99/99/9999":U INITIAL 01/01/13 
     VIEW-AS FILL-IN 
     SIZE 15 BY .88 NO-UNDO.

DEFINE VARIABLE dt-impl-ini AS DATE FORMAT "99/99/9999":U INITIAL 01/01/11 
     LABEL "Data de implataá∆o" 
     VIEW-AS FILL-IN 
     SIZE 15 BY .88 NO-UNDO.
...
DEFINE FRAME fPage2
     c-usu-aprov-ini AT ROW 1.75 COL 19 COLON-ALIGNED WIDGET-ID 20
     c-usu-aprov-fin AT ROW 1.75 COL 50.14 COLON-ALIGNED NO-LABEL WIDGET-ID 18
     dt-impl-ini AT ROW 3 COL 19 COLON-ALIGNED WIDGET-ID 4
     dt-impl-fin AT ROW 3 COL 50.14 COLON-ALIGNED NO-LABEL WIDGET-ID 2
     dt-aprov-ini AT ROW 4.25 COL 19 COLON-ALIGNED WIDGET-ID 12
     dt-aprov-fin AT ROW 4.25 COL 50.14 COLON-ALIGNED NO-LABEL WIDGET-ID 10
     IMAGE-1 AT ROW 1.75 COL 36 WIDGET-ID 22
     IMAGE-2 AT ROW 1.75 COL 49.29 WIDGET-ID 24
     IMAGE-3 AT ROW 3 COL 36 WIDGET-ID 6
     IMAGE-4 AT ROW 3 COL 49.29 WIDGET-ID 8
     IMAGE-5 AT ROW 4.25 COL 36 WIDGET-ID 14
     IMAGE-6 AT ROW 4.25 COL 49.29 WIDGET-ID 16
...
/*                                                                                                */
    ...
    create tt-param.
    assign tt-param.ini-campo       = INPUT FRAME fPage2 c-usu-aprov-ini
           tt-param.fim-campo       = INPUT FRAME fPage2 c-usu-aprov-fin
           tt-param.impl-ini        = INPUT FRAME fPage2 dt-impl-ini
           tt-param.impl-fin        = INPUT FRAME fPage2 dt-impl-fin
           tt-param.aprov-ini       = INPUT FRAME fPage2 dt-aprov-ini
           tt-param.aprov-fin       = INPUT FRAME fPage2 dt-aprov-fin
...
END.
    ...
    {report/rprun.i esp/pdp/espdp075rp.p}
