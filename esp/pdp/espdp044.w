...
&GLOBAL-DEFINE Program        espdp044
...
&GLOBAL-DEFINE page2Widgets   tgRpaExec tgRpaUnico  tgRpbAguardandoPagamento ~
                              tgRpbPagamentoConfirmado tgRpbPedidosCancelados tgRpbUnico tgRpcExec tgRpcUnico ~
                              tgRpcExec tgRpcUnico tgRpbExec
...
&GLOBAL-DEFINE page2Fields    fiRpaCpf fiRpaCnpj fiRpbCodigoPedido fiRpcCodigoPedido 
...
DEFINE VARIABLE fiRpaCnpj AS CHARACTER FORMAT "XX.XXX.XXX/XXXX-XX":U 
     LABEL "CNPJ" 
     VIEW-AS FILL-IN 
     SIZE 15 BY .79 NO-UNDO.

DEFINE VARIABLE fiRpaCpf AS CHARACTER FORMAT "XXX.XXX.XXX-XX":U 
     LABEL "CPF" 
     VIEW-AS FILL-IN 
     SIZE 15 BY .79 NO-UNDO.

DEFINE VARIABLE fiRpbCodigoPedido AS INTEGER FORMAT ">>>>>>>>9":U INITIAL 0 
     LABEL "Pedido" 
     VIEW-AS FILL-IN 
     SIZE 13 BY .79 NO-UNDO.

DEFINE VARIABLE fiRpcCodigoPedido AS INTEGER FORMAT ">>>>>>>>9":U INITIAL 0 
     LABEL "Pedido" 
     VIEW-AS FILL-IN 
     SIZE 13 BY .79 NO-UNDO.

DEFINE VARIABLE fiRpdItCodigoFim AS CHARACTER FORMAT "X(16)":U INITIAL "ZZZZZZZZZZZZZZZZ" 
     LABEL "AtÇ" 
     VIEW-AS FILL-IN 
     SIZE 16 BY .79 NO-UNDO.

DEFINE VARIABLE fiRpdItCodigoIni AS CHARACTER FORMAT "X(16)":U 
     LABEL "De" 
     VIEW-AS FILL-IN 
     SIZE 16 BY .79 NO-UNDO.
...
DEFINE VARIABLE tgRpaExec AS LOGICAL INITIAL yes 
     LABEL "Importar Clientes" 
     VIEW-AS TOGGLE-BOX
     SIZE 15 BY .83 NO-UNDO.

DEFINE VARIABLE tgRpaUnico AS LOGICAL INITIAL no 
     LABEL "Um £nico cliente" 
     VIEW-AS TOGGLE-BOX
     SIZE 15 BY .83 NO-UNDO.

DEFINE VARIABLE tgRpbAguardandoPagamento AS LOGICAL INITIAL yes 
     LABEL "Aguardando Pagamento" 
     VIEW-AS TOGGLE-BOX
     SIZE 20 BY .83 NO-UNDO.

DEFINE VARIABLE tgRpbExec AS LOGICAL INITIAL yes 
     LABEL "Importar Pedidos" 
     VIEW-AS TOGGLE-BOX
     SIZE 15 BY .83 NO-UNDO.

DEFINE VARIABLE tgRpbPagamentoConfirmado AS LOGICAL INITIAL yes 
     LABEL "Pagamento Confirmado" 
     VIEW-AS TOGGLE-BOX
     SIZE 19 BY .83 NO-UNDO.

DEFINE VARIABLE tgRpbPedidosCancelados AS LOGICAL INITIAL yes 
     LABEL "Pedidos Cancelados" 
     VIEW-AS TOGGLE-BOX
     SIZE 19 BY .83 NO-UNDO.

DEFINE VARIABLE tgRpbUnico AS LOGICAL INITIAL no 
     LABEL "Um £nico pedido" 
     VIEW-AS TOGGLE-BOX
     SIZE 15 BY .83 NO-UNDO.

DEFINE VARIABLE tgRpcExec AS LOGICAL INITIAL yes 
     LABEL "Atualizar Pedidos" 
     VIEW-AS TOGGLE-BOX
     SIZE 15 BY .83 NO-UNDO.

DEFINE VARIABLE tgRpcUnico AS LOGICAL INITIAL no 
     LABEL "Um £nico pedido" 
     VIEW-AS TOGGLE-BOX
     SIZE 15 BY .83 NO-UNDO.

DEFINE VARIABLE tgRpdExec AS LOGICAL INITIAL no 
...
DEFINE FRAME fPage2
     tgRpaExec AT ROW 2.5 COL 9 WIDGET-ID 2
     tgRpbExec AT ROW 2.5 COL 33 WIDGET-ID 20
     tgRpcExec AT ROW 2.5 COL 56 WIDGET-ID 30
     tgRpaUnico AT ROW 3.25 COL 9 WIDGET-ID 8
     tgRpbAguardandoPagamento AT ROW 3.25 COL 33 WIDGET-ID 22
     tgRpcUnico AT ROW 3.25 COL 56 WIDGET-ID 36
     tgRpbPagamentoConfirmado AT ROW 4 COL 33 WIDGET-ID 24
     fiRpcCodigoPedido AT ROW 4.25 COL 60 COLON-ALIGNED WIDGET-ID 38
     fiRpaCpf AT ROW 4.5 COL 11 COLON-ALIGNED WIDGET-ID 12
     tgRpbPedidosCancelados AT ROW 4.75 COL 33 WIDGET-ID 52
     fiRpaCnpj AT ROW 5.5 COL 11 COLON-ALIGNED WIDGET-ID 14
     tgRpbUnico AT ROW 5.75 COL 33 WIDGET-ID 26
     fiRpbCodigoPedido AT ROW 6.75 COL 36 COLON-ALIGNED WIDGET-ID 28
     tgRpdExec AT ROW 9 COL 9 WIDGET-ID 44
     fiRpdItCodigoIni AT ROW 10 COL 10 COLON-ALIGNED WIDGET-ID 48
     fiRpdItCodigoFim AT ROW 11 COL 10 COLON-ALIGNED WIDGET-ID 50
     "Estoque" VIEW-AS TEXT
          SIZE 7 BY .54 AT ROW 8.25 COL 8 WIDGET-ID 42
     "Pedidos" VIEW-AS TEXT
          SIZE 6 BY .54 AT ROW 1.75 COL 32 WIDGET-ID 18
     "Clientes" VIEW-AS TEXT
          SIZE 6 BY .54 AT ROW 1.75 COL 8 WIDGET-ID 6
     "Status dos Pedidos" VIEW-AS TEXT
          SIZE 14 BY .54 AT ROW 1.75 COL 56 WIDGET-ID 34
     RECT-13 AT ROW 2 COL 7 WIDGET-ID 4
     RECT-14 AT ROW 2 COL 31 WIDGET-ID 16
     RECT-15 AT ROW 2 COL 55 WIDGET-ID 32
     RECT-16 AT ROW 8.5 COL 7 WIDGET-ID 40
...
/* SETTINGS FOR FRAME fPage2
                                                                        */
/* SETTINGS FOR TOGGLE-BOX tgRpdExec IN FRAME fPage2
   NO-ENABLE                                                            */
...
do on error undo, return error on stop  undo, return error:
    ...
    */
    ...
    assign tt-param.usuario         = c-seg-usuario
           ...
           tt-param.exec-rpa        = input frame fPage2 tgRpaExec
           tt-param.exec-rpb        = input frame fPage2 tgRpbExec
           tt-param.exec-rpc        = input frame fPage2 tgRpcExec
           tt-param.exec-rpd        = NO.
           
    create tt-param-rpa.
    assign tt-param-rpa.Unico = input frame fPage2 tgRpaUnico
           tt-param-rpa.CPF  = input frame fPage2 fiRpaCpf
           tt-param-rpa.CNPJ = input frame fPage2 fiRpaCnpj.

    create tt-param-rpb.
    assign tt-param-rpb.AguardandoPagamento = input frame fPage2 tgRpbAguardandoPagamento
           tt-param-rpb.PagamentoConfirmado = input frame fPage2 tgRpbPagamentoConfirmado
           tt-param-rpb.PedidoCancelado     = INPUT FRAME fPage2 tgRpbPedidosCancelados
           tt-param-rpb.Unico               = input frame fPage2 tgRpbUnico
           tt-param-rpb.CodigoPedido        = input frame fPage2 fiRpbCodigoPedido.

    create tt-param-rpc.
    assign tt-param-rpc.Unico        = input frame fPage2 tgRpcUnico
           tt-param-rpc.CodigoPedido = input frame fPage2 fiRpcCodigoPedido.

    create tt-param-rpd.
/*     assign tt-param-rpd.it-codigo-ini = input frame fPage2 fiRpdItCodigoIni  */
/*            tt-param-rpd.it-codigo-fim = input frame fPage2 fiRpdItCodigoFim. */

    raw-transfer tt-param-rpa to tt-param.param-rpa.
    raw-transfer tt-param-rpb to tt-param.param-rpb.
    raw-transfer tt-param-rpc to tt-param.param-rpc.
    raw-transfer tt-param-rpd to tt-param.param-rpd.
    ...
    {report/rprun.i esp/pdp/espdp044rp.p}
