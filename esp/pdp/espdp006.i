...
DEFINE VARIABLE iOrig-mercad        AS INTEGER    INITIAL 1             NO-UNDO.
DEFINE VARIABLE vParcMinima         AS LOGICAL                          NO-UNDO.
DEFINE VARIABLE lPedAlocado         AS LOGICAL                          NO-UNDO.
