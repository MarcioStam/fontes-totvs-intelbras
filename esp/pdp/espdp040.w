...
*******************************************************************************/
{include/i-prgvrs.i espdp040 1.00.00.000}

CREATE WIDGET-POOL.

/* Preprocessors Definitions ---                                      */
&GLOBAL-DEFINE Program        espdp040
...
&GLOBAL-DEFINE page2Fields    fiDtImplantFim fiDtImplantIni fiNrPedidoFim ~
                              fiNrPedidoIni fiCodAtendenteIni fiCodAtendenteFim 
...
DEFINE VARIABLE fiCodAtendenteFim AS INTEGER FORMAT ">>>9" INITIAL 0 
     VIEW-AS FILL-IN 
     SIZE 5 BY .88
     FONT 1 NO-UNDO.
...
do on error undo, return error on stop  undo, return error:
    ...
    */
    ...
    {report/rprun.i esp/pdp/espdp040rp.p}    
