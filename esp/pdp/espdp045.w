...
&GLOBAL-DEFINE Program        espdp045
...
&GLOBAL-DEFINE page2Widgets   tgRpcExec
...
DEFINE FRAME fPage2
     tgRpcExec AT ROW 2.5 COL 6 WIDGET-ID 30
     "Status dos Pedidos" VIEW-AS TEXT
          SIZE 14 BY .54 AT ROW 1.75 COL 6 WIDGET-ID 34
     pdp0RECT-15 AT ROW 2 COL 5 WIDGET-ID 32
...
/* SETTINGS FOR FRAME fPage2
                                                                        */
/* SETTINGS FOR TOGGLE-BOX tgRpcExec IN FRAME fPage2
   NO-ENABLE                                                            */
...
ASSIGN tgRpcExec:sensitive IN FRAME fPage2 = NO.
...
do on error undo, return error on stop  undo, return error:
    ...
    */
    ...
    {report/rprun.i esp/pdp/espdp045rp.p}
