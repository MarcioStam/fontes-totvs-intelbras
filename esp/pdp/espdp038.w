...
&GLOBAL-DEFINE Program        ESPDP038
...
&GLOBAL-DEFINE page2Fields    fiestabel fiind-acrescimo fitb-preco
...
DEFINE VARIABLE fiEstabel AS CHARACTER FORMAT "X(3)":U 
     LABEL "Estabelecimento" 
     VIEW-AS FILL-IN 
     SIZE 6 BY .88
     FONT 1 NO-UNDO.

DEFINE VARIABLE fiind-acrescimo AS DECIMAL FORMAT ">>9.99":U INITIAL 1.2 
     LABEL "Öndice Acr‚scimo" 
     VIEW-AS FILL-IN 
     SIZE 6 BY .79 NO-UNDO.

DEFINE VARIABLE fitb-preco AS CHARACTER FORMAT "X(8)":U 
     LABEL "Tb.Pre‡o" 
     VIEW-AS FILL-IN 
     SIZE 11 BY .88
     FONT 1 NO-UNDO.
...
DEFINE FRAME fPage2
     fiEstabel AT ROW 2 COL 29
     fitb-preco AT ROW 3 COL 33.86 WIDGET-ID 30
     fiind-acrescimo AT ROW 4 COL 39 COLON-ALIGNED WIDGET-ID 22
...
/* SETTINGS FOR FRAME fPage2
                                                                        */
/* SETTINGS FOR FILL-IN fiEstabel IN FRAME fPage2
   ALIGN-L                                                              */
/* SETTINGS FOR FILL-IN fitb-preco IN FRAME fPage2
   ALIGN-L                                                              */
...
do on error undo, return error on stop  undo, return error:
    ...
    assign tt-param.usuario          = c-seg-usuario
           ...
           tt-param.cod-estabel      = INPUT FRAME fPage2 fiEstabel
           tt-param.tb-preco         = INPUT FRAME fPage2 fitb-preco
           tt-param.ind-acrescimo    = INPUT FRAME fPage2 fiind-acrescimo
    ...
    {report/rprun.i esp/pdp/espdp038rp.p}
