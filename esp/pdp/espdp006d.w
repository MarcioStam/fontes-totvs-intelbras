...
*******************************************************************************/
{include/i-prgvrs.i ESPDP006d 2.04.00.001}

CREATE WIDGET-POOL.

/* Preprocessors Definitions ---                                      */
&GLOBAL-DEFINE Program        ESPDP006d
    ...
    IF tt-digita.cod-depos:SCREEN-VALUE IN BROWSE br-EstabDepos <> '' THEN DO:
        ...
        IF AVAIL tt-digita THEN DO:
            ...
            IF AVAIL deposito THEN DO:
                ...
                RUN esp/wmp/eswmpapi006.p( INPUT tt-digita.cod-estab, OUTPUT l-wms-estab-ativo).
                IF  l-wms-estab-ativo 
                AND deposito.cod-depos = 'EXP' THEN DO:
                    run utp/ut-msgs.p (input "show":U, input 17006, input "Dep¢sito Inv lido!~~Dep¢sito informado nÆo pode ser utilizado no estabelecimento " + tt-digita.cod-estab + ".").
...
/*        RUN utp/ut-msgs.p (input "show":U, input 17006, input "Fun‡Æo temporariamente desativada":U). */
/*        RETURN NO-APPLY.                                                                              */
/*     END.                                                                                             */
    ...
    AND INPUT FRAME fPage2 l-alocFat    = NO  THEN DO:
       RUN utp/ut-msgs.p (input "show":U, input 17006, input "Escolher uma Op‡Æo:~~'Alocar e Liberar para Faturamento' ou 'Alocar e Faturar'":U).
       RETURN NO-APPLY.
    END.
...
DO ON ERROR UNDO, RETURN ERROR ON STOP UNDO, RETURN ERROR:
    ...
    {report/rprun.i esp/pdp/espdp006rp.p}
