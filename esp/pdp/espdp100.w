...
*******************************************************************************/
{include/i-prgvrs.i espdp100 2.00.00.000}
...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW w-relat ASSIGN
         HIDDEN             = YES
         TITLE              = "Atualiza‡Æo de Saldo - Meta de Canais"
         HEIGHT             = 15
         WIDTH              = 81.14
         MAX-HEIGHT         = 28.92
         MAX-WIDTH          = 146.29
...
{utp/ut9000.i "espdp100" "2.00.00.000"}
...
do on error undo, return error on stop  undo, return error:
    ...
    {include/i-rprun.i esp/pdp/espdp100rp.p}
