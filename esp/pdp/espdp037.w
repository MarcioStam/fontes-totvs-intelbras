...
*******************************************************************************/
{include/i-prgvrs.i ESPDP037 2.04.00.001}

CREATE WIDGET-POOL.

/* Preprocessors Definitions ---                                      */
&GLOBAL-DEFINE Program        ESPDP037
...
&GLOBAL-DEFINE page0Widgets   btOk ~
                              btCancel ~
                              btHelp2
&GLOBAL-DEFINE page2Widgets   id-ativo id-situacao dt-venc-lim-ini dt-venc-lim-fin
...
DEFINE VARIABLE dt-venc-lim-fin AS DATE FORMAT "99/99/9999":U INITIAL ? 
     VIEW-AS FILL-IN 
     SIZE 12 BY .79 NO-UNDO.

DEFINE VARIABLE dt-venc-lim-ini AS DATE FORMAT "99/99/9999":U INITIAL ? 
     LABEL "Dt.Vencimento Limite" 
     VIEW-AS FILL-IN 
     SIZE 12 BY .79 NO-UNDO.
...
DEFINE VARIABLE id-ativo AS INTEGER 
...
DEFINE VARIABLE id-situacao AS INTEGER 
     VIEW-AS RADIO-SET VERTICAL
     RADIO-BUTTONS 
     "Normal", 1,
     "Automatico", 2,
...
DEFINE FRAME fPage2
     dt-venc-lim-ini AT ROW 2 COL 23 COLON-ALIGNED WIDGET-ID 2
     dt-venc-lim-fin AT ROW 2 COL 55 COLON-ALIGNED NO-LABEL WIDGET-ID 4
     id-ativo AT ROW 3.5 COL 27 NO-LABEL WIDGET-ID 10
     id-situacao AT ROW 6.75 COL 26 NO-LABEL WIDGET-ID 14
     "Situa‡Æo Cr‚dito" VIEW-AS TEXT
          SIZE 14 BY .75 AT ROW 6.25 COL 7 WIDGET-ID 24
     "Situa‡Æo Cliente" VIEW-AS TEXT
          SIZE 16 BY .75 AT ROW 3.5 COL 7 WIDGET-ID 26
     IMAGE-1 AT ROW 2 COL 38 WIDGET-ID 6
     IMAGE-2 AT ROW 2 COL 53.43 WIDGET-ID 8
     RECT-17 AT ROW 3.25 COL 5 WIDGET-ID 20
     RECT-18 AT ROW 6 COL 5 WIDGET-ID 22
...
do on error undo, return error on stop  undo, return error:
    ...
    assign tt-param.usuario          = c-seg-usuario
           ...
           tt-param.id-ativo         = INPUT FRAME fpage2 id-ativo
           tt-param.dt-venc-lim-ini  = INPUT FRAME fpage2 dt-venc-lim-ini
           tt-param.dt-venc-lim-fin  = INPUT FRAME fpage2 dt-venc-lim-fin
           tt-param.id-situacao      = INPUT FRAME fpage2 id-situacao.
           .
    ...
    {report/rprun.i esp/pdp/espdp037rp.p}
