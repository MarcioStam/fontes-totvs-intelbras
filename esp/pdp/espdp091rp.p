{include/i-prgvrs.i ESPDP091rp 2.06.00.002}
/***********************************************************************
**  Programa..:  ESP\PDP\ESPDP091RP.P 
    ...
    FOR EACH tt-notaFiscaisGeradas no-lock:
        ...
        IF AVAIL nota-fiscal THEN DO:
            ...
            ASSIGN tt-ft0910.usuario           = ""
                   tt-ft0910.arquivo           = "espdp091rp.txt"
                   tt-ft0910.destino           = 2
...
PROCEDURE LiberaParaFaturamento: /* Mesma rotina do espdp091.w botao libera para faturamento */
