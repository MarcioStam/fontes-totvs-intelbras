...
CREATE WIDGET-POOL.
DEF INPUT PARAMETER c-observ-pedido AS CHAR.
DEF INPUT PARAMETER c-cond-espec AS CHAR.
/* ***************************  Definitions  ************************** */
...
&Scoped-Define ENABLED-OBJECTS rt-button EDITOR-1 EDITOR-2 bt-ok bt-cancela ~
bt-ajuda 
...
DEFINE FRAME f-cad
     EDITOR-1 AT ROW 1.5 COL 21 NO-LABEL WIDGET-ID 4
     EDITOR-2 AT ROW 6 COL 21 NO-LABEL WIDGET-ID 6
     bt-ok AT ROW 12.21 COL 3
     bt-cancela AT ROW 12.21 COL 14
     bt-imprime AT ROW 12.21 COL 25
     bt-ajuda AT ROW 12.21 COL 69
     "Observ. do Pedido" VIEW-AS TEXT
          SIZE 18 BY .67 AT ROW 1.75 COL 2 WIDGET-ID 8
     "Condi‡äes Espec." VIEW-AS TEXT
          SIZE 18 BY .67 AT ROW 6.25 COL 2 WIDGET-ID 10
...
------------------------------------------------------------------------------*/
  ...
  ENABLE rt-button EDITOR-1 EDITOR-2 bt-ok bt-cancela bt-ajuda 
      WITH FRAME f-cad IN WINDOW w-cadsim.
...
------------------------------------------------------------------------------*/
  ...
  {utp/ut9000.i "ESPDP005C" "9.99.99.999"}
...
ASSIGN editor-1:SCREEN-VALUE IN FRAME f-cad = c-observ-pedido.
ASSIGN editor-2:SCREEN-VALUE IN FRAME f-cad = c-cond-espec.
DISABLE EDITOR-1 editor-2 WITH FRAME F-CAD.
