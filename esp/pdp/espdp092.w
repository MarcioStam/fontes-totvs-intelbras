...
*******************************************************************************/
{include/i-prgvrs.i espdp092 2.00.00.000}
...
&Scoped-define FIELDS-IN-QUERY-br-digita tt-digita.nr-pedido tt-digita.cod-transp   
&Scoped-define ENABLED-FIELDS-IN-QUERY-br-digita tt-digita.nr-pedido tt-digita.cod-transp   
...
DEFINE VARIABLE EDITOR-1 AS CHARACTER INITIAL "Troca de transportadora dos pedidos." 
     VIEW-AS EDITOR
     SIZE 74 BY 4 NO-UNDO.
...
DEFINE FRAME f-pg-sel
     EDITOR-1 AT ROW 1.25 COL 3 NO-LABEL WIDGET-ID 2
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 3 ROW 2.85
...
DO:
    if  br-digita:new-row in frame f-pg-dig then do:
        ...
        display tt-digita.nr-pedido
                tt-digita.cod-transp with browse br-digita. 
    end.
    return no-apply.
END.
...
DO:
    ...
    do transaction on error undo, return no-apply:
        ...
        assign input browse br-digita tt-digita.nr-pedido
               input browse br-digita tt-digita.cod-transp.
...
{utp/ut9000.i "espdp092" "2.00.00.000"}
...
do on error undo, return error on stop  undo, return error:
    ...
    for each tt-digita no-lock:
        ...
        IF NOT CAN-FIND (FIRST transporte
                         WHERE transporte.cod-transp = tt-digita.cod-transp) THEN DO:
            assign browse br-digita:CURRENT-COLUMN = tt-digita.cod-transp:HANDLE in browse br-digita.

            apply "MOUSE-SELECT-CLICK":U to im-pg-dig in frame f-relat.
            reposition br-digita to rowid r-tt-digita.

            run utp/ut-msgs.p (input "show":U, input 17006, input "Transportadora n∆o cadastrada.").
            apply "ENTRY":U to tt-digita.cod-transp in browse br-digita.
    ...
    {include/i-rprun.i esp/pdp/espdp092rp.p}
