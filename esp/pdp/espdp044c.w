...
*******************************************************************************/
{include/i-prgvrs.i espdp044c 2.04.00.001}

CREATE WIDGET-POOL.

/* Preprocessors Definitions ---                                      */
&GLOBAL-DEFINE Program        espdp044c
...
&GLOBAL-DEFINE page2Widgets   tgRpdExec
...
&GLOBAL-DEFINE page2Fields    fiRpdItCodigoIni fiRpdItCodigoFim
...
DEFINE VARIABLE tgRpaExec AS LOGICAL INITIAL no 
...
DEFINE VARIABLE tgRpbAguardandoPagamento AS LOGICAL INITIAL no 
     LABEL "Aguardando Pagamento" 
     VIEW-AS TOGGLE-BOX
     SIZE 20 BY .83 NO-UNDO.

DEFINE VARIABLE tgRpbExec AS LOGICAL INITIAL no 
     LABEL "Importar Pedidos" 
     VIEW-AS TOGGLE-BOX
     SIZE 15 BY .83 NO-UNDO.

DEFINE VARIABLE tgRpbPagamentoConfirmado AS LOGICAL INITIAL no 
     LABEL "Pagamento Confirmado" 
     VIEW-AS TOGGLE-BOX
     SIZE 19 BY .83 NO-UNDO.

DEFINE VARIABLE tgRpbPedidosCancelados AS LOGICAL INITIAL no 
...
DEFINE VARIABLE tgRpcExec AS LOGICAL INITIAL no 
...
DEFINE VARIABLE tgRpdExec AS LOGICAL INITIAL yes 
...
do on error undo, return error on stop  undo, return error:
    ...
    */
    ...
    assign tt-param.usuario         = c-seg-usuario
           ...
           tt-param.exec-rpa        = no
           tt-param.exec-rpb        = no
           tt-param.exec-rpc        = no
           tt-param.exec-rpd        = input frame fPage2 tgRpdExec.
           
    create tt-param-rpa.
    assign tt-param-rpa.Unico = NO
           tt-param-rpa.CPF  =  ""
           tt-param-rpa.CNPJ =  "".

    create tt-param-rpb.
    assign tt-param-rpb.AguardandoPagamento = no
           tt-param-rpb.PagamentoConfirmado = no
           tt-param-rpb.PedidoCancelado     = no
           tt-param-rpb.Unico               = no
           tt-param-rpb.CodigoPedido        = 0.

    create tt-param-rpc.
    assign tt-param-rpc.Unico        = NO
           tt-param-rpc.CodigoPedido = 0.
