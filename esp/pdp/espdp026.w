...
*******************************************************************************/
{include/i-prgvrs.i ESPDP026 2.00.00.001}
...
&IF "{&EMSFND_VERSION}" >= "1.00" &THEN
    {include/i-license-manager.i ESPDP026 MPD}
&ENDIF
...
DEFINE VARIABLE cod-emitente-fim AS INTEGER FORMAT "999999999":U INITIAL 999999999 
     VIEW-AS FILL-IN NATIVE 
     SIZE 12 BY .88 NO-UNDO.

DEFINE VARIABLE cod-emitente-ini AS INTEGER FORMAT "999999999":U INITIAL 0 
     LABEL "Cod Cliente" 
     VIEW-AS FILL-IN NATIVE 
     SIZE 12 BY .88 NO-UNDO.

DEFINE VARIABLE dt-entrega-fim AS DATE FORMAT "99/99/9999" INITIAL 12/31/9999 
     VIEW-AS FILL-IN 
     SIZE 11 BY .88 NO-UNDO.

DEFINE VARIABLE dt-entrega-ini AS DATE FORMAT "99/99/9999" INITIAL 01/01/001 
     LABEL "Prev.Fatur" 
     VIEW-AS FILL-IN 
     SIZE 11 BY .88 NO-UNDO.
...
DEFINE VARIABLE nr-repres-fim AS INTEGER FORMAT ">>>>9":U INITIAL 99999 
     VIEW-AS FILL-IN 
     SIZE 7 BY .88 NO-UNDO.

DEFINE VARIABLE nr-repres-ini AS INTEGER FORMAT ">>>>9":U INITIAL 0 
     LABEL "Representante" 
     VIEW-AS FILL-IN 
     SIZE 7 BY .88 NO-UNDO.

DEFINE VARIABLE tp-pedido-new AS CHARACTER FORMAT "x(2)" INITIAL "ZZ" 
     LABEL "Atendente Novo" 
     VIEW-AS FILL-IN 
     SIZE 3 BY .88 NO-UNDO.

DEFINE VARIABLE tp-pedido-old AS CHARACTER FORMAT "x(2)" 
     LABEL "Atendente Antigo" 
     VIEW-AS FILL-IN 
     SIZE 3 BY .88 NO-UNDO.
...
DEFINE FRAME f-pg-sel
     ...
     dt-implant-ini AT ROW 2.25 COL 19 COLON-ALIGNED HELP
          "Data em que o Pedido foi implantado no sistema" WIDGET-ID 12
     dt-implant-fim AT ROW 2.25 COL 48.14 COLON-ALIGNED HELP
          "Data em que o Pedido foi implantado no sistema" NO-LABEL WIDGET-ID 10
     dt-entrega-ini AT ROW 3.25 COL 19 COLON-ALIGNED HELP
          "Data de entrega" WIDGET-ID 44
     dt-entrega-fim AT ROW 3.25 COL 48.14 COLON-ALIGNED HELP
          "Data de entrega" NO-LABEL WIDGET-ID 42
     cod-emitente-ini AT ROW 4.25 COL 17.86 COLON-ALIGNED WIDGET-ID 54
     cod-emitente-fim AT ROW 4.25 COL 48.43 COLON-ALIGNED NO-LABEL WIDGET-ID 56
     nr-repres-ini AT ROW 5.25 COL 22.72 COLON-ALIGNED WIDGET-ID 62
     nr-repres-fim AT ROW 5.25 COL 48.57 COLON-ALIGNED NO-LABEL WIDGET-ID 64
     tp-pedido-old AT ROW 6.29 COL 27 COLON-ALIGNED HELP
          "Dispon¡vel para classifica‡Æo/indica‡Æo pr¢pria do usu rio" WIDGET-ID 36
     tp-pedido-new AT ROW 6.29 COL 48.14 COLON-ALIGNED HELP
          "Dispon¡vel para classifica‡Æo/indica‡Æo pr¢pria do usu rio" WIDGET-ID 34
     IMAGE-1 AT ROW 1.25 COL 31.86
     IMAGE-2 AT ROW 1.25 COL 47.29
     IMAGE-5 AT ROW 2.25 COL 31.86 WIDGET-ID 14
     IMAGE-6 AT ROW 2.25 COL 47.29 WIDGET-ID 16
     IMAGE-13 AT ROW 3.25 COL 31.86 WIDGET-ID 46
     IMAGE-14 AT ROW 3.25 COL 47.29 WIDGET-ID 48
     IMAGE-15 AT ROW 4.25 COL 32 WIDGET-ID 50
     IMAGE-16 AT ROW 4.25 COL 47.29 WIDGET-ID 52
     IMAGE-17 AT ROW 5.25 COL 32 WIDGET-ID 58
     IMAGE-18 AT ROW 5.25 COL 47.29 WIDGET-ID 60
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 3 ROW 2.85
...
ON END-ERROR OF w-relat /* Altera Atendente */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL w-relat w-relat
ON WINDOW-CLOSE OF w-relat /* Altera Atendente */
DO:
...
{utp/ut9000.i "ESPDP026" "2.00.00.001"}
...
------------------------------------------------------------------------------*/
  ...
  DISPLAY nr-pedido-ini nr-pedido-fim dt-implant-ini dt-implant-fim 
          dt-entrega-ini dt-entrega-fim cod-emitente-ini cod-emitente-fim 
          nr-repres-ini nr-repres-fim tp-pedido-old tp-pedido-new 
      WITH FRAME f-pg-sel IN WINDOW w-relat.
  ENABLE IMAGE-1 IMAGE-2 IMAGE-5 IMAGE-6 IMAGE-13 IMAGE-14 IMAGE-15 IMAGE-16 
         IMAGE-17 IMAGE-18 nr-pedido-ini nr-pedido-fim dt-implant-ini 
         dt-implant-fim dt-entrega-ini dt-entrega-fim cod-emitente-ini 
         cod-emitente-fim nr-repres-ini nr-repres-fim tp-pedido-old 
         tp-pedido-new 
      WITH FRAME f-pg-sel IN WINDOW w-relat.
...
do on error undo, return error on stop  undo, return error:
    ...
    assign tt-param.usuario           = c-seg-usuario
           ...
           tt-param.dt-entrega-ini   = input frame f-pg-sel dt-entrega-ini
           tt-param.dt-entrega-fim   = input frame f-pg-sel dt-entrega-fim
           tt-param.tp-pedido-new    = input frame f-pg-sel tp-pedido-new 
           tt-param.tp-pedido-old    = input frame f-pg-sel tp-pedido-old 
           ...
           tt-param.nr-repres-ini    = input frame f-pg-sel nr-repres-ini
           tt-param.nr-repres-fim    = input frame f-pg-sel nr-repres-fim.
    ...
    {include/i-rprun.i esp/pdp/espdp026rp.p}
