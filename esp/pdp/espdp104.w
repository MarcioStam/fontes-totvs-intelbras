...
*******************************************************************************/
{include/i-prgvrs.i espdp104 1.10.00.000}
//123
...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW w-relat ASSIGN
         HIDDEN             = YES
         TITLE              = "Inativacao Precos Obsoletos"
         HEIGHT             = 15
         WIDTH              = 81.14
         MAX-HEIGHT         = 28.92
         MAX-WIDTH          = 146.29
...
ON END-ERROR OF w-relat /* Inativacao Precos Obsoletos */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL w-relat w-relat
ON WINDOW-CLOSE OF w-relat /* Inativacao Precos Obsoletos */
DO:
...
{utp/ut9000.i "espdp104" "1.00.00.000"}
...
do on error undo, return error on stop  undo, return error:
    ...
    {include/i-rprun.i esp/pdp/espdp104rp.p}
