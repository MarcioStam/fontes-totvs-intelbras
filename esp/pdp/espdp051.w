...
*******************************************************************************/
{include/i-prgvrs.i espdp051 2.00.00.002}  /*** 010002 ***/
...
DEFINE VARIABLE l-bonificacao AS LOGICAL INITIAL no 
     LABEL "Considerar Pedidos de Bonificaá∆o" 
     VIEW-AS TOGGLE-BOX
...
DEFINE VARIABLE c-grupo-cobran-fim AS CHARACTER FORMAT "X(03)":U INITIAL "99" 
     VIEW-AS FILL-IN 
     SIZE 7.14 BY .88 NO-UNDO.

DEFINE VARIABLE c-grupo-cobran-ini AS CHARACTER FORMAT "X(03)":U 
     LABEL "Grupo de Cobranáa" 
     VIEW-AS FILL-IN 
     SIZE 7 BY .88 NO-UNDO.

DEFINE VARIABLE c-grupo-fim AS CHARACTER FORMAT "X(03)":U INITIAL "99" 
     VIEW-AS FILL-IN 
     SIZE 7.14 BY .88 NO-UNDO.

DEFINE VARIABLE c-grupo-ini AS CHARACTER FORMAT "X(03)":U 
...
DEFINE VARIABLE c-priori-fim AS CHARACTER FORMAT "X(03)":U INITIAL "99" 
     VIEW-AS FILL-IN 
     SIZE 7.14 BY .88 NO-UNDO.

DEFINE VARIABLE c-priori-ini AS CHARACTER FORMAT "X(03)":U 
     LABEL "Prioridade" 
     VIEW-AS FILL-IN 
     SIZE 7 BY .88 NO-UNDO.
...
DEFINE FRAME f-pg-sel
     c-estab-ini AT ROW 2 COL 18 COLON-ALIGNED
     c-estab-fim AT ROW 2 COL 48 COLON-ALIGNED NO-LABEL
     c-cli-ini AT ROW 3 COL 18 COLON-ALIGNED HELP
          "Nome abreviado inicial do cliente."
     c-cli-fim AT ROW 3 COL 48 COLON-ALIGNED HELP
          "Nome abreviado final do cliente." NO-LABEL
     c-pedido-ini AT ROW 4 COL 18 COLON-ALIGNED HELP
          "Pedido inicial do cliente."
     c-pedido-fim AT ROW 4 COL 48 COLON-ALIGNED HELP
          "Pedido final do cliente." NO-LABEL
     dt-impl-ini AT ROW 5 COL 18 COLON-ALIGNED HELP
          "Data inicial de implantaá∆o."
     dt-impl-fim AT ROW 5 COL 48 COLON-ALIGNED HELP
          "Data final de implantaá∆o." NO-LABEL
     dt-entr-ini AT ROW 6 COL 18 COLON-ALIGNED HELP
          "Data de entrega inicial."
     dt-entr-fim AT ROW 6 COL 48 COLON-ALIGNED HELP
          "Data de entrega final." NO-LABEL
     c-rep-ini AT ROW 7 COL 18 COLON-ALIGNED HELP
          "Nome abreviado do representante inicial."
     c-rep-fim AT ROW 7 COL 48 COLON-ALIGNED HELP
          "Nome abreviado do representante inicial." NO-LABEL
     c-priori-ini AT ROW 8 COL 18 COLON-ALIGNED WIDGET-ID 4
     c-priori-fim AT ROW 8 COL 48 COLON-ALIGNED NO-LABEL WIDGET-ID 2
     c-grupo-ini AT ROW 9 COL 18 COLON-ALIGNED WIDGET-ID 12
     c-grupo-fim AT ROW 9 COL 48 COLON-ALIGNED NO-LABEL WIDGET-ID 10
     c-grupo-cobran-ini AT ROW 10 COL 18 COLON-ALIGNED WIDGET-ID 20
     c-grupo-cobran-fim AT ROW 10 COL 48 COLON-ALIGNED NO-LABEL WIDGET-ID 18
     IMAGE-1 AT ROW 2 COL 35
     IMAGE-2 AT ROW 2 COL 47
     IMAGE-3 AT ROW 3 COL 35
     IMAGE-4 AT ROW 3 COL 47
     IMAGE-5 AT ROW 4 COL 35
     IMAGE-6 AT ROW 4 COL 47
     IMAGE-7 AT ROW 5 COL 35
     IMAGE-8 AT ROW 5 COL 47
     IMAGE-9 AT ROW 6 COL 35
     IMAGE-10 AT ROW 6 COL 47
     IMAGE-11 AT ROW 7 COL 35
     IMAGE-12 AT ROW 7 COL 47
     IMAGE-13 AT ROW 8 COL 35 WIDGET-ID 6
     IMAGE-14 AT ROW 8 COL 47 WIDGET-ID 8
     IMAGE-15 AT ROW 9 COL 35 WIDGET-ID 14
     IMAGE-16 AT ROW 9 COL 47 WIDGET-ID 16
     IMAGE-17 AT ROW 10 COL 35 WIDGET-ID 22
     IMAGE-18 AT ROW 10 COL 47 WIDGET-ID 24
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 3 ROW 2.85
         SIZE 76.86 BY 10.62
...
DEFINE FRAME f-pg-par
     ...
     l-bonificacao AT ROW 7.29 COL 5.72 WIDGET-ID 4
     ...
     RECT-14 AT ROW 6.75 COL 3 WIDGET-ID 2
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 3 ROW 3
         SIZE 76.72 BY 10.5
...
{utp/ut9000.i "espdp051" "2.00.00.002"}
...
------------------------------------------------------------------------------*/
  ...
  DISPLAY c-estab-ini c-estab-fim c-cli-ini c-cli-fim c-pedido-ini c-pedido-fim 
          ...
          c-priori-ini c-priori-fim c-grupo-ini c-grupo-fim c-grupo-cobran-ini 
          c-grupo-cobran-fim 
  ...
  ENABLE IMAGE-1 IMAGE-2 IMAGE-3 IMAGE-4 IMAGE-5 IMAGE-6 IMAGE-7 IMAGE-8 
         ...
         IMAGE-17 IMAGE-18 c-estab-ini c-estab-fim c-cli-ini c-cli-fim 
         c-pedido-ini c-pedido-fim dt-impl-ini dt-impl-fim dt-entr-ini 
         dt-entr-fim c-rep-ini c-rep-fim c-priori-ini c-priori-fim c-grupo-ini 
         c-grupo-fim c-grupo-cobran-ini c-grupo-cobran-fim 
      WITH FRAME f-pg-sel IN WINDOW w-relat.
  ...
  DISPLAY rs-moeda l-ped-aval l-ped-n-aval l-ped-aprov l-ped-n-aprov 
          l-mot-recusa l-bonificacao c-text2 c-text c-text3 
      WITH FRAME f-pg-par IN WINDOW w-relat.
  ENABLE RECT-12 RECT-11 RECT-13 RECT-14 rs-moeda l-ped-aval l-ped-n-aval 
         l-ped-aprov l-ped-n-aprov l-mot-recusa l-bonificacao c-text2 c-text 
         c-text3 
      WITH FRAME f-pg-par IN WINDOW w-relat.
...
/*              tt-param.l-ped-pend-inf = input frame f-pg-par l-ped-pend-inf*/
              ...
              tt-param.i-priori-ini       = int(input frame f-pg-sel c-priori-ini)
              tt-param.i-priori-fim       = int(input frame f-pg-sel c-priori-fim)
              tt-param.i-grupo-ini        = int(input frame f-pg-sel c-grupo-ini)
              tt-param.i-grupo-fim        = int(input frame f-pg-sel c-grupo-fim)
              tt-param.i-grupo-cobran-ini = INT(INPUT FRAME f-pg-sel c-grupo-cobran-ini)
              tt-param.i-grupo-cobran-fim = INT(INPUT FRAME f-pg-sel c-grupo-cobran-fim)
              tt-param.l-bonificacao      = input frame f-pg-par l-bonificacao.
    ...
    {include/i-rprun.i esp/pdp/espdp051rp.p}
