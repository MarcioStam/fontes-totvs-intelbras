...
def frame f_sea_01_grp_clien 
    ...
    with 1 down side-labels no-validate keep-tab-order three-d 
         ...
         title "Pesquisa Usu rios - ES0512KA-2 - 1.00.00.001". 
    ...
    case input frame f_sea_01_grp_clien rs_sea_grp_clien: 
        ...
        when "Por Descri‡Æo" then 
            ...
            do: 
                open query qr_sea_grp_clien for 
                    each usuar_mestre no-lock 
                    where usuar_mestre.nom_usuar >= v_cod_initial 
                      and usuar_mestre.nom_usuar <= v_cod_final 
                    by usuar_mestre.nom_usuar. 
            end /* do name_block */. 
    end /* case case_block */. 
END PROCEDURE.
