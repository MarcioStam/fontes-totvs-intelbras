...
*******************************************************************************/
{include/i-prgvrs.i es0577 2.04.00.001}

CREATE WIDGET-POOL.

/* Preprocessors Definitions ---                                      */
&GLOBAL-DEFINE Program        es0577
...
DEFINE FRAME fPage6
     rsDestiny AT ROW 2.25 COL 3.29 HELP
          "Destino de Impress∆o do Relat¢rio" NO-LABEL
     btFile AT ROW 3.46 COL 43.29 HELP
          "Escolha do nome do arquivo"
     btConfigImpr AT ROW 3.46 COL 43.29 HELP
          "Configuraá∆o da impressora"
     cFile AT ROW 3.5 COL 3.29 HELP
          "Nome do arquivo de destino do relat¢rio" NO-LABEL
     rsExecution AT ROW 5.63 COL 3 HELP
          "Modo de Execuá∆o" NO-LABEL
     text-destino AT ROW 1.5 COL 1.86 COLON-ALIGNED NO-LABEL
     text-modo AT ROW 4.88 COL 1.29 COLON-ALIGNED NO-LABEL
     RECT-7 AT ROW 1.79 COL 2.14
