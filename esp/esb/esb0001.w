...
*******************************************************************************/
{include/i-prgvrs.i ESB0001 2.00.00.000}
...
DEFINE FRAME f-pg-par
     l-nota-fiscal AT ROW 2.17 COL 3.43
     "Movimentaá‰es:" VIEW-AS TEXT
          SIZE 12 BY .54 AT ROW 1 COL 3.72 WIDGET-ID 86
     RECT-12 AT ROW 1.25 COL 2.14 WIDGET-ID 80
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 3 ROW 3
         SIZE 77 BY 10.63
...
DEFINE FRAME f-pg-sel
     ...
     c-cod-emitente-ini AT ROW 6 COL 15 COLON-ALIGNED WIDGET-ID 44
     c-cod-emitente-fim AT ROW 6 COL 48.14 COLON-ALIGNED NO-LABEL WIDGET-ID 42
     ...
     IMAGE-11 AT ROW 6 COL 31.86 WIDGET-ID 48
     IMAGE-12 AT ROW 6 COL 47.29 WIDGET-ID 46
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 3 ROW 2.85
         SIZE 76.86 BY 10.62
...
{utp/ut9000.i "ESB0001" "2.00.00.000"}
...
------------------------------------------------------------------------------*/
  ...
  ENABLE IMAGE-1 IMAGE-2 RECT-10 IMAGE-5 IMAGE-6 IMAGE-7 IMAGE-8 IMAGE-9 
         IMAGE-10 IMAGE-11 IMAGE-12 d-emiss-nota-ini d-emiss-nota-fim 
         c-cod-estabel-ini c-cod-estabel-fim c-serie-ini c-serie-fim 
         c-nr-nota-fis-ini c-nr-nota-fis-fim c-cod-emitente-ini 
         c-cod-emitente-fim 
      WITH FRAME f-pg-sel IN WINDOW w-relat.
  ...
  DISPLAY l-nota-fiscal 
      WITH FRAME f-pg-par IN WINDOW w-relat.
  ENABLE RECT-12 l-nota-fiscal 
      WITH FRAME f-pg-par IN WINDOW w-relat.
