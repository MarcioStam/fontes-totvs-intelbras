...
PROCEDURE pi-Integra-Despesas-APB:
    ...
    DEF INPUT PARAM TABLE FOR tt-rateio-unid.
    ...
    IF  NOT CAN-FIND (FIRST tt-beneficio) THEN DO:
        MESSAGE "busca beneficios canal" VIEW-AS ALERT-BOX.
    ...
    FOR FIRST int-cc-benef NO-LOCK   
        ...
        FIND FIRST tt-rateio-unid
             WHERE tt-rateio-unid.canal          = int-cc-benef.canal
               AND tt-rateio-unid.tipo-beneficio = int-cc-benef.tipo-beneficio
               AND tt-rateio-unid.nova-unidade   = int-cc-benef.unid-neg NO-ERROR.
        ...
        IF NOT AVAIL estabelec THEN DO:
            ...
            MESSAGE "int-cc-benef.canal "        int-cc-benef.canal        SKIP
                    "tt-beneficio.cod-estabel "  tt-beneficio.cod-estabel  SKIP
                    "tt-beneficio.conta "        tt-beneficio.conta        SKIP
                    "tt-beneficio.centro-custo " tt-beneficio.centro-custo SKIP
                    "tt-beneficio.cod-especie "  tt-beneficio.cod-especie  SKIP
                    "tt-beneficio.tipo-fluxo "   tt-beneficio.tipo-fluxo   SKIP
                    "tt-beneficio.unid-neg "     tt-beneficio.unid-neg
                    VIEW-AS ALERT-BOX.
        ...
        /*-----------------------------------*/
        IF  NOT (tt-beneficio.perc-custo > 0) AND  int-cc-benef.unid-neg <> "ADM" THEN DO:
            RUN pi-cria-erro IN THIS-PROCEDURE (INPUT 17006, /* Erro */
        ...
        END.
        ELSE DO:
            DEF VAR da-vencto-aux AS DATE NO-UNDO.
            
            IF  tt-beneficio.tipo-beneficio = 37 
            OR  tt-beneficio.tipo-beneficio = 66 THEN
                ASSIGN da-vencto-aux = 07/31/2018.
            ELSE 
                ASSIGN da-vencto-aux = 07/31/2018.
...
PROCEDURE pi-cria-temp-table-titulo:
    ...
    ASSIGN tt_integr_apb_item_lote_impl_3.ttv_rec_integr_apb_lote_impl     = recid(tt_integr_apb_lote_impl)
           ...
           tt_integr_apb_item_lote_impl_3.tta_dat_emis_docto               = TODAY /*p-dt-transacao*/
    ...
    IF CAN-FIND (FIRST tt-rateio-unid) THEN DO:
        FOR EACH tt-rateio-unid
            WHERE tt-rateio-unid.canal          = int-cc-benef.canal
              AND tt-rateio-unid.tipo-beneficio = int-cc-benef.tipo-beneficio
              AND tt-rateio-unid.nova-unidade   = int-cc-benef.unid-neg:
            ...
            ASSIGN tt_integr_apb_aprop_ctbl_pend.ttv_rec_integr_apb_item_lote  = recid(tt_integr_apb_item_lote_impl_3)
                   ...
                   tt_integr_apb_aprop_ctbl_pend.tta_cod_unid_negoc            = tt-rateio-unid.unid-neg
                   tt_integr_apb_aprop_ctbl_pend.tta_cod_tip_fluxo_financ      = tt-rateio-unid.tipo-fluxo
                   tt_integr_apb_aprop_ctbl_pend.tta_val_aprop_ctbl            = tt-rateio-unid.vl-rateio /* Saldo da conta de despesas */
                   ...
                   tt_integr_apb_aprop_ctbl_pend.tta_cod_cta_ctbl              = tt-rateio-unid.conta
                   tt_integr_apb_aprop_ctbl_pend.tta_cod_plano_ccusto          = c-tta_cod_plano_ccusto
                   tt_integr_apb_aprop_ctbl_pend.tta_cod_ccusto                = tt-rateio-unid.centro-custo.
...
/*                              OUTPUT c-refer).     */
    ...
    assign tt_tit_ap_alteracao_base_aux_1.ttv_cod_usuar_corren             = /* v_cod_usuar_corren */ "integra"
