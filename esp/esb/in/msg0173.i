...
DEFINE TEMP-TABLE msg0173 NO-UNDO XML-NODE-NAME 'MSG0173'
...
DEFINE TEMP-TABLE msg0173-ProdutoSolicitacaoItens NO-UNDO XML-NODE-NAME 'ProdutoSolicitacaoItens'
   FIELD idm AS INT XML-NODE-TYPE 'HIDDEN'.

DEFINE TEMP-TABLE msg0173-ProdutoSolicitacaoItem NO-UNDO XML-NODE-NAME 'ProdutoSolicitacaoItem'
   FIELD idm AS INT XML-NODE-TYPE 'HIDDEN'
...
DEFINE TEMP-TABLE msg0173r1 NO-UNDO XML-NODE-NAME 'MSG0173R1'
   FIELD idm AS INT XML-NODE-TYPE 'HIDDEN'
   FIELD CodigoSolicitacaoBeneficio            AS CHAR  INIT ?
   FIELD Proprietario                          AS CHAR  INIT ?
   FIELD TipoProprietario                      AS CHAR  INIT ?.

DEFINE TEMP-TABLE msg0173r1-SaldoBeneficioCanal NO-UNDO XML-NODE-NAME 'SaldoBeneficioCanal'
   FIELD idm AS INT XML-NODE-TYPE 'HIDDEN'
