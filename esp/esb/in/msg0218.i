...
/*Dataset Entrada*/
DEFINE TEMP-TABLE MSG0218 NO-UNDO XML-NODE-NAME 'MSG0218'
   FIELD idm AS INT XML-NODE-TYPE 'HIDDEN'.

DEFINE TEMP-TABLE MSG_ParcelaOrdemCompra NO-UNDO XML-NODE-NAME 'InspecaoAgendada'
   FIELD idm AS INT XML-NODE-TYPE 'HIDDEN'
   ...
   FIELD DataHistorico           AS DATE
   FIELD HoraHistorico           AS CHAR.

/*Dataset Retorno*/
DEFINE TEMP-TABLE MSG0218_R1 NO-UNDO XML-NODE-NAME 'MSG0218R1'
   FIELD idm AS INT XML-NODE-TYPE 'HIDDEN'.
