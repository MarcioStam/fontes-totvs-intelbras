...
/*Dataset de entrada*/
DEFINE TEMP-TABLE MSG0219 NO-UNDO XML-NODE-NAME 'MSG0219'
...
DEFINE TEMP-TABLE PontoControle NO-UNDO XML-NODE-NAME 'PontoControle'
   ...
   FIELD DataUltimaPrevisaoPontoControle LIKE historico-embarque.dt-ult-previsao INITIAL ?
   ...
   FIELD TipoEfetivacao                  AS CHAR.

/*Dataset de sa¡da*/
DEFINE TEMP-TABLE MSG0219R1 NO-UNDO XML-NODE-NAME 'MSG0219R1'
   FIELD idm AS INT XML-NODE-TYPE 'HIDDEN'
...
DEFINE TEMP-TABLE PontoControleR NO-UNDO XML-NODE-NAME 'PontoControle'
   FIELD idm AS INT XML-NODE-TYPE 'HIDDEN'
   FIELD CodigoPontoControle             LIKE historico-embarque.cod-pto-contr
   FIELD SequenciaPontoControle          LIKE historico-embarque.sequencia
