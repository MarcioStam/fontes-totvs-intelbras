...
DEFINE TEMP-TABLE msg0155 NO-UNDO XML-NODE-NAME 'MSG0155'
...
DEFINE TEMP-TABLE msg0155r1 NO-UNDO XML-NODE-NAME 'MSG0155R1'
   FIELD idm AS INT XML-NODE-TYPE 'HIDDEN'
   FIELD CodigoSolicitacaoBeneficio            AS CHAR  INIT ?
   FIELD Proprietario                          AS CHAR  INIT ?
   FIELD TipoProprietario                      AS CHAR  INIT ?.

DEFINE TEMP-TABLE msg0155r1-SaldoBeneficioCanal NO-UNDO XML-NODE-NAME 'SaldoBeneficioCanal'
   FIELD idm AS INT XML-NODE-TYPE 'HIDDEN'
