...
{esp/esb/in/msg0009.i}
{esp/esb/in/msg9999.i}

DEFINE TEMP-TABLE tt-erro           NO-UNDO
    FIELD mensagem AS CHARACTER FORMAT "x(250)".

DEFINE DATASET mensagem XML-NODE-NAME 'MENSAGEM' FOR cabecalho, conteudo, msg0009
   DATA-RELATION FOR conteudo, msg0009 RELATION-FIELDS (idm, idm) NESTED.

DATASET mensagem:READ-XML('LONGCHAR', iXML, 'EMPTY', ?, ?).

DEFINE DATASET mensagemr XML-NODE-NAME 'MENSAGEM' FOR cabecalhor, conteudor, msg0009r, resultado
   DATA-RELATION FOR conteudor, msg0009r RELATION-FIELDS (idm, idm) NESTED
   DATA-RELATION FOR msg0009r, resultado RELATION-FIELDS (idm, idm) NESTED.
...
ASSIGN cabecalhor.CodigoMensagem    = 'msg0009R'
       cabecalhor.IdentidadeEmissor = "64546C2E-6DAB-4311-A74A-5ACA96134AFF".

FIND FIRST msg0009 NO-ERROR.
    ...
    ON STOP  UNDO blk_principal,LEAVE blk_principal:
        ...
        {esp/esb/in/msg9999.i01     "b-int-regiao-geografica"
                                    " FIND FIRST b-int-regiao-geografica 
                                        WHERE b-int-regiao-geografica.cod-regiao = msg0009.CodigoRegiaoGeografica EXCLUSIVE-LOCK NO-WAIT NO-ERROR. "
                                    2  
                                    5  }
        ...
        IF  NOT l-reg-disponivel  THEN DO:
            ...
            END.
            ELSE DO:
                RUN pi-erro (INPUT "Registro Regi∆o Geogr†fica n∆o cadastrado."). 
                UNDO, RETURN "NOK".
            END.
        END.

        /* ELIMINA O REGISTRO */
        DELETE b-int-regiao-geografica.
