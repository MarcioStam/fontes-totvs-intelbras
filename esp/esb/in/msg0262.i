...
/*Dataset Entrada*/
DEFINE TEMP-TABLE MSG0262 NO-UNDO XML-NODE-NAME 'MSG0262'
   FIELD idm AS INT XML-NODE-TYPE 'HIDDEN'
   FIELD DataSwift                LIKE pagamento.data-swift   INITIAL ?
   .
...
/*Dataset Retorno*/
DEFINE TEMP-TABLE MSG0262R1 NO-UNDO XML-NODE-NAME 'MSG0262R1'
   FIELD idm AS INT XML-NODE-TYPE 'HIDDEN'.
