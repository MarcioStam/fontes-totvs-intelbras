...
/*     <CodigoMensagem>MSG0262</CodigoMensagem>                                    */
/*   </CABECALHO>                                                                  */
/*   <CONTEUDO>                                                                    */
/*     <MSG0262>                                                                   */
...
{esp/esb/in/msg0262.i}

DEFINE DATASET mensagem XML-NODE-NAME 'MENSAGEM' FOR cabecalho, conteudo, msg0262, SolicitacaoInternaSwift, HistoricoSolicitacaoInterna
   DATA-RELATION FOR conteudo, msg0262                   RELATION-FIELDS (idm, idm) NESTED
   DATA-RELATION FOR msg0262,SolicitacaoInternaSwift     RELATION-FIELDS (idm, idm) NESTED
   DATA-RELATION FOR msg0262,HistoricoSolicitacaoInterna RELATION-FIELDS (idm, idm) NESTED.

DATASET mensagem:READ-XML('LONGCHAR', iXML, 'EMPTY', ?, ?).

DEFINE DATASET mensagemr XML-NODE-NAME 'MENSAGEM' FOR cabecalhor, conteudor, msg0262R1, resultado
   DATA-RELATION FOR conteudor,  msg0262R1 RELATION-FIELDS (idm, idm) NESTED
   DATA-RELATION FOR msg0262R1,  resultado RELATION-FIELDS (idm, idm) NESTED.
...
ASSIGN cabecalhor.CodigoMensagem    = 'MSG0262R1'
       cabecalhor.IdentidadeEmissor = "64546C2E-6DAB-4311-A74A-5ACA96134AFF".

FIND FIRST msg0262 NO-ERROR.
    ...
    ON STOP  UNDO blk_swift, LEAVE blk_swift: 
        ...
        FOR EACH SolicitacaoInternaSwift:
            ...
            IF AVAIL pagamento THEN DO:
                ...
                ASSIGN pagamento.swift                  = string(SolicitacaoInternaSwift.CodigoSolicitacaoInterna)
                       pagamento.data-swift             = msg0262.DataSwift
                       pagamento.ind-status-solicitacao = 4 /*Pagamento Efetuado*/.
            ...
            END.
            ELSE DO:
                RUN pi-erro (INPUT "NÆo encontrada CI " + STRING(SolicitacaoInternaSwift.CodigoSolicitacaoInterna)).
            END.
        END.

        IF  CAN-FIND (FIRST tt-erro) THEN DO:
            UNDO blk_swift, RETURN "NOK".
        END.
    END.
