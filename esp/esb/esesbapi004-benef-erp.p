...
PROCEDURE pi-retorna-beneficios:
    ...
    FOR EACH tt-canal:
        ...
        FOR EACH int-benef-canal NO-LOCK
            ...
            IF  p-tipo-beneficio <> ? AND p-unid-neg <> ? THEN


            /* S¢ busca e os percentuais de : */
            IF  int-benef-canal.BeneficioCodigo <> 22 /* 22 - STOCK ROTATION    */
            AND int-benef-canal.BeneficioCodigo <> 37 /* 37 - REBATE            */
            AND int-benef-canal.BeneficioCodigo <> 66 /* 66 - REBATE  P‡S-VENDA */
            AND int-benef-canal.BeneficioCodigo <> 21 /* 21 - VMC               */
            AND int-benef-canal.BeneficioCodigo <> 15 /* 15 - SHOWROOM          */
            AND int-benef-canal.BeneficioCodigo <> 08 /* 08 - PRICE PROTECTION  */
            AND int-benef-canal.BeneficioCodigo <> 04 /* 04 - STOCK BACKUP      */ 
            THEN
                NEXT.
...
PROCEDURE pi-Buscar-Parametros-Globais:
    ...
    FIND int-benef-canal-perc NO-LOCK
    ...
    IF  AVAIL int-benef-canal-perc THEN DO:
        IF  dec(int-benef-canal-perc.ValorParametroGlobal) = 0 THEN DO:
            RUN pi-cria-erro IN THIS-PROCEDURE (INPUT 17006, /* Erro */
