/*------------------------------------------------------------------------------------------------------------------------------------------------------------ */
/* ESESBAPI013-SALDO - Retornar o Saldo Atualizado do Benef°cio, a partir do c¢digo da                                                                         */
...
{esp/esb/esesbapi013-saldo.i} /*funá‰es para retorno de verba reembolsada/emenhada */
...
RUN pi-retorna-movimentos-saldo(INPUT int-cc-benef.canal,
