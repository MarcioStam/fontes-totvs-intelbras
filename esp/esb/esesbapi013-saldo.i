...
PROCEDURE pi-retorna-movimentos-saldo:
    ...
    FOR EACH int-solicitacao NO-LOCK
        ...
        IF  int-solicitacao.SituacaoSolicitacaoBeneficio = 993520004 THEN DO:
            ASSIGN p-verba-reembolsada = p-verba-reembolsada + (int-solicitacao.ValorSolicitado - int-solicitacao.ValorAprovado) /*int-solicitacao.ValorPago*/.
        END.
        ...
        IF  int-solicitacao.SituacaoSolicitacaoBeneficio <> 993520006
        AND int-solicitacao.SituacaoSolicitacaoBeneficio <> 993520004
        AND int-solicitacao.SituacaoSolicitacaoBeneficio <> 993520003 THEN DO:
        ...
        IF  int-solicitacao.SituacaoSolicitacaoBeneficio  = 993520003 THEN DO:
            IF  int-solicitacao.ValorAprovado > 0 THEN
                ASSIGN p-verba-empenhada-aprovada = p-verba-empenhada-aprovada + int-solicitacao.ValorAprovado.
            ELSE
                ASSIGN p-verba-empenhada-aprovada = p-verba-empenhada-aprovada + int-solicitacao.ValorSolicitado.
        END.
    END.
