...
{include/i-prgvrs.i esesb004 2.00.00.001}  /*** 010002 ***/
/********************************************************************************
...
&GLOBAL-DEFINE Program        esesb004
...
DEFINE VARIABLE hdbotr088    AS HANDLE  NO-UNDO.
DEFINE VARIABLE h-botr306    AS HANDLE     NO-UNDO.
DEFINE VARIABLE c-erp-of     AS CHARACTER  NO-UNDO.
DEFINE VARIABLE c-versao-of  AS CHARACTER  NO-UNDO.
DEFINE VARIABLE h-boin172    AS HANDLE     NO-UNDO.



DEF VAR c-cgc AS CHAR FORMAT "x(19)" NO-UNDO.
DEF VAR c-cgc-cpf AS CHAR NO-UNDO.
DEF VAR c-formato-cgc AS CHAR NO-UNDO.
DEF VAR c-formato-cpf AS CHAR NO-UNDO.
DEF VAR h-botr028 AS HANDLE NO-UNDO.
DEF VAR hDBOTR000 AS HANDLE NO-UNDO.
...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW wReport ASSIGN
         HIDDEN             = YES
         TITLE              = "Gera Mensagem Inadimplˆncia"
         HEIGHT             = 16.42
         WIDTH              = 90.57
         MAX-HEIGHT         = 22
         MAX-WIDTH          = 114.29
...
ON END-ERROR OF wReport /* Gera Mensagem Inadimplˆncia */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL wReport wReport
ON WINDOW-CLOSE OF wReport /* Gera Mensagem Inadimplˆncia */
DO:
...
do on error undo, return error on stop  undo, return error:
    ...
    {report/rprun.i esp/esb/esesb004rp.p}
