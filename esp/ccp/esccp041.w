...
*******************************************************************************/
{include/i-prgvrs.i esccp041 1.00.00.000}
...
&GLOBAL-DEFINE Program        esccp041
...
&GLOBAL-DEFINE ttTable        tt-int-projeto
&GLOBAL-DEFINE hDBOTable      h-boes702
&GLOBAL-DEFINE DBOTable       int-projeto

&GLOBAL-DEFINE page0KeyFields tt-int-projeto.cod-projeto
&GLOBAL-DEFINE page0Fields    tt-int-projeto.desc-projeto
...
&Scoped-Define ENABLED-FIELDS tt-int-projeto.cod-projeto ~
tt-int-projeto.desc-projeto 
&Scoped-define ENABLED-TABLES tt-int-projeto
...
DEFINE FRAME fpage0
     ...
     btHelp AT ROW 1.13 COL 86.72 HELP
          "Ajuda"
     tt-int-projeto.cod-projeto AT ROW 3 COL 29 COLON-ALIGNED WIDGET-ID 8
          VIEW-AS FILL-IN 
          SIZE 12 BY .88
     tt-int-projeto.desc-projeto AT ROW 4 COL 29 COLON-ALIGNED WIDGET-ID 2
          VIEW-AS FILL-IN 
          SIZE 50 BY .88
...
------------------------------------------------------------------------------*/
    ...
    DEFINE VARIABLE i-cod-projeto LIKE {&ttTable}.cod-projeto NO-UNDO.
...
/*tech1139 - FO 1338.917 - 10/07/2006  */
    ...
    ON "CHOOSE":U OF btGoToOK IN FRAME fGoToRecord DO:
        ...
        RUN goToKey IN {&hDBOTable} (INPUT i-cod-projeto).
...
------------------------------------------------------------------------------*/
    ...
    IF NOT VALID-HANDLE({&hDBOTable}) OR
       ...
       {&hDBOTable}:FILE-NAME <> "esbo/boes702.p":U THEN DO:
        {btb/btb008za.i1 esbo/boes702.p YES}
        {btb/btb008za.i2 esbo/boes702.p '' {&hDBOTable}}
    END.
