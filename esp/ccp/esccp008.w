...
*******************************************************************************/
{include/i-prgvrs.i ESCCP008 1.00.00.000}

CREATE WIDGET-POOL.

/* Preprocessors Definitions ---                                      */
&GLOBAL-DEFINE Program        ESCCP008
&GLOBAL-DEFINE Version        1.00.00.000
&GLOBAL-DEFINE Folder         YES
&GLOBAL-DEFINE InitialPage    1

&GLOBAL-DEFINE FolderLabels   Seleá∆o,Email,ParÉmetros,Impress∆o
...
&GLOBAL-DEFINE page0Widgets   btCancel btHelp2 btOk 
&GLOBAL-DEFINE page2Widgets   fi-ini-cod-estabel fi-fim-cod-emitente fi-fim-data fi-fim-it-codigo fi-ini-cod-emitente ~
                              fi-ini-data fi-ini-it-codigo fi-ini-cod-comprado fi-fim-cod-comprado fi-fim-cod-estabel fi-ini-cod-unid-negoc fi-fim-cod-unid-negoc
&GLOBAL-DEFINE page3Widgets   fi-email fi-email-2 rs-distribuicao
&GLOBAL-DEFINE page4Widgets   rsClassif tg-dependente tg-independente tg-importados tg-nacionais tg-adicionais tg-oem tg-NarrativaItem ~
                              tg-NarrativaOrdem tg-lista-contato tg-confirmada tg-eliminada tg-recebida
...
&Scoped-define List-1 fi-ini-cod-estabel fi-ini-cod-emitente ~
fi-fim-cod-emitente fi-ini-data fi-fim-data fi-ini-cod-unid-negoc 
&Scoped-define List-2 rs-distribuicao fi-email fi-email-2 
...
DEFINE VARIABLE fi-email-2 AS CHARACTER FORMAT "X(200)":U 
     LABEL "E-Mail Alternativo" 
     VIEW-AS FILL-IN 
     SIZE 50 BY .88 NO-UNDO.

DEFINE VARIABLE rs-distribuicao AS INTEGER INITIAL 2 
...
DEFINE VARIABLE rsClassif AS INTEGER INITIAL 1 
     ...
     RADIO-BUTTONS 
          "1 - Fornecedor/Data/Item", 1,
"2 - Item/Data/Fornecedor", 2
     SIZE 23.86 BY 2
     FONT 1 NO-UNDO.
...
DEFINE VARIABLE tg-adicionais AS LOGICAL INITIAL no 
     LABEL "Imprime dados adicionais" 
     VIEW-AS TOGGLE-BOX
     SIZE 22.72 BY .83 NO-UNDO.

DEFINE VARIABLE tg-confirmada AS LOGICAL INITIAL yes 
     LABEL "Confirmada" 
     VIEW-AS TOGGLE-BOX
...
DEFINE VARIABLE tg-importados AS LOGICAL INITIAL yes 
     LABEL "Importados" 
     VIEW-AS TOGGLE-BOX
     SIZE 14 BY .88 NO-UNDO.
...
DEFINE VARIABLE tg-lista-contato AS LOGICAL INITIAL no 
     LABEL "Contato Fornecedor" 
     VIEW-AS TOGGLE-BOX
     SIZE 20.86 BY .83 NO-UNDO.

DEFINE VARIABLE tg-nacionais AS LOGICAL INITIAL yes 
     LABEL "Nacionais" 
     VIEW-AS TOGGLE-BOX
     SIZE 14 BY .88 NO-UNDO.

DEFINE VARIABLE tg-NarrativaItem AS LOGICAL INITIAL no 
     LABEL "Imprime Narrativa Item" 
     VIEW-AS TOGGLE-BOX
     SIZE 23.72 BY .83 NO-UNDO.

DEFINE VARIABLE tg-NarrativaOrdem AS LOGICAL INITIAL no 
     LABEL "Imprime Narrativa Ordem" 
     VIEW-AS TOGGLE-BOX
     SIZE 20.72 BY .83 NO-UNDO.

DEFINE VARIABLE tg-oem AS LOGICAL INITIAL no 
     LABEL "Imprimir dados OEM" 
     VIEW-AS TOGGLE-BOX
     SIZE 19.72 BY .83 NO-UNDO.

DEFINE VARIABLE tg-recebida AS LOGICAL INITIAL no 
     LABEL "Recebida" 
     VIEW-AS TOGGLE-BOX
     SIZE 11.57 BY .83 NO-UNDO.
...
DEFINE FRAME fPage2
     fi-ini-cod-estabel AT ROW 2.33 COL 15.86 COLON-ALIGNED
     fi-fim-cod-estabel AT ROW 2.33 COL 52.29 COLON-ALIGNED NO-LABEL
     fi-ini-it-codigo AT ROW 3.33 COL 16 COLON-ALIGNED HELP
          "C¢digo do Item"
     fi-fim-it-codigo AT ROW 3.29 COL 52.29 COLON-ALIGNED HELP
          "C¢digo do Item" NO-LABEL
     fi-ini-cod-emitente AT ROW 4.33 COL 15.86 COLON-ALIGNED
     fi-fim-cod-emitente AT ROW 4.33 COL 52.43 COLON-ALIGNED NO-LABEL
     fi-ini-cod-comprado AT ROW 5.33 COL 15.86 COLON-ALIGNED HELP
          "C¢digo do comprador"
     fi-fim-cod-comprado AT ROW 5.33 COL 52.43 COLON-ALIGNED HELP
          "C¢digo do comprador" NO-LABEL
     fi-ini-data AT ROW 6.33 COL 15.86 COLON-ALIGNED
     fi-fim-data AT ROW 6.33 COL 52.43 COLON-ALIGNED NO-LABEL
     fi-ini-cod-unid-negoc AT ROW 7.25 COL 16 COLON-ALIGNED WIDGET-ID 8
     fi-fim-cod-unid-negoc AT ROW 7.29 COL 52.29 COLON-ALIGNED NO-LABEL WIDGET-ID 6
     IMAGE-1 AT ROW 3.33 COL 37.86
     IMAGE-10 AT ROW 5.33 COL 51
     IMAGE-11 AT ROW 4.33 COL 51
     IMAGE-12 AT ROW 4.33 COL 37.86
     IMAGE-29 AT ROW 6.33 COL 51
     IMAGE-30 AT ROW 3.33 COL 51
     IMAGE-5 AT ROW 6.33 COL 37.86
     IMAGE-9 AT ROW 5.33 COL 37.86
     IMAGE-31 AT ROW 2.38 COL 37.72 WIDGET-ID 2
     IMAGE-32 AT ROW 2.33 COL 51 WIDGET-ID 4
     IMAGE-33 AT ROW 7.29 COL 37.86 WIDGET-ID 10
     IMAGE-34 AT ROW 7.29 COL 51.14 WIDGET-ID 12
...
DEFINE FRAME fPage3
     rs-distribuicao AT ROW 2.25 COL 20 NO-LABEL
     fi-email AT ROW 4.04 COL 15 COLON-ALIGNED
     fi-email-2 AT ROW 5.04 COL 15 COLON-ALIGNED
     "Distribuiá∆o de E-Mail" VIEW-AS TEXT
          SIZE 17 BY .54 AT ROW 1.5 COL 20
     RECT-13 AT ROW 1.75 COL 17
    WITH 1 DOWN KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 3.57 ROW 2.79
         SIZE 84.43 BY 11.96
...
DEFINE FRAME fPage4
     tg-dependente AT ROW 2.33 COL 5.14
     rsClassif AT ROW 2.42 COL 45.43 HELP
          "Classificaá∆o para emiss∆o do relat¢rio" NO-LABEL
     tg-independente AT ROW 3.33 COL 5.14
     tg-importados AT ROW 4.33 COL 5.14
     tg-nacionais AT ROW 5.33 COL 5.14
     tg-confirmada AT ROW 5.75 COL 46 WIDGET-ID 12
     tg-adicionais AT ROW 6.42 COL 5.14
     tg-recebida AT ROW 6.75 COL 46 WIDGET-ID 14
     tg-oem AT ROW 7.42 COL 5.14
     tg-eliminada AT ROW 7.75 COL 46 WIDGET-ID 16
     tg-NarrativaItem AT ROW 8.42 COL 5.14
     tg-NarrativaOrdem AT ROW 9.42 COL 5.14 WIDGET-ID 6
     tg-lista-contato AT ROW 10.25 COL 5.14 WIDGET-ID 8
     "Situaá∆o" VIEW-AS TEXT
          SIZE 7 BY .54 AT ROW 5 COL 45 WIDGET-ID 18
     "Listar:" VIEW-AS TEXT
          SIZE 4.57 BY .54 AT ROW 1.5 COL 4.43
     "Classificaá∆o:" VIEW-AS TEXT
          SIZE 10.57 BY .54 AT ROW 1.58 COL 45.14
     RECT-14 AT ROW 1.88 COL 44
     RECT-16 AT ROW 1.71 COL 3
     RECT-17 AT ROW 5.29 COL 44 WIDGET-ID 10
    WITH 1 DOWN KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 3.57 ROW 2.79
         SIZE 84.43 BY 11.96
...
/* SETTINGS FOR FRAME fPage2
   Custom                                                               */
/* SETTINGS FOR FILL-IN fi-fim-cod-emitente IN FRAME fPage2
   1                                                                    */
/* SETTINGS FOR FILL-IN fi-fim-data IN FRAME fPage2
   1                                                                    */
/* SETTINGS FOR FILL-IN fi-ini-cod-emitente IN FRAME fPage2
   1                                                                    */
/* SETTINGS FOR FILL-IN fi-ini-cod-estabel IN FRAME fPage2
   1                                                                    */
/* SETTINGS FOR FILL-IN fi-ini-cod-unid-negoc IN FRAME fPage2
   1                                                                    */
/* SETTINGS FOR FILL-IN fi-ini-data IN FRAME fPage2
   1                                                                    */
/* SETTINGS FOR FRAME fPage3
                                                                        */
/* SETTINGS FOR FILL-IN fi-email IN FRAME fPage3
   2                                                                    */
/* SETTINGS FOR FILL-IN fi-email-2 IN FRAME fPage3
   2                                                                    */
/* SETTINGS FOR RADIO-SET rs-distribuicao IN FRAME fPage3
   2                                                                    */
...
fi-ini-cod-estabel:SCREEN-VALUE = v_cod_estab_usuar.
fi-fim-cod-estabel:SCREEN-VALUE = v_cod_estab_usuar.


FOR FIRST usuar-mater NO-LOCK
    WHERE usuar-mater.cod-usuario = c-seg-usuario:

    ASSIGN fi-email:SCREEN-VALUE IN FRAME fPage3 = usuar-mater.e-mail
           fi-email-2:SCREEN-VALUE IN FRAME fPage3 = usuar-mater.e-mail.
...
do on error undo, return error on stop  undo, return error:
    ...
    IF INPUT FRAME fpage3 fi-email = "" THEN DO:
        run utp/ut-msgs.p (input "show":U, input 17006, input "Endereáo de E-Mail n∆o informado":U).
        run setFolder IN hFolder (input 2).
        APPLY "entry" TO fi-email IN FRAME fpage3.
        return error.
    END.

    IF INPUT FRAME fpage4 tg-dependente = NO AND
       INPUT FRAME fpage4 tg-independente = NO THEN DO:
        run utp/ut-msgs.p (input "show":U, input 17006, input "Deve ser marcado Dependente e/ou Independente":U).
        run setFolder IN hFolder (input 3).
        APPLY "entry" TO tg-dependente IN FRAME fpage4.
        return error.
    END.

    IF INPUT FRAME fpage4 tg-importados = NO AND
       INPUT FRAME fpage4 tg-nacionais = NO THEN DO:
        run utp/ut-msgs.p (input "show":U, input 17006, input "Deve ser marcado Nacionais e/ou Importados":U).
        run setFolder IN hFolder (input 3).
        APPLY "entry" TO tg-nacionais IN FRAME fpage4.
        return error.
    END.
    ...
    assign tt-param.usuario           = c-seg-usuario
           ...
           tt-param.fi-fim-cod-unid-negoc = input frame fPage2 fi-fim-cod-unid-negoc
           tt-param.fi-ini-cod-unid-negoc = input frame fPage2 fi-ini-cod-unid-negoc
           tt-param.cod-estabel-ini   = input frame fPage2 fi-ini-cod-estabel
           tt-param.cod-estabel-fim   = input frame fPage2 fi-fim-cod-estabel
           tt-param.cod-emitente-ini  = input frame fPage2 fi-ini-cod-emitente
           tt-param.cod-emitente-fim  = input frame fPage2 fi-fim-cod-emitente
           ...
           tt-param.c-email           = input frame fPage3 fi-email
           tt-param.c-email-2         = input frame fPage3 fi-email-2
           tt-param.i-distribuicao    = input frame fPage3 rs-distribuicao
           tt-param.i-classif         = input frame fPage4 rsClassif
           tt-param.l-dependente      = input frame fPage4 tg-dependente
           tt-param.l-independente    = input frame fPage4 tg-independente
           tt-param.l-importados      = input frame fPage4 tg-importados
           tt-param.l-nacionais       = input frame fPage4 tg-nacionais
           tt-param.l-adicionais      = input frame fPage4 tg-adicionais
           tt-param.l-oem             = input frame fPage4 tg-oem
           tt-param.l-narrativa       = INPUT FRAME fPage4 tg-NarrativaItem
           tt-param.l-narrativa-ordem = INPUT FRAME fPage4 tg-NarrativaOrdem
           tt-param.l-lista-contatos  = INPUT FRAME fpage4 tg-lista-contato
           tt-param.l-confirmada      = INPUT FRAME fpage4 tg-confirmada
           tt-param.l-recebida        = INPUT FRAME fpage4 tg-recebida
           tt-param.l-eliminada       = INPUT FRAME fpage4 tg-eliminada.
    ...
    {report/rprun.i esp/ccp/esccp008rp.p}
