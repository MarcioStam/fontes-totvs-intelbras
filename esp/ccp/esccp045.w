...
*******************************************************************************/
{include/i-prgvrs.i esccp045 2.00.00.000}
...
DEFINE VARIABLE c-cod-estabel-fim AS CHARACTER FORMAT "X(5)":U INITIAL "ZZZZZZ" 
     VIEW-AS FILL-IN 
...
DEFINE VARIABLE c-embarque-fim AS CHARACTER FORMAT "X(16)":U INITIAL "ZZZZZZZZZZZZZZZZ" 
     VIEW-AS FILL-IN 
     SIZE 15 BY .88 NO-UNDO.
...
DEFINE FRAME f-pg-sel
     c-cod-estabel-ini AT ROW 1.25 COL 15 COLON-ALIGNED
     c-cod-estabel-fim AT ROW 1.25 COL 48.14 COLON-ALIGNED NO-LABEL
     c-embarque-ini AT ROW 2.25 COL 15 COLON-ALIGNED WIDGET-ID 4
     c-embarque-fim AT ROW 2.25 COL 48.14 COLON-ALIGNED NO-LABEL WIDGET-ID 2
     ...
     d-data-ini AT ROW 4.25 COL 15 COLON-ALIGNED WIDGET-ID 20
     d-data-fim AT ROW 4.25 COL 48.14 COLON-ALIGNED NO-LABEL WIDGET-ID 18
     c-it-codigo-ini AT ROW 5.25 COL 15 COLON-ALIGNED WIDGET-ID 28
     c-it-codigo-fim AT ROW 5.25 COL 48.14 COLON-ALIGNED NO-LABEL WIDGET-ID 26
...
{utp/ut9000.i "ESCCP045" "2.00.00.000"}
...
------------------------------------------------------------------------------*/
  ...
  DISPLAY c-cod-estabel-ini c-cod-estabel-fim c-embarque-ini c-embarque-fim 
          i-cod-emitente-ini i-cod-emitente-fim d-data-ini d-data-fim 
          c-it-codigo-ini c-it-codigo-fim 
      WITH FRAME f-pg-sel IN WINDOW w-relat.
  ENABLE IMAGE-1 IMAGE-2 IMAGE-3 IMAGE-4 IMAGE-5 IMAGE-6 IMAGE-7 IMAGE-8 
         IMAGE-9 IMAGE-10 c-cod-estabel-ini c-cod-estabel-fim c-embarque-ini 
         c-embarque-fim i-cod-emitente-ini i-cod-emitente-fim d-data-ini 
         d-data-fim c-it-codigo-ini c-it-codigo-fim 
      WITH FRAME f-pg-sel IN WINDOW w-relat.
...
do on error undo, return error on stop  undo, return error:
    ...
    assign tt-param.usuario         = c-seg-usuario
           ...
           tt-param.embarque-fim     = INPUT FRAME f-pg-sel c-embarque-fim 
    ...
    {include/i-rprun.i esp/ccp/esccp045rp.p}
