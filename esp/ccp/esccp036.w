...
*******************************************************************************/
{include/i-prgvrs.i esccp036 1.00.00.000}
...
DEFINE VARIABLE i-processo AS INTEGER FORMAT ">>>>>9":U INITIAL 0 
     LABEL "Processo" 
     VIEW-AS FILL-IN 
...
DEFINE FRAME f-pg-imp
    ...
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 3 ROW 3
         SIZE 76.57 BY 10.5 WIDGET-ID 100.

DEFINE FRAME f-pg-sel
     i-processo AT ROW 5 COL 34 COLON-ALIGNED
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 3 ROW 3
         SIZE 76.57 BY 10.5 WIDGET-ID 100.
...
ON END-ERROR OF w-relat /* Processo Compras */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL w-relat w-relat
ON WINDOW-CLOSE OF w-relat /* Processo Compras */
DO:
...
&Scoped-define SELF-NAME i-processo
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL i-processo w-relat
ON F5 OF i-processo IN FRAME f-pg-sel /* Processo */
DO:
    /* Zoom Smart Object */
    assign l-implanta = yes.  
    {include/zoomvar.i &prog-zoom="inzoom/z07in295.w"
                       &campo=i-processo
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL i-processo w-relat
ON MOUSE-SELECT-DBLCLICK OF i-processo IN FRAME f-pg-sel /* Processo */
DO:
    APPLY "F5":U TO SELF.  
END.
...
{utp/ut9000.i "esccp036" "1.00.00.000"}
...
DO  ON ERROR   UNDO MAIN-BLOCK, LEAVE MAIN-BLOCK
    ...
    i-processo:load-mouse-pointer("image/lupa.cur":U) in frame f-pg-sel.

    ASSIGN rs-destino:SCREEN-VALUE IN FRAME f-pg-imp = "2":U.
    APPLY "VALUE-CHANGED":U TO rs-destino IN FRAME f-pg-imp.
    ASSIGN c-arquivo:SCREEN-VALUE IN FRAME f-pg-imp = session:temp-directory + "processoCompra.csv".
...
do on error undo, return error on stop  undo, return error:
    ...
    assign tt-param.usuario         = c-seg-usuario
           ...
           tt-param.nr-processo     = input frame f-pg-sel i-processo.
    ...
    {include/i-rprun.i esp/ccp/esccp036rp.p}
