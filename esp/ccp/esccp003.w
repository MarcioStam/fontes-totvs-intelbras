...
*******************************************************************************/
{include/i-prgvrs.i esccp003 2.00.00.000}
...
DEFINE VARIABLE c-cod-estab-fim AS CHARACTER FORMAT "X(15)":U INITIAL "ZZZZZ" 
     VIEW-AS FILL-IN 
...
DEFINE FRAME f-pg-sel
     c-cod-estab-ini AT ROW 1.25 COL 19.14 COLON-ALIGNED
     c-cod-estab-fim AT ROW 1.25 COL 50.29 COLON-ALIGNED NO-LABEL
     d-dt-emis-ini AT ROW 2.25 COL 19 COLON-ALIGNED WIDGET-ID 4
     d-dt-emis-fim AT ROW 2.25 COL 50.29 COLON-ALIGNED NO-LABEL WIDGET-ID 2
     i-cod-emitente-ini AT ROW 3.25 COL 19 COLON-ALIGNED WIDGET-ID 20
     i-cod-emitente-fim AT ROW 3.25 COL 50.29 COLON-ALIGNED NO-LABEL WIDGET-ID 18
     i-num-pedido-ini AT ROW 4.25 COL 19 COLON-ALIGNED WIDGET-ID 28
     i-num-pedido-fim AT ROW 4.25 COL 50.29 COLON-ALIGNED NO-LABEL WIDGET-ID 26
     IMAGE-1 AT ROW 1.25 COL 36
     IMAGE-2 AT ROW 1.25 COL 49.43
     IMAGE-3 AT ROW 2.25 COL 36 WIDGET-ID 6
     IMAGE-4 AT ROW 2.25 COL 49.43 WIDGET-ID 8
     IMAGE-7 AT ROW 3.25 COL 36 WIDGET-ID 22
     IMAGE-8 AT ROW 3.25 COL 49.43 WIDGET-ID 24
     IMAGE-9 AT ROW 4.25 COL 36 WIDGET-ID 30
     IMAGE-10 AT ROW 4.25 COL 49.43 WIDGET-ID 32
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 3 ROW 2.85
...
{utp/ut9000.i "esccp003" "2.00.00.000"}
...
DO  ON ERROR   UNDO MAIN-BLOCK, LEAVE MAIN-BLOCK
    ...
    ASSIGN d-dt-emis-ini:SCREEN-VALUE IN FRAME f-pg-sel = STRING(TODAY)
...
------------------------------------------------------------------------------*/
  ...
  DISPLAY c-cod-estab-ini c-cod-estab-fim d-dt-emis-ini d-dt-emis-fim 
          i-cod-emitente-ini i-cod-emitente-fim i-num-pedido-ini 
          i-num-pedido-fim 
      WITH FRAME f-pg-sel IN WINDOW w-relat.
  ENABLE IMAGE-1 IMAGE-2 IMAGE-3 IMAGE-4 IMAGE-7 IMAGE-8 IMAGE-9 IMAGE-10 
         c-cod-estab-ini c-cod-estab-fim d-dt-emis-ini d-dt-emis-fim 
         i-cod-emitente-ini i-cod-emitente-fim i-num-pedido-ini 
         i-num-pedido-fim 
      WITH FRAME f-pg-sel IN WINDOW w-relat.
...
do on error undo, return error on stop  undo, return error:
    ...
    assign tt-param.usuario           = c-seg-usuario
           ...
           tt-param.num-pedido-ini    = INPUT FRAME f-pg-sel i-num-pedido-ini
           tt-param.num-pedido-fim    = INPUT FRAME f-pg-sel i-num-pedido-fim
    ...
    {include/i-rprun.i esp/ccp/esccp003rp.p}
