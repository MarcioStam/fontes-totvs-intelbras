...
*******************************************************************************/
{include/i-prgvrs.i ESCCP048 1.00.00.000}

CREATE WIDGET-POOL.

/* Preprocessors Definitions ---                                      */
&GLOBAL-DEFINE Program        ESCCP048
...
&GLOBAL-DEFINE page2Widgets   fi-ini-data fi-fim-data fi-ini-it-codigo fi-fim-it-codigo fi-ini-cod-comprado fi-fim-cod-comprado fi-ini-ge fi-fim-ge
...
&Scoped-define List-1 fi-ini-data fi-fim-data fi-ini-ge 
...
DEFINE VARIABLE fi-fim-ge AS INTEGER FORMAT "999":U INITIAL 999 
     VIEW-AS FILL-IN 
...
DEFINE VARIABLE fi-ini-ge AS INTEGER FORMAT ">>9" INITIAL 0 
     LABEL "Grupo Estoque" 
     VIEW-AS FILL-IN 
     SIZE 4.43 BY .88 NO-UNDO.
...
DEFINE FRAME fPage2
     fi-ini-data AT ROW 2.75 COL 21.72 COLON-ALIGNED
     fi-fim-data AT ROW 2.75 COL 51.43 COLON-ALIGNED NO-LABEL
     fi-ini-cod-comprado AT ROW 3.71 COL 19.57 COLON-ALIGNED HELP
          "C¢digo do comprador"
     fi-fim-cod-comprado AT ROW 3.71 COL 51.43 COLON-ALIGNED HELP
          "C¢digo do comprador" NO-LABEL
     fi-ini-it-codigo AT ROW 4.67 COL 15 COLON-ALIGNED HELP
          "C¢digo do Item"
     fi-fim-it-codigo AT ROW 4.67 COL 51.43 COLON-ALIGNED HELP
          "C¢digo do Item" NO-LABEL
     fi-ini-ge AT ROW 5.63 COL 30 COLON-ALIGNED WIDGET-ID 8
     fi-fim-ge AT ROW 5.63 COL 51.43 COLON-ALIGNED NO-LABEL WIDGET-ID 6
     IMAGE-1 AT ROW 4.71 COL 36.86
     IMAGE-10 AT ROW 3.75 COL 50
     IMAGE-29 AT ROW 2.79 COL 49.86
     IMAGE-30 AT ROW 4.71 COL 50
     IMAGE-5 AT ROW 2.79 COL 36.72
     IMAGE-9 AT ROW 3.75 COL 36.86
     IMAGE-33 AT ROW 5.67 COL 36.86 WIDGET-ID 10
     IMAGE-34 AT ROW 5.67 COL 50.14 WIDGET-ID 12
...
/* SETTINGS FOR FILL-IN fi-ini-data IN FRAME fPage2
   1                                                                    */
/* SETTINGS FOR FILL-IN fi-ini-ge IN FRAME fPage2
   1                                                                    */
...
do on error undo, return error on stop  undo, return error:
    ...
    assign tt-param.usuario           = c-seg-usuario
           ...
           tt-param.i-ge-ini          = INPUT FRAME fPage2 fi-ini-ge
           tt-param.i-ge-fim          = INPUT FRAME fPage2 fi-fim-ge.
    ...
    {report/rprun.i esp/ccp/esccp048rp.p}
