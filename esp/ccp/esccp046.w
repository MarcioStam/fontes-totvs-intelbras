...
*******************************************************************************/
{include/i-prgvrs.i esccp046 9.99.99.999}
...
DEFINE VARIABLE d-data-corte AS DATE FORMAT "99/99/9999":U INITIAL ? 
     LABEL "Data de Corte" 
     VIEW-AS FILL-IN 
...
DEFINE FRAME f-pg-sel
     ...
     d-data-corte AT ROW 2.25 COL 15 COLON-ALIGNED WIDGET-ID 2
...
{utp/ut9000.i "esccp046" "9.99.99.999"}
...
------------------------------------------------------------------------------*/
  ...
  DISPLAY i-cod-emitente-ini i-cod-emitente-fim d-data-corte 
      WITH FRAME f-pg-sel IN WINDOW w-relat.
  ENABLE IMAGE-1 IMAGE-2 i-cod-emitente-ini i-cod-emitente-fim d-data-corte 
      WITH FRAME f-pg-sel IN WINDOW w-relat.
...
do on error undo, return error on stop  undo, return error:
    ...
    assign tt-param.usuario          = c-seg-usuario
           ...
           tt-param.data-corte       = INPUT FRAME f-pg-sel d-data-corte
           .
    ...
    {include/i-rprun.i esp/ccp/esccp046rp.p}
