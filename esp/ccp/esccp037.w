...
*******************************************************************************/
{include/i-prgvrs.i esccp037 2.00.00.000}
...
&Scoped-define List-1 fi-ini-data fi-fim-data 
...
DEFINE VARIABLE c-cod-comprado-fim AS CHARACTER FORMAT "X(12)" INITIAL "ZZZZZZZZZZZZ" 
     VIEW-AS FILL-IN 
     SIZE 16.14 BY .88 NO-UNDO.

DEFINE VARIABLE c-cod-comprado-ini LIKE ordem-compra.cod-comprado
     VIEW-AS FILL-IN 
     SIZE 16.14 BY .88 NO-UNDO.
...
DEFINE VARIABLE c-cod-emitente-ini LIKE emitente.cod-emitente
     LABEL "Fornecedor" 
     VIEW-AS FILL-IN 
     SIZE 11.43 BY .88 NO-UNDO.
...
DEFINE FRAME f-pg-sel
     c-it-codigo-ini AT ROW 1.25 COL 12.72 COLON-ALIGNED
     c-it-codigo-fim AT ROW 1.25 COL 48.14 COLON-ALIGNED NO-LABEL
     c-cod-estab-ini AT ROW 2.25 COL 12.72 COLON-ALIGNED WIDGET-ID 4
     c-cod-estab-fim AT ROW 2.25 COL 48.14 COLON-ALIGNED NO-LABEL WIDGET-ID 2
     c-cod-emitente-ini AT ROW 3.25 COL 12.72 COLON-ALIGNED HELP
          "" WIDGET-ID 18
          LABEL "Fornecedor"
     c-cod-emitente-fim AT ROW 3.25 COL 48.14 COLON-ALIGNED NO-LABEL WIDGET-ID 16
     c-cod-comprado-ini AT ROW 4.25 COL 12.72 COLON-ALIGNED HELP
          "" WIDGET-ID 26
     c-cod-comprado-fim AT ROW 4.25 COL 48.14 COLON-ALIGNED NO-LABEL WIDGET-ID 24
     fi-ini-data AT ROW 5.25 COL 12.72 COLON-ALIGNED WIDGET-ID 38
     fi-fim-data AT ROW 5.25 COL 48 COLON-ALIGNED NO-LABEL WIDGET-ID 36
     c-email AT ROW 6.46 COL 12.57 COLON-ALIGNED WIDGET-ID 32
     tg-confirmada AT ROW 8.58 COL 17 WIDGET-ID 12
     tg-recebida AT ROW 9.58 COL 17 WIDGET-ID 14
     "Situaá∆o" VIEW-AS TEXT
          SIZE 7 BY .54 AT ROW 7.79 COL 15.86 WIDGET-ID 34
     IMAGE-1 AT ROW 1.25 COL 31.86
     IMAGE-2 AT ROW 1.25 COL 47.29
     IMAGE-3 AT ROW 2.25 COL 31.86 WIDGET-ID 6
     IMAGE-4 AT ROW 2.25 COL 47.29 WIDGET-ID 8
     IMAGE-5 AT ROW 3.25 COL 31.86 WIDGET-ID 20
     IMAGE-6 AT ROW 3.25 COL 47.29 WIDGET-ID 22
     IMAGE-7 AT ROW 4.25 COL 31.86 WIDGET-ID 28
     IMAGE-8 AT ROW 4.25 COL 47.29 WIDGET-ID 30
     RECT-17 AT ROW 8.08 COL 14.86 WIDGET-ID 10
     IMAGE-29 AT ROW 5.25 COL 47.29 WIDGET-ID 40
     IMAGE-35 AT ROW 5.25 COL 32 WIDGET-ID 42
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 3 ROW 2.83
         SIZE 76.86 BY 10.62
...
/* SETTINGS FOR FRAME f-pg-sel
                                                                        */
/* SETTINGS FOR FILL-IN c-cod-comprado-ini IN FRAME f-pg-sel
   LIKE = mgmov.ordem-compra.cod-comprado EXP-SIZE                     */
/* SETTINGS FOR FILL-IN c-cod-emitente-ini IN FRAME f-pg-sel
...
{utp/ut9000.i "esccp037" "2.00.00.000"}
...
DO  ON ERROR   UNDO MAIN-BLOCK, LEAVE MAIN-BLOCK
    ...
    FOR FIRST usuar_mestre FIELDS (cod_e_mail_local)
        ...
        IF usuar_mestre.cod_e_mail_local <> "" THEN
            ASSIGN c-email:SCREEN-VALUE IN FRAME f-pg-sel = usuar_mestre.cod_e_mail_local.
    END.
...
------------------------------------------------------------------------------*/
  ...
  DISPLAY c-it-codigo-ini c-it-codigo-fim c-cod-estab-ini c-cod-estab-fim 
          c-cod-emitente-ini c-cod-emitente-fim c-cod-comprado-ini 
          c-cod-comprado-fim fi-ini-data fi-fim-data c-email tg-confirmada 
          tg-recebida 
      WITH FRAME f-pg-sel IN WINDOW w-relat.
  ENABLE IMAGE-1 IMAGE-2 IMAGE-3 IMAGE-4 IMAGE-5 IMAGE-6 IMAGE-7 IMAGE-8 
         RECT-17 IMAGE-29 IMAGE-35 c-it-codigo-ini c-it-codigo-fim 
         c-cod-estab-ini c-cod-estab-fim c-cod-emitente-ini c-cod-emitente-fim 
         c-cod-comprado-ini c-cod-comprado-fim fi-ini-data fi-fim-data c-email 
         tg-confirmada tg-recebida 
      WITH FRAME f-pg-sel IN WINDOW w-relat.
...
do on error undo, return error on stop  undo, return error:
    ...
    assign tt-param.usuario          = c-seg-usuario
           ...
           tt-param.cod-emitente-ini = input frame f-pg-sel c-cod-emitente-ini
           tt-param.cod-emitente-fim = input frame f-pg-sel c-cod-emitente-fim
           tt-param.cod-comprado-ini = input frame f-pg-sel c-cod-comprado-ini
           tt-param.cod-comprado-fim = input frame f-pg-sel c-cod-comprado-fim
           tt-param.email            = input frame f-pg-sel c-email
           tt-param.l-confirmada      = INPUT FRAME f-pg-sel tg-confirmada
           tt-param.l-recebida        = INPUT FRAME f-pg-sel tg-recebida
           tt-param.ini-data          = INPUT FRAME f-pg-sel fi-ini-data
           tt-param.fim-data          = INPUT FRAME f-pg-sel fi-fim-data
    ...
    {include/i-rprun.i esp/ccp/esccp037rp.p}
