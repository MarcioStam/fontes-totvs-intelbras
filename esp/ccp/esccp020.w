...
*******************************************************************************/
{include/i-prgvrs.i ESCCP020 2.04.00.001}

CREATE WIDGET-POOL.

/* Preprocessors Definitions ---                                      */
&GLOBAL-DEFINE Program        ESCCP020
...
&GLOBAL-DEFINE page2Fields    fi-cod-estabel fi-fim-dt-entrega fi-fim-it-codigo fi-ini-dt-entrega fi-ini-it-codigo
...
DEFINE VARIABLE fi-fim-dt-entrega AS DATE FORMAT "99/99/9999" INITIAL 12/31/2999 
     VIEW-AS FILL-IN 
...
DEFINE VARIABLE fi-ini-dt-entrega AS DATE FORMAT "99/99/9999" INITIAL 01/01/07 
     LABEL "Data Entrega":R14 
     VIEW-AS FILL-IN 
     SIZE 12.57 BY .88 NO-UNDO.
...
DEFINE FRAME fPage2
     fi-cod-estabel AT ROW 2.21 COL 17 COLON-ALIGNED HELP
          "Estabelecimento" 
     fi-ini-it-codigo AT ROW 3.21 COL 17 COLON-ALIGNED HELP
          "C¢digo do Item" 
     fi-fim-it-codigo AT ROW 3.25 COL 42 COLON-ALIGNED HELP
          "C¢digo do Item" NO-LABEL 
     fi-ini-dt-entrega AT ROW 4.21 COL 17 COLON-ALIGNED 
     fi-fim-dt-entrega AT ROW 4.21 COL 42 COLON-ALIGNED NO-LABEL 
     IMAGE-1 AT ROW 3.17 COL 35.86
     IMAGE-2 AT ROW 3.25 COL 40
     IMAGE-5 AT ROW 4.25 COL 36 
     IMAGE-6 AT ROW 4.25 COL 40 
...
ASSIGN fi-cod-estabel:SCREEN-VALUE IN FRAME fPage2 = v_cod_estab_usuar.
...
do on error undo, return error on stop  undo, return error:
    ...
    assign tt-param.usuario         = c-seg-usuario
           ...
           tt-param.data-ini        = input frame fPage2 fi-ini-dt-entrega
           tt-param.data-fim        = input frame fPage2 fi-fim-dt-entrega
    ...
    {report/rprun.i esp/ccp/esccp020rp.p}
