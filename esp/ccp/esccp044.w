...
DEFINE VARIABLE l-ativo AS LOGICAL INITIAL yes 
     LABEL "Ativo" 
     VIEW-AS TOGGLE-BOX
     SIZE 30 BY 1.08 NO-UNDO.

DEFINE VARIABLE l-obsoleto-aut AS LOGICAL INITIAL yes 
     LABEL "Obsoleto Ordens Autom ticas" 
     VIEW-AS TOGGLE-BOX
     SIZE 28 BY 1.08 NO-UNDO.

DEFINE VARIABLE l-obsoleto-todas AS LOGICAL INITIAL no 
     LABEL "Obsoleto Todas as Ordens" 
     VIEW-AS TOGGLE-BOX
     SIZE 27 BY 1.08 NO-UNDO.

DEFINE VARIABLE l-totalmente-obsoleto AS LOGICAL INITIAL no 
...
DEFINE FRAME f-pg-sel
     c-it-codigo-ini AT ROW 1.25 COL 12.86 COLON-ALIGNED
...
DEFINE FRAME f-pg-par
     l-ativo AT ROW 1.75 COL 4
     l-obsoleto-aut AT ROW 2.75 COL 4 WIDGET-ID 6
     l-obsoleto-todas AT ROW 3.75 COL 4 WIDGET-ID 8
     l-totalmente-obsoleto AT ROW 4.75 COL 4 WIDGET-ID 10
     "Situa‡Æo Item - CD0204" VIEW-AS TEXT
          SIZE 17 BY .54 AT ROW 1 COL 3 WIDGET-ID 14
     RECT-10 AT ROW 1.25 COL 2 WIDGET-ID 12
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 3 ROW 3
         SIZE 75 BY 10
...
{utp/ut9000.i "esccp044" "2.00.00.000"}
...
------------------------------------------------------------------------------*/
  ...
  DISPLAY c-it-codigo-ini c-it-codigo-fim 
      WITH FRAME f-pg-sel IN WINDOW w-relat.
  ENABLE IMAGE-1 IMAGE-2 c-it-codigo-ini c-it-codigo-fim 
      WITH FRAME f-pg-sel IN WINDOW w-relat.
  ...
  DISPLAY l-ativo l-obsoleto-aut l-obsoleto-todas l-totalmente-obsoleto 
      WITH FRAME f-pg-par IN WINDOW w-relat.
  ENABLE RECT-10 l-ativo l-obsoleto-aut l-obsoleto-todas l-totalmente-obsoleto 
      WITH FRAME f-pg-par IN WINDOW w-relat.
...
do on error undo, return error on stop  undo, return error:
    ...
    assign tt-param.usuario             = c-seg-usuario
           ...
           tt-param.ativo               = l-ativo:CHECKED IN FRAME f-pg-par
           tt-param.obsoleto-aut        = l-obsoleto-aut:CHECKED IN FRAME f-pg-par
           tt-param.obsoleto-todas      = l-obsoleto-todas:CHECKED IN FRAME f-pg-par
           tt-param.totalmente-obsoleto = l-totalmente-obsoleto:CHECKED IN FRAME f-pg-par
           .
    ...
    {include/i-rprun.i esp/ccp/esccp044rp.p}
