...
*******************************************************************************/
{include/i-prgvrs.i esccp002 2.00.00.000}
...
&Scoped-define FIELDS-IN-QUERY-br-digita tt-digita.num-pedido tt-digita.numero-ordem tt-digita.parcela tt-digita.data tt-digita.nf   
...
DEFINE VARIABLE EDITOR-2 AS CHARACTER INITIAL "Pedido~;Ordem Compra~;Parcela~;Data~;NF~;" 
     VIEW-AS EDITOR
     SIZE 75 BY 4 NO-UNDO.
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br-digita w-relat _FREEFORM
  QUERY br-digita DISPLAY
      tt-digita.num-pedido WIDTH 10
tt-digita.numero-ordem WIDTH 12
tt-digita.parcela
    tt-digita.data WIDTH 12
    tt-digita.nf WIDTH 12
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
...
DEFINE FRAME f-pg-sel
     EDITOR-2 AT ROW 1.25 COL 2 NO-LABEL WIDGET-ID 44
     bt-arquivo-entrada AT ROW 8.71 COL 43.14 HELP
          "Escolha do nome do arquivo" WIDGET-ID 34
     c-arquivo-entrada AT ROW 8.75 COL 3.29 HELP
          "Nome do arquivo de destino do relat¢rio" NO-LABEL WIDGET-ID 36
     bt-carrega AT ROW 9.75 COL 3.29 WIDGET-ID 42
     text-entrada AT ROW 7.71 COL 4.14 NO-LABEL WIDGET-ID 40
     RECT-8 AT ROW 8.04 COL 2 WIDGET-ID 38
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 3 ROW 2.85
...
/* SETTINGS FOR FRAME f-pg-sel
                                                                        */
/* SETTINGS FOR EDITOR EDITOR-2 IN FRAME f-pg-sel
   NO-ENABLE                                                            */
...
{utp/ut9000.i "esccp002" "2.00.00.000"}
...
------------------------------------------------------------------------------*/
  ...
  DISPLAY EDITOR-2 c-arquivo-entrada 
      WITH FRAME f-pg-sel IN WINDOW w-relat.
  ENABLE RECT-8 bt-arquivo-entrada c-arquivo-entrada bt-carrega 
      WITH FRAME f-pg-sel IN WINDOW w-relat.
...
------------------------------------------------------------------------------*/
    ...
    INPUT FROM VALUE (c-arquivo-entrada:SCREEN-VALUE IN FRAME f-pg-sel) NO-CONVERT.
    ...
    REPEAT:
        ...
        RUN pi-acompanhar IN h-acomp (INPUT "Importando ordem: " + ENTRY(1, c-linha, ";")).

        CREATE tt-digita.
        ASSIGN tt-digita.num-pedido   = INT(ENTRY(1, c-linha, ";"))
               tt-digita.numero-ordem = INT(ENTRY(2, c-linha, ";"))
               tt-digita.parcela      = INT(ENTRY(3, c-linha, ";"))
               tt-digita.data         = DATE(ENTRY(4, c-linha, ";"))
               tt-digita.nf           = ENTRY(5, c-linha, ";").
...
do on error undo, return error on stop  undo, return error:
    ...
    {include/i-rprun.i esp/ccp/esccp002rp.p}
