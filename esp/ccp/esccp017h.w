...
*******************************************************************************/
{include/i-prgvrs.i esccp017H 2.04.00.001}

CREATE WIDGET-POOL.

/* Preprocessors Definitions ---                                      */
&GLOBAL-DEFINE Program        esccp017H
...
def input parameter table for tt-param2.
def input parameter table for tt-situacao.
...
DEFINE FRAME fPage6
     rsDestiny AT ROW 3.5 COL 4 HELP
          "Destino de Impress∆o do Relat¢rio" NO-LABEL
     cFile AT ROW 4.75 COL 4 HELP
          "Nome do arquivo de destino do relat¢rio" NO-LABEL
     btFile AT ROW 4.63 COL 43.86 HELP
          "Escolha do nome do arquivo"
     btConfigImpr AT ROW 4.63 COL 43.86 HELP
          "Configuraá∆o da impressora"
     rsExecution AT ROW 8 COL 3.86 HELP
          "Modo de Execuá∆o" NO-LABEL
     text-destino AT ROW 2.75 COL 2.72 COLON-ALIGNED NO-LABEL
     text-modo AT ROW 7.25 COL 2.14 COLON-ALIGNED NO-LABEL
     RECT-7 AT ROW 3.04 COL 3
     RECT-9 AT ROW 7.5 COL 3
...
do on error undo, return error on stop  undo, return error:
    ...
    for each tt-situacao:
        create tt-situacao2.
        buffer-copy tt-situacao to tt-situacao2.
    end.
    ...
    buffer-copy tt-param2 to tt-param.
    
    assign tt-param.rw-homologacao  = p-rw-homologacao
    ...
    {report/rprun.i esp/ccp/esccp017hrp.p}
