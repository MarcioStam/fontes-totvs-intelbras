...
*******************************************************************************/
{include/i-prgvrs.i es0024 2.04.00.001}

CREATE WIDGET-POOL.

/* Preprocessors Definitions ---                                      */
&GLOBAL-DEFINE Program        es0024
...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW wReport ASSIGN
         HIDDEN             = YES
         TITLE              = "C†lculo do Fator de Internaá∆o"
         HEIGHT             = 17
         WIDTH              = 90
         MAX-HEIGHT         = 40.83
         MAX-WIDTH          = 182.86
...
ON END-ERROR OF wReport /* C†lculo do Fator de Internaá∆o */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL wReport wReport
ON WINDOW-CLOSE OF wReport /* C†lculo do Fator de Internaá∆o */
DO:
