...
*******************************************************************************/
{include/i-prgvrs.i esapi400 TOTVS}
...
DEFINE SUB-MENU mi-arquivo 
       ...
       MENU-ITEM mi-va-para     LABEL "&Vÿ para"       ACCELERATOR "CTRL-T"
...
DEFINE VARIABLE h_esapi400-q01 AS HANDLE NO-UNDO.
DEFINE VARIABLE h_esapi400-v01 AS HANDLE NO-UNDO.
...
ON END-ERROR OF w-cadsim /* Manuten»’o <Insira o complemento> */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL w-cadsim w-cadsim
ON WINDOW-CLOSE OF w-cadsim /* Manuten»’o <Insira o complemento> */
DO:
...
ON CHOOSE OF MENU-ITEM mi-va-para /* Vÿ para */
DO:
...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'esp/esapi400-v01.w':U ,
             INPUT  FRAME f-cad:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_esapi400-v01 ).
       RUN set-position IN h_esapi400-v01 ( 2.88 , 1.57 ) NO-ERROR.
       /* Size in UIB:  ( 2.50 , 88.57 ) */

       RUN init-object IN THIS-PROCEDURE (
             INPUT  'esp/esapi400-q01.w':U ,
             INPUT  FRAME f-cad:HANDLE ,
             INPUT  'ProgPesquisa = esp/esapi400-z01.w,
                     ProgVaPara = esp/esapi400-g01.w,
                     ProgIncMod = ,
                     Implantar = no':U ,
             OUTPUT h_esapi400-q01 ).
       RUN set-position IN h_esapi400-q01 ( 1.25 , 61.00 ) NO-ERROR.
       /* Size in UIB:  ( 1.63 , 7.72 ) */

       /* Links to SmartPanel h_p-exihel. */
       RUN add-link IN adm-broker-hdl ( h_p-cadsim , 'State':U , h_p-exihel ).

       /* Links to SmartViewer h_esapi400-v01. */
       RUN add-link IN adm-broker-hdl ( h_esapi400-q01 , 'Record':U , h_esapi400-v01 ).
       RUN add-link IN adm-broker-hdl ( h_p-cadsim , 'TableIO':U , h_esapi400-v01 ).

       /* Links to SmartQuery h_esapi400-q01. */
       RUN add-link IN adm-broker-hdl ( h_p-navega , 'Navigation':U , h_esapi400-q01 ).
       RUN add-link IN adm-broker-hdl ( h_p-navega , 'State':U , h_esapi400-q01 ).
       ...
       RUN adjust-tab-order IN adm-broker-hdl ( h_p-exihel ,
             h_p-cadsim , 'AFTER':U ).
       RUN adjust-tab-order IN adm-broker-hdl ( h_esapi400-v01 ,
             h_p-exihel , 'AFTER':U ).
    END. /* Page 0 */
