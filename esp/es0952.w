...
*******************************************************************************/
{include/i-prgvrs.i es0952 2.06.00.002}

CREATE WIDGET-POOL.

/* Preprocessors Definitions ---                                      */
&GLOBAL-DEFINE Program        es0952
...
&GLOBAL-DEFINE page2Fields    ini-data fim-data ini-conta fim-conta l-despesa ini-ccusto fim-ccusto ini-estab fim-estab l-ACR l-APB l-APL l-CMG 
...
DEFINE FRAME fPage2
     ini-estab AT ROW 2.75 COL 33 COLON-ALIGNED
     fim-estab AT ROW 2.71 COL 54.57 COLON-ALIGNED NO-LABEL
     ini-data AT ROW 3.75 COL 19.14 WIDGET-ID 14
     fim-data AT ROW 3.71 COL 56.57 NO-LABEL WIDGET-ID 16
     ini-conta AT ROW 4.75 COL 30 COLON-ALIGNED WIDGET-ID 56
     fim-conta AT ROW 4.71 COL 54.57 COLON-ALIGNED NO-LABEL WIDGET-ID 62
     ini-ccusto AT ROW 5.75 COL 33 COLON-ALIGNED WIDGET-ID 14
     fim-ccusto AT ROW 5.71 COL 54.57 COLON-ALIGNED NO-LABEL WIDGET-ID 16
     l-despesa AT ROW 8 COL 29
     l-ACR AT ROW 9.75 COL 29
     l-APB AT ROW 10.75 COL 29
     l-CMG AT ROW 9.79 COL 46.14
     l-APL AT ROW 10.79 COL 46.14
...
DO:
    ...
    IF ini-ccusto <> "" OR fim-ccusto <> "ZZZZZ" 
    THEN DO:
