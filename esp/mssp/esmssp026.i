/*------------------------------------------------------------------------
    File        : ESMSSP026.I
    Purpose     : Include Busca Estabelecimentos da Fam¡lia Material -
                  Procedure: buscaEstFamMat
    Syntax      : <none>
    Description : <none>
...
DEFINE TEMP-TABLE tt-estabelec NO-UNDO
    FIELD cod-estabel  LIKE estabelec.cod-estabel LABEL "C¢digo Estabelecimento":U COLUMN-LABEL "C¢d Estabel":U
    FIELD nome-estabel LIKE estabelec.nome        LABEL "Nome Estabelecimento":U   COLUMN-LABEL "Nome Estabelec":U
