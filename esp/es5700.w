...
**  Programa: es5700 - Andrey M Oliveira - 13/07/2023
**            Extracao de dados para registro Sped 1601.
**
*******************************************************************************/
{include/i-prgvrs.i es5700 1.00.00.000}
{utp/ut-glob.i}
{cdp/cdcfgmat.i}
...
&GLOBAL-DEFINE page2Fields    v_data_ini v_data_fim
...
DEFINE VARIABLE v_data_fim AS DATE FORMAT "99/99/9999":U 
     VIEW-AS FILL-IN 
     SIZE 13 BY .79 NO-UNDO.

DEFINE VARIABLE v_data_ini AS DATE FORMAT "99/99/9999":U 
     LABEL "Data" 
     VIEW-AS FILL-IN 
     SIZE 13 BY .79 NO-UNDO.
...
DEFINE FRAME fPage2
     v_data_ini AT ROW 3.25 COL 20 COLON-ALIGNED WIDGET-ID 8
     v_data_fim AT ROW 3.25 COL 42 COLON-ALIGNED NO-LABEL WIDGET-ID 10
     IMAGE-34 AT ROW 3.25 COL 40 WIDGET-ID 198
     IMAGE-33 AT ROW 3.25 COL 36 WIDGET-ID 196
...
ASSIGN v_data_ini:SCREEN-VALUE IN FRAME fPage2 = string(TODAY)
           v_data_fim:SCREEN-VALUE IN FRAME fPage2 = string(TODAY)
           v_data_ini:SENSITIVE    IN FRAME fPage2 = YES
           v_data_fim:SENSITIVE    IN FRAME fPage2 = YES.
...
do on error undo, return error on stop  undo, return error:
    ...
    ASSIGN tt-param.usuario   = c-seg-usuario
           ...
           tt-param.data-ini  = INPUT FRAME fPage2 v_data_ini
           tt-param.data-fim  = INPUT FRAME fPage2 v_data_fim.
