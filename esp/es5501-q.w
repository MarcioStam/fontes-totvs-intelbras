...
&Scoped-define INTERNAL-TABLES param_orcto

/* Definitions for QUERY Query-Main                                     */
&Scoped-define QUERY-STRING-Query-Main FOR EACH param_orcto NO-LOCK
&Scoped-define OPEN-QUERY-Query-Main OPEN QUERY Query-Main FOR EACH param_orcto NO-LOCK.
&Scoped-define TABLES-IN-QUERY-Query-Main param_orcto
&Scoped-define FIRST-TABLE-IN-QUERY-Query-Main param_orcto
