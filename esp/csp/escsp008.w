...
&GLOBAL-DEFINE Program        ESCSP008
...
&GLOBAL-DEFINE page2Widgets   fi-cod-estab-ini fi-cod-estab-fim fi-it-codigo-ini fi-it-codigo-fim ~
                              fi-dt-emissao-ini fi-dt-emissao-fim fi-nr-ord-produ-ini fi-nr-ord-produ-fim
...
&GLOBAL-DEFINE page2Fields   fi-cod-estab-ini fi-cod-estab-fim fi-it-codigo-ini fi-it-codigo-fim ~
                             fi-dt-emissao-ini fi-dt-emissao-fim fi-nr-ord-produ-ini fi-nr-ord-produ-fim
...
DEFINE VARIABLE fi-it-codigo-fim AS CHARACTER FORMAT "x(16)" INITIAL "9999999999999999" 
     VIEW-AS FILL-IN 
     SIZE 17 BY .88.
...
DEFINE FRAME fPage2
     fi-cod-estab-ini AT ROW 1.5 COL 6 HELP
          "C¢digo Estabelecimento Inicial" WIDGET-ID 40
     fi-cod-estab-fim AT ROW 1.5 COL 51.57 COLON-ALIGNED HELP
          "C¢digo Estabelecimento Final" NO-LABEL WIDGET-ID 38
     fi-it-codigo-ini AT ROW 2.5 COL 14.28
     fi-it-codigo-fim AT ROW 2.5 COL 51.57 COLON-ALIGNED NO-LABEL
     fi-dt-emissao-ini AT ROW 3.5 COL 7.86 WIDGET-ID 4
     fi-dt-emissao-fim AT ROW 3.5 COL 51.57 COLON-ALIGNED NO-LABEL WIDGET-ID 2
     fi-nr-ord-produ-ini AT ROW 4.5 COL 4.43 HELP
          "N£mero da Ordem de Produ‡Æo Final" WIDGET-ID 48
     fi-nr-ord-produ-fim AT ROW 4.5 COL 53.57 HELP
          "N£mero da Ordem de Produ‡Æo Final" NO-LABEL WIDGET-ID 54
     IMAGE-3 AT ROW 2.5 COL 36
     IMAGE-4 AT ROW 2.5 COL 50
     IMAGE-35 AT ROW 3.5 COL 36 WIDGET-ID 6
     IMAGE-36 AT ROW 3.5 COL 50 WIDGET-ID 8
     IMAGE-37 AT ROW 1.5 COL 36 WIDGET-ID 42
     IMAGE-38 AT ROW 1.5 COL 50 WIDGET-ID 44
     IMAGE-39 AT ROW 4.5 COL 36 WIDGET-ID 50
     IMAGE-40 AT ROW 4.5 COL 50 WIDGET-ID 52
    WITH 1 DOWN KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 3.57 ROW 2.81
         SIZE 84.43 BY 10.15
...
/* SETTINGS FOR FILL-IN fi-cod-estab-ini IN FRAME fPage2
   ALIGN-L                                                              */
/* SETTINGS FOR FILL-IN fi-dt-emissao-ini IN FRAME fPage2
   ALIGN-L                                                              */
/* SETTINGS FOR FILL-IN fi-it-codigo-ini IN FRAME fPage2
   ALIGN-L                                                              */
/* SETTINGS FOR FILL-IN fi-nr-ord-produ-fim IN FRAME fPage2
   ALIGN-L                                                              */
/* SETTINGS FOR FILL-IN fi-nr-ord-produ-ini IN FRAME fPage2
   ALIGN-L                                                              */
...
------------------------------------------------------------------------------*/
    ...
    ASSIGN fi-cod-estab-ini:SCREEN-VALUE IN FRAME fPage2  = v_cod_estab_usuar
...
do on error undo, return error on stop  undo, return error:
    ...
    IF INPUT FRAME fPage2 fi-dt-emissao-ini >  INPUT FRAME fPage2 fi-dt-emissao-fim THEN DO:
        run utp/ut-msgs.p (input "show":U, input 17006, input "Data EmissÆo inicial maior que data final!~~Verificar datas.":U).
        apply "ENTRY":U to fi-dt-emissao-ini in frame fPage2.
        return error.
    END.
    ...
    assign tt-param.usuario          = c-seg-usuario
           ...
           tt-param.dt-emissao-ini   = INPUT FRAME fPage2 fi-dt-emissao-ini  
           tt-param.dt-emissao-fim   = INPUT FRAME fPage2 fi-dt-emissao-fim  
           tt-param.nr-ord-produ-ini = INPUT FRAME fPage2 fi-nr-ord-produ-ini
           tt-param.nr-ord-produ-fim = INPUT FRAME fPage2 fi-nr-ord-produ-fim.
    ...
    {report/rprun.i esp/csp/escsp008rp.p}
