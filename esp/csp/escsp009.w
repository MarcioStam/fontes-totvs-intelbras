...
*******************************************************************************/
{include/i-prgvrs.i ESCSP009 2.04.00.000}

CREATE WIDGET-POOL.

/* Preprocessors Definitions ---                                      */
&GLOBAL-DEFINE Program        ESCSP009
...
&GLOBAL-DEFINE page2Widgets   fi-cod-estab fi-data-corte fi-it-codigo-ini fi-it-codigo-fim ~
                              fi-dt-emissao-ini fi-dt-emissao-fim tg-lista-estrutura tg-itens-unidades
...
&GLOBAL-DEFINE page2Fields   fi-cod-estab fi-data-corte fi-it-codigo-ini fi-it-codigo-fim ~
...
DEFINE VARIABLE tg-itens-unidades AS LOGICAL INITIAL yes 
     LABEL "Lista Itens Unidades?" 
     VIEW-AS TOGGLE-BOX
     SIZE 18 BY .83 NO-UNDO.

DEFINE VARIABLE tg-lista-estrutura AS LOGICAL INITIAL yes 
     LABEL "Lista por Estrutura?" 
     VIEW-AS TOGGLE-BOX
...
DEFINE FRAME fPage2
     fi-cod-estab AT ROW 1.5 COL 6 HELP
          "C¢digo Estabelecimento Inicial" WIDGET-ID 40
     fi-data-corte AT ROW 1.46 COL 51.57 COLON-ALIGNED WIDGET-ID 30
     fi-it-codigo-ini AT ROW 2.5 COL 7.71
     ...
     tg-lista-estrutura AT ROW 4.75 COL 18 WIDGET-ID 32
     tg-itens-unidades AT ROW 5.75 COL 18 WIDGET-ID 36
...
------------------------------------------------------------------------------*/
    ...
    ASSIGN fi-cod-estab:SCREEN-VALUE IN FRAME fPage2  = v_cod_estab_usuar
           fi-data-corte:SCREEN-VALUE IN FRAME fPage2 = STRING(TODAY,"99/99/9999")
           fi-dt-emissao-ini:SCREEN-VALUE IN FRAME fPage2 = STRING(TODAY - 30,"99/99/9999")
           fi-dt-emissao-fim:SCREEN-VALUE IN FRAME fPage2 = STRING(TODAY,"99/99/9999").
...
do on error undo, return error on stop  undo, return error:
    ...
    IF INPUT FRAME fPage2 fi-dt-emissao-ini >  INPUT FRAME fPage2 fi-dt-emissao-fim THEN DO:
        run utp/ut-msgs.p (input "show":U, input 17006, input "Data Emiss∆o inicial maior que data final!~~Verificar datas.":U).
    ...
    assign tt-param.usuario           = c-seg-usuario
           ...
           tt-param.l-lista-estrutura = INPUT FRAME fPage2 tg-lista-estrutura
           tt-param.l-itens-unidades  = INPUT FRAME fPage2 tg-itens-unidades.
    ...
    {report/rprun.i esp/csp/escsp009rp.p}
