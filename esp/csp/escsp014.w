...
*******************************************************************************/
{include/i-prgvrs.i ESCSP014 2.04.00.000}

CREATE WIDGET-POOL.

/* Preprocessors Definitions ---                                      */
&GLOBAL-DEFINE Program        ESCSP014
...
&GLOBAL-DEFINE page2Widgets   i-cod-desp-ini i-cod-desp-fim 
...
DEFINE VARIABLE i-cod-desp-fim AS INTEGER FORMAT ">>,>>9" INITIAL 99999 
     VIEW-AS FILL-IN 
     SIZE 9 BY .88.

DEFINE VARIABLE i-cod-desp-ini AS INTEGER FORMAT ">>,>>9" INITIAL 0 
     LABEL "Despesa" 
     VIEW-AS FILL-IN 
     SIZE 9 BY .88.
...
DEFINE FRAME fPage2
     i-cod-desp-ini AT ROW 3 COL 37.14 RIGHT-ALIGNED HELP
          "C¢digo Despesa Inicial" WIDGET-ID 34
     i-cod-desp-fim AT ROW 3 COL 45.86 COLON-ALIGNED HELP
          "C¢digo Despesa Final" NO-LABEL WIDGET-ID 42
     IMAGE-37 AT ROW 3 COL 39 WIDGET-ID 38
     IMAGE-38 AT ROW 3 COL 44 WIDGET-ID 40
    WITH 1 DOWN KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 3.57 ROW 2.81
         SIZE 84.43 BY 10.15
...
/* SETTINGS FOR FRAME fPage2
   Custom                                                               */
/* SETTINGS FOR FILL-IN i-cod-desp-ini IN FRAME fPage2
   ALIGN-R                                                              */
...
do on error undo, return error on stop  undo, return error:
    ...
    IF INPUT FRAME fPage2 i-cod-desp-ini >  INPUT FRAME fPage2 i-cod-desp-fim THEN DO:
        run utp/ut-msgs.p (input "show":U, input 17006, input "Despesa inicial maior que Despesa final!~~Verificar Faixa.":U).
        apply "ENTRY":U to i-cod-desp-ini in frame fPage2.
        return error.
    END.
    ...
    assign tt-param.usuario          = c-seg-usuario
           ...
           tt-param.cod-desp-ini     = input frame fPage2 i-cod-desp-ini
           tt-param.cod-desp-fim     = input frame fPage2 i-cod-desp-fim.
    ...
    {report/rprun.i esp/csp/escsp014rp.p}
