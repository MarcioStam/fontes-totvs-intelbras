...
*******************************************************************************/
{include/i-prgvrs.i ESCSP004 2.04.00.001}

CREATE WIDGET-POOL.

/* Preprocessors Definitions ---                                      */
&GLOBAL-DEFINE Program        ESCSP004
...
&GLOBAL-DEFINE page2Widgets   fi-cod-estabel-ini fi-cod-estabel-fim fi-it-codigo-ini fi-it-codigo-fim 
...
DEFINE VARIABLE fi-it-codigo-fim AS CHARACTER FORMAT "X(20)":U INITIAL "ZZZZZZZZZZZZZZZZZZZZ" 
     VIEW-AS FILL-IN 
...
DEFINE FRAME fPage2
     fi-cod-estabel-ini AT ROW 2.58 COL 11.57
     fi-cod-estabel-fim AT ROW 2.58 COL 49.57 NO-LABEL
     fi-it-codigo-ini AT ROW 3.67 COL 21.57 COLON-ALIGNED HELP
          "Item Inicial" WIDGET-ID 38
     fi-it-codigo-fim AT ROW 3.67 COL 47.57 COLON-ALIGNED HELP
          "Item Final" NO-LABEL WIDGET-ID 44
     IMAGE-1 AT ROW 2.58 COL 42.29
     IMAGE-2 AT ROW 2.58 COL 46.29
     IMAGE-13 AT ROW 3.67 COL 42.29 WIDGET-ID 40
     IMAGE-14 AT ROW 3.67 COL 46.29 WIDGET-ID 42
    WITH 1 DOWN KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 3.57 ROW 2.79
         SIZE 84.43 BY 11.21
...
do on error undo, return error on stop  undo, return error:
    ...
    {report/rprun.i esp/csp/escsp004rp.p}
