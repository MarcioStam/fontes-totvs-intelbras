...
*******************************************************************************/
{include/i-prgvrs.i ESCSP012 1.00.00.000}
...
&GLOBAL-DEFINE Program        ESCSP012
...
&GLOBAL-DEFINE page0Widgets   btOk ~
                              btCancel ~
                              btHelp2
&GLOBAL-DEFINE page4Widgets   fi-data btInputFile
&GLOBAL-DEFINE page6Widgets   rsDestiny ~
                              btConfigImpr ~
                              btFile ~
                              rsExecution
&GLOBAL-DEFINE page0Text      
&GLOBAL-DEFINE page4Text      text-entrada text-layout ed-layout
...
{esp/csp/escsp012.i} /* tt-param ; tt-digita */
...
DEFINE VARIABLE ed-layout AS CHARACTER INITIAL "Ordem~;Tempo(Decimal)~;Grupo de M†quina" 
     VIEW-AS EDITOR
     SIZE 44 BY 3 NO-UNDO.

DEFINE VARIABLE fi-data AS DATE FORMAT "99/99/9999":U INITIAL ? 
...
DEFINE VARIABLE text-layout AS CHARACTER FORMAT "X(256)":U INITIAL "Layout do Arquivo CSV" 
      VIEW-AS TEXT 
     SIZE 17 BY .63
     FONT 1 NO-UNDO.
...
DEFINE FRAME fPage4
     fi-data AT ROW 1.5 COL 38 COLON-ALIGNED WIDGET-ID 8
     btInputFile AT ROW 4.25 COL 61.14 HELP
          "Escolha do nome do arquivo"
     cInputFile AT ROW 4.29 COL 21.14 HELP
          "Nome do arquivo de destino do relat¢rio" NO-LABEL
     ed-layout AT ROW 7 COL 21 NO-LABEL WIDGET-ID 2
     text-entrada AT ROW 3.25 COL 22.14 NO-LABEL
     text-layout AT ROW 6 COL 22 NO-LABEL WIDGET-ID 6
     RECT-12 AT ROW 3.5 COL 20
     RECT-13 AT ROW 6.25 COL 20 WIDGET-ID 4
...
/* SETTINGS FOR FILL-IN text-layout IN FRAME fPage4
   NO-DISPLAY NO-ENABLE ALIGN-L                                         */
ASSIGN 
       text-layout:PRIVATE-DATA IN FRAME fPage4     = 
                "Layout".
...
do on error undo, return error on stop  undo, return error:
    ...
    assign tt-param.usuario         = c-seg-usuario
           ...
           tt-param.data-movto      = INPUT FRAME fPage4 fi-data
    ...
    {report/rprun.i esp/csp/escsp012rp.p}
