...
*******************************************************************************/
{include/i-prgvrs.i ESCSP011 2.00.00.000}

CREATE WIDGET-POOL.

/* Preprocessors Definitions ---                                      */
&GLOBAL-DEFINE Program        ESCSP011
...
DEFINE VARIABLE edit AS CHARACTER 
     VIEW-AS EDITOR MAX-CHARS 255
     SIZE 39 BY 2.75 NO-UNDO.
...
DEFINE FRAME fPage4
     edit AT ROW 2.5 COL 6 NO-LABEL WIDGET-ID 6
     ...
     "Layout Arquivo .CSV" VIEW-AS TEXT
          SIZE 16 BY .54 AT ROW 1.5 COL 4.14
     RECT-12 AT ROW 9 COL 2
     RECT-13 AT ROW 1.75 COL 2 WIDGET-ID 2
...
/* SETTINGS FOR FRAME fPage4
                                                                        */
/* SETTINGS FOR EDITOR edit IN FRAME fPage4
   NO-ENABLE                                                            */
...
ASSIGN edit:SCREEN-VALUE IN FRAME fPage4 = "Centro de Custo ; Conta ; Estab ; Valor" + CHR(10) + CHR(10) + "
OBS.: Verificar se ao gerar o arquivo .CSV o Centro de Custo ainda cont‚m os zeros na frente dos n£meros.".
...
do on error undo, return error on stop  undo, return error:
    ...
    {report/rprun.i esp/csp/escsp011rp.p}
