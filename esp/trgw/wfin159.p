/********************************************************************************
 ** UPC........: wfin829.p - UPC TRIGGER WRITE aloc_bem
 ** Data.......: Novembro / 2020
 ** Objetivo...: Cria‡Æo Hist¢rico de altera‡Æo da aloca‡Æo de bens.
 ********************************************************************************/

DEF PARAM BUFFER b_aloc_bem      FOR aloc_bem.
DEF PARAM BUFFER b_old_aloc_bem  FOR aloc_bem.
...
IF  NEW b_aloc_bem THEN DO:
    ...
    ASSIGN tab_espec_financ.cod_modul_dtsul    = "FAS"
           ...
           tab_espec_financ.ind_event          = "NEW"
           ...
           tab_espec_financ.des_histor_tab     = "Centro de Custo: " + b_aloc_bem.cod_ccusto             +
                                                 ...
                                                 " Perc Aloc: "      + STRING(b_aloc_bem.val_perc_aprop) +
                                                 " Programas: "      + fn-monta-origem()
           tab_espec_financ.cod_usuario        = v_cod_usuar_corren
           tab_espec_financ.ind_tip_alter      = "Criado"
