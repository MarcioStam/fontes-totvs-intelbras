TRIGGER PROCEDURE FOR WRITE OF cc_uni_estab.

/********************************************************************************
 ** UPC........: wes487.p - UPC WRITE cc_uni_estab    
 ** Data.......: Maio / 2009
 ** Objetivo...: Grava centro custo ems2
 ********************************************************************************/
    ...
    FOR FIRST emscad.ccusto NO-LOCK
        ...
        THEN DO:
            ...
            ASSIGN tt-integra-ccusto.c-cod-estab  = c-estabelec
                   ...
                   tt-integra-ccusto.c-ind-movto  = "I".
