...
&Scoped-define INTERNAL-TABLES es-agente emitente

/* Define KEY-PHRASE in case it is used by any query. */
&Scoped-define KEY-PHRASE TRUE

/* Definitions for BROWSE br-table                                      */
&Scoped-define FIELDS-IN-QUERY-br-table es-agente.cod-agente emitente.nome-emit   
&Scoped-define ENABLED-FIELDS-IN-QUERY-br-table   
&Scoped-define SELF-NAME br-table
&Scoped-define QUERY-STRING-br-table FOR EACH es-agente NO-LOCK       WHERE es-agente.cod-agente >= i-inicial         AND es-agente.cod-agente <= i-final, ~
              EACH emitente NO-LOCK       WHERE emitente.cod-emitente = es-agente.cod-agente     ~{&SORTBY-PHRASE} INDEXED-REPOSITION
&Scoped-define OPEN-QUERY-br-table OPEN QUERY {&SELF-NAME}    FOR EACH es-agente NO-LOCK       WHERE es-agente.cod-agente >= i-inicial         AND es-agente.cod-agente <= i-final, ~
              EACH emitente NO-LOCK       WHERE emitente.cod-emitente = es-agente.cod-agente     ~{&SORTBY-PHRASE} INDEXED-REPOSITION.
&Scoped-define TABLES-IN-QUERY-br-table es-agente emitente
&Scoped-define FIRST-TABLE-IN-QUERY-br-table es-agente
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br-table B-table-Win _FREEFORM
  QUERY br-table NO-LOCK DISPLAY
      es-agente.cod-agente FORMAT ">>>,>>>,>>9":U
      emitente.nome-emit
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
...
OPEN QUERY {&SELF-NAME}
   FOR EACH es-agente NO-LOCK
      WHERE es-agente.cod-agente >= i-inicial
        AND es-agente.cod-agente <= i-final,
       EACH emitente NO-LOCK
      WHERE emitente.cod-emitente = es-agente.cod-agente
