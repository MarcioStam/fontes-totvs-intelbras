...
THEN DO:
    FIND int-evento-monitorado NO-LOCK
        WHERE int-evento-monitorado.cod-evento = 8 /* Elimina‡Æo do item do pedido abaixo minimo */
