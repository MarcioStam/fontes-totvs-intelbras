...
*******************************************************************************/
{include/i-prgvrs.i ESSFC001A 2.04.00.001}
{include/i-license-manager.i ESSFC001A FGL}

CREATE WIDGET-POOL.

/* Preprocessors Definitions ---                                      */
&GLOBAL-DEFINE Program        ESSFC001A
...
&GLOBAL-DEFINE page0Widgets   btQueryJoins btReportsJoins btExit btHelp ~
                              btOK btCancel fidtreporte tg-procura-saldo tg-nao-imprimir fiPrinter btConfigImpr
                              
/**/ 
/* Parameters Definitions ---                                           */
DEFINE INPUT-OUTPUT PARAM pNomeImp     AS CHAR NO-UNDO.
DEFINE INPUT-OUTPUT PARAM pDtReporte   AS DATE NO-UNDO.
DEFINE INPUT-OUTPUT PARAM pNaoImprimir AS LOG  NO-UNDO.
DEFINE INPUT-OUTPUT PARAM pProcuraSaldo AS LOG  NO-UNDO.
...
DEF VAR cImpressora AS CHAR NO-UNDO.
...
btReportsJoins btExit btHelp tg-procura-saldo fiDtReporte btConfigImpr ~
fiPrinter tg-nao-imprimir btOK btCancel 
&Scoped-Define DISPLAYED-OBJECTS tg-procura-saldo fiDtReporte fiPrinter ~
tg-nao-imprimir 
...
DEFINE VARIABLE fiDtReporte AS DATE FORMAT "99/99/9999":U 
...
DEFINE VARIABLE tg-nao-imprimir AS LOGICAL INITIAL no 
     LABEL "NÆo Imprimir" 
     VIEW-AS TOGGLE-BOX
     SIZE 11.57 BY .83 NO-UNDO.

DEFINE VARIABLE tg-procura-saldo AS LOGICAL INITIAL no 
     LABEL "Procura Autom tica de Saldos?" 
     VIEW-AS TOGGLE-BOX
...
DEFINE FRAME fpage0
     ...
     btHelp AT ROW 1.13 COL 86.72 HELP
          "Ajuda"
     tg-procura-saldo AT ROW 2.96 COL 38.86 WIDGET-ID 30
     fiDtReporte AT ROW 3 COL 17 COLON-ALIGNED
     btConfigImpr AT ROW 4.08 COL 63.57 HELP
          "Configura‡Æo da impressora" WIDGET-ID 22
     fiPrinter AT ROW 4.25 COL 19 NO-LABEL WIDGET-ID 24 NO-TAB-STOP 
     tg-nao-imprimir AT ROW 5.5 COL 19 WIDGET-ID 28
     btOK AT ROW 6.96 COL 2
     btCancel AT ROW 6.96 COL 13
     "Impressora:" VIEW-AS TEXT
          SIZE 8 BY .63 AT ROW 4.33 COL 10.86 WIDGET-ID 26
          FONT 1
...
DO:
    ASSIGN pNomeImp      = INPUT FRAME fPage0 fiPrinter
           pDtReporte    = INPUT FRAME fPage0 fiDtReporte
           pNaoImprimir  = INPUT FRAME fpage0 tg-nao-imprimir
           pProcuraSaldo = INPUT FRAME fpage0 tg-procura-saldo.
...
------------------------------------------------------------------------------*/
    ...
    END.
    ASSIGN fiDtReporte:SCREEN-VALUE IN FRAME fPage0 = string(TODAY)
           tg-nao-imprimir:CHECKED IN FRAME fPage0  = pNaoImprimir
           tg-procura-saldo:CHECKED IN FRAME fPage0 = pProcuraSaldo.
