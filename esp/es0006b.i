...
procedure html-tit-tab.
    ...
    {&OUT} "<TR><TD ALIGN= " c-alin " > " c-titulo "</TD></TR></TABLE>"     skip.

end.

procedure html-ini-tab.
    {&OUT} "<TABLE BORDER ALIGN = CENTER " "BGCOLOR = " "#FFFFFF"                 ~    " WIDTH= " c-tam-tab " >" skip .
end.
...
procedure html-tot-tab.
    ...
    {&OUT} "<TD COLSPAN=" c-col " ALIGN= " '"left"' ">" 
        c-titulo "</TD> " skip
...
procedure html-con-tab-colspan.
    ...
    def input parameter c-alin as char.
    def input parameter c-col as char.
    {&OUT} "<TD COLSPAN=" c-col " ALIGN=" '"' + c-alin + '"' ">" c-con  "</TD>" skip . 
end.
...
procedure html-con-tab-cor.
    ...
    def input parameter c-alin as char.
    DEF INPUT PARAMETER c-cor AS CHAR.
    {&OUT} "<TD class=" + '"cor' + c-cor + '"' +  " ALIGN=" '"' + c-alin + '"' ">" c-con  "</TD>" skip . 
end.
...
procedure html-con-w-tab-cor.
    ...
    def input parameter c-width as char.
    DEF INPUT PARAMETER c-cor AS CHAR.
    {&OUT} "<TD class=" + '"cor' + c-cor + '"' +  " ALIGN=" '"'  c-alin + '"' 
            " WIDTH=" '"'  c-width  '"' 
            ">" c-con "</TD>" skip. 
end.
...
procedure html-manda-mail.
    ...
    do html-i-cont = 1 to 10:
        {&OUT} c-texto-html[html-i-cont] skip.
    end.
