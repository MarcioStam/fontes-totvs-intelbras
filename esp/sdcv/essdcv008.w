...
*******************************************************************************/
{include/i-prgvrs.i ESSDCV008 2.06.00.000}
/*------------------------------------------------------------------------
    File        : ESSDCV008.W
    Purpose     : Exportar Cotaá∆o por data para o OutBuyCenter (SDCV).
    Syntax      : <none>
    Description : <none>
----------------------------------------------------------------------*/
...
&IF "{&EMSFND_VERSION}" >= "1.00" &THEN
    {include/i-license-manager.i ESSDCV008 ESP}
&ENDIF
...
&GLOBAL-DEFINE Program        ESSDCV008
...
&GLOBAL-DEFINE page2Widgets   fiCotacaoInicial fiCotacaoFinal
...
DEFINE VARIABLE fiCotacaoFinal AS DATE FORMAT "99/99/9999":U 
     VIEW-AS FILL-IN 
     SIZE 12 BY .88 NO-UNDO.

DEFINE VARIABLE fiCotacaoInicial AS DATE FORMAT "99/99/9999":U 
     LABEL "Data Cotaá∆o" 
     VIEW-AS FILL-IN 
     SIZE 12 BY .88 NO-UNDO.
...
DEFINE FRAME fPage2
     fiCotacaoInicial AT ROW 3.5 COL 21 COLON-ALIGNED HELP
          "Per°odo Inicial (Exportaá∆o Cotaá∆o da Moeda)"
     fiCotacaoFinal AT ROW 3.5 COL 42.72 COLON-ALIGNED HELP
          "Per°odo Final (Exportaá∆o Cotaá∆o da Moeda)" NO-LABEL
     "Exporta as Cotaá‰es das Moedas para os dias selecionados" VIEW-AS TEXT
          SIZE 49 BY 1.25 AT ROW 1.63 COL 13.14 WIDGET-ID 6
     IMAGE-1 AT ROW 3.5 COL 35.43
     IMAGE-2 AT ROW 3.5 COL 41.29
    WITH 1 DOWN KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 3.57 ROW 2.81
         SIZE 84.43 BY 10.15
...
{report/mainblock.i}
    ...
    ASSIGN fiCotacaoInicial:SCREEN-VALUE IN FRAME fPage2 = STRING(TODAY - 1)
           fiCotacaoFinal:SCREEN-VALUE   IN FRAME fPage2 = STRING(TODAY - 1).
...
------------------------------------------------------------------------------*/
    ...
    DO ON ERROR UNDO, RETURN ERROR
       ON STOP  UNDO, RETURN ERROR:
        ...
        ASSIGN tt-param.c-cotacao-inicial      = INPUT FRAME fPage2 fiCotacaoInicial
        ...
        {report/rprun.i esp/sdcv/essdcv008rp.p}
