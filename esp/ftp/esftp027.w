...
*******************************************************************************/
{include/i-prgvrs.i ESFTP027 2.04.00.001}

CREATE WIDGET-POOL.

/* Preprocessors Definitions ---                                      */
&GLOBAL-DEFINE Program        ESFTP027
...
&GLOBAL-DEFINE page2Widgets   fi-fim-cod-mov fi-fim-cod-rep fi-fim-dt-movto ~
                              fi-ini-cod-mov fi-ini-cod-rep fi-ini-dt-movto
...
DEFINE VARIABLE fi-fim-cod-mov AS INTEGER FORMAT ">>9" INITIAL 999 
     VIEW-AS FILL-IN 
...
DEFINE VARIABLE fi-fim-dt-movto AS DATE FORMAT "99/99/9999" INITIAL 12/31/9999 
     VIEW-AS FILL-IN 
     SIZE 14 BY .88 NO-UNDO.

DEFINE VARIABLE fi-ini-cod-mov AS INTEGER FORMAT ">>9" INITIAL 0 
...
DEFINE VARIABLE fi-ini-dt-movto AS DATE FORMAT "99/99/9999" INITIAL 11/01/03 
     LABEL "Data" 
     VIEW-AS FILL-IN 
     SIZE 14 BY .88 NO-UNDO.
...
DEFINE FRAME fPage2
     fi-ini-dt-movto AT ROW 1.5 COL 35 RIGHT-ALIGNED
     fi-fim-dt-movto AT ROW 1.5 COL 54.14 NO-LABEL
     fi-ini-cod-rep AT ROW 2.5 COL 20 COLON-ALIGNED
     fi-fim-cod-rep AT ROW 2.5 COL 54.14 NO-LABEL
     fi-ini-cod-mov AT ROW 3.5 COL 20 COLON-ALIGNED
     fi-fim-cod-mov AT ROW 3.5 COL 54.14 NO-LABEL
     IMAGE-1 AT ROW 1.5 COL 35.86
     IMAGE-2 AT ROW 1.5 COL 51.14
     IMAGE-9 AT ROW 2.5 COL 35.86
     IMAGE-10 AT ROW 2.5 COL 51.14
     IMAGE-11 AT ROW 3.5 COL 35.86
     IMAGE-12 AT ROW 3.5 COL 51.14
...
/* SETTINGS FOR FRAME fPage2
                                                                        */
/* SETTINGS FOR FILL-IN fi-fim-cod-mov IN FRAME fPage2
   ALIGN-L                                                              */
/* SETTINGS FOR FILL-IN fi-fim-cod-rep IN FRAME fPage2
   ALIGN-L                                                              */
/* SETTINGS FOR FILL-IN fi-fim-dt-movto IN FRAME fPage2
   ALIGN-L                                                              */
/* SETTINGS FOR FILL-IN fi-ini-dt-movto IN FRAME fPage2
   ALIGN-R                                                              */
...
do on error undo, return error on stop  undo, return error:
    ...
    */
    ...
    assign tt-param.usuario         = c-seg-usuario
           ...
           tt-param.dt-ini          = input frame fPage2 fi-ini-dt-movto
           tt-param.dt-fim          = input frame fPage2 fi-fim-dt-movto
           tt-param.cod-rep-ini     = input frame fPage2 fi-ini-cod-rep
           tt-param.cod-rep-fim     = input frame fPage2 fi-fim-cod-rep
           tt-param.cod-mov-ini     = input frame fPage2 fi-ini-cod-mov
           tt-param.cod-mov-fim     = input frame fPage2 fi-fim-cod-mov
    ...
    {report/rprun.i esp/ftp/esftp027rp.p}
