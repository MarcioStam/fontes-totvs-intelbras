...
&Scoped-Define ENABLED-FIELDS int-param-comis.periodo-mes ~
...
&Scoped-define ADM-CREATE-FIELDS int-param-comis.dt-periodo-ini ~
...
DEFINE FRAME f-main
     int-param-comis.periodo-mes AT ROW 1.21 COL 23 COLON-ALIGNED WIDGET-ID 14
          LABEL "Per¡odo"
          VIEW-AS FILL-IN 
          SIZE 3 BY .88
     int-param-comis.periodo-ano AT ROW 1.21 COL 27.14 COLON-ALIGNED NO-LABEL WIDGET-ID 16
          VIEW-AS FILL-IN 
          SIZE 6 BY .88
     int-param-comis.dt-periodo-ini AT ROW 2.67 COL 23 COLON-ALIGNED WIDGET-ID 22
          VIEW-AS FILL-IN 
          SIZE 12.57 BY .88
     int-param-comis.dt-periodo-fim AT ROW 2.67 COL 36 COLON-ALIGNED NO-LABEL WIDGET-ID 20
          VIEW-AS FILL-IN 
          SIZE 13 BY .88
     int-param-comis.idi-status AT ROW 3.67 COL 23 COLON-ALIGNED WIDGET-ID 12
          ...
          SIZE 26 BY .88
     "/" VIEW-AS TEXT
          SIZE 1 BY .54 AT ROW 1.38 COL 28.14 WIDGET-ID 18
...
/*------------------------------------------------------------------------------
  ...
  Notes:       
------------------------------------------------------------------------------*/
 IF int-param-comis.idi-status > 1 THEN DO:
    RUN utp/ut-msgs.p (INPUT "show",
                       INPUT 17006,
                       INPUT "NÆo ‚ permitido exclusÆo de parƒmetros com status diferente de iniciado.").

    RETURN "adm-error".
END.
                                                        
FOR EACH int-execsuperv-calc OF int-param-comis EXCLUSIVE-LOCK:
    DELETE int-execsuperv-calc.
END.
/* Dispatch standard ADM method.                             */
