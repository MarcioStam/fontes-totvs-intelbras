...
&GLOBAL-DEFINE Program        esftp073
...
&GLOBAL-DEFINE page0KeyFields   tt-int-nota-conhec.cod-estabel tt-int-nota-conhec.serie  tt-int-nota-conhec.nr-nota-fis tt-int-nota-conhec.nr-volume
&GLOBAL-DEFINE page0Fields      
&GLOBAL-DEFINE page1Fields      tt-int-nota-conhec.nr-conhec tt-int-nota-conhec.xml-enviado 
...
btSave btReportsJoins btExit btHelp btQueryJoins 
...
DEFINE FRAME fpage0
     ...
     btHelp AT ROW 1.13 COL 86.72 HELP
          "Ajuda"
     tt-int-nota-conhec.cod-estabel AT ROW 3.25 COL 28 COLON-ALIGNED WIDGET-ID 2
          VIEW-AS FILL-IN 
          SIZE 6 BY .79
     btQueryJoins AT ROW 3.75 COL 55 HELP
          "Rastreamento de Objeto"
     tt-int-nota-conhec.serie AT ROW 4.25 COL 28 COLON-ALIGNED WIDGET-ID 4
          VIEW-AS FILL-IN 
          SIZE 6 BY .79
     tt-int-nota-conhec.nr-nota-fis AT ROW 5.25 COL 28 COLON-ALIGNED WIDGET-ID 6
          VIEW-AS FILL-IN 
          SIZE 12 BY .79
     tt-int-nota-conhec.nr-volume AT ROW 6.25 COL 28 COLON-ALIGNED WIDGET-ID 8
          VIEW-AS FILL-IN 
          SIZE 8.86 BY .79
...
DEFINE FRAME fPage1
     tt-int-nota-conhec.nr-conhec AT ROW 2.25 COL 25 COLON-ALIGNED WIDGET-ID 8
          VIEW-AS FILL-IN 
          SIZE 20 BY .79
     tt-int-nota-conhec.xml-enviado AT ROW 3.25 COL 27 WIDGET-ID 12
          VIEW-AS TOGGLE-BOX
          SIZE 23 BY .83
...
OR CHOOSE OF MENU-ITEM miQueryJoins IN MENU mbMain DO:
  ...
  CREATE "InternetExplorer.Application.1" chWeb.
   ...
   //chWebAppl:Navigate("http://websro.correios.com.br/sro_bin/txect01$.QueryList?P_LINGUA=001&P_TIPO=001&P_COD_UNI=" + tt-int-nota-conhec.nr-conhec  ).
   chWebAppl:Navigate("https://correiosrastrear.com/" + tt-int-nota-conhec.nr-conhec  ).
END.
...
------------------------------------------------------------------------------*/
    ...
    DEFINE FRAME fGoToRecord
        ...
        i-nr-volume       AT ROW 4.21 COL 17.72 COLON-ALIGNED VIEW-AS FILL-IN SIZE 6   BY .88
