define temp-table tt-param no-undo
    ...
    FIELD tb-embarque      AS LOGICAL
    FIELD tb-notas         AS LOGICAL
    FIELD tb-notas-sem-data-saida         AS LOGICAL
    FIELD cod-atendente-ini AS INTEGER
    FIELD cod-atendente-fim AS INTEGER.
