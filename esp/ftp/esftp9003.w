...
//PROGRAMA DESCONTINUADO, PASSOU A SER USADO O ESFTP9006
...
*******************************************************************************/
{include/i-prgvrs.i ESFTP9003 2.00.00.000}
...
&Scoped-Define ENABLED-OBJECTS rt-button RECT-1 RECT-3 EDITOR-1 d-date ~
bt-ok bt-cancela bt-ajuda 
&Scoped-Define DISPLAYED-OBJECTS EDITOR-1 d-date 
...
DEFINE VARIABLE d-date AS DATE FORMAT "99/99/9999":U INITIAL 01/01/001 
     LABEL "Data" 
     VIEW-AS FILL-IN 
...
DEFINE FRAME f-cad
     EDITOR-1 AT ROW 2.17 COL 5.86 NO-LABEL WIDGET-ID 6
     d-date AT ROW 6.88 COL 4.86 COLON-ALIGNED WIDGET-ID 8
     bt-ok AT ROW 8.96 COL 2.14
     bt-cancela AT ROW 8.96 COL 13.14
     bt-imprime AT ROW 8.96 COL 24.14
     bt-ajuda AT ROW 8.96 COL 44.57
     rt-button AT ROW 8.75 COL 1.43
     RECT-1 AT ROW 1.21 COL 1.57 WIDGET-ID 2
     RECT-3 AT ROW 6 COL 1.57 WIDGET-ID 12
...
DO:
    ...
    IF AVAILABLE tt-prog-ponto               AND
        tt-prog-ponto.conteudo <> "TESTE":U THEN DO:
    ...
    OUTPUT TO c:\temp\atualiza.txt.
    FOR EACH nota-fiscal
        WHERE nota-fiscal.dt-emis-nota >= INPUT FRAME f-cad d-date 
    ...
    END.
    OUTPUT CLOSE.
    MESSAGE "ATUALIZAۂO EFETUADA " SKIP
            "****************************************"
            "***   SAIA DO EMS E ENTRE NOVAMENTE  ***" SKIP
    
    
        VIEW-AS ALERT-BOX INFO BUTTONS OK.
    DOS SILENT notepad c:\temp\atualiza.txt.
END.
...
------------------------------------------------------------------------------*/
  DISPLAY EDITOR-1 d-date 
      WITH FRAME f-cad IN WINDOW w-cadsim.
  ENABLE rt-button RECT-1 RECT-3 EDITOR-1 d-date bt-ok bt-cancela bt-ajuda 
      WITH FRAME f-cad IN WINDOW w-cadsim.
...
------------------------------------------------------------------------------*/
  ...
  {utp/ut9000.i "esftp9003" "2.00.00.000"}
