...
*******************************************************************************/
{include/i-prgvrs.i esftp119 2.00.00.000}
...
DEFINE VARIABLE cod-estab-fim AS CHARACTER FORMAT "X(5)":U INITIAL "ZZZZZ" 
     VIEW-AS FILL-IN 
...
DEFINE VARIABLE nr-nota-fis-fim AS CHARACTER FORMAT "X(16)":U INITIAL "ZZZZZZZZZZZZZZZZ" 
     VIEW-AS FILL-IN 
...
DEFINE VARIABLE tg-tributos AS LOGICAL INITIAL no 
     LABEL "Imprime Tributos" 
     VIEW-AS TOGGLE-BOX
...
DEFINE FRAME f-pg-sel
     cod-estab-ini AT ROW 1.25 COL 23.86 COLON-ALIGNED
     cod-estab-fim AT ROW 1.25 COL 48.14 COLON-ALIGNED NO-LABEL
     serie-ini AT ROW 2.25 COL 23.86 COLON-ALIGNED WIDGET-ID 4
     serie-fim AT ROW 2.25 COL 48.14 COLON-ALIGNED NO-LABEL WIDGET-ID 2
     nr-nota-fis-ini AT ROW 3.25 COL 12.86 COLON-ALIGNED WIDGET-ID 16
     nr-nota-fis-fim AT ROW 3.25 COL 48.14 COLON-ALIGNED NO-LABEL WIDGET-ID 14
     tg-email AT ROW 4.54 COL 15.14 WIDGET-ID 18
     tg-tributos AT ROW 5.5 COL 15 WIDGET-ID 20
     ...
     IMAGE-5 AT ROW 3.25 COL 31.86 WIDGET-ID 10
     IMAGE-6 AT ROW 3.25 COL 47.29 WIDGET-ID 12
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 3 ROW 2.85
         SIZE 76.86 BY 10.62
...
{utp/ut9000.i "esftp119" "2.00.00.000"}
...
------------------------------------------------------------------------------*/
  ...
  DISPLAY cod-estab-ini cod-estab-fim serie-ini serie-fim nr-nota-fis-ini 
          nr-nota-fis-fim tg-email tg-tributos 
      WITH FRAME f-pg-sel IN WINDOW w-relat.
  ENABLE IMAGE-1 IMAGE-2 IMAGE-3 IMAGE-4 IMAGE-5 IMAGE-6 cod-estab-ini 
         cod-estab-fim serie-ini serie-fim nr-nota-fis-ini nr-nota-fis-fim 
         tg-email tg-tributos 
      WITH FRAME f-pg-sel IN WINDOW w-relat.
...
do on error undo, return error on stop  undo, return error:
    ...
    assign tt-param.usuario         = c-seg-usuario
           ...
           tt-param.cod-estab-ini   = input frame f-pg-sel cod-estab-ini  
           ...
           tt-param.l-envia-email   = INPUT FRAME f-pg-sel tg-email
           tt-param.l-imprime-trib  = INPUT FRAME f-pg-sel tg-tributos.
    ...
    {include/i-rprun.i esp/ftp/esftp119rp.p}
