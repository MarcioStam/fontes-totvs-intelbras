...
*******************************************************************************/
{include/i-prgvrs.i esftp062 1.12.00.001}
...
&IF "{&EMSFND_VERSION}" >= "1.00" &THEN
    {include/i-license-manager.i esftp062 mft}
&ENDIF

CREATE WIDGET-POOL.

/* Preprocessors Definitions ---                                      */
&GLOBAL-DEFINE Program        esftp062
...
&GLOBAL-DEFINE page2Fields    dtDataIni dtDataFim
...
ASSIGN dtDataIni:SCREEN-VALUE IN FRAME fPage2 = STRING(TODAY - 365)
       dtDataFim:SCREEN-VALUE IN FRAME fPage2 = STRING(TODAY).
END PROCEDURE.
...
do on error undo, return error on stop  undo, return error:
    ...
    {report/rprun.i esp/ftp/esftp062rp.p}
