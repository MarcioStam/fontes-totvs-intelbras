...
*******************************************************************************/
{include/i-prgvrs.i ESFTP126 2.00.00.000}
...
&GLOBAL-DEFINE Program        ESFTP126
...
DEFINE VARIABLE c-data-ini AS DATE FORMAT "99/99/9999":U INITIAL 01/01/2020 
     LABEL "Data" 
     VIEW-AS FILL-IN 
     SIZE 10 BY .88
     FONT 1 NO-UNDO.
...
DEFINE FRAME fPage3
     rs-classif AT ROW 2.75 COL 27 NO-LABEL WIDGET-ID 8
     RECT-14 AT ROW 2 COL 1 WIDGET-ID 12
...
do on error undo, return error on stop  undo, return error:
    ...
    {report/rprun.i esp/ftp/esftp126rp.p}
