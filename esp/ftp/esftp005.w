...
&GLOBAL-DEFINE Program        ESFTP005
...
&GLOBAL-DEFINE page2Fields    fiCodEmitenteIni fiCodEmitenteFim fiNatOperacaoIni ~
                              fiNatOperacaoFim fiDtEmissaoIni fiDtEmissaoFim ~
                              fiEstadoIni fiEstadoFim 
...
DEFINE FRAME fPage2
     fiNatOperacaoIni AT ROW 2.5 COL 10.28 HELP
          "Natureza de opera‡Æo"
     fiNatOperacaoFim AT ROW 2.5 COL 47.43 HELP
          "Natureza de opera‡Æo" NO-LABEL
     fiCodEmitenteIni AT ROW 3.5 COL 17.57
     fiCodEmitenteFim AT ROW 3.5 COL 47.29 NO-LABEL
     fiDtEmissaoIni AT ROW 4.5 COL 13.85
     fiDtEmissaoFim AT ROW 4.5 COL 47.43 NO-LABEL
     fiEstadoIni AT ROW 5.5 COL 23.28 HELP
          "Unidade da federa‡Æo"
     fiEstadoFim AT ROW 5.5 COL 47.43 HELP
          "Unidade da federa‡Æo" NO-LABEL
     IMAGE-1 AT ROW 4.5 COL 37.43
     IMAGE-15 AT ROW 5.5 COL 37.43
     IMAGE-16 AT ROW 5.5 COL 43.43
     IMAGE-17 AT ROW 2.5 COL 37.43
     IMAGE-18 AT ROW 2.5 COL 43.43
     IMAGE-2 AT ROW 4.5 COL 43.43
     IMAGE-35 AT ROW 3.5 COL 37.43
     IMAGE-36 AT ROW 3.5 COL 43.43
...
/*------------------------------------------------------------------------------
  ...
  Notes:       
------------------------------------------------------------------------------*/
    ASSIGN fiDtEmissaoIni   = DATE(MONTH(TODAY),01,YEAR(TODAY))
           fiDtEmissaoFim   = DATE(MONTH(fiDtEmissaoIni + 40),01,YEAR(fiDtEmissaoIni + 40)) - 1
           fiCodEmitenteFim = 999999999
           fiEstadoFim      = "ZZ"
           fiNatOperacaoFim = "ZZZ".
...
do on error undo, return error on stop  undo, return error:
    ...
    DO WITH FRAME fPage2:
        ASSIGN tt-param.DtEmissaoIni    = INPUT fiDtEmissaoIni 
               ...
               tt-param.CodEmitenteIni  = INPUT fiCodEmitenteIni  
               tt-param.CodEmitenteFim  = INPUT fiCodEmitenteFim  
               tt-param.UfIni           = INPUT fiEstadoIni 
               tt-param.UfFim           = INPUT fiEstadoFim 
    ...
    {report/rprun.i esp/ftp/esftp005rp.p}
