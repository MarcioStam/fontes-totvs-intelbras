...
*******************************************************************************/
{include/i-prgvrs.i Z01ESFTP205 2.00.00.000}
...
DEFINE VARIABLE h_z01esftp205-b01 AS HANDLE NO-UNDO.
DEFINE VARIABLE h_z01esftp205-b02 AS HANDLE NO-UNDO.
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'FOLDER-LABELS = ':U + 'Per¡odo|Executivo' + ',
                     FOLDER-TAB-TYPE = 1':U ,
             OUTPUT h_folder ).
    ...
    WHEN 1 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'esp/ftp/z01esftp205-b01.w':U ,
             INPUT  FRAME f-zoom:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_z01esftp205-b01 ).
       RUN set-position IN h_z01esftp205-b01 ( 2.75 , 5.00 ) NO-ERROR.
       /* Size in UIB:  ( 10.17 , 80.14 ) */

       /* Links to SmartBrowser h_z01esftp205-b01. */
       RUN add-link IN adm-broker-hdl ( h_z01esftp205-b01 , 'State':U , THIS-PROCEDURE ).

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_z01esftp205-b01 ,
             h_folder , 'AFTER':U ).
    END. /* Page 1 */
    WHEN 2 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'esp/ftp/z01esftp205-b02.w':U ,
             INPUT  FRAME f-zoom:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_z01esftp205-b02 ).
       RUN set-position IN h_z01esftp205-b02 ( 2.75 , 5.00 ) NO-ERROR.
       /* Size in UIB:  ( 10.17 , 80.14 ) */

       /* Links to SmartBrowser h_z01esftp205-b02. */
       RUN add-link IN adm-broker-hdl ( h_z01esftp205-b02 , 'State':U , THIS-PROCEDURE ).

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_z01esftp205-b02 ,
             h_folder , 'AFTER':U ).
    END. /* Page 2 */
...
------------------------------------------------------------------------------*/
  ...
  {utp/ut9000.i "Z01ESFTP205" "2.00.00.000"}
