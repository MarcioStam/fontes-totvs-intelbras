...
&Scoped-Define ENABLED-OBJECTS rt-button RECT-9 c-obs bt-ok bt-cancela ~
bt-imprime bt-ajuda 
&Scoped-Define DISPLAYED-OBJECTS c-obs 
...
DEFINE FRAME f-cad
     c-obs AT ROW 2.5 COL 5 NO-LABEL WIDGET-ID 8
     bt-ok AT ROW 12.21 COL 3
     bt-cancela AT ROW 12.21 COL 14
     bt-imprime AT ROW 12.21 COL 25
     bt-ajuda AT ROW 12.21 COL 69
     "Observa‡Æo Pedido" VIEW-AS TEXT
          SIZE 15 BY .67 AT ROW 1.25 COL 4 WIDGET-ID 6
     rt-button AT ROW 12 COL 2
     RECT-9 AT ROW 1.5 COL 2 WIDGET-ID 4
...
ASSIGN 
       c-obs:READ-ONLY IN FRAME f-cad        = TRUE.
...
------------------------------------------------------------------------------*/
  ...
  ENABLE rt-button RECT-9 c-obs bt-ok bt-cancela bt-imprime bt-ajuda 
      WITH FRAME f-cad IN WINDOW w-cadsim.
...
------------------------------------------------------------------------------*/
  ...
  {utp/ut9000.i "esftp211c" "2.00.00.000"}
  ...
  IF AVAIL ped-venda THEN
    ASSIGN c-obs:SCREEN-VALUE IN FRAME f-cad = string(ped-venda.observacoes).
