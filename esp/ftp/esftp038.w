...
*******************************************************************************/
{include/i-prgvrs.i ESFTP038 1.00.00.001}
...
&IF "{&EMSFND_VERSION}" >= "1.00" &THEN
    {include/i-license-manager.i ESFTP038 MFT}
&ENDIF
...
DEFINE VARIABLE h_esftp038-q01 AS HANDLE NO-UNDO.
DEFINE VARIABLE h_esftp038-v01 AS HANDLE NO-UNDO.
...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'esp/ftp/esftp038-v01.w':U ,
             INPUT  FRAME f-cad:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_esftp038-v01 ).
       RUN set-position IN h_esftp038-v01 ( 3.00 , 1.72 ) NO-ERROR.
       /* Size in UIB:  ( 2.75 , 88.57 ) */

       RUN init-object IN THIS-PROCEDURE (
             INPUT  'esp/ftp/esftp038-q01.w':U ,
             INPUT  FRAME f-cad:HANDLE ,
             INPUT  'ProgPesquisa = esp/ftp/esftp038-z01.w,
                     ProgVaPara = esp/ftp/esftp038-g01.w,
                     ProgIncMod = ,
                     Implantar = no':U ,
             OUTPUT h_esftp038-q01 ).
       RUN set-position IN h_esftp038-q01 ( 1.25 , 62.00 ) NO-ERROR.
       /* Size in UIB:  ( 1.63 , 7.72 ) */

       /* Links to SmartPanel h_p-exihel. */
       RUN add-link IN adm-broker-hdl ( h_p-cadsim , 'State':U , h_p-exihel ).

       /* Links to SmartViewer h_esftp038-v01. */
       RUN add-link IN adm-broker-hdl ( h_esftp038-q01 , 'Record':U , h_esftp038-v01 ).
       RUN add-link IN adm-broker-hdl ( h_p-cadsim , 'TableIO':U , h_esftp038-v01 ).

       /* Links to SmartQuery h_esftp038-q01. */
       RUN add-link IN adm-broker-hdl ( h_p-exihel , 'State':U , h_esftp038-q01 ).
       RUN add-link IN adm-broker-hdl ( h_p-navega , 'Navigation':U , h_esftp038-q01 ).
       RUN add-link IN adm-broker-hdl ( h_p-navega , 'State':U , h_esftp038-q01 ).
       ...
       RUN adjust-tab-order IN adm-broker-hdl ( h_p-exihel ,
             h_p-cadsim , 'AFTER':U ).
       RUN adjust-tab-order IN adm-broker-hdl ( h_esftp038-v01 ,
             h_p-exihel , 'AFTER':U ).
    END. /* Page 0 */
...
------------------------------------------------------------------------------*/
  ...
  {utp/ut9000.i "ESFTP038" "1.00.00.001"}
