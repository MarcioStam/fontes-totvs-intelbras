...
&Scoped-Define ENABLED-FIELDS int-simula-dev.narrativa 
...
&Scoped-Define DISPLAYED-FIELDS int-simula-dev.narrativa 
...
DEFINE FRAME f-main
     int-simula-dev.narrativa AT ROW 1.25 COL 2 NO-LABEL WIDGET-ID 4
