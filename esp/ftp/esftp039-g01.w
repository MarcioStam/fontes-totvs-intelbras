...
&Scoped-Define ENABLED-OBJECTS rt-button c_cod-usuario bt-ok bt-cancela ~
bt-ajuda 
&Scoped-Define DISPLAYED-OBJECTS c_cod-usuario 
...
DEFINE VARIABLE c_cod-usuario AS CHARACTER FORMAT "x(12)":U 
     LABEL "Usuario" 
     VIEW-AS FILL-IN 
...
DEFINE FRAME d-vapara
     c_cod-usuario AT ROW 1.83 COL 28.86 COLON-ALIGNED WIDGET-ID 2
    ...
    WITH VIEW-AS DIALOG-BOX KEEP-TAB-ORDER 
         ...
         FONT 4
         TITLE "V  Para Usuario - Lib Item Fat"
...
ON GO OF FRAME d-vapara /* V  Para Usuario - Lib Item Fat */
DO:
FIND usu-lib-item-fat NO-LOCK
    WHERE usu-lib-item-fat.cod-usuario EQ INPUT FRAME {&FRAME-NAME} c_cod-usuario NO-ERROR.

IF NOT AVAILABLE usu-lib-item-fat THEN DO:
    {utp/ut-table.i mgesp usu-lib-item-fat 1}
    RUN utp/ut-msgs.p(INPUT "show",
                      INPUT 2,
                      INPUT RETURN-VALUE).
    RETURN NO-APPLY.
END.
ASSIGN p-row-tabela = ROWID(usu-lib-item-fat).
END.
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL d-vapara d-vapara
ON WINDOW-CLOSE OF FRAME d-vapara /* V  Para Usuario - Lib Item Fat */
DO:  
...
------------------------------------------------------------------------------*/
  DISPLAY c_cod-usuario 
      WITH FRAME d-vapara.
  ENABLE rt-button c_cod-usuario bt-ok bt-cancela bt-ajuda 
      WITH FRAME d-vapara.
  VIEW FRAME d-vapara.
