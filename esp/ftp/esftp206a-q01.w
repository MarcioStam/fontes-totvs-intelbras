...
&Scoped-define QUERY-STRING-Query-Main FOR EACH int-comissao-adc NO-LOCK
&Scoped-define OPEN-QUERY-Query-Main OPEN QUERY Query-Main FOR EACH int-comissao-adc NO-LOCK.
&Scoped-define TABLES-IN-QUERY-Query-Main int-comissao-adc
&Scoped-define FIRST-TABLE-IN-QUERY-Query-Main int-comissao-adc
...
/* Query rebuild information for QUERY Query-Main
     _TblList          = "mgesp.int-comissao-adc"
     _Options          = "NO-LOCK"
