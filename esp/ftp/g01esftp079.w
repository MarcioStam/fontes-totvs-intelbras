...
DEFINE FRAME d-vapara
     c_nat-operacao AT ROW 2 COL 23 COLON-ALIGNED WIDGET-ID 2
...
FIND natur-oper NO-LOCK
    WHERE natur-oper.nat-operacao EQ INPUT FRAME {&FRAME-NAME} c_nat-operacao NO-ERROR.

IF NOT AVAILABLE natur-oper THEN DO:
    {utp/ut-table.i mgcad natur-oper 1}
    RUN utp/ut-msgs.p(INPUT "show",
                      INPUT 2,
                      INPUT RETURN-VALUE).
    RETURN NO-APPLY.
END.
ASSIGN p-row-tabela = ROWID(natur-oper).
END.
...
------------------------------------------------------------------------------*/
  ...
  {utp/ut9000.i "g01esftp079" "2.00.00.000"}
