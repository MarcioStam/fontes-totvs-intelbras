...
*******************************************************************************/
{include/i-prgvrs.i ESFTP223 9.99.99.999}
...
&IF "{&EMSFND_VERSION}" >= "1.00" &THEN
    {include/i-license-manager.i ESFTP223 esp}
&ENDIF
...
DEFINE FRAME f-pg-sel
     ...
     tg-altera-data AT ROW 9 COL 23 WIDGET-ID 44
...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW w-relat ASSIGN
         HIDDEN             = YES
         TITLE              = "Faturamento APS - ESFTP223"
         HEIGHT             = 16.29
         WIDTH              = 83.29
         MAX-HEIGHT         = 27.88
         MAX-WIDTH          = 195.14
...
ON END-ERROR OF w-relat /* Faturamento APS - ESFTP223 */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL w-relat w-relat
ON WINDOW-CLOSE OF w-relat /* Faturamento APS - ESFTP223 */
DO:
...
{utp/ut9000.i "ESFTP223" "9.99.99.999"}
...
do on error undo, return error on stop  undo, return error:
   ...
   /*:T Coloque aqui as validaá‰es das outras p†ginas, lembrando que elas devem 
    ...
    {include/i-rprun.i esp/ftp/esftp223rp.p}
