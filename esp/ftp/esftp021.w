...
*******************************************************************************/
{include/i-prgvrs.i ESFTP021 1.00.00.000}

CREATE WIDGET-POOL.

/* Preprocessors Definitions ---                                      */
&GLOBAL-DEFINE Program        ESFTP021
...
&GLOBAL-DEFINE page2Fields    fiItem fiData fiperiodo 
...
DEFINE VARIABLE fiItem AS CHARACTER FORMAT "X(15)":U 
     LABEL "Item Imobilizado" 
     VIEW-AS FILL-IN 
     SIZE 15 BY .88
     FONT 1 NO-UNDO.

DEFINE VARIABLE fiperiodo AS CHARACTER FORMAT "99/9999":U INITIAL "000000" 
     LABEL "Periodo Faturamento" 
     VIEW-AS FILL-IN 
     SIZE 15 BY .88
     FONT 1 NO-UNDO.
...
DEFINE FRAME fPage2
     fiItem AT ROW 1.5 COL 22.43
     fidata AT ROW 2.5 COL 23.14
     fiperiodo AT ROW 3.5 COL 19.14 HELP
          "Para cr‚dito presumido, informe o periodo"
...
/* SETTINGS FOR FRAME fPage2
                                                                        */
/* SETTINGS FOR FILL-IN fidata IN FRAME fPage2
   ALIGN-L                                                              */
/* SETTINGS FOR FILL-IN fiItem IN FRAME fPage2
   ALIGN-L                                                              */
/* SETTINGS FOR FILL-IN fiperiodo IN FRAME fPage2
   ALIGN-L                                                              */
...
do on error undo, return error on stop  undo, return error:
    ...
    assign tt-param.usuario         = c-seg-usuario
           ...
           tt-param.c-it-codigo     = input frame fPage2 fiItem
           tt-param.da-data         = input frame fPage2 fiData
           tt-param.c-periodo       = IF INPUT FRAME fPage2 fiPeriodo = ? 
                                      OR INPUT FRAME fPage2 fiPeriodo = "000000" THEN "" 
                                                                                 ELSE INPUT FRAME fPage2 fiPeriodo
    ...
    {report/rprun.i esp/ftp/esftp021rp.p}
