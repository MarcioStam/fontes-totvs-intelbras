...
*******************************************************************************/
{include/i-prgvrs.i esftp052 2.04.00.001}

CREATE WIDGET-POOL.

/* Preprocessors Definitions ---                                      */
&GLOBAL-DEFINE Program        esftp052
...
&GLOBAL-DEFINE page2Fields    fiIniEstabel fiFimEstabel fiIniDtEmissao ~
                              fiFimDtEmissao de-saldo-credor
...
DEFINE VARIABLE de-saldo-credor AS DECIMAL FORMAT "->,>>>,>>>,>>>,>>9.99":U INITIAL 0 
     LABEL "Saldo Credor do Periodo Anterior" 
     VIEW-AS FILL-IN 
...
DEFINE FRAME fPage2
     ...
     fiFimEstabel AT ROW 2.75 COL 48 NO-LABEL
     fiIniDtEmissao AT ROW 3.75 COL 24 COLON-ALIGNED WIDGET-ID 14
     fiFimDtEmissao AT ROW 3.75 COL 46 COLON-ALIGNED NO-LABEL WIDGET-ID 16
     de-saldo-credor AT ROW 4.75 COL 24 COLON-ALIGNED WIDGET-ID 22
     IMAGE-1 AT ROW 2.75 COL 38
     IMAGE-2 AT ROW 2.75 COL 45
     IMAGE-5 AT ROW 3.75 COL 38 WIDGET-ID 18
     IMAGE-6 AT ROW 3.75 COL 45 WIDGET-ID 20
...
do on error undo, return error on stop  undo, return error:
    ...
    assign tt-param.usuario          = c-seg-usuario
           ...
           tt-param.valor-saldo-credor = INPUT FRAME fpage2 de-saldo-credor.
    ...
    {report/rprun.i esp/ftp/esftp052rp.p}
