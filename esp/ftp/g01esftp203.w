...
&Scoped-Define ENABLED-OBJECTS rt-button i_cod-supervisor bt-ok bt-cancela ~
bt-ajuda 
&Scoped-Define DISPLAYED-OBJECTS i_cod-supervisor 
...
DEFINE VARIABLE i_cod-supervisor AS INTEGER FORMAT ">>>>9":U INITIAL 0 
     LABEL "Supervisor" 
     VIEW-AS FILL-IN 
...
DEFINE FRAME d-vapara
     i_cod-supervisor AT ROW 2 COL 16 COLON-ALIGNED WIDGET-ID 2
     bt-ok AT ROW 4.5 COL 2.14
     bt-cancela AT ROW 4.5 COL 13
     bt-ajuda AT ROW 4.5 COL 34.43
...
DO:
FIND int-supervisor NO-LOCK
    WHERE int-supervisor.cod-supervisor EQ INPUT FRAME {&FRAME-NAME} i_cod-supervisor NO-ERROR.

IF NOT AVAILABLE int-supervisor THEN DO:
    {utp/ut-table.i mgesp int-supervisor 1}
    RUN utp/ut-msgs.p(INPUT "show",
                      INPUT 2,
                      INPUT RETURN-VALUE).
    RETURN NO-APPLY.
END.
ASSIGN p-row-tabela = ROWID(int-supervisor).
END.
...
------------------------------------------------------------------------------*/
  DISPLAY i_cod-supervisor 
      WITH FRAME d-vapara.
  ENABLE rt-button i_cod-supervisor bt-ok bt-cancela bt-ajuda 
      WITH FRAME d-vapara.
  VIEW FRAME d-vapara.
...
------------------------------------------------------------------------------*/
  ...
  {utp/ut9000.i "esftp203-g01" "2.00.00.000"}
