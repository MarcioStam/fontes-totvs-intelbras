...
*******************************************************************************/
{include/i-prgvrs.i esftp0528 2.00.00.000}
...
DEFINE FRAME f-pg-sel
     d-data-ini AT ROW 1.25 COL 15 COLON-ALIGNED WIDGET-ID 8
     d-data-fim AT ROW 1.25 COL 48.14 COLON-ALIGNED NO-LABEL WIDGET-ID 6
     IMAGE-1 AT ROW 1.25 COL 31.86 WIDGET-ID 10
     IMAGE-2 AT ROW 1.25 COL 47.29 WIDGET-ID 12
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 3 ROW 2.83
         SIZE 73.57 BY 10.63
...
{utp/ut9000.i "esftp0528" "2.00.00.000"}
...
DO  ON ERROR   UNDO MAIN-BLOCK, LEAVE MAIN-BLOCK
    ...
    ASSIGN d-data-ini:SCREEN-VALUE IN FRAME f-pg-sel = STRING(TODAY)
           d-data-fim:SCREEN-VALUE IN FRAME f-pg-sel = STRING(TODAY).
...
------------------------------------------------------------------------------*/
  ...
  DISPLAY d-data-ini d-data-fim 
      WITH FRAME f-pg-sel IN WINDOW w-relat.
  ENABLE IMAGE-1 IMAGE-2 d-data-ini d-data-fim 
      WITH FRAME f-pg-sel IN WINDOW w-relat.
...
do on error undo, return error on stop  undo, return error:
    ...
    {include/i-rprun.i esp/ftp/esftp0527rp.p}
