...
&Scoped-define QUERY-STRING-Query-Main FOR EACH int-meta-repres NO-LOCK
&Scoped-define OPEN-QUERY-Query-Main OPEN QUERY Query-Main FOR EACH int-meta-repres NO-LOCK.
&Scoped-define TABLES-IN-QUERY-Query-Main int-meta-repres
&Scoped-define FIRST-TABLE-IN-QUERY-Query-Main int-meta-repres
...
/* Query rebuild information for QUERY Query-Main
     _TblList          = "mgesp.int-meta-repres"
     _Options          = "NO-LOCK"
