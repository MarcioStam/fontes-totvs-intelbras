...
*******************************************************************************/
{include/i-prgvrs.i esftp202 2.00.00.000}
...
DEFINE VARIABLE i-cod-executivo-fim AS INTEGER FORMAT ">>>>9":U INITIAL 99999 
     VIEW-AS FILL-IN 
     SIZE 8.86 BY .88 NO-UNDO.
...
DEFINE FRAME f-pg-par
     ...
     i-cod-executivo-ini AT ROW 4 COL 9.29 COLON-ALIGNED WIDGET-ID 10
     i-cod-executivo-fim AT ROW 4 COL 26 COLON-ALIGNED NO-LABEL WIDGET-ID 12
     c-periodo-mes AT ROW 5 COL 9.29 COLON-ALIGNED WIDGET-ID 14
     c-periodo-ano AT ROW 5 COL 13.57 COLON-ALIGNED NO-LABEL WIDGET-ID 22
     ...
     "/" VIEW-AS TEXT
          SIZE 1 BY .54 AT ROW 5.13 COL 14.43 WIDGET-ID 20
...
DO:
    IF INPUT FRAME f-pg-par rs-import-excluir = 2 THEN DO:
        ASSIGN c-periodo-mes:SENSITIVE IN FRAME f-pg-par = YES
               c-periodo-ano:SENSITIVE IN FRAME f-pg-par = YES.
    END.
    ELSE DO:
        ASSIGN c-periodo-mes:SCREEN-VALUE IN FRAME f-pg-par = "0"
               c-periodo-ano:SCREEN-VALUE IN FRAME f-pg-par = "0".

        ASSIGN c-periodo-mes:SENSITIVE IN FRAME f-pg-par = NO
...
{utp/ut9000.i "esftp202" "2.00.00.000"}
...
DO  ON ERROR   UNDO MAIN-BLOCK, LEAVE MAIN-BLOCK
    ...
    {include/i-imvrf.i &programa=esftp202 &versao-layout=001}
...
do  on error undo, return error
    ...
    if file-info:pathname = ? and
       input frame f-pg-log rs-execucao = 1 
    AND input frame f-pg-par rs-import-excluir = 1 then do:
        run utp/ut-msgs.p (input "show":U,
                           input 326,
    ...
    {include/i-imrun.i esp/ftp/esftp202rp.p}
