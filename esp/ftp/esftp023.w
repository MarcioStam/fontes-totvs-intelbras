...
*******************************************************************************/
{include/i-prgvrs.i ESFTP023 2.04.00.000}

CREATE WIDGET-POOL.

/* Preprocessors Definitions ---                                      */
&GLOBAL-DEFINE Program        ESFTP023
...
&GLOBAL-DEFINE page2Fields    fi-cod-estab-ini fi-cod-estab-fim de-ali-1 de-ali-2 de-ali-3 de-ali-4 de-ali-5 de-ali-6 de-convenio-1 de-convenio-sc de-convenio-2a de-convenio-2b de-deposito de-perc-int dt-emiss-fim dt-emiss-ini de-pis-cofins tg-excel
...
DEFINE VARIABLE de-ali-1 AS DECIMAL FORMAT ">>9.99":U INITIAL 4.00 
     LABEL "Aliquota 1" 
     VIEW-AS FILL-IN 
     SIZE 8.86 BY .88 NO-UNDO.

DEFINE VARIABLE de-ali-2 AS DECIMAL FORMAT ">>9.99":U INITIAL 3.00 
     LABEL "Aliquota 2" 
     VIEW-AS FILL-IN 
     SIZE 8.86 BY .88 NO-UNDO.

DEFINE VARIABLE de-ali-3 AS DECIMAL FORMAT ">>9.99":U INITIAL 2.00 
     LABEL "Aliquota 3" 
     VIEW-AS FILL-IN 
     SIZE 8.86 BY .88 NO-UNDO.

DEFINE VARIABLE de-ali-4 AS DECIMAL FORMAT ">>9.99":U INITIAL 1.00 
     LABEL "Aliquota 4" 
     VIEW-AS FILL-IN 
     SIZE 8.86 BY .88 NO-UNDO.

DEFINE VARIABLE de-ali-5 AS DECIMAL FORMAT ">>9.99":U INITIAL 0.75 
     LABEL "Aliquota 5" 
     VIEW-AS FILL-IN 
     SIZE 8.86 BY .88 NO-UNDO.

DEFINE VARIABLE de-ali-6 AS DECIMAL FORMAT ">>9.99":U INITIAL 0.50 
     LABEL "Aliquota 6" 
     VIEW-AS FILL-IN 
     SIZE 8.86 BY .88 NO-UNDO.
...
DEFINE VARIABLE tg-excel AS LOGICAL INITIAL yes 
     LABEL "Gera em formato Excel?" 
     VIEW-AS TOGGLE-BOX
...
DEFINE FRAME fPage2
     ...
     de-ali-6 AT ROW 5.25 COL 46 COLON-ALIGNED WIDGET-ID 18
     ...
     tg-excel AT ROW 9.5 COL 48 WIDGET-ID 16
...
do on error undo, return error on stop  undo, return error:
    ...
    assign tt-param.usuario         = c-seg-usuario
           ...
           tt-param.de-ali-6        = INPUT FRAME fPage2 de-ali-6
           ...
           tt-param.excel           = input frame fpage2 tg-excel.
    ...
    {report/rprun.i esp/ftp/esftp023rp.p}
