...
*******************************************************************************/
{include/i-prgvrs.i esftp108 1.00.00.000}
...
&GLOBAL-DEFINE Program        esftp108
...
&Scoped-define INTERNAL-TABLES item-caixa embalag

/* Definitions for BROWSE brTable1                                      */
&Scoped-define FIELDS-IN-QUERY-brTable1 item-caixa.it-codigo ~
embalag.sigla-emb embalag.embalagem embalag.descricao item-caixa.qt-item ~
embalag.peso-embal embalag.altura embalag.largura embalag.comprim ~
embalag.volume 
&Scoped-define ENABLED-FIELDS-IN-QUERY-brTable1 
&Scoped-define QUERY-STRING-brTable1 FOR EACH item-caixa ~
      WHERE item-caixa.it-codigo >= fl-it-codigo-ini:screen-value in frame fPage2 ~
 AND item-caixa.it-codigo <= fl-it-codigo-fim:screen-value in frame fPage2 NO-LOCK, ~
      EACH embalag OF item-caixa NO-LOCK ~
    BY item-caixa.it-codigo INDEXED-REPOSITION
&Scoped-define OPEN-QUERY-brTable1 OPEN QUERY brTable1 FOR EACH item-caixa ~
      WHERE item-caixa.it-codigo >= fl-it-codigo-ini:screen-value in frame fPage2 ~
 AND item-caixa.it-codigo <= fl-it-codigo-fim:screen-value in frame fPage2 NO-LOCK, ~
      EACH embalag OF item-caixa NO-LOCK ~
    BY item-caixa.it-codigo INDEXED-REPOSITION.
&Scoped-define TABLES-IN-QUERY-brTable1 item-caixa embalag
&Scoped-define FIRST-TABLE-IN-QUERY-brTable1 item-caixa
&Scoped-define SECOND-TABLE-IN-QUERY-brTable1 embalag
...
DEFINE VARIABLE fl-it-codigo-fim AS CHARACTER FORMAT "X(9)":U 
     VIEW-AS FILL-IN 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS brTable1 wReport _STRUCTURED
  QUERY brTable1 NO-LOCK DISPLAY
      item-caixa.it-codigo FORMAT "x(16)":U
      embalag.sigla-emb FORMAT "!xx":U WIDTH 7.29
      embalag.embalagem FORMAT "x(10)":U WIDTH 13
      embalag.descricao FORMAT "x(30)":U
      item-caixa.qt-item FORMAT ">>>>,>>9.9999":U
      embalag.peso-embal FORMAT ">>>,>>9.99999":U
      embalag.altura FORMAT ">>>,>>9.999":U
      embalag.largura FORMAT ">>>,>>9.999":U
      embalag.comprim FORMAT ">>>,>>9.999":U
      embalag.volume FORMAT ">>>,>>>,>>9.9999999999":U
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ASSIGN NO-ROW-MARKERS SEPARATORS SIZE 126.86 BY 11.25
...
/* Query rebuild information for BROWSE brTable1
     _TblList          = "mgcad.item-caixa,mgcad.embalag OF mgcad.item-caixa"
     _Options          = "NO-LOCK INDEXED-REPOSITION"
     _TblOptList       = ","
     _OrdList          = "mgcad.item-caixa.it-codigo|yes"
     _Where[1]         = "mgcad.item-caixa.it-codigo >= fl-it-codigo-ini:screen-value in frame fPage2
 AND mgcad.item-caixa.it-codigo <= fl-it-codigo-fim:screen-value in frame fPage2"
     _FldNameList[1]   = mgcad.item-caixa.it-codigo
     _FldNameList[2]   > mgcad.embalag.sigla-emb
"embalag.sigla-emb" ? ? "character" ? ? ? ? ? ? no ? no no "7.29" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[3]   > mgcad.embalag.embalagem
"embalag.embalagem" ? ? "character" ? ? ? ? ? ? no ? no no "13" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[4]   = mgcad.embalag.descricao
     _FldNameList[5]   = mgcad.item-caixa.qt-item
     _FldNameList[6]   = mgcad.embalag.peso-embal
     _FldNameList[7]   = mgcad.embalag.altura
     _FldNameList[8]   = mgcad.embalag.largura
     _FldNameList[9]   = mgcad.embalag.comprim
     _FldNameList[10]   = mgcad.embalag.volume
     _Query            is OPENED
*/  /* BROWSE brTable1 */
&ANALYZE-RESUME
...
DO:
    ...
    PUT STREAM str-excel "Item;Sigla;Descri‡Æo;Qtd;Peso;Altura;Largura;Comprimento;Volume" SKIP.
    
    FOR EACH item-caixa NO-LOCK
        WHERE item-caixa.it-codigo >= INPUT FRAME fpage2 fl-it-codigo-ini
          AND item-caixa.it-codigo <= INPUT FRAME fpage2 fl-it-codigo-fim,
      EACH embalag OF item-caixa NO-LOCK:
        

        PUT STREAM str-excel UNFORMATTED
            item-caixa.it-codigo ";" 
            embalag.sigla-emb    ";"
            embalag.descricao    ";"
            item-caixa.qt-item   ";"
            embalag.peso-embal   ";"
