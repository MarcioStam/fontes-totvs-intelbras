...
DEFINE VARIABLE h_esftp203b-q01 AS HANDLE NO-UNDO.
DEFINE VARIABLE h_esftp203b-v01-2 AS HANDLE NO-UNDO.
...
DEFINE FRAME f-cad
     bt-ok AT ROW 5.63 COL 2.43 HELP
          "Salva e sai"
     bt-save AT ROW 5.63 COL 12.86 HELP
          "Salva e cria novo"
     bt-cancela AT ROW 5.63 COL 23.43 HELP
          "Cancela"
     bt-ajuda AT ROW 5.63 COL 79.72
     rt-button AT ROW 5.46 COL 1.43
...
DO:
{include/okfil.i h_esftp203b-v01-2}
END.
...
DO:
{include/salvafil.i h_esftp203b-v01-2}
END.
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'esp/ftp/esftp203b-v01.w':U ,
             INPUT  FRAME f-cad:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_esftp203b-v01-2 ).
       RUN set-position IN h_esftp203b-v01-2 ( 1.25 , 2.00 ) NO-ERROR.
       /* Size in UIB:  ( 4.00 , 88.57 ) */

       RUN init-object IN THIS-PROCEDURE (
             INPUT  'esp/ftp/esftp203b-q01.w':U ,
             INPUT  FRAME f-cad:HANDLE ,
             INPUT  '':U ,
             OUTPUT h_esftp203b-q01 ).
       RUN set-position IN h_esftp203b-q01 ( 1.00 , 57.00 ) NO-ERROR.
       /* Size in UIB:  ( 1.63 , 7.72 ) */

       /* Links to SmartViewer h_esftp203b-v01-2. */
       RUN add-link IN adm-broker-hdl ( h_esftp203b-q01 , 'Record':U , h_esftp203b-v01-2 ).
       RUN add-link IN adm-broker-hdl ( THIS-PROCEDURE , 'TableIO':U , h_esftp203b-v01-2 ).

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_esftp203b-v01-2 ,
...
------------------------------------------------------------------------------*/
  ...
  {utp/ut9000.i "esftp203B" "2.00.00.000"}

  /* Dispatch standard ADM method.                             */
  RUN dispatch IN THIS-PROCEDURE ( INPUT 'initialize':U ) .

  run pi-atualiza-parent in h_esftp203b-v01-2 (input v-row-parent).
...
/*------------------------------------------------------------------------------
  ...
  Notes:       
------------------------------------------------------------------------------*/
  RUN pi-reposiciona-query IN h_esftp203b-q01 (input v-row-table).
