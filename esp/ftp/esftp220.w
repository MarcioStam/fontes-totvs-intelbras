...
*******************************************************************************/
{include/i-prgvrs.i esftp220 2.00.00.000}
...
DEFINE FRAME f-pg-sel
     EDITOR-1 AT ROW 1.08 COL 4.43 NO-LABEL WIDGET-ID 4
     bt-arquivo-entrada AT ROW 10.33 COL 45.57 HELP
          "Escolha do nome do arquivo" WIDGET-ID 34
     c-arquivo-entrada AT ROW 10.38 COL 5.72 HELP
          "Nome do arquivo de destino do relat¢rio" NO-LABEL WIDGET-ID 36
     text-entrada AT ROW 9.63 COL 5.86 NO-LABEL WIDGET-ID 40
     RECT-8 AT ROW 10 COL 4.43 WIDGET-ID 38
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 3 ROW 2.85
         SIZE 76.86 BY 10.62
...
{utp/ut9000.i "esftp220" "2.00.00.000"}
...
DO  ON ERROR   UNDO MAIN-BLOCK, LEAVE MAIN-BLOCK
    ...
    ASSIGN EDITOR-1:SCREEN-VALUE IN FRAME F-PG-SEL = 'LAYOUT IMPORTACAO (Inicia na Linha 2, formato CSV)'       + CHR(13) + CHR(13) + 
                                                     'Coluna A: ESTABELECIMENTO'        + fill(chr(9),1) + 'Coluna J:  ALIQUOTA ICMS'                     + CHR(13) + 
                                                     'Coluna B: SERIE'                  + fill(chr(9),3) + 'Coluna K:  VALOR ICMS'                        + CHR(13) + 
                                                     'Coluna C: NR§ DOCUMENTO'          + fill(chr(9),2) + 'Coluna L:  VALOR OUTROS'                      + CHR(13) + 
                                                     'Coluna D: EMITENTE'               + fill(chr(9),2) + 'Coluna M: DESCRICAO (0460)'                   + CHR(13) +
                                                     'Coluna E: NAT.OPERACAO'           + fill(chr(9),2) + 'Coluna N: DESCRICAO COMPLEMENTAR (C195/C595)' + CHR(13) +  
                                                     'Coluna F:  ITEM'                  + fill(chr(9),2) + CHR(13) +  
                                                     'Coluna G: COD.AJUSTE'             + fill(chr(9),2) + CHR(13) +  
                                                     'Coluna H: DESCRICAO COMPLEMENTAR' + fill(chr(9),2) + CHR(13) +   
                                                     'Coluna  I:  BASE CALCULO ICMS'    + fill(chr(9),2). 
                                                     . 
...
------------------------------------------------------------------------------*/
  ...
  DISPLAY EDITOR-1 c-arquivo-entrada 
      WITH FRAME f-pg-sel IN WINDOW w-relat.
  ENABLE RECT-8 EDITOR-1 bt-arquivo-entrada c-arquivo-entrada 
      WITH FRAME f-pg-sel IN WINDOW w-relat.
...
do on error undo, return error on stop  undo, return error:
    ...
    {include/i-rprun.i esp/ftp/esftp220rp.p}
