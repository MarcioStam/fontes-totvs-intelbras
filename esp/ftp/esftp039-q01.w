...
&Scoped-define INTERNAL-TABLES usu-lib-item-fat

/* Definitions for QUERY Query-Main                                     */
&Scoped-define QUERY-STRING-Query-Main FOR EACH usu-lib-item-fat NO-LOCK INDEXED-REPOSITION
&Scoped-define OPEN-QUERY-Query-Main OPEN QUERY Query-Main FOR EACH usu-lib-item-fat NO-LOCK INDEXED-REPOSITION.
&Scoped-define TABLES-IN-QUERY-Query-Main usu-lib-item-fat
&Scoped-define FIRST-TABLE-IN-QUERY-Query-Main usu-lib-item-fat
...
/* Query rebuild information for QUERY Query-Main
     _TblList          = "mgesp.usu-lib-item-fat"
