...
DEFINE VARIABLE h_esftp203a-v01 AS HANDLE NO-UNDO.
...
DEFINE FRAME f-cad
     bt-ok AT ROW 5.33 COL 3.14 HELP
          "Salva e sai"
     bt-save AT ROW 5.33 COL 14.14 HELP
          "Salva e cria novo registro"
     bt-cancela AT ROW 5.33 COL 25.14 HELP
          "Cancela"
     bt-ajuda AT ROW 5.33 COL 78.14
     rt-button AT ROW 5.17 COL 2
...
DO:
{include/okpai.i h_esftp203a-v01}
END.
...
DO:
{include/salvapai.i h_esftp203a-v01}
 END.
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'esp/ftp/esftp203a-v01.w':U ,
             INPUT  FRAME f-cad:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_esftp203a-v01 ).
       RUN set-position IN h_esftp203a-v01 ( 1.25 , 2.00 ) NO-ERROR.
       ...
       RUN set-position IN h_esftp203-q01 ( 1.00 , 67.00 ) NO-ERROR.
       /* Size in UIB:  ( 1.63 , 7.72 ) */

       /* Links to SmartViewer h_esftp203a-v01. */
       RUN add-link IN adm-broker-hdl ( h_esftp203-q01 , 'Record':U , h_esftp203a-v01 ).
       RUN add-link IN adm-broker-hdl ( THIS-PROCEDURE , 'TableIO':U , h_esftp203a-v01 ).

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_esftp203a-v01 ,
...
------------------------------------------------------------------------------*/
  ...
  {utp/ut9000.i "esftp203A" "2.00.00.000"}
...
/*------------------------------------------------------------------------------
  ...
  Notes:       
------------------------------------------------------------------------------*/
  RUN pi-reposiciona-query IN h_esftp203-q01 (INPUT v-row-table). 
