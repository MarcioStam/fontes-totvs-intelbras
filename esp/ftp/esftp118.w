...
*******************************************************************************/
{include/i-prgvrs.i esftp118 2.00.00.000}
...
DEFINE VARIABLE d-emiss-fim AS DATE FORMAT "99/99/9999":U 
     VIEW-AS FILL-IN 
     SIZE 15 BY .88 NO-UNDO.

DEFINE VARIABLE d-emiss-ini AS DATE FORMAT "99/99/9999":U 
     LABEL "Emiss∆o" 
     VIEW-AS FILL-IN 
     SIZE 15 BY .88 NO-UNDO.
...
DEFINE FRAME f-pg-sel
     c-estab-ini AT ROW 1.25 COL 15 COLON-ALIGNED
     c-estab-fim AT ROW 1.25 COL 48.14 COLON-ALIGNED NO-LABEL
     d-emiss-ini AT ROW 2.25 COL 15 COLON-ALIGNED WIDGET-ID 4
     d-emiss-fim AT ROW 2.25 COL 48.14 COLON-ALIGNED NO-LABEL WIDGET-ID 2
...
{utp/ut9000.i "ESFTP118" "2.00.00.000"}
...
DO  ON ERROR   UNDO MAIN-BLOCK, LEAVE MAIN-BLOCK
    ...
    ASSIGN d-emiss-ini:SCREEN-VALUE IN FRAME f-pg-sel = STRING(TODAY)
           d-emiss-fim:SCREEN-VALUE IN FRAME f-pg-sel = STRING(TODAY).
...
------------------------------------------------------------------------------*/
  ...
  DISPLAY c-estab-ini c-estab-fim d-emiss-ini d-emiss-fim 
      WITH FRAME f-pg-sel IN WINDOW w-relat.
  ENABLE IMAGE-1 IMAGE-2 IMAGE-3 IMAGE-4 c-estab-ini c-estab-fim d-emiss-ini 
         d-emiss-fim 
      WITH FRAME f-pg-sel IN WINDOW w-relat.
...
do on error undo, return error on stop  undo, return error:
    ...
    assign tt-param.usuario   = c-seg-usuario
           ...
           tt-param.emiss-ini = input frame f-pg-sel d-emiss-ini
           tt-param.emiss-fim = input frame f-pg-sel d-emiss-fim.
    ...
    {include/i-rprun.i esp/ftp/esftp118rp.p}
