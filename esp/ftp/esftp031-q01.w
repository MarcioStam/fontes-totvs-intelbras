...
&Scoped-define QUERY-STRING-Query-Main FOR EACH lib-item-fat NO-LOCK
&Scoped-define OPEN-QUERY-Query-Main OPEN QUERY Query-Main FOR EACH lib-item-fat NO-LOCK.
&Scoped-define TABLES-IN-QUERY-Query-Main lib-item-fat
&Scoped-define FIRST-TABLE-IN-QUERY-Query-Main lib-item-fat
