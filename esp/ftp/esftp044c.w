...
&GLOBAL-DEFINE page2Fields    fi-cat-ini fi-cat-fim fi-sequencia-ini fi-sequencia-fim fi-dt-emissao-ini fi-dt-emissao-fim rs-situacao
...
DEFINE VARIABLE fi-cat-fim AS CHARACTER FORMAT "X(6)":U INITIAL "999999" 
     VIEW-AS FILL-IN 
...
DEFINE FRAME fPage2
     fi-cat-ini AT ROW 2.17 COL 21 COLON-ALIGNED WIDGET-ID 2
     fi-cat-fim AT ROW 2.17 COL 45 COLON-ALIGNED NO-LABEL WIDGET-ID 44
     fi-sequencia-ini AT ROW 3.25 COL 21 COLON-ALIGNED
     fi-sequencia-fim AT ROW 3.25 COL 45 COLON-ALIGNED NO-LABEL
     fi-dt-emissao-ini AT ROW 4.25 COL 21 COLON-ALIGNED WIDGET-ID 52
     fi-dt-emissao-fim AT ROW 4.25 COL 45 COLON-ALIGNED NO-LABEL WIDGET-ID 50
     rs-situacao AT ROW 7.25 COL 21 NO-LABEL WIDGET-ID 66
     IMAGE-3 AT ROW 3.25 COL 42 WIDGET-ID 8
     IMAGE-4 AT ROW 3.25 COL 38 WIDGET-ID 10
     IMAGE-15 AT ROW 2 COL 42 WIDGET-ID 46
     IMAGE-16 AT ROW 2 COL 38 WIDGET-ID 48
     IMAGE-17 AT ROW 4.25 COL 42 WIDGET-ID 54
     IMAGE-18 AT ROW 4.25 COL 38 WIDGET-ID 56
     RECT-11 AT ROW 6.75 COL 12 WIDGET-ID 64
...
DO ON ERROR UNDO, RETURN ERROR ON STOP UNDO, RETURN ERROR:
    ...
    {report/rprun.i esp\ftp\esftp044rp.p}
