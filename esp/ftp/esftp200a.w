...
*******************************************************************************/
{include/i-prgvrs.i XX9999A 9.99.99.999}
...
DEFINE VARIABLE h_esftp200a-v01-2 AS HANDLE NO-UNDO.
...
DEFINE FRAME f-cad
     bt-ajuda AT ROW 20.88 COL 78.14
     bt-ok AT ROW 20.92 COL 3.14 HELP
          "Salva e sai"
     bt-save AT ROW 20.92 COL 14.14 HELP
          "Salva e cria novo registro"
     bt-cancela AT ROW 20.92 COL 25.14 HELP
          "Cancela"
     rt-button AT ROW 20.71 COL 2
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 1 ROW 1
         SIZE 90 BY 21.5 WIDGET-ID 100.
...
DO:
{include/okpai.i h_esftp200a-v01-2}
END.
...
DO:
{include/salvapai.i h_esftp200a-v01-2}
 END.
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'esp/ftp/esftp200a-v01.w':U ,
             INPUT  FRAME f-cad:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_esftp200a-v01-2 ).
       RUN set-position IN h_esftp200a-v01-2 ( 1.33 , 2.00 ) NO-ERROR.
       /* Size in UIB:  ( 19.25 , 88.57 ) */
       ...
       RUN set-position IN h_esftp200-q01 ( 1.00 , 83.00 ) NO-ERROR.
       /* Size in UIB:  ( 1.63 , 7.72 ) */

       /* Links to SmartViewer h_esftp200a-v01-2. */
       RUN add-link IN adm-broker-hdl ( h_esftp200-q01 , 'Record':U , h_esftp200a-v01-2 ).
       RUN add-link IN adm-broker-hdl ( THIS-PROCEDURE , 'TableIO':U , h_esftp200a-v01-2 ).

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_esftp200a-v01-2 ,
...
------------------------------------------------------------------------------*/
  ...
  {utp/ut9000.i "esftp200a" "2.00.00.000"}
...
/*------------------------------------------------------------------------------
  ...
  Notes:       
------------------------------------------------------------------------------*/
  RUN pi-reposiciona-query IN h_esftp200-q01 (INPUT v-row-table). 
