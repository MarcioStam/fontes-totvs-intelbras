...
*******************************************************************************/
{include/i-prgvrs.i esftp205 2.00.00.000}
...
DEFINE VARIABLE h_esftp205-b01-2 AS HANDLE NO-UNDO.
DEFINE VARIABLE h_esftp205-q01 AS HANDLE NO-UNDO.
DEFINE VARIABLE h_esftp205-v01 AS HANDLE NO-UNDO.
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _XFTR "SmartWindowCues" w-concom _INLINE
...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'esp/ftp/esftp205-v01.w':U ,
             INPUT  FRAME f-cad:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_esftp205-v01 ).
       RUN set-position IN h_esftp205-v01 ( 3.00 , 2.00 ) NO-ERROR.
       /* Size in UIB:  ( 2.58 , 88.57 ) */

       RUN init-object IN THIS-PROCEDURE (
             INPUT  'adm/objects/folder.w':U ,
             INPUT  FRAME f-cad:HANDLE ,
             INPUT  'FOLDER-LABELS = ':U + 'SellOut' + ',
                     FOLDER-TAB-TYPE = 1':U ,
             OUTPUT h_folder ).
       RUN set-position IN h_folder ( 8.33 , 1.57 ) NO-ERROR.
       RUN set-size IN h_folder ( 9.33 , 88.57 ) NO-ERROR.

       RUN init-object IN THIS-PROCEDURE (
             INPUT  'esp/ftp/esftp205-q01.w':U ,
             INPUT  FRAME f-cad:HANDLE ,
             INPUT  'ProgPesquisa = esp/ftp/z01esftp205.w,
                     ProgVaPara = esp/ftp/g01esftp205.w,
                     ProgIncMod = ,
                     Implantar = no':U ,
             OUTPUT h_esftp205-q01 ).
       RUN set-position IN h_esftp205-q01 ( 2.00 , 52.00 ) NO-ERROR.
       /* Size in UIB:  ( 1.63 , 7.72 ) */

       /* Links to SmartViewer h_esftp205-v01. */
       RUN add-link IN adm-broker-hdl ( h_esftp205-q01 , 'Record':U , h_esftp205-v01 ).

       /* Links to SmartFolder h_folder. */
       RUN add-link IN adm-broker-hdl ( h_folder , 'Page':U , THIS-PROCEDURE ).

       /* Links to SmartQuery h_esftp205-q01. */
       RUN add-link IN adm-broker-hdl ( h_p-exihel , 'State':U , h_esftp205-q01 ).
       RUN add-link IN adm-broker-hdl ( h_p-navega , 'Navigation':U , h_esftp205-q01 ).
       RUN add-link IN adm-broker-hdl ( h_p-navega , 'State':U , h_esftp205-q01 ).

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_p-exihel ,
             h_p-navega , 'AFTER':U ).
       RUN adjust-tab-order IN adm-broker-hdl ( h_esftp205-v01 ,
             h_p-exihel , 'AFTER':U ).
       RUN adjust-tab-order IN adm-broker-hdl ( h_folder ,
             h_esftp205-v01 , 'AFTER':U ).
    END. /* Page 0 */
    WHEN 1 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'esp/ftp/esftp205-b01.w':U ,
             INPUT  FRAME f-cad:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_esftp205-b01-2 ).
       RUN set-position IN h_esftp205-b01-2 ( 9.75 , 4.00 ) NO-ERROR.
       /* Size in UIB:  ( 6.75 , 84.00 ) */

       /* Links to SmartBrowser h_esftp205-b01-2. */
       RUN add-link IN adm-broker-hdl ( h_esftp205-q01 , 'Record':U , h_esftp205-b01-2 ).

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_esftp205-b01-2 ,
             h_folder , 'AFTER':U ).
    END. /* Page 1 */
...
------------------------------------------------------------------------------*/
  ...
  {utp/ut9000.i "esftp205" "2.00.00.000"}
