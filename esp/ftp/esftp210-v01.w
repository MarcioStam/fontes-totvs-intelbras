...
&Scoped-Define ENABLED-FIELDS int-simula-dev.cod-emitente ~
int-simula-dev.dt-simula int-simula-dev.email int-simula-dev.log-email ~
int-simula-dev.nr-sequencia 
&Scoped-define ENABLED-TABLES int-simula-dev
&Scoped-define FIRST-ENABLED-TABLE int-simula-dev
&Scoped-Define ENABLED-OBJECTS rt-key bt-envia-email 
...
&Scoped-Define DISPLAYED-OBJECTS c-desc-cliente 
...
DEFINE BUTTON bt-envia-email 
     IMAGE-UP FILE "image\im-email.gif":U
     LABEL "" 
     SIZE 4 BY 1.

DEFINE VARIABLE c-desc-cliente AS CHARACTER FORMAT "X(255)":U 
     VIEW-AS FILL-IN 
...
DEFINE FRAME f-main
     int-simula-dev.cod-emitente AT ROW 1.25 COL 9 COLON-ALIGNED WIDGET-ID 2
          VIEW-AS FILL-IN 
          SIZE 10 BY .88
     c-desc-cliente AT ROW 1.25 COL 19 COLON-ALIGNED NO-LABEL WIDGET-ID 12
     int-simula-dev.dt-simula AT ROW 1.25 COL 71 COLON-ALIGNED WIDGET-ID 4
          LABEL "Data"
          VIEW-AS FILL-IN 
          SIZE 13 BY .88
     bt-envia-email AT ROW 2.17 COL 62.14 WIDGET-ID 14
     int-simula-dev.email AT ROW 2.25 COL 6.14 WIDGET-ID 6
          LABEL "E-mail"
          VIEW-AS FILL-IN 
          SIZE 51 BY .88
     int-simula-dev.log-email AT ROW 2.25 COL 73 WIDGET-ID 10
          VIEW-AS TOGGLE-BOX
          SIZE 13 BY .83
     int-simula-dev.nr-sequencia AT ROW 3.25 COL 9 COLON-ALIGNED WIDGET-ID 16
          VIEW-AS FILL-IN 
          SIZE 10 BY .88
...
&Scoped-define SELF-NAME bt-envia-email
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL bt-envia-email V-table-Win
ON CHOOSE OF bt-envia-email IN FRAME f-main
DO:
    IF AVAIL int-simula-dev THEN DO:
        RUN esp/ftp/esftp210c.p (INPUT ROWID(int-simula-dev),
                                 INPUT 2 /*gera o pdf e envia por e-mail*/).

        FIND CURRENT int-simula-dev EXCLUSIVE-LOCK.
        ASSIGN int-simula-dev.log-email = YES.
