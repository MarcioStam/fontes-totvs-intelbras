...
*******************************************************************************/
{include/i-prgvrs.i esftp200 2.00.00.000}
...
DEFINE VARIABLE h_esftp200-b01 AS HANDLE NO-UNDO.
DEFINE VARIABLE h_esftp200-b02 AS HANDLE NO-UNDO.
DEFINE VARIABLE h_esftp200-q01 AS HANDLE NO-UNDO.
DEFINE VARIABLE h_esftp200-v01 AS HANDLE NO-UNDO.
...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'esp/ftp/esftp200-v01.w':U ,
             INPUT  FRAME f-cad:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_esftp200-v01 ).
       RUN set-position IN h_esftp200-v01 ( 2.75 , 2.00 ) NO-ERROR.
       /* Size in UIB:  ( 3.75 , 88.57 ) */

       RUN init-object IN THIS-PROCEDURE (
             INPUT  'adm/objects/folder.w':U ,
             INPUT  FRAME f-cad:HANDLE ,
             INPUT  'FOLDER-LABELS = ':U + 'Exec/Rep|Supervisores' + ',
                     FOLDER-TAB-TYPE = 1':U ,
             OUTPUT h_folder ).
       ...
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'esp/ftp/esftp200-q01.w':U ,
             INPUT  FRAME f-cad:HANDLE ,
             INPUT  'ProgPesquisa = esp/ftp/z01esftp200.w,
                     ProgVaPara = esp/ftp/g01esftp200.w,
                     ProgIncMod = esp/ftp/esftp200a.w,
                     Implantar = no':U ,
             OUTPUT h_esftp200-q01 ).
       RUN set-position IN h_esftp200-q01 ( 1.25 , 56.00 ) NO-ERROR.
       /* Size in UIB:  ( 1.63 , 7.72 ) */

       /* Links to SmartPanel h_p-exihel. */
       RUN add-link IN adm-broker-hdl ( h_p-exihel , 'State':U , THIS-PROCEDURE ).

       /* Links to SmartViewer h_esftp200-v01. */
       RUN add-link IN adm-broker-hdl ( h_esftp200-q01 , 'Record':U , h_esftp200-v01 ).
       RUN add-link IN adm-broker-hdl ( h_p-cadpai , 'TableIO':U , h_esftp200-v01 ).

       /* Links to SmartFolder h_folder. */
       RUN add-link IN adm-broker-hdl ( h_folder , 'Page':U , THIS-PROCEDURE ).

       /* Links to SmartQuery h_esftp200-q01. */
       RUN add-link IN adm-broker-hdl ( h_p-cadpai , 'State':U , h_esftp200-q01 ).
       RUN add-link IN adm-broker-hdl ( h_p-exihel , 'State':U , h_esftp200-q01 ).
       RUN add-link IN adm-broker-hdl ( h_p-navega , 'Navigation':U , h_esftp200-q01 ).
       RUN add-link IN adm-broker-hdl ( h_p-navega , 'State':U , h_esftp200-q01 ).
       ...
       RUN adjust-tab-order IN adm-broker-hdl ( h_p-exihel ,
             h_p-cadpai , 'AFTER':U ).
       RUN adjust-tab-order IN adm-broker-hdl ( h_esftp200-v01 ,
             h_p-exihel , 'AFTER':U ).
       RUN adjust-tab-order IN adm-broker-hdl ( h_folder ,
             h_esftp200-v01 , 'AFTER':U ).
    END. /* Page 0 */
    WHEN 1 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'esp/ftp/esftp200-b01.w':U ,
             INPUT  FRAME f-cad:HANDLE ,
             INPUT  'Initial-Lock = NO-LOCK,
                     ...
                     Create-On-Add = ?,
                     ProgAtributo = ,
                     ProgIncMod = esp/ftp/esftp200b.w,
                     MessageNum = 0,
                     MessageParam = ':U ,
             OUTPUT h_esftp200-b01 ).
       RUN set-position IN h_esftp200-b01 ( 9.75 , 3.00 ) NO-ERROR.
       /* Size in UIB:  ( 7.50 , 87.00 ) */

       /* Links to BrowserCadastro2 h_esftp200-b01. */
       RUN add-link IN adm-broker-hdl ( h_esftp200-q01 , 'Record':U , h_esftp200-b01 ).

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_esftp200-b01 ,
             h_folder , 'AFTER':U ).
    END. /* Page 1 */
    WHEN 2 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'esp/ftp/esftp200-b02.w':U ,
             INPUT  FRAME f-cad:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_esftp200-b02 ).
       RUN set-position IN h_esftp200-b02 ( 9.75 , 3.14 ) NO-ERROR.
       /* Size in UIB:  ( 7.50 , 85.00 ) */

       /* Links to BrowserCadastro2 h_esftp200-b02. */
       RUN add-link IN adm-broker-hdl ( h_esftp200-q01 , 'Record':U , h_esftp200-b02 ).

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_esftp200-b02 ,
             h_folder , 'AFTER':U ).
    END. /* Page 2 */
...
------------------------------------------------------------------------------*/
  ...
  {utp/ut9000.i "esftp200" "2.00.00.000"}
