...
*******************************************************************************/
{include/i-prgvrs.i esftp123 2.00.00.000}
...
DEFINE VARIABLE rs-analit-sintet AS INTEGER 
...
DEFINE VARIABLE l-saldo-zerado AS LOGICAL INITIAL no 
     LABEL "Lista Saldos Zerados?" 
     VIEW-AS TOGGLE-BOX
     SIZE 18.72 BY 1.08 NO-UNDO.
...
DEFINE VARIABLE c-nat-operacao-ini AS CHARACTER FORMAT "X(6)":U 
     LABEL "Nat. Opera‡Æo" 
     VIEW-AS FILL-IN 
     SIZE 7 BY .88 NO-UNDO.

DEFINE VARIABLE c-nr-nota-fis-fim AS CHARACTER FORMAT "X(16)":U INITIAL "99999999999999" 
     VIEW-AS FILL-IN 
...
DEFINE VARIABLE d-dt-emis-fim AS DATE FORMAT "99/99/9999":U INITIAL 12/31/9999 
     VIEW-AS FILL-IN 
...
DEFINE FRAME f-pg-sel
     c-cod-estab-ini AT ROW 1.25 COL 23 COLON-ALIGNED
     c-cod-estab-fim AT ROW 1.25 COL 48.43 COLON-ALIGNED NO-LABEL
     c-serie-ini AT ROW 2.25 COL 23 COLON-ALIGNED WIDGET-ID 4
     c-serie-fim AT ROW 2.25 COL 48.43 COLON-ALIGNED NO-LABEL WIDGET-ID 2
     c-nr-nota-fis-ini AT ROW 3.25 COL 17 COLON-ALIGNED WIDGET-ID 12
     c-nr-nota-fis-fim AT ROW 3.25 COL 48.43 COLON-ALIGNED NO-LABEL WIDGET-ID 10
     c-nat-operacao-ini AT ROW 4.25 COL 23 COLON-ALIGNED WIDGET-ID 20
     c-nat-operacao-fim AT ROW 4.25 COL 48.43 COLON-ALIGNED NO-LABEL WIDGET-ID 18
     i-cod-emitente-ini AT ROW 5.25 COL 20 COLON-ALIGNED WIDGET-ID 28
     i-cod-emitente-fim AT ROW 5.25 COL 48.43 COLON-ALIGNED NO-LABEL WIDGET-ID 26
     c-it-codigo-ini AT ROW 6.25 COL 13 COLON-ALIGNED WIDGET-ID 36
     c-it-codigo-fim AT ROW 6.25 COL 48.43 COLON-ALIGNED NO-LABEL WIDGET-ID 34
     d-dt-emis-ini AT ROW 7.25 COL 19 COLON-ALIGNED WIDGET-ID 44
     d-dt-emis-fim AT ROW 7.25 COL 48.43 COLON-ALIGNED NO-LABEL WIDGET-ID 42
     IMAGE-1 AT ROW 1.25 COL 32.14
     IMAGE-2 AT ROW 1.25 COL 47.57
     IMAGE-3 AT ROW 2.25 COL 32.14 WIDGET-ID 6
     IMAGE-4 AT ROW 2.25 COL 47.57 WIDGET-ID 8
     IMAGE-5 AT ROW 3.25 COL 32.14 WIDGET-ID 14
     IMAGE-6 AT ROW 3.25 COL 47.57 WIDGET-ID 16
     IMAGE-7 AT ROW 4.25 COL 32.14 WIDGET-ID 22
     IMAGE-8 AT ROW 4.25 COL 47.57 WIDGET-ID 24
     IMAGE-9 AT ROW 5.25 COL 32.14 WIDGET-ID 30
     IMAGE-10 AT ROW 5.25 COL 47.57 WIDGET-ID 32
     IMAGE-11 AT ROW 6.25 COL 32.14 WIDGET-ID 38
     IMAGE-12 AT ROW 6.25 COL 47.57 WIDGET-ID 40
     IMAGE-13 AT ROW 7.25 COL 32.14 WIDGET-ID 46
     IMAGE-14 AT ROW 7.25 COL 47.57 WIDGET-ID 48
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 3 ROW 2.85
         SIZE 76.86 BY 10.62
...
DEFINE FRAME f-pg-par
     rs-analit-sintet AT ROW 1.75 COL 3 NO-LABEL WIDGET-ID 2
     l-saldo-zerado AT ROW 4 COL 3
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 3 ROW 3
         SIZE 75 BY 10
...
{utp/ut9000.i "esftp123" "9.99.99.999"}
...
------------------------------------------------------------------------------*/
  ...
  DISPLAY c-cod-estab-ini c-cod-estab-fim c-serie-ini c-serie-fim 
          c-nr-nota-fis-ini c-nr-nota-fis-fim c-nat-operacao-ini 
          c-nat-operacao-fim i-cod-emitente-ini i-cod-emitente-fim 
          c-it-codigo-ini c-it-codigo-fim d-dt-emis-ini d-dt-emis-fim 
      WITH FRAME f-pg-sel IN WINDOW w-relat.
  ENABLE IMAGE-1 IMAGE-2 IMAGE-3 IMAGE-4 IMAGE-5 IMAGE-6 IMAGE-7 IMAGE-8 
         IMAGE-9 IMAGE-10 IMAGE-11 IMAGE-12 IMAGE-13 IMAGE-14 c-cod-estab-ini 
         c-cod-estab-fim c-serie-ini c-serie-fim c-nr-nota-fis-ini 
         c-nr-nota-fis-fim c-nat-operacao-ini c-nat-operacao-fim 
         i-cod-emitente-ini i-cod-emitente-fim c-it-codigo-ini c-it-codigo-fim 
         d-dt-emis-ini d-dt-emis-fim 
      WITH FRAME f-pg-sel IN WINDOW w-relat.
  ...
  DISPLAY rs-analit-sintet l-saldo-zerado 
      WITH FRAME f-pg-par IN WINDOW w-relat.
  ENABLE rs-analit-sintet l-saldo-zerado 
      WITH FRAME f-pg-par IN WINDOW w-relat.
...
do on error undo, return error on stop  undo, return error:
    ...
    assign tt-param.usuario          = c-seg-usuario
           ...
           tt-param.nr-nota-fis-ini  = input frame f-pg-sel c-nr-nota-fis-ini 
           tt-param.nr-nota-fis-fim  = input frame f-pg-sel c-nr-nota-fis-fim 
           ...
           tt-param.analit-sintet    = input frame f-pg-par rs-analit-sintet
           tt-param.saldo-zerado     = input frame f-pg-par l-saldo-zerado
           .
    ...
    {include/i-rprun.i esp/ftp/esftp123rp.p}
