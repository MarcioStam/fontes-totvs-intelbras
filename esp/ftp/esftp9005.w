...
*******************************************************************************/
{include/i-prgvrs.i esftp9005 2.00.00.000}
...
bt-config-impr rs-execucao 
&Scoped-Define DISPLAYED-OBJECTS rs-execucao 
...
DEFINE VARIABLE gera-nota AS INTEGER INITIAL 2 
     VIEW-AS RADIO-SET HORIZONTAL
     RADIO-BUTTONS 
          "Efetivar notas geradas", 1,
"Somente Criar documento no ft4003", 2
...
DEFINE FRAME f-pg-sel
     bt-arquivo-entrada AT ROW 1.75 COL 50.72 HELP
          "Escolha do nome do arquivo" WIDGET-ID 8
     c-arquivo-imp AT ROW 1.83 COL 8.29 COLON-ALIGNED WIDGET-ID 4
     gera-nota AT ROW 2.92 COL 10.29 NO-LABEL WIDGET-ID 16
     ed-layout AT ROW 5.63 COL 2.29 NO-LABEL WIDGET-ID 14
     RECT-2 AT ROW 1.21 COL 1 WIDGET-ID 6
     RECT-3 AT ROW 5 COL 1 WIDGET-ID 10
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 3 ROW 2.85
         SIZE 76.86 BY 10.62
...
ASSIGN 
       c-arquivo:HIDDEN IN FRAME f-pg-imp           = TRUE.
...
/* SETTINGS FOR FRAME f-pg-sel
                                                                        */
ASSIGN 
       ed-layout:READ-ONLY IN FRAME f-pg-sel        = TRUE.
...
DO:
    ...
    ASSIGN c-arquivo-imp:SCREEN-VALUE IN FRAME f-pg-sel = c-arquivo-imp.
END.
...
{utp/ut9000.i "esftp9005" "2.00.00.000"}
...
DO  ON ERROR   UNDO MAIN-BLOCK, LEAVE MAIN-BLOCK
    ...
    {include/i-rpmbl.i}
    ASSIGN ed-layout:SCREEN-VALUE IN FRAME f-pg-sel = "O layout de importaá∆o deve seguir o seguinte padr∆o: Estab;SÇrie;C¢d Cliente;Nat Oper;Canal Venda;Representante;Cond Pag;Data Vencto;Rota;Transporte;Contrato;Observaá∆o;Item;Qtde Unit Fat;Preáo Orig;Cidade;UF;Dep¢sito                                                                                                                      Exemplo: 104;1;7621;610100;8;4000;1;14/11/2013;PR - Cap;298;;observaá∆o teste;4750014;1;5,5;RIBEIRAO PRETO;sp;EXP".
...
------------------------------------------------------------------------------*/
  ...
  DISPLAY c-arquivo-imp gera-nota ed-layout 
      WITH FRAME f-pg-sel IN WINDOW w-relat.
  ENABLE RECT-2 RECT-3 bt-arquivo-entrada c-arquivo-imp gera-nota ed-layout 
      WITH FRAME f-pg-sel IN WINDOW w-relat.
  {&OPEN-BROWSERS-IN-QUERY-f-pg-sel}
  DISPLAY rs-execucao 
      WITH FRAME f-pg-imp IN WINDOW w-relat.
  ENABLE RECT-7 RECT-9 rs-destino bt-arquivo bt-config-impr rs-execucao 
      WITH FRAME f-pg-imp IN WINDOW w-relat.
...
do on error undo, return error on stop  undo, return error:
    ...
    assign tt-param.usuario         = c-seg-usuario
           ...
           tt-param.arquivo-importa = c-arquivo-imp:SCREEN-VALUE IN FRAME f-pg-sel
           tt-param.atualiza-nota   = input frame f-pg-sel gera-nota = 1.
    ...
    {include/i-rprun.i esp/ftp/esftp9005rp.p}
