...
DEFINE VARIABLE text-ex AS CHARACTER FORMAT "X(256)":U INITIAL "Ex: <item>~;<quantid.>~;<preco>~;<deposito>~;<NCM>~;<Peso Liquido>,<Peso Bruto>,<Narrativa>,<Aliq IPI>" 
      VIEW-AS TEXT 
...
DEFINE FRAME fpage0
     ...
     "<conta bem>~; <Bem Pat>~; <Seq Bem>" VIEW-AS TEXT
          SIZE 68 BY .54 AT ROW 4.08 COL 10 WIDGET-ID 10
