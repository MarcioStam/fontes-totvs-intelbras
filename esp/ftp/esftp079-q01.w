...
&Scoped-define QUERY-STRING-Query-Main FOR EACH natur-oper ~
      WHERE natur-oper.terceiros = TRUE NO-LOCK
&Scoped-define OPEN-QUERY-Query-Main OPEN QUERY Query-Main FOR EACH natur-oper ~
      WHERE natur-oper.terceiros = TRUE NO-LOCK.
&Scoped-define TABLES-IN-QUERY-Query-Main natur-oper
&Scoped-define FIRST-TABLE-IN-QUERY-Query-Main natur-oper
...
/* Query rebuild information for QUERY Query-Main
     ...
     _Options          = "NO-LOCK"
     _Where[1]         = "mgcad.natur-oper.terceiros = TRUE"
