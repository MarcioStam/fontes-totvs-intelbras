...
*******************************************************************************/
{include/i-prgvrs.i esftp134 2.00.00.000}
...
DEFINE VARIABLE c-pedido AS CHARACTER FORMAT "X(30)":U 
     LABEL "Pedido" 
     VIEW-AS FILL-IN 
...
DEFINE FRAME f-pg-sel
     c-pedido AT ROW 5 COL 25 COLON-ALIGNED WIDGET-ID 28
     "Integra‡Æo XML" VIEW-AS TEXT
          SIZE 13.57 BY .54 AT ROW 1.08 COL 3.43 WIDGET-ID 6
...
{utp/ut9000.i "esftp134" "2.00.00.000"}
...
do on error undo, return error on stop  undo, return error:
    ...
    assign tt-param.usuario         = c-seg-usuario
           ...
           tt-param.cnr-pedido      = input frame f-pg-sel c-pedido
           .
    ...
    {include/i-rprun.i esp/ftp/esftp134rp.p}
