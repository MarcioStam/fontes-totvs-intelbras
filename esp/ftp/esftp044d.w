...
&GLOBAL-DEFINE page2Fields    c-ano
...
DEFINE VARIABLE c-ano AS CHARACTER FORMAT "X(256)":U 
     LABEL "Ano Referˆncia" 
     VIEW-AS FILL-IN 
...
DEFINE FRAME fPage2
     c-ano AT ROW 3.25 COL 34 COLON-ALIGNED WIDGET-ID 70
...
DO ON ERROR UNDO, RETURN ERROR ON STOP UNDO, RETURN ERROR:
    ...
    DO WITH FRAME fPage2:
        assign tt-param.c-ano             = INPUT c-ano:SCREEN-VALUE IN FRAME fpage2.
    ...
    {report/rprun.i esp\ftp\esftp044drp.p}
