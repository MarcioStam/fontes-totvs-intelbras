...
*******************************************************************************/
{include/i-prgvrs.i esftp139 2.00.00.000}
...
DEFINE VARIABLE c-cdd-embarq LIKE nota-fiscal.cdd-embarq
     VIEW-AS FILL-IN 
...
DEFINE FRAME f-pg-sel
     c-cdd-embarq AT ROW 5 COL 25 COLON-ALIGNED HELP
          "C¢digo - Decimal Embarque" WIDGET-ID 28
     "Embarque Retira Matriz" VIEW-AS TEXT
          SIZE 16.57 BY .54 AT ROW 1.08 COL 3.43 WIDGET-ID 6
...
/* SETTINGS FOR FRAME f-pg-sel
                                                                        */
/* SETTINGS FOR FILL-IN c-cdd-embarq IN FRAME f-pg-sel
   LIKE = mgmov.nota-fiscal.cdd-embarq EXP-SIZE                         */
...
{utp/ut9000.i "esftp139" "2.00.00.000"}
...
------------------------------------------------------------------------------*/
  ...
  DISPLAY c-cdd-embarq 
      WITH FRAME f-pg-sel IN WINDOW w-relat.
  ENABLE RECT-10 c-cdd-embarq 
      WITH FRAME f-pg-sel IN WINDOW w-relat.
...
do on error undo, return error on stop  undo, return error:
    ...
    assign tt-param.usuario         = c-seg-usuario
           ...
           tt-param.cdd-embarq      = input frame f-pg-sel c-cdd-embarq
           .
    ...
    {include/i-rprun.i esp/ftp/esftp139rp.p}
