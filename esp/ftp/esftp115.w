...
&GLOBAL-DEFINE Program        ESFTP115
...
&GLOBAL-DEFINE page4Fields    c-estab 
...
DEFINE VARIABLE c-estab AS CHARACTER FORMAT "X(3)":U INITIAL "*" 
     LABEL "Estabelecimetno" 
     VIEW-AS FILL-IN 
     SIZE 8.86 BY .88 TOOLTIP "Informe o estabelecimento desejado ou * para todos" NO-UNDO.
...
DEFINE FRAME fPage4
     c-estab AT ROW 3.25 COL 33 COLON-ALIGNED WIDGET-ID 30
...
do on error undo, return error on stop  undo, return error:
    ...
    ASSIGN tt-param.c-estab = INPUT FRAME fPage4 c-estab.
    ...
    {report/rprun.i esp/ftp/esftp115rp.p}
