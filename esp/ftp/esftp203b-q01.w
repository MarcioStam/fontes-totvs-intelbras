...
&Scoped-define QUERY-STRING-Query-Main FOR EACH int-exec-superv NO-LOCK
&Scoped-define OPEN-QUERY-Query-Main OPEN QUERY Query-Main FOR EACH int-exec-superv NO-LOCK.
&Scoped-define TABLES-IN-QUERY-Query-Main int-exec-superv
&Scoped-define FIRST-TABLE-IN-QUERY-Query-Main int-exec-superv
...
/* Query rebuild information for QUERY Query-Main
     _TblList          = "mgesp.int-exec-superv"
     _Options          = "NO-LOCK"
