...
&Scoped-define INTERNAL-TABLES int-simula-dev-it

/* Define KEY-PHRASE in case it is used by any query. */
&Scoped-define KEY-PHRASE TRUE

/* Definitions for BROWSE br-table                                      */
&Scoped-define FIELDS-IN-QUERY-br-table int-simula-dev-it.it-codigo ~
int-simula-dev-it.qt-devolvida int-simula-dev-it.vl-unitario ~
int-simula-dev-it.vl-tot-it int-simula-dev-it.observacao 
&Scoped-define ENABLED-FIELDS-IN-QUERY-br-table 
&Scoped-define QUERY-STRING-br-table FOR EACH int-simula-dev-it OF int-simula-dev WHERE ~{&KEY-PHRASE} NO-LOCK ~
    ~{&SORTBY-PHRASE}
&Scoped-define OPEN-QUERY-br-table OPEN QUERY br-table FOR EACH int-simula-dev-it OF int-simula-dev WHERE ~{&KEY-PHRASE} NO-LOCK ~
    ~{&SORTBY-PHRASE}.
&Scoped-define TABLES-IN-QUERY-br-table int-simula-dev-it
&Scoped-define FIRST-TABLE-IN-QUERY-br-table int-simula-dev-it
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br-table B-table-Win _STRUCTURED
  QUERY br-table NO-LOCK DISPLAY
      int-simula-dev-it.it-codigo FORMAT "x(16)":U
      int-simula-dev-it.qt-devolvida FORMAT ">>>>,>>9.99":U
      int-simula-dev-it.vl-unitario FORMAT ">>>,>>>,>>9.99":U
      int-simula-dev-it.vl-tot-it FORMAT ">>>,>>>,>>9.99":U
      int-simula-dev-it.observacao FORMAT "x(200)":U WIDTH 30
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
...
DEFINE FRAME F-Main
     ...
     bt-eliminar AT ROW 7.5 COL 11.14
...
/* Settings for THIS-PROCEDURE
   ...
   External Tables: mgesp.int-simula-dev
   Allow: Basic,Browse
   Frames: 1
...
/* Query rebuild information for BROWSE br-table
     _TblList          = "mgesp.int-simula-dev-it OF mgesp.int-simula-dev"
     _Options          = "NO-LOCK KEY-PHRASE SORTBY-PHRASE"
     _FldNameList[1]   = mgesp.int-simula-dev-it.it-codigo
     _FldNameList[2]   = mgesp.int-simula-dev-it.qt-devolvida
     _FldNameList[3]   = mgesp.int-simula-dev-it.vl-unitario
     _FldNameList[4]   = mgesp.int-simula-dev-it.vl-tot-it
     _FldNameList[5]   > mgesp.int-simula-dev-it.observacao
"int-simula-dev-it.observacao" ? ? "character" ? ? ? ? ? ? no ? no no "30" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
...
IF AVAIL int-simula-dev THEN DO:
    ...
    IF int-simula-dev.log-email THEN
        RUN pi-disable.
    ELSE 
        RUN pi-enable.
END.
...
/*------------------------------------------------------------------------------
  ...
  Notes:       
------------------------------------------------------------------------------*/
ASSIGN bt-incluir:SENSITIVE IN FRAME f-main = NO
...
/*------------------------------------------------------------------------------
  ...
  Notes:       
------------------------------------------------------------------------------*/
ASSIGN bt-incluir:SENSITIVE IN FRAME f-main = YES
...
------------------------------------------------------------------------------*/
  ...
  {src/adm/template/snd-list.i "int-simula-dev-it"}
