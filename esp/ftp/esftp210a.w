...
*******************************************************************************/
{include/i-prgvrs.i esftp210a 2.00.00.000}
...
DEFINE VARIABLE h_esftp210a-v01 AS HANDLE NO-UNDO.
...
DEFINE FRAME f-cad
     bt-ok AT ROW 16.42 COL 3.14 HELP
          "Salva e sai"
     bt-save AT ROW 16.42 COL 14.14 HELP
          "Salva e cria novo registro"
     bt-cancela AT ROW 16.42 COL 25.14 HELP
          "Cancela"
     bt-ajuda AT ROW 16.42 COL 78.14
     rt-button AT ROW 16.25 COL 2
...
DO:
{include/okpai.i h_esftp210a-v01}
END.
...
DO:
{include/salvapai.i h_esftp210a-v01}
 END.
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'esp/ftp/esftp210a-v01.w':U ,
             INPUT  FRAME f-cad:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_esftp210a-v01 ).
       RUN set-position IN h_esftp210a-v01 ( 2.00 , 1.00 ) NO-ERROR.
       /* Size in UIB:  ( 12.63 , 88.57 ) */
       ...
       RUN set-position IN h_esftp210-q01 ( 1.25 , 63.00 ) NO-ERROR.
       /* Size in UIB:  ( 1.63 , 7.72 ) */

       /* Links to SmartViewer h_esftp210a-v01. */
       RUN add-link IN adm-broker-hdl ( h_esftp210-q01 , 'Record':U , h_esftp210a-v01 ).
       RUN add-link IN adm-broker-hdl ( THIS-PROCEDURE , 'TableIO':U , h_esftp210a-v01 ).

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_esftp210a-v01 ,
...
------------------------------------------------------------------------------*/
  ...
  {utp/ut9000.i "esftp210A" "2.00.00.000"}
...
/*------------------------------------------------------------------------------
  ...
  Notes:       
------------------------------------------------------------------------------*/
  RUN pi-reposiciona-query IN h_esftp210-q01 (INPUT v-row-table). 
