...
&Scoped-Define ENABLED-OBJECTS rt-button i_cod-sup-exec i_idi-tipo ~
i_periodo-mes i_periodo-ano bt-ok bt-cancela bt-ajuda 
&Scoped-Define DISPLAYED-OBJECTS i_cod-sup-exec i_idi-tipo i_periodo-mes ~
i_periodo-ano 
...
DEFINE VARIABLE i_idi-tipo AS INTEGER 
...
DEFINE FRAME d-vapara
     i_cod-sup-exec AT ROW 1.5 COL 26 COLON-ALIGNED WIDGET-ID 2
     i_idi-tipo AT ROW 1.75 COL 45 NO-LABEL WIDGET-ID 12
     i_periodo-mes AT ROW 2.5 COL 26 COLON-ALIGNED WIDGET-ID 4
     i_periodo-ano AT ROW 2.5 COL 30.43 COLON-ALIGNED NO-LABEL WIDGET-ID 6
     bt-ok AT ROW 4.5 COL 2.14
     bt-cancela AT ROW 4.5 COL 13
     bt-ajuda AT ROW 4.5 COL 58
     "/" VIEW-AS TEXT
          SIZE 1 BY .54 AT ROW 2.67 COL 31.29 WIDGET-ID 10
...
FIND int-execsuperv-calc NO-LOCK
    WHERE int-execsuperv-calc.cod-sup-exec EQ INPUT FRAME {&FRAME-NAME} i_cod-sup-exec
      AND int-execsuperv-calc.periodo-mes EQ INPUT FRAME {&FRAME-NAME} i_periodo-mes
...
------------------------------------------------------------------------------*/
  DISPLAY i_cod-sup-exec i_idi-tipo i_periodo-mes i_periodo-ano 
      WITH FRAME d-vapara.
  ENABLE rt-button i_cod-sup-exec i_idi-tipo i_periodo-mes i_periodo-ano bt-ok 
         bt-cancela bt-ajuda 
      WITH FRAME d-vapara.
  VIEW FRAME d-vapara.
...
------------------------------------------------------------------------------*/
  ...
  {utp/ut9000.i "G01esftp206" "2.00.00.000"}
