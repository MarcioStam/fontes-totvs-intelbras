...
*******************************************************************************/
{include/i-prgvrs.i esftp207 2.00.00.000}
...
DEFINE VARIABLE i-periodo-ano AS INTEGER FORMAT "9999" INITIAL 0 
     VIEW-AS FILL-IN 
     SIZE 6 BY .88.

DEFINE VARIABLE i-periodo-mes AS INTEGER FORMAT "99" INITIAL 0 
     LABEL "Per¡odo" 
     VIEW-AS FILL-IN 
     SIZE 3.43 BY .88.
...
DEFINE FRAME f-pg-sel
     i-periodo-mes AT ROW 1.75 COL 13 COLON-ALIGNED WIDGET-ID 6
     i-periodo-ano AT ROW 1.75 COL 18 COLON-ALIGNED NO-LABEL WIDGET-ID 4
     "/" VIEW-AS TEXT
          SIZE 1 BY .79 AT ROW 1.75 COL 18.72 WIDGET-ID 8
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 3 ROW 2.85
         SIZE 76.86 BY 10.62
...
{utp/ut9000.i "esftp207" "2.00.00.000"}
...
------------------------------------------------------------------------------*/
  ...
  DISPLAY i-periodo-mes i-periodo-ano 
      WITH FRAME f-pg-sel IN WINDOW w-relat.
  ENABLE i-periodo-mes i-periodo-ano 
      WITH FRAME f-pg-sel IN WINDOW w-relat.
...
do on error undo, return error on stop  undo, return error:
    ...
    assign tt-param.usuario     = c-seg-usuario
           ...
           tt-param.periodo-mes = INPUT FRAME f-pg-sel i-periodo-mes
           tt-param.periodo-ano = INPUT FRAME f-pg-sel i-periodo-ano.
    ...
    {include/i-rprun.i esp/ftp/esftp207rp.p}
