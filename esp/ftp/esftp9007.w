...
*******************************************************************************/
{include/i-prgvrs.i ESFTP9007 1.11.00.001}
...
&IF "{&EMSFND_VERSION}" >= "1.00" &THEN
    {include/i-license-manager.i esftp9007 FTP}
&ENDIF
...
DEFINE VARIABLE dt-emis-nota-fim AS DATE FORMAT "99/99/9999" INITIAL 12/31/9999 
     VIEW-AS FILL-IN 
     SIZE 11 BY .88 NO-UNDO.

DEFINE VARIABLE dt-emis-nota-ini AS DATE FORMAT "99/99/9999" INITIAL 01/01/001 
     LABEL "Dt Emiss∆o" 
     VIEW-AS FILL-IN 
     SIZE 11 BY .88 NO-UNDO.
...
DEFINE FRAME f-pg-sel
     dt-emis-nota-ini AT ROW 1.25 COL 19 COLON-ALIGNED HELP
          "Data de emiss∆o da nota fiscal"
     dt-emis-nota-fim AT ROW 1.25 COL 48.14 COLON-ALIGNED HELP
          "Data de emiss∆o da nota fiscal" NO-LABEL
     c-cod-estabel-ini AT ROW 2.25 COL 24 COLON-ALIGNED HELP
          "C¢digo do estabelecimento" WIDGET-ID 12
     c-cod-estabel-fim AT ROW 2.25 COL 48.14 COLON-ALIGNED HELP
          "C¢digo do estabelecimento" NO-LABEL WIDGET-ID 10
     c-serie-ini AT ROW 3.25 COL 24 COLON-ALIGNED HELP
          "SÇrie da nota fiscal" WIDGET-ID 4
     c-serie-fim AT ROW 3.25 COL 48.14 COLON-ALIGNED HELP
          "SÇrie da nota fiscal" NO-LABEL WIDGET-ID 2
     c-nr-nota-fis-ini AT ROW 4.25 COL 13 COLON-ALIGNED HELP
          "N£mero da nota fiscal" WIDGET-ID 20
     c-nr-nota-fis-fim AT ROW 4.25 COL 48.14 COLON-ALIGNED HELP
          "N£mero da nota fiscal" NO-LABEL WIDGET-ID 18
     c-nr-pedcli-ini AT ROW 5.25 COL 17 COLON-ALIGNED HELP
          "N£mero do pedido do cliente" WIDGET-ID 28
     c-nr-pedcli-fim AT ROW 5.25 COL 48.14 COLON-ALIGNED HELP
          "N£mero do pedido do cliente" NO-LABEL WIDGET-ID 26
     ...
     IMAGE-6 AT ROW 3.25 COL 47.29 WIDGET-ID 16
     IMAGE-7 AT ROW 4.25 COL 31.86 WIDGET-ID 22
     IMAGE-8 AT ROW 4.25 COL 47.29 WIDGET-ID 24
     IMAGE-9 AT ROW 5.25 COL 31.86 WIDGET-ID 30
     IMAGE-10 AT ROW 5.25 COL 47.29 WIDGET-ID 32
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 3 ROW 2.85
         SIZE 76.86 BY 10.62
...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW w-relat ASSIGN
         HIDDEN             = YES
         TITLE              = "Integraá∆o Notas ASTEC x CRM"
         HEIGHT             = 15
         WIDTH              = 81.14
         MAX-HEIGHT         = 28.33
         MAX-WIDTH          = 195.14
...
ON END-ERROR OF w-relat /* Integraá∆o Notas ASTEC x CRM */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL w-relat w-relat
ON WINDOW-CLOSE OF w-relat /* Integraá∆o Notas ASTEC x CRM */
DO:
...
{utp/ut9000.i "ESFTP9007" "1.11.00.001"}  
...
------------------------------------------------------------------------------*/
  ...
  DISPLAY dt-emis-nota-ini dt-emis-nota-fim c-cod-estabel-ini c-cod-estabel-fim 
          c-serie-ini c-serie-fim c-nr-nota-fis-ini c-nr-nota-fis-fim 
          c-nr-pedcli-ini c-nr-pedcli-fim 
      WITH FRAME f-pg-sel IN WINDOW w-relat.
  ENABLE IMAGE-1 IMAGE-2 IMAGE-3 IMAGE-4 IMAGE-5 IMAGE-6 IMAGE-7 IMAGE-8 
         IMAGE-9 IMAGE-10 dt-emis-nota-ini dt-emis-nota-fim c-cod-estabel-ini 
         c-cod-estabel-fim c-serie-ini c-serie-fim c-nr-nota-fis-ini 
         c-nr-nota-fis-fim c-nr-pedcli-ini c-nr-pedcli-fim 
      WITH FRAME f-pg-sel IN WINDOW w-relat.
...
do on error undo, return error on stop  undo, return error:
    ...
    assign tt-param.usuario          = c-seg-usuario
           ...
           tt-param.i-execucao       = input frame f-pg-imp rs-execucao.
    ...
    {include/i-rprun.i esp/ftp/esftp9007rp.p}
