...
FOR EACH tt-digita
   BREAK BY tt-digita.nome-transp:
							  
    IF tt-param-aux.log-imp-notafiscal
    THEN DO:
        /*executado via esftp0528*/
        IF tt-param-aux.arquivo = "esftp0528.txt" THEN DO:
    ...
    IF tt-param-aux.rs-imprime = 2  // 2¯ Reimpress∆o
    OR tt-param-aux.log-imp-Estrutura
    OR tt-param-aux.log-imp-folhaRosto
    THEN DO:
        RUN esp/ftp/esftp222c.p (INPUT tt-digita.rw-nota-fiscal,
                                 INPUT tt-param-aux.log-imp-Estrutura,
                                 INPUT tt-param-aux.log-imp-folhaRosto,
...
FOR EACH ttArquivo:
    //OS-DELETE VALUE(SESSION:TEMP-DIRECTORY + ttArquivo.nomeArquivo).
END.
   ...
   ELSE DO:
      FOR EACH ttArquivo NO-LOCK:
         ...
         IF tt-param-aux.arquivo = "esftp0528.txt" THEN DO:
             ...
             OS-COPY VALUE(c-dir-tmp + ttArquivo.nomeArquivo) VALUE(TRIM(param-gener.cod-valor) + "\DANFE\" + nota-fiscal.cod-chave-aces-nf-eletro + ".pdf").
             OS-DELETE VALUE(c-dir-tmp + ttArquivo.nomeArquivo) NO-ERROR.
         END.
         ELSE 
