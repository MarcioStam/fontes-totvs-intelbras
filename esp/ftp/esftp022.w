...
&GLOBAL-DEFINE Program        ESFTP022
...
&GLOBAL-DEFINE page2Fields    fiCodEstabelIni fiCodEstabelFim fiDtEmissaoFim fiDtEmissaoIni fiEstadoFim ~
                              fiEstadoIni 
...
DEFINE FRAME fPage2
     ...
     fiCodEstabelIni    AT ROW 1.5 COL 18.71 
     fiCodEstabelFim    AT ROW 1.5 COL 47.29  NO-LABEL
     fiDtEmissaoIni AT ROW 2.5 COL 13.71
     fiDtEmissaoFim AT ROW 2.5 COL 47.29 NO-LABEL
     fiEstadoIni    AT ROW 3.58 COL 28.14 HELP "Unidade da federa‡Æo"
     fiEstadoFim    AT ROW 3.58 COL 47.29 HELP "Unidade da federa‡Æo" NO-LABEL
     IMAGE-1        AT ROW 1.5 COL 37.29
     IMAGE-2        AT ROW 1.5 COL 43.29
     IMAGE-3        AT ROW 2.5 COL 37.29
     IMAGE-4        AT ROW 2.5 COL 43.29

     IMAGE-15       AT ROW 3.58 COL 37.29
     IMAGE-16       AT ROW 3.58 COL 43.29
...
------------------------------------------------------------------------------*/
    ASSIGN fiDtEmissaoIni   = TODAY /*DATE(MONTH(TODAY),01,YEAR(TODAY))*/
           ...
           find first estabelec where 
                      estabelec.cod-estabel =  v_cod_estab_usuar no-lock no-error.
           if avail estabelec then 
           assign fiEstadoIni = estabelec.estado
                  fiEstadoFim = estabelec.estado.
...
do on error undo, return error on stop  undo, return error:
    ...
    DO WITH FRAME fPage2:
        ASSIGN tt-param.DtEmissaoIni    = INPUT fiDtEmissaoIni 
               ...
               tt-param.cod-estabel-ini = INPUT fiCodEstabelIni
               tt-param.cod-estabel-fim = INPUT fiCodEstabelFim.
    ...
    {report/rprun.i esp/ftp/esftp022rp.p}
