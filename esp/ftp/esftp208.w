...
*******************************************************************************/
{include/i-prgvrs.i esftp208 2.00.00.000}
...
DEFINE VARIABLE i-cod-representante-fim AS INTEGER FORMAT ">>>>9":U INITIAL 0 
     VIEW-AS FILL-IN 
     SIZE 8.86 BY .88 NO-UNDO.

DEFINE VARIABLE i-cod-representante-ini AS INTEGER FORMAT ">>>>9":U INITIAL 0 
     LABEL "Representante" 
     VIEW-AS FILL-IN 
     SIZE 8.86 BY .88 NO-UNDO.
...
DEFINE FRAME f-pg-sel
     c-periodo-mes AT ROW 2.5 COL 12 COLON-ALIGNED WIDGET-ID 14
     c-periodo-ano AT ROW 2.5 COL 16.29 COLON-ALIGNED NO-LABEL WIDGET-ID 22
     i-cod-representante-ini AT ROW 3.5 COL 12 COLON-ALIGNED WIDGET-ID 10
     i-cod-representante-fim AT ROW 3.5 COL 28.14 COLON-ALIGNED NO-LABEL WIDGET-ID 12
     rs-import-excluir AT ROW 5.71 COL 12 NO-LABEL WIDGET-ID 2
     "/" VIEW-AS TEXT
          SIZE 1 BY .54 AT ROW 2.67 COL 17.14 WIDGET-ID 20
     "Fun‡Æo:" VIEW-AS TEXT
          SIZE 7 BY .54 AT ROW 5 COL 11 WIDGET-ID 8
     IMAGE-1 AT ROW 3.5 COL 23 WIDGET-ID 16
     IMAGE-2 AT ROW 3.5 COL 27.14 WIDGET-ID 18
     RECT-12 AT ROW 5.17 COL 10 WIDGET-ID 6
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 3 ROW 2.85
         SIZE 76.86 BY 10.62
...
{utp/ut9000.i "esftp208" "2.00.00.000"}
...
------------------------------------------------------------------------------*/
  ...
  DISPLAY c-periodo-mes c-periodo-ano i-cod-representante-ini 
          i-cod-representante-fim rs-import-excluir 
      WITH FRAME f-pg-sel IN WINDOW w-relat.
  ENABLE IMAGE-1 IMAGE-2 RECT-12 c-periodo-mes c-periodo-ano 
         i-cod-representante-ini i-cod-representante-fim rs-import-excluir 
      WITH FRAME f-pg-sel IN WINDOW w-relat.
...
do on error undo, return error on stop  undo, return error:
    ...
    assign tt-param.usuario     = c-seg-usuario
           ...
           tt-param.periodo-mes = INPUT FRAME f-pg-sel c-periodo-mes          
           tt-param.periodo-ano = INPUT FRAME f-pg-sel c-periodo-ano          
           tt-param.cod-rep-ini = INPUT FRAME f-pg-sel i-cod-representante-ini
           tt-param.cod-rep-fim = INPUT FRAME f-pg-sel i-cod-representante-fim
           tt-param.id-opcao    = INPUT FRAME f-pg-sel rs-import-excluir       
           .
    ...
    {include/i-rprun.i esp/ftp/esftp208rp.p}
