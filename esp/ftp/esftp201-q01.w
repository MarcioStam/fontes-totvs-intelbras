...
&Scoped-define QUERY-STRING-Query-Main FOR EACH int-executivo NO-LOCK
&Scoped-define OPEN-QUERY-Query-Main OPEN QUERY Query-Main FOR EACH int-executivo NO-LOCK.
&Scoped-define TABLES-IN-QUERY-Query-Main int-executivo
&Scoped-define FIRST-TABLE-IN-QUERY-Query-Main int-executivo
