...
*******************************************************************************/
{include/i-prgvrs.i esftp132 2.00.00.000}
...
DEFINE VARIABLE d-dt-venc-ini AS DATE FORMAT "99/99/9999":U INITIAL 01/01/2020
     LABEL "Dt Vencimento" 
     VIEW-AS FILL-IN 
     SIZE 10 BY .88 NO-UNDO.
...
{utp/ut9000.i "esftp132" "2.00.00.000"}
...
do on error undo, return error on stop  undo, return error:
    ...
    {include/i-rprun.i esp/ftp/esftp132rp.p}
