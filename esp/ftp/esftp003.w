...
&GLOBAL-DEFINE Program        ESFTP003
...
&GLOBAL-DEFINE page2Fields    fiDtEmissaoFim fiDtEmissaoIni  
...
DEFINE FRAME fPage2
     fiDtEmissaoIni AT ROW 1.5 COL 13.71
     fiDtEmissaoFim AT ROW 1.5 COL 47.29 NO-LABEL
...
------------------------------------------------------------------------------*/
    ASSIGN fiDtEmissaoIni   = DATE(MONTH(TODAY),01,YEAR(TODAY))
           fiDtEmissaoFim   = DATE(MONTH(fiDtEmissaoIni + 40),01,YEAR(TODAY)) - 1.
    rsTipoImpressao:DISABLE("Duplicidade") IN FRAME fPage4.
...
do on error undo, return error on stop  undo, return error:
    ...
    assign tt-param.usuario         = c-seg-usuario
           ...
           tt-param.iTipo           = INPUT FRAME fPage4 rsTipoImpressao.
    DO WITH FRAME fPage2:
        ASSIGN tt-param.da-emis-Ini    = INPUT fiDtEmissaoIni 
               tt-param.da-emis-Fim    = INPUT fiDtEmissaoFim.
    END.
           /*
    ...
    {report/rprun.i esp/ftp/esftp003rp.p}
