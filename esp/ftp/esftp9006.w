...
*******************************************************************************/
{include/i-prgvrs.i esftp9006 2.04.00.001}

CREATE WIDGET-POOL.

/* Preprocessors Definitions ---                                      */
&GLOBAL-DEFINE Program        esftp9006
...
&GLOBAL-DEFINE page2Fields    fiDtEmissaoIni editor-1
...
DEFINE VARIABLE EDITOR-1 AS CHARACTER INITIAL "************************* C U I D  A D O ************************** ATENCAO, ESTE PROCESSO DEVERA SER RODADO SOMENTE NA BASE DE TESTES  SOMENTE ATUALIZA O STATUS DAS NOTAS NÇO ATUALIZA ESTOQUE" 
     VIEW-AS EDITOR
     SIZE 72.14 BY 8.08
     FGCOLOR 12 FONT 0 NO-UNDO.

DEFINE VARIABLE fiDtEmissaoIni AS DATE FORMAT "99/99/99":U INITIAL ? 
     LABEL "Data Inicial" 
     VIEW-AS FILL-IN 
...
DEFINE FRAME fPage2
     EDITOR-1 AT ROW 3.5 COL 8 NO-LABEL WIDGET-ID 26
     fiDtEmissaoIni AT ROW 12.75 COL 12 COLON-ALIGNED WIDGET-ID 28
...
do on error undo, return error on stop  undo, return error:
    {report/rpexa.i}
    /* VERIFICA BASE (TESTE/PRODU€¶O) */
        DEFINE VARIABLE l-opcao AS LOGICAL     NO-UNDO.
    ...
    IF AVAILABLE tt-prog-ponto    THEN DO:
        ...
        MESSAGE "PROGRAMA SENDO EXECUTADO EM AMBIENTE OFICIAL, FAVOR CONFIRMAR!"
            VIEW-AS ALERT-BOX INFO BUTTONS YES-NO UPDATE l-opcao.
        IF l-opcao = NO THEN
            RETURN NO-APPLY.
    END.
    ...
    {report/rprun.i esp/ftp/esftp9006rp.p}
