...
*******************************************************************************/
{include/i-prgvrs.i ESFTP102 2.04.00.001}

CREATE WIDGET-POOL.

/* Preprocessors Definitions ---                                      */
&GLOBAL-DEFINE Program        ESFTP102
...
&GLOBAL-DEFINE page2Fields    fiCodEstabelIni fiCodEstabelFim ~
                              ...
                              fidupIni fiItCodigoFim fiItCodigoIni fiCdAtendente-ini fiCdAtendente-fim
...
DEFINE VARIABLE fiCdAtendente-fim AS CHARACTER FORMAT "X(256)":U INITIAL "80" 
     VIEW-AS FILL-IN 
     SIZE 4 BY .88
     FONT 1 NO-UNDO.

DEFINE VARIABLE ficdAtendente-ini AS CHARACTER FORMAT "X(256)":U INITIAL "80" 
     LABEL "Atendente" 
     VIEW-AS FILL-IN 
     SIZE 4 BY .88
     FONT 1 NO-UNDO.
...
------------------------------------------------------------------------------*/
    ASSIGN btUpdate:SENSITIVE IN FRAME fPage5 = NO.
    DISABLE ficdAtendente-ini WITH FRAME fPage2.
    DISABLE fiCdAtendente-fim WITH FRAME fPage2.
END PROCEDURE.
...
do on error undo, return error on stop  undo, return error:
    ...
    {report/rprun.i esp/ftp/esftp102rp.p}
