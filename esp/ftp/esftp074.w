...
*******************************************************************************/
{include/i-prgvrs.i ESFTP074 2.04.00.000}

CREATE WIDGET-POOL.

/* Preprocessors Definitions ---                                      */
&GLOBAL-DEFINE Program        ESFTP074
...
{esp/ftp/esftp074.i} /* Definiá∆o das temp-tables tt-param e tt-raw-digita */
...
DEFINE VARIABLE cCodEstabel AS CHARACTER FORMAT "X(256)":U INITIAL "101,104" 
...
DEFINE VARIABLE tb-Reenvia AS LOGICAL INITIAL no 
     LABEL "Reenvia e-mail" 
     VIEW-AS TOGGLE-BOX
...
DEFINE FRAME fPage2
     cCodEstabel AT ROW 3.75 COL 16 COLON-ALIGNED WIDGET-ID 6
     i-cod-emitente AT ROW 4.75 COL 16 COLON-ALIGNED HELP
          "Cliente Inicial"
     ...
     tb-Reenvia AT ROW 7.25 COL 19 WIDGET-ID 8
     "Informe separado" VIEW-AS TEXT
          SIZE 14 BY 1 AT ROW 3.5 COL 57 WIDGET-ID 2
     "por virgulas" VIEW-AS TEXT
          SIZE 13 BY .54 AT ROW 4.5 COL 57 WIDGET-ID 4
...
------------------------------------------------------------------------------*/
    ...
    DO ON ERROR UNDO, RETURN ERROR ON STOP UNDO, RETURN ERROR:
        ...
        {report/rprun.i esp/ftp/esftp074rp.p}
