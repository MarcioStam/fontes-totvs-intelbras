RUN pi-acompanhar IN h-acomp (INPUT "Nota / Item.: " + 
                        nota-fiscal.nr-nota-fis + " / " + 
                        item.it-codigo).

FIND LAST b-volume-nf NO-LOCK
     WHERE b-volume-nf.cod-estabel = volume-nf.cod-estabel AND
    ...
    IF nota-fiscal.cod-estabel = "999" OR
       nota-fiscal.cod-estabel = "301" THEN DO:
        ...
        IF AVAIL loc-entr THEN DO:
            ...
            PUT UNFORMAT "^FO390,105^CF0^A0N,40,35^FD" + c-sigla-transp + "^FS"  SKIP. /* SIGLA DA TRANSPORTADORA */
        ...
        ELSE DO:
            ...
            PUT UNFORMAT "^FO390,105^CF0^A0N,40,35^FD" + c-sigla-transp + "^FS"  SKIP. /* SIGLA DA TRANSPORTADORA na linha da cidade*/

        END. 
                    
        PUT  "^FO35,150^GB350,0,2^FS"
             "^FO35,160^CF0^AON,25,25^FDNF:" + string(nota-fiscal.nr-nota-fis,"9999999") + " VOL:" + string(volume-nf.nr-volume,">>>9") + "/" + trim(string(i-ult-volume,">>>9")) + "  " + c-desc-separa + "^FS" format "X(90)" SKIP.
...
ELSE DO:            /* Sem endere‡o */
        ...
        END.
            ...
            IF AVAIL loc-entr THEN DO:
                ...
                PUT UNFORMAT "^FO390,100^CF0^A0N,40,35^FD" + c-sigla-transp + "^FS"  SKIP. /* SIGLA DA TRANSPORTADORA */
...
*/
        ...
        PUT  "^FO35,140^GB350,0,2^FS" SKIP
             "^FO35,153^CF0^AON,35,35^FDNF:" + string(nota-fiscal.nr-nota-fis,"9999999") + " VOL:" + string(volume-nf.nr-volume,">>>9") + "/" + trim(string(i-ult-volume,">>>9")) + "  " + c-desc-separa + "^FS" format "X(80)" SKIP.
        ...
        if nota-fiscal.cod-estabel = "301" OR
           nota-fiscal.cod-estabel = "999" then do:
            put "^FO35,215^CF0^AAN,25,25^FD TRANSP.: " + transporte.nome     format "x(80)".
...
IF c-descricao = "" THEN
   ASSIGN c-descricao = (IF volume-nf.it-codigo <> '' THEN item.desc-item ELSE '').
