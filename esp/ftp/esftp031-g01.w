...
*******************************************************************************/
{include/i-prgvrs.i ESFTP031-G01 1.00.00.001}
...
&Scoped-Define ENABLED-OBJECTS rt-button i_cod-solicitacao bt-ok bt-cancela ~
bt-ajuda 
&Scoped-Define DISPLAYED-OBJECTS i_cod-solicitacao 
...
DEFINE VARIABLE i_cod-solicitacao AS INTEGER FORMAT ">>>>>>>>>9":U INITIAL 0 
     LABEL "Solicitacao" 
     VIEW-AS FILL-IN 
...
DEFINE FRAME d-vapara
     i_cod-solicitacao AT ROW 2.13 COL 30 COLON-ALIGNED WIDGET-ID 6
    ...
    WITH VIEW-AS DIALOG-BOX KEEP-TAB-ORDER 
         ...
         TITLE "V  Para Solicitacao - Item Fat"
...
ON GO OF FRAME d-vapara /* V  Para Solicitacao - Item Fat */
DO:
FIND lib-item-fat NO-LOCK
    WHERE lib-item-fat.cod-solicitacao EQ INPUT FRAME {&FRAME-NAME} i_cod-solicitacao NO-ERROR.

IF NOT AVAILABLE lib-item-fat THEN DO:
    {utp/ut-table.i mgesp lib-item-fat 1}
    RUN utp/ut-msgs.p(INPUT "show",
                      INPUT 2,
                      INPUT RETURN-VALUE).
    RETURN NO-APPLY.
END.
ASSIGN p-row-tabela = ROWID(lib-item-fat).
END.
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL d-vapara d-vapara
ON WINDOW-CLOSE OF FRAME d-vapara /* V  Para Solicitacao - Item Fat */
DO:  
...
------------------------------------------------------------------------------*/
  DISPLAY i_cod-solicitacao 
      WITH FRAME d-vapara.
  ENABLE rt-button i_cod-solicitacao bt-ok bt-cancela bt-ajuda 
      WITH FRAME d-vapara.
  VIEW FRAME d-vapara.
...
------------------------------------------------------------------------------*/
  ...
  {utp/ut9000.i "ESFTP031-G01" "1.00.00.001"}
