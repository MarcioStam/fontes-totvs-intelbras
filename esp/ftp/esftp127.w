...
*******************************************************************************/
{include/i-prgvrs.i esftp127 2.00.00.000}
...
DEFINE VARIABLE d-dt-emis-ini AS DATE FORMAT "99/99/9999":U INITIAL 01/01/001 
     LABEL "Dt. Emiss∆o" 
     VIEW-AS FILL-IN 
     SIZE 15 BY .88 NO-UNDO.
...
DEFINE FRAME f-pg-sel
     ...
     d-dt-emis-ini AT ROW 2.25 COL 15 COLON-ALIGNED WIDGET-ID 4
     d-dt-emis-fim AT ROW 2.25 COL 48.14 COLON-ALIGNED NO-LABEL WIDGET-ID 2
...
{utp/ut9000.i "esftp127" "2.00.00.000"}
...
------------------------------------------------------------------------------*/
  ...
  DISPLAY c-cod-estabel-ini c-cod-estabel-fim d-dt-emis-ini d-dt-emis-fim 
...
do on error undo, return error on stop  undo, return error:
    ...
    {include/i-rprun.i esp/ftp/esftp127rp.p}
