...
*******************************************************************************/
{include/i-prgvrs.i ESFTP086 2.04.00.001}

CREATE WIDGET-POOL.

/* Preprocessors Definitions ---                                      */
&GLOBAL-DEFINE Program        ESFTP086
...
&GLOBAL-DEFINE page2Fields    tb-digitado tb-a-liberar tb-a-relacionar dt-data-corte
...
DEFINE VARIABLE dt-data-corte AS DATE FORMAT "99/99/9999":U 
     LABEL "Data de Corte" 
     VIEW-AS FILL-IN 
     SIZE 15 BY .79 NO-UNDO.

DEFINE VARIABLE tb-a-liberar AS LOGICAL INITIAL yes 
     LABEL "A Liberar" 
     VIEW-AS TOGGLE-BOX
     SIZE 25 BY 1.75 NO-UNDO.

DEFINE VARIABLE tb-a-relacionar AS LOGICAL INITIAL yes 
     LABEL "A Relacionar" 
     VIEW-AS TOGGLE-BOX
     SIZE 25 BY 1.75 NO-UNDO.

DEFINE VARIABLE tb-digitado AS LOGICAL INITIAL yes 
     LABEL "Digitado" 
     VIEW-AS TOGGLE-BOX
...
DEFINE FRAME fPage2
     tb-digitado AT ROW 2.75 COL 34 WIDGET-ID 26
     tb-a-liberar AT ROW 3.5 COL 34 WIDGET-ID 30
     tb-a-relacionar AT ROW 4.75 COL 34 WIDGET-ID 28
     dt-data-corte AT ROW 6.75 COL 32 COLON-ALIGNED WIDGET-ID 32
...
/*------------------------------------------------------------------------------
  ...
  Notes:       
------------------------------------------------------------------------------*/
ASSIGN dt-data-corte:SCREEN-VALUE IN FRAME fPage2 = string(TODAY - 90).
END PROCEDURE.
...
do on error undo, return error on stop  undo, return error:
    ...
    DO  WITH FRAME fPage2:
        ASSIGN  tt-param.digitado              = INPUT tb-digitado
                tt-param.a-liberar             = INPUT tb-a-liberar
                tt-param.a-relacionar          = INPUT tb-a-relacionar
                tt-param.da-dt-corte           = INPUT dt-data-corte. 
    ...
    {report/rprun.i esp/ftp/esftp086rp.p}
