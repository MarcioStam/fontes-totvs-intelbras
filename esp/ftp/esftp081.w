...
DEFINE TEMP-TABLE tt-usuario-impressora NO-UNDO LIKE usuario-impressora
       field r-rowid as rowid.
...
*******************************************************************************/
{include/i-prgvrs.i ESFTP081 2.00.00.001}

CREATE WIDGET-POOL.

/* Preprocessors Definitions ---                                      */
&GLOBAL-DEFINE Program          ESFTP081
&GLOBAL-DEFINE Version          2.00.00.001

&GLOBAL-DEFINE Folder           YES
&GLOBAL-DEFINE InitialPage      1
&GLOBAL-DEFINE FolderLabels     Exceá‰es
...
&GLOBAL-DEFINE hDBOParent       h-boes571
&GLOBAL-DEFINE DBOParentTable   impressora-padrao
&GLOBAL-DEFINE DBOParentDestroy YES

&GLOBAL-DEFINE ttSon1           tt-usuario-impressora
&GLOBAL-DEFINE hDBOSon1         h-boes572
&GLOBAL-DEFINE DBOSon1Table     usuario-impressora
&GLOBAL-DEFINE DBOSon1Destroy   YES

&GLOBAL-DEFINE page0Fields      tt-impressora-padrao.cod-estabel tt-impressora-padrao.serie tt-impressora-padrao.impressora
...
&Scoped-define INTERNAL-TABLES tt-usuario-impressora

/* Definitions for BROWSE brSon1                                        */
&Scoped-define FIELDS-IN-QUERY-brSon1 tt-usuario-impressora.cod-usuario ~
tt-usuario-impressora.impressora 
&Scoped-define ENABLED-FIELDS-IN-QUERY-brSon1 
&Scoped-define QUERY-STRING-brSon1 FOR EACH tt-usuario-impressora NO-LOCK
&Scoped-define OPEN-QUERY-brSon1 OPEN QUERY brSon1 FOR EACH tt-usuario-impressora NO-LOCK.
&Scoped-define TABLES-IN-QUERY-brSon1 tt-usuario-impressora
&Scoped-define FIRST-TABLE-IN-QUERY-brSon1 tt-usuario-impressora
...
btReportsJoins btExit btHelp c-nome-estabel 
...
DEFINE QUERY brSon1 FOR 
      tt-usuario-impressora SCROLLING.
&ANALYZE-RESUME
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS brSon1 wMasterDetail _STRUCTURED
  QUERY brSon1 NO-LOCK DISPLAY
      tt-usuario-impressora.cod-usuario FORMAT "x(12)":U
      tt-usuario-impressora.impressora FORMAT "x(100)":U WIDTH 69.29
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
...
DEFINE FRAME fPage0
     ...
     btHelp AT ROW 1.13 COL 86.86 HELP
          "Ajuda"
     tt-impressora-padrao.cod-estabel AT ROW 2.75 COL 20 COLON-ALIGNED WIDGET-ID 2
          VIEW-AS FILL-IN 
          SIZE 6 BY .88
     c-nome-estabel AT ROW 2.75 COL 26.29 COLON-ALIGNED NO-LABEL WIDGET-ID 8
     tt-impressora-padrao.serie AT ROW 3.75 COL 20 COLON-ALIGNED WIDGET-ID 6
          VIEW-AS FILL-IN 
          SIZE 6 BY .88
     tt-impressora-padrao.impressora AT ROW 4.75 COL 20 COLON-ALIGNED WIDGET-ID 4
          VIEW-AS FILL-IN 
          SIZE 65 BY .88
...
/* Settings for THIS-PROCEDURE
   ...
   Temp-Tables and Buffers:
      ...
      ADDITIONAL-FIELDS:
          field r-rowid as rowid
      END-FIELDS.
      TABLE: tt-usuario-impressora T "?" NO-UNDO mgesp usuario-impressora
      ADDITIONAL-FIELDS:
          field r-rowid as rowid
      END-FIELDS.
   END-TABLES.
...
/* Query rebuild information for BROWSE brSon1
     _TblList          = "Temp-Tables.tt-usuario-impressora"
     _Options          = "NO-LOCK"
     _FldNameList[1]   = Temp-Tables.tt-usuario-impressora.cod-usuario
     _FldNameList[2]   > Temp-Tables.tt-usuario-impressora.impressora
"tt-usuario-impressora.impressora" ? ? "character" ? ? ? ? ? ? no ? no no "69.29" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
...
OR CHOOSE OF MENU-ITEM miAdd IN MENU mbMain DO:
    RUN addRecord IN THIS-PROCEDURE (INPUT "esp/ftp/esftp081a.w":U).
END.
...
DO:
    {masterdetail/addson.i &ProgramSon="esp/ftp/esftp081b.w"
                           &PageNumber="1"}
END.
...
OR CHOOSE OF MENU-ITEM miCopy IN MENU mbMain DO:
    RUN copyRecord (INPUT "esp/ftp/esftp081a.w":U).
END.
...
DO:
    {masterdetail/copyson.i &ProgramSon="esp/ftp/esftp081b.w"
                            &PageNumber="1"}
END.
...
OR CHOOSE OF MENU-ITEM miSearch IN MENU mbMain DO:
    {method/zoomreposition.i &ProgramZoom="eszoom/z01es571.w"}
END.
...
OR CHOOSE OF MENU-ITEM miUpdate IN MENU mbMain DO:
    RUN updateRecord IN THIS-PROCEDURE (INPUT "esp/ftp/esftp081a.w":U).
END.
...
DO:
    {masterdetail/updateson.i &ProgramSon="esp/ftp/esftp081b.w"
                              &PageNumber="1"}
END.
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL tt-impressora-padrao.cod-estabel wMasterDetail
ON LEAVE OF tt-impressora-padrao.cod-estabel IN FRAME fPage0 /* Estabelecimento */
DO:
    IF  AVAIL tt-impressora-padrao THEN DO:
...
------------------------------------------------------------------------------*/
    ...
    APPLY "LEAVE":U TO tt-impressora-padrao.cod-estabel IN FRAME fPage0.
...
------------------------------------------------------------------------------*/
    ...
    DEFINE FRAME fGoToRecord
        c-cod-estabel   AT ROW 1.21 COL 17.72 COLON-ALIGNED VIEW-AS FILL-IN SIZE 6 BY 0.88
        c-serie         AT ROW 2.21 COL 17.72 COLON-ALIGNED VIEW-AS FILL-IN SIZE 6 BY 0.88
        btGoToOK        AT ROW 3.63 COL 2.14
        btGoToCancel    AT ROW 3.63 COL 13
        rtGoToButton    AT ROW 3.38 COL 1
        SPACE(0.28)
        WITH VIEW-AS DIALOG-BOX KEEP-TAB-ORDER SIDE-LABELS NO-UNDERLINE 
             THREE-D SCROLLABLE TITLE "V† Para Impressora Padr∆o" FONT 1
             DEFAULT-BUTTON btGoToOK CANCEL-BUTTON btGoToCancel.
                                         
    ON "CHOOSE":U OF btGoToOK IN FRAME fGoToRecord DO:
        ASSIGN c-cod-estabel c-serie .
        
        /*:T Posiciona query, do DBO, atravÇs dos valores do °ndice £nico */
        RUN goToKey IN {&hDBOParent} (INPUT c-cod-estabel , INPUT c-serie ).
        IF RETURN-VALUE = "NOK":U THEN DO:
            RUN utp/ut-msgs.p (INPUT "SHOW":U, INPUT 2, INPUT "Impressora Padr∆o":U).
            RETURN NO-APPLY.
        END.
    ...
    ENABLE c-cod-estabel c-serie  btGoToOK btGoToCancel 
...
------------------------------------------------------------------------------*/
    ...
    IF NOT VALID-HANDLE({&hDBOParent}) OR
       ...
       {&hDBOParent}:FILE-NAME <> "esbo/boes571.p":U THEN DO:
        {btb/btb008za.i1 esbo/boes571.p YES}
        {btb/btb008za.i2 esbo/boes571.p '' {&hDBOParent}} 
    END.
    ...
    IF NOT VALID-HANDLE({&hDBOSon1}) OR 
       ...
       {&hDBOSon1}:FILE-NAME <> "esbo/boes572.p":U THEN DO:
        {btb/btb008za.i1 esbo/boes572.p YES}
        {btb/btb008za.i2 esbo/boes572.p '' {&hDBOSon1}} 
    END.
...
------------------------------------------------------------------------------*/
    ...
    {masterdetail/openqueriesson.i &Parent="ImpPadrao"
                                   &Query="EstabSerie"
                                   &PageNumber="1"}
