...
DEFINE VARIABLE h_esftp038-b01 AS HANDLE NO-UNDO.
...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW w-pesquisa ASSIGN
         HIDDEN             = YES
         TITLE              = "Pesquisa de Unidade de Negocio"
         HEIGHT             = 17
         WIDTH              = 90
         MAX-HEIGHT         = 28.33
         MAX-WIDTH          = 195.14
...
ON END-ERROR OF w-pesquisa /* Pesquisa de Unidade de Negocio */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL w-pesquisa w-pesquisa
ON WINDOW-CLOSE OF w-pesquisa /* Pesquisa de Unidade de Negocio */
DO:
...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 1 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'esp/ftp/esftp038-b01.w':U ,
             INPUT  FRAME f-zoom:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_esftp038-b01 ).
       RUN set-position IN h_esftp038-b01 ( 3.25 , 6.00 ) NO-ERROR.
       /* Size in UIB:  ( 10.17 , 80.14 ) */

       /* Links to SmartBrowser h_esftp038-b01. */
       RUN add-link IN adm-broker-hdl ( h_esftp038-b01 , 'State':U , THIS-PROCEDURE ).

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_esftp038-b01 ,
             h_folder , 'AFTER':U ).
    END. /* Page 1 */
