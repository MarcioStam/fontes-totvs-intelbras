...
&GLOBAL-DEFINE Program        ESFTP125
...
&GLOBAL-DEFINE page4Widgets   tg-pos tg-inv rs-tipo rs-diario
...
&GLOBAL-DEFINE page2Fields    c-item-ini c-item-fim c-data-ini c-data-fim
...
DEFINE VARIABLE c-data-ini AS DATE FORMAT "99/99/9999":U INITIAL 01/01/001 
     LABEL "Data" 
     VIEW-AS FILL-IN 
     SIZE 10 BY .88
     FONT 1 NO-UNDO.
...
DEFINE VARIABLE rs-diario AS INTEGER 
...
DEFINE VARIABLE tg-inv AS LOGICAL INITIAL yes 
     LABEL "Invent†rio" 
     VIEW-AS TOGGLE-BOX
     SIZE 10 BY .83 NO-UNDO.

DEFINE VARIABLE tg-pos AS LOGICAL INITIAL yes 
     LABEL "Vendas" 
     VIEW-AS TOGGLE-BOX
     SIZE 10 BY .83 NO-UNDO.
...
DEFINE FRAME fPage2
     c-item-ini AT ROW 2 COL 16.28
     c-item-fim AT ROW 2 COL 54.14 NO-LABEL
     c-data-ini AT ROW 3 COL 21.86 WIDGET-ID 4
     c-data-fim AT ROW 3 COL 54.14 NO-LABEL WIDGET-ID 2
     IMAGE-1 AT ROW 2 COL 35.86
     IMAGE-2 AT ROW 2 COL 51.14
...
DEFINE FRAME fPage4
     tg-pos AT ROW 2.5 COL 21 WIDGET-ID 10
     tg-inv AT ROW 3.5 COL 21 WIDGET-ID 12
     rs-tipo AT ROW 5.29 COL 24 NO-LABEL WIDGET-ID 20
     rs-diario AT ROW 7 COL 24 NO-LABEL WIDGET-ID 26
     "Arquivos" VIEW-AS TEXT
          SIZE 6 BY .5 AT ROW 1.75 COL 18 WIDGET-ID 16
     RECT-10 AT ROW 2 COL 16 WIDGET-ID 14
     RECT-11 AT ROW 5.04 COL 16 WIDGET-ID 18
     RECT-12 AT ROW 6.75 COL 16 WIDGET-ID 24
    WITH 1 DOWN KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 3.57 ROW 2.81
         SIZE 84.43 BY 10.15
...
do on error undo, return error on stop  undo, return error:
    ...
    assign tt-param.usuario         = c-seg-usuario
           ...
           tt-param.l-pos           = input frame fPage4 tg-pos
           tt-param.l-inv           = input frame fPage4 tg-inv
           tt-param.tipo            = input frame fPage4 rs-tipo
           tt-param.i-diario        = input frame fPage4 rs-diario
           &IF "{&RTF}":U = "YES":U &THEN
    ...
    {report/rprun.i esp/ftp/esftp125rp.p}
