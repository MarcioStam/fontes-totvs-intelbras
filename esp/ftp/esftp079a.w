...
DEFINE VARIABLE h_esftp079a-q01 AS HANDLE NO-UNDO.
DEFINE VARIABLE h_esftp079a-v01 AS HANDLE NO-UNDO.
...
DEFINE FRAME f-cad
     bt-ok AT ROW 3.67 COL 2.29 HELP
          "Salva e sai"
     bt-save AT ROW 3.67 COL 12.72 HELP
          "Salva e cria novo"
     bt-cancela AT ROW 3.67 COL 23.29 HELP
          "Cancela"
     bt-ajuda AT ROW 3.67 COL 70.43
...
DO:
{include/okfil.i h_esftp079a-v01}
END.
...
DO:
{include/salvafil.i h_esftp079a-v01}
END.
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'esp/ftp/esftp079a-v01.w':U ,
             INPUT  FRAME f-cad:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_esftp079a-v01 ).
       RUN set-position IN h_esftp079a-v01 ( 1.50 , 2.00 ) NO-ERROR.
       /* Size in UIB:  ( 1.33 , 79.00 ) */

       RUN init-object IN THIS-PROCEDURE (
             INPUT  'esp/ftp/esftp079a-q01.w':U ,
             INPUT  FRAME f-cad:HANDLE ,
             INPUT  '':U ,
             OUTPUT h_esftp079a-q01 ).
       RUN set-position IN h_esftp079a-q01 ( 1.00 , 55.00 ) NO-ERROR.
       /* Size in UIB:  ( 1.63 , 7.72 ) */

       /* Links to SmartViewer h_esftp079a-v01. */
       RUN add-link IN adm-broker-hdl ( h_esftp079a-q01 , 'Record':U , h_esftp079a-v01 ).
       RUN add-link IN adm-broker-hdl ( THIS-PROCEDURE , 'TableIO':U , h_esftp079a-v01 ).

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_esftp079a-v01 ,
...
------------------------------------------------------------------------------*/
  ...
  {utp/ut9000.i "esftp079a" "2.00.00.000"}

  /* Dispatch standard ADM method.                             */
  RUN dispatch IN THIS-PROCEDURE ( INPUT 'initialize':U ) .

  run pi-atualiza-parent in h_esftp079a-v01 (input v-row-parent).
...
/*------------------------------------------------------------------------------
  ...
  Notes:       
------------------------------------------------------------------------------*/
  RUN pi-reposiciona-query IN h_esftp079a-q01 (input v-row-table).
