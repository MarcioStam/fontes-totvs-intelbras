...
&Scoped-define QUERY-STRING-Query-Main FOR EACH int-execsuperv-calc ~
      WHERE int-execsuperv-calc.idi-tipo = 1 NO-LOCK
&Scoped-define OPEN-QUERY-Query-Main OPEN QUERY Query-Main FOR EACH int-execsuperv-calc ~
      WHERE int-execsuperv-calc.idi-tipo = 1 NO-LOCK.
&Scoped-define TABLES-IN-QUERY-Query-Main int-execsuperv-calc
&Scoped-define FIRST-TABLE-IN-QUERY-Query-Main int-execsuperv-calc
