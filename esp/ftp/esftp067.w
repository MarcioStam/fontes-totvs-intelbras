...
*******************************************************************************/
{include/i-prgvrs.i esftp067 2.00.00.000}
...
DEFINE VARIABLE dt-emis-nota-fim AS DATE FORMAT "99/99/9999":U INITIAL ? 
     VIEW-AS FILL-IN 
     SIZE 15 BY .88 NO-UNDO.

DEFINE VARIABLE dt-emis-nota-ini AS DATE FORMAT "99/99/9999":U INITIAL ? 
     LABEL "Emiss∆o" 
     VIEW-AS FILL-IN 
     SIZE 15 BY .88 NO-UNDO.
...
DEFINE FRAME f-pg-sel
     dt-emis-nota-ini AT ROW 1.25 COL 15 COLON-ALIGNED
     dt-emis-nota-fim AT ROW 1.25 COL 48.14 COLON-ALIGNED NO-LABEL
...
{utp/ut9000.i "esftp067" "2.00.00.000"}
...
------------------------------------------------------------------------------*/
  ...
  DISPLAY dt-emis-nota-ini dt-emis-nota-fim 
      WITH FRAME f-pg-sel IN WINDOW w-relat.
  ENABLE IMAGE-1 IMAGE-2 dt-emis-nota-ini dt-emis-nota-fim 
      WITH FRAME f-pg-sel IN WINDOW w-relat.
...
do on error undo, return error on stop  undo, return error:
    ...
    {include/i-rprun.i esp/ftp/esftp067rp.p}
