...
&Scoped-define QUERY-STRING-Query-Main FOR EACH int-execsuperv-calc NO-LOCK
&Scoped-define OPEN-QUERY-Query-Main OPEN QUERY Query-Main FOR EACH int-execsuperv-calc NO-LOCK.
