...
*******************************************************************************/
{include/i-prgvrs.i ESFTP087 2.04.00.001}

CREATE WIDGET-POOL.

/* Preprocessors Definitions ---                                      */
&GLOBAL-DEFINE Program        ESFTP087
...
&GLOBAL-DEFINE page2Widgets   fi-fim-cod-emitente fi-fim-data~
                              ...
                              fi-ini-data fi-ini-nat-operacao fi-ini-uf fi-ini-cod-estabel fi-fim-cod-estabel  fi-ini-it-codigo fi-fim-it-codigo ~
                              fi-fm-codigo-ini fi-fm-codigo-fim l-faturamento-total c-cfop
...
DEFINE VARIABLE c-cfop AS CHARACTER INITIAL "1201,1202,1203,1204,1410,1411,2201,2202,2203,2204,2410,2411" 
...
DEFINE VARIABLE fi-fim-nat-operacao AS CHARACTER FORMAT "x(06)" INITIAL "799999" 
     VIEW-AS FILL-IN 
...
DEFINE VARIABLE fi-ini-nat-operacao AS CHARACTER FORMAT "x(06)" INITIAL "510000" 
     LABEL "Natureza":R15 
     VIEW-AS FILL-IN 
     SIZE 8 BY .88 NO-UNDO.
...
DEFINE VARIABLE l-faturamento-total AS LOGICAL INITIAL no 
     LABEL "Listar Notas Faturamento Total" 
     VIEW-AS TOGGLE-BOX
...
DEFINE FRAME fPage2
     fi-ini-cod-estabel AT ROW 2.25 COL 23 COLON-ALIGNED HELP
          "Cod. Estabelecimento" WIDGET-ID 10
     fi-fim-cod-estabel AT ROW 2.25 COL 52 COLON-ALIGNED HELP
          "Cod. Estabelecimento" NO-LABEL WIDGET-ID 12
     fi-ini-nat-operacao AT ROW 3.25 COL 23 COLON-ALIGNED HELP
          "Natureza da Operaá∆o"
     fi-fim-nat-operacao AT ROW 3.25 COL 52 COLON-ALIGNED HELP
          "Natureza da Operaá∆o" NO-LABEL
     fi-ini-cod-emitente AT ROW 4.25 COL 23 COLON-ALIGNED
     fi-fim-cod-emitente AT ROW 4.25 COL 52 COLON-ALIGNED NO-LABEL
     fi-ini-data AT ROW 5.25 COL 23 COLON-ALIGNED
     fi-fim-data AT ROW 5.25 COL 52 COLON-ALIGNED NO-LABEL
     fi-ini-uf AT ROW 6.25 COL 23 COLON-ALIGNED
     fi-fim-uf AT ROW 6.25 COL 52 COLON-ALIGNED NO-LABEL
     fi-ini-it-codigo AT ROW 7.25 COL 23 COLON-ALIGNED WIDGET-ID 20
     fi-fim-it-codigo AT ROW 7.25 COL 52 COLON-ALIGNED NO-LABEL WIDGET-ID 22
     fi-fm-codigo-ini AT ROW 8.25 COL 23 COLON-ALIGNED WIDGET-ID 26
     fi-fm-codigo-fim AT ROW 8.25 COL 52 COLON-ALIGNED NO-LABEL WIDGET-ID 24
     c-cfop AT ROW 9.75 COL 25 NO-LABEL WIDGET-ID 36
     l-faturamento-total AT ROW 14.5 COL 31 WIDGET-ID 34
     "CFOP de Devoluá∆o:" VIEW-AS TEXT
          SIZE 15 BY 1.5 AT ROW 9.5 COL 10 WIDGET-ID 44
     IMAGE-1 AT ROW 5.25 COL 38
     IMAGE-10 AT ROW 6.25 COL 51
     IMAGE-2 AT ROW 4.25 COL 51
     IMAGE-3 AT ROW 3.25 COL 38
     IMAGE-4 AT ROW 3.25 COL 51
     IMAGE-5 AT ROW 4.25 COL 38
     IMAGE-6 AT ROW 5.25 COL 51
     IMAGE-9 AT ROW 6.25 COL 38
     RECT-10 AT ROW 1 COL 2
     RECT-11 AT ROW 14.25 COL 2
     IMAGE-11 AT ROW 7.25 COL 51 WIDGET-ID 6
     IMAGE-12 AT ROW 7.25 COL 38 WIDGET-ID 8
     IMAGE-13 AT ROW 2.25 COL 38 WIDGET-ID 16
     IMAGE-14 AT ROW 2.25 COL 51 WIDGET-ID 18
     IMAGE-15 AT ROW 8.25 COL 51 WIDGET-ID 28
     IMAGE-16 AT ROW 8.25 COL 38 WIDGET-ID 30
...
do on error undo, return error on stop  undo, return error:
    ...
    assign tt-param.usuario          = c-seg-usuario
           ...
           tt-param.cfop-devolucao   = INPUT FRAME fPage2 c-cfop
           ...
           tt-param.faturamento-total    = INPUT FRAME fpage2 l-faturamento-total. 
    ...
    {report/rprun.i esp/ftp/esftp087rp.p}
