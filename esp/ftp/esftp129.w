...
*******************************************************************************/
{include/i-prgvrs.i ESFTP129 2.06.00.000}
/*------------------------------------------------------------------------
    File        : ESFTP129.W
    Description : Importador de vinculos entre NF e NS (numero s‚rie)
...
&GLOBAL-DEFINE Program        ESFTP129
...
&GLOBAL-DEFINE page4Fields    tg-emails c-emails fi-cod-estabel ed-descricao
...
DEFINE VARIABLE c-importacao     AS CHARACTER   NO-UNDO.
DEFINE VARIABLE c-processado     AS CHARACTER   NO-UNDO.
...
DEFINE VARIABLE fi-cod-estabel AS CHARACTER FORMAT "X(20)":U 
...
DEFINE FRAME fPage4
     ...
     fi-cod-estabel AT ROW 10.46 COL 21.14 COLON-ALIGNED WIDGET-ID 16
     "E-mail para alerta de erros" VIEW-AS TEXT
          SIZE 19 BY .54 AT ROW 6.46 COL 8.72 WIDGET-ID 12
     "Estabelecimento das Notas" VIEW-AS TEXT
          SIZE 19.29 BY .54 AT ROW 9.71 COL 7.72 WIDGET-ID 14
...
------------------------------------------------------------------------------*/
    ...
    RUN esp/es0018p.p (INPUT "ESFTP129", /* Nome do programa */
    ...
    FOR EACH tt-prog-ponto:
        CASE tt-prog-ponto.sequencia:
            ...
            WHEN 1 THEN ASSIGN fi-cod-estabel = tt-prog-ponto.conteudo.
    ...
    ASSIGN ed-descricao = "Diret¢rios definidos no ES0018. Rodar on-line ou no RPW Windows" + CHR(10) +
...
------------------------------------------------------------------------------*/
    ...
    DO ON ERROR UNDO, RETURN ERROR
       ON STOP  UNDO, RETURN ERROR:
        ...
        {report/rprun.i esp\ftp\esftp129rp.p}
