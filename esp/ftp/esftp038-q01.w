...
&Scoped-define INTERNAL-TABLES int-unid-negoc

/* Definitions for QUERY Query-Main                                     */
&Scoped-define QUERY-STRING-Query-Main FOR EACH int-unid-negoc NO-LOCK INDEXED-REPOSITION
&Scoped-define OPEN-QUERY-Query-Main OPEN QUERY Query-Main FOR EACH int-unid-negoc NO-LOCK INDEXED-REPOSITION.
&Scoped-define TABLES-IN-QUERY-Query-Main int-unid-negoc
&Scoped-define FIRST-TABLE-IN-QUERY-Query-Main int-unid-negoc
