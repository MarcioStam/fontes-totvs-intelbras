...
*******************************************************************************/
{include/i-prgvrs.i ESFTP038-G01 1.00.00.001}
...
&Scoped-Define ENABLED-OBJECTS rt-button c_cdn-unid-negoc bt-ok bt-cancela ~
bt-ajuda 
&Scoped-Define DISPLAYED-OBJECTS c_cdn-unid-negoc 
...
DEFINE VARIABLE c_cdn-unid-negoc AS CHARACTER FORMAT "x(3)":U 
...
DEFINE FRAME d-vapara
     c_cdn-unid-negoc AT ROW 1.96 COL 18.57 WIDGET-ID 2
    ...
    WITH VIEW-AS DIALOG-BOX KEEP-TAB-ORDER 
         ...
         FONT 4
         TITLE "V  Para - Unidade de Neg¢cio"
...
/* SETTINGS FOR FILL-IN c_cdn-unid-negoc IN FRAME d-vapara
   ALIGN-L                                                              */
...
ON GO OF FRAME d-vapara /* V  Para - Unidade de Neg¢cio */
DO:
FIND int-unid-negoc NO-LOCK
    WHERE int-unid-negoc.cod-unid-negoc EQ INPUT FRAME {&FRAME-NAME} c_cdn-unid-negoc NO-ERROR.

IF NOT AVAILABLE int-unid-negoc THEN DO:
    {utp/ut-table.i mgesp int-unid-negoc 1}
    RUN utp/ut-msgs.p(INPUT "show",
                      INPUT 2,
                      INPUT RETURN-VALUE).
    RETURN NO-APPLY.
END.
ASSIGN p-row-tabela = ROWID(int-unid-negoc).
END.
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL d-vapara d-vapara
ON WINDOW-CLOSE OF FRAME d-vapara /* V  Para - Unidade de Neg¢cio */
DO:  
...
------------------------------------------------------------------------------*/
  DISPLAY c_cdn-unid-negoc 
      WITH FRAME d-vapara.
  ENABLE rt-button c_cdn-unid-negoc bt-ok bt-cancela bt-ajuda 
      WITH FRAME d-vapara.
  VIEW FRAME d-vapara.
...
------------------------------------------------------------------------------*/
  ...
  {utp/ut9000.i "ESFTP038-G01" "1.00.00.001"}
