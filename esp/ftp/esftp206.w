...
DEFINE VARIABLE h_esftp206-b01 AS HANDLE NO-UNDO.
DEFINE VARIABLE h_esftp206-q01 AS HANDLE NO-UNDO.
DEFINE VARIABLE h_esftp206-v01 AS HANDLE NO-UNDO.
...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'esp/ftp/esftp206-v01.w':U ,
             INPUT  FRAME f-cad:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_esftp206-v01 ).
       RUN set-position IN h_esftp206-v01 ( 3.25 , 2.00 ) NO-ERROR.
       /* Size in UIB:  ( 2.75 , 88.57 ) */

       RUN init-object IN THIS-PROCEDURE (
             INPUT  'adm/objects/folder.w':U ,
             INPUT  FRAME f-cad:HANDLE ,
             INPUT  'FOLDER-LABELS = ':U + 'Lanc. DB/CR' + ',
                     FOLDER-TAB-TYPE = 1':U ,
             OUTPUT h_folder ).
       ...
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'esp/ftp/esftp206-q01.w':U ,
             INPUT  FRAME f-cad:HANDLE ,
             INPUT  'ProgPesquisa = esp/ftp/z01esftp206.w,
                     ProgVaPara = esp/ftp/g01esftp206.w,
                     ProgIncMod = ,
                     Implantar = no':U ,
             OUTPUT h_esftp206-q01 ).
       RUN set-position IN h_esftp206-q01 ( 1.25 , 59.00 ) NO-ERROR.
       /* Size in UIB:  ( 1.63 , 7.72 ) */

       /* Links to SmartPanel h_p-exihel. */
       RUN add-link IN adm-broker-hdl ( h_p-exihel , 'State':U , THIS-PROCEDURE ).

       /* Links to SmartViewer h_esftp206-v01. */
       RUN add-link IN adm-broker-hdl ( h_esftp206-q01 , 'Record':U , h_esftp206-v01 ).

       /* Links to SmartFolder h_folder. */
       RUN add-link IN adm-broker-hdl ( h_folder , 'Page':U , THIS-PROCEDURE ).

       /* Links to SmartQuery h_esftp206-q01. */
       RUN add-link IN adm-broker-hdl ( h_p-exihel , 'State':U , h_esftp206-q01 ).
       RUN add-link IN adm-broker-hdl ( h_p-navega , 'Navigation':U , h_esftp206-q01 ).
       RUN add-link IN adm-broker-hdl ( h_p-navega , 'State':U , h_esftp206-q01 ).

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_p-navega ,
             h_p-exihel , 'AFTER':U ).
       RUN adjust-tab-order IN adm-broker-hdl ( h_esftp206-v01 ,
             h_p-navega , 'AFTER':U ).
       RUN adjust-tab-order IN adm-broker-hdl ( h_folder ,
             h_esftp206-v01 , 'AFTER':U ).
    END. /* Page 0 */
    WHEN 1 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'esp/ftp/esftp206-b01.w':U ,
             INPUT  FRAME f-cad:HANDLE ,
             INPUT  'Initial-Lock = NO-LOCK,
                     ...
                     Create-On-Add = ?,
                     ProgAtributo = ,
                     ProgIncMod = esp/ftp/esftp206a.w,
                     MessageNum = 0,
                     MessageParam = ':U ,
             OUTPUT h_esftp206-b01 ).
       RUN set-position IN h_esftp206-b01 ( 9.25 , 2.00 ) NO-ERROR.
       /* Size in UIB:  ( 7.50 , 87.00 ) */

       /* Links to BrowserCadastro2 h_esftp206-b01. */
       RUN add-link IN adm-broker-hdl ( h_esftp206-q01 , 'Record':U , h_esftp206-b01 ).
       RUN add-link IN adm-broker-hdl ( h_esftp206-v01 , 'State':U , h_esftp206-b01 ).

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_esftp206-b01 ,
             h_folder , 'AFTER':U ).
    END. /* Page 1 */
...
------------------------------------------------------------------------------*/
  ...
  {utp/ut9000.i "esftp206" "2.00.00.000"}
