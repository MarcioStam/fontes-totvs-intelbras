...
DEFINE VARIABLE h_esftp201b-q01 AS HANDLE NO-UNDO.
DEFINE VARIABLE h_esftp201b-v01-2 AS HANDLE NO-UNDO.
...
DEFINE FRAME f-cad
     bt-ok AT ROW 14.5 COL 2 HELP
          "Salva e sai"
     bt-save AT ROW 14.5 COL 12.43 HELP
          "Salva e cria novo"
     bt-cancela AT ROW 14.5 COL 23 HELP
          "Cancela"
     bt-ajuda AT ROW 14.5 COL 79
     rt-button AT ROW 14.25 COL 1
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 1 ROW 1
         SIZE 89 BY 17 WIDGET-ID 100.
...
DO:
{include/okfil.i h_esftp201b-v01-2}
END.
...
DO:
{include/salvafil.i h_esftp201b-v01-2}
END.
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'esp/ftp/esftp201b-v01.w':U ,
             INPUT  FRAME f-cad:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_esftp201b-v01-2 ).
       RUN set-position IN h_esftp201b-v01-2 ( 1.00 , 1.00 ) NO-ERROR.
       /* Size in UIB:  ( 13.00 , 88.57 ) */

       RUN init-object IN THIS-PROCEDURE (
             INPUT  'esp/ftp/esftp201b-q01.w':U ,
             INPUT  FRAME f-cad:HANDLE ,
             INPUT  '':U ,
             OUTPUT h_esftp201b-q01 ).
       RUN set-position IN h_esftp201b-q01 ( 1.00 , 56.00 ) NO-ERROR.
       /* Size in UIB:  ( 1.63 , 7.72 ) */

       /* Links to SmartViewer h_esftp201b-v01-2. */
       RUN add-link IN adm-broker-hdl ( h_esftp201b-q01 , 'Record':U , h_esftp201b-v01-2 ).
       RUN add-link IN adm-broker-hdl ( THIS-PROCEDURE , 'TableIO':U , h_esftp201b-v01-2 ).

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_esftp201b-v01-2 ,
...
------------------------------------------------------------------------------*/
  ...
  {utp/ut9000.i "esftp201B" "2.00.00.000"}
  ...
  run pi-atualiza-parent in h_esftp201b-v01-2 (input v-row-parent).
...
/*------------------------------------------------------------------------------
  ...
  Notes:       
------------------------------------------------------------------------------*/
  RUN pi-reposiciona-query IN h_esftp201b-q01 (input v-row-table).
