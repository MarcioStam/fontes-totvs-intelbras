...
*******************************************************************************/
{include/i-prgvrs.i esftp042c 2.00.00.000}
...
ON END-ERROR OF w-relat /* Gerar arquivo PIN */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL w-relat w-relat
ON WINDOW-CLOSE OF w-relat /* Gerar arquivo PIN */
DO:
...
{utp/ut9000.i "esftp042c" "2.00.00.000"}
...
do on error undo, return error on stop  undo, return error:
    ...
    {include/i-rprun.i esp/ftp/esftp042crp.p}
