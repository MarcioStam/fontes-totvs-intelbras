...
&IF "{&EMSFND_VERSION}" >= "1.00" &THEN
    {include/i-license-manager.i esftp137 mft}
&ENDIF

CREATE WIDGET-POOL.

/* Preprocessors Definitions ---                                      */
&GLOBAL-DEFINE Program        esftp137
...
&GLOBAL-DEFINE page2Fields    cIniField cEndField tg-reimpressao
...
define temp-table tt-param no-undo
    ...
    FIELD de-etiq-ini       AS DEC
    FIELD de-etiq-fim       AS DEC
...
DEFINE VARIABLE cEndField AS DECIMAL FORMAT ">>>>>>>>>>>>>>9":U INITIAL 999999999999999 
     VIEW-AS FILL-IN 
     SIZE 15 BY .88
     FONT 1 NO-UNDO.

DEFINE VARIABLE cIniField AS DECIMAL FORMAT ">>>>>>>>>>>>>>9":U INITIAL 0 
     LABEL "Etiqueta Separaá∆o" 
     VIEW-AS FILL-IN 
     SIZE 15 BY .88
     FONT 1 NO-UNDO.
...
DEFINE FRAME fPage2
     cIniField AT ROW 1.5 COL 6.71
     cEndField AT ROW 1.5 COL 54.14 NO-LABEL
     tg-reimpressao AT ROW 4.25 COL 21 WIDGET-ID 2
...
FIND FIRST imprsor_usuar NO-LOCK
     WHERE imprsor_usuar.cod_usuario = c-seg-usuario
       AND log_imprsor_princ NO-ERROR.
IF AVAIL imprsor_usuar THEN DO:
    cFile:SCREEN-VALUE IN FRAME fpage6 = imprsor_usuar.nom_impressora + ":sem-layout".
END.
...
do on error undo, return error on stop  undo, return error:
    ...
    assign tt-param.usuario         = c-seg-usuario
           ...
           &endif
           tt-param.de-etiq-ini       = INPUT FRAME fpage2 cIniField
           tt-param.de-etiq-fim       = INPUT FRAME fpage2 cEndField
           tt-param.tg-reimpressao    = INPUT FRAME fpage2 tg-reimpressao
           tt-param.arquivo           = input frame fPage6 cFile.
    ...
    {report/rprun.i esp/ftp/esftp137rp.p}
