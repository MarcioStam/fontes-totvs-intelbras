...
*******************************************************************************/
{include/i-prgvrs.i esftp007 2.04.00.001}

CREATE WIDGET-POOL.

/* Preprocessors Definitions ---                                      */
&GLOBAL-DEFINE Program        esftp007
...
&GLOBAL-DEFINE page2Fields    fiCodEstabelIni fiCodEstabelFim ~
                              ...
                              fiDtEmissaoIni fiDtEmissaoFim ~
                              fiCodEmitenteFim fiCodEmitenteIni ~
                              fiItCodigoFim fiItCodigoIni 
...
DEFINE FRAME fPage2
     fiCodEstabelIni AT ROW 4 COL 19 COLON-ALIGNED
     fiCodEstabelFim AT ROW 4 COL 53 COLON-ALIGNED NO-LABEL
     fi-uf AT ROW 5 COL 19 COLON-ALIGNED WIDGET-ID 10
     ff-uf AT ROW 5 COL 53 COLON-ALIGNED NO-LABEL WIDGET-ID 12
     fiDtEmissaoIni AT ROW 6 COL 8.71
     fiDtEmissaoFim AT ROW 6 COL 55 NO-LABEL
     fiCodEmitenteIni AT ROW 7 COL 15.57
     fiCodEmitenteFim AT ROW 7 COL 55 NO-LABEL
     fiItCodigoIni AT ROW 8 COL 19 COLON-ALIGNED
     fiItCodigoFim AT ROW 8 COL 52.86 COLON-ALIGNED NO-LABEL
     IMAGE-1 AT ROW 6 COL 36.14
     IMAGE-2 AT ROW 6 COL 51.29
     IMAGE-5 AT ROW 7 COL 36.14
     IMAGE-6 AT ROW 7 COL 51.29
     IMAGE-21 AT ROW 4 COL 51.29
     IMAGE-22 AT ROW 4 COL 36.14
     IMAGE-35 AT ROW 5 COL 51.43 WIDGET-ID 14
     IMAGE-36 AT ROW 5 COL 36.29 WIDGET-ID 16
     IMAGE-37 AT ROW 8 COL 35.86 WIDGET-ID 22
     IMAGE-38 AT ROW 8 COL 51 WIDGET-ID 24
    WITH 1 DOWN KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
...
do on error undo, return error on stop  undo, return error:
    ...
    {report/rprun.i esp/ftp/esftp007rp.p}
