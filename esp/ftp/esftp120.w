...
&GLOBAL-DEFINE Program        ESFTP120
...
&GLOBAL-DEFINE page2Fields    c-item-ini c-item-fim c-uf-ini c-uf-fim ~
                              d-aliq-ini d-aliq-fim i-mensagem-ini i-mensagem-fim
...
DEFINE VARIABLE d-aliq-fim AS DECIMAL FORMAT ">>9.99":U INITIAL 100.00 
     VIEW-AS FILL-IN 
     SIZE 6 BY .88
     FONT 1 NO-UNDO.

DEFINE VARIABLE d-aliq-ini AS DECIMAL FORMAT ">>9.99":U INITIAL 0 
     LABEL "Aliquota ICMS" 
     VIEW-AS FILL-IN 
     SIZE 6 BY .88
     FONT 1 NO-UNDO.

DEFINE VARIABLE i-mensagem-fim AS INTEGER FORMAT ">>>>9":U INITIAL 99999 
     VIEW-AS FILL-IN 
     SIZE 6 BY .88
     FONT 1 NO-UNDO.

DEFINE VARIABLE i-mensagem-ini AS INTEGER FORMAT ">>>>9":U INITIAL 0 
     LABEL "Mensagem" 
     VIEW-AS FILL-IN 
     SIZE 6 BY .88
     FONT 1 NO-UNDO.
...
DEFINE FRAME fPage2
     c-item-ini AT ROW 1.5 COL 16.28
     c-item-fim AT ROW 1.5 COL 54.14 NO-LABEL
     c-uf-ini AT ROW 2.5 COL 29.14 WIDGET-ID 4
     c-uf-fim AT ROW 2.5 COL 54.14 NO-LABEL WIDGET-ID 2
     d-aliq-ini AT ROW 3.5 COL 19.57 WIDGET-ID 12
     d-aliq-fim AT ROW 3.5 COL 54.14 NO-LABEL WIDGET-ID 10
     i-mensagem-ini AT ROW 4.5 COL 21.71 WIDGET-ID 20
     i-mensagem-fim AT ROW 4.5 COL 54.14 NO-LABEL WIDGET-ID 18
...
/* SETTINGS FOR FILL-IN c-item-ini IN FRAME fPage2
   ALIGN-L                                                              */
/* SETTINGS FOR FILL-IN c-uf-fim IN FRAME fPage2
   ALIGN-L                                                              */
/* SETTINGS FOR FILL-IN c-uf-ini IN FRAME fPage2
   ALIGN-L                                                              */
/* SETTINGS FOR FILL-IN d-aliq-fim IN FRAME fPage2
   ALIGN-L                                                              */
/* SETTINGS FOR FILL-IN d-aliq-ini IN FRAME fPage2
   ALIGN-L                                                              */
/* SETTINGS FOR FILL-IN i-mensagem-fim IN FRAME fPage2
   ALIGN-L                                                              */
/* SETTINGS FOR FILL-IN i-mensagem-ini IN FRAME fPage2
   ALIGN-L                                                              */
...
do on error undo, return error on stop  undo, return error:
    ...
    assign tt-param.usuario         = c-seg-usuario
           ...
           tt-param.uf-ini          = input frame fPage2 c-uf-ini
           tt-param.uf-fim          = input frame fPage2 c-uf-fim
           tt-param.aliq-ini        = input frame fPage2 d-aliq-ini
           tt-param.aliq-fim        = input frame fPage2 d-aliq-fim
           tt-param.mensagem-ini    = input frame fPage2 i-mensagem-ini
           tt-param.mensagem-fim    = input frame fPage2 i-mensagem-fim
           &IF "{&RTF}":U = "YES":U &THEN
    ...
    {report/rprun.i esp/ftp/esftp120rp.p}
