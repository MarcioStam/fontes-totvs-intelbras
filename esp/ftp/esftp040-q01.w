...
&Scoped-define INTERNAL-TABLES param-lib-item-fat

/* Definitions for QUERY Query-Main                                     */
&Scoped-define QUERY-STRING-Query-Main FOR EACH param-lib-item-fat NO-LOCK
&Scoped-define OPEN-QUERY-Query-Main OPEN QUERY Query-Main FOR EACH param-lib-item-fat NO-LOCK.
&Scoped-define TABLES-IN-QUERY-Query-Main param-lib-item-fat
&Scoped-define FIRST-TABLE-IN-QUERY-Query-Main param-lib-item-fat
...
/* Query rebuild information for QUERY Query-Main
     _TblList          = "mgesp.param-lib-item-fat"
     _Options          = "NO-LOCK"
