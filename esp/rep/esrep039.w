...
*******************************************************************************/
{include/i-prgvrs.i ESREP039 2.04.00.000}

CREATE WIDGET-POOL.

/* Preprocessors Definitions ---                                      */
&GLOBAL-DEFINE Program        ESREP039
...
&GLOBAL-DEFINE page2Widgets   fi-cod-estab-ini fi-cod-estab-fim fi-fim-data  fi-ini-data rs-tipo
...
DEFINE VARIABLE fi-cod-estab-fim AS CHARACTER FORMAT "x(05)" 
     VIEW-AS FILL-IN 
     SIZE 6.14 BY .88.
...
DEFINE FRAME fPage2
     rs-tipo AT ROW 8.5 COL 26.14 NO-LABEL WIDGET-ID 44
     ...
     fi-ini-data AT ROW 5.13 COL 40.57 RIGHT-ALIGNED WIDGET-ID 4
     fi-fim-data AT ROW 5.13 COL 49.72 COLON-ALIGNED NO-LABEL WIDGET-ID 2
     "Tipo de Relat¢rio:" VIEW-AS TEXT
          SIZE 13 BY .54 AT ROW 7.42 COL 17.57 WIDGET-ID 50
     "Sele‡Æo:" VIEW-AS TEXT
          SIZE 6.43 BY .54 AT ROW 2.92 COL 17.57 WIDGET-ID 54
     IMAGE-35 AT ROW 5.13 COL 41.86 WIDGET-ID 6
     IMAGE-36 AT ROW 5.13 COL 48.43 WIDGET-ID 8
     IMAGE-37 AT ROW 4.13 COL 41.86 WIDGET-ID 38
     IMAGE-38 AT ROW 4.13 COL 48.43 WIDGET-ID 40
     RECT-20 AT ROW 7.67 COL 16.57 WIDGET-ID 48
     RECT-21 AT ROW 3.17 COL 16.57 WIDGET-ID 52
    WITH 1 DOWN KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 3.57 ROW 2.81
         SIZE 84.43 BY 10.15
...
------------------------------------------------------------------------------*/
    ...
    ASSIGN fi-ini-data:SCREEN-VALUE      IN FRAME fPage2 = STRING(TODAY,"99/99/9999")
           fi-ini-data:SCREEN-VALUE      IN FRAME fPage2 = STRING(TODAY,"99/99/9999")
           fi-cod-estab-ini:SCREEN-VALUE IN FRAME fPage2 = ""
           fi-cod-estab-fim:SCREEN-VALUE IN FRAME fPage2 = "ZZZZZ"
           rs-tipo:SCREEN-VALUE          IN FRAME fPage2 = "3".
...
do on error undo, return error on stop  undo, return error:
    ...
    {report/rprun.i esp/rep/esrep039rp.p}
