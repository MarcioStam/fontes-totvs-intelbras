...
*******************************************************************************/
{include/i-prgvrs.i esrep041 2.00.00.000}
...
DEFINE VARIABLE EDITOR-1 AS CHARACTER INITIAL "Envio de e-mail com lembrete para o agendamento de inspe‡Æo." 
     VIEW-AS EDITOR
...
DEFINE FRAME f-pg-sel
     EDITOR-1 AT ROW 1.5 COL 3 NO-LABEL WIDGET-ID 2
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 3 ROW 2.85
...
{utp/ut9000.i "ESREP041" "2.00.00.000"}
...
do on error undo, return error on stop  undo, return error:
    ...
    {include/i-rprun.i esp/rep/esrep041rp.p}
