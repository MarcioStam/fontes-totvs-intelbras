...
&GLOBAL-DEFINE Program        ESREP013
...
&GLOBAL-DEFINE page0Widgets   btOk ~
                              btCancel ~
                              btHelp2
&GLOBAL-DEFINE page2Widgets   fi-cod-estab-ini fi-cod-estab-fim fi-data-ini fi-data-fim fi-it-codigo-ini fi-it-codigo-fim ~
                              fi-nat-operacao-ini fi-nat-operacao-fim rs-opcao
...
DEFINE VARIABLE fi-cod-estab-fim AS CHARACTER FORMAT "X(16)":U INITIAL "ZZZ" 
     VIEW-AS FILL-IN 
     SIZE 4 BY .88 NO-UNDO.

DEFINE VARIABLE fi-cod-estab-ini AS CHARACTER FORMAT "X(16)":U 
     LABEL "Estabelecimento" 
     VIEW-AS FILL-IN 
     SIZE 4 BY .88 NO-UNDO.

DEFINE VARIABLE fi-data-fim AS DATE FORMAT "99/99/9999" INITIAL 12/31/9999 
     VIEW-AS FILL-IN 
     SIZE 10 BY .88 NO-UNDO.

DEFINE VARIABLE fi-data-ini AS DATE FORMAT "99/99/9999" INITIAL 01/01/001 
     LABEL "Per°odo" 
     VIEW-AS FILL-IN 
     SIZE 10 BY .88 NO-UNDO.
...
DEFINE VARIABLE fi-nat-operacao-fim AS CHARACTER FORMAT "x(06)" INITIAL "ZZZZZZ" 
     VIEW-AS FILL-IN 
...
DEFINE FRAME fpage0
     ...
     btCancel AT ROW 15.75 COL 13
     btHelp2 AT ROW 15.75 COL 80
...
DEFINE FRAME fPage2
     fi-cod-estab-ini AT ROW 1.96 COL 32 COLON-ALIGNED WIDGET-ID 4
     fi-cod-estab-fim AT ROW 1.96 COL 52 COLON-ALIGNED NO-LABEL WIDGET-ID 2
     fi-data-ini AT ROW 2.96 COL 26 COLON-ALIGNED
     fi-data-fim AT ROW 2.96 COL 52 COLON-ALIGNED NO-LABEL
     fi-it-codigo-ini AT ROW 3.96 COL 17 COLON-ALIGNED
     fi-it-codigo-fim AT ROW 3.96 COL 52 COLON-ALIGNED NO-LABEL
     fi-nat-operacao-ini AT ROW 4.96 COL 28 COLON-ALIGNED HELP
          "Natureza da Operaá∆o"
     fi-nat-operacao-fim AT ROW 4.96 COL 52 COLON-ALIGNED HELP
          "Natureza da Operaá∆o" NO-LABEL
     rs-opcao AT ROW 7.5 COL 34 NO-LABEL
     IMAGE-1 AT ROW 3.96 COL 38.43
     IMAGE-2 AT ROW 3.96 COL 50.72
     IMAGE-5 AT ROW 1.96 COL 38.43
     IMAGE-6 AT ROW 1.96 COL 50.86
     IMAGE-9 AT ROW 4.96 COL 38.43
     IMAGE-15 AT ROW 2.96 COL 38.43
     IMAGE-16 AT ROW 2.96 COL 50.86
     IMAGE-17 AT ROW 4.96 COL 50.72
     RECT-11 AT ROW 1.5 COL 2
     RECT-47 AT ROW 7.25 COL 2
...
ON MOUSE-SELECT-CLICK OF rs-opcao IN FRAME fPage2
DO:
    ASSIGN tipo-rel = INT(rs-opcao:SCREEN-VALUE in FRAME fpage2).
END.
...
/*DISP TODAY @ fi-data-ini
     TODAY @ fi-data-fim WITH FRAME fpage2.*/
...
do on error undo, return error on stop  undo, return error:
    ...
    ASSIGN tt-param.usuario             = c-seg-usuario
           ...
           tt-param.nat-operacao-ini    = INPUT FRAME fPage2 fi-nat-operacao-ini
           tt-param.nat-operacao-fim    = INPUT FRAME fPage2 fi-nat-operacao-fim 
           tt-param.opcao               = tipo-rel.
    ...
    {report/rprun.i esp/rep/esrep013rp.p}
