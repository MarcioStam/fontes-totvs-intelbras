...
*******************************************************************************/
{include/i-prgvrs.i esrep043 2.00.00.000}
...
DEFINE VARIABLE h_esrep043-q01 AS HANDLE NO-UNDO.
DEFINE VARIABLE h_esrep043-v01 AS HANDLE NO-UNDO.
...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'esp/rep/esrep043-v01.w':U ,
             INPUT  FRAME f-cad:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_esrep043-v01 ).
       RUN set-position IN h_esrep043-v01 ( 3.00 , 1.57 ) NO-ERROR.
       /* Size in UIB:  ( 3.00 , 88.57 ) */

       RUN init-object IN THIS-PROCEDURE (
             INPUT  'esp/rep/esrep043-q01.w':U ,
             INPUT  FRAME f-cad:HANDLE ,
             INPUT  'ProgPesquisa = esp/rep/z01esrep043.w,
                     ProgVaPara = esp/rep/esrep043-g01.w,
                     ProgIncMod = ,
                     Implantar = no':U ,
             OUTPUT h_esrep043-q01 ).
       RUN set-position IN h_esrep043-q01 ( 1.50 , 60.00 ) NO-ERROR.
       /* Size in UIB:  ( 1.63 , 7.72 ) */

       /* Links to SmartPanel h_p-exihel. */
       RUN add-link IN adm-broker-hdl ( h_p-cadsim , 'State':U , h_p-exihel ).

       /* Links to SmartViewer h_esrep043-v01. */
       RUN add-link IN adm-broker-hdl ( h_esrep043-q01 , 'Record':U , h_esrep043-v01 ).
       RUN add-link IN adm-broker-hdl ( h_p-cadsim , 'TableIO':U , h_esrep043-v01 ).

       /* Links to SmartQuery h_esrep043-q01. */
       RUN add-link IN adm-broker-hdl ( h_p-exihel , 'State':U , h_esrep043-q01 ).
       RUN add-link IN adm-broker-hdl ( h_p-navega , 'Navigation':U , h_esrep043-q01 ).
       RUN add-link IN adm-broker-hdl ( h_p-navega , 'State':U , h_esrep043-q01 ).
       ...
       RUN adjust-tab-order IN adm-broker-hdl ( h_p-exihel ,
             h_p-cadsim , 'AFTER':U ).
       RUN adjust-tab-order IN adm-broker-hdl ( h_esrep043-v01 ,
             h_p-exihel , 'AFTER':U ).
    END. /* Page 0 */
...
------------------------------------------------------------------------------*/
  ...
  {utp/ut9000.i "esrep043" "2.00.00.000"}
