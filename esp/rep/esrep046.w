...
*******************************************************************************/
{include/i-prgvrs.i esrep046 2.06.00.0001}
...
&IF "{&EMSFND_VERSION}" >= "1.00" &THEN
    {include/i-license-manager.i esrep046 MRE}
&ENDIF

CREATE WIDGET-POOL.

/* Preprocessors Definitions ---                                      */
&GLOBAL-DEFINE Program        esrep046
...
ASSIGN cIniField:HIDDEN IN FRAME fpage2 = YES
       cEndField:HIDDEN IN FRAME fpage2 = YES
       IMAGE-1  :HIDDEN IN FRAME fpage2 = YES
       IMAGE-2  :HIDDEN IN FRAME fpage2 = YES.
...
do on error undo, return error on stop  undo, return error:
    ...
    {report/rprun.i esp/rep/esrep046rp.p}
