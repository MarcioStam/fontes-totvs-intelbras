...
*******************************************************************************/
{include/i-prgvrs.i esrep036 2.00.00.000}
...
DEFINE VARIABLE c-cod-deposito LIKE ped-transf.cod-depos-dest
     VIEW-AS FILL-IN 
     SIZE 4.14 BY .88 NO-UNDO.

DEFINE VARIABLE c-cod-estabel LIKE docum-est.cod-estabel
     VIEW-AS FILL-IN 
     SIZE 6.14 BY .88 NO-UNDO.

DEFINE VARIABLE c-nr-nota-fis LIKE docum-est.nro-docto
     VIEW-AS FILL-IN 
...
DEFINE FRAME f-pg-sel
     c-cod-estabel AT ROW 2 COL 15.72 COLON-ALIGNED HELP
          "" WIDGET-ID 2
     c-nr-nota-fis AT ROW 3 COL 15.72 COLON-ALIGNED HELP
          "" WIDGET-ID 6
     c-serie AT ROW 4 COL 15.72 COLON-ALIGNED HELP
          "" WIDGET-ID 4
     c-cod-deposito AT ROW 5 COL 15.72 COLON-ALIGNED HELP
          "C¢digo do Dep¢sito de Destino" WIDGET-ID 8
...
/* SETTINGS FOR FRAME f-pg-sel
                                                                        */
/* SETTINGS FOR FILL-IN c-cod-deposito IN FRAME f-pg-sel
   LIKE = mgesp.ped-transf.cod-depos-dest EXP-SIZE                     */
/* SETTINGS FOR FILL-IN c-cod-estabel IN FRAME f-pg-sel
   LIKE = mgmov.docum-est.cod-estabel EXP-SIZE                         */
/* SETTINGS FOR FILL-IN c-nr-nota-fis IN FRAME f-pg-sel
   LIKE = mgmov.docum-est.nro-docto EXP-SIZE                           */
/* SETTINGS FOR FILL-IN c-serie IN FRAME f-pg-sel
...
{utp/ut9000.i "esrep036" "2.00.00.000"}
...
------------------------------------------------------------------------------*/
  ...
  DISPLAY c-cod-estabel c-nr-nota-fis c-serie c-cod-deposito 
      WITH FRAME f-pg-sel IN WINDOW w-relat.
  ENABLE c-cod-estabel c-nr-nota-fis c-serie c-cod-deposito 
      WITH FRAME f-pg-sel IN WINDOW w-relat.
...
do on error undo, return error on stop  undo, return error:
    ...
    assign tt-param.usuario         = c-seg-usuario
           ...
           tt-param.nr-nota-fis     = input frame f-pg-sel c-nr-nota-fis
           tt-param.serie           = input frame f-pg-sel c-serie      
           tt-param.cod-deposito    = input frame f-pg-sel c-cod-deposito     
        .
    ...
    {include/i-rprun.i esp/rep/esrep036rp.p}
