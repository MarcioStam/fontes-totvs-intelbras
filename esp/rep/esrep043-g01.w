...
*******************************************************************************/
{include/i-prgvrs.i esftp070-g01 2.00.00.000}
...
&Scoped-Define ENABLED-OBJECTS rt-button i_cd-enquadramento bt-ok ~
bt-cancela bt-ajuda 
&Scoped-Define DISPLAYED-OBJECTS i_cd-enquadramento 
...
DEFINE VARIABLE i_cd-enquadramento AS INTEGER FORMAT ">>>>>>>>9":U INITIAL 0 
     LABEL "Cd. Enquadramento" 
     VIEW-AS FILL-IN 
...
DEFINE FRAME d-vapara
     i_cd-enquadramento AT ROW 2 COL 24 COLON-ALIGNED WIDGET-ID 2
...
DO:
FIND int-enquadramento NO-LOCK
    WHERE int-enquadramento.cd-enquadramento EQ INPUT FRAME {&FRAME-NAME} i_cd-enquadramento NO-ERROR.

IF NOT AVAILABLE int-enquadramento THEN DO:
    {utp/ut-table.i mgesp int-enquadramento 1}
    RUN utp/ut-msgs.p(INPUT "show",
                      INPUT 2,
                      INPUT RETURN-VALUE).
    RETURN NO-APPLY.
END.
ASSIGN p-row-tabela = ROWID(int-enquadramento).
END.
...
------------------------------------------------------------------------------*/
  DISPLAY i_cd-enquadramento 
      WITH FRAME d-vapara.
  ENABLE rt-button i_cd-enquadramento bt-ok bt-cancela bt-ajuda 
      WITH FRAME d-vapara.
  VIEW FRAME d-vapara.
...
------------------------------------------------------------------------------*/
  ...
  {utp/ut9000.i "esftp070-g01" "2.00.00.000"}
