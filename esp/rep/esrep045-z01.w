...
*******************************************************************************/
{include/i-prgvrs.i ESREP045-Z01 1.00.00.001}
...
&IF "{&EMSFND_VERSION}" >= "1.00" &THEN
    {include/i-license-manager.i ESREP045-Z01 REC}
&ENDIF
...
DEFINE VARIABLE h_esrep045-b01 AS HANDLE NO-UNDO.
...
DEFINE FRAME f-zoom
     bt-implantar AT ROW 12.42 COL 1
     bt-ok AT ROW 14.21 COL 2.43
     bt-cancela AT ROW 14.21 COL 13.43
     bt-ajuda AT ROW 14.21 COL 69.43
     rt-button AT ROW 13.96 COL 1.43
  ...
  CASE adm-current-page: 
    ...
    WHEN 1 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'esp/rep/esrep045-b01.w':U ,
             INPUT  FRAME f-zoom:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_esrep045-b01 ).
       RUN set-position IN h_esrep045-b01 ( 1.00 , 1.00 ) NO-ERROR.
       /* Size in UIB:  ( 11.42 , 80.29 ) */

       /* Links to SmartBrowser h_esrep045-b01. */
       RUN add-link IN adm-broker-hdl ( h_esrep045-b01 , 'State':U , THIS-PROCEDURE ).

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_esrep045-b01 ,
...
------------------------------------------------------------------------------*/
  ...
  {utp/ut9000.i "ESREP045-Z01" "1.00.00.001"}
