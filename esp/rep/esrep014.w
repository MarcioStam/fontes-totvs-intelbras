...
*******************************************************************************/
{include/i-prgvrs.i ESREP014 2.04.00.000}

CREATE WIDGET-POOL.

/* Preprocessors Definitions ---                                      */
&GLOBAL-DEFINE Program        ESREP014
...
&GLOBAL-DEFINE page0Widgets   btOk ~
                              btCancel ~
                              btHelp2
&GLOBAL-DEFINE page2Widgets   fi-estab-ini fi-estab-fim fi-especie-ini fi-especie-fim fi-data-ini fi-data-fim  
...
DEFINE VARIABLE fi-especie-fim AS CHARACTER FORMAT "X(02)" INITIAL "ZZ" 
     VIEW-AS FILL-IN 
     SIZE 10 BY .88 NO-UNDO.

DEFINE VARIABLE fi-especie-ini AS CHARACTER FORMAT "X(02)" 
     LABEL "EspÇcie" 
     VIEW-AS FILL-IN 
     SIZE 10 BY .88 NO-UNDO.

DEFINE VARIABLE fi-estab-fim AS CHARACTER FORMAT "X(03)" INITIAL "ZZZ" 
     VIEW-AS FILL-IN 
     SIZE 10 BY .88 NO-UNDO.

DEFINE VARIABLE fi-estab-ini AS CHARACTER FORMAT "X(03)" 
...
DEFINE FRAME fPage2
     fi-estab-ini AT ROW 2.46 COL 26 COLON-ALIGNED WIDGET-ID 12
     fi-estab-fim AT ROW 2.46 COL 52 COLON-ALIGNED NO-LABEL WIDGET-ID 10
     fi-especie-ini AT ROW 3.5 COL 26 COLON-ALIGNED
     fi-especie-fim AT ROW 3.5 COL 52 COLON-ALIGNED NO-LABEL
     fi-data-ini AT ROW 4.67 COL 26 COLON-ALIGNED WIDGET-ID 4
     fi-data-fim AT ROW 4.67 COL 52 COLON-ALIGNED NO-LABEL WIDGET-ID 2
     IMAGE-5 AT ROW 3.5 COL 38
     IMAGE-6 AT ROW 3.5 COL 51.14
     RECT-11 AT ROW 1.75 COL 2
     IMAGE-9 AT ROW 4.67 COL 38 WIDGET-ID 6
     IMAGE-10 AT ROW 4.67 COL 51.14 WIDGET-ID 8
     IMAGE-11 AT ROW 2.46 COL 38 WIDGET-ID 14
     IMAGE-12 AT ROW 2.46 COL 51.14 WIDGET-ID 16
...
do on error undo, return error on stop  undo, return error:
    ...
    ASSIGN tt-param.usuario             = c-seg-usuario
           ...
           tt-param.especie-ini         = INPUT FRAME fpage2 fi-especie-ini
           tt-param.especie-fim         = INPUT FRAME fpage2 fi-especie-fim
    ...
    {report/rprun.i esp/rep/esrep014rp.p}
