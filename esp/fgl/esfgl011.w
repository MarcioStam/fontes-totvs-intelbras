...
DEFINE VARIABLE l-acr AS LOGICAL INITIAL no 
     LABEL "ACR" 
     VIEW-AS TOGGLE-BOX
     SIZE 44 BY 1.08 NO-UNDO.

DEFINE VARIABLE l-apb AS LOGICAL INITIAL no 
     LABEL "APB" 
     VIEW-AS TOGGLE-BOX
     SIZE 44 BY 1.08 NO-UNDO.
...
DEFINE FRAME f-pg-par
     l-acr AT ROW 1.25 COL 4
     l-apb AT ROW 2.25 COL 4 WIDGET-ID 2
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 3 ROW 3
         SIZE 75 BY 10
...
DEFINE FRAME f-pg-sel
     c-periodo AT ROW 1.75 COL 13.57 COLON-ALIGNED
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 3 ROW 2.85
         SIZE 76.86 BY 10.62
...
{utp/ut9000.i "esfgl011" "2.00.00.000"}
...
do on error undo, return error on stop  undo, return error:
    ...
    assign tt-param.usuario         = c-seg-usuario
           ...
           tt-param.periodo         = input frame f-pg-sel c-periodo
           tt-param.acr             = input frame f-pg-par l-acr
           tt-param.apb             = input frame f-pg-par l-apb
           .
    ...
    {include/i-rprun.i esp/fgl/esfgl011rp.p}
