...
*******************************************************************************/
{include/i-prgvrs.i es0023 2.04.00.001}

CREATE WIDGET-POOL.

/* Preprocessors Definitions ---                                      */
&GLOBAL-DEFINE Program        es0023
...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW wReport ASSIGN
         HIDDEN             = YES
         TITLE              = "Geraá∆o de Dados da Projeá∆o do Estoque"
         HEIGHT             = 17
         WIDTH              = 90
         MAX-HEIGHT         = 40.83
         MAX-WIDTH          = 182.86
...
ON END-ERROR OF wReport /* Geraá∆o de Dados da Projeá∆o do Estoque */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL wReport wReport
ON WINDOW-CLOSE OF wReport /* Geraá∆o de Dados da Projeá∆o do Estoque */
DO:
