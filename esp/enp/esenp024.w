...
*******************************************************************************/
{include/i-prgvrs.i ESENP024 2.00.00.000}

CREATE WIDGET-POOL.

/* Preprocessors Definitions ---                                      */
&GLOBAL-DEFINE Program        ESENP024
...
&GLOBAL-DEFINE page0Widgets   btGoto btSearch btReportsJoins btExit btHelp br-alternativo
...
&Scoped-Define ENABLED-OBJECTS rtToolBar-2 RECT-1 RECT-2 btGoto btSearch ~
btReportsJoins btExit btHelp fi-it-codigo fi-desc-item br-alternativo 
...
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ROW-MARKERS SEPARATORS SIZE 82.86 BY 10
...
DEFINE FRAME fpage0
     ...
     br-alternativo AT ROW 5.38 COL 4.72 WIDGET-ID 200
...
"it-altern.it-altern" "Item Alternativo" ? "character" ? ? ? ? ? ? no ? no no "12.43" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[2]   > mgcad.item.desc-item
"item.desc-item" ? ? "character" ? ? ? ? ? ? no ? no no "66.72" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _Query            is OPENED
