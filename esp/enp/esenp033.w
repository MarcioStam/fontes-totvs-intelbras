...
*******************************************************************************/
{include/i-prgvrs.i ESENP033 1.00.00.000}
...
&IF "{&EMSFND_VERSION}" >= "1.00" &THEN
    {include/i-license-manager.i ESENP033 ESP}
&ENDIF
...
DEFINE VARIABLE fi-ferramenta-fim AS CHARACTER FORMAT "X(16)":U INITIAL "ZZZZZZZZZZZZZZZZ" 
     VIEW-AS FILL-IN 
     SIZE 17 BY .88 NO-UNDO.

DEFINE VARIABLE fi-ferramenta-ini AS CHARACTER FORMAT "X(16)":U 
     LABEL "Ferramenta" 
     VIEW-AS FILL-IN 
     SIZE 17 BY .88 NO-UNDO.
...
DEFINE FRAME f-relat
     ...
     im-pg-par AT ROW 1.5 COL 49.29
...
DEFINE FRAME f-pg-sel
     fi-it-codigo-ini AT ROW 2 COL 13 COLON-ALIGNED HELP
          "Item inicial" WIDGET-ID 4
     fi-it-codigo-fim AT ROW 2 COL 41 COLON-ALIGNED HELP
          "Item final" NO-LABEL WIDGET-ID 2
     fi-ferramenta-ini AT ROW 3 COL 13 COLON-ALIGNED HELP
          "Ferramenta inicial" WIDGET-ID 12
     fi-ferramenta-fim AT ROW 3 COL 41 COLON-ALIGNED HELP
          "Ferramenta final" NO-LABEL WIDGET-ID 10
     IMAGE-3 AT ROW 2 COL 32.14 WIDGET-ID 6
     IMAGE-4 AT ROW 2 COL 40 WIDGET-ID 8
     IMAGE-15 AT ROW 3 COL 32.14 WIDGET-ID 14
     IMAGE-16 AT ROW 3 COL 40 WIDGET-ID 16
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW w-relat ASSIGN
         HIDDEN             = YES
         TITLE              = "Opera‡äes x Ferramentas (APS)"
         HEIGHT             = 15
         WIDTH              = 81.14
         MAX-HEIGHT         = 41.33
         MAX-WIDTH          = 274.29
...
ON END-ERROR OF w-relat /* Opera‡äes x Ferramentas (APS) */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL w-relat w-relat
ON WINDOW-CLOSE OF w-relat /* Opera‡äes x Ferramentas (APS) */
DO:
...
{utp/ut9000.i "ESENP033" "1.00.00.000"}
...
------------------------------------------------------------------------------*/
  ...
  DISPLAY fi-it-codigo-ini fi-it-codigo-fim fi-ferramenta-ini fi-ferramenta-fim 
      WITH FRAME f-pg-sel IN WINDOW w-relat.
  ENABLE IMAGE-3 IMAGE-4 IMAGE-15 IMAGE-16 fi-it-codigo-ini fi-it-codigo-fim 
         fi-ferramenta-ini fi-ferramenta-fim 
      WITH FRAME f-pg-sel IN WINDOW w-relat.
...
do on error undo, return error on stop  undo, return error:
    ...
    if input frame f-pg-sel fi-ferramenta-ini > input frame f-pg-sel fi-ferramenta-fim
    then do:
         apply "MOUSE-SELECT-CLICK":U to im-pg-sel in frame f-relat.
         run utp/ut-msgs.p (input "show", input 17567, input "Ferramenta inicial maior que final!").
         apply 'entry' to fi-ferramenta-ini in frame f-pg-sel.
         return 'ADM-ERROR'.
    end.
    ...
    assign tt-param.execucao       = input frame f-pg-imp rs-execucao
           ...
           tt-param.ferramenta-ini = input frame f-pg-sel fi-ferramenta-ini   
           tt-param.ferramenta-fim = input frame f-pg-sel fi-ferramenta-fim.
    ...
    {include/i-rprun.i esp/enp/esenp033rp.p}
