...
*******************************************************************************/
{include/i-prgvrs.i esenp026 1.00.00.000}
...
DEFINE VARIABLE dt-fin-aux    AS DATE FORMAT "99/99/9999" NO-UNDO.
DEFINE VARIABLE dt-ini-aux    AS DATE FORMAT "99/99/9999" NO-UNDO.
...
DEFINE VARIABLE c-cod-estabel AS CHARACTER FORMAT "x(3)":U INITIAL "105" 
...
DEFINE FRAME f-pg-imp
     ...
     rs-execucao AT ROW 5 COL 2.86 HELP
          "Modo de Execuá∆o" NO-LABEL
     text-destino AT ROW 1.04 COL 3.86 NO-LABEL
     text-modo AT ROW 4.25 COL 1.14 COLON-ALIGNED NO-LABEL
     RECT-7 AT ROW 1.33 COL 2.14
     RECT-9 AT ROW 4.46 COL 2
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 3 ROW 2.85
...
DEFINE FRAME f-pg-sel
     c-cod-estabel AT ROW 4.5 COL 24 COLON-ALIGNED HELP
          "C¢digo do Estabelecimento" WIDGET-ID 2
     d-dt-inicial AT ROW 5.5 COL 24 COLON-ALIGNED HELP
          "Data Inicial"
     d-dt-final AT ROW 5.5 COL 46.57 COLON-ALIGNED HELP
          "Data Final" NO-LABEL
     IMAGE-1 AT ROW 5.5 COL 37.86
     IMAGE-2 AT ROW 5.5 COL 45.72
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 3 ROW 2.85
         SIZE 76.86 BY 10.62 WIDGET-ID 100.
...
{utp/ut9000.i "esenp026" "1.00.00.000"}
...
------------------------------------------------------------------------------*/
  ...
  DISPLAY c-cod-estabel d-dt-inicial d-dt-final 
      WITH FRAME f-pg-sel IN WINDOW w-relat.
  ENABLE IMAGE-1 IMAGE-2 c-cod-estabel d-dt-inicial d-dt-final 
      WITH FRAME f-pg-sel IN WINDOW w-relat.
...
do on error undo, return error on stop  undo, return error:
    ...
    assign tt-param.usuario         = c-seg-usuario
           ...
           tt-param.dt-inicial      = input frame f-pg-sel d-dt-inicial
           tt-param.dt-final        = input frame f-pg-sel d-dt-final
    ...
    {include/i-rprun.i esp/enp/esenp026rp.p}
