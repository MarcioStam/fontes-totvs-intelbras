...
*******************************************************************************/
{include/i-prgvrs.i ESENP027 1.00.00.000}

CREATE WIDGET-POOL.

/* Preprocessors Definitions ---                                      */
&GLOBAL-DEFINE Program        ESENP027
...
DEFINE VARIABLE item-fim AS CHARACTER FORMAT "X(7)":U 
     VIEW-AS FILL-IN 
...
DEFINE FRAME fPage2
     item-ini AT ROW 5.5 COL 24 COLON-ALIGNED WIDGET-ID 2
     item-fim AT ROW 5.5 COL 46.57 COLON-ALIGNED NO-LABEL WIDGET-ID 4
...
do on error undo, return error on stop  undo, return error:
    ...
    {report/rprun.i esp/enp/esenp027rp.p}
