...
*******************************************************************************/
{include/i-prgvrs.i esenp029 1.00.00.000}
...
&GLOBAL-DEFINE Program        esenp029
...
&GLOBAL-DEFINE page2Fields    fl-item-ini fl-item-fim fl-data-ini 
&GLOBAL-DEFINE page4Fields    tg-fabricado tg-comprado
...
DEFINE VARIABLE tg-comprado AS LOGICAL INITIAL yes 
     LABEL "Item Comprado" 
     VIEW-AS TOGGLE-BOX
     SIZE 14 BY .88 NO-UNDO.

DEFINE VARIABLE tg-fabricado AS LOGICAL INITIAL yes 
     LABEL "Item Fabricado" 
     VIEW-AS TOGGLE-BOX
...
DEFINE FRAME fPage2
     ...
     fl-data-ini AT ROW 3.5 COL 24 COLON-ALIGNED WIDGET-ID 10
     RECT-20 AT ROW 1.5 COL 2 WIDGET-ID 2
...
DEFINE FRAME fPage4
     tg-fabricado AT ROW 2.5 COL 8 HELP
          "Lista itens fabricados." WIDGET-ID 20
     tg-comprado AT ROW 3.5 COL 8 HELP
          "Lista os items comprados." WIDGET-ID 30
     "Tipo do item" VIEW-AS TEXT
          SIZE 9 BY .54 AT ROW 1.75 COL 5 WIDGET-ID 32
     RECT-21 AT ROW 2 COL 4 WIDGET-ID 4
    WITH 1 DOWN KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 3.57 ROW 2.79
         SIZE 84.43 BY 10.96
...
/* SETTINGS FOR FRAME fPage2
                                                                        */
ASSIGN 
       fl-data-ini:PRIVATE-DATA IN FRAME fPage2     = 
                "today".
...
&Scoped-define SELF-NAME fl-data-ini
&Scoped-define FRAME-NAME fPage6
...
DISPLAY fl-data-ini WITH FRAME fPage2.
...
do on error undo, return error on stop  undo, return error:
    ...
    assign tt-param.usuario        = c-seg-usuario
           ...
           tt-param.fabricado      = INPUT FRAME fPage4 tg-fabricado
           tt-param.comprado       = INPUT FRAME fPage4 tg-comprado.
    ...
    {report/rprun.i esp/enp/esenp029rp.p}
