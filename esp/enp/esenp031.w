...
*******************************************************************************/
{include/i-prgvrs.i esenp031 2.00.00.000}
...
&Scoped-define FIELDS-IN-QUERY-br-digita tt-digita.it-codigo fnDescItem(tt-digita.it-codigo) @ c-desc-item   
...
fnDescItem(tt-digita.it-codigo) @ c-desc-item FORMAT "x(40)" COLUMN-LABEL "Desc"
ENABLE
tt-digita.it-codigo
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
...
DO:
    if  br-digita:new-row in frame f-pg-dig then do:
        ...
        display tt-digita.it-codigo with browse br-digita. 
    end.
    return no-apply.
END.
...
{utp/ut9000.i "ESENP031" "2.00.00.000"}
...
ON 'leave':U OF tt-digita.it-codigo DO:
    IF AVAIL tt-digita THEN
        DISPLAY fnDescItem(tt-digita.it-codigo) @ c-desc-item WITH BROWSE br-digita.
END.
...
do on error undo, return error on stop  undo, return error:
    ...
    for each tt-digita no-lock:
        ...
        if NOT CAN-FIND (FIRST ITEM
            ...
            run utp/ut-msgs.p (input "show":U, input 17006, input "Item " + tt-digita.it-codigo + " n∆o cadastrado!").
            apply "ENTRY":U to tt-digita.it-codigo in browse br-digita.
    ...
    {include/i-rprun.i esp/enp/esenp031rp.p}
