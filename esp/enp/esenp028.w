...
*******************************************************************************/
{include/i-prgvrs.i esenp028 1.00.00.000}

CREATE WIDGET-POOL.

/* Preprocessors Definitions ---                                      */
&GLOBAL-DEFINE Program        esenp028
...
&GLOBAL-DEFINE page4Widgets   tg-ativos
...
&GLOBAL-DEFINE page2Fields    item-ini item-fim
...
DEFINE VARIABLE item-fim AS CHARACTER FORMAT "X(7)":U INITIAL "ZZZZZZZ" 
     VIEW-AS FILL-IN 
     SIZE 9 BY .88 NO-UNDO.

DEFINE VARIABLE item-ini AS CHARACTER FORMAT "X(7)":U 
     LABEL "Item" 
     VIEW-AS FILL-IN 
     SIZE 9 BY .88 NO-UNDO.
...
DEFINE FRAME fPage2
     item-ini AT ROW 5.5 COL 28 COLON-ALIGNED WIDGET-ID 2
     item-fim AT ROW 5.5 COL 48 COLON-ALIGNED NO-LABEL WIDGET-ID 4
     IMAGE-1 AT ROW 5.5 COL 39.29
     IMAGE-2 AT ROW 5.5 COL 47.14
...
DEFINE FRAME fPage4
     tg-ativos AT ROW 5 COL 32 WIDGET-ID 4
    WITH 1 DOWN KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 3.57 ROW 2.81
         SIZE 84.43 BY 10.15
...
do on error undo, return error on stop  undo, return error:
    ...
    assign tt-param.usuario         = c-seg-usuario
           ...
           tt-param.item-ini        = INPUT FRAME fPage2 item-ini
           tt-param.item-fim        = INPUT FRAME fPage2 item-fim
    ...
    {report/rprun.i esp/enp/esenp028rp.p}
