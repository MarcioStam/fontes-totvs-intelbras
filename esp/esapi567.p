...
//                  MESSAGE ">> aliquotaCOFINS " ItensPedido.aliquotaCOFINS .
      ...
      FOR EACH declaracao:
         ...
         ASSIGN
//            embarque-imp.declaracao-import = declaracao.numeroDI       
            declaracao.dataRegistroDI      = SUBSTR(declaracao.dataRegistroDI,1,10)
            embarque-imp.data-di           = DATE(INT(ENTRY(2,declaracao.dataRegistroDI,"-")),
...
//                  tt-ordens-desemb.peso-liquido    = ItensPedido.pesoLiquido    
                  //tt-ordens-desemb.peso-bruto      = ItensPedido.pesoBruto      
               
//                  tt-ordens-desemb.de-peso-liquido = ItensPedido.pesoLiquido    
//                  tt-ordens-desemb.de-peso-bruto   = ItensPedido.pesoBruto      
