...
*******************************************************************************/
{include/i-prgvrs.i ESCPP104 2.00.00.000}
{include/i-license-manager.i ESCPP104 FGL}

CREATE WIDGET-POOL.

/* Preprocessors Definitions ---                                      */
&GLOBAL-DEFINE Program        ESCPP104
...
&GLOBAL-DEFINE page0Widgets   btQueryJoins btReportsJoins btExit btHelp ~
                              ...
                              c-sigla btConfigImpr btReimpressao c-mac
...
&Scoped-Define ENABLED-OBJECTS c-it-codigo c-sigla c-mac btReimpressao ~
...
&Scoped-Define DISPLAYED-OBJECTS c-it-codigo c-sigla c-mac c-desc-item ~
...
DEFINE FRAME fpage0
     ...
     c-mac AT ROW 7.13 COL 18.72 COLON-ALIGNED WIDGET-ID 44
    ...
    FOR FIRST modelo-etiq NO-LOCK
        ...
        IF modelo-etiq.tipo = 1 THEN DO:
            ...
            ELSE DO:
                ...
                // Vincula o MAC lido ao NS gerado
                FIND FIRST tt-lista-ns NO-LOCK NO-ERROR.

                IF AVAIL tt-lista-ns 
                THEN ASSIGN mac-address.n-serie = tt-lista-ns.num-serie.
