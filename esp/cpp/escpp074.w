...
*******************************************************************************/
{include/i-prgvrs.i ESCPP074 2.00.00.000}

CREATE WIDGET-POOL.

/* Preprocessors Definitions ---                                      */
&GLOBAL-DEFINE Program          ESCPP074
&GLOBAL-DEFINE Version          2.00.00.000

&GLOBAL-DEFINE Folder           YES
&GLOBAL-DEFINE InitialPage      1
&GLOBAL-DEFINE FolderLabels     DUN14
...
&GLOBAL-DEFINE hDBOParent       b-boin172
&GLOBAL-DEFINE DBOParentTable   ITEM
&GLOBAL-DEFINE DBOParentDestroy NO

&GLOBAL-DEFINE ttSon1           tt-item-dun
&GLOBAL-DEFINE hDBOSon1         h-boes614
&GLOBAL-DEFINE DBOSon1Table     item-dun
...
&Scoped-define FIELDS-IN-QUERY-brSon1 tt-item-dun.qtd-emb ~
tt-item-dun.cod-dun 
&Scoped-define ENABLED-FIELDS-IN-QUERY-brSon1 
&Scoped-define QUERY-STRING-brSon1 FOR EACH tt-item-dun NO-LOCK
&Scoped-define OPEN-QUERY-brSon1 OPEN QUERY brSon1 FOR EACH tt-item-dun NO-LOCK.
&Scoped-define TABLES-IN-QUERY-brSon1 tt-item-dun
&Scoped-define FIRST-TABLE-IN-QUERY-brSon1 tt-item-dun
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS brSon1 wMasterDetail _STRUCTURED
  QUERY brSon1 NO-LOCK DISPLAY
      ...
      tt-item-dun.cod-dun FORMAT "x(14)":U WIDTH 16
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ROW-MARKERS SEPARATORS SIZE 82 BY 10.58
         FONT 2.
...
DEFINE FRAME fPage0
     ...
     btHelp AT ROW 1.13 COL 86.86 HELP
          "Ajuda"
     tt-item.it-codigo AT ROW 3 COL 12 COLON-ALIGNED WIDGET-ID 4
          VIEW-AS FILL-IN 
          SIZE 14 BY .88
...
/* Query rebuild information for BROWSE brSon1
     ...
     _Options          = "NO-LOCK"
     _FldNameList[1]   = Temp-Tables.tt-item-dun.qtd-emb
     _FldNameList[2]   > Temp-Tables.tt-item-dun.cod-dun
"cod-dun" ? ? "character" ? ? ? ? ? ? no ? no no "16" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _Query            is OPENED
*/  /* BROWSE brSon1 */
&ANALYZE-RESUME
...
------------------------------------------------------------------------------*/
    ...
    ASSIGN c-it-codigo:WIDTH IN FRAME fGoToRecord = 10.
...
------------------------------------------------------------------------------*/
    ...
    IF NOT VALID-HANDLE({&hDBOSon1}) OR 
       ...
       {&hDBOSon1}:FILE-NAME <> "esbo/boes614.p":U THEN DO:
        {btb/btb008za.i1 esbo/boes614.p YES}
        {btb/btb008za.i2 esbo/boes614.p '' {&hDBOSon1}} 
    END.
