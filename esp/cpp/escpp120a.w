...
*******************************************************************************/
{include/i-prgvrs.i escpp120a 1.00.00.000}
...
&IF "{&EMSFND_VERSION}" >= "1.00" &THEN
    {include/i-license-manager.i escpp120a mcp}
&ENDIF

CREATE WIDGET-POOL.

/* Preprocessors Definitions ---                                      */
&GLOBAL-DEFINE Program        escpp120a
...
&GLOBAL-DEFINE page2Fields    cItemIni cItemFim dDataIni dDataFim iPedido
...
DEFINE VARIABLE dDataFim AS DATE FORMAT "99/99/9999":U INITIAL 12/31/9999 
     VIEW-AS FILL-IN 
     SIZE 12 BY .88 NO-UNDO.

DEFINE VARIABLE dDataIni AS DATE FORMAT "99/99/9999":U INITIAL 01/01/22 
     LABEL "Data" 
     VIEW-AS FILL-IN 
     SIZE 12 BY .88 NO-UNDO.

DEFINE VARIABLE iPedido AS INTEGER FORMAT ">>>>>,>>9":U INITIAL 0 
     LABEL "Pedido" 
     VIEW-AS FILL-IN 
...
DEFINE FRAME fPage2
     dDataIni AT ROW 1.5 COL 21.57 COLON-ALIGNED WIDGET-ID 6
     dDataFim AT ROW 1.5 COL 52.14 COLON-ALIGNED NO-LABEL WIDGET-ID 8
     cItemIni AT ROW 2.5 COL 13.85
     cItemFim AT ROW 2.5 COL 54.14 NO-LABEL
     iPedido AT ROW 3.5 COL 22 COLON-ALIGNED WIDGET-ID 10
     IMAGE-1 AT ROW 1.5 COL 35.86
     IMAGE-2 AT ROW 1.5 COL 51.14
     IMAGE-3 AT ROW 2.5 COL 35.86 WIDGET-ID 2
     IMAGE-4 AT ROW 2.5 COL 51.14 WIDGET-ID 4
...
FRAME fpage1:VISIBLE = NO.
FRAME fpage3:VISIBLE = NO.
FRAME fpage4:VISIBLE = NO.
FRAME fpage5:VISIBLE = NO.
FRAME fpage7:VISIBLE = NO.
...
do on error undo, return error on stop  undo, return error:
    ...
    assign tt-param.usuario         = c-seg-usuario
           ...
           &endif
           tt-param.dDataIni         = INPUT FRAME fpage2 dDataIni
           tt-param.dDataFim         = INPUT FRAME fpage2 dDataFim
           tt-param.cItemIni         = INPUT FRAME fpage2 cItemIni
           tt-param.cItemFim         = INPUT FRAME fpage2 cItemFim
           tt-param.iPedido          = INPUT FRAME fpage2 iPedido.           
    ...
    {report/rprun.i esp/cpp/escpp120arp.p}
