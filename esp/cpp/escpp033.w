...
*******************************************************************************/
{include/i-prgvrs.i ESCPP033 1.00.00.001}
...
DEFINE FRAME f-pg-sel
     bt-arquivo-entrada AT ROW 2.25 COL 71.86 HELP
     ...
     text-entrada AT ROW 1.25 COL 4.14 NO-LABEL WIDGET-ID 8
...
DO:
    {include/i-imarq.i c-arquivo-entrada f-pg-sel "'*.XLS' '*.xlsx'"}
END.
...
ON CHOOSE OF bt-cancelar IN FRAME f-import /* Fechar */
DO:
   apply "close":U to this-procedure.
END.
...
{utp/ut9000.i "ESCPP033" "1.00.00.001"}
...
DO  ON ERROR   UNDO MAIN-BLOCK, LEAVE MAIN-BLOCK
    ...
    {include/i-imvrf.i &programa=ESCPP033 &versao-layout=001}
...
------------------------------------------------------------------------------*/
  ...
  ENABLE RECT-9 RECT-7 rs-destino bt-config-impr-destino bt-arquivo-destino 
...
do  on error undo, return error
    ...
    {include/i-imrun.i esp/cpp/escpp033rp.p}
