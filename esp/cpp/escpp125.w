...
*******************************************************************************/
{include/i-prgvrs.i escpp125 1.00.00.001}
...
&IF "{&EMSFND_VERSION}" >= "1.00" &THEN
    {include/i-license-manager.i escpp125 mft}
&ENDIF

CREATE WIDGET-POOL.

/* Preprocessors Definitions ---                                      */
&GLOBAL-DEFINE Program        escpp125
...
&GLOBAL-DEFINE page2Fields    iItemIni iItemFim cEstabIni cEstabFim
...
DEFINE VARIABLE iItemFim AS INTEGER FORMAT ">>>,>>>,>>9":U INITIAL 999999999 
     VIEW-AS FILL-IN 
     SIZE 12 BY .88
     FONT 1 NO-UNDO.

DEFINE VARIABLE iItemIni AS INTEGER FORMAT ">>>,>>>,>>9":U INITIAL 0 
     LABEL "Produto" 
     VIEW-AS FILL-IN 
     SIZE 12 BY .88
     FONT 1 NO-UNDO.
...
DEFINE FRAME fPage2
     iItemIni AT ROW 1.5 COL 14.86
     iItemFim AT ROW 1.5 COL 54.14 NO-LABEL
     cEstabIni AT ROW 2.5 COL 19 COLON-ALIGNED WIDGET-ID 2
     cEstabFim AT ROW 2.5 COL 52 COLON-ALIGNED NO-LABEL WIDGET-ID 4
     IMAGE-1 AT ROW 1.5 COL 33.43
     IMAGE-2 AT ROW 1.5 COL 51.14
     IMAGE-37 AT ROW 2.54 COL 33.43 WIDGET-ID 6
     IMAGE-38 AT ROW 2.54 COL 51.14 WIDGET-ID 8
...
/* SETTINGS FOR FRAME fPage2
                                                                        */
/* SETTINGS FOR FILL-IN iItemFim IN FRAME fPage2
   ALIGN-L                                                              */
/* SETTINGS FOR FILL-IN iItemIni IN FRAME fPage2
   ALIGN-L                                                              */
...
do on error undo, return error on stop  undo, return error:
    ...
    */
    ...
    assign tt-param.usuario         = c-seg-usuario
           ...
           &endif
           tt-param.i-item-ini       = INPUT FRAME fpage2 iItemIni
           tt-param.i-item-fim       = INPUT FRAME fpage2 iItemFim
           tt-param.c-estab-ini      = INPUT FRAME fpage2 cEstabIni
           tt-param.c-estab-fim      = INPUT FRAME fpage2 cEstabFim
           .
    ...
    {report/rprun.i esp/cpp/escpp125rp.p}
