...
************************************************************************/
{include/i-prgvrs.i escpp110 2.00.00.000}
...
DEFINE VARIABLE c-homolog-fim AS CHARACTER FORMAT "X(25)":U INITIAL "ZZZZZZZZZZZZZZZZ" 
     VIEW-AS FILL-IN 
     SIZE 16.86 BY .88 NO-UNDO.

DEFINE VARIABLE c-homolog-ini AS CHARACTER FORMAT "X(25)":U 
     LABEL "Homologa‡Æo" 
     VIEW-AS FILL-IN 
...
DEFINE FRAME f-pg-sel
     c-it-codigo-ini AT ROW 1.25 COL 15 COLON-ALIGNED
     c-it-codigo-fim AT ROW 1.25 COL 48.14 COLON-ALIGNED NO-LABEL
     c-homolog-ini AT ROW 2.29 COL 14 COLON-ALIGNED WIDGET-ID 4
     c-homolog-fim AT ROW 2.29 COL 48.14 COLON-ALIGNED NO-LABEL WIDGET-ID 2
     IMAGE-1 AT ROW 1.25 COL 31.86
     IMAGE-2 AT ROW 1.25 COL 47.29
     IMAGE-3 AT ROW 2.29 COL 31.86 WIDGET-ID 6
     IMAGE-4 AT ROW 2.29 COL 47.29 WIDGET-ID 8
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 3 ROW 2.85
         SIZE 76.86 BY 10.62
...
{utp/ut9000.i "escpp110" "2.00.00.000"}
...
------------------------------------------------------------------------------*/
  ...
  DISPLAY c-it-codigo-ini c-it-codigo-fim c-homolog-ini c-homolog-fim 
      WITH FRAME f-pg-sel IN WINDOW w-relat.
  ENABLE IMAGE-1 IMAGE-2 IMAGE-3 IMAGE-4 c-it-codigo-ini c-it-codigo-fim 
         c-homolog-ini c-homolog-fim 
      WITH FRAME f-pg-sel IN WINDOW w-relat.
...
do on error undo, return error on stop  undo, return error:
    ...
    assign tt-param.usuario         = c-seg-usuario
           ...
           tt-param.homolog-ini     = INPUT FRAME f-pg-sel c-homolog-ini 
           tt-param.homolog-fim     = INPUT FRAME f-pg-sel c-homolog-fim
           .
    ...
    {include/i-rprun.i esp/cpp/escpp110rp.p}
