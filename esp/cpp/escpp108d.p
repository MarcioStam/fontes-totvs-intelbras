{include/i-prgvrs.i escpp108d 2.04.00.001}
/***********************************************************************
**  Programa..: ESP\escpp108d.P
       ...
       DO:
           ...
           FOR EACH tt-rep-prod:
               FIND FIRST ITEM NO-LOCK
                    WHERE ITEM.it-codigo = tt-rep-prod.it-codigo NO-ERROR.

               IF ITEM.tipo-con-est = 3 
               OR ITEM.tipo-con-est = 4 THEN
                   ASSIGN tt-rep-prod.lote-serie = "generico"
