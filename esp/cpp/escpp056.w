...
&GLOBAL-DEFINE Program        escpp056
...
&GLOBAL-DEFINE page2Fields    fi-cod-estabel 
...
DEFINE FRAME fPage2
     fi-cod-estabel AT ROW 2.5 COL 29 COLON-ALIGNED HELP
          "Estabelecimento" WIDGET-ID 4
...
ON MOUSE-SELECT-DBLCLICK OF fi-cod-estabel IN FRAME fPage2 /* Estab */
DO:
  apply "F5":U to self.
END.
...
apply "LEAVE":U to fi-cod-estabel in frame fPage2.
...
do on error undo, return error on stop  undo, return error:
    ...
    {report/rprun.i esp/cpp/escpp056rp.p}
