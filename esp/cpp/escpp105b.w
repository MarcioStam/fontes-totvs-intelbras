...
*******************************************************************************/
{include/i-prgvrs.i ESCPP105B 2.00.00.000}
{include/i-license-manager.i ESCPP105B FGL}

CREATE WIDGET-POOL.

/* Preprocessors Definitions ---                                      */
&GLOBAL-DEFINE Program        ESCPP105B
...
DO:
    ...
    /* Valida permissío para reimprimir */
    FOR EACH tt-prog-ponto: DELETE tt-prog-ponto. END.

    RUN esp\es0018p.p (INPUT "escpp105b",   /* Nome do programa */
    ...
    IF NOT AVAIL tt-prog-ponto THEN DO:
        RUN utp/ut-msgs.p (INPUT "SHOW":U,
                           INPUT 17006,
                           INPUT "Usuario sem permiss∆o para reimprimir.").
...
DO:
    ...
    ELSE DO:
        ...
        THEN DO:
           RUN utp/ut-msgs.p (INPUT 'show':U,
                              INPUT 17006,
                              INPUT 'Numero de Serie ' + STRING(fc-ns) + ' j† foi impresso'
                                    + '~~' + 'Deve ser efetuado reimpress∆o').
           RETURN "NOK":U.
        END.
