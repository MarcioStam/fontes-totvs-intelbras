...
&Scoped-define INTERNAL-TABLES int-param-ord-prod-monitor

/* Definitions for QUERY Query-Main                                     */
&Scoped-define QUERY-STRING-Query-Main FOR EACH int-param-ord-prod-monitor NO-LOCK
&Scoped-define OPEN-QUERY-Query-Main OPEN QUERY Query-Main FOR EACH int-param-ord-prod-monitor NO-LOCK.
&Scoped-define TABLES-IN-QUERY-Query-Main int-param-ord-prod-monitor
&Scoped-define FIRST-TABLE-IN-QUERY-Query-Main int-param-ord-prod-monitor
...
<FOREIGN-KEYS>
cod-estabel||y|mgesp.int-param-ord-prod-monitor.cod-estabel
...
DEFINE QUERY Query-Main FOR 
      int-param-ord-prod-monitor SCROLLING.
&ANALYZE-RESUME
...
/* Query rebuild information for QUERY Query-Main
     _TblList          = "mgesp.int-param-ord-prod-monitor"
     _Options          = "NO-LOCK"
