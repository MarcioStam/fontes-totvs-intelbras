...
DEFINE TEMP-TABLE tt-altern-astec NO-UNDO LIKE altern-astec
...
*******************************************************************************/
{include/i-prgvrs.i escpp095 1.00.00.000}
...
&GLOBAL-DEFINE Program          escpp095
&GLOBAL-DEFINE Version          1.00.00.000

&GLOBAL-DEFINE Folder           YES
&GLOBAL-DEFINE InitialPage      1
&GLOBAL-DEFINE FolderLabels     Alternativo
...
&GLOBAL-DEFINE ttSon1           tt-altern-astec
&GLOBAL-DEFINE hDBOSon1         h-boes718
&GLOBAL-DEFINE DBOSon1Table     altern-astec
&GLOBAL-DEFINE DBOSon1Destroy   TRUE
...
&Scoped-define INTERNAL-TABLES tt-altern-astec

/* Definitions for BROWSE brSon1                                        */
&Scoped-define FIELDS-IN-QUERY-brSon1 tt-altern-astec.it-altern ~
f-desc-item(tt-altern-astec.it-altern) @ c-desc-item 
&Scoped-define ENABLED-FIELDS-IN-QUERY-brSon1 
&Scoped-define QUERY-STRING-brSon1 FOR EACH tt-altern-astec NO-LOCK
&Scoped-define OPEN-QUERY-brSon1 OPEN QUERY brSon1 FOR EACH tt-altern-astec NO-LOCK.
&Scoped-define TABLES-IN-QUERY-brSon1 tt-altern-astec
&Scoped-define FIRST-TABLE-IN-QUERY-brSon1 tt-altern-astec
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _FUNCTION-FORWARD f-desc-item wMasterDetail 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS brSon1 wMasterDetail _STRUCTURED
  QUERY brSon1 NO-LOCK DISPLAY
      tt-altern-astec.it-altern FORMAT "x(16)":U
      f-desc-item(tt-altern-astec.it-altern) @ c-desc-item COLUMN-LABEL "Descri‡Æo" FORMAT "X(60)":U
            WIDTH 60
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
...
DEFINE FRAME fPage0
     ...
     btHelp AT ROW 1.13 COL 86.86 HELP
          "Ajuda"
     tt-item.it-codigo AT ROW 3 COL 13 COLON-ALIGNED WIDGET-ID 4
          VIEW-AS FILL-IN 
          SIZE 12.57 BY .88
     tt-item.desc-item AT ROW 3 COL 26 COLON-ALIGNED NO-LABEL WIDGET-ID 2
          VIEW-AS FILL-IN 
          SIZE 51 BY .88
...
/* Settings for THIS-PROCEDURE
   ...
   Temp-Tables and Buffers:
      TABLE: tt-altern-astec T "?" NO-UNDO mgesp altern-astec
      ADDITIONAL-FIELDS:
          field r-rowid as rowid
      END-FIELDS.
...
/* Query rebuild information for BROWSE brSon1
     _TblList          = "Temp-Tables.tt-altern-astec"
     _Options          = "NO-LOCK"
     _FldNameList[1]   = Temp-Tables.tt-altern-astec.it-altern
     _FldNameList[2]   > "_<CALC>"
"f-desc-item(tt-altern-astec.it-altern) @ c-desc-item" "Descri‡Æo" "X(60)" ? ? ? ? ? ? ? no ? no no "60" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _Query            is OPENED
*/  /* BROWSE brSon1 */
&ANALYZE-RESUME
...
DO:
    {masterdetail/addson.i &ProgramSon="esp/cpp/escpp095a.w"
                           &PageNumber="1"}
END.
...
------------------------------------------------------------------------------*/
    ...
    IF NOT VALID-HANDLE({&hDBOSon1}) OR 
       ...
       {&hDBOSon1}:FILE-NAME <> "esbo/boes718.p":U THEN DO:
        {btb/btb008za.i1 esbo/boes718.p YES}
        {btb/btb008za.i2 esbo/boes718.p '' {&hDBOSon1}} 
    END.
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _FUNCTION f-desc-item wMasterDetail 
FUNCTION f-desc-item RETURNS CHARACTER
