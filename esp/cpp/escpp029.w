...
*******************************************************************************/
{include/i-prgvrs.i ESCPP029 2.04.00.001}

CREATE WIDGET-POOL.

/* Preprocessors Definitions ---                                      */
&GLOBAL-DEFINE Program        ESCPP029
...
&GLOBAL-DEFINE page2Fields    fi-fim-cod-fabric fi-fim-it-codigo fi-ini-cod-fabric fi-ini-it-codigo
...
DEFINE VARIABLE fi-fim-cod-fabric AS INTEGER FORMAT ">>>,>>9" INITIAL 999999 
     VIEW-AS FILL-IN 
...
DEFINE VARIABLE fi-ini-cod-fabric AS INTEGER FORMAT ">>>,>>9" INITIAL 0 
     LABEL "Fabricante" 
     VIEW-AS FILL-IN 
     SIZE 9.14 BY .88 NO-UNDO.
...
DEFINE FRAME fPage6
     ...
     tb-parametros AT ROW 2.5 COL 53 WIDGET-ID 2
     rect-rtf AT ROW 5.29 COL 2
     RECT-7 AT ROW 1.92 COL 2.14
     RECT-9 AT ROW 9 COL 2
     RECT-13 AT ROW 2 COL 52 WIDGET-ID 4
...
DEFINE FRAME fPage2
     fi-ini-it-codigo AT ROW 1.5 COL 8.29 COLON-ALIGNED HELP
          "C¢digo do Item" WIDGET-ID 2
     fi-fim-it-codigo AT ROW 1.5 COL 52.14 COLON-ALIGNED HELP
          "C¢digo do Item" NO-LABEL WIDGET-ID 48
     fi-ini-cod-fabric AT ROW 2.5 COL 8.29 COLON-ALIGNED HELP
          "Informe o codigo do fabricante" WIDGET-ID 4
     fi-fim-cod-fabric AT ROW 2.5 COL 52.14 COLON-ALIGNED HELP
          "Informe o codigo do fabricante" NO-LABEL WIDGET-ID 46
     cb-ini-cod-obsoleto AT ROW 3.5 COL 8.29 COLON-ALIGNED WIDGET-ID 28
     cb-fim-cod-obsoleto AT ROW 3.5 COL 52.14 COLON-ALIGNED NO-LABEL WIDGET-ID 36
     IMAGE-1 AT ROW 1.5 COL 35.86
     IMAGE-2 AT ROW 1.5 COL 51.14
     IMAGE-9 AT ROW 2.5 COL 35.86 WIDGET-ID 38
     IMAGE-10 AT ROW 2.5 COL 51.14 WIDGET-ID 40
     IMAGE-11 AT ROW 3.5 COL 35.86 WIDGET-ID 42
     IMAGE-12 AT ROW 3.5 COL 51.14 WIDGET-ID 44
    WITH 1 DOWN KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 3.57 ROW 2.81
         SIZE 84.43 BY 10.15
...
&Scoped-define SELF-NAME fi-fim-cod-fabric
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL fi-fim-cod-fabric wReport
ON F5 OF fi-fim-cod-fabric IN FRAME fPage2 /* Fabricante */
DO:
  {method/ZoomFields.i &ProgramZoom="eszoom/z01es077.w"
                         &FieldZoom1="cod-fabric"
                         &FieldScreen1="fi-fim-cod-fabric"
                         &Frame1="fPage2"
                         &EnableImplant="NO"}  
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL fi-fim-cod-fabric wReport
ON MOUSE-SELECT-DBLCLICK OF fi-fim-cod-fabric IN FRAME fPage2 /* Fabricante */
DO:
  apply "f5" to self.
END.
...
ON F5 OF fi-fim-it-codigo IN FRAME fPage2 /* Item */
DO:
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL fi-fim-it-codigo wReport
ON MOUSE-SELECT-DBLCLICK OF fi-fim-it-codigo IN FRAME fPage2 /* Item */
DO:
  apply "f5" to self.
END.
...
&Scoped-define SELF-NAME fi-ini-cod-fabric
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL fi-ini-cod-fabric wReport
ON F5 OF fi-ini-cod-fabric IN FRAME fPage2 /* Fabricante */
DO:
  {method/ZoomFields.i &ProgramZoom="eszoom/z01es077.w"
                         &FieldZoom1="cod-fabric"
                         &FieldScreen1="fi-ini-cod-fabric"
                         &Frame1="fPage2"
                         &EnableImplant="NO"}  
END.
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL fi-ini-cod-fabric wReport
ON MOUSE-SELECT-DBLCLICK OF fi-ini-cod-fabric IN FRAME fPage2 /* Fabricante */
DO:
  apply "f5" to self.
END.
...
fi-ini-it-codigo:load-mouse-pointer ("image/lupa.cur") in frame fPage2.
fi-fim-it-codigo:load-mouse-pointer ("image/lupa.cur") in frame fPage2.
fi-ini-cod-fabric:load-mouse-pointer ("image/lupa.cur") in frame fPage2.
fi-fim-cod-fabric:load-mouse-pointer ("image/lupa.cur") in frame fPage2.
...
do on error undo, return error on stop  undo, return error:
    ...
    assign tt-param.usuario         = c-seg-usuario
           ...
           tt-param.item-ini        = input frame fPage2 fi-ini-it-codigo
           tt-param.item-fim        = input frame fPage2 fi-fim-it-codigo
           tt-param.fabric-ini      = input frame fPage2 fi-ini-cod-fabric
           tt-param.fabric-fim      = input frame fPage2 fi-fim-cod-fabric
    ...
    {report/rprun.i esp/cpp/escpp029rp.p}
