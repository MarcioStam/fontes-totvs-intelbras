...
*******************************************************************************/
{include/i-prgvrs.i escpp094 1.00.00.000}
...
&GLOBAL-DEFINE Program        escpp094
...
&GLOBAL-DEFINE page4Widgets   tg-semanal fi-email tg-habilita-email
...
DEFINE VARIABLE fl-item-fim AS CHARACTER FORMAT "X(10)":U INITIAL "ZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZ" 
     VIEW-AS FILL-IN 
...
DEFINE VARIABLE tg-habilita-email AS LOGICAL INITIAL no 
     LABEL "Enviar e-mail" 
     VIEW-AS TOGGLE-BOX
     SIZE 13 BY .88 NO-UNDO.

DEFINE VARIABLE tg-semanal AS LOGICAL INITIAL no 
     LABEL "Semanal" 
     VIEW-AS TOGGLE-BOX
...
DEFINE FRAME fPage2
     ...
     fl-data-ini AT ROW 3 COL 23 COLON-ALIGNED WIDGET-ID 2
     fl-data-fim AT ROW 3 COL 52 COLON-ALIGNED NO-LABEL WIDGET-ID 4
     IMAGE-1 AT ROW 1.75 COL 35
     IMAGE-2 AT ROW 1.75 COL 51.14
     IMAGE-5 AT ROW 3 COL 35 WIDGET-ID 10
     IMAGE-6 AT ROW 3 COL 51 WIDGET-ID 12
    WITH 1 DOWN KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 3.57 ROW 2.81
         SIZE 84.43 BY 10.15
...
DEFINE FRAME fPage4
     tg-semanal AT ROW 2 COL 5 WIDGET-ID 2
     tg-habilita-email AT ROW 6 COL 5 WIDGET-ID 8
     fi-email AT ROW 7.25 COL 8 COLON-ALIGNED WIDGET-ID 38
     RECT-44 AT ROW 1.75 COL 3 WIDGET-ID 4
     RECT-45 AT ROW 5.75 COL 3 WIDGET-ID 6
    WITH 1 DOWN KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 3.57 ROW 2.81
         SIZE 84.43 BY 10.15
...
&Scoped-define SELF-NAME tg-habilita-email
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL tg-habilita-email wReport
ON VALUE-CHANGED OF tg-habilita-email IN FRAME fPage4 /* Enviar e-mail */
DO:
    DO WITH FRAME fPage4:
        IF SELF:INPUT-VALUE = NO THEN
             ASSIGN tg-habilita-email:CHECKED = NO
                    fi-email:VISIBLE = NO.
        ELSE
        ASSIGN tg-habilita-email:CHECKED = YES
               fi-email:VISIBLE = YES.
     END. 
...
do on error undo, return error on stop  undo, return error:
    ...
    assign tt-param.usuario         = c-seg-usuario
           ...
           tt-param.semanal         = INPUT FRAME fPage4 tg-semanal
           tt-param.email           = INPUT FRAME fPage4 fi-email
           tt-param.habilita-email  = INPUT FRAME fPage4 tg-habilita-email.
    ...
    {report/rprun.i esp/cpp/escpp094rp.p}
