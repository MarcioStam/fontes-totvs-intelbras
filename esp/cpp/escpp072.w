...
*******************************************************************************/
{include/i-prgvrs.i ESCPP072 2.00.00.000}
...
&GLOBAL-DEFINE ttSon1           tt-item-rast
&GLOBAL-DEFINE hDBOSon1         h-boes618
&GLOBAL-DEFINE DBOSon1Table     item-rast
&GLOBAL-DEFINE DBOSon1Destroy   NO

&GLOBAL-DEFINE page0Fields      tt-item.it-codigo tt-item.desc-item 

//&GLOBAL-DEFINE page1Fields      tg-ult
...
&Scoped-define INTERNAL-TABLES tt-item-rast

/* Definitions for BROWSE brSon1                                        */
&Scoped-define FIELDS-IN-QUERY-brSon1 tt-item-rast.data-ini ~
tt-item-rast.data-fim tt-item-rast.usuario tt-item-rast.observacao 
&Scoped-define ENABLED-FIELDS-IN-QUERY-brSon1 
&Scoped-define QUERY-STRING-brSon1 FOR EACH tt-item-rast NO-LOCK
&Scoped-define OPEN-QUERY-brSon1 OPEN QUERY brSon1 FOR EACH tt-item-rast NO-LOCK.
&Scoped-define TABLES-IN-QUERY-brSon1 tt-item-rast
&Scoped-define FIRST-TABLE-IN-QUERY-brSon1 tt-item-rast
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS brSon1 wMasterDetail _STRUCTURED
  QUERY brSon1 NO-LOCK DISPLAY
      tt-item-rast.data-ini FORMAT "99/99/9999":U WIDTH 12.43
      tt-item-rast.data-fim FORMAT "99/99/9999":U WIDTH 11.43
      tt-item-rast.usuario FORMAT "x(12)":U WIDTH 11.43
      tt-item-rast.observacao FORMAT "x(200)":U WIDTH 40
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
...
/* Query rebuild information for BROWSE brSon1
     _TblList          = "Temp-Tables.tt-item-rast"
     _Options          = "NO-LOCK"
     _FldNameList[1]   > Temp-Tables.tt-item-rast.data-ini
"tt-item-rast.data-ini" ? ? "date" ? ? ? ? ? ? no ? no no "12.43" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[2]   > Temp-Tables.tt-item-rast.data-fim
"tt-item-rast.data-fim" ? ? "date" ? ? ? ? ? ? no ? no no "11.43" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[3]   > Temp-Tables.tt-item-rast.usuario
"tt-item-rast.usuario" ? ? "character" ? ? ? ? ? ? no ? no no "11.43" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[4]   > Temp-Tables.tt-item-rast.observacao
"tt-item-rast.observacao" ? ? "character" ? ? ? ? ? ? no ? no no "40" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _Query            is OPENED
*/  /* BROWSE brSon1 */
&ANALYZE-RESUME
...
DO:
    {masterdetail/addson.i &ProgramSon="esp/cpp/escpp072a.w"
                           &PageNumber="1"}
END.
...
DO:
    {masterdetail/copyson.i &ProgramSon="esp/cpp/escpp072a.w"
                            &PageNumber="1"}
END.
...
DO:
    {masterdetail/updateson.i &ProgramSon="esp/cpp/escpp072a.w"
                              &PageNumber="1"}
END.
...
------------------------------------------------------------------------------*/
    ...
    IF NOT VALID-HANDLE({&hDBOSon1}) OR 
       ...
       {&hDBOSon1}:FILE-NAME <> "esbo/boes618.p":U THEN DO:
        {btb/btb008za.i1 esbo/boes618.p YES}
        {btb/btb008za.i2 esbo/boes618.p '' {&hDBOSon1}} 
    END.
    
  //  ASSIGN tg-ult:SENSITIVE IN FRAME fpage1 = YES.
