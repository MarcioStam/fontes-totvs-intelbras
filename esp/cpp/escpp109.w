...
*******************************************************************************/
{include/i-prgvrs.i escpp109 2.00.00.000}
...
DEFINE VARIABLE h_escpp109-q01 AS HANDLE NO-UNDO.
DEFINE VARIABLE h_escpp109-v01-2 AS HANDLE NO-UNDO.
...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'esp/cpp/escpp109-v01.w':U ,
             INPUT  FRAME f-cad:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_escpp109-v01-2 ).
       RUN set-position IN h_escpp109-v01-2 ( 2.75 , 1.43 ) NO-ERROR.
       /* Size in UIB:  ( 12.00 , 88.57 ) */

       RUN init-object IN THIS-PROCEDURE (
             INPUT  'esp/cpp/escpp109-q01.w':U ,
             INPUT  FRAME f-cad:HANDLE ,
             INPUT  '':U ,
             OUTPUT h_escpp109-q01 ).
       RUN set-position IN h_escpp109-q01 ( 1.50 , 59.00 ) NO-ERROR.
       /* Size in UIB:  ( 1.63 , 7.72 ) */

       /* Links to SmartPanel h_p-exihel. */
       RUN add-link IN adm-broker-hdl ( h_p-cadsim , 'State':U , h_p-exihel ).

       /* Links to SmartViewer h_escpp109-v01-2. */
       RUN add-link IN adm-broker-hdl ( h_escpp109-q01 , 'Record':U , h_escpp109-v01-2 ).
       RUN add-link IN adm-broker-hdl ( h_p-cadsim , 'TableIO':U , h_escpp109-v01-2 ).

       /* Links to SmartQuery h_escpp109-q01. */
       RUN add-link IN adm-broker-hdl ( h_p-exihel , 'State':U , h_escpp109-q01 ).
       RUN add-link IN adm-broker-hdl ( h_p-navega , 'Navigation':U , h_escpp109-q01 ).
       RUN add-link IN adm-broker-hdl ( h_p-navega , 'State':U , h_escpp109-q01 ).
       ...
       RUN adjust-tab-order IN adm-broker-hdl ( h_p-exihel ,
             h_p-cadsim , 'AFTER':U ).
       RUN adjust-tab-order IN adm-broker-hdl ( h_escpp109-v01-2 ,
             h_p-exihel , 'AFTER':U ).
    END. /* Page 0 */
...
------------------------------------------------------------------------------*/
  ...
  {utp/ut9000.i "escpp109" "2.00.00.000"}
