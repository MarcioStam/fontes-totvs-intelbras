...
*******************************************************************************/
{include/i-prgvrs.i ESCPP085RP 2.00.00.000}  /*** 010000 ***/
/*******************************************************************************
**  Programa: ESCPP085RP
**  Objetivo: <comment>
...
assign c-programa     = "ESCPP085"
       c-sistema      = "ESP"
       c-titulo-relat = "Relat¢rio de Item Rastreabilidade"
       c-versao       = "2.00.00"
       c-revisao      = "000"
       c-empresa      = "Intelbras".
...
FOR EACH item-rast NO-LOCK
    WHERE item-rast.it-codigo >= tt-param.it-codigo-ini
    AND   item-rast.it-codigo <= tt-param.it-codigo-fim:

    FOR FIRST ITEM NO-LOCK
        WHERE ITEM.it-codigo = item-rast.it-codigo:

        FOR FIRST usuar_mestre NO-LOCK
            WHERE usuar_mestre.cod_usuario = item-rast.usuario:

            DISP item-rast.it-codigo
                 ITEM.desc-item
                 item-rast.data-ini
                 item-rast.data-fim
                 item-rast.usuario
