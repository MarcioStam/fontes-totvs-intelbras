...
&GLOBAL-DEFINE Program        ESCPP066
...
&GLOBAL-DEFINE page0Widgets   tg-astec btQueryJoins btReportsJoins btExit btHelp ~
                              ...
                              c-sigla i-qtd btConfigImpr btReimpressao bt-imp-teste fi-lei-info
...
&Scoped-Define ENABLED-OBJECTS tg-astec fi-lei-info btReimpressao ~
btQueryJoins btReportsJoins btExit btHelp c-it-codigo c-desc-item ~
c-desc-modelo c-sigla c-desc-sigla c-cod-estabel c-desc-estabelec i-qtd ~
i-num-po cb-modelo btConfigImpr btOK btCancel btHelp2 fiPrinter ~
bt-imp-teste rtToolBar-2 rtToolBar RECT-1 RECT-2 RECT-3 rt-cor 
&Scoped-Define DISPLAYED-OBJECTS tg-astec fi-lei-info c-it-codigo ~
c-desc-item c-desc-modelo c-sigla c-desc-sigla c-cod-estabel ~
c-desc-estabelec i-qtd i-num-po cb-modelo fiPrinter 
...
DEFINE FRAME fpage0
     ...
     fi-lei-info AT ROW 19.63 COL 27.14 COLON-ALIGNED NO-LABEL WIDGET-ID 46
     ...
     i-num-po AT ROW 7.13 COL 48.72 COLON-ALIGNED WIDGET-ID 48
     ...
     btOK AT ROW 21.46 COL 2
     btCancel AT ROW 21.46 COL 12
     btHelp2 AT ROW 21.46 COL 88.43
     fiPrinter AT ROW 8.04 COL 20.72 NO-LABEL WIDGET-ID 24 NO-TAB-STOP 
     bt-imp-teste AT ROW 21.46 COL 45.14 WIDGET-ID 34
     ...
     RECT-3 AT ROW 9.33 COL 2 WIDGET-ID 20
     im-imagem AT ROW 9.67 COL 3 WIDGET-ID 28
     rt-cor AT ROW 19.5 COL 3 WIDGET-ID 38
...
DO:
    ...
    /* Banda KU escpp105 - imprimir data */
...
IF AVAIL item-ean THEN DO:
    IF item-ean.tp-fabric = 1 THEN DO: /*CKD*/
       ...
       IF cb-modelo:SCREEN-VALUE IN FRAME fPage0 = '510' AND v_cod_estab_usuar = '104' THEN 
           ASSIGN i-num-po:LABEL   IN FRAME fPage0 = 'N¯ PO'
                  i-num-po:VISIBLE IN FRAME fPage0 = YES.
       ...
       FOR EACH tt-prog-ponto:
           IF tt-prog-ponto.conteudo = cb-modelo:SCREEN-VALUE THEN DO:
              ASSIGN i-num-po:LABEL   IN FRAME fPage0 = 'Nr Ord.Prod'
                     i-num-po:VISIBLE IN FRAME fPage0 = YES.
