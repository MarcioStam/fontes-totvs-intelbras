...
&GLOBAL-DEFINE Program        ESCPP009
...
&GLOBAL-DEFINE page2Widgets   fi-cod-estabel fi-fim-it-codigo fi-fim-maximo fi-fim-minimo ~
                              fi-fim-nr-linha fi-ini-it-codigo fi-ini-maximo ~
                              fi-ini-minimo fi-ini-nr-linha tb-lista tb-lista-1 tb-lista-2
...
&GLOBAL-DEFINE page2Fields    fi-fim-it-codigo fi-fim-maximo fi-fim-minimo ~
                              fi-fim-nr-linha fi-ini-it-codigo fi-ini-maximo ~
                              fi-ini-minimo fi-ini-nr-linha 
...
DEFINE VARIABLE fi-fim-maximo AS INTEGER FORMAT ">,>>>,>>9" INITIAL 9999999 
     VIEW-AS FILL-IN 
     SIZE 10 BY .88.

DEFINE VARIABLE fi-fim-minimo AS INTEGER FORMAT ">,>>>,>>9" INITIAL 9999999 
     VIEW-AS FILL-IN 
     SIZE 10 BY .88.

DEFINE VARIABLE fi-fim-nr-linha AS INTEGER FORMAT ">>9" INITIAL 8 
     VIEW-AS FILL-IN 
     SIZE 4 BY .88.
...
DEFINE VARIABLE fi-ini-maximo AS INTEGER FORMAT ">,>>>,>>9" INITIAL 0 
     LABEL "M ximo" 
     VIEW-AS FILL-IN 
     SIZE 10 BY .88.

DEFINE VARIABLE fi-ini-minimo AS INTEGER FORMAT ">,>>>,>>9" INITIAL 0 
     LABEL "M¡nimo" 
     VIEW-AS FILL-IN 
     SIZE 10 BY .88.
...
DEFINE VARIABLE tb-lista AS LOGICAL INITIAL no 
     LABEL "Lista com saldo OK?" 
     VIEW-AS TOGGLE-BOX
     SIZE 20 BY .83 NO-UNDO.

DEFINE VARIABLE tb-lista-1 AS LOGICAL INITIAL no 
     LABEL "Lista abaixo do m¡nimo?" 
     VIEW-AS TOGGLE-BOX
     SIZE 20 BY .83 NO-UNDO.

DEFINE VARIABLE tb-lista-2 AS LOGICAL INITIAL no 
     LABEL "Lista acima do m ximo?" 
     VIEW-AS TOGGLE-BOX
     SIZE 20 BY .83 NO-UNDO.
...
DEFINE FRAME fPage2
     fi-cod-estabel AT ROW 1.75 COL 30 COLON-ALIGNED WIDGET-ID 2
     fi-ini-nr-linha AT ROW 2.75 COL 35 RIGHT-ALIGNED
     fi-fim-nr-linha AT ROW 2.75 COL 53 COLON-ALIGNED NO-LABEL
     fi-ini-it-codigo AT ROW 3.75 COL 35 RIGHT-ALIGNED
     fi-fim-it-codigo AT ROW 3.75 COL 53 COLON-ALIGNED NO-LABEL
     fi-ini-minimo AT ROW 4.75 COL 35 RIGHT-ALIGNED
     fi-fim-minimo AT ROW 4.75 COL 53 COLON-ALIGNED NO-LABEL
     fi-ini-maximo AT ROW 5.75 COL 35 RIGHT-ALIGNED
     fi-fim-maximo AT ROW 5.75 COL 53 COLON-ALIGNED NO-LABEL
     tb-lista-1 AT ROW 7.5 COL 20
     tb-lista-2 AT ROW 8.5 COL 20
     tb-lista AT ROW 9.5 COL 20
     IMAGE-1 AT ROW 2.75 COL 36.29
     IMAGE-2 AT ROW 2.75 COL 51.72
     IMAGE-3 AT ROW 3.75 COL 36.29
     IMAGE-4 AT ROW 3.75 COL 51.72
     IMAGE-5 AT ROW 4.75 COL 36.29
     IMAGE-6 AT ROW 4.75 COL 51.72
     IMAGE-7 AT ROW 5.75 COL 36.29
     IMAGE-8 AT ROW 5.75 COL 51.72
...
/* SETTINGS FOR FILL-IN fi-ini-it-codigo IN FRAME fPage2
   ALIGN-R                                                              */
/* SETTINGS FOR FILL-IN fi-ini-maximo IN FRAME fPage2
   ALIGN-R                                                              */
/* SETTINGS FOR FILL-IN fi-ini-minimo IN FRAME fPage2
   ALIGN-R                                                              */
/* SETTINGS FOR FILL-IN fi-ini-nr-linha IN FRAME fPage2
   ALIGN-R                                                              */
...
do on error undo, return error on stop  undo, return error:
    ...
    assign tt-param.usuario         = c-seg-usuario
           ...
           tt-param.nr-linha-ini    = INPUT FRAME fPage2 fi-ini-nr-linha
           tt-param.nr-linha-fim    = INPUT FRAME fPage2 fi-fim-nr-linha
           tt-param.it-codigo-ini   = INPUT FRAME fPage2 fi-ini-it-codigo
           tt-param.it-codigo-fim   = INPUT FRAME fPage2 fi-fim-it-codigo
           tt-param.minimo-ini      = INPUT FRAME fPage2 fi-ini-minimo
           tt-param.minimo-fim      = INPUT FRAME fPage2 fi-fim-minimo
           tt-param.maximo-ini      = INPUT FRAME fPage2 fi-ini-maximo
           tt-param.maximo-fim      = INPUT FRAME fPage2 fi-fim-maximo
           tt-param.lista-ok        = INPUT FRAME fPage2 tb-lista
           tt-param.lista-min       = INPUT FRAME fPage2 tb-lista-1
           tt-param.lista-max       = INPUT FRAME fPage2 tb-lista-2
    ...
    {report/rprun.i esp/cpp/escpp009rp.p}
