...
*******************************************************************************/
{include/i-prgvrs.i ESCPP122 2.00.00.000}
{include/i-license-manager.i ESCPP106 FGL}

CREATE WIDGET-POOL.

/* Preprocessors Definitions ---                                      */
&GLOBAL-DEFINE Program        ESCPP122
...
&GLOBAL-DEFINE page0Widgets   btQueryJoins btReportsJoins btExit btHelp ~
                              ...
                              c-sigla btConfigImpr btReimpressao c-qr-code  
...
&Scoped-Define ENABLED-OBJECTS c-it-codigo c-sigla c-qr-code btReimpressao ~
...
&Scoped-Define DISPLAYED-OBJECTS c-it-codigo c-sigla c-qr-code c-desc-item ~
...
DO:
    ...
    RUN esp/cpp/escpp122a.w (OUTPUT c-motivo).

    RUN piImpressao (INPUT c-motivo ).
...
------------------------------------------------------------------------------*/
    ...
    DEF INPUT PARAM p-motivo-reimp AS CHAR NO-UNDO.
    ...
    CREATE tt-lista-ns.
    ASSIGN tt-lista-ns.num-serie = c-n-serie. /*num-serie.n-serie.*/
    ...
    DO TRANSACTION ON ERROR UNDO Grava, LEAVE Grava:
        ...
        FOR FIRST item-mat
            WHERE item-mat.it-codigo = c-it-codigo:SCREEN-VALUE IN FRAME fPage0 NO-LOCK:
        END.

        FOR FIRST item-ean
            WHERE item-ean.it-codigo = c-it-codigo:SCREEN-VALUE IN FRAME fPage0 NO-LOCK:
        END.
        ...
        IF NOT AVAIL num-serie-dahua THEN DO:
           CREATE num-serie-dahua.
           ASSIGN num-serie-dahua.n-serie = c-n-serie
                  num-serie-dahua.mac     = c-mac[1]. 
        END.

        IF p-motivo-reimp <> '' THEN
           ASSIGN num-serie-dahua.hora-reimp = STRING(TIME,'HH:MM:SS') 
                  num-serie-dahua.data-reimp = TODAY                  
                  num-serie-dahua.motivo-reimp = p-motivo-reimp
                  num-serie-dahua.qtd-reimp    = num-serie-dahua.qtd-reimp + 1
                  num-serie-dahua.reimp        = YES.
         
        ASSIGN num-serie-dahua.hora = STRING(TIME,'HH:MM:SS')
               num-serie-dahua.data = TODAY.
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE piImpressaoEtiq wWindow 
PROCEDURE piImpressaoEtiq :
/*------------------------------------------------------------------------------
  Purpose:     
  Parameters:  <none>
  Notes:       
