...
*******************************************************************************/
{include/i-prgvrs.i ESCPP088 1.00.00.000}
...
&GLOBAL-DEFINE Program        ESCPP088
...
&GLOBAL-DEFINE page2Fields    c-it-codigo-ini c-it-codigo-fim
...
DEFINE FRAME fPage2
     c-it-codigo-ini AT ROW 4 COL 21 COLON-ALIGNED HELP
          "C¢digo do Item" WIDGET-ID 2
     c-it-codigo-fim AT ROW 4 COL 49 COLON-ALIGNED HELP
          "C¢digo do Item" NO-LABEL WIDGET-ID 46
     IMAGE-1 AT ROW 4 COL 40.86
     IMAGE-2 AT ROW 4 COL 48
     RECT-13 AT ROW 3 COL 1 WIDGET-ID 12
...
ON F5 OF c-it-codigo-fim IN FRAME fPage2 /* Produto */
DO:
    {include/zoomvar.i &prog-zoom="inzoom/z02in172.w"
                       &campo="c-it-codigo-fim"
                       &campozoom="it-codigo"
                       &frame="fPage2"}
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL c-it-codigo-fim wReport
ON MOUSE-SELECT-DBLCLICK OF c-it-codigo-fim IN FRAME fPage2 /* Produto */
DO:
  APPLY 'F5' TO SELF.
END.
...
ON F5 OF c-it-codigo-ini IN FRAME fPage2 /* Item */
DO:
    {include/zoomvar.i &prog-zoom="inzoom/z02in172.w"
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL c-it-codigo-ini wReport
ON MOUSE-SELECT-DBLCLICK OF c-it-codigo-ini IN FRAME fPage2 /* Item */
DO:
  APPLY 'F5' TO SELF.
END.
...
c-it-codigo-ini:load-mouse-pointer("image/lupa.cur") IN FRAME fPage2.
c-it-codigo-fim:load-mouse-pointer("image/lupa.cur") IN FRAME fPage2.
...
do on error undo, return error on stop  undo, return error:
    ...
    IF INPUT FRAME fPage2 c-it-codigo-ini > INPUT FRAME fPage2 c-it-codigo-fim THEN DO:
        run SetFolder IN hFolder (INPUT 2).
        run utp/ut-msgs.p (input "show":U, input 17006, input "Faixa incorreta." + "~~" + "Item final deve ser maior ou igual a item inicial.":U).
        apply "ENTRY":U to c-it-codigo-ini in frame fPage2.
        return error.
    ...
    assign tt-param.usuario         = c-seg-usuario
           ...
           tt-param.it-codigo-ini   = input frame fPage2 c-it-codigo-ini
           tt-param.it-codigo-fim   = input frame fPage2 c-it-codigo-fim
           &if "{&RTF}":U = "YES":U &then
    ...
    then 
        ...
        then assign tt-param.arquivo = replace(input frame fPage6 cFile, "LST", "LST").
    ...
    {report/rprun.i esp/cpp/escpp088rp.p}
