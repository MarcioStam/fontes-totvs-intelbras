...
&GLOBAL-DEFINE page2Fields    c-cod-emitente-ini c-cod-emitente-fim 
...
DEFINE VARIABLE c-cod-emitente-fim AS INTEGER FORMAT "999999999":U INITIAL 999999999 
     VIEW-AS FILL-IN 
     SIZE 20.86 BY .88
     FONT 1 NO-UNDO.
...
DEFINE FRAME fPage2
     c-cod-emitente-ini AT ROW 1.5 COL 9.57
     c-cod-emitente-fim AT ROW 1.5 COL 54 NO-LABEL
...
do on error undo, return error on stop  undo, return error:
    ...
    {report/rprun.i esp/cpp/escpp099rp.p}
