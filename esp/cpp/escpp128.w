...
*******************************************************************************/
{include/i-prgvrs.i ESCPP128 1.00.00.001}
...
DEFINE VARIABLE data-imp-fim AS DATE FORMAT "99/99/9999":U INITIAL 12/31/9999 
     VIEW-AS FILL-IN 
     SIZE 12 BY .88 NO-UNDO.

DEFINE VARIABLE data-imp-ini AS DATE FORMAT "99/99/9999" INITIAL 01/01/22 
     LABEL "Data Impress∆o" 
     VIEW-AS FILL-IN 
     SIZE 12 BY .88 NO-UNDO.

DEFINE VARIABLE n-serie-fim AS CHARACTER FORMAT "X(15)":U INITIAL "ZZZZZZZZZZZZZZZ" 
     VIEW-AS FILL-IN 
     SIZE 15 BY .88 NO-UNDO.

DEFINE VARIABLE n-serie-ini AS CHARACTER FORMAT "X(15)":U 
     LABEL "Num.SÇrie" 
     VIEW-AS FILL-IN 
     SIZE 15 BY .88 NO-UNDO.
...
DEFINE FRAME f-pg-sel
     n-serie-ini AT ROW 2.75 COL 14 COLON-ALIGNED
     n-serie-fim AT ROW 2.75 COL 47.14 COLON-ALIGNED NO-LABEL
     c-item-ini AT ROW 3.75 COL 14 COLON-ALIGNED WIDGET-ID 16
     c-item-fim AT ROW 3.75 COL 47.14 COLON-ALIGNED NO-LABEL WIDGET-ID 14
     data-imp-ini AT ROW 4.75 COL 16.86 COLON-ALIGNED WIDGET-ID 4
     data-imp-fim AT ROW 4.75 COL 47.14 COLON-ALIGNED NO-LABEL WIDGET-ID 2
     IMAGE-1 AT ROW 2.75 COL 30.86
     IMAGE-2 AT ROW 2.75 COL 46.29
     IMAGE-3 AT ROW 4.75 COL 30.86 WIDGET-ID 6
     IMAGE-4 AT ROW 4.75 COL 46.29 WIDGET-ID 8
     IMAGE-5 AT ROW 3.75 COL 30.86 WIDGET-ID 10
     IMAGE-6 AT ROW 3.75 COL 46.29 WIDGET-ID 12
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 3 ROW 2.85
...
{utp/ut9000.i "ESCPP128" "1.00.00.001"}
...
DO  ON ERROR   UNDO MAIN-BLOCK, LEAVE MAIN-BLOCK
    ...
    data-imp-ini:SCREEN-VALUE IN FRAME f-pg-sel = '01/' + STRING(MONTH(TODAY)) + '/' + STRING(YEAR(TODAY)).
...
------------------------------------------------------------------------------*/
  ...
  DISPLAY n-serie-ini n-serie-fim c-item-ini c-item-fim data-imp-ini 
          data-imp-fim 
      WITH FRAME f-pg-sel IN WINDOW w-relat.
  ENABLE IMAGE-1 IMAGE-2 IMAGE-3 IMAGE-4 IMAGE-5 IMAGE-6 n-serie-ini 
         n-serie-fim c-item-ini c-item-fim data-imp-ini data-imp-fim 
      WITH FRAME f-pg-sel IN WINDOW w-relat.
...
do on error undo, return error on stop  undo, return error:
    ...
    assign tt-param.usuario         = c-seg-usuario
           ...
           tt-param.n-serie-ini     = input frame f-pg-sel n-serie-ini   
           tt-param.n-serie-fim     = input frame f-pg-sel n-serie-fim   
           tt-param.data-imp-ini    = input frame f-pg-sel data-imp-ini  
           tt-param.data-imp-fim    = input frame f-pg-sel data-imp-fim  
    ...
    {include/i-rprun.i esp/cpp/escpp128rp.p}
