...
*******************************************************************************/
{include/i-prgvrs.i ESCPP031 2.04.00.003}

CREATE WIDGET-POOL.

/* Preprocessors Definitions ---                                      */
&GLOBAL-DEFINE Program        ESCPP031
...
&GLOBAL-DEFINE page2Fields    fi-cod-estabel fi-fim-dt-inicio fi-fim-it-codigo fi-fim-nr-ord-produ fi-ini-dt-inicio fi-ini-it-codigo fi-ini-nr-ord-produ
...
DEFINE VARIABLE fi-fim-dt-inicio AS DATE FORMAT "99/99/9999" 
     VIEW-AS FILL-IN 
...
DEFINE VARIABLE fi-fim-nr-ord-produ AS INTEGER FORMAT ">>>,>>>,>>9" INITIAL 999999999 
     VIEW-AS FILL-IN 
     SIZE 13.72 BY .88 NO-UNDO.

DEFINE VARIABLE fi-ini-dt-inicio AS DATE FORMAT "99/99/9999" 
...
DEFINE VARIABLE fi-ini-nr-ord-produ AS INTEGER FORMAT ">>>,>>>,>>9" INITIAL 0 
...
DEFINE FRAME fPage2
     fi-cod-estabel AT ROW 1.5 COL 16.86 COLON-ALIGNED HELP
          "C¢digo do estabelecimento"
     fi-ini-it-codigo AT ROW 2.5 COL 16.86 COLON-ALIGNED HELP
          "C¢digo do Item" WIDGET-ID 4
     fi-fim-it-codigo AT ROW 2.5 COL 54.14 COLON-ALIGNED HELP
          "C¢digo do Item" NO-LABEL WIDGET-ID 18
     fi-ini-nr-ord-produ AT ROW 3.5 COL 16.86 COLON-ALIGNED HELP
          "N£mero da Ordem de Produ‡Æo" WIDGET-ID 22
     fi-fim-nr-ord-produ AT ROW 3.5 COL 54.14 COLON-ALIGNED HELP
          "N£mero da Ordem de Produ‡Æo" NO-LABEL WIDGET-ID 24
     fi-ini-dt-inicio AT ROW 4.5 COL 16.86 COLON-ALIGNED WIDGET-ID 2
     fi-fim-dt-inicio AT ROW 4.5 COL 54.14 COLON-ALIGNED NO-LABEL WIDGET-ID 16
     IMAGE-1 AT ROW 2.5 COL 35.86 WIDGET-ID 8
     IMAGE-2 AT ROW 2.5 COL 53.14 WIDGET-ID 10
     IMAGE-3 AT ROW 3.5 COL 35.86 WIDGET-ID 12
     IMAGE-4 AT ROW 3.5 COL 53.14 WIDGET-ID 14
     IMAGE-5 AT ROW 4.5 COL 35.86 WIDGET-ID 26
     IMAGE-6 AT ROW 4.5 COL 53.14 WIDGET-ID 28
    WITH 1 DOWN KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 3.57 ROW 2.81
         SIZE 84.43 BY 10.15
...
do on error undo, return error on stop  undo, return error:
    ...
    assign tt-param.usuario         = c-seg-usuario
           ...
           tt-param.data-ini        = input frame fPage2 fi-ini-dt-inicio
           tt-param.data-fim        = input frame fPage2 fi-fim-dt-inicio
           tt-param.nr-ord-ini      = input frame fPage2 fi-ini-nr-ord-produ
           tt-param.nr-ord-fim      = input frame fPage2 fi-fim-nr-ord-produ           
    ...
    {report/rprun.i esp/cpp/escpp031rp.p}
