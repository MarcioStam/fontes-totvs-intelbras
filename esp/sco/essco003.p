...
*******************************************************************************/
{include/i-prgvrs.i essco003 2.04.00.000}

CREATE WIDGET-POOL.

/* Preprocessors Definitions ---                                      */
&GLOBAL-DEFINE Program        essco003
...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW wReport ASSIGN
         HIDDEN             = YES
         TITLE              = "Importaá∆o Conciliaá∆o B2C"
         HEIGHT             = 17
         WIDTH              = 90
         MAX-HEIGHT         = 40.83
         MAX-WIDTH          = 182.86
...
do on error undo, return error on stop  undo, return error:
    ...
    */
    ...
    {report/rprun.i esp/sco/essco003rp.p}
    {report/rpexc.i}
...
do  on error undo, return error
    ...
    {report/imrun.i esp/sco/essco003rp.p}
