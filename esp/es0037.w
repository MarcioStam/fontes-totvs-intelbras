...
*******************************************************************************/
{include/i-prgvrs.i ES0037 0.11.00.001}
...
&IF "{&EMSFND_VERSION}" >= "1.00" &THEN
    {include/i-license-manager.i es0037 ESP}
&ENDIF
...
bt-config-impr c-arquivo l-habilitaRtf bt-modelo-rtf text-rtf ~
text-modelo-rtf 
...
DEFINE VARIABLE rs-clientlog AS INTEGER 
     VIEW-AS RADIO-SET VERTICAL
     RADIO-BUTTONS 
          "Ativa", 1,
"Desativa", 2
     SIZE 12 BY 2.04 NO-UNDO.
...
DEFINE FRAME f-pg-par
     rs-clientlog AT ROW 2.46 COL 8 NO-LABEL WIDGET-ID 2
     "Opá‰es Extra - Clientlog" VIEW-AS TEXT
          SIZE 17 BY .67 AT ROW 1.75 COL 8 WIDGET-ID 8
     RECT-10 AT ROW 2.13 COL 7 WIDGET-ID 6
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 3 ROW 3
         SIZE 75 BY 10
...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW w-relat ASSIGN
         HIDDEN             = YES
         TITLE              = "Opá‰es Extras - Clientlog RPW"
         HEIGHT             = 15
         WIDTH              = 81.14
         MAX-HEIGHT         = 22.33
         MAX-WIDTH          = 114.29
...
ON END-ERROR OF w-relat /* Opá‰es Extras - Clientlog RPW */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL w-relat w-relat
ON WINDOW-CLOSE OF w-relat /* Opá‰es Extras - Clientlog RPW */
DO:
...
{utp/ut9000.i "ES0037" "0.11.00.001"}  
...
------------------------------------------------------------------------------*/
  ...
  ENABLE rect-rtf RECT-7 RECT-9 rs-destino bt-arquivo bt-config-impr c-arquivo 
         l-habilitaRtf bt-modelo-rtf text-rtf text-modelo-rtf 
      WITH FRAME f-pg-imp IN WINDOW w-relat.
  {&OPEN-BROWSERS-IN-QUERY-f-pg-imp}
  DISPLAY rs-clientlog 
      WITH FRAME f-pg-par IN WINDOW w-relat.
  ENABLE RECT-10 rs-clientlog 
      WITH FRAME f-pg-par IN WINDOW w-relat.
...
do on error undo, return error on stop  undo, return error:
    ...
    **********/
    ...
    assign tt-param.usuario         = c-seg-usuario
           ...
           tt-param.i-clientlog     = input frame f-pg-par rs-clientlog
    ...
    {include/i-rprun.i esp/es0037rp.p}
