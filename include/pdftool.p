...
PROCEDURE DisplayTableHeader:
  ...
  DO i_Field = 1 TO h_DataBuffer:NUM-FIELDS:
    ...
    IF d_Outline <> 0 THEN DO:
     /* RUN pdf_stroke_fill in pCallProc (pdfStream,d_BGred,d_BGgreen,d_BGblue). 1*/
...
PROCEDURE DisplayTableDetail:
  ...
  DO i_Field = 1 TO h_DataBuffer:NUM-FIELDS:
    ...
    DO:
      ...
      /*RUN pdf_stroke_fill IN pCallProc (pdfStream,d_BGred,d_BGgreen,d_BGblue). 2*/
...
PROCEDURE DisplayTableOutline:
  ...
  IF d_Outline > 0 THEN DO:
    ...
    /*RUN pdf_stroke_fill IN pCallProc (pdfStream,d_BGred,d_BGgreen,d_BGblue). 3*/
...
PROCEDURE CalendarMonth:
  ...
  c_Weekdays = pdf_get_tool_parameter(pdfStream,
                                      ...
                                      "WeekDays",
                                       0) NO-ERROR.
  IF c_Weekdays = "" THEN 
    c_Weekdays = "Domingo,Segunda,Ter‡a,Quarta,Quinta,Sexta,S bado".
