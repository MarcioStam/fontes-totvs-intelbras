...
** Data Geracao..........: 19/08/2008 - 14:04:43
** Criado por............: Ganzen
** Criado em.............: 16/11/1995 09:12:50
** Alterado por..........: fut1228_4
** Alterado em...........: 31/10/2006 14:08:02
** Gerado por............: fut43120
*****************************************************************************/
...
def frame f_dlg_02_bord_ap_param_impres
    ...
    rt_009
         at row 08.04 col 03.00
    " Borderì " view-as text
         at row 07.74 col 05.00 bgcolor 8 
    rt_008
    ...
    v_ind_dest_bord_ap
         ...
         bgcolor 8 
    v_ind_bord_dados_1
         at row 08.50 col 04.29 no-label
         view-as radio-set Vertical
         radio-buttons "Borderì", "Borderì","Guia Previdància Social", "Guia Previdància Social","Darf", "Darf"
          /*l_bordero*/ /*l_bordero*/ /*l_gps*/ /*l_gps*/ /*l_darf*/ /*l_darf*/
         bgcolor 8 
    ...
    v_nom_arq_bord_ap
         ...
         bgcolor 15 font 2
    v_ind_ender_complet
         at row 11.33 col 03.43 no-label
         view-as radio-set Vertical
         radio-buttons "Endereáo", "Endereáo","Endereáo Completo", "Endereáo Completo"
          /*l_endereco*/ /*l_endereco*/ /*l_endereco_completo*/ /*l_endereco_completo*/
         bgcolor 8 
...
DO:
    ...
    if not v_log_pagto_trib then do:    
        if input frame f_dlg_02_bord_ap_param_impres v_ind_bord_guia = "Borderì" /*l_bordero*/  then do:
            run prgfin/apb/apb742zb.py (Input v_log_impr_histor_pef) /*prg_fnc_bord_ap_imprimir*/.
        end.
        else do:
...
then do:
    run pi_version_extract ('fnc_bord_ap_param_impres':U, 'prgfin/apb/apb742za.p':U, '1.00.00.023':U, 'pro':U).
end /* if */.
...
then do:
    ...
    assign v_log_method = v_ind_classif_bord:delete("Por Fornecedor" /*l_por_fornecedor*/ )     
           v_log_method = v_ind_classif_bord:delete("Por Data Vencimento" /*l_por_data_vencimento*/ )
           v_log_method = v_ind_classif_bord:delete("Por Forma de Pagto/Fornecedor" /*l_por_forma_pagto_fornecedor*/ )
           v_log_method = v_ind_classif_bord:delete("Por Estabelecimento/Fornecedor" /*l_por_estabelecimentofornecedor*/ )
           v_log_method = v_ind_classif_bord:delete("Por Estabelecimento/Data Vencto" /*l_por_estabelecimentodata_vencto*/ )
           v_log_method = v_ind_classif_bord:delete("Por Estabelecimento/Forma Pagto" /*l_por_estabelecimentoforma_pagto*/ )
           v_log_method = v_ind_classif_bord:delete("Por Fornecedor/Documento" /*l_por_fornecedordocumento*/ )
           in frame f_dlg_02_bord_ap_param_impres.
    assign v_log_method = v_ind_classif_bord:insert("Por Favorecido" /*l_por_favorecido*/ ,1)     
           v_log_method = v_ind_classif_bord:insert("Por Data Emiss∆o" /*l_por_data_emissao*/ ,2)
           in frame f_dlg_02_bord_ap_param_impres.
