/*****************************************************************************
** Programa..............: fas727ca_epc.p - isl_bas_bem_pat_calculo_movto
...
DEFINE NEW GLOBAL SHARED VAR h_bt_zoo_183865  AS WIDGET-HANDLE NO-UNDO.
...
IF  p_ind_event = "ENABLE" THEN DO:
    ...
    IF  NOT AVAIL tt-prog-ponto THEN DO:
        ...
        RUN piFindWidget(INPUT "bt_zoo_183865", 
                         INPUT "BUTTON", 
                         INPUT  p_wgh_frame, 
                         OUTPUT h_bt_zoo_183865).
    
        IF  VALID-HANDLE(h_bt_zoo_183865) THEN
            ASSIGN h_bt_zoo_183865:SENSITIVE = NO.
    END.
END.
