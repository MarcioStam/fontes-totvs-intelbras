...
PROCEDURE pi_trata_motivo:
    ...
    IF  VALID-HANDLE(h_ind_motiv_bxa) THEN DO:
        ...
        IF  wh_ind_motiv_bxa_fas702ca:SCREEN-VALUE = "N∆o Localizado/Doado" THEN
            ASSIGN h_ind_motiv_bxa:SCREEN-VALUE = "Inutilizaá∆o".

        IF  wh_ind_motiv_bxa_fas702ca:SCREEN-VALUE = "Sem Condiá∆o de Uso" THEN
            ASSIGN h_ind_motiv_bxa:SCREEN-VALUE = "Exaust∆o".

        IF  wh_ind_motiv_bxa_fas702ca:SCREEN-VALUE <> "N∆o Localizado/Doado" 
        AND wh_ind_motiv_bxa_fas702ca:SCREEN-VALUE <> "Sem Condiá∆o de Uso" THEN
            ASSIGN h_ind_motiv_bxa:SCREEN-VALUE = wh_ind_motiv_bxa_fas702ca:SCREEN-VALUE.
...
PROCEDURE pi_trata_leave_2:
    ...
    IF  VALID-HANDLE(wh_ind_motiv_bxa_fas702ca) THEN DO:        

        IF  wh_ind_motiv_bxa_fas702ca:SCREEN-VALUE = "" 
        OR  wh_ind_motiv_bxa_fas702ca:SCREEN-VALUE = ? THEN
            ASSIGN wh_ind_motiv_bxa_fas702ca:SCREEN-VALUE = "N∆o Localizado/Doado".

        APPLY "ENTRY" TO wh_ind_motiv_bxa_fas702ca.
    END.
