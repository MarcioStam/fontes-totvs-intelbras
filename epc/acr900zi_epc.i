...
DEFINE TEMP-TABLE tt_log_erros NO-UNDO
    ...
    FIELD tta_serie         AS CHARACTER FORMAT "x(5)":U                          LABEL "S²rie":U          COLUMN-LABEL "Ser":U
    ...
    FIELD ttv_num_mensagem  AS INTEGER   FORMAT ">>>>,>>9":U                      LABEL "Nœmero":U         COLUMN-LABEL "Nœmero":U
