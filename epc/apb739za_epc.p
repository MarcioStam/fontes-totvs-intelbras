/****************************************************************************
** Programa..............: apb739za_epc
** Versao................: 1.00.00.000
** Nome Externo..........: epc/apb739za_epc.p
** Criado por............: Andrey Mauricio de Oliveira
** Criado em.............: 08/11/2018
*****************************************************************************/
...
IF  p_cod_evento <> "Implantacao" THEN 
    RETURN "OK".

FIND FIRST tt_epc
    WHERE tt_epc.cod_event     = "Implantacao"
    AND   tt_epc.cod_parameter = "Recid" NO-LOCK NO-ERROR.

IF  NOT AVAIL tt_epc THEN 
    RETURN "OK".

FIND FIRST tit_ap
    WHERE RECID(tit_ap) = int64(tt_epc.val_parameter) NO-LOCK NO-ERROR.
