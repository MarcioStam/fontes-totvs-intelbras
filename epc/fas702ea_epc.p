/*****************************************************************************
** Programa..............: fas702ea_epc.p
** Descricao.............: EPC do programa edl_bem_pat_baixa
...
DEF VAR h_fas702ea_epc_1 AS WIDGET-HANDLE NO-UNDO.
...
IF  p_ind_event = "INITIALIZE" THEN DO:
    RUN epc/fas702ea_epc_01.p PERSISTENT SET h_fas702ea_epc_1(INPUT p_ind_event,
                                                              INPUT p_ind_object,
                                                              INPUT p_wgh_object,
                                                              INPUT p_wgh_frame,
                                                              INPUT p_cod_table,
    ...
    IF  VALID-HANDLE(h_ind_motiv_bxa) THEN DO:
        ...
        CREATE COMBO-BOX wh_ind_motiv_bxa_fas702ea
        ASSIGN FRAME           = p_wgh_frame
               ...
               SENSITIVE       = YES
               VISIBLE         = YES
               LIST-ITEMS      = "N∆o Localizado/Doado,Quebra,Venda,Devoluá∆o,Sem Condiá∆o de Uso"
               LIST-ITEM-PAIRS = "N∆o Localizado/Doado,N∆o Localizado/Doado,Quebra,Quebra,Venda,Venda,Devoluá∆o,Devoluá∆o,Sem Condiá∆o de Uso,Sem Condiá∆o de Uso".
    END.

    ON "VALUE-CHANGED" OF wh_ind_motiv_bxa_fas702ea PERSISTENT RUN pi_trata_motivo IN h_fas702ea_epc_1.

    ON "LEAVE" OF wh_ind_motiv_bxa_fas702ea PERSISTENT RUN pi_trata_leave_1 IN h_fas702ea_epc_1.

    ON "LEAVE" OF h_ind_tip_bxa_bem_pat PERSISTENT RUN pi_trata_leave_2 IN h_fas702ea_epc_1.
...
IF  p_ind_event = "DISPLAY" THEN DO:
    ...
    IF  VALID-HANDLE(h_ind_motiv_bxa) THEN DO:
        IF  h_ind_motiv_bxa:SCREEN-VALUE = "Inutilizaá∆o" THEN
            ASSIGN wh_ind_motiv_bxa_fas702ea:SCREEN-VALUE = "N∆o Localizado/Doado".

        IF  h_ind_motiv_bxa:SCREEN-VALUE = "Exaust∆o" THEN
            ASSIGN wh_ind_motiv_bxa_fas702ea:SCREEN-VALUE = "Sem Condiá∆o de Uso".

        IF  h_ind_motiv_bxa:SCREEN-VALUE <> "Inutilizaá∆o" 
        AND h_ind_motiv_bxa:SCREEN-VALUE <> "Exaust∆o" THEN
            ASSIGN wh_ind_motiv_bxa_fas702ea:SCREEN-VALUE = h_ind_motiv_bxa:SCREEN-VALUE.
    END.
END.
