...
*******************************************************************************/
{include/i-prgvrs.i FT4001A-EPC 2.00.00.001}  /*** 010001 ***/
/***********************************************************************
**  
**
************************************************************************/
...
/*--- Bloco Principal ---*/
CASE p-ind-event:
    WHEN "END_FT4001A":U THEN DO:

        /*MESSAGE "END_FT4001A - v_val_dec_1 " v_val_dec_1 VIEW-AS ALERT-BOX.*/
        ...
        IF  AVAIL int-ped-venda2 THEN DO:
            /*MESSAGE "achou int-ped-venda2 - ft4001a-epc  - v_val_dec_1 " v_val_dec_1 VIEW-AS ALERT-BOX.*/
