/*****************************************************************************
** Programa..............: fas718ca_epc.p - isl_apol_seguro_calc_amort
...
DEFINE NEW GLOBAL SHARED VAR h_bt_zoo_58954  AS WIDGET-HANDLE NO-UNDO.
...
IF  p_ind_event = "ENABLE" THEN DO:
    ...
    IF  NOT AVAIL tt-prog-ponto THEN DO:
        ...
        RUN piFindWidget(INPUT "bt_zoo_58954", 
                         INPUT "BUTTON", 
                         INPUT  p_wgh_frame, 
                         OUTPUT h_bt_zoo_58954).
    
        IF  VALID-HANDLE(h_bt_zoo_58954) THEN
            ASSIGN h_bt_zoo_58954:SENSITIVE = NO.
    END.
END.
