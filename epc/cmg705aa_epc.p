...
if  p_ind_event = "INITIALIZE" then do:
    ...
    assign frame      = p_wgh_frame
           ...
           sensitive  = yes
           visible    = yes
           tooltip    = "Libera Pedido B2C"
           triggers:
               on choose persistent run epc/cmg705aa1_epc.p.
           end triggers.

    wh_button:load-image("image/im-orcto.bmp":U).
...
if  p_ind_event = "DISPLAY" then
    assign v_rec_extrat_cta_corren = p_rec_table.
