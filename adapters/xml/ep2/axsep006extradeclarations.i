...
DEFINE BUFFER bf-cidade-est      FOR mgcad.cidade.     /* Leitura Cidade     do Estabelecimento  */
...
DEFINE BUFFER bf-cidade-emit     FOR mgcad.cidade.     /* Leitura Cidade     do Emitente         */
DEFINE BUFFER bf-cidade-entrega  FOR mgcad.cidade.     /* Leitura Cidade     do Local de Entrega */
DEFINE BUFFER bf-cidade-nf       FOR mgcad.cidade.     /* Leitura Cidade     da Nota Fiscal      */
...
DEFINE BUFFER bf-pais            FOR mgcad.pais.       /* Leitura Pa°s do Emitente */
