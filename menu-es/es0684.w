...
*******************************************************************************/
{include/i-prgvrs.i es0684 1.00.00.000}

CREATE WIDGET-POOL.

/* Preprocessors Definitions ---                                      */
&GLOBAL-DEFINE Program        es0684
...
&GLOBAL-DEFINE page2Fields    c-it-codigo ctipo
...
DEFINE VARIABLE ctipo AS INTEGER 
...
DEFINE FRAME fPage2
     c-it-codigo AT ROW 1.5 COL 17.28
     cdescricao AT ROW 1.5 COL 37 COLON-ALIGNED NO-LABEL WIDGET-ID 6
     ctipo AT ROW 3.75 COL 32 NO-LABEL WIDGET-ID 2
     RECT-23 AT ROW 3.25 COL 27 WIDGET-ID 8
...
/* SETTINGS FOR FILL-IN c-it-codigo IN FRAME fPage2
   ALIGN-L                                                              */
/* SETTINGS FOR FILL-IN cdescricao IN FRAME fPage2
   NO-ENABLE                                                            */
...
ON LEAVE OF c-it-codigo IN FRAME fPage2 /* Item */
DO:
    IF c-it-codigo:SCREEN-VALUE IN FRAME fPage2 <> ""  /* AND
       cdescricao:SCREEN-VALUE IN FRAME fPage2 = "" */ THEN DO:
        FIND ITEM WHERE ITEM.it-codigo = c-it-codigo:SCREEN-VALUE IN FRAME fPage2 NO-LOCK NO-ERROR.
        IF AVAIL ITEM THEN
            ASSIGN cdescricao:SCREEN-VALUE IN FRAME fPage2 = ITEM.descricao-1 + ITEM.descricao-2.
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL c-it-codigo wReport
ON MOUSE-SELECT-DBLCLICK OF c-it-codigo IN FRAME fPage2 /* Item */
DO:
...
c-it-codigo:LOAD-MOUSE-POINTER("image/lupa.cur":U) IN FRAME fPage2.
...
do on error undo, return error on stop  undo, return error:
    ...
    ASSIGN tt-param.it-codigo = INPUT FRAME fPage2 c-it-codigo
           tt-param.tipo  = int(ctipo:SCREEN-VALUE IN FRAME fPage2).
    ...
    {report/rprun.i menu-es/es0684rp.p}
