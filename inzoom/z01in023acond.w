...
DEFINE TEMP-TABLE tt-c-tab-res NO-UNDO LIKE c-tab-res
...
*******************************************************************************/
{include/i-prgvrs.i z01in023E 1.00.00.000}
...
&GLOBAL-DEFINE Program           Z01IN023E
&GLOBAL-DEFINE Version           1.00.00.000

&GLOBAL-DEFINE InitialPage       1
&GLOBAL-DEFINE FolderLabels      Acondicionamento

&GLOBAL-DEFINE Range             YES

&GLOBAL-DEFINE FieldsRangePage1  mgcad.c-tab-res.sequencia,mgcad.c-tab-res.descricao
&GLOBAL-DEFINE FieldsAnyKeyPage1 NO,NO

&GLOBAL-DEFINE ttTable1          tt-c-tab-res
&GLOBAL-DEFINE hDBOTable1        h-boin023acond
&GLOBAL-DEFINE DBOTable1         c-tab-res

&GLOBAL-DEFINE page1Browse       br-acond
...
&Scoped-define BROWSE-NAME br-acond

/* Internal Tables (found by Frame, Query & Browse Queries)             */
&Scoped-define INTERNAL-TABLES tt-c-tab-res

/* Definitions for BROWSE br-acond                                      */
&Scoped-define FIELDS-IN-QUERY-br-acond tt-c-tab-res.nr-tabela ~
tt-c-tab-res.sequencia tt-c-tab-res.descricao 
&Scoped-define ENABLED-FIELDS-IN-QUERY-br-acond 
&Scoped-define QUERY-STRING-br-acond FOR EACH tt-c-tab-res NO-LOCK INDEXED-REPOSITION
&Scoped-define OPEN-QUERY-br-acond OPEN QUERY br-acond FOR EACH tt-c-tab-res NO-LOCK INDEXED-REPOSITION.
&Scoped-define TABLES-IN-QUERY-br-acond tt-c-tab-res
&Scoped-define FIRST-TABLE-IN-QUERY-br-acond tt-c-tab-res
...
/* Query definitions                                                    */
&ANALYZE-SUSPEND
DEFINE QUERY br-acond FOR 
      tt-c-tab-res SCROLLING.
&ANALYZE-RESUME

/* Browse definitions                                                   */
DEFINE BROWSE br-acond
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br-acond wZoom _STRUCTURED
  QUERY br-acond NO-LOCK DISPLAY
      tt-c-tab-res.nr-tabela FORMAT ">>>>9":U
      tt-c-tab-res.sequencia FORMAT ">>>>9":U
      tt-c-tab-res.descricao FORMAT "x(60)":U
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
...
/* Settings for THIS-PROCEDURE
   ...
   Temp-Tables and Buffers:
      TABLE: tt-c-tab-res T "?" NO-UNDO mgcad c-tab-res
      ADDITIONAL-FIELDS:
          field r-rowid as rowid
      END-FIELDS.
   END-TABLES.
...
&ANALYZE-SUSPEND _QUERY-BLOCK BROWSE br-acond
/* Query rebuild information for BROWSE br-acond
     _TblList          = "Temp-Tables.tt-c-tab-res"
     _Options          = "NO-LOCK INDEXED-REPOSITION"
     _FldNameList[1]   = Temp-Tables.tt-c-tab-res.nr-tabela
     _FldNameList[2]   = Temp-Tables.tt-c-tab-res.sequencia
     _FldNameList[3]   = Temp-Tables.tt-c-tab-res.descricao
     _Query            is OPENED
*/  /* BROWSE br-acond */
&ANALYZE-RESUME
...
DO:
    {zoom/implant.i &ProgramImplant="cdp/cd0214.w"
                    &PageNumber="1"}
END.
...
------------------------------------------------------------------------------*/
    ...
    IF NOT VALID-HANDLE({&hDBOTable1}) OR
       ...
       {&hDBOTable1}:FILE-NAME <> "inbo/boin023acond.p":U THEN DO:
       
        {btb/btb008za.i1 inbo/boin023acond.p YES}
        {btb/btb008za.i2 inbo/boin023acond.p '' {&hDBOTable1}} 
    END.
...
------------------------------------------------------------------------------*/
    ...
    CASE pPageNumber:
        WHEN 1 THEN
            ...
            RUN setConstraintZoom IN {&hDBOTable1} (INPUT 4,
                                                    INPUT FnIniRangeIntPage(1, 1),
