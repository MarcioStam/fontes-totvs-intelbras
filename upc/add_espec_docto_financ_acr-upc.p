/* -------------------------------------------------------------------------------------------------------------
Programa : upc/add_espec_docto_financ_acr-upc.p
Funcao   : UPC criada para acrescentar o campo "Gera Comiss∆o" na espÇcie financeiro do m¢dulo Contas a Receber.
...
IF p-ind-event = "ASSIGN" AND 
   p-ind-object = "VIEWER" THEN DO:
    ...
    assign int_espec_docto_financ_acr.cod_espec_docto   = espec_docto_financ_acr.cod_espec_docto
           int_espec_docto_financ_acr.log_gera_comissao = wh-toggle-add:CHECKED.
END.
