              ...
              DO:
                  ...
                  Do While valid-handle(wh-objeto3):
                     ...
                     DO:
                        ...
                        on "row-display" OF wh-browse-cp0511 persistent run upc/upc_cp0511.p ('Row-Display-brTable', 
                                                                                               p-ind-object,
                                                                                               p-wgh-object,
                                                                                               p-wgh-frame, 
                                                                                               p-cod-table, 
                        ...
                        on "ENTRY" OF wh-browse-cp0511 persistent run upc/upc_cp0511.p ('ENTRY-BROWSE', 
                                                                                         p-ind-object,
                                                                                         p-wgh-object,
                                                                                         p-wgh-frame, 
                                                                                         p-cod-table, 
...
PROCEDURE pi-recarrega-browse:
    ...
    // Quando Planejador nao informado nao entra na rotina de filtro customizado
    IF VALID-HANDLE(wh-plan-cp0511) THEN
       IF wh-plan-cp0511:SCREEN-VALUE = '' THEN LEAVE.
    ...
    REPEAT:
       ...
       IF VALID-HANDLE(wh-plan-cp0511) THEN
       DO:
          IF wh-plan-cp0511:SCREEN-VALUE <> wh-buffer-brw:Buffer-field("cd-planejado"):BUFFER-VALUE THEN
    ...
    IF VALID-HANDLE(wh-plan-cp0511) THEN
       ASSIGN wh-plan-cp0511:SCREEN-VALUE = ''.

    IF wh-query-brw:NUM-RESULTS > 0 THEN
       wh-browse-cp0511:REFRESH().
END.
