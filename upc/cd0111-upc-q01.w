...
*******************************************************************************/
{include/i-prgvrs.i CD0111-UPC-Q01 1.00.00.000}
...
&IF "{&EMSFND_VERSION}" >= "1.00" &THEN
    {include/i-license-manager.i CD0111-UPC-Q01 ESP}
&ENDIF
...
&Scoped-define INTERNAL-TABLES int-gm-operador

/* Definitions for QUERY Query-Main                                     */
&Scoped-define QUERY-STRING-Query-Main FOR EACH int-gm-operador NO-LOCK INDEXED-REPOSITION
&Scoped-define OPEN-QUERY-Query-Main OPEN QUERY Query-Main FOR EACH int-gm-operador NO-LOCK INDEXED-REPOSITION.
&Scoped-define TABLES-IN-QUERY-Query-Main int-gm-operador
&Scoped-define FIRST-TABLE-IN-QUERY-Query-Main int-gm-operador
...
/* Query rebuild information for QUERY Query-Main
     _TblList          = "mgesp.int-gm-operador"
