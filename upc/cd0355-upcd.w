...
&Scoped-define FRAME-NAME cd0355-upcd
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CUSTOM _DEFINITIONS cd0355-upcd 
/*:T*******************************************************************************
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CUSTOM _INCLUDED-LIB cd0355-upcd 
/* ************************* Included-Libraries *********************** */
...
/* SETTINGS FOR DIALOG-BOX cd0355-upcd
   NOT-VISIBLE FRAME-NAME L-To-R                                        */
ASSIGN 
       FRAME cd0355-upcd:SCROLLABLE       = FALSE
       FRAME cd0355-upcd:HIDDEN           = TRUE.
...
&ANALYZE-SUSPEND _QUERY-BLOCK DIALOG-BOX cd0355-upcd
/* Query rebuild information for DIALOG-BOX cd0355-upcd
     _Options          = "SHARE-LOCK"
     _Query            is NOT OPENED
*/  /* DIALOG-BOX cd0355-upcd */
&ANALYZE-RESUME
...
&Scoped-define SELF-NAME cd0355-upcd
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL cd0355-upcd cd0355-upcd
ON WINDOW-CLOSE OF FRAME cd0355-upcd /* Pesquisar */
DO:  
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL bt-ok cd0355-upcd
ON CHOOSE OF bt-ok IN FRAME cd0355-upcd /* OK */
DO:
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CUSTOM _MAIN-BLOCK cd0355-upcd 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE adm-create-objects cd0355-upcd  _ADM-CREATE-OBJECTS
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE adm-row-available cd0355-upcd  _ADM-ROW-AVAILABLE
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE disable_UI cd0355-upcd  _DEFAULT-DISABLE
...
------------------------------------------------------------------------------*/
  /* Hide all frames. */
  HIDE FRAME cd0355-upcd.
END PROCEDURE.

/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME

&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE enable_UI cd0355-upcd  _DEFAULT-ENABLE
PROCEDURE enable_UI :
/*------------------------------------------------------------------------------
...
------------------------------------------------------------------------------*/
  DISPLAY rs-tipo fi-cod-estab fi-nat-operacao fi-ncm fi-cod-item fi-data 
      ...
      WITH FRAME cd0355-upcd.
  ENABLE rt-buttom rs-tipo fi-cod-estab fi-nat-operacao fi-ncm fi-cod-item 
         fi-data fi-grupo-emit fi-cod-emitente bt-ok 
      WITH FRAME cd0355-upcd.
  {&OPEN-BROWSERS-IN-QUERY-cd0355-upcd}
END PROCEDURE.

/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME

&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE local-destroy cd0355-upcd 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE local-initialize cd0355-upcd 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE send-records cd0355-upcd  _ADM-SEND-RECORDS
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE state-changed cd0355-upcd 
