...
DEFINE VARIABLE h_wm0192-zoom-b01-upc-2 AS HANDLE NO-UNDO.
DEFINE VARIABLE h_wm0192-zoom-b02-upc-2 AS HANDLE NO-UNDO.
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'FOLDER-LABELS = ':U + 'Item|Descri‡Æo' + ',
                     FOLDER-TAB-TYPE = 1':U ,
             OUTPUT h_folder ).
    ...
    WHEN 1 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'upc/wm0192-zoom-b01-upc.w':U ,
             INPUT  FRAME f-zoom:HANDLE ,
             INPUT  'Key-Name = cod-embalagem,
                     Layout = ':U ,
             OUTPUT h_wm0192-zoom-b01-upc-2 ).
       RUN set-position IN h_wm0192-zoom-b01-upc-2 ( 3.25 , 5.00 ) NO-ERROR.
       /* Size in UIB:  ( 10.17 , 80.14 ) */

       /* Initialize other pages that this page requires. */
       RUN init-pages IN THIS-PROCEDURE ('2':U) NO-ERROR.

       /* Links to SmartBrowser h_wm0192-zoom-b01-upc-2. */
       RUN add-link IN adm-broker-hdl ( h_wm0192-zoom-b02-upc-2 , 'Record':U , h_wm0192-zoom-b01-upc-2 ).
       RUN add-link IN adm-broker-hdl ( h_wm0192-zoom-b01-upc-2 , 'State':U , THIS-PROCEDURE ).

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_wm0192-zoom-b01-upc-2 ,
             h_folder , 'AFTER':U ).
    END. /* Page 1 */
    WHEN 2 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'upc/wm0192-zoom-b02-upc.w':U ,
             INPUT  FRAME f-zoom:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_wm0192-zoom-b02-upc-2 ).
       RUN set-position IN h_wm0192-zoom-b02-upc-2 ( 3.25 , 5.00 ) NO-ERROR.
       /* Size in UIB:  ( 10.17 , 80.14 ) */

       /* Links to SmartBrowser h_wm0192-zoom-b02-upc-2. */
       RUN add-link IN adm-broker-hdl ( h_wm0192-zoom-b02-upc-2 , 'State':U , THIS-PROCEDURE ).

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_wm0192-zoom-b02-upc-2 ,
             h_folder , 'AFTER':U ).
    END. /* Page 2 */
