...
*******************************************************************************/
{include/i-prgvrs.i cd0355-upcb 1.00.00.000}
...
&IF "{&EMSFND_VERSION}" >= "1.00" &THEN
    {include/i-license-manager.i cd0355-upcb cdp}
&ENDIF

CREATE WIDGET-POOL.

/* Preprocessors Definitions ---                                      */
&GLOBAL-DEFINE Program        cd0355-upcb
...
DO:
    ...
    DO WITH FRAME fpage1:
        FOR EACH sit-tribut-relacto NO-LOCK
            WHERE sit-tribut-relacto.cdn-tribut = 12 /*IPI*/
            ...
            ,FIRST sit-tribut  FIELDS(cdn-sit-tribut)
                WHERE sit-tribut.cdn-sit-tribut = sit-tribut-relacto.cdn-sit-tribut
                 AND sit-tribut.cdn-tribut = 12 /*IPI*/ NO-LOCK:
...
DO:
    ...
    IF  AVAIL tt-sit-tribut-relacto THEN DO:
        ...
        IF  AVAIL sit-tribut THEN 
            ...
            RUN repositionRecord IN g-h-window-cd0355:INSTANTIATING-PROCEDURE(INPUT ROWID(sit-tribut)).
            
            RUN repositionRecordSon IN g-h-window-cd0355:INSTANTIATING-PROCEDURE(INPUT tt-sit-tribut-relacto.r-row-table ,1).  
