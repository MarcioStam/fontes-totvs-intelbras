...
IF p-ind-event = "ADD" THEN DO:
   IF p-wgh-frame:NAME = "f-main"  THEN DO:
      ASSIGN wh-altura:SENSITIVE         = YES
             ...
             tx-altura:SCREEN-VALUE      = "Kg              Altura:                        mm"
             tx-largura:SCREEN-VALUE     = " Largura:                        mm"
             tx-comprimento:SCREEN-VALUE = "Comprim:                        mm"
