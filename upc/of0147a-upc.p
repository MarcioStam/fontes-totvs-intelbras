...
DO:
    ...
    REPEAT:
        ...
        FIND FIRST estabelec NO-LOCK
            WHERE estabelec.cod-estabel = ENTRY(2,c-linha,";") NO-ERROR.

        IF NOT AVAIL estabelec THEN DO:
            ASSIGN c-editor:SCREEN-VALUE = c-editor:SCREEN-VALUE +  "Estabelecimento nao encontrado, linha " + STRING(i-linha) + " nao sera importada: " + ENTRY(2, c-linha, ";") + CHR(13).
            NEXT.
        END.

        FIND FIRST item-uni-estab EXCLUSIVE-LOCK
            WHERE item-uni-estab.it-codigo   = ENTRY(1,c-linha,";") 
              AND item-uni-estab.cod-estabel = ENTRY(2,c-linha,";")  NO-ERROR.

        IF AVAIL item-uni-estab THEN
            ASSIGN item-uni-estab.cdn-sit-tribut  = int(ENTRY(3,c-linha,";"))
                   item-uni-estab.val-aliq-icms   = dec(ENTRY(4,c-linha,";")).

        ELSE DO:
            CREATE item-uni-estab.
            ASSIGN item-uni-estab.it-codigo       = ENTRY(1,c-linha,";")
                   item-uni-estab.cod-estabel     = ENTRY(2,c-linha,";")
                   item-uni-estab.cdn-sit-tribut  = int(ENTRY(3,c-linha,";"))
                   item-uni-estab.val-aliq-icms   = dec(ENTRY(4,c-linha,";")). 
        END.
