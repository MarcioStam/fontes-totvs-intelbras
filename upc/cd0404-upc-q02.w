...
*******************************************************************************/
{include/i-prgvrs.i CD0404-UPC-Q02 1.00.00.000}
...
&IF "{&EMSFND_VERSION}" >= "1.00" &THEN
    {include/i-license-manager.i CD0404-UPC-Q02 MCD}
&ENDIF
...
&Scoped-define INTERNAL-TABLES int-cond-pagto-produto

/* Definitions for QUERY Query-Main                                     */
&Scoped-define QUERY-STRING-Query-Main FOR EACH int-cond-pagto-produto NO-LOCK INDEXED-REPOSITION
&Scoped-define OPEN-QUERY-Query-Main OPEN QUERY Query-Main FOR EACH int-cond-pagto-produto NO-LOCK INDEXED-REPOSITION.
&Scoped-define TABLES-IN-QUERY-Query-Main int-cond-pagto-produto
&Scoped-define FIRST-TABLE-IN-QUERY-Query-Main int-cond-pagto-produto
...
DEFINE QUERY Query-Main FOR 
      int-cond-pagto-produto SCROLLING.
&ANALYZE-RESUME
...
/* Query rebuild information for QUERY Query-Main
     _TblList          = "mgesp.int-cond-pagto-produto"
