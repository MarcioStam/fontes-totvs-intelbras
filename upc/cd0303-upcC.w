...
RUN upc/cd0303-upcD.w (output p-cod-estab       ,
...
RUN  goToKey IN wh-DBOSon-cd0303  (INPUT g-cdn-tirbut-cd0303,     /*cdn-tribut*/
                                   INPUT g-cdn-sit-tirbut-cd0303, /*cdn-sit-tribut*/
...
/*
RUN  goToKey IN wh-DBOSon-cd0303  (INPUT 12,         /*cdn-tribut*/
...
RUN geTRowid IN wh-DBOSon-cd0303 (OUTPUT r-row).

FIND sit-tribut-relacto NO-LOCK
    WHERE ROWID(sit-tribut-relacto) = r-row NO-ERROR.

RUN repositionRecord IN wh-DBOSon-cd0303 /*:INSTANTIATING-PROCEDURE */ (INPUT r-row).

RUN repositionRecordSon IN g-h-window-cd0303:INSTANTIATING-PROCEDURE (INPUT r-row,
                                                                      INPUT 1).
