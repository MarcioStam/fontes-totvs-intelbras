/* -------------------------------------------------------------------------------------------------------------
Programa : upc/bas_portador-upc.p
Funcao   : UPC criada para mostrar o campo "Considera Comiss∆o Portador" no cadastro do portador do 
...
IF p-ind-event = "DISPLAY" AND 
   p-ind-object = "VIEWER" THEN DO:
    ...
    FOR FIRST int-portador OF emscad.portador:
        ASSIGN wh-toggle-bas:CHECKED = int-portador.log_considera_comissao.
    END.
END.
