...
*******************************************************************************/
{include/i-prgvrs.i CD0111-UPCA 1.00.00.000}
...
&IF "{&EMSFND_VERSION}" >= "1.00" &THEN
    {include/i-license-manager.i CD0111-UPCA ESP}
&ENDIF
...
DEFINE VARIABLE h_cd0111-upc-q01 AS HANDLE NO-UNDO.
DEFINE VARIABLE h_cd0111-upc-v01 AS HANDLE NO-UNDO.
...
DEFINE FRAME f-cad
     bt-ok AT ROW 5.33 COL 2 HELP
          "Salva e sai"
     bt-save AT ROW 5.33 COL 12.43 HELP
          "Salva e cria novo"
     bt-cancela AT ROW 5.33 COL 23 HELP
          "Cancela"
     bt-ajuda AT ROW 5.33 COL 70.14
     rt-button AT ROW 5.17 COL 1
...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW w-cadsim ASSIGN
         HIDDEN             = YES
         TITLE              = "Inclui/Modifica Cargos UEP"
         HEIGHT             = 5.71
         WIDTH              = 80.72
         MAX-HEIGHT         = 41.33
         MAX-WIDTH          = 274.29
...
ON END-ERROR OF w-cadsim /* Inclui/Modifica Cargos UEP */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL w-cadsim w-cadsim
ON WINDOW-CLOSE OF w-cadsim /* Inclui/Modifica Cargos UEP */
DO:
...
DO:
{include/okfil.i h_cd0111-upc-v01}
END.
...
DO:
{include/salvafil.i h_cd0111-upc-v01}
END.
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'upc/cd0111-upc-v01.w':U ,
             INPUT  FRAME f-cad:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_cd0111-upc-v01 ).
       RUN set-position IN h_cd0111-upc-v01 ( 1.25 , 1.00 ) NO-ERROR.
       /* Size in UIB:  ( 3.75 , 79.29 ) */

       RUN init-object IN THIS-PROCEDURE (
             INPUT  'upc/cd0111-upc-q01.w':U ,
             INPUT  FRAME f-cad:HANDLE ,
             INPUT  '':U ,
             OUTPUT h_cd0111-upc-q01 ).
       RUN set-position IN h_cd0111-upc-q01 ( 5.00 , 49.43 ) NO-ERROR.
       /* Size in UIB:  ( 1.63 , 7.72 ) */

       /* Links to SmartViewer h_cd0111-upc-v01. */
       RUN add-link IN adm-broker-hdl ( h_cd0111-upc-q01 , 'Record':U , h_cd0111-upc-v01 ).
       RUN add-link IN adm-broker-hdl ( THIS-PROCEDURE , 'TableIO':U , h_cd0111-upc-v01 ).

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_cd0111-upc-v01 ,
...
------------------------------------------------------------------------------*/
  ...
  {utp/ut9000.i "CD0111-UPCA" "1.00.00.000"}

  /* Dispatch standard ADM method.                             */
  RUN dispatch IN THIS-PROCEDURE ( INPUT 'initialize':U ) .

  run pi-atualiza-parent in h_cd0111-upc-v01 (input v-row-parent).
...
/*------------------------------------------------------------------------------
  ...
  Notes:       
------------------------------------------------------------------------------*/
  RUN pi-reposiciona-query IN h_cd0111-upc-q01 (input v-row-table).
