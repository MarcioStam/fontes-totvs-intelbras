...
*******************************************************************************/
{include/i-prgvrs.i CC0300a1 3.00.00.000}
...
DEFINE INPUT        PARAMETER pLogHabilita  AS LOGICAL      NO-UNDO.
DEFINE INPUT-OUTPUT PARAMETER pObservacao   AS CHARACTER    NO-UNDO.
...
&Scoped-Define ENABLED-OBJECTS rt-button edObservacao bt-ok bt-cancela ~
bt-ajuda 
&Scoped-Define DISPLAYED-OBJECTS edObservacao 
...
DEFINE VARIABLE edObservacao AS CHARACTER 
     VIEW-AS EDITOR NO-WORD-WRAP SCROLLBAR-HORIZONTAL SCROLLBAR-VERTICAL
     SIZE 76 BY 9.5 NO-UNDO.
...
DEFINE FRAME f-cad
     edObservacao AT ROW 2.25 COL 3 NO-LABEL WIDGET-ID 2
     bt-ok AT ROW 12.21 COL 3
     bt-cancela AT ROW 12.21 COL 14
     bt-ajuda AT ROW 12.21 COL 69
     "Motivo:" VIEW-AS TEXT
          SIZE 31 BY .67 AT ROW 1.5 COL 3 WIDGET-ID 4
...
DO:
    ...
    ASSIGN pObservacao = edObservacao:SCREEN-VALUE.
...
------------------------------------------------------------------------------*/
  DISPLAY edObservacao 
      WITH FRAME f-cad IN WINDOW w-cadsim.
  ENABLE rt-button edObservacao bt-ok bt-cancela bt-ajuda 
      WITH FRAME f-cad IN WINDOW w-cadsim.
...
------------------------------------------------------------------------------*/
  ...
  {utp/ut9000.i "CC0300a1" "3.00.00.000"}

  /* Dispatch standard ADM method.                             */
  RUN dispatch IN THIS-PROCEDURE ( INPUT 'initialize':U ) .

  ASSIGN    edObservacao:SENSITIVE    = pLogHabilita
            edObservacao:SCREEN-VALUE = pObservacao.
