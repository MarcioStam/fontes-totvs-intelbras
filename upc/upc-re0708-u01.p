...
DEF NEW GLOBAL SHARED VAR wh-re0708-fpage2               AS WIDGET-HANDLE NO-UNDO.
...
IF p-ind-event  = "AFTER-ENABLE" AND 
   ...
   c-handle-obj = fc-handle-obj("fpage2,btAtualiza", p-wgh-frame).
   ASSIGN wh-re0708-fpage2      = WIDGET-HANDLE(ENTRY(1,c-handle-obj)) 
          wh-re0708-btAtualiza  = WIDGET-HANDLE(ENTRY(2,c-handle-obj))  NO-ERROR.

   c-handle-obj = fc-handle-obj("btReprocessa2,brTable2", wh-re0708-fpage2).

    /* alimentando as variaveis com os handles dos objetos */
   ASSIGN wh-re0708-btReprocessa2   = WIDGET-HANDLE(ENTRY(1,c-handle-obj)) 
          wh-re0708-browse-brTable2 = WIDGET-HANDLE(ENTRY(2,c-handle-obj)) NO-ERROR.


   IF VALID-HANDLE(wh-re0708-btReprocessa2) THEN DO:

        CREATE BUTTON wh-re0708-btReprocessa2-f
        ASSIGN  FRAME       = wh-re0708-btReprocessa2:FRAME
                TOOLTIP     = wh-re0708-btReprocessa2:TOOLTIP
                LABEL       = wh-re0708-btReprocessa2:LABEL
                WIDTH       = wh-re0708-btReprocessa2:WIDTH
                HEIGHT      = wh-re0708-btReprocessa2:HEIGHT
                COL         = wh-re0708-btReprocessa2:COLUMN
                ROW         = wh-re0708-btReprocessa2:ROW   /* + 0.5 */  
                VISIBLE     = wh-re0708-btReprocessa2:VISIBLE     
                SENSITIVE   = wh-re0708-btReprocessa2:SENSITIVE. 

        wh-re0708-btReprocessa2-f:MOVE-TO-TOP( ). 
        ON CHOOSE OF wh-re0708-btReprocessa2-f PERSISTENT RUN upc/upc-re0708-u02.p.
   END.
END. 
...
PROCEDURE pi-arq-eventos: 
    OUTPUT TO c:\temp\pontos-cd0708.txt APPEND. 
