/* -------------------------------------------------------------------------------------------------------------
Programa : upc/det_espec_docto_financ_acr-upc.p
Funcao   : UPC criada para mostrar o campo "Gera Comiss∆o" na espÇcie financeiro do m¢dulo Contas a Receber na
           tela de detalhe.
...
IF p-ind-event = "DISPLAY" AND 
   p-ind-object = "VIEWER" THEN DO:
    ...
    FOR FIRST int_espec_docto_financ_acr OF espec_docto_financ_acr:
        ASSIGN wh-toggle-det:CHECKED = int_espec_docto_financ_acr.log_gera_comissao.
    END.
END.
