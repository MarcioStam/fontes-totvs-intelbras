...
DEFINE NEW GLOBAL SHARED VARIABLE wh-toggle-mod-utb112 AS WIDGET-HANDLE    NO-UNDO.
...
IF p-ind-event = "INITIALIZE" AND 
   p-ind-object = "VIEWER" THEN DO:
    ...
    create TOGGLE-BOX wh-toggle-mod-utb112
    ...
    IF AVAIL representante THEN DO:
        ...
        IF AVAIL int-repres THEN DO:
            IF SUBSTRING(char-1,3,1) = "s" THEN
                ASSIGN wh-toggle-mod-utb112:CHECKED = YES.
            ELSE
                ASSIGN wh-toggle-mod-utb112:CHECKED = NO.
   ...
   p-ind-object = "VIEWER" THEN DO:
    ...
    IF AVAIL representante THEN DO:
        FIND FIRST int-repres
            WHERE int-repres.cod-repres = representante.cdn_repres NO-ERROR.
        IF AVAIL int-repres THEN DO:
            IF wh-toggle-mod-utb112:CHECKED = YES THEN
