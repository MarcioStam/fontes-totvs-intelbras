...
*******************************************************************************/
{include/i-prgvrs.i cd0354-upca 2.00.00.000}
...
DEFINE OUTPUT PARAM p-it-codigo AS CHAR.
...
&Scoped-Define ENABLED-OBJECTS rt-button c-it-codigo bt-ok bt-cancela 
&Scoped-Define DISPLAYED-OBJECTS c-it-codigo c-desc-item 
...
DEFINE FRAME f-cad
     c-it-codigo AT ROW 2.5 COL 7 COLON-ALIGNED WIDGET-ID 2
     c-desc-item AT ROW 2.5 COL 21.14 COLON-ALIGNED NO-LABEL WIDGET-ID 4
     bt-ok AT ROW 5.54 COL 3
     bt-cancela AT ROW 5.54 COL 14
     bt-imprime AT ROW 5.54 COL 25
     bt-ajuda AT ROW 5.54 COL 48.43
     rt-button AT ROW 5.33 COL 2
...
DO:
    ASSIGN p-it-codigo = c-it-codigo:SCREEN-VALUE IN FRAME f-cad.
...
DO:
    FIND FIRST ITEM NO-LOCK
         WHERE ITEM.it-codigo = c-it-codigo:SCREEN-VALUE IN FRAME f-cad NO-ERROR.
...
------------------------------------------------------------------------------*/
  DISPLAY c-it-codigo c-desc-item 
      WITH FRAME f-cad IN WINDOW w-cadsim.
  ENABLE rt-button c-it-codigo bt-ok bt-cancela 
      WITH FRAME f-cad IN WINDOW w-cadsim.
...
------------------------------------------------------------------------------*/
  ...
  {utp/ut9000.i "cd0354-upca" "2.00.00.000"}
