...
{include/i-prgvrs.i cd0303-upca 2.06.00.001}

CREATE WIDGET-POOL.

/* Preprocessors Definitions ---                                      */
&GLOBAL-DEFINE Program        cd0303-upca
...
------------------------------------------------------------------------------*/
    ...
    ASSIGN edLayout = "+----------------------------------------------------------------------------+":U + CHR(10) +
                      "|                Layout do Arquivo de Importa‡Æo de Relac CST                |":U + CHR(10) +
                      "|----------------------------------------------------------------------------|":U + CHR(10) +
...
/*         END.                                                                                                 */
        ...
        REPEAT:
           ...
           RUN pi-acompanhar in h-acomp (input "Codigo "  + string(ENTRY(2, c-linha, ";") ) ).
               ...
               FIND sit-tribut
                   WHERE sit-tribut.cdn-tribut                  = int(string(ENTRY(1, c-linha, ";") ))
                     AND sit-tribut.cdn-sit-tribut              = int(string(ENTRY(2, c-linha, ";") ))
                   NO-LOCK NO-ERROR.
               IF NOT AVAIL sit-tribut THEN DO:
                   PUT i-cont " Codigo de Tributo informado nÆo existe "   string(ENTRY(1, c-linha, ";") ) " "  string(ENTRY(2, c-linha, ";") ) SKIP.
                  NEXT.
               ...
               IF int(string(ENTRY(9, c-linha, ";") ))  <> 0 THEN DO:
                   FIND gr-cli NO-LOCK 
                       WHERE gr-cli.cod-gr-cli =  int(string(ENTRY(9, c-linha, ";") )) NO-ERROR.
                   IF NOT AVAIL gr-cli THEN DO:
                        PUT i-cont " Grupo de Cliente NÆo Encontrado "   string(ENTRY(9, c-linha, ";") ) SKIP.
               ...
               FIND sit-tribut-relacto
                   WHERE sit-tribut-relacto.cdn-tribut                  = int(string(ENTRY(1, c-linha, ";") ))
                     AND sit-tribut-relacto.cdn-sit-tribut              = int(string(ENTRY(2, c-linha, ";") ))
                     ...
                     AND sit-tribut-relacto.cdn-grp-emit                = int(string(ENTRY(9, c-linha, ";") ))                             
                     AND sit-tribut-relacto.cdn-emitente                = int(string(ENTRY(10, c-linha, ";") ))                            NO-LOCK NO-ERROR.
               ...
               ASSIGN sit-tribut-relacto.cdn-tribut                  = int(string(ENTRY(1, c-linha, ";") ))
                      sit-tribut-relacto.cdn-sit-tribut              = int(string(ENTRY(2, c-linha, ";") ))
                      ...
                      sit-tribut-relacto.cdn-grp-emit                = int(string(ENTRY(9, c-linha, ";") ))      
