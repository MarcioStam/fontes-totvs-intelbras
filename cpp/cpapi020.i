/*****************************************************************************
**
**   cpapi020.i - Defini‡Æo da tt-balanceia
**
******************************************************************************/

def temp-table tt-balanceia no-undo
    field nr-ord-produ          as int   /* Num. Ordem de Produ‡Æo                      */
    field it-codigo             as char  /* Cod. Item controlado por PPM / Concentra‡Æo */
    ...
    FIELD de-perc-alteracao     AS DEC   /* Campo de uso interno na rotina de Manuten‡Æo da Aloca‡Æo - cpapi013.i15 */
    field cod-versao-integracao as int
    index codigo nr-ord-produ it-codigo.

/*Implementado no projeto 346 - Controle de Potˆncia
  O sistema passa a permitir mais de um ve¡culo em uma mesma ordem. Essa temp-table ir  retornar a diferen‡a que dever  ser acrescida
  a quantidade de cada ve¡culo da ordem para que o mesmo fique balanceado, de acordo com o percentual de distribui‡Æo registrado na reserva*/
DEF TEMP-TABLE tt-veiculos NO-UNDO
    ...
    FIELD perc-distrib  AS DEC DECIMALS 4                /*Percentual de Distribui‡Æo do ve¡culo na reserva*/
