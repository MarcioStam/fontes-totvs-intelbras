...
*******************************************************************************/
{include/i-prgvrs.i Z01ES174 2.04.00.001}

CREATE WIDGET-POOL.

/* Preprocessors Definitions ---                                      */
&GLOBAL-DEFINE Program           Z01ES174
&GLOBAL-DEFINE Version           2.04.00.001

&GLOBAL-DEFINE InitialPage       1
&GLOBAL-DEFINE FolderLabels      SubFam¡lia,Descri‡Æo

&GLOBAL-DEFINE Range             YES

&GLOBAL-DEFINE FieldsRangePage1  mgesp.sub-familia-item.cod-familia,mgesp.sub-familia-item.cod-sub-familia
&GLOBAL-DEFINE FieldsRangePage2  mgesp.sub-familia-item.cod-familia,mgesp.sub-familia-item.Descricao
&GLOBAL-DEFINE FieldsAnyKeyPage1 no,no
&GLOBAL-DEFINE FieldsAnyKeyPage2 no,yes

&GLOBAL-DEFINE ttTable1          ttsub-familia-item
&GLOBAL-DEFINE hDBOTable1        hboes174
&GLOBAL-DEFINE DBOTable1         sub-familia-item

&GLOBAL-DEFINE ttTable2          ttsub-familia-item
&GLOBAL-DEFINE hDBOTable2        hboes174-1
&GLOBAL-DEFINE DBOTable2         sub-familia-item
...
&Scoped-define INTERNAL-TABLES ttsub-familia-item

/* Definitions for BROWSE brTable1                                      */
&Scoped-define FIELDS-IN-QUERY-brTable1 ttsub-familia-item.cod-familia ~
ttsub-familia-item.cod-sub-familia ttsub-familia-item.Descricao ~
ttsub-familia-item.abreviatura 
&Scoped-define ENABLED-FIELDS-IN-QUERY-brTable1 
&Scoped-define QUERY-STRING-brTable1 FOR EACH ttsub-familia-item NO-LOCK
&Scoped-define OPEN-QUERY-brTable1 OPEN QUERY brTable1 FOR EACH ttsub-familia-item NO-LOCK.
&Scoped-define TABLES-IN-QUERY-brTable1 ttsub-familia-item
&Scoped-define FIRST-TABLE-IN-QUERY-brTable1 ttsub-familia-item


/* Definitions for BROWSE brTable2                                      */
&Scoped-define FIELDS-IN-QUERY-brTable2 ttsub-familia-item.cod-familia ~
ttsub-familia-item.Descricao ttsub-familia-item.cod-sub-familia ~
ttsub-familia-item.abreviatura 
&Scoped-define ENABLED-FIELDS-IN-QUERY-brTable2 
&Scoped-define QUERY-STRING-brTable2 FOR EACH ttsub-familia-item NO-LOCK ~
    BY ttsub-familia-item.cod-familia ~
       BY ttsub-familia-item.Descricao
&Scoped-define OPEN-QUERY-brTable2 OPEN QUERY brTable2 FOR EACH ttsub-familia-item NO-LOCK ~
    BY ttsub-familia-item.cod-familia ~
       BY ttsub-familia-item.Descricao.
&Scoped-define TABLES-IN-QUERY-brTable2 ttsub-familia-item
&Scoped-define FIRST-TABLE-IN-QUERY-brTable2 ttsub-familia-item
...
/* Query rebuild information for BROWSE brTable1
     ...
     _Options          = "NO-LOCK"
     _FldNameList[1]   = Temp-Tables.ttsub-familia-item.cod-familia
     _FldNameList[2]   = Temp-Tables.ttsub-familia-item.cod-sub-familia
     _FldNameList[3]   = Temp-Tables.ttsub-familia-item.Descricao
     _FldNameList[4]   = Temp-Tables.ttsub-familia-item.abreviatura
     _Query            is OPENED
*/  /* BROWSE brTable1 */
&ANALYZE-RESUME
...
/* Query rebuild information for BROWSE brTable2
     _TblList          = "Temp-Tables.ttsub-familia-item"
     _Options          = "NO-LOCK"
     _OrdList          = "Temp-Tables.ttsub-familia-item.cod-familia|yes,Temp-Tables.ttsub-familia-item.Descricao|yes"
     _FldNameList[1]   = Temp-Tables.ttsub-familia-item.cod-familia
     _FldNameList[2]   = Temp-Tables.ttsub-familia-item.Descricao
     _FldNameList[3]   = Temp-Tables.ttsub-familia-item.cod-sub-familia
     _FldNameList[4]   = Temp-Tables.ttsub-familia-item.abreviatura
     _Query            is OPENED
*/  /* BROWSE brTable2 */
&ANALYZE-RESUME
...
------------------------------------------------------------------------------*/
    ...
    IF NOT VALID-HANDLE({&hDBOTable1}) OR
       ...
       {&hDBOTable1}:FILE-NAME <> "esbo/boes174.p":U THEN DO:
       
        {btb/btb008za.i1 esbo/boes174.p YES}
        {btb/btb008za.i2 esbo/boes174.p '' {&hDBOTable1}} 
    END.
    ...
    IF NOT VALID-HANDLE({&hDBOTable2}) OR
       ...
       {&hDBOTable2}:FILE-NAME <> "esbo/boes174.p":U THEN DO:
       
        {btb/btb008za.i1 esbo/boes174.p YES}
        {btb/btb008za.i2 esbo/boes174.p '' {&hDBOTable2}} 
    END.
