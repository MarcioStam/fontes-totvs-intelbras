...
*******************************************************************************/
{include/i-prgvrs.i z01es332 2.04.00.000}

CREATE WIDGET-POOL.

/* Preprocessors Definitions ---                                      */
&GLOBAL-DEFINE Program           z01es332
...
&GLOBAL-DEFINE ttTable1          ttint-emitente
&GLOBAL-DEFINE hDBOTable1        HDBOint-emitente
&GLOBAL-DEFINE DBOTable1         int-emitente
...
&Scoped-define INTERNAL-TABLES ttint-emitente

/* Definitions for BROWSE brTable1                                      */
&Scoped-define FIELDS-IN-QUERY-brTable1 ttint-emitente.cod-emitente ~
ttint-emitente.vl-desconto-cat 
&Scoped-define ENABLED-FIELDS-IN-QUERY-brTable1 
&Scoped-define QUERY-STRING-brTable1 FOR EACH ttint-emitente NO-LOCK
&Scoped-define OPEN-QUERY-brTable1 OPEN QUERY brTable1 FOR EACH ttint-emitente NO-LOCK.
&Scoped-define TABLES-IN-QUERY-brTable1 ttint-emitente
&Scoped-define FIRST-TABLE-IN-QUERY-brTable1 ttint-emitente
...
DEFINE VARIABLE i-cod-emitente-fim AS INTEGER FORMAT "->,>>>,>>9" INITIAL 999999 
     VIEW-AS FILL-IN 
     SIZE 6 BY .88.
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS brTable1 wZoom _STRUCTURED
  QUERY brTable1 NO-LOCK DISPLAY
      ttint-emitente.cod-emitente FORMAT ">>>>>9":U
      ttint-emitente.vl-desconto-cat FORMAT ">>9.99":U
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ROW-MARKERS SEPARATORS SIZE 26 BY 8.5
         FONT 2.
...
DEFINE FRAME fPage1
     i-cod-emitente-ini AT ROW 2.25 COL 27 COLON-ALIGNED HELP
          "Serie da Nota Fiscal" WIDGET-ID 12
     i-cod-emitente-fim AT ROW 2.25 COL 44 COLON-ALIGNED HELP
          "Cliente" NO-LABEL WIDGET-ID 10
     btCheck-1 AT ROW 2.25 COL 60
     brTable1 AT ROW 4.5 COL 29
     btImplant1 AT ROW 13 COL 2
     IMAGE-9 AT ROW 2.25 COL 38 WIDGET-ID 14
     IMAGE-10 AT ROW 2.25 COL 42 WIDGET-ID 16
...
/* Query rebuild information for BROWSE brTable1
     _TblList          = "Temp-Tables.ttint-emitente"
     _Options          = "NO-LOCK"
     _FldNameList[1]   = Temp-Tables.ttint-emitente.cod-emitente
     _FldNameList[2]   = Temp-Tables.ttint-emitente.vl-desconto-cat
     _Query            is OPENED
*/  /* BROWSE brTable1 */
&ANALYZE-RESUME
...
------------------------------------------------------------------------------*/
    ...
    DISP ""              @ i-cod-emitente-ini 
         "999999"        @ i-cod-emitente-fim
...
------------------------------------------------------------------------------*/
    ...
    IF NOT VALID-HANDLE({&hDBOTable1}) OR
       ...
       {&hDBOTable1}:FILE-NAME <> "esbo/boes332.p":U THEN DO:
       
        {btb/btb008za.i1 esbo/boes332.p YES}
        {btb/btb008za.i2 esbo/boes332.p '' {&hDBOTable1}} 
    END.
    
    RUN setConstraintRangeCodigo IN {&hDBOTable1} (INPUT "",
                                                  INPUT "9999999") NO-ERROR.
...
------------------------------------------------------------------------------*/
    ...
    CASE pPageNumber:
        WHEN 1 THEN
            ...
            RUN setConstraintRangeCodigo IN {&hDBOTable1} (INPUT FRAME fPage1 i-cod-emitente-ini,
