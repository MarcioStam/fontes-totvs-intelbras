...
*******************************************************************************/
{include/i-prgvrs.i z01es501 2.04.00.000}

CREATE WIDGET-POOL.

/* Preprocessors Definitions ---                                      */
&GLOBAL-DEFINE Program           z01es501
&GLOBAL-DEFINE Version           2.04.00.000

&GLOBAL-DEFINE InitialPage       1
&GLOBAL-DEFINE FolderLabels      Pontos

&GLOBAL-DEFINE Range             YES

&GLOBAL-DEFINE FieldsRangePage1  mgesp.pontos-fidelidade.cpf-cnpj,mgesp.pontos-fidelidade.data-movto,mgesp.pontos-fidelidade.ns-keycode
&GLOBAL-DEFINE FieldsAnyKeyPage1 NO,NO,NO

&GLOBAL-DEFINE ttTable1          ttpontos-fidelidade
&GLOBAL-DEFINE hDBOTable1        hboes501
&GLOBAL-DEFINE DBOTable1         pontos-fidelidade
...
&Scoped-define INTERNAL-TABLES ttpontos-fidelidade

/* Definitions for BROWSE brTable1                                      */
&Scoped-define FIELDS-IN-QUERY-brTable1 ttpontos-fidelidade.cpf-cnpj ~
ttpontos-fidelidade.data-movto ttpontos-fidelidade.ns-keycode ~
ttpontos-fidelidade.pontos 
&Scoped-define ENABLED-FIELDS-IN-QUERY-brTable1 
&Scoped-define QUERY-STRING-brTable1 FOR EACH ttpontos-fidelidade NO-LOCK
&Scoped-define OPEN-QUERY-brTable1 OPEN QUERY brTable1 FOR EACH ttpontos-fidelidade NO-LOCK.
&Scoped-define TABLES-IN-QUERY-brTable1 ttpontos-fidelidade
&Scoped-define FIRST-TABLE-IN-QUERY-brTable1 ttpontos-fidelidade
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS brTable1 wZoom _STRUCTURED
  QUERY brTable1 NO-LOCK DISPLAY
      ttpontos-fidelidade.cpf-cnpj FORMAT "x(16)":U
      ttpontos-fidelidade.data-movto FORMAT "99/99/9999":U
      ttpontos-fidelidade.ns-keycode FORMAT "x(5)":U
      ttpontos-fidelidade.pontos FORMAT ">>>,>>>,>>9":U
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
...
/* Query rebuild information for BROWSE brTable1
     _TblList          = "Temp-Tables.ttpontos-fidelidade"
     _Options          = "NO-LOCK"
     _FldNameList[1]   = Temp-Tables.ttpontos-fidelidade.cpf-cnpj
     _FldNameList[2]   = Temp-Tables.ttpontos-fidelidade.data-movto
     _FldNameList[3]   = Temp-Tables.ttpontos-fidelidade.ns-keycode
     _FldNameList[4]   = Temp-Tables.ttpontos-fidelidade.pontos
     _Query            is OPENED
*/  /* BROWSE brTable1 */
&ANALYZE-RESUME
...
------------------------------------------------------------------------------*/
    ...
    IF NOT VALID-HANDLE({&hDBOTable1}) OR
       ...
       {&hDBOTable1}:FILE-NAME <> "esbo/boes501.p":U THEN DO:
       
        {btb/btb008za.i1 esbo/boes501.p YES}
        {btb/btb008za.i2 esbo/boes501.p '' {&hDBOTable1}} 
    END.
    
    /*RUN setConstraintZoom1 IN {&hDBOTable1} NO-ERROR.*/
...
------------------------------------------------------------------------------*/
    ...
    IF AVAILABLE {&ttTable1} THEN DO:
        CASE pcField:
            WHEN "cpf-cnpj":U THEN
                ASSIGN pcFieldValue = STRING({&ttTable1}.cpf-cnpj).
            WHEN "data-movto":U THEN
                ASSIGN pcFieldValue = STRING({&ttTable1}.data-movto).
            WHEN "ns-keycode":U THEN
                ASSIGN pcFieldValue = STRING({&ttTable1}.ns-keycode).
        END CASE.
    END.
    ...
    CASE pPageNumber:
        WHEN 1 THEN
            ...
            RUN setConstraintZoom1 IN {&hDBOTable1} (INPUT fnIniRangeCharPage(INPUT 1, INPUT 1),
                                                     ...
                                                     INPUT fnIniRangeDatePage(INPUT 1, INPUT 2),
                                                     INPUT fnEndRangeDatePage(INPUT 1, INPUT 2),
