...
*******************************************************************************/
{include/i-prgvrs.i z01es502 2.04.00.000}

CREATE WIDGET-POOL.

/* Preprocessors Definitions ---                                      */
&GLOBAL-DEFINE Program           z01es502
...
&GLOBAL-DEFINE FieldsRangePage1  mgesp.usuario-fidelidade.cpf-cnpj,mgesp.usuario-fidelidade.nome,mgesp.usuario-fidelidade.empresa
&GLOBAL-DEFINE FieldsAnyKeyPage1 NO,NO,NO

&GLOBAL-DEFINE ttTable1          ttusuario-fidelidade
&GLOBAL-DEFINE hDBOTable1        hboes502
&GLOBAL-DEFINE DBOTable1         usuario-fidelidade
...
&Scoped-define INTERNAL-TABLES ttusuario-fidelidade

/* Definitions for BROWSE brTable1                                      */
&Scoped-define FIELDS-IN-QUERY-brTable1 ttusuario-fidelidade.cpf-cnpj ~
ttusuario-fidelidade.nome ttusuario-fidelidade.empresa ~
ttusuario-fidelidade.login 
&Scoped-define ENABLED-FIELDS-IN-QUERY-brTable1 
&Scoped-define QUERY-STRING-brTable1 FOR EACH ttusuario-fidelidade NO-LOCK
&Scoped-define OPEN-QUERY-brTable1 OPEN QUERY brTable1 FOR EACH ttusuario-fidelidade NO-LOCK.
&Scoped-define TABLES-IN-QUERY-brTable1 ttusuario-fidelidade
&Scoped-define FIRST-TABLE-IN-QUERY-brTable1 ttusuario-fidelidade
...
DEFINE QUERY brTable1 FOR 
      ttusuario-fidelidade SCROLLING.
&ANALYZE-RESUME
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS brTable1 wZoom _STRUCTURED
  QUERY brTable1 NO-LOCK DISPLAY
      ttusuario-fidelidade.cpf-cnpj FORMAT "x(16)":U
      ttusuario-fidelidade.nome FORMAT "x(40)":U
      ttusuario-fidelidade.empresa FORMAT "x(60)":U
      ttusuario-fidelidade.login FORMAT "x(20)":U
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
...
/* Query rebuild information for BROWSE brTable1
     _TblList          = "Temp-Tables.ttusuario-fidelidade"
     _Options          = "NO-LOCK"
     _FldNameList[1]   = Temp-Tables.ttusuario-fidelidade.cpf-cnpj
     _FldNameList[2]   = Temp-Tables.ttusuario-fidelidade.nome
     _FldNameList[3]   = Temp-Tables.ttusuario-fidelidade.empresa
     _FldNameList[4]   = Temp-Tables.ttusuario-fidelidade.login
     _Query            is OPENED
*/  /* BROWSE brTable1 */
&ANALYZE-RESUME
...
------------------------------------------------------------------------------*/
    ...
    IF NOT VALID-HANDLE({&hDBOTable1}) OR
       ...
       {&hDBOTable1}:FILE-NAME <> "esbo/boes502.p":U THEN DO:
       
        {btb/btb008za.i1 esbo/boes502.p YES}
        {btb/btb008za.i2 esbo/boes502.p '' {&hDBOTable1}} 
    END.
...
------------------------------------------------------------------------------*/
    ...
    IF AVAILABLE {&ttTable1} THEN DO:
        CASE pcField:
            ...
            WHEN "empresa":U THEN
                ASSIGN pcFieldValue = STRING({&ttTable1}.empresa).
        END CASE.
    END.
