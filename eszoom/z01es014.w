...
DEFINE TEMP-TABLE tt-imagem-etiq2 NO-UNDO LIKE imagem-etiq
       field r-rowid as rowid.
...
*******************************************************************************/
{include/i-prgvrs.i Z01ES014 2.00.00.000}

CREATE WIDGET-POOL.

/* Preprocessors Definitions ---                                      */
&GLOBAL-DEFINE Program           z01ES014
&GLOBAL-DEFINE Version           2.00.00.000

&GLOBAL-DEFINE InitialPage       1
&GLOBAL-DEFINE FolderLabels      Imagem,Descri‡Æo

&GLOBAL-DEFINE Range             YES

&GLOBAL-DEFINE FieldsRangePage1  mgesp.imagem-etiq.cod-imagem
&GLOBAL-DEFINE FieldsRangePage2  mgesp.imagem-etiq.descricao
&GLOBAL-DEFINE FieldsAnyKeyPage1 NO
&GLOBAL-DEFINE FieldsAnyKeyPage2 NO

&GLOBAL-DEFINE ttTable1          tt-imagem-etiq
&GLOBAL-DEFINE hDBOTable1        h-boes014
&GLOBAL-DEFINE DBOTable1         imagem-etiq

&GLOBAL-DEFINE ttTable2          tt-imagem-etiq2
&GLOBAL-DEFINE hDBOTable2        h-boes014-2
&GLOBAL-DEFINE DBOTable2         imagem-etiq
...
&Scoped-define INTERNAL-TABLES tt-imagem-etiq tt-imagem-etiq2

/* Definitions for BROWSE brTable1                                      */
&Scoped-define FIELDS-IN-QUERY-brTable1 tt-imagem-etiq.cod-imagem ~
tt-imagem-etiq.descricao tt-imagem-etiq.usu-resp tt-imagem-etiq.imagem 
&Scoped-define ENABLED-FIELDS-IN-QUERY-brTable1 
&Scoped-define QUERY-STRING-brTable1 FOR EACH tt-imagem-etiq NO-LOCK
&Scoped-define OPEN-QUERY-brTable1 OPEN QUERY brTable1 FOR EACH tt-imagem-etiq NO-LOCK.
&Scoped-define TABLES-IN-QUERY-brTable1 tt-imagem-etiq
&Scoped-define FIRST-TABLE-IN-QUERY-brTable1 tt-imagem-etiq


/* Definitions for BROWSE brTable2                                      */
&Scoped-define FIELDS-IN-QUERY-brTable2 tt-imagem-etiq2.cod-imagem ~
tt-imagem-etiq2.descricao tt-imagem-etiq2.usu-resp tt-imagem-etiq2.imagem 
&Scoped-define ENABLED-FIELDS-IN-QUERY-brTable2 
&Scoped-define QUERY-STRING-brTable2 FOR EACH tt-imagem-etiq2 NO-LOCK
&Scoped-define OPEN-QUERY-brTable2 OPEN QUERY brTable2 FOR EACH tt-imagem-etiq2 NO-LOCK.
&Scoped-define TABLES-IN-QUERY-brTable2 tt-imagem-etiq2
&Scoped-define FIRST-TABLE-IN-QUERY-brTable2 tt-imagem-etiq2
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS brTable1 wZoom _STRUCTURED
  QUERY brTable1 NO-LOCK DISPLAY
      ...
      tt-imagem-etiq.descricao FORMAT "x(80)":U
      tt-imagem-etiq.usu-resp FORMAT "x(12)":U
      tt-imagem-etiq.imagem FORMAT "x(80)":U
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS brTable2 wZoom _STRUCTURED
  QUERY brTable2 NO-LOCK DISPLAY
      tt-imagem-etiq2.cod-imagem FORMAT "999":U
      tt-imagem-etiq2.descricao FORMAT "x(80)":U
      tt-imagem-etiq2.usu-resp FORMAT "x(12)":U
      tt-imagem-etiq2.imagem FORMAT "x(80)":U
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ROW-MARKERS SEPARATORS SIZE 82 BY 10.67
         FONT 2.
...
/* Settings for THIS-PROCEDURE
   ...
   Temp-Tables and Buffers:
      ...
      ADDITIONAL-FIELDS:
          field r-rowid as rowid
      END-FIELDS.
      TABLE: tt-imagem-etiq2 T "?" NO-UNDO mgesp imagem-etiq
      ADDITIONAL-FIELDS:
          field r-rowid as rowid
      END-FIELDS.
   END-TABLES.
...
/* Query rebuild information for BROWSE brTable1
     _TblList          = "Temp-Tables.tt-imagem-etiq"
     _Options          = "NO-LOCK"
     _FldNameList[1]   = Temp-Tables.tt-imagem-etiq.cod-imagem
     _FldNameList[2]   = Temp-Tables.tt-imagem-etiq.descricao
     _FldNameList[3]   = Temp-Tables.tt-imagem-etiq.usu-resp
     _FldNameList[4]   = Temp-Tables.tt-imagem-etiq.imagem
     _Query            is OPENED
*/  /* BROWSE brTable1 */
&ANALYZE-RESUME
...
/* Query rebuild information for BROWSE brTable2
     _TblList          = "Temp-Tables.tt-imagem-etiq2"
     _Options          = "NO-LOCK"
     _FldNameList[1]   = Temp-Tables.tt-imagem-etiq2.cod-imagem
     _FldNameList[2]   = Temp-Tables.tt-imagem-etiq2.descricao
     _FldNameList[3]   = Temp-Tables.tt-imagem-etiq2.usu-resp
     _FldNameList[4]   = Temp-Tables.tt-imagem-etiq2.imagem
     _Query            is OPENED
*/  /* BROWSE brTable2 */
&ANALYZE-RESUME
...
------------------------------------------------------------------------------*/
    ...
    IF NOT VALID-HANDLE({&hDBOTable1}) OR
       ...
       {&hDBOTable1}:FILE-NAME <> "esbo/boes014.p":U THEN DO:
       
        {btb/btb008za.i1 esbo/boes014.p YES}
        {btb/btb008za.i2 esbo/boes014.p '' {&hDBOTable1}} 
    END.
    ...
    IF NOT VALID-HANDLE({&hDBOTable2}) OR
       ...
       {&hDBOTable2}:FILE-NAME <> "esbo/boes014.p":U THEN DO:
       
        {btb/btb008za.i1 esbo/boes014.p YES}
        {btb/btb008za.i2 esbo/boes014.p '' {&hDBOTable2}} 
    END.
...
------------------------------------------------------------------------------*/
    ...
    {zoom/openqueries.i &Query="CodImagem"
                        &PageNumber="1"}
    ...
    IF AVAILABLE {&ttTable1} THEN DO:
        CASE pcField:
            WHEN "cod-imagem":U THEN
                ASSIGN pcFieldValue = STRING({&ttTable1}.cod-imagem).
...
------------------------------------------------------------------------------*/
    ...
    IF AVAILABLE {&ttTable2} THEN DO:
        CASE pcField:
            WHEN "cod-imagem":U THEN
                ASSIGN pcFieldValue = STRING({&ttTable2}.cod-imagem).
            WHEN "descricao":U THEN
...
------------------------------------------------------------------------------*/
    ...
    CASE pPageNumber:
        WHEN 1 THEN
            ...
            RUN setConstraintCodImagem IN {&hDBOTable1} (INPUT fnIniRangeIntPage(INPUT 1, INPUT 1),
