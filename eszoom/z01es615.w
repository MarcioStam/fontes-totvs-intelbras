...
*******************************************************************************/
{include/i-prgvrs.i Z01ES615 2.00.00.000}

CREATE WIDGET-POOL.

/* Preprocessors Definitions ---                                      */
&GLOBAL-DEFINE Program           Z01ES615
&GLOBAL-DEFINE Version           2.00.00.000

&GLOBAL-DEFINE InitialPage       1
&GLOBAL-DEFINE FolderLabels      Num Serie

&GLOBAL-DEFINE Range             YES

&GLOBAL-DEFINE FieldsRangePage1  mgesp.num-serie.n-serie,mgesp.num-serie.it-codigo

&GLOBAL-DEFINE FieldsAnyKeyPage1 NO,NO

&GLOBAL-DEFINE ttTable1          tt-num-serie
&GLOBAL-DEFINE hDBOTable1        h-boes615
&GLOBAL-DEFINE DBOTable1         num-serie
...
&Scoped-define INTERNAL-TABLES tt-num-serie

/* Definitions for BROWSE brTable1                                      */
&Scoped-define FIELDS-IN-QUERY-brTable1 tt-num-serie.n-serie ~
tt-num-serie.it-codigo tt-num-serie.ano tt-num-serie.semana ~
tt-num-serie.sequencia tt-num-serie.num-pedido tt-num-serie.cod-estabel 
&Scoped-define ENABLED-FIELDS-IN-QUERY-brTable1 
&Scoped-define QUERY-STRING-brTable1 FOR EACH tt-num-serie NO-LOCK
&Scoped-define OPEN-QUERY-brTable1 OPEN QUERY brTable1 FOR EACH tt-num-serie NO-LOCK.
&Scoped-define TABLES-IN-QUERY-brTable1 tt-num-serie
&Scoped-define FIRST-TABLE-IN-QUERY-brTable1 tt-num-serie
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS brTable1 wZoom _STRUCTURED
  QUERY brTable1 NO-LOCK DISPLAY
      tt-num-serie.n-serie FORMAT "x(13)":U WIDTH 16
      tt-num-serie.it-codigo FORMAT "x(7)":U WIDTH 10
      tt-num-serie.ano FORMAT "9999":U WIDTH 6
      tt-num-serie.semana FORMAT "99":U
      tt-num-serie.sequencia FORMAT "99999":U
      tt-num-serie.num-pedido FORMAT ">,>>>,>>9":U
      tt-num-serie.cod-estabel FORMAT "x(3)":U
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
...
/* Query rebuild information for BROWSE brTable1
     _TblList          = "Temp-Tables.tt-num-serie"
     _Options          = "NO-LOCK"
     _FldNameList[1]   > Temp-Tables.tt-num-serie.n-serie
"n-serie" ? ? "character" ? ? ? ? ? ? no ? no no "16" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[2]   > Temp-Tables.tt-num-serie.it-codigo
"it-codigo" ? ? "character" ? ? ? ? ? ? no ? no no "10" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[3]   > Temp-Tables.tt-num-serie.ano
"ano" ? ? "integer" ? ? ? ? ? ? no ? no no "6" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[4]   = Temp-Tables.tt-num-serie.semana
     _FldNameList[5]   = Temp-Tables.tt-num-serie.sequencia
     _FldNameList[6]   = Temp-Tables.tt-num-serie.num-pedido
     _FldNameList[7]   = Temp-Tables.tt-num-serie.cod-estabel
     _Query            is OPENED
*/  /* BROWSE brTable1 */
&ANALYZE-RESUME
...
DO:
    {zoom/implant.i &ProgramImplant="esp/cpp/escpp066.w"
                    &PageNumber="1"}
END.
...
------------------------------------------------------------------------------*/
    ...
    IF NOT VALID-HANDLE({&hDBOTable1}) OR
       ...
       {&hDBOTable1}:FILE-NAME <> "esbo/boes615.p":U THEN DO:
       
        {btb/btb008za.i1 esbo/boes615.p YES}
        {btb/btb008za.i2 esbo/boes615.p '' {&hDBOTable1}} 
    END.
...
------------------------------------------------------------------------------*/
    ...
    {zoom/openqueries.i &Query="NumSerieItCodigo"
                        &PageNumber="1"}        
...
------------------------------------------------------------------------------*/
    ...
    IF AVAILABLE {&ttTable1} THEN DO:
        CASE pcField:
            WHEN "n-serie":U THEN
                ASSIGN pcFieldValue = STRING({&ttTable1}.n-serie).
...
------------------------------------------------------------------------------*/
    ...
    CASE pPageNumber:
        WHEN 1 THEN
            ...
            RUN setConstraintNumSerieItCodigo IN {&hDBOTable1} (INPUT FnIniRangeCharPage(1, 1),
