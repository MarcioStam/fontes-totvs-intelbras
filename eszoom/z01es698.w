...
*******************************************************************************/
{include/i-prgvrs.i z01es698 1.00.00.001}
...
&IF "{&EMSFND_VERSION}" >= "1.00" &THEN
    {include/i-license-manager.i z01es698 mcp}
&ENDIF
*/
...
&GLOBAL-DEFINE Program           z01es698
&GLOBAL-DEFINE Version           1.00.00.001

&GLOBAL-DEFINE InitialPage       1
&GLOBAL-DEFINE FolderLabels      Linha Produ‡Æo MQA

&GLOBAL-DEFINE Range             YES

&GLOBAL-DEFINE FieldsRangePage1  mgesp.int-lin-prod-mqa.nr-linha

&GLOBAL-DEFINE FieldsAnyKeyPage1 NO

&GLOBAL-DEFINE ttTable1          tt-int-lin-prod-mqa
&GLOBAL-DEFINE hDBOTable1        h-boes698
&GLOBAL-DEFINE DBOTable1         int-lin-prod-mqa
...
&Scoped-define INTERNAL-TABLES tt-int-lin-prod-mqa

/* Definitions for BROWSE brTable1                                      */
&Scoped-define FIELDS-IN-QUERY-brTable1 tt-int-lin-prod-mqa.nr-linha ~
tt-int-lin-prod-mqa.ds-email-extrapolacao 
&Scoped-define ENABLED-FIELDS-IN-QUERY-brTable1 
&Scoped-define QUERY-STRING-brTable1 FOR EACH tt-int-lin-prod-mqa NO-LOCK INDEXED-REPOSITION
&Scoped-define OPEN-QUERY-brTable1 OPEN QUERY brTable1 FOR EACH tt-int-lin-prod-mqa NO-LOCK INDEXED-REPOSITION.
&Scoped-define TABLES-IN-QUERY-brTable1 tt-int-lin-prod-mqa
&Scoped-define FIRST-TABLE-IN-QUERY-brTable1 tt-int-lin-prod-mqa
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS brTable1 wZoom _STRUCTURED
  QUERY brTable1 NO-LOCK DISPLAY
      tt-int-lin-prod-mqa.nr-linha FORMAT "99":U
      tt-int-lin-prod-mqa.ds-email-extrapolacao FORMAT "x(100)":U
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
...
/* Query rebuild information for BROWSE brTable1
     _TblList          = "Temp-Tables.tt-int-lin-prod-mqa"
     _Options          = "NO-LOCK INDEXED-REPOSITION"
     _FldNameList[1]   = Temp-Tables.tt-int-lin-prod-mqa.nr-linha
     _FldNameList[2]   = Temp-Tables.tt-int-lin-prod-mqa.ds-email-extrapolacao
     _Query            is OPENED
*/  /* BROWSE brTable1 */
&ANALYZE-RESUME
...
DO:
    {zoom/implant.i &ProgramImplant="esp/cpp/escpp124.w"
                    &PageNumber="1"}
END.
...
------------------------------------------------------------------------------*/
    ...
    IF NOT VALID-HANDLE({&hDBOTable1}) OR
       ...
       {&hDBOTable1}:FILE-NAME <> "esbo/boes698.p":U THEN DO:
       
        {btb/btb008za.i1 esbo/boes698.p YES}
        {btb/btb008za.i2 esbo/boes698.p '' {&hDBOTable1}} 
    END.
...
------------------------------------------------------------------------------*/
    ...
    IF AVAILABLE {&ttTable1} THEN DO:
        CASE pcField:
            WHEN "nr-linha":U THEN
                ASSIGN pcFieldValue = STRING({&ttTable1}.nr-linha).
        END CASE.
    END.
...
------------------------------------------------------------------------------*/
    ...
    CASE pPageNumber:
        WHEN 1 THEN
            RUN setConstraintLinha IN {&hDBOTable1} (INPUT FnIniRangeIntPage(1,1),
