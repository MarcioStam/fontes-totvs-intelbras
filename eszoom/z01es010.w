...
*******************************************************************************/
{include/i-prgvrs.i z01es010 1.00.00.000}

CREATE WIDGET-POOL.

/* Preprocessors Definitions ---                                      */
&GLOBAL-DEFINE Program           z01es010
...
&GLOBAL-DEFINE ttTable1          TTAe-Item
&GLOBAL-DEFINE hDBOTable1        HDBOTTAe-Item
&GLOBAL-DEFINE DBOTable1         Ae-Item
...
&Scoped-define FIELDS-IN-QUERY-brTable1 ttae-item.nr-ae ttae-item.situacao ~
ttae-item.sequencia ttae-item.data ttae-item.data-validade 
&Scoped-define ENABLED-FIELDS-IN-QUERY-brTable1 
&Scoped-define QUERY-STRING-brTable1 FOR EACH ttae-item NO-LOCK
&Scoped-define OPEN-QUERY-brTable1 OPEN QUERY brTable1 FOR EACH ttae-item NO-LOCK.
&Scoped-define TABLES-IN-QUERY-brTable1 ttae-item
&Scoped-define FIRST-TABLE-IN-QUERY-brTable1 ttae-item
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS brTable1 wZoom _STRUCTURED
  QUERY brTable1 NO-LOCK DISPLAY
      ttae-item.nr-ae COLUMN-LABEL "Nr§ AE" FORMAT "9999999":U
      ttae-item.situacao FORMAT "Baixado/Pendente":U
      ttae-item.sequencia COLUMN-LABEL "Sequˆncia" FORMAT "999":U
      ttae-item.data COLUMN-LABEL "Data entrada" FORMAT "99/99/9999":U
      ttae-item.data-validade COLUMN-LABEL "Data validade" FORMAT "99/99/9999":U
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
...
DEFINE FRAME fPage1
     fi-ini-nr-ae AT ROW 1.5 COL 21 COLON-ALIGNED
     fi-fim-nr-ae AT ROW 1.5 COL 45 COLON-ALIGNED NO-LABEL
     btCheck AT ROW 1.5 COL 77
     fi-ini-sequencia AT ROW 2.5 COL 15.43
     fi-fim-sequencia AT ROW 2.5 COL 47 NO-LABEL
...
/* SETTINGS FOR FRAME fPage1
                                                                        */
/* BROWSE-TAB brTable1 fi-fim-sequencia fPage1 */
...
/* Query rebuild information for BROWSE brTable1
     _TblList          = "Temp-Tables.ttae-item"
     _Options          = "NO-LOCK"
     _FldNameList[1]   > Temp-Tables.ttae-item.nr-ae
"ttae-item.nr-ae" "Nr§ AE" ? "integer" ? ? ? ? ? ? no ? no no ? yes no no "U" "" ""
     _FldNameList[2]   = Temp-Tables.ttae-item.situacao
     _FldNameList[3]   > Temp-Tables.ttae-item.sequencia
"ttae-item.sequencia" "Sequˆncia" ? "integer" ? ? ? ? ? ? no ? no no ? yes no no "U" "" ""
     _FldNameList[4]   > Temp-Tables.ttae-item.data
"ttae-item.data" "Data entrada" ? "date" ? ? ? ? ? ? no ? no no ? yes no no "U" "" ""
     _FldNameList[5]   > Temp-Tables.ttae-item.data-validade
"ttae-item.data-validade" "Data validade" ? "date" ? ? ? ? ? ? no ? no no ? yes no no "U" "" ""
     _Query            is OPENED
*/  /* BROWSE brTable1 */
&ANALYZE-RESUME
...
DO:
  ASSIGN INPUT FRAME fpage1
         fi-ini-nr-ae fi-fim-nr-ae fi-ini-sequencia fi-fim-sequencia.
...
/*------------------------------------------------------------------------------
  ...
  Notes:       
------------------------------------------------------------------------------*/
    DISP fi-ini-nr-ae fi-fim-nr-ae fi-ini-sequencia fi-fim-sequencia WITH FRAME fPage1.
    ENABLE fi-ini-nr-ae fi-fim-nr-ae fi-ini-sequencia fi-fim-sequencia btCheck WITH FRAME fPage1.
...
------------------------------------------------------------------------------*/
    ...
    IF NOT VALID-HANDLE({&hDBOTable1}) OR
       ...
       {&hDBOTable1}:FILE-NAME <> "esbo/boes010.p":U THEN DO:
       
        {btb/btb008za.i1 esbo/boes010.p YES}
        {btb/btb008za.i2 esbo/boes010.p '' {&hDBOTable1}} 
    END.
...
/*:T------------------------------------------------------------------------------
  ...
  Notes:       
------------------------------------------------------------------------------*/
    {zoom/OpenQueries.i &Query="ByCod2"
                        &PageNumber="1"}
...
------------------------------------------------------------------------------*/
    ...
    IF AVAILABLE {&ttTable1} THEN DO:
        CASE pcField:
            ...
            WHEN "data-validade":U THEN
                ASSIGN pcFieldValue = STRING({&ttTable1}.data-validade).
        END CASE.
    END.
