...
*******************************************************************************/
{include/i-prgvrs.i Z01ES080 2.04.00.001}

CREATE WIDGET-POOL.

/* Preprocessors Definitions ---                                      */
&GLOBAL-DEFINE Program           Z01ES080
&GLOBAL-DEFINE Version           2.04.00.001

&GLOBAL-DEFINE InitialPage       1
&GLOBAL-DEFINE FolderLabels      Fam¡lia,Descri‡Æo

&GLOBAL-DEFINE Range             YES

&GLOBAL-DEFINE FieldsRangePage1  mgesp.familia-item.cod-familia
&GLOBAL-DEFINE FieldsRangePage2  mgesp.familia-item.Descricao
&GLOBAL-DEFINE FieldsAnyKeyPage1 no
&GLOBAL-DEFINE FieldsAnyKeyPage2 yes

&GLOBAL-DEFINE ttTable1          ttfamilia-item
&GLOBAL-DEFINE hDBOTable1        hboes080
&GLOBAL-DEFINE DBOTable1         familia-item

&GLOBAL-DEFINE ttTable2          ttfamilia-item
&GLOBAL-DEFINE hDBOTable2        hboes080-1
&GLOBAL-DEFINE DBOTable2         familia-item
...
&Scoped-define INTERNAL-TABLES ttfamilia-item

/* Definitions for BROWSE brTable1                                      */
&Scoped-define FIELDS-IN-QUERY-brTable1 ttfamilia-item.cod-familia ~
ttfamilia-item.Descricao ttfamilia-item.abreviatura 
&Scoped-define ENABLED-FIELDS-IN-QUERY-brTable1 
&Scoped-define QUERY-STRING-brTable1 FOR EACH ttfamilia-item NO-LOCK
&Scoped-define OPEN-QUERY-brTable1 OPEN QUERY brTable1 FOR EACH ttfamilia-item NO-LOCK.
&Scoped-define TABLES-IN-QUERY-brTable1 ttfamilia-item
&Scoped-define FIRST-TABLE-IN-QUERY-brTable1 ttfamilia-item


/* Definitions for BROWSE brTable2                                      */
&Scoped-define FIELDS-IN-QUERY-brTable2 ttfamilia-item.Descricao ~
ttfamilia-item.cod-familia ttfamilia-item.abreviatura 
&Scoped-define ENABLED-FIELDS-IN-QUERY-brTable2 
&Scoped-define QUERY-STRING-brTable2 FOR EACH ttfamilia-item NO-LOCK ~
    BY ttfamilia-item.Descricao
&Scoped-define OPEN-QUERY-brTable2 OPEN QUERY brTable2 FOR EACH ttfamilia-item NO-LOCK ~
    BY ttfamilia-item.Descricao.
&Scoped-define TABLES-IN-QUERY-brTable2 ttfamilia-item
&Scoped-define FIRST-TABLE-IN-QUERY-brTable2 ttfamilia-item
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS brTable1 wZoom _STRUCTURED
  QUERY brTable1 NO-LOCK DISPLAY
      ttfamilia-item.cod-familia FORMAT ">>9":U
      ttfamilia-item.Descricao FORMAT "x(35)":U
      ttfamilia-item.abreviatura FORMAT "x(15)":U
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
...
/* Query rebuild information for BROWSE brTable1
     _TblList          = "Temp-Tables.ttfamilia-item"
     _Options          = "NO-LOCK"
     _FldNameList[1]   = Temp-Tables.ttfamilia-item.cod-familia
     _FldNameList[2]   = Temp-Tables.ttfamilia-item.Descricao
     _FldNameList[3]   = Temp-Tables.ttfamilia-item.abreviatura
     _Query            is OPENED
*/  /* BROWSE brTable1 */
&ANALYZE-RESUME
...
/* Query rebuild information for BROWSE brTable2
     _TblList          = "Temp-Tables.ttfamilia-item"
     _Options          = "NO-LOCK"
     _OrdList          = "Temp-Tables.ttfamilia-item.Descricao|yes"
     _FldNameList[1]   = Temp-Tables.ttfamilia-item.Descricao
     _FldNameList[2]   = Temp-Tables.ttfamilia-item.cod-familia
     _FldNameList[3]   = Temp-Tables.ttfamilia-item.abreviatura
     _Query            is OPENED
*/  /* BROWSE brTable2 */
&ANALYZE-RESUME
...
------------------------------------------------------------------------------*/
    ...
    IF NOT VALID-HANDLE({&hDBOTable1}) OR
       ...
       {&hDBOTable1}:FILE-NAME <> "esbo/boes080.p":U THEN DO:
       
        {btb/btb008za.i1 esbo/boes080.p YES}
        {btb/btb008za.i2 esbo/boes080.p '' {&hDBOTable1}} 
    END.
    
    RUN setConstraintZoom1 IN {&hDBOTable1} (input 0, 999) NO-ERROR.
    
    /*:T--- Verifica se o DBO j  est  inicializado ---*/
    IF NOT VALID-HANDLE({&hDBOTable2}) OR
       {&hDBOTable2}:TYPE <> "PROCEDURE":U OR
       {&hDBOTable2}:FILE-NAME <> "esbo/boes080.p":U THEN DO:
       
        {btb/btb008za.i1 esbo/boes080.p YES}
        {btb/btb008za.i2 esbo/boes080.p '' {&hDBOTable2}} 
    END.
