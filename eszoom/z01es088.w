...
DEFINE TEMP-TABLE ttgrupo-mail NO-UNDO LIKE grupo-mail
...
*******************************************************************************/
{include/i-prgvrs.i Z01ES088 2.04.00.001}

CREATE WIDGET-POOL.

/* Preprocessors Definitions ---                                      */
&GLOBAL-DEFINE Program           z01es088
&GLOBAL-DEFINE Version           2.04.00.001

&GLOBAL-DEFINE InitialPage       1
&GLOBAL-DEFINE FolderLabels      Grupos

&GLOBAL-DEFINE Range             YES

&GLOBAL-DEFINE FieldsRangePage1  mgesp.grupo-mail.cod-grupo
&GLOBAL-DEFINE FieldsAnyKeyPage1 YES

&GLOBAL-DEFINE ttTable1          ttgrupo-mail
&GLOBAL-DEFINE hDBOTable1        hboes088

&GLOBAL-DEFINE DBOTable1         grupo-mail
...
&Scoped-define INTERNAL-TABLES ttgrupo-mail

/* Definitions for BROWSE brTable1                                      */
&Scoped-define FIELDS-IN-QUERY-brTable1 ttgrupo-mail.cod-grupo ~
ttgrupo-mail.grupo ttgrupo-mail.cc-codigo 
&Scoped-define ENABLED-FIELDS-IN-QUERY-brTable1 
&Scoped-define QUERY-STRING-brTable1 FOR EACH ttgrupo-mail NO-LOCK INDEXED-REPOSITION
&Scoped-define OPEN-QUERY-brTable1 OPEN QUERY brTable1 FOR EACH ttgrupo-mail NO-LOCK INDEXED-REPOSITION.
&Scoped-define TABLES-IN-QUERY-brTable1 ttgrupo-mail
&Scoped-define FIRST-TABLE-IN-QUERY-brTable1 ttgrupo-mail
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS brTable1 wZoom _STRUCTURED
  QUERY brTable1 NO-LOCK DISPLAY
      ttgrupo-mail.cod-grupo FORMAT ">>>9":U
      ttgrupo-mail.grupo FORMAT "x(30)":U
      ttgrupo-mail.cc-codigo FORMAT "x(8)":U
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
...
/* Settings for THIS-PROCEDURE
   ...
   Temp-Tables and Buffers:
      TABLE: ttgrupo-mail T "?" NO-UNDO mgesp grupo-mail
      ADDITIONAL-FIELDS:
          field r-rowid as rowid
      END-FIELDS.
   END-TABLES.
...
/* Query rebuild information for BROWSE brTable1
     _TblList          = "Temp-Tables.ttgrupo-mail"
     _Options          = "NO-LOCK INDEXED-REPOSITION"
     _FldNameList[1]   = Temp-Tables.ttgrupo-mail.cod-grupo
     _FldNameList[2]   = Temp-Tables.ttgrupo-mail.grupo
     _FldNameList[3]   = Temp-Tables.ttgrupo-mail.cc-codigo
     _Query            is OPENED
*/  /* BROWSE brTable1 */
&ANALYZE-RESUME
...
------------------------------------------------------------------------------*/
    ...
    IF NOT VALID-HANDLE({&hDBOTable1}) OR
       ...
       {&hDBOTable1}:FILE-NAME <> "esbo/boes088.p":U THEN DO:
       
        {btb/btb008za.i1 esbo/boes088.p YES}
        {btb/btb008za.i2 esbo/boes088.p '' {&hDBOTable1}} 
    END.
    
    RUN setConstraintZoom IN {&hDBOTable1} (input 0, input 9999) NO-ERROR.
...
------------------------------------------------------------------------------*/
    ...
    IF AVAILABLE {&ttTable1} THEN DO:
        CASE pcField:
            WHEN "cod-grupo":U THEN
                ASSIGN pcFieldValue = STRING({&ttTable1}.cod-grupo).
                
            WHEN "grupo":U THEN
                ASSIGN pcFieldValue = STRING({&ttTable1}.grupo).
...
------------------------------------------------------------------------------*/
    ...
    CASE pPageNumber:
        WHEN 1 THEN
            ...
            RUN setConstraintZoom IN {&hDBOTable1} (INPUT fnIniRangeIntPage(INPUT 1, INPUT 1),
