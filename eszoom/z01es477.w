...
*******************************************************************************/
{include/i-prgvrs.i z01es477 2.04.00.000}

CREATE WIDGET-POOL.

/* Preprocessors Definitions ---                                      */
&GLOBAL-DEFINE Program           z01es477
...
&GLOBAL-DEFINE ttTable1          tt-juridico-solucoes
&GLOBAL-DEFINE hDBOTable1        hboes477
&GLOBAL-DEFINE DBOTable1         tt-juridico-solucoes
...
&Scoped-define INTERNAL-TABLES tt-juridico-solucoes

/* Definitions for BROWSE brTable1                                      */
&Scoped-define FIELDS-IN-QUERY-brTable1 tt-juridico-solucoes.codigo ~
tt-juridico-solucoes.descricao 
&Scoped-define ENABLED-FIELDS-IN-QUERY-brTable1 
&Scoped-define QUERY-STRING-brTable1 FOR EACH tt-juridico-solucoes NO-LOCK
&Scoped-define OPEN-QUERY-brTable1 OPEN QUERY brTable1 FOR EACH tt-juridico-solucoes NO-LOCK.
&Scoped-define TABLES-IN-QUERY-brTable1 tt-juridico-solucoes
&Scoped-define FIRST-TABLE-IN-QUERY-brTable1 tt-juridico-solucoes
...
DEFINE QUERY brTable1 FOR 
      tt-juridico-solucoes SCROLLING.
&ANALYZE-RESUME
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS brTable1 wZoom _STRUCTURED
  QUERY brTable1 NO-LOCK DISPLAY
      tt-juridico-solucoes.codigo FORMAT ">>>>>>9":U WIDTH 11.43
      tt-juridico-solucoes.descricao FORMAT "x(40)":U WIDTH 66.86
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
...
/* Query rebuild information for BROWSE brTable1
     _TblList          = "Temp-Tables.tt-juridico-solucoes"
     _Options          = "NO-LOCK"
     _TblOptList       = ", FIRST USED"
     _FldNameList[1]   > Temp-Tables.tt-juridico-solucoes.codigo
"tt-juridico-solucoes.codigo" ? ? "integer" ? ? ? ? ? ? no ? no no "11.43" yes no no "U" "" ""
     _FldNameList[2]   > Temp-Tables.tt-juridico-solucoes.descricao
"tt-juridico-solucoes.descricao" ? ? "character" ? ? ? ? ? ? no ? no no "66.86" yes no no "U" "" ""
     _Query            is OPENED
*/  /* BROWSE brTable1 */
&ANALYZE-RESUME
...
------------------------------------------------------------------------------*/
    ...
    IF NOT VALID-HANDLE({&hDBOTable1}) OR
       ...
       {&hDBOTable1}:FILE-NAME <> "esbo/boes477.p":U THEN DO:
       
        {btb/btb008za.i1 esbo/boes477.p YES}
        {btb/btb008za.i2 esbo/boes477.p '' {&hDBOTable1}} 
    END.
