...
*******************************************************************************/
{include/i-prgvrs.i Z01ES921 2.00.00.000}

CREATE WIDGET-POOL.

/* Preprocessors Definitions ---                                      */
&GLOBAL-DEFINE Program           Z01ES921
...
&GLOBAL-DEFINE ttTable1          tt-int-logistica-ecommerce
&GLOBAL-DEFINE hDBOTable1        hDBODefTransp
&GLOBAL-DEFINE DBOTable1         int-logistica-ecommerce
...
&Scoped-define INTERNAL-TABLES tt-int-logistica-ecommerce

/* Definitions for BROWSE brTable1                                      */
&Scoped-define FIELDS-IN-QUERY-brTable1 tt-int-logistica-ecommerce.cod-transp ~
tt-int-logistica-ecommerce.cod-estabel tt-int-logistica-ecommerce.Estado ~
tt-int-logistica-ecommerce.cidade tt-int-logistica-ecommerce.cod-emitente ~
tt-int-logistica-ecommerce.sigla-transp tt-int-logistica-ecommerce.cep-inicial ~
tt-int-logistica-ecommerce.cep-final 
&Scoped-define ENABLED-FIELDS-IN-QUERY-brTable1 
&Scoped-define QUERY-STRING-brTable1 FOR EACH tt-int-logistica-ecommerce NO-LOCK
&Scoped-define OPEN-QUERY-brTable1 OPEN QUERY brTable1 FOR EACH tt-int-logistica-ecommerce NO-LOCK.
&Scoped-define TABLES-IN-QUERY-brTable1 tt-int-logistica-ecommerce
&Scoped-define FIRST-TABLE-IN-QUERY-brTable1 tt-int-logistica-ecommerce
...
DEFINE QUERY brTable1 FOR 
      tt-int-logistica-ecommerce SCROLLING.
&ANALYZE-RESUME
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS brTable1 wZoom _STRUCTURED
  QUERY brTable1 NO-LOCK DISPLAY
      tt-int-logistica-ecommerce.cod-transp FORMAT ">>>>>>>>9":U WIDTH 9.43
      tt-int-logistica-ecommerce.cod-estabel COLUMN-LABEL "Estab" FORMAT "x(3)":U
            WIDTH 5
      tt-int-logistica-ecommerce.Estado FORMAT "x(04)":U WIDTH 3
      tt-int-logistica-ecommerce.cidade FORMAT "x(25)":U WIDTH 11.86
      tt-int-logistica-ecommerce.cod-emitente FORMAT ">>>>>9":U WIDTH 9.72
      tt-int-logistica-ecommerce.sigla-transp FORMAT "x(12)":U WIDTH 8.72
      tt-int-logistica-ecommerce.cep-inicial FORMAT "x(12)":U WIDTH 11.43
      tt-int-logistica-ecommerce.cep-final FORMAT "x(12)":U WIDTH 14.57
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
...
/* Query rebuild information for BROWSE brTable1
     _TblList          = "Temp-Tables.tt-int-logistica-ecommerce"
     _Options          = "NO-LOCK"
     _FldNameList[1]   > Temp-Tables.tt-int-logistica-ecommerce.cod-transp
"cod-transp" ? ? "integer" ? ? ? ? ? ? no ? no no "9.43" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[2]   > Temp-Tables.tt-int-logistica-ecommerce.cod-estabel
"cod-estabel" "Estab" ? "character" ? ? ? ? ? ? no ? no no "5" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[3]   > Temp-Tables.tt-int-logistica-ecommerce.Estado
"Estado" ? ? "character" ? ? ? ? ? ? no ? no no "3" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[4]   > Temp-Tables.tt-int-logistica-ecommerce.cidade
"cidade" ? ? "character" ? ? ? ? ? ? no ? no no "11.86" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[5]   > Temp-Tables.tt-int-logistica-ecommerce.cod-emitente
"cod-emitente" ? ? "integer" ? ? ? ? ? ? no ? no no "9.72" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[6]   > Temp-Tables.tt-int-logistica-ecommerce.sigla-transp
"sigla-transp" ? "x(12)" "character" ? ? ? ? ? ? no ? no no "8.72" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[7]   > Temp-Tables.tt-int-logistica-ecommerce.cep-inicial
"cep-inicial" ? ? "character" ? ? ? ? ? ? no ? no no "11.43" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[8]   > Temp-Tables.tt-int-logistica-ecommerce.cep-final
...
------------------------------------------------------------------------------*/
    ...
    IF NOT VALID-HANDLE({&hDBOTable1}) OR
       ...
       {&hDBOTable1}:FILE-NAME <> "esbo/boes175.p":U THEN DO:
       
        {btb/btb008za.i1 esbo/boes175.p YES}
        {btb/btb008za.i2 esbo/boes175.p '' {&hDBOTable1}} 
    END.
