...
*******************************************************************************/
{include/i-prgvrs.i espdp046 1.00.00.000}

CREATE WIDGET-POOL.

/* Preprocessors Definitions ---                                      */
&GLOBAL-DEFINE Program           espdp046
&GLOBAL-DEFINE Version           1.00.00.000

&GLOBAL-DEFINE InitialPage       1
&GLOBAL-DEFINE FolderLabels      Parceiros

&GLOBAL-DEFINE Range             YES

&GLOBAL-DEFINE FieldsRangePage1  mgesp.repres-parceiros.cod-rep,mgesp.repres-parceiros.parceiro 
&GLOBAL-DEFINE FieldsRangePage2  

&GLOBAL-DEFINE FieldsAnyKeyPage1 NO,NO
&GLOBAL-DEFINE FieldsAnyKeyPage2 

&GLOBAL-DEFINE ttTable1          ttrepres-parceiros
&GLOBAL-DEFINE hDBOTable1        hDBORepres-parceiros
&GLOBAL-DEFINE DBOTable1         repres-parceiros      
...
&Scoped-define INTERNAL-TABLES ttrepres-parceiros repres

/* Definitions for BROWSE brTable1                                      */
&Scoped-define FIELDS-IN-QUERY-brTable1 ttrepres-parceiros.cod-rep ~
repres.nome ttrepres-parceiros.parceiro 
&Scoped-define ENABLED-FIELDS-IN-QUERY-brTable1 
&Scoped-define QUERY-STRING-brTable1 FOR EACH ttrepres-parceiros NO-LOCK, ~
      FIRST repres OF ttrepres-parceiros NO-LOCK
&Scoped-define OPEN-QUERY-brTable1 OPEN QUERY brTable1 FOR EACH ttrepres-parceiros NO-LOCK, ~
      FIRST repres OF ttrepres-parceiros NO-LOCK.
&Scoped-define TABLES-IN-QUERY-brTable1 ttrepres-parceiros repres
&Scoped-define FIRST-TABLE-IN-QUERY-brTable1 ttrepres-parceiros
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS brTable1 wZoom _STRUCTURED
  QUERY brTable1 NO-LOCK DISPLAY
      ttrepres-parceiros.cod-rep FORMAT ">>>>9":U WIDTH 8.43
      repres.nome FORMAT "x(40)":U WIDTH 45.43
      ttrepres-parceiros.parceiro FORMAT "x(12)":U WIDTH 22.43
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ROW-MARKERS SEPARATORS SIZE 82 BY 11.5
         FONT 2.
...
DEFINE FRAME fpage0
     btOK AT ROW 19.25 COL 2
     btCancel AT ROW 19.25 COL 13
     btHelp AT ROW 19.25 COL 80
...
/* Query rebuild information for BROWSE brTable1
     _TblList          = "Temp-Tables.ttrepres-parceiros,mgcad.repres OF Temp-Tables.ttrepres-parceiros"
     _Options          = "NO-LOCK"
     _TblOptList       = ", FIRST"
     _FldNameList[1]   > Temp-Tables.ttrepres-parceiros.cod-rep
"Temp-Tables.ttrepres-parceiros.cod-rep" ? ? "integer" ? ? ? ? ? ? no ? no no "8.43" yes no no "U" "" ""
     _FldNameList[2]   > mgcad.repres.nome
"mgcad.repres.nome" ? ? "character" ? ? ? ? ? ? no ? no no "45.43" yes no no "U" "" ""
     _FldNameList[3]   > Temp-Tables.ttrepres-parceiros.parceiro
"Temp-Tables.ttrepres-parceiros.parceiro" ? ? "character" ? ? ? ? ? ? no ? no no "22.43" yes no no "U" "" ""
     _Query            is OPENED
*/  /* BROWSE brTable1 */
&ANALYZE-RESUME
...
------------------------------------------------------------------------------*/
    ...
    IF NOT VALID-HANDLE({&hDBOTable1}) OR
       ...
       {&hDBOTable1}:FILE-NAME <> "espdp046":U THEN DO:
       
        {btb/btb008za.i1 esbo/boes435.p YES}
        {btb/btb008za.i2 esbo/boes435.p '' {&hDBOTable1}} 
    END.
        /*---Abre a Query Zoom1 do DBO ---*/
...
------------------------------------------------------------------------------*/
    ...
    IF AVAILABLE ttrepres-parceiros THEN DO:
        CASE pcField:
            WHEN "cod-rep":U THEN
                ASSIGN pcFieldValue = STRING(ttrepres-parceiros.cod-rep).
            WHEN "parceiro" THEN
                ASSIGN pcFieldValue = STRING(ttrepres-parceiros.parceiro).
