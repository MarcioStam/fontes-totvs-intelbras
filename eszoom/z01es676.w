...
*******************************************************************************/
{include/i-prgvrs.i Z01ES676 2.00.00.000}
...
&GLOBAL-DEFINE Program           Z01ES676
&GLOBAL-DEFINE Version           2.00.00.000

&GLOBAL-DEFINE InitialPage       1
&GLOBAL-DEFINE FolderLabels      Testes

&GLOBAL-DEFINE Range             YES

&GLOBAL-DEFINE FieldsRangePage1  mgesp.aq-teste.nr-seq-teste,mgesp.aq-teste.des-teste
&GLOBAL-DEFINE FieldsAnyKeyPage1 NO,NO

&GLOBAL-DEFINE ttTable1          tt-aq-teste
&GLOBAL-DEFINE hDBOTable1        h-boes676
&GLOBAL-DEFINE DBOTable1         aq-teste   
...
&Scoped-define INTERNAL-TABLES tt-aq-teste

/* Definitions for BROWSE brTable1                                      */
&Scoped-define FIELDS-IN-QUERY-brTable1 tt-aq-teste.des-teste ~
tt-aq-teste.nr-seq-teste 
&Scoped-define ENABLED-FIELDS-IN-QUERY-brTable1 
&Scoped-define QUERY-STRING-brTable1 FOR EACH tt-aq-teste NO-LOCK ~
    BY tt-aq-teste.des-teste
&Scoped-define OPEN-QUERY-brTable1 OPEN QUERY brTable1 FOR EACH tt-aq-teste NO-LOCK ~
    BY tt-aq-teste.des-teste.
&Scoped-define TABLES-IN-QUERY-brTable1 tt-aq-teste
&Scoped-define FIRST-TABLE-IN-QUERY-brTable1 tt-aq-teste
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS brTable1 wZoom _STRUCTURED
  QUERY brTable1 NO-LOCK DISPLAY
      tt-aq-teste.des-teste COLUMN-LABEL "Descri‡Æo" FORMAT "x(40)":U
      tt-aq-teste.nr-seq-teste COLUMN-LABEL "C¢digo" FORMAT ">>>>>9":U
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
...
/* Query rebuild information for BROWSE brTable1
     _TblList          = "Temp-Tables.tt-aq-teste"
     _Options          = "NO-LOCK"
     _OrdList          = "Temp-Tables.tt-aq-teste.des-teste|yes"
     _FldNameList[1]   > Temp-Tables.tt-aq-teste.des-teste
"tt-aq-teste.des-teste" "Descri‡Æo" ? "character" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[2]   > Temp-Tables.tt-aq-teste.nr-seq-teste
"tt-aq-teste.nr-seq-teste" "C¢digo" ? "integer" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _Query            is OPENED
*/  /* BROWSE brTable1 */
&ANALYZE-RESUME
...
DO:
    {zoom/implant.i &ProgramImplant="esp\aqp\esaqp011.w"
                    &PageNumber="1"}
END.
...
------------------------------------------------------------------------------*/
    ...
    IF NOT VALID-HANDLE({&hDBOTable1}) OR
       ...
       {&hDBOTable1}:FILE-NAME <> "esbo/boes676.p":U THEN DO:
       
        {btb/btb008za.i1 esbo/boes676.p YES}
        {btb/btb008za.i2 esbo/boes676.p '' {&hDBOTable1}} 
    END.
...
------------------------------------------------------------------------------*/
    ...
    {zoom/openqueries.i &Query="Teste"
                        &PageNumber="1"}
...
------------------------------------------------------------------------------*/
    ...
    IF AVAILABLE {&ttTable1} THEN DO:
        CASE pcField:
            WHEN "nr-seq-teste":U THEN
                ASSIGN pcFieldValue = STRING({&ttTable1}.nr-seq-teste).
            /*WHEN "des-teste":U THEN
                ASSIGN pcFieldValue = STRING({&ttTable1}.des-teste).*/
        END CASE.
    END.
...
------------------------------------------------------------------------------*/
    ...
    CASE pPageNumber:
        WHEN 1 THEN
            ...
            RUN setConstraintTeste IN {&hDBOTable1} (INPUT FnIniRangeIntPage(1,1),
