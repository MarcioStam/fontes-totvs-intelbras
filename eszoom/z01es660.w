...
*******************************************************************************/
{include/i-prgvrs.i Z01ES660 2.00.00.000}
...
&GLOBAL-DEFINE Program           Z01ES660
...
&GLOBAL-DEFINE FieldsRangePage1  mgesp.INT_usuar_mestre.cod_usuario
&GLOBAL-DEFINE FieldsAnyKeyPage1 NO

&GLOBAL-DEFINE ttTable1          tt-int_usuar_mestre
&GLOBAL-DEFINE hDBOTable1        h-boes660
&GLOBAL-DEFINE DBOTable1         INT_usuar_mestre
...
&Scoped-define INTERNAL-TABLES tt-int_usuar_mestre

/* Definitions for BROWSE brTable1                                      */
&Scoped-define FIELDS-IN-QUERY-brTable1 tt-int_usuar_mestre.cod_usuario ~
tt-int_usuar_mestre.cpf tt-int_usuar_mestre.ramal 
&Scoped-define ENABLED-FIELDS-IN-QUERY-brTable1 
&Scoped-define QUERY-STRING-brTable1 FOR EACH tt-int_usuar_mestre NO-LOCK
&Scoped-define OPEN-QUERY-brTable1 OPEN QUERY brTable1 FOR EACH tt-int_usuar_mestre NO-LOCK.
&Scoped-define TABLES-IN-QUERY-brTable1 tt-int_usuar_mestre
&Scoped-define FIRST-TABLE-IN-QUERY-brTable1 tt-int_usuar_mestre
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS brTable1 wZoom _STRUCTURED
  QUERY brTable1 NO-LOCK DISPLAY
      tt-int_usuar_mestre.cod_usuario FORMAT "x(12)":U
      tt-int_usuar_mestre.cpf FORMAT "x(11)":U
      tt-int_usuar_mestre.ramal FORMAT "x(20)":U
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
...
/* Query rebuild information for BROWSE brTable1
     _TblList          = "Temp-Tables.tt-int_usuar_mestre"
     _Options          = "NO-LOCK"
     _FldNameList[1]   = Temp-Tables.tt-int_usuar_mestre.cod_usuario
     _FldNameList[2]   = Temp-Tables.tt-int_usuar_mestre.cpf
     _FldNameList[3]   = Temp-Tables.tt-int_usuar_mestre.ramal
     _Query            is OPENED
*/  /* BROWSE brTable1 */
&ANALYZE-RESUME
...
------------------------------------------------------------------------------*/
    ...
    IF NOT VALID-HANDLE({&hDBOTable1}) OR
       ...
       {&hDBOTable1}:FILE-NAME <> "esbo/boes660.p":U THEN DO:
       
        {btb/btb008za.i1 esbo/boes660.p YES}
        {btb/btb008za.i2 esbo/boes660.p '' {&hDBOTable1}} 
    END.
    
    /*RUN setConstraint<Description> IN {&hDBOTable1} (<pamameters>) NO-ERROR.*/

    RUN openQueryStatic IN {&hDBOTable1} (INPUT "Main").
...
------------------------------------------------------------------------------*/
    ...
    {zoom/openqueries.i &Query="cod_usuario"
                        &PageNumber="1"}
...
------------------------------------------------------------------------------*/
    ...
    CASE pPageNumber:
        WHEN 1 THEN
            ...
            RUN setConstraintCod_usuario IN {&hDBOTable1} (INPUT FnIniRangeCharPage(1, 1),
