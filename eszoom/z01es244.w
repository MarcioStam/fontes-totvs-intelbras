...
*******************************************************************************/
{include/i-prgvrs.i z01es244 1.00.00.000}

CREATE WIDGET-POOL.

/* Preprocessors Definitions ---                                      */
&GLOBAL-DEFINE Program           z01es244
&GLOBAL-DEFINE Version           1.00.00.000

&GLOBAL-DEFINE InitialPage       1
&GLOBAL-DEFINE FolderLabels      Sigla

&GLOBAL-DEFINE Range             NO

&GLOBAL-DEFINE FieldsRangePage1  /*mgesp.ns-sigla.sigla*/
&GLOBAL-DEFINE FieldsAnyKeyPage1 NO

&GLOBAL-DEFINE ttTable1          TTns-sigla
&GLOBAL-DEFINE hDBOTable1        HDBOTTns-sigla
&GLOBAL-DEFINE DBOTable1         ns-sigla
...
&Scoped-define INTERNAL-TABLES ttns-sigla

/* Definitions for BROWSE brTable1                                      */
&Scoped-define FIELDS-IN-QUERY-brTable1 ttns-sigla.codigo ttns-sigla.sigla ~
ttns-sigla.descricao 
&Scoped-define ENABLED-FIELDS-IN-QUERY-brTable1 
&Scoped-define QUERY-STRING-brTable1 FOR EACH ttns-sigla NO-LOCK
&Scoped-define OPEN-QUERY-brTable1 OPEN QUERY brTable1 FOR EACH ttns-sigla NO-LOCK.
&Scoped-define TABLES-IN-QUERY-brTable1 ttns-sigla
&Scoped-define FIRST-TABLE-IN-QUERY-brTable1 ttns-sigla
...
DEFINE VARIABLE fi-fim-sigla AS CHARACTER FORMAT "X(2)" INITIAL "zz" 
     VIEW-AS FILL-IN 
     SIZE 9 BY .88.

DEFINE VARIABLE fi-ini-sigla AS CHARACTER FORMAT "X(2)" 
     LABEL "Sigla":R17 
     VIEW-AS FILL-IN 
     SIZE 9 BY .88.
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS brTable1 wZoom _STRUCTURED
  QUERY brTable1 NO-LOCK DISPLAY
      ttns-sigla.codigo FORMAT "999":U
      ttns-sigla.sigla COLUMN-LABEL "Sigla" FORMAT "x(2)":U
      ttns-sigla.descricao FORMAT "x(40)":U
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
...
DEFINE FRAME fPage1
     fi-ini-sigla AT ROW 1.5 COL 21 COLON-ALIGNED
     fi-fim-sigla AT ROW 1.5 COL 45 COLON-ALIGNED NO-LABEL
...
/* Query rebuild information for BROWSE brTable1
     _TblList          = "Temp-Tables.ttns-sigla"
     _Options          = "NO-LOCK"
     _FldNameList[1]   > Temp-Tables.ttns-sigla.codigo
"codigo" ? "999" "integer" ? ? ? ? ? ? no ? no no ? yes no no "U" "" ""
     _FldNameList[2]   > Temp-Tables.ttns-sigla.sigla
"sigla" "Sigla" ? "character" ? ? ? ? ? ? no ? no no ? yes no no "U" "" ""
     _FldNameList[3]   = Temp-Tables.ttns-sigla.descricao
     _Query            is OPENED
*/  /* BROWSE brTable1 */
&ANALYZE-RESUME
...
------------------------------------------------------------------------------*/
    ...
    DISP fi-ini-sigla fi-fim-sigla WITH FRAME fPage1.
    ENABLE fi-ini-sigla fi-fim-sigla btCheck WITH FRAME fPage1.
    APPLY "choose" TO btCheck IN FRAME fPage1.
    APPLY "entry" TO fi-ini-sigla IN FRAME fPage1.
...
------------------------------------------------------------------------------*/
    ...
    IF NOT VALID-HANDLE({&hDBOTable1}) OR
       ...
       {&hDBOTable1}:FILE-NAME <> "esbo/boes244.p":U THEN DO:
       
        {btb/btb008za.i1 esbo/boes244.p YES}
        {btb/btb008za.i2 esbo/boes244.p '' {&hDBOTable1}} 
    END.
...
------------------------------------------------------------------------------*/
    ...
    IF AVAILABLE {&ttTable1} THEN DO:
        CASE pcField:
            WHEN "sigla":U THEN
                ASSIGN pcFieldValue = STRING({&ttTable1}.sigla).
