...
*******************************************************************************/
{include/i-prgvrs.i Z01ES564 2.04.00.001}

CREATE WIDGET-POOL.

/* Preprocessors Definitions ---                                      */
&GLOBAL-DEFINE Program           Z01ES564
&GLOBAL-DEFINE Version           2.04.00.001

&GLOBAL-DEFINE InitialPage       1
&GLOBAL-DEFINE FolderLabels      Cartoes

&GLOBAL-DEFINE Range             YES

&GLOBAL-DEFINE FieldsRangePage1  mgesp.correios-cartao.nr-cartao,mgesp.correios-cartao.ct-codigo
&GLOBAL-DEFINE FieldsAnyKeyPage1 no,no

&GLOBAL-DEFINE ttTable1          tt-correios-cartao
&GLOBAL-DEFINE hDBOTable1        h-boes564
&GLOBAL-DEFINE DBOTable1         correios-cartao
...
&Scoped-define INTERNAL-TABLES tt-correios-cartao

/* Definitions for BROWSE brTable1                                      */
&Scoped-define FIELDS-IN-QUERY-brTable1 tt-correios-cartao.nr-cartao ~
tt-correios-cartao.ct-codigo fn-desc-conta() @ c-desc-conta 
&Scoped-define ENABLED-FIELDS-IN-QUERY-brTable1 
&Scoped-define QUERY-STRING-brTable1 FOR EACH tt-correios-cartao NO-LOCK
&Scoped-define OPEN-QUERY-brTable1 OPEN QUERY brTable1 FOR EACH tt-correios-cartao NO-LOCK.
&Scoped-define TABLES-IN-QUERY-brTable1 tt-correios-cartao
&Scoped-define FIRST-TABLE-IN-QUERY-brTable1 tt-correios-cartao
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _FUNCTION-FORWARD fn-desc-conta wZoom 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS brTable1 wZoom _STRUCTURED
  QUERY brTable1 NO-LOCK DISPLAY
      tt-correios-cartao.nr-cartao FORMAT "x(20)":U
      tt-correios-cartao.ct-codigo FORMAT "x(8)":U
      fn-desc-conta() @ c-desc-conta COLUMN-LABEL "Descricao" FORMAT "x(30)":U
            WIDTH 30
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ROW-MARKERS SEPARATORS SIZE 82 BY 12.08
         FONT 2.
...
/* Query rebuild information for BROWSE brTable1
     _TblList          = "Temp-Tables.tt-correios-cartao"
     _Options          = "NO-LOCK"
     _TblOptList       = ", FIRST, FIRST"
     _FldNameList[1]   = Temp-Tables.tt-correios-cartao.nr-cartao
     _FldNameList[2]   = Temp-Tables.tt-correios-cartao.ct-codigo
     _FldNameList[3]   > "_<CALC>"
"fn-desc-conta() @ c-desc-conta" "Descricao" "x(30)" ? ? ? ? ? ? ? no ? no no "30" yes no no "U" "" ""
     _Query            is OPENED
*/  /* BROWSE brTable1 */
&ANALYZE-RESUME
...
------------------------------------------------------------------------------*/
    ...
    IF NOT VALID-HANDLE({&hDBOTable1}) OR
       ...
       {&hDBOTable1}:FILE-NAME <> "esbo/boes564.p":U THEN DO:
       
        {btb/btb008za.i1 esbo/boes564.p YES}
        {btb/btb008za.i2 esbo/boes564.p '' {&hDBOTable1}} 
    END.
    
    RUN setConstraintZoom1 IN {&hDBOTable1} (input "", 
                                             input "ZZZ",
                                             input "00000000",
                                             input "99999999") NO-ERROR.
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _FUNCTION fn-desc-conta wZoom 
FUNCTION fn-desc-conta RETURNS CHARACTER
...
------------------------------------------------------------------------------*/
    ...
    IF AVAIL tt-correios-cartao THEN DO:  
      ...
      /*
      FIND FIRST conta NO-LOCK WHERE
                 conta.ct-codigo = tt-correios-cartao.ct-codigo NO-ERROR.
      IF AVAIL conta THEN 
         RETURN conta.titulo. 
      ELSE 
      RETURN "".
      */
        ...
        ASSIGN v_cod_cta_ctbl = tt-correios-cartao.ct-codigo.
