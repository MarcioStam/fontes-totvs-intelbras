...
*******************************************************************************/
{include/i-prgvrs.i Z01ES665 2.00.00.000}
...
&GLOBAL-DEFINE Program           Z01ES665
&GLOBAL-DEFINE Version           2.00.00.000

&GLOBAL-DEFINE InitialPage       1
&GLOBAL-DEFINE FolderLabels      Categoria

&GLOBAL-DEFINE Range             YES

&GLOBAL-DEFINE FieldsRangePage1  mgesp.aq-categoria.nr-seq-categoria,mgesp.aq-categoria.des-categoria
&GLOBAL-DEFINE FieldsAnyKeyPage1 NO,NO

&GLOBAL-DEFINE ttTable1          tt-aq-categoria
&GLOBAL-DEFINE hDBOTable1        h-boes665
&GLOBAL-DEFINE DBOTable1         aq-categoria
...
&Scoped-define INTERNAL-TABLES tt-aq-categoria

/* Definitions for BROWSE brTable1                                      */
&Scoped-define FIELDS-IN-QUERY-brTable1 tt-aq-categoria.des-categoria ~
tt-aq-categoria.nr-seq-categoria tt-aq-categoria.peso 
&Scoped-define ENABLED-FIELDS-IN-QUERY-brTable1 
&Scoped-define QUERY-STRING-brTable1 FOR EACH tt-aq-categoria NO-LOCK ~
    BY tt-aq-categoria.des-categoria
&Scoped-define OPEN-QUERY-brTable1 OPEN QUERY brTable1 FOR EACH tt-aq-categoria NO-LOCK ~
    BY tt-aq-categoria.des-categoria.
&Scoped-define TABLES-IN-QUERY-brTable1 tt-aq-categoria
&Scoped-define FIRST-TABLE-IN-QUERY-brTable1 tt-aq-categoria
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS brTable1 wZoom _STRUCTURED
  QUERY brTable1 NO-LOCK DISPLAY
      tt-aq-categoria.des-categoria FORMAT "x(50)":U
      tt-aq-categoria.nr-seq-categoria FORMAT ">>>>>9":U
      tt-aq-categoria.peso FORMAT ">>>,>>>,>>9.9999":U
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
...
DEFINE FRAME fPage1
     btCheck1 AT ROW 2.25 COL 74 WIDGET-ID 2
...
/* Query rebuild information for BROWSE brTable1
     _TblList          = "Temp-Tables.tt-aq-categoria"
     _Options          = "NO-LOCK"
     _OrdList          = "Temp-Tables.tt-aq-categoria.des-categoria|yes"
     _FldNameList[1]   = Temp-Tables.tt-aq-categoria.des-categoria
     _FldNameList[2]   = Temp-Tables.tt-aq-categoria.nr-seq-categoria
     _FldNameList[3]   = Temp-Tables.tt-aq-categoria.peso
     _Query            is OPENED
*/  /* BROWSE brTable1 */
&ANALYZE-RESUME
...
DO:
    {zoom/implant.i &ProgramImplant="esp\aqp\esaqp005.w"
                    &PageNumber="1"}
END.
...
------------------------------------------------------------------------------*/
    ...
    IF NOT VALID-HANDLE({&hDBOTable1}) OR
       ...
       {&hDBOTable1}:FILE-NAME <> "esbo/boes665.p":U THEN DO:
       
        {btb/btb008za.i1 esbo/boes665.p YES}
        {btb/btb008za.i2 esbo/boes665.p '' {&hDBOTable1}} 
    END.
...
------------------------------------------------------------------------------*/
    ...
    {zoom/openqueries.i &Query="Categoria"
                        &PageNumber="1"}
...
------------------------------------------------------------------------------*/
    ...
    IF AVAILABLE {&ttTable1} THEN DO:
        CASE pcField:
            WHEN "nr-seq-categoria":U THEN
                ASSIGN pcFieldValue = STRING({&ttTable1}.nr-seq-categoria).
            WHEN "des-categoria" THEN
                ASSIGN pcFieldValue = STRING({&ttTable1}.des-categoria).
        END CASE.
    END.
...
------------------------------------------------------------------------------*/
    ...
    CASE pPageNumber:
        WHEN 1 THEN
            ...
            RUN setConstraintCategoria IN {&hDBOTable1} (INPUT FnIniRangeIntPage(1,1),
