...
*******************************************************************************/
{include/i-prgvrs.i z01es452 2.04.00.000}

CREATE WIDGET-POOL.

/* Preprocessors Definitions ---                                      */
&GLOBAL-DEFINE Program           z01es452
&GLOBAL-DEFINE Version           2.04.00.000

&GLOBAL-DEFINE InitialPage       1
&GLOBAL-DEFINE FolderLabels      Tipo Acordo

&GLOBAL-DEFINE Range             NO
&GLOBAL-DEFINE ttTable1          tt-tipo-acordo
&GLOBAL-DEFINE hDBOTable1        hboes452
&GLOBAL-DEFINE DBOTable1         tt-tipo-acordo
...
&Scoped-define INTERNAL-TABLES tt-tipo-acordo

/* Definitions for BROWSE brTable1                                      */
&Scoped-define FIELDS-IN-QUERY-brTable1 tt-tipo-acordo.codigo ~
tt-tipo-acordo.descricao 
&Scoped-define ENABLED-FIELDS-IN-QUERY-brTable1 
&Scoped-define QUERY-STRING-brTable1 FOR EACH tt-tipo-acordo NO-LOCK
&Scoped-define OPEN-QUERY-brTable1 OPEN QUERY brTable1 FOR EACH tt-tipo-acordo NO-LOCK.
&Scoped-define TABLES-IN-QUERY-brTable1 tt-tipo-acordo
&Scoped-define FIRST-TABLE-IN-QUERY-brTable1 tt-tipo-acordo
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS brTable1 wZoom _STRUCTURED
  QUERY brTable1 NO-LOCK DISPLAY
      tt-tipo-acordo.codigo FORMAT ">>>>9":U WIDTH 8.43
      tt-tipo-acordo.descricao FORMAT "x(40)":U WIDTH 69.86
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
...
/* Query rebuild information for BROWSE brTable1
     _TblList          = "Temp-Tables.tt-tipo-acordo"
     _Options          = "NO-LOCK"
     _TblOptList       = ", FIRST USED"
     _FldNameList[1]   > Temp-Tables.tt-tipo-acordo.codigo
"codigo" ? ? "integer" ? ? ? ? ? ? no ? no no "8.43" yes no no "U" "" ""
     _FldNameList[2]   > Temp-Tables.tt-tipo-acordo.descricao
"descricao" ? ? "character" ? ? ? ? ? ? no ? no no "69.86" yes no no "U" "" ""
     _Query            is OPENED
*/  /* BROWSE brTable1 */
&ANALYZE-RESUME
...
------------------------------------------------------------------------------*/
    ...
    IF NOT VALID-HANDLE({&hDBOTable1}) OR
       ...
       {&hDBOTable1}:FILE-NAME <> "esbo/boes452.p":U THEN DO:
       
        {btb/btb008za.i1 esbo/boes452.p YES}
        {btb/btb008za.i2 esbo/boes452.p '' {&hDBOTable1}} 
    END.
