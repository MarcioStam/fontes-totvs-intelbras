...
*******************************************************************************/
{include/i-prgvrs.i z01es436 1.00.00.000}

CREATE WIDGET-POOL.

/* Preprocessors Definitions ---                                      */
&GLOBAL-DEFINE Program           z01es436
&GLOBAL-DEFINE Version           1.00.00.000

&GLOBAL-DEFINE InitialPage       1
&GLOBAL-DEFINE FolderLabels      Itens B2C

&GLOBAL-DEFINE Range             YES

&GLOBAL-DEFINE FieldsRangePage1  mgesp.item-estab-b2c.cod-estabel,mgesp.item-estab-b2c.it-codigo
&GLOBAL-DEFINE FieldsRangePage2  

&GLOBAL-DEFINE FieldsAnyKeyPage1 NO,no
&GLOBAL-DEFINE FieldsAnyKeyPage2 

&GLOBAL-DEFINE ttTable1          ttitem-estab-b2c
&GLOBAL-DEFINE hDBOTable1        hDBOItem-estab-b2c
&GLOBAL-DEFINE DBOTable1         item-estab-b2c
...
&Scoped-define INTERNAL-TABLES ttitem-estab-b2c item

/* Definitions for BROWSE brTable1                                      */
&Scoped-define FIELDS-IN-QUERY-brTable1 ttitem-estab-b2c.cod-estabel ~
ttitem-estab-b2c.it-codigo ttitem-estab-b2c.ind-aceita-saldao ~
item.desc-item 
&Scoped-define ENABLED-FIELDS-IN-QUERY-brTable1 
&Scoped-define QUERY-STRING-brTable1 FOR EACH ttitem-estab-b2c NO-LOCK, ~
      FIRST item OF ttitem-estab-b2c NO-LOCK
&Scoped-define OPEN-QUERY-brTable1 OPEN QUERY brTable1 FOR EACH ttitem-estab-b2c NO-LOCK, ~
      FIRST item OF ttitem-estab-b2c NO-LOCK.
&Scoped-define TABLES-IN-QUERY-brTable1 ttitem-estab-b2c item
&Scoped-define FIRST-TABLE-IN-QUERY-brTable1 ttitem-estab-b2c
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS brTable1 wZoom _STRUCTURED
  QUERY brTable1 NO-LOCK DISPLAY
      ttitem-estab-b2c.cod-estabel COLUMN-LABEL "Est" FORMAT "x(3)":U
            WIDTH 3.43
      ttitem-estab-b2c.it-codigo FORMAT "x(16)":U WIDTH 13.43
      ttitem-estab-b2c.ind-aceita-saldao FORMAT "yes/no":U
...
/* Query rebuild information for BROWSE brTable1
     _TblList          = "Temp-Tables.ttitem-estab-b2c,mgcad.item OF Temp-Tables.ttitem-estab-b2c"
     _Options          = "NO-LOCK"
     _TblOptList       = ", FIRST, FIRST"
     _FldNameList[1]   > Temp-Tables.ttitem-estab-b2c.cod-estabel
"Temp-Tables.ttitem-estab-b2c.cod-estabel" "Est" ? "character" ? ? ? ? ? ? no ? no no "3.43" yes no no "U" "" ""
     _FldNameList[2]   > Temp-Tables.ttitem-estab-b2c.it-codigo
"Temp-Tables.ttitem-estab-b2c.it-codigo" ? ? "character" ? ? ? ? ? ? no ? no no "13.43" yes no no "U" "" ""
     _FldNameList[3]   = Temp-Tables.ttitem-estab-b2c.ind-aceita-saldao
...
------------------------------------------------------------------------------*/
    ...
    IF NOT VALID-HANDLE({&hDBOTable1}) OR
       ...
       {&hDBOTable1}:FILE-NAME <> "espdp047":U THEN DO:
       
        {btb/btb008za.i1 esbo/boes436.p YES}
        {btb/btb008za.i2 esbo/boes436.p '' {&hDBOTable1}} 
    END.
...
------------------------------------------------------------------------------*/
    ...
    IF AVAILABLE ttitem-estab-b2c THEN DO:
        CASE pcField:
            WHEN "cod-estabel":U THEN
                ASSIGN pcFieldValue = STRING(ttitem-estab-b2c.cod-estabel).
            WHEN "it-codigo":U THEN
                ASSIGN pcFieldValue = STRING(ttitem-estab-b2c.it-codigo).
        END CASE.
    END.
