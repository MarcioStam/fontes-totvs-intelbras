...
DEFINE TEMP-TABLE ttponto-extra NO-UNDO LIKE ponto-extra
...
*******************************************************************************/
{include/i-prgvrs.i z01es545 2.04.00.000}

CREATE WIDGET-POOL.

/* Preprocessors Definitions ---                                      */
&GLOBAL-DEFINE Program           z01es545
...
&GLOBAL-DEFINE FieldsRangePage1  mgesp.ponto-extra.cpf-cnpj,mgesp.ponto-extra.data-movto,mgesp.ponto-extra.sequencia
&GLOBAL-DEFINE FieldsAnyKeyPage1 NO,NO,NO

&GLOBAL-DEFINE ttTable1          ttponto-extra
&GLOBAL-DEFINE hDBOTable1        hboes545
&GLOBAL-DEFINE DBOTable1         ponto-extra
...
&Scoped-define INTERNAL-TABLES ttponto-extra

/* Definitions for BROWSE brTable1                                      */
&Scoped-define FIELDS-IN-QUERY-brTable1 ttponto-extra.cpf-cnpj ~
ttponto-extra.data-movto ttponto-extra.sequencia ttponto-extra.descricao 
&Scoped-define ENABLED-FIELDS-IN-QUERY-brTable1 
&Scoped-define QUERY-STRING-brTable1 FOR EACH ttponto-extra NO-LOCK
&Scoped-define OPEN-QUERY-brTable1 OPEN QUERY brTable1 FOR EACH ttponto-extra NO-LOCK.
&Scoped-define TABLES-IN-QUERY-brTable1 ttponto-extra
&Scoped-define FIRST-TABLE-IN-QUERY-brTable1 ttponto-extra
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS brTable1 wZoom _STRUCTURED
  QUERY brTable1 NO-LOCK DISPLAY
      ttponto-extra.cpf-cnpj FORMAT "x(16)":U
      ttponto-extra.data-movto FORMAT "99/99/9999":U
      ttponto-extra.sequencia FORMAT ">>>>>>>>9":U
      ttponto-extra.descricao FORMAT "x(60)":U
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
...
/* Settings for THIS-PROCEDURE
   ...
   Temp-Tables and Buffers:
      TABLE: ttponto-extra T "?" NO-UNDO mgesp ponto-extra
      ADDITIONAL-FIELDS:
          field r-rowid as rowid
      END-FIELDS.
   END-TABLES.
...
/* Query rebuild information for BROWSE brTable1
     _TblList          = "Temp-Tables.ttponto-extra"
     _Options          = "NO-LOCK"
     _FldNameList[1]   = Temp-Tables.ttponto-extra.cpf-cnpj
     _FldNameList[2]   = Temp-Tables.ttponto-extra.data-movto
     _FldNameList[3]   = Temp-Tables.ttponto-extra.sequencia
     _FldNameList[4]   = Temp-Tables.ttponto-extra.descricao
     _Query            is OPENED
*/  /* BROWSE brTable1 */
&ANALYZE-RESUME
...
------------------------------------------------------------------------------*/
    ...
    IF NOT VALID-HANDLE({&hDBOTable1}) OR
       ...
       {&hDBOTable1}:FILE-NAME <> "esbo/boes545.p":U THEN DO:
       
        {btb/btb008za.i1 esbo/boes545.p YES}
        {btb/btb008za.i2 esbo/boes545.p '' {&hDBOTable1}} 
    END.
