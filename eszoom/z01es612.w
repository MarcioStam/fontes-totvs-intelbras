...
DEFINE TEMP-TABLE tt-modelo-etiq2 NO-UNDO LIKE modelo-etiq
       field r-rowid as rowid.
...
*******************************************************************************/
{include/i-prgvrs.i Z01ES612 2.00.00.000}

CREATE WIDGET-POOL.

/* Preprocessors Definitions ---                                      */
&GLOBAL-DEFINE Program           z01ES612   
...
&GLOBAL-DEFINE FieldsRangePage1  mgesp.modelo-etiq.cod-modelo
&GLOBAL-DEFINE FieldsRangePage2  mgesp.modelo-etiq.descricao
&GLOBAL-DEFINE FieldsAnyKeyPage1 NO
&GLOBAL-DEFINE FieldsAnyKeyPage2 NO

&GLOBAL-DEFINE ttTable1          tt-modelo-etiq
&GLOBAL-DEFINE hDBOTable1        h-boes612
&GLOBAL-DEFINE DBOTable1         modelo-etiq

&GLOBAL-DEFINE ttTable2          tt-modelo-etiq2
&GLOBAL-DEFINE hDBOTable2        h-boes612-2
&GLOBAL-DEFINE DBOTable2         modelo-etiq
...
&Scoped-define INTERNAL-TABLES tt-modelo-etiq tt-modelo-etiq2

/* Definitions for BROWSE brTable1                                      */
&Scoped-define FIELDS-IN-QUERY-brTable1 tt-modelo-etiq.cod-modelo ~
tt-modelo-etiq.descricao tt-modelo-etiq.usu-resp 
&Scoped-define ENABLED-FIELDS-IN-QUERY-brTable1 
&Scoped-define QUERY-STRING-brTable1 FOR EACH tt-modelo-etiq NO-LOCK
&Scoped-define OPEN-QUERY-brTable1 OPEN QUERY brTable1 FOR EACH tt-modelo-etiq NO-LOCK.
&Scoped-define TABLES-IN-QUERY-brTable1 tt-modelo-etiq
&Scoped-define FIRST-TABLE-IN-QUERY-brTable1 tt-modelo-etiq


/* Definitions for BROWSE brTable2                                      */
&Scoped-define FIELDS-IN-QUERY-brTable2 tt-modelo-etiq2.cod-modelo ~
tt-modelo-etiq2.descricao tt-modelo-etiq2.usu-resp tt-modelo-etiq2.imagem 
&Scoped-define ENABLED-FIELDS-IN-QUERY-brTable2 
&Scoped-define QUERY-STRING-brTable2 FOR EACH tt-modelo-etiq2 NO-LOCK
&Scoped-define OPEN-QUERY-brTable2 OPEN QUERY brTable2 FOR EACH tt-modelo-etiq2 NO-LOCK.
&Scoped-define TABLES-IN-QUERY-brTable2 tt-modelo-etiq2
&Scoped-define FIRST-TABLE-IN-QUERY-brTable2 tt-modelo-etiq2
...
DEFINE QUERY brTable1 FOR 
      tt-modelo-etiq SCROLLING.

DEFINE QUERY brTable2 FOR 
      tt-modelo-etiq2 SCROLLING.
&ANALYZE-RESUME
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS brTable1 wZoom _STRUCTURED
  QUERY brTable1 NO-LOCK DISPLAY
      tt-modelo-etiq.cod-modelo FORMAT "999":U
      tt-modelo-etiq.descricao FORMAT "x(80)":U
      tt-modelo-etiq.usu-resp FORMAT "x(12)":U
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS brTable2 wZoom _STRUCTURED
  QUERY brTable2 NO-LOCK DISPLAY
      tt-modelo-etiq2.cod-modelo FORMAT "999":U
      tt-modelo-etiq2.descricao FORMAT "x(80)":U
      tt-modelo-etiq2.usu-resp FORMAT "x(12)":U
      tt-modelo-etiq2.imagem FORMAT "x(80)":U
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ROW-MARKERS SEPARATORS SIZE 82 BY 10.67
         FONT 2.
...
/* Settings for THIS-PROCEDURE
   ...
   Temp-Tables and Buffers:
      ...
      ADDITIONAL-FIELDS:
          field r-rowid as rowid
      END-FIELDS.
      TABLE: tt-modelo-etiq2 T "?" NO-UNDO mgesp modelo-etiq
      ADDITIONAL-FIELDS:
          field r-rowid as rowid
      END-FIELDS.
   END-TABLES.
...
/* Query rebuild information for BROWSE brTable1
     _TblList          = "Temp-Tables.tt-modelo-etiq"
     _Options          = "NO-LOCK"
     _FldNameList[1]   = Temp-Tables.tt-modelo-etiq.cod-modelo
     _FldNameList[2]   = Temp-Tables.tt-modelo-etiq.descricao
     _FldNameList[3]   = Temp-Tables.tt-modelo-etiq.usu-resp
     _Query            is OPENED
*/  /* BROWSE brTable1 */
&ANALYZE-RESUME
...
/* Query rebuild information for BROWSE brTable2
     _TblList          = "Temp-Tables.tt-modelo-etiq2"
     _Options          = "NO-LOCK"
     _FldNameList[1]   = Temp-Tables.tt-modelo-etiq2.cod-modelo
     _FldNameList[2]   = Temp-Tables.tt-modelo-etiq2.descricao
     _FldNameList[3]   = Temp-Tables.tt-modelo-etiq2.usu-resp
     _FldNameList[4]   = Temp-Tables.tt-modelo-etiq2.imagem
     _Query            is OPENED
*/  /* BROWSE brTable2 */
&ANALYZE-RESUME
...
DO:
    {zoom/implant.i &ProgramImplant="esp/cpp/escpp064.w"
                    &PageNumber="1"}
END.
...
------------------------------------------------------------------------------*/
    ...
    IF NOT VALID-HANDLE({&hDBOTable1}) OR
       ...
       {&hDBOTable1}:FILE-NAME <> "esbo/boes612.p":U THEN DO:
       
        {btb/btb008za.i1 esbo/boes612.p YES}
        {btb/btb008za.i2 esbo/boes612.p '' {&hDBOTable1}} 
    END.
    ...
    IF NOT VALID-HANDLE({&hDBOTable2}) OR
       ...
       {&hDBOTable2}:FILE-NAME <> "esbo/boes612.p":U THEN DO:
       
        {btb/btb008za.i1 esbo/boes612.p YES}
        {btb/btb008za.i2 esbo/boes612.p '' {&hDBOTable2}} 
    END.
...
------------------------------------------------------------------------------*/
    ...
    {zoom/openqueries.i &Query="CodModelo"
                        &PageNumber="1"}
...
------------------------------------------------------------------------------*/
    ...
    IF AVAILABLE {&ttTable1} THEN DO:
        CASE pcField:
            WHEN "cod-modelo":U THEN
                ASSIGN pcFieldValue = STRING({&ttTable1}.cod-modelo).
            WHEN "descricao":U THEN
                ASSIGN pcFieldValue = STRING({&ttTable1}.descricao).
            WHEN "tipo":U THEN
                ASSIGN pcFieldValue = STRING({&ttTable1}.tipo).
            WHEN "usu-resp":U THEN
                ASSIGN pcFieldValue = STRING({&ttTable1}.usu-resp).
            WHEN "imagem":U THEN
                ASSIGN pcFieldValue = STRING({&ttTable1}.imagem).
        END CASE.
    END.
...
------------------------------------------------------------------------------*/
    ...
    IF AVAILABLE {&ttTable2} THEN DO:
        CASE pcField:
            WHEN "cod-modelo":U THEN
                ASSIGN pcFieldValue = STRING({&ttTable2}.cod-modelo).
            WHEN "descricao":U THEN
                ASSIGN pcFieldValue = STRING({&ttTable2}.descricao).
            WHEN "tipo":U THEN
                ASSIGN pcFieldValue = STRING({&ttTable2}.tipo).
            WHEN "usu-resp":U THEN
                ASSIGN pcFieldValue = STRING({&ttTable2}.usu-resp).
            WHEN "imagem":U THEN
                ASSIGN pcFieldValue = STRING({&ttTable2}.imagem).
        END CASE.
    END.
...
------------------------------------------------------------------------------*/
    ...
    CASE pPageNumber:
        WHEN 1 THEN
            ...
            RUN setConstraintCodModelo IN {&hDBOTable1} (INPUT fnIniRangeIntPage(INPUT 1, INPUT 1),
