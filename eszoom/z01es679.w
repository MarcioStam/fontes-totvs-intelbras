...
*******************************************************************************/
{include/i-prgvrs.i Z01ES679 2.00.00.000}
...
&GLOBAL-DEFINE Program           Z01ES679
&GLOBAL-DEFINE Version           2.00.00.000

&GLOBAL-DEFINE InitialPage       1
&GLOBAL-DEFINE FolderLabels      Origem Problema

&GLOBAL-DEFINE Range             YES

&GLOBAL-DEFINE FieldsRangePage1  mgesp.aq-origem-prob.nr-seq-orig-prob,mgesp.aq-origem-prob.des-orig-prob
&GLOBAL-DEFINE FieldsAnyKeyPage1 NO,NO

&GLOBAL-DEFINE ttTable1          tt-aq-origem-prob
&GLOBAL-DEFINE hDBOTable1        h-boes679
&GLOBAL-DEFINE DBOTable1         aq-origem-prob
...
&Scoped-define INTERNAL-TABLES tt-aq-origem-prob

/* Definitions for BROWSE brTable1                                      */
&Scoped-define FIELDS-IN-QUERY-brTable1 tt-aq-origem-prob.des-orig-prob ~
tt-aq-origem-prob.nr-seq-orig-prob 
&Scoped-define ENABLED-FIELDS-IN-QUERY-brTable1 
&Scoped-define QUERY-STRING-brTable1 FOR EACH tt-aq-origem-prob ~
      WHERE tt-aq-origem-prob.log-inativo = no NO-LOCK
&Scoped-define OPEN-QUERY-brTable1 OPEN QUERY brTable1 FOR EACH tt-aq-origem-prob ~
      WHERE tt-aq-origem-prob.log-inativo = no NO-LOCK.
&Scoped-define TABLES-IN-QUERY-brTable1 tt-aq-origem-prob
&Scoped-define FIRST-TABLE-IN-QUERY-brTable1 tt-aq-origem-prob
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS brTable1 wZoom _STRUCTURED
  QUERY brTable1 NO-LOCK DISPLAY
      tt-aq-origem-prob.des-orig-prob FORMAT "x(50)":U
      tt-aq-origem-prob.nr-seq-orig-prob FORMAT ">>>>>9":U
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
...
/* Query rebuild information for BROWSE brTable1
     _TblList          = "Temp-Tables.tt-aq-origem-prob"
     _Options          = "NO-LOCK"
     _Where[1]         = "Temp-Tables.tt-aq-origem-prob.log-inativo = no"
     _FldNameList[1]   = Temp-Tables.tt-aq-origem-prob.des-orig-prob
     _FldNameList[2]   = Temp-Tables.tt-aq-origem-prob.nr-seq-orig-prob
     _Query            is OPENED
*/  /* BROWSE brTable1 */
&ANALYZE-RESUME
...
DO:
    {zoom/implant.i &ProgramImplant="esp\aqp\esaqp003.w"
                    &PageNumber="1"}
END.
...
------------------------------------------------------------------------------*/
    ...
    IF NOT VALID-HANDLE({&hDBOTable1}) OR
       ...
       {&hDBOTable1}:FILE-NAME <> "esbo/boes679.p":U THEN DO:
       
        {btb/btb008za.i1 esbo/boes679.p YES}
        {btb/btb008za.i2 esbo/boes679.p '' {&hDBOTable1}} 
    END.
...
------------------------------------------------------------------------------*/
    ...
    IF AVAILABLE {&ttTable1} THEN DO:
        CASE pcField:
            WHEN "nr-seq-orig-prob":U THEN
                ASSIGN pcFieldValue = STRING({&ttTable1}.nr-seq-orig-prob).
            WHEN "des-orig-prob" THEN
                ASSIGN pcFieldValue = STRING({&ttTable1}.des-orig-prob).
