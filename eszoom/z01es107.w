...
*******************************************************************************/
{include/i-prgvrs.i z01es107 1.00.00.000}

CREATE WIDGET-POOL.

/* Preprocessors Definitions ---                                      */
&GLOBAL-DEFINE Program           z01es107
&GLOBAL-DEFINE Version           1.00.00.000

&GLOBAL-DEFINE InitialPage       1
&GLOBAL-DEFINE FolderLabels      Etiquetas EPROM
...
&GLOBAL-DEFINE ttTable1          TTitem-ean
&GLOBAL-DEFINE hDBOTable1        HDBOTTitem-ean
&GLOBAL-DEFINE DBOTable1         item-ean
...
&Scoped-define INTERNAL-TABLES ttitem-ean

/* Definitions for BROWSE brTable1                                      */
&Scoped-define FIELDS-IN-QUERY-brTable1 ttitem-ean.descricao ~
ttitem-ean.it-codigo 
&Scoped-define ENABLED-FIELDS-IN-QUERY-brTable1 
&Scoped-define QUERY-STRING-brTable1 FOR EACH ttitem-ean NO-LOCK
&Scoped-define OPEN-QUERY-brTable1 OPEN QUERY brTable1 FOR EACH ttitem-ean NO-LOCK.
&Scoped-define TABLES-IN-QUERY-brTable1 ttitem-ean
&Scoped-define FIRST-TABLE-IN-QUERY-brTable1 ttitem-ean
...
DEFINE VARIABLE fi-fim-descricao AS CHARACTER FORMAT "X(15)" INITIAL "zzzzzzzzzzzzzzz" 
     VIEW-AS FILL-IN 
     SIZE 16 BY .88.
...
DEFINE VARIABLE fi-ini-descricao AS CHARACTER FORMAT "X(15)" 
     LABEL "Descri‡Æo":R17 
     VIEW-AS FILL-IN 
     SIZE 16 BY .88.
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS brTable1 wZoom _STRUCTURED
  QUERY brTable1 NO-LOCK DISPLAY
      ttitem-ean.descricao FORMAT "x(15)":U
      ttitem-ean.it-codigo FORMAT "x(16)":U
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
...
/* SETTINGS FOR FRAME fPage1
                                                                        */
/* BROWSE-TAB brTable1 fi-fim-descricao fPage1 */
/* SETTINGS FOR FILL-IN fi-fim-descricao IN FRAME fPage1
   ALIGN-L                                                              */
/* SETTINGS FOR FILL-IN fi-ini-descricao IN FRAME fPage1
   ALIGN-L                                                              */
...
/* Query rebuild information for BROWSE brTable1
     _TblList          = "Temp-Tables.ttitem-ean"
     _Options          = "NO-LOCK"
     _FldNameList[1]   = Temp-Tables.ttitem-ean.descricao
     _FldNameList[2]   = Temp-Tables.ttitem-ean.it-codigo
     _Query            is OPENED
*/  /* BROWSE brTable1 */
&ANALYZE-RESUME
...
DO:
  ASSIGN INPUT FRAME fpage1
         fi-ini-it-codigo fi-fim-it-codigo fi-ini-descricao fi-fim-descricao.
...
------------------------------------------------------------------------------*/
    ...
    DISP fi-ini-it-codigo fi-fim-it-codigo fi-ini-descricao fi-fim-descricao WITH FRAME fPage1.
    ENABLE fi-ini-it-codigo fi-fim-it-codigo fi-ini-descricao fi-fim-descricao btCheck WITH FRAME fPage1.
...
------------------------------------------------------------------------------*/
    ...
    IF NOT VALID-HANDLE({&hDBOTable1}) OR
       ...
       {&hDBOTable1}:FILE-NAME <> "esbo/boes107.p":U THEN DO:
       
        {btb/btb008za.i1 esbo/boes107.p YES}
        {btb/btb008za.i2 esbo/boes107.p '' {&hDBOTable1}} 
    END.

    /* A linha abaixo ‚ utilizada para trazer o browse carregado com uma faixa inicial
       pr‚-definida na primeira chamada do programa*/

    RUN setConstraintByCod IN {&hDBOTable1} (INPUT "", INPUT "zzzzzzzzzzzzzzzz", INPUT "", INPUT "zzzzzzzzzzzzzzz").
        ...
        WHEN 1 THEN
            ...
            RUN setConstraintByCod IN {&hDBOTable1} 
                (INPUT fi-ini-it-codigo,
                 ...
                 INPUT fi-ini-descricao,
                 INPUT fi-fim-descricao).
    END CASE.
