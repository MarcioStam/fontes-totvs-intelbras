...
*******************************************************************************/
{include/i-prgvrs.i z01es513 2.06.00.001}

CREATE WIDGET-POOL.

/* Preprocessors Definitions ---                                      */
&GLOBAL-DEFINE Program           z01es513
...
DEFINE VARIABLE cb-selecao AS INTEGER FORMAT "->,>>>,>>9":U INITIAL 0 
     LABEL "Sele‡Æo" 
     VIEW-AS COMBO-BOX INNER-LINES 8
     LIST-ITEM-PAIRS "Familia Comercial",0,
                     "Unidade",1,
                     "Segmento",2,
                     "Familia",3,
                     "Sub-familia",4,
...
DEFINE VARIABLE fi-valor AS CHARACTER FORMAT "X(12)" 
     VIEW-AS FILL-IN 
     SIZE 28 BY .88.
...
DEFINE FRAME fPage1
     btCheck AT ROW 1.17 COL 83 RIGHT-ALIGNED
     cb-selecao AT ROW 1.25 COL 17.72 COLON-ALIGNED WIDGET-ID 2
     fi-valor AT ROW 1.25 COL 34 COLON-ALIGNED NO-LABEL
...
/* SETTINGS FOR FRAME fPage1
                                                                        */
/* BROWSE-TAB brTable1 fi-valor fPage1 */
...
"tt-fam-com-item.fm-cod-com" ? ? "character" ? ? ? ? ? ? no ? no no "11.43" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[2]   > Temp-Tables.tt-fam-com-item.descricao
"tt-fam-com-item.descricao" ? ? "character" ? ? ? ? ? ? no ? no no "40.86" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[3]   > Temp-Tables.tt-fam-com-item.unidade
"tt-fam-com-item.unidade" "Unid" "x(2)" "character" ? ? ? ? ? ? no ? no no "4.57" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[4]   > Temp-Tables.tt-fam-com-item.segmento
"tt-fam-com-item.segmento" "Segm" "x(2)" "character" ? ? ? ? ? ? no ? no no "4.57" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[5]   > Temp-Tables.tt-fam-com-item.familia1
"tt-fam-com-item.familia1" "Fam" ? "character" ? ? ? ? ? ? no ? no no "4.57" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[6]   > Temp-Tables.tt-fam-com-item.familia2
"tt-fam-com-item.familia2" "Sub" "x(2)" "character" ? ? ? ? ? ? no ? no no "4.57" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[7]   > Temp-Tables.tt-fam-com-item.origem
"tt-fam-com-item.origem" "Orig" ? "character" ? ? ? ? ? ? no ? no no "4.57" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _Query            is OPENED
*/  /* BROWSE brTable1 */
&ANALYZE-RESUME
...
DO:
  ASSIGN INPUT FRAME fpage1 cb-selecao fi-valor.
...
------------------------------------------------------------------------------*/
    ...
    DISP cb-selecao fi-valor WITH FRAME fPage1.
    ENABLE cb-selecao fi-valor btCheck WITH FRAME fPage1.
    APPLY "choose" TO btCheck IN FRAME fPage1.
    APPLY "entry" TO fi-valor IN FRAME fPage1.
...
------------------------------------------------------------------------------*/
    ...
    RUN setConstraintZoom IN {&hDBOTable1} (INPUT 6,
                                            INPUT "").
...
------------------------------------------------------------------------------*/
    ...
    CASE pPageNumber:
        WHEN 1 THEN DO:
            RUN setConstraintZoom IN {&hDBOTable1} (INPUT cb-selecao,
                                                    INPUT fi-valor).
