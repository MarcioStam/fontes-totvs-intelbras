...
*******************************************************************************/
{include/i-prgvrs.i z01es503 2.04.00.000}

CREATE WIDGET-POOL.

/* Preprocessors Definitions ---                                      */
&GLOBAL-DEFINE Program           z01es503
...
&GLOBAL-DEFINE ttTable1          tt-tipo-equipamentos
&GLOBAL-DEFINE hDBOTable1        hboes503
&GLOBAL-DEFINE DBOTable1         tt-tipo-equipamentos
...
&Scoped-define INTERNAL-TABLES tt-tipo-equipamentos

/* Definitions for BROWSE brTable1                                      */
&Scoped-define FIELDS-IN-QUERY-brTable1 tt-tipo-equipamentos.codigo ~
tt-tipo-equipamentos.descricao 
&Scoped-define ENABLED-FIELDS-IN-QUERY-brTable1 
&Scoped-define QUERY-STRING-brTable1 FOR EACH tt-tipo-equipamentos NO-LOCK
&Scoped-define OPEN-QUERY-brTable1 OPEN QUERY brTable1 FOR EACH tt-tipo-equipamentos NO-LOCK.
&Scoped-define TABLES-IN-QUERY-brTable1 tt-tipo-equipamentos
&Scoped-define FIRST-TABLE-IN-QUERY-brTable1 tt-tipo-equipamentos
...
DEFINE QUERY brTable1 FOR 
      tt-tipo-equipamentos SCROLLING.
&ANALYZE-RESUME
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS brTable1 wZoom _STRUCTURED
  QUERY brTable1 NO-LOCK DISPLAY
      tt-tipo-equipamentos.codigo FORMAT ">>>>>>9":U WIDTH 9.43
      tt-tipo-equipamentos.descricao FORMAT "x(40)":U WIDTH 68.86
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
...
/* Query rebuild information for BROWSE brTable1
     _TblList          = "Temp-Tables.tt-tipo-equipamentos"
     _Options          = "NO-LOCK"
     _TblOptList       = ", FIRST USED"
     _FldNameList[1]   > Temp-Tables.tt-tipo-equipamentos.codigo
"tt-tipo-equipamentos.codigo" ? ? "integer" ? ? ? ? ? ? no ? no no "9.43" yes no no "U" "" ""
     _FldNameList[2]   > Temp-Tables.tt-tipo-equipamentos.descricao
"tt-tipo-equipamentos.descricao" ? ? "character" ? ? ? ? ? ? no ? no no "68.86" yes no no "U" "" ""
     _Query            is OPENED
*/  /* BROWSE brTable1 */
&ANALYZE-RESUME
...
------------------------------------------------------------------------------*/
    ...
    IF NOT VALID-HANDLE({&hDBOTable1}) OR
       ...
       {&hDBOTable1}:FILE-NAME <> "esbo/boes503.p":U THEN DO:
       
        {btb/btb008za.i1 esbo/boes503.p YES}
        {btb/btb008za.i2 esbo/boes503.p '' {&hDBOTable1}} 
    END.
