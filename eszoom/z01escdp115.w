...
*******************************************************************************/
{include/i-prgvrs.i Z01ESCDP115 9.99.99.999}
...
DEFINE VARIABLE h_b01escdp115 AS HANDLE NO-UNDO.
...
DO:
  {include/i-implan.i esp/cdp/escdp116.w h_b01escdp115}
END.
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'FOLDER-LABELS = ':U + 'Segmento' + ',
                     FOLDER-TAB-TYPE = 1':U ,
             OUTPUT h_folder ).
    ...
    WHEN 1 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'eszoom/b01escdp115.w':U ,
             INPUT  FRAME f-zoom:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_b01escdp115 ).
       RUN set-position IN h_b01escdp115 ( 3.00 , 4.00 ) NO-ERROR.
       /* Size in UIB:  ( 10.17 , 80.14 ) */

       /* Links to SmartBrowser h_b01escdp115. */
       RUN add-link IN adm-broker-hdl ( h_b01escdp115 , 'State':U , THIS-PROCEDURE ).

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_b01escdp115 ,
             h_folder , 'AFTER':U ).
    END. /* Page 1 */
...
------------------------------------------------------------------------------*/
  ...
  {utp/ut9000.i "Z01ESCDP115" "2.00.00.001"}
