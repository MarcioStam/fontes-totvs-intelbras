...
*******************************************************************************/
{include/i-prgvrs.i z01es454 2.04.00.000}

CREATE WIDGET-POOL.

/* Preprocessors Definitions ---                                      */
&GLOBAL-DEFINE Program           z01es454
&GLOBAL-DEFINE Version           2.04.00.000

&GLOBAL-DEFINE InitialPage       1
&GLOBAL-DEFINE FolderLabels      Tipo Verba

&GLOBAL-DEFINE Range             NO
&GLOBAL-DEFINE ttTable1          tt-tipo-verba
&GLOBAL-DEFINE hDBOTable1        hboes454
&GLOBAL-DEFINE DBOTable1         tt-tipo-verba
...
&Scoped-define INTERNAL-TABLES tt-tipo-verba

/* Definitions for BROWSE brTable1                                      */
&Scoped-define FIELDS-IN-QUERY-brTable1 tt-tipo-verba.codigo ~
tt-tipo-verba.descricao 
&Scoped-define ENABLED-FIELDS-IN-QUERY-brTable1 
&Scoped-define QUERY-STRING-brTable1 FOR EACH tt-tipo-verba NO-LOCK
&Scoped-define OPEN-QUERY-brTable1 OPEN QUERY brTable1 FOR EACH tt-tipo-verba NO-LOCK.
&Scoped-define TABLES-IN-QUERY-brTable1 tt-tipo-verba
&Scoped-define FIRST-TABLE-IN-QUERY-brTable1 tt-tipo-verba
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS brTable1 wZoom _STRUCTURED
  QUERY brTable1 NO-LOCK DISPLAY
      tt-tipo-verba.codigo FORMAT ">>>>9":U WIDTH 8.43
      tt-tipo-verba.descricao FORMAT "x(40)":U WIDTH 69.86
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
...
/* Query rebuild information for BROWSE brTable1
     _TblList          = "Temp-Tables.tt-tipo-verba"
     _Options          = "NO-LOCK"
     _TblOptList       = ", FIRST USED"
     _FldNameList[1]   > Temp-Tables.tt-tipo-verba.codigo
"codigo" ? ? "integer" ? ? ? ? ? ? no ? no no "8.43" yes no no "U" "" ""
     _FldNameList[2]   > Temp-Tables.tt-tipo-verba.descricao
...
------------------------------------------------------------------------------*/
    ...
    IF NOT VALID-HANDLE({&hDBOTable1}) OR
       ...
       {&hDBOTable1}:FILE-NAME <> "esbo/boes454.p":U THEN DO:
       
        {btb/btb008za.i1 esbo/boes454.p YES}
        {btb/btb008za.i2 esbo/boes454.p '' {&hDBOTable1}} 
    END.
