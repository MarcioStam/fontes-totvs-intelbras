...
*******************************************************************************/
{include/i-prgvrs.i Z01ES659 1.00.00.000}
...
&GLOBAL-DEFINE Program           Z01ES659
&GLOBAL-DEFINE Version           1.00.00.000

&GLOBAL-DEFINE InitialPage       1
&GLOBAL-DEFINE FolderLabels      Origens

&GLOBAL-DEFINE Range             YES

&GLOBAL-DEFINE FieldsRangePage1  mgesp.origem-mqa.origem-falha,mgesp.origem-mqa.descricao
&GLOBAL-DEFINE FieldsAnyKeyPage1 YES,YES

&GLOBAL-DEFINE ttTable1          tt-origem-mqa
&GLOBAL-DEFINE hDBOTable1        h-boes659
&GLOBAL-DEFINE DBOTable1         origem-mqa
...
&Scoped-define INTERNAL-TABLES tt-origem-mqa

/* Definitions for BROWSE brTable1                                      */
&Scoped-define FIELDS-IN-QUERY-brTable1 tt-origem-mqa.origem-falha ~
tt-origem-mqa.descricao 
&Scoped-define ENABLED-FIELDS-IN-QUERY-brTable1 
&Scoped-define QUERY-STRING-brTable1 FOR EACH tt-origem-mqa NO-LOCK
&Scoped-define OPEN-QUERY-brTable1 OPEN QUERY brTable1 FOR EACH tt-origem-mqa NO-LOCK.
&Scoped-define TABLES-IN-QUERY-brTable1 tt-origem-mqa
&Scoped-define FIRST-TABLE-IN-QUERY-brTable1 tt-origem-mqa
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS brTable1 wZoom _STRUCTURED
  QUERY brTable1 NO-LOCK DISPLAY
      tt-origem-mqa.origem-falha FORMAT "99":U
      tt-origem-mqa.descricao FORMAT "x(60)":U
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
...
/* Query rebuild information for BROWSE brTable1
     _TblList          = "Temp-Tables.tt-origem-mqa"
     _Options          = "NO-LOCK"
     _FldNameList[1]   = Temp-Tables.tt-origem-mqa.origem-falha
     _FldNameList[2]   = Temp-Tables.tt-origem-mqa.descricao
     _Query            is OPENED
*/  /* BROWSE brTable1 */
&ANALYZE-RESUME
...
DO:
    {zoom/implant.i &ProgramImplant="esp/cpp/escpp089.w"
                    &PageNumber="1"}
END.
...
ENABLE btImplant1 WITH FRAME fPage1.
...
------------------------------------------------------------------------------*/
    ...
    IF NOT VALID-HANDLE({&hDBOTable1}) OR
       ...
       {&hDBOTable1}:FILE-NAME <> "esbo/boes659.p":U THEN DO:
       
        {btb/btb008za.i1 esbo/boes659.p YES}
        {btb/btb008za.i2 esbo/boes659.p '' {&hDBOTable1}} 
    END.
    
    RUN openQueryMain IN {&hDBOTable1} NO-ERROR.
...
------------------------------------------------------------------------------*/
    ...
    {zoom/openqueries.i &Query="ItemDesc"
                        &PageNumber="1"}
...
------------------------------------------------------------------------------*/
    ...
    IF AVAILABLE {&ttTable1} THEN DO:
        CASE pcField:
            WHEN "origem-falha":U THEN
                ASSIGN pcFieldValue = STRING({&ttTable1}.origem-falha).
            WHEN "descricao" THEN
...
------------------------------------------------------------------------------*/
    ...
    CASE pPageNumber:
        WHEN 1 THEN
            ...
            RUN setConstraintItemDesc IN {&hDBOTable1} (INPUT FnIniRangeIntPage(1,1),
