...
DEFINE VARIABLE h_b01int-class-canal AS HANDLE NO-UNDO.
...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW w-pesquisa ASSIGN
         HIDDEN             = YES
         TITLE              = "Pesquisa de Classifica‡Æo"
         HEIGHT             = 16.96
         WIDTH              = 89.72
         MAX-HEIGHT         = 20.54
         MAX-WIDTH          = 106
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'FOLDER-LABELS = ':U + 'Classifica‡Æo' + ',
                     FOLDER-TAB-TYPE = 1':U ,
             OUTPUT h_folder ).
    ...
    WHEN 1 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'esbrw/b01int-class-canal.w':U ,
             INPUT  FRAME f-zoom:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_b01int-class-canal ).
       RUN set-position IN h_b01int-class-canal ( 3.00 , 4.00 ) NO-ERROR.
       /* Size in UIB:  ( 11.96 , 85.72 ) */

       /* Links to SmartBrowser h_b01int-class-canal. */
       RUN add-link IN adm-broker-hdl ( h_b01int-class-canal , 'State':U , THIS-PROCEDURE ).

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_b01int-class-canal ,
             h_folder , 'AFTER':U ).
    END. /* Page 1 */
...
{utp/ut9000.i "z01int-class-canal" "2.00.00.001"}
...
*/
  ...
  {include/win-size.i}
  /*
  run pi-rec-param in h_b01int-class-canal (input l-pend, input l-em-an, input l-pe-ret,
...
-------------------------------------------------------------*/
  RUN esbrw\b01int-class-canal.w.
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE setInitials w-pesquisa 
...
------------------------------------------------------------------------------*/
    ...
    run pi-seta-inicial in h_b01int-class-canal (input p-ini-it-codigo).   
