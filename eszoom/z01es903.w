...
DEFINE TEMP-TABLE ttint-forma-pagto NO-UNDO LIKE int-forma-pagto
...
*******************************************************************************/
{include/i-prgvrs.i z01es903 2.04.00.000}

CREATE WIDGET-POOL.

/* Preprocessors Definitions ---                                      */
&GLOBAL-DEFINE Program           z01es903
&GLOBAL-DEFINE Version           2.04.00.000

&GLOBAL-DEFINE InitialPage       1
&GLOBAL-DEFINE FolderLabels      A‡äes

&GLOBAL-DEFINE Range             NO
&GLOBAL-DEFINE ttTable1          ttint-forma-pagto
&GLOBAL-DEFINE hDBOTable1        hboes903
&GLOBAL-DEFINE DBOTable1         ttint-forma-pagto
...
DEF VAR ini-cod-forma-pagto  LIKE int-forma-pagto.cod-forma-pagto.
DEF VAR fim-cod-forma-pagto  LIKE int-forma-pagto.cod-forma-pagto INIT 999.
...
&Scoped-define INTERNAL-TABLES ttint-forma-pagto

/* Definitions for BROWSE brTable1                                      */
&Scoped-define FIELDS-IN-QUERY-brTable1 ttint-forma-pagto.cod-forma-pagto ttint-forma-pagto.Desc-forma-pagto 
&Scoped-define ENABLED-FIELDS-IN-QUERY-brTable1 
&Scoped-define QUERY-STRING-brTable1 FOR EACH ttint-forma-pagto ~
      WHERE ttint-forma-pagto.cod-forma-pagto >= fi-ini-cod-forma-pagto ~
and ttint-forma-pagto.cod-forma-pagto <= fi-fim-cod-forma-pagto NO-LOCK INDEXED-REPOSITION
&Scoped-define OPEN-QUERY-brTable1 OPEN QUERY brTable1 FOR EACH ttint-forma-pagto ~
      WHERE ttint-forma-pagto.cod-forma-pagto >= fi-ini-cod-forma-pagto ~
and ttint-forma-pagto.cod-forma-pagto <= fi-fim-cod-forma-pagto NO-LOCK INDEXED-REPOSITION.
&Scoped-define TABLES-IN-QUERY-brTable1 ttint-forma-pagto
&Scoped-define FIRST-TABLE-IN-QUERY-brTable1 ttint-forma-pagto
...
DEFINE VARIABLE fi-fim-cod-forma-pagto AS INTEGER FORMAT ">>9" INITIAL 999 
     VIEW-AS FILL-IN 
     SIZE 16.29 BY .88.

DEFINE VARIABLE fi-ini-cod-forma-pagto AS INTEGER FORMAT ">>9" INITIAL 0 
     LABEL "A‡Æo" 
     VIEW-AS FILL-IN 
     SIZE 16.29 BY .88.
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS brTable1 wZoom _STRUCTURED
  QUERY brTable1 NO-LOCK DISPLAY
      ttint-forma-pagto.cod-forma-pagto FORMAT ">>9":U
      ttint-forma-pagto.Desc-forma-pagto FORMAT "X(50)":U
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
...
DEFINE FRAME fPage1
     fi-ini-cod-forma-pagto AT ROW 1.25 COL 12 COLON-ALIGNED
     fi-fim-cod-forma-pagto AT ROW 1.25 COL 52 COLON-ALIGNED NO-LABEL
...
/* Settings for THIS-PROCEDURE
   ...
   Temp-Tables and Buffers:
      TABLE: ttint-forma-pagto T "?" NO-UNDO mgesp int-forma-pagto
      ADDITIONAL-FIELDS:
          field r-rowid as rowid
      END-FIELDS.
   END-TABLES.
...
/* Query rebuild information for BROWSE brTable1
     _TblList          = "Temp-Tables.ttint-forma-pagto"
     _Options          = "NO-LOCK INDEXED-REPOSITION"
     _TblOptList       = ", FIRST USED"
     _Where[1]         = "Temp-Tables.ttint-forma-pagto.cod-forma-pagto >= fi-ini-cod-forma-pagto
and Temp-Tables.ttint-forma-pagto.cod-forma-pagto <= fi-fim-cod-forma-pagto"
     _FldNameList[1]   = Temp-Tables.ttint-forma-pagto.cod-forma-pagto
     _FldNameList[2]   = Temp-Tables.ttint-forma-pagto.Desc-forma-pagto
     _Query            is OPENED
*/  /* BROWSE brTable1 */
&ANALYZE-RESUME
...
DO:
  ASSIGN INPUT FRAME fpage1
         fi-fim-cod-forma-pagto fi-ini-cod-forma-pagto.
  ASSIGN ini-cod-forma-pagto = fi-ini-cod-forma-pagto
         fim-cod-forma-pagto = fi-fim-cod-forma-pagto.
...
------------------------------------------------------------------------------*/
    ...
    DISP fi-fim-cod-forma-pagto fi-ini-cod-forma-pagto WITH FRAME fPage1.
    ENABLE fi-fim-cod-forma-pagto fi-ini-cod-forma-pagto btCheck WITH FRAME fPage1.
    APPLY "choose" TO btCheck IN FRAME fPage1.
    APPLY "entry" TO fi-ini-cod-forma-pagto IN FRAME fPage1.
...
------------------------------------------------------------------------------*/
    ...
    IF NOT VALID-HANDLE({&hDBOTable1}) OR
       ...
       {&hDBOTable1}:FILE-NAME <> "esbo/boes903.p":U THEN DO:
       
        {btb/btb008za.i1 esbo/boes903.p YES}
        {btb/btb008za.i2 esbo/boes903.p '' {&hDBOTable1}} 
    END.
...
------------------------------------------------------------------------------*/
    ...
    {zoom/OpenQueries.i &Query="FaixaFormaPagto"
                        &PageNumber="1"}
...
------------------------------------------------------------------------------*/
    ...
    IF AVAILABLE {&ttTable1} THEN DO:
        CASE pcField:
            WHEN "cod-forma-pagto":U THEN
                ASSIGN pcFieldValue = STRING({&ttTable1}.cod-forma-pagto).
        END CASE.
    END.
...
------------------------------------------------------------------------------*/
    ...
    CASE pPageNumber:
        WHEN 1 THEN
            ...
            RUN setConstraintFaixaFormaPagto IN {&hDBOTable1} (INPUT ini-cod-forma-pagto,
                                                               INPUT fim-cod-forma-pagto).
