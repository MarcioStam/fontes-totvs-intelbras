...
*******************************************************************************/
{include/i-prgvrs.i z01es345 1.00.00.000}

CREATE WIDGET-POOL.

/* Preprocessors Definitions ---                                      */
&GLOBAL-DEFINE Program           z01es345
...
&GLOBAL-DEFINE ttTable1          ttmeta-rep
&GLOBAL-DEFINE hDBOTable1        HDBOTTmeta-rep
&GLOBAL-DEFINE DBOTable1         meta-rep
...
&Scoped-define INTERNAL-TABLES ttmeta-rep repres

/* Definitions for BROWSE brTable1                                      */
&Scoped-define FIELDS-IN-QUERY-brTable1 ttmeta-rep.cod-estabel ~
ttmeta-rep.cod-diretoria ttmeta-rep.cod-gerente ttmeta-rep.cod-rep ~
repres.nome ttmeta-rep.periodo ttmeta-rep.Valor 
&Scoped-define ENABLED-FIELDS-IN-QUERY-brTable1 
&Scoped-define QUERY-STRING-brTable1 FOR EACH ttmeta-rep NO-LOCK, ~
      EACH repres OF ttmeta-rep NO-LOCK
&Scoped-define OPEN-QUERY-brTable1 OPEN QUERY brTable1 FOR EACH ttmeta-rep NO-LOCK, ~
      EACH repres OF ttmeta-rep NO-LOCK.
&Scoped-define TABLES-IN-QUERY-brTable1 ttmeta-rep repres
&Scoped-define FIRST-TABLE-IN-QUERY-brTable1 ttmeta-rep
...
DEFINE VARIABLE c-periodo-fim AS CHARACTER FORMAT "9999/99" INITIAL "9999/31" 
     VIEW-AS FILL-IN 
     SIZE 9 BY .88.

DEFINE VARIABLE c-periodo-ini AS CHARACTER FORMAT "9999/99" INITIAL "0001/01" 
     LABEL "Periodo" 
     VIEW-AS FILL-IN 
     SIZE 9 BY .88.
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS brTable1 wZoom _STRUCTURED
  QUERY brTable1 NO-LOCK DISPLAY
      ttmeta-rep.cod-estabel FORMAT "x(3)":U
      ttmeta-rep.cod-diretoria COLUMN-LABEL "Diretoria" FORMAT "X(3)":U
            WIDTH 6.43
      ttmeta-rep.cod-gerente COLUMN-LABEL "Gerente" FORMAT ">>9":U
            WIDTH 6.43
      ttmeta-rep.cod-rep FORMAT ">>>>9":U WIDTH 6.43
      repres.nome FORMAT "x(40)":U WIDTH 34.43
      ttmeta-rep.periodo FORMAT "9999/99":U WIDTH 8.43
      ttmeta-rep.Valor FORMAT ">>>,>>>,>>9.99":U WIDTH 9.29
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ROW-MARKERS SEPARATORS SIZE 82 BY 6.63
...
DEFINE FRAME fPage1
     fi-ini-cod-estabel AT ROW 1.17 COL 21 COLON-ALIGNED HELP
          "C¢digo do estabelecimento" WIDGET-ID 4
     fi-fim-cod-estabel AT ROW 1.17 COL 45 COLON-ALIGNED NO-LABEL WIDGET-ID 2
     btCheck AT ROW 1.17 COL 77
     fi-ini-cod-diretoria AT ROW 2.13 COL 21 COLON-ALIGNED HELP
          "C¢digo de diretoria"
     fi-fim-cod-diretoria AT ROW 2.13 COL 45 COLON-ALIGNED NO-LABEL
     fi-ini-cod-gerente AT ROW 3.13 COL 11.28
     fi-fim-cod-gerente AT ROW 3.13 COL 47 NO-LABEL
     fi-ini-cod-rep AT ROW 4.13 COL 21 COLON-ALIGNED
     fi-fim-cod-rep AT ROW 4.13 COL 47 NO-LABEL
     c-periodo-ini AT ROW 5.13 COL 21 COLON-ALIGNED WIDGET-ID 12
     c-periodo-fim AT ROW 5.13 COL 47 NO-LABEL WIDGET-ID 10
     brTable1 AT ROW 6.25 COL 2
     btImplant1 AT ROW 13 COL 2
     IMAGE-1 AT ROW 2.13 COL 32
     IMAGE-2 AT ROW 2.13 COL 44
     IMAGE-5 AT ROW 4.13 COL 32
     IMAGE-6 AT ROW 4.13 COL 44
     IMAGE-7 AT ROW 3.13 COL 32
     IMAGE-8 AT ROW 3.13 COL 44
     IMAGE-9 AT ROW 1.17 COL 32 WIDGET-ID 6
     IMAGE-10 AT ROW 1.17 COL 44 WIDGET-ID 8
     IMAGE-11 AT ROW 5.13 COL 32 WIDGET-ID 14
     IMAGE-12 AT ROW 5.13 COL 44 WIDGET-ID 16
...
/* SETTINGS FOR FRAME fPage1
                                                                        */
/* BROWSE-TAB brTable1 c-periodo-fim fPage1 */
/* SETTINGS FOR FILL-IN c-periodo-fim IN FRAME fPage1
   ALIGN-L                                                              */
...
/* Query rebuild information for BROWSE brTable1
     _TblList          = "Temp-Tables.ttmeta-rep,mgcad.repres OF Temp-Tables.ttmeta-rep"
     _Options          = "NO-LOCK"
     _FldNameList[1]   = Temp-Tables.ttmeta-rep.cod-estabel
     _FldNameList[2]   > Temp-Tables.ttmeta-rep.cod-diretoria
"ttmeta-rep.cod-diretoria" "Diretoria" ? "character" ? ? ? ? ? ? no ? no no "6.43" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[3]   > Temp-Tables.ttmeta-rep.cod-gerente
"ttmeta-rep.cod-gerente" "Gerente" ? "integer" ? ? ? ? ? ? no ? no no "6.43" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[4]   > Temp-Tables.ttmeta-rep.cod-rep
"ttmeta-rep.cod-rep" ? ? "integer" ? ? ? ? ? ? no ? no no "6.43" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[5]   > mgcad.repres.nome
"repres.nome" ? ? "character" ? ? ? ? ? ? no ? no no "34.43" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[6]   > Temp-Tables.ttmeta-rep.periodo
"ttmeta-rep.periodo" ? ? "character" ? ? ? ? ? ? no ? no no "8.43" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[7]   > Temp-Tables.ttmeta-rep.Valor
"ttmeta-rep.Valor" ? ? "decimal" ? ? ? ? ? ? no ? no no "9.29" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _Query            is OPENED
*/  /* BROWSE brTable1 */
&ANALYZE-RESUME
...
DO:
  ...
  ASSIGN INPUT FRAME fpage1
      ...
      fi-ini-cod-diretoria 
      fi-fim-cod-diretoria 
      fi-ini-cod-gerente 
      fi-fim-cod-gerente 
      fi-ini-cod-rep 
      fi-fim-cod-rep 
...
------------------------------------------------------------------------------*/
    ...
    DISP fi-ini-cod-estabel 
         ...
         c-periodo-ini
         c-periodo-fim WITH FRAME fPage1.
...
------------------------------------------------------------------------------*/
    ...
    IF AVAILABLE {&ttTable1} THEN DO:
        CASE pcField:
            ...
            WHEN "Valor":U THEN
                ASSIGN pcFieldValue = STRING({&ttTable1}.valor).
        END CASE.
    END.
...
------------------------------------------------------------------------------*/
    ...
    CASE pPageNumber:
        WHEN 1 THEN
            ...
            RUN setConstraintByCod IN {&hDBOTable1} (INPUT fi-ini-cod-estabel,
...
------------------------------------------------------------------------------*/
  ...
  FIND repres NO-LOCK WHERE 
       repres.cod-rep = ttmeta-rep.cod-rep NO-ERROR.
