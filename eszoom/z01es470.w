...
*******************************************************************************/
{include/i-prgvrs.i z01es470 2.04.00.000}

CREATE WIDGET-POOL.

/* Preprocessors Definitions ---                                      */
&GLOBAL-DEFINE Program           z01es470
...
&GLOBAL-DEFINE ttTable1          tt-juridico-acoes
&GLOBAL-DEFINE hDBOTable1        hboes470
&GLOBAL-DEFINE DBOTable1         tt-juridico-acoes
...
&Scoped-define INTERNAL-TABLES tt-juridico-acoes

/* Definitions for BROWSE brTable1                                      */
&Scoped-define FIELDS-IN-QUERY-brTable1 tt-juridico-acoes.codigo ~
tt-juridico-acoes.descricao 
&Scoped-define ENABLED-FIELDS-IN-QUERY-brTable1 
&Scoped-define QUERY-STRING-brTable1 FOR EACH tt-juridico-acoes NO-LOCK
&Scoped-define OPEN-QUERY-brTable1 OPEN QUERY brTable1 FOR EACH tt-juridico-acoes NO-LOCK.
&Scoped-define TABLES-IN-QUERY-brTable1 tt-juridico-acoes
&Scoped-define FIRST-TABLE-IN-QUERY-brTable1 tt-juridico-acoes
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS brTable1 wZoom _STRUCTURED
  QUERY brTable1 NO-LOCK DISPLAY
      tt-juridico-acoes.codigo FORMAT ">>>>>>9":U WIDTH 9.43
      tt-juridico-acoes.descricao FORMAT "x(40)":U WIDTH 68.86
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
...
/* Query rebuild information for BROWSE brTable1
     _TblList          = "Temp-Tables.tt-juridico-acoes"
     _Options          = "NO-LOCK"
     _TblOptList       = ", FIRST USED"
     _FldNameList[1]   > Temp-Tables.tt-juridico-acoes.codigo
"tt-juridico-acoes.codigo" ? ? "integer" ? ? ? ? ? ? no ? no no "9.43" yes no no "U" "" ""
     _FldNameList[2]   > Temp-Tables.tt-juridico-acoes.descricao
"tt-juridico-acoes.descricao" ? ? "character" ? ? ? ? ? ? no ? no no "68.86" yes no no "U" "" ""
     _Query            is OPENED
*/  /* BROWSE brTable1 */
&ANALYZE-RESUME
...
------------------------------------------------------------------------------*/
    ...
    IF NOT VALID-HANDLE({&hDBOTable1}) OR
       ...
       {&hDBOTable1}:FILE-NAME <> "esbo/boes470.p":U THEN DO:
       
        {btb/btb008za.i1 esbo/boes470.p YES}
        {btb/btb008za.i2 esbo/boes470.p '' {&hDBOTable1}} 
    END.
