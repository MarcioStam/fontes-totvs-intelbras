...
*******************************************************************************/
{include/i-prgvrs.i z01es471 2.04.00.000}

CREATE WIDGET-POOL.

/* Preprocessors Definitions ---                                      */
&GLOBAL-DEFINE Program           z01es471
...
&GLOBAL-DEFINE ttTable1          tt-juridico-situacoes
&GLOBAL-DEFINE hDBOTable1        hboes471
&GLOBAL-DEFINE DBOTable1         tt-juridico-situacoes
...
&Scoped-define INTERNAL-TABLES tt-juridico-situacoes

/* Definitions for BROWSE brTable1                                      */
&Scoped-define FIELDS-IN-QUERY-brTable1 tt-juridico-situacoes.codigo ~
tt-juridico-situacoes.descricao 
&Scoped-define ENABLED-FIELDS-IN-QUERY-brTable1 
&Scoped-define QUERY-STRING-brTable1 FOR EACH tt-juridico-situacoes NO-LOCK
&Scoped-define OPEN-QUERY-brTable1 OPEN QUERY brTable1 FOR EACH tt-juridico-situacoes NO-LOCK.
&Scoped-define TABLES-IN-QUERY-brTable1 tt-juridico-situacoes
&Scoped-define FIRST-TABLE-IN-QUERY-brTable1 tt-juridico-situacoes
...
DEFINE QUERY brTable1 FOR 
      tt-juridico-situacoes SCROLLING.
&ANALYZE-RESUME
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS brTable1 wZoom _STRUCTURED
  QUERY brTable1 NO-LOCK DISPLAY
      tt-juridico-situacoes.codigo FORMAT ">>>>>>9":U WIDTH 8.43
      tt-juridico-situacoes.descricao FORMAT "x(40)":U WIDTH 69.86
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
...
/* Query rebuild information for BROWSE brTable1
     _TblList          = "Temp-Tables.tt-juridico-situacoes"
     _Options          = "NO-LOCK"
     _TblOptList       = ", FIRST USED"
     _FldNameList[1]   > Temp-Tables.tt-juridico-situacoes.codigo
"tt-juridico-situacoes.codigo" ? ? "integer" ? ? ? ? ? ? no ? no no "8.43" yes no no "U" "" ""
     _FldNameList[2]   > Temp-Tables.tt-juridico-situacoes.descricao
"tt-juridico-situacoes.descricao" ? ? "character" ? ? ? ? ? ? no ? no no "69.86" yes no no "U" "" ""
     _Query            is OPENED
*/  /* BROWSE brTable1 */
&ANALYZE-RESUME
...
------------------------------------------------------------------------------*/
    ...
    IF NOT VALID-HANDLE({&hDBOTable1}) OR
       ...
       {&hDBOTable1}:FILE-NAME <> "esbo/boes471.p":U THEN DO:
       
        {btb/btb008za.i1 esbo/boes471.p YES}
        {btb/btb008za.i2 esbo/boes471.p '' {&hDBOTable1}} 
    END.
