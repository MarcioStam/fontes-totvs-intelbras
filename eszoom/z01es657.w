...
&GLOBAL-DEFINE Program           z01es657
...
&GLOBAL-DEFINE FieldsRangePage1  mgesp.aponta-mqa.cod-estabel,mgesp.aponta-mqa.data,mgesp.aponta-mqa.nr-linha
&GLOBAL-DEFINE FieldsAnyKeyPage1 NO, NO, NO

&GLOBAL-DEFINE ttTable1          tt-aponta-mqa
&GLOBAL-DEFINE hDBOTable1        h-boes657
&GLOBAL-DEFINE DBOTable1         aponta-mqa
...
&Scoped-define FIELDS-IN-QUERY-brTable1 tt-aponta-mqa.cod-estabel ~
tt-aponta-mqa.cod-falha tt-aponta-mqa.cod-prod tt-aponta-mqa.es-codigo ~
tt-aponta-mqa.local-montag tt-aponta-mqa.nr-linha 
&Scoped-define ENABLED-FIELDS-IN-QUERY-brTable1 
&Scoped-define QUERY-STRING-brTable1 FOR EACH tt-aponta-mqa NO-LOCK
&Scoped-define OPEN-QUERY-brTable1 OPEN QUERY brTable1 FOR EACH tt-aponta-mqa NO-LOCK.
&Scoped-define TABLES-IN-QUERY-brTable1 tt-aponta-mqa
&Scoped-define FIRST-TABLE-IN-QUERY-brTable1 tt-aponta-mqa
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS brTable1 wZoom _STRUCTURED
  QUERY brTable1 NO-LOCK DISPLAY
      tt-aponta-mqa.cod-estabel FORMAT "x(3)":U
      tt-aponta-mqa.cod-falha FORMAT ">>9":U
      tt-aponta-mqa.cod-prod FORMAT ">>>,>>>,>>9":U
      tt-aponta-mqa.es-codigo FORMAT "x(16)":U
      tt-aponta-mqa.local-montag FORMAT "x(10)":U
      tt-aponta-mqa.nr-linha FORMAT "99":U
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
...
/* Query rebuild information for BROWSE brTable1
     _TblList          = "Temp-Tables.tt-aponta-mqa"
     _Options          = "NO-LOCK"
     _FldNameList[1]   = Temp-Tables.tt-aponta-mqa.cod-estabel
     _FldNameList[2]   = Temp-Tables.tt-aponta-mqa.cod-falha
     _FldNameList[3]   = Temp-Tables.tt-aponta-mqa.cod-prod
     _FldNameList[4]   = Temp-Tables.tt-aponta-mqa.es-codigo
     _FldNameList[5]   = Temp-Tables.tt-aponta-mqa.local-montag
     _FldNameList[6]   = Temp-Tables.tt-aponta-mqa.nr-linha
...
------------------------------------------------------------------------------*/
    ...
    IF NOT VALID-HANDLE({&hDBOTable1}) OR
       ...
       {&hDBOTable1}:FILE-NAME <> "esbo/boes657.p":U THEN DO:
       
        {btb/btb008za.i1 esbo/boes657.p YES}
        {btb/btb008za.i2 esbo/boes657.p '' {&hDBOTable1}} 
    END.
