...
*******************************************************************************/
{include/i-prgvrs.i Z01ES568 2.00.00.001}

CREATE WIDGET-POOL.

/* Preprocessors Definitions ---                                      */
&GLOBAL-DEFINE Program           z01es568
&GLOBAL-DEFINE Version           2.00.00.001

&GLOBAL-DEFINE InitialPage       1
&GLOBAL-DEFINE FolderLabels      Unid Comerc

&GLOBAL-DEFINE Range             YES

&GLOBAL-DEFINE FieldsRangePage1  mgesp.unid-comerc.cd-unid-comerc
&GLOBAL-DEFINE FieldsAnyKeyPage1 NO

&GLOBAL-DEFINE ttTable1          tt-unid-comerc
&GLOBAL-DEFINE hDBOTable1        h-boes568
&GLOBAL-DEFINE DBOTable1         unid-comerc
...
&Scoped-define INTERNAL-TABLES tt-unid-comerc

/* Definitions for BROWSE brTable1                                      */
&Scoped-define FIELDS-IN-QUERY-brTable1 tt-unid-comerc.cd-unid-comerc ~
tt-unid-comerc.ds-unid-comerc 
&Scoped-define ENABLED-FIELDS-IN-QUERY-brTable1 
&Scoped-define QUERY-STRING-brTable1 FOR EACH tt-unid-comerc NO-LOCK INDEXED-REPOSITION
&Scoped-define OPEN-QUERY-brTable1 OPEN QUERY brTable1 FOR EACH tt-unid-comerc NO-LOCK INDEXED-REPOSITION.
&Scoped-define TABLES-IN-QUERY-brTable1 tt-unid-comerc
&Scoped-define FIRST-TABLE-IN-QUERY-brTable1 tt-unid-comerc
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS brTable1 wZoom _STRUCTURED
  QUERY brTable1 NO-LOCK DISPLAY
      tt-unid-comerc.cd-unid-comerc FORMAT ">>9":U WIDTH 9.43
      tt-unid-comerc.ds-unid-comerc FORMAT "x(25)":U WIDTH 68.43
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
...
/* Query rebuild information for BROWSE brTable1
     _TblList          = "Temp-Tables.tt-unid-comerc"
     _Options          = "NO-LOCK INDEXED-REPOSITION"
     _FldNameList[1]   > Temp-Tables.tt-unid-comerc.cd-unid-comerc
"tt-unid-comerc.cd-unid-comerc" ? ? "integer" ? ? ? ? ? ? no ? no no "9.43" yes no no "U" "" ""
     _FldNameList[2]   > Temp-Tables.tt-unid-comerc.ds-unid-comerc
"tt-unid-comerc.ds-unid-comerc" ? ? "character" ? ? ? ? ? ? no ? no no "68.43" yes no no "U" "" ""
     _Query            is OPENED
*/  /* BROWSE brTable1 */
&ANALYZE-RESUME
...
DO:
    {zoom/implant.i &ProgramImplant="esp/cdp/escdp038.w"
                    &PageNumber="1"}
END.
...
------------------------------------------------------------------------------*/
    ...
    IF NOT VALID-HANDLE({&hDBOTable1}) OR
       ...
       {&hDBOTable1}:FILE-NAME <> "esbo/boes568.p":U THEN DO:
        {btb/btb008za.i1 esbo/boes568.p YES}
        {btb/btb008za.i2 esbo/boes568.p '' {&hDBOTable1}} 
    END.
    
    RUN setConstraintCodigo IN {&hDBOTable1} (INPUT 0,
                                              INPUT 999) NO-ERROR.
...
------------------------------------------------------------------------------*/
    ...
    {zoom/openqueries.i &Query="Codigo"
                        &PageNumber="1"}
...
------------------------------------------------------------------------------*/
    ...
    IF AVAILABLE {&ttTable1} THEN DO:
        CASE pcField:
            WHEN "cd-unid-comerc":U THEN
                ASSIGN pcFieldValue = STRING({&ttTable1}.cd-unid-comerc).
            WHEN "ds-unid-comerc":U THEN
                ASSIGN pcFieldValue = STRING({&ttTable1}.ds-unid-comerc).
        END CASE.
    END.
...
------------------------------------------------------------------------------*/
    ...
    CASE pPageNumber:
        WHEN 1 THEN
            ...
            RUN setConstraintCodigo IN {&hDBOTable1} (INPUT fnIniRangeCharPage(1,1),
