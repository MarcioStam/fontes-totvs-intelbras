...
DEFINE TEMP-TABLE tt-indice-qualid NO-UNDO LIKE indice-qualid
...
*******************************************************************************/
{include/i-prgvrs.i Z01ES658 2.00.00.000}
...
&GLOBAL-DEFINE Program           Z01ES658
&GLOBAL-DEFINE Version           2.00.00.000

&GLOBAL-DEFINE InitialPage       1
&GLOBAL-DEFINE FolderLabels      Öndices

&GLOBAL-DEFINE Range             YES

&GLOBAL-DEFINE FieldsRangePage1  mgesp.indice-qualid.cod-estabel,mgesp.indice-qualid.it-codigo
&GLOBAL-DEFINE FieldsAnyKeyPage1 NO,NO

&GLOBAL-DEFINE ttTable1          tt-indice-qualid
&GLOBAL-DEFINE hDBOTable1        h-boes658
&GLOBAL-DEFINE DBOTable1         indice-qualid
...
&Scoped-define INTERNAL-TABLES tt-indice-qualid

/* Definitions for BROWSE brTable1                                      */
&Scoped-define FIELDS-IN-QUERY-brTable1 tt-indice-qualid.cod-estabel ~
tt-indice-qualid.it-codigo tt-indice-qualid.absol-atencao ~
tt-indice-qualid.absol-problema tt-indice-qualid.relat-atencao ~
tt-indice-qualid.relat-problema 
&Scoped-define ENABLED-FIELDS-IN-QUERY-brTable1 
&Scoped-define QUERY-STRING-brTable1 FOR EACH tt-indice-qualid NO-LOCK
&Scoped-define OPEN-QUERY-brTable1 OPEN QUERY brTable1 FOR EACH tt-indice-qualid NO-LOCK.
&Scoped-define TABLES-IN-QUERY-brTable1 tt-indice-qualid
&Scoped-define FIRST-TABLE-IN-QUERY-brTable1 tt-indice-qualid
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS brTable1 wZoom _STRUCTURED
  QUERY brTable1 NO-LOCK DISPLAY
      tt-indice-qualid.cod-estabel FORMAT "x(3)":U
      tt-indice-qualid.it-codigo FORMAT "x(16)":U
      tt-indice-qualid.absol-atencao FORMAT ">>9.99":U
      tt-indice-qualid.absol-problema FORMAT ">>9.99":U
      tt-indice-qualid.relat-atencao FORMAT ">>9.99":U
      tt-indice-qualid.relat-problema FORMAT ">>9.99":U
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
...
/* Settings for THIS-PROCEDURE
   ...
   Temp-Tables and Buffers:
      TABLE: tt-indice-qualid T "?" NO-UNDO mgesp indice-qualid
      ADDITIONAL-FIELDS:
          field r-rowid as rowid
      END-FIELDS.
   END-TABLES.
...
/* Query rebuild information for BROWSE brTable1
     _TblList          = "Temp-Tables.tt-indice-qualid"
     _Options          = "NO-LOCK"
     _FldNameList[1]   = Temp-Tables.tt-indice-qualid.cod-estabel
     _FldNameList[2]   = Temp-Tables.tt-indice-qualid.it-codigo
     _FldNameList[3]   = Temp-Tables.tt-indice-qualid.absol-atencao
     _FldNameList[4]   = Temp-Tables.tt-indice-qualid.absol-problema
     _FldNameList[5]   = Temp-Tables.tt-indice-qualid.relat-atencao
     _FldNameList[6]   = Temp-Tables.tt-indice-qualid.relat-problema
     _Query            is OPENED
*/  /* BROWSE brTable1 */
&ANALYZE-RESUME
...
------------------------------------------------------------------------------*/
    ...
    IF NOT VALID-HANDLE({&hDBOTable1}) OR
       ...
       {&hDBOTable1}:FILE-NAME <> "esbo/boes658.p":U THEN DO:
       
        {btb/btb008za.i1 esbo/boes658.p YES}
        {btb/btb008za.i2 esbo/boes658.p '' {&hDBOTable1}} 
    END.
...
------------------------------------------------------------------------------*/
    ...
    {zoom/openqueries.i &Query="EstabItem"
                        &PageNumber="1"}
...
------------------------------------------------------------------------------*/
    ...
    CASE pPageNumber:
        WHEN 1 THEN
            ...
            RUN setConstraintEstabItem IN {&hDBOTable1} (INPUT FnIniRangeCharPage(1,1),
