...
*******************************************************************************/
{include/i-prgvrs.i z01es515 2.04.00.000}

CREATE WIDGET-POOL.

/* Preprocessors Definitions ---                                      */
&GLOBAL-DEFINE Program           z01es515
&GLOBAL-DEFINE Version           2.04.00.000

&GLOBAL-DEFINE InitialPage       1
&GLOBAL-DEFINE FolderLabels      Prˆmios

&GLOBAL-DEFINE Range             YES

&GLOBAL-DEFINE FieldsRangePage1  mgesp.premios-fidelidade.cod-premio,mgesp.premios-fidelidade.descricao
&GLOBAL-DEFINE FieldsAnyKeyPage1 NO,NO

&GLOBAL-DEFINE ttTable1          ttpremios-fidelidade
&GLOBAL-DEFINE hDBOTable1        hboes515
&GLOBAL-DEFINE DBOTable1         premios-fidelidade
...
&Scoped-define INTERNAL-TABLES ttpremios-fidelidade

/* Definitions for BROWSE brTable1                                      */
&Scoped-define FIELDS-IN-QUERY-brTable1 ttpremios-fidelidade.cod-premio ~
ttpremios-fidelidade.descricao ttpremios-fidelidade.qt-pontos ~
ttpremios-fidelidade.situacao 
&Scoped-define ENABLED-FIELDS-IN-QUERY-brTable1 
&Scoped-define QUERY-STRING-brTable1 FOR EACH ttpremios-fidelidade NO-LOCK
&Scoped-define OPEN-QUERY-brTable1 OPEN QUERY brTable1 FOR EACH ttpremios-fidelidade NO-LOCK.
&Scoped-define TABLES-IN-QUERY-brTable1 ttpremios-fidelidade
&Scoped-define FIRST-TABLE-IN-QUERY-brTable1 ttpremios-fidelidade
...
DEFINE QUERY brTable1 FOR 
      ttpremios-fidelidade SCROLLING.
&ANALYZE-RESUME
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS brTable1 wZoom _STRUCTURED
  QUERY brTable1 NO-LOCK DISPLAY
      ttpremios-fidelidade.cod-premio FORMAT ">>>,>>>,>>9":U
      ttpremios-fidelidade.descricao FORMAT "x(80)":U
      ttpremios-fidelidade.qt-pontos FORMAT ">>>,>>>,>>9":U
      ttpremios-fidelidade.situacao FORMAT ">9":U
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
...
/* Query rebuild information for BROWSE brTable1
     _TblList          = "Temp-Tables.ttpremios-fidelidade"
     _Options          = "NO-LOCK"
     _FldNameList[1]   = Temp-Tables.ttpremios-fidelidade.cod-premio
     _FldNameList[2]   = Temp-Tables.ttpremios-fidelidade.descricao
     _FldNameList[3]   = Temp-Tables.ttpremios-fidelidade.qt-pontos
     _FldNameList[4]   = Temp-Tables.ttpremios-fidelidade.situacao
     _Query            is OPENED
*/  /* BROWSE brTable1 */
&ANALYZE-RESUME
...
------------------------------------------------------------------------------*/
    ...
    IF NOT VALID-HANDLE({&hDBOTable1}) OR
       ...
       {&hDBOTable1}:FILE-NAME <> "esbo/boes515.p":U THEN DO:
       
        {btb/btb008za.i1 esbo/boes515.p YES}
        {btb/btb008za.i2 esbo/boes515.p '' {&hDBOTable1}} 
    END.
...
------------------------------------------------------------------------------*/
    ...
    IF AVAILABLE {&ttTable1} THEN DO:
        CASE pcField:
            WHEN "cod-premio":U THEN
                ASSIGN pcFieldValue = STRING({&ttTable1}.cod-premio).
        END CASE.
    END.
