...
DEFINE TEMP-TABLE tt-crm-categoria1 NO-UNDO LIKE crm-categoria
       field r-rowid as rowid.
DEFINE TEMP-TABLE tt-crm-categoria2 NO-UNDO LIKE crm-categoria
       field r-rowid as rowid.
...
*******************************************************************************/
{include/i-prgvrs.i Z01ES546 2.00.00.001}

CREATE WIDGET-POOL.

/* Preprocessors Definitions ---                                      */
&GLOBAL-DEFINE Program           Z01ES546
...
&GLOBAL-DEFINE FieldsRangePage1  mgesp.crm-categoria.cd-categoria
&GLOBAL-DEFINE FieldsRangePage2  mgesp.crm-categoria.ds-categoria
&GLOBAL-DEFINE FieldsAnyKeyPage1 NO
&GLOBAL-DEFINE FieldsAnyKeyPage2 NO

&GLOBAL-DEFINE ttTable1          tt-crm-categoria1
&GLOBAL-DEFINE hDBOTable1        h-boes546-1
&GLOBAL-DEFINE DBOTable1         crm-categoria

&GLOBAL-DEFINE ttTable2          tt-crm-categoria2
&GLOBAL-DEFINE hDBOTable2        h-boes546-2
&GLOBAL-DEFINE DBOTable2         crm-categoria
...
&Scoped-define INTERNAL-TABLES tt-crm-categoria1 tt-crm-categoria2

/* Definitions for BROWSE brTable1                                      */
&Scoped-define FIELDS-IN-QUERY-brTable1 tt-crm-categoria1.cd-categoria ~
tt-crm-categoria1.ds-categoria 
&Scoped-define ENABLED-FIELDS-IN-QUERY-brTable1 
&Scoped-define QUERY-STRING-brTable1 FOR EACH tt-crm-categoria1 NO-LOCK ~
    BY tt-crm-categoria1.cd-categoria
&Scoped-define OPEN-QUERY-brTable1 OPEN QUERY brTable1 FOR EACH tt-crm-categoria1 NO-LOCK ~
    BY tt-crm-categoria1.cd-categoria.
&Scoped-define TABLES-IN-QUERY-brTable1 tt-crm-categoria1
&Scoped-define FIRST-TABLE-IN-QUERY-brTable1 tt-crm-categoria1


/* Definitions for BROWSE brTable2                                      */
&Scoped-define FIELDS-IN-QUERY-brTable2 tt-crm-categoria2.ds-categoria ~
tt-crm-categoria2.cd-categoria 
&Scoped-define ENABLED-FIELDS-IN-QUERY-brTable2 
&Scoped-define QUERY-STRING-brTable2 FOR EACH tt-crm-categoria2 NO-LOCK ~
    BY tt-crm-categoria2.ds-categoria
&Scoped-define OPEN-QUERY-brTable2 OPEN QUERY brTable2 FOR EACH tt-crm-categoria2 NO-LOCK ~
    BY tt-crm-categoria2.ds-categoria.
&Scoped-define TABLES-IN-QUERY-brTable2 tt-crm-categoria2
&Scoped-define FIRST-TABLE-IN-QUERY-brTable2 tt-crm-categoria2
...
DEFINE QUERY brTable1 FOR 
      tt-crm-categoria1 SCROLLING.

DEFINE QUERY brTable2 FOR 
      tt-crm-categoria2 SCROLLING.
&ANALYZE-RESUME
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS brTable1 wZoom _STRUCTURED
  QUERY brTable1 NO-LOCK DISPLAY
      tt-crm-categoria1.cd-categoria FORMAT ">>9":U
      tt-crm-categoria1.ds-categoria FORMAT "x(30)":U
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS brTable2 wZoom _STRUCTURED
  QUERY brTable2 NO-LOCK DISPLAY
      tt-crm-categoria2.ds-categoria FORMAT "x(30)":U
      tt-crm-categoria2.cd-categoria FORMAT ">>9":U
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ROW-MARKERS SEPARATORS SIZE 82 BY 10.67
         FONT 2.
...
/* Settings for THIS-PROCEDURE
   ...
   Temp-Tables and Buffers:
      TABLE: tt-crm-categoria1 T "?" NO-UNDO mgesp crm-categoria
      ADDITIONAL-FIELDS:
          field r-rowid as rowid
      END-FIELDS.
      TABLE: tt-crm-categoria2 T "?" NO-UNDO mgesp crm-categoria
      ADDITIONAL-FIELDS:
          field r-rowid as rowid
      END-FIELDS.
   END-TABLES.
...
/* Query rebuild information for BROWSE brTable1
     _TblList          = "Temp-Tables.tt-crm-categoria1"
     _Options          = "NO-LOCK"
     _OrdList          = "Temp-Tables.tt-crm-categoria1.cd-categoria|yes"
     _FldNameList[1]   = Temp-Tables.tt-crm-categoria1.cd-categoria
     _FldNameList[2]   = Temp-Tables.tt-crm-categoria1.ds-categoria
     _Query            is OPENED
*/  /* BROWSE brTable1 */
&ANALYZE-RESUME
...
/* Query rebuild information for BROWSE brTable2
     _TblList          = "Temp-Tables.tt-crm-categoria2"
     _Options          = "NO-LOCK"
     _OrdList          = "Temp-Tables.tt-crm-categoria2.ds-categoria|yes"
     _FldNameList[1]   = Temp-Tables.tt-crm-categoria2.ds-categoria
     _FldNameList[2]   = Temp-Tables.tt-crm-categoria2.cd-categoria
     _Query            is OPENED
*/  /* BROWSE brTable2 */
&ANALYZE-RESUME
...
DO:
    {zoom/implant.i &ProgramImplant="esp\cdp\escdp024.w"
                    &PageNumber="1"}
END.
...
------------------------------------------------------------------------------*/
    ...
    IF NOT VALID-HANDLE({&hDBOTable1}) OR
       ...
       {&hDBOTable1}:FILE-NAME <> "esbo/boes546.p":U THEN DO:
        {btb/btb008za.i1 esbo/boes546.p YES}
        {btb/btb008za.i2 esbo/boes546.p '' {&hDBOTable1}} 
    END.
    
    RUN setConstraintCodigo IN {&hDBOTable1} (INPUT 0, INPUT 999) NO-ERROR.
    
    /*:T--- Verifica se o DBO j  est  inicializado ---*/
    IF NOT VALID-HANDLE({&hDBOTable2}) OR
       {&hDBOTable2}:TYPE <> "PROCEDURE":U OR
       {&hDBOTable2}:FILE-NAME <> "esbo/boes546.p":U THEN DO:
        {btb/btb008za.i1 esbo/boes546.p YES}
        {btb/btb008za.i2 esbo/boes546.p '' {&hDBOTable2}} 
    END.
    
    RUN setConstraintDescricao IN {&hDBOTable2} (INPUT "", INPUT FILL("Z",30)) NO-ERROR.
...
------------------------------------------------------------------------------*/
    ...
    {zoom/openqueries.i &Query="RangeCodigo"
                        &PageNumber="1"}
    
    {zoom/openqueries.i &Query="RangeDescricao"
                        &PageNumber="2"}
...
------------------------------------------------------------------------------*/
    ...
    IF AVAILABLE {&ttTable1} THEN DO:
        CASE pcField:
            ...
            WHEN "ds-categoria" THEN
                ASSIGN pcFieldValue = STRING({&ttTable1}.ds-categoria).
        END CASE.
    END.
...
------------------------------------------------------------------------------*/
    ...
    IF AVAILABLE {&ttTable2} THEN DO:
        CASE pcField:
            WHEN "cd-categoria":U THEN
                ASSIGN pcFieldValue = STRING({&ttTable2}.cd-categoria).
            WHEN "ds-categoria" THEN
                ASSIGN pcFieldValue = STRING({&ttTable2}.ds-categoria).
        END CASE.
    END.
...
------------------------------------------------------------------------------*/
    ...
    CASE pPageNumber:
        WHEN 1 THEN
            ...
            RUN setConstraintRangeCodigo IN {&hDBOTable1} (INPUT fnIniRangeIntPage(1,1),
                                                           INPUT fnEndRangeIntPage(1,1)).
        
        WHEN 2 THEN
            /*:T--- Seta Constraints para o DBO Table2 ---*/
            RUN setConstraintRangeDescricao IN {&hDBOTable2} (INPUT fnIniRangeCharPage(2,1),
