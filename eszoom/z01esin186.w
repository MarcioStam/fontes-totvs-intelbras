...
DEFINE TEMP-TABLE tt-lin-prod NO-UNDO LIKE lin-prod
...
*******************************************************************************/
{include/i-prgvrs.i Z01ESIN186 1.00.00.000}
...
&GLOBAL-DEFINE Program           Z01ESIN186
&GLOBAL-DEFINE Version           1.00.00.000

&GLOBAL-DEFINE InitialPage       1
&GLOBAL-DEFINE FolderLabels      Linha

&GLOBAL-DEFINE Range             YES

&GLOBAL-DEFINE FieldsRangePage1  mgcad.lin-prod.nr-linha
&GLOBAL-DEFINE FieldsAnyKeyPage1 NO

&GLOBAL-DEFINE ttTable1          tt-lin-prod
&GLOBAL-DEFINE hDBOTable1        h-boin186
&GLOBAL-DEFINE DBOTable1         boin186
...
&Scoped-define INTERNAL-TABLES tt-lin-prod

/* Definitions for BROWSE brTable1                                      */
&Scoped-define FIELDS-IN-QUERY-brTable1 tt-lin-prod.cod-estabel ~
tt-lin-prod.nr-linha tt-lin-prod.descricao 
&Scoped-define ENABLED-FIELDS-IN-QUERY-brTable1 
&Scoped-define QUERY-STRING-brTable1 FOR EACH tt-lin-prod NO-LOCK
&Scoped-define OPEN-QUERY-brTable1 OPEN QUERY brTable1 FOR EACH tt-lin-prod NO-LOCK.
&Scoped-define TABLES-IN-QUERY-brTable1 tt-lin-prod
&Scoped-define FIRST-TABLE-IN-QUERY-brTable1 tt-lin-prod
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS brTable1 wZoom _STRUCTURED
  QUERY brTable1 NO-LOCK DISPLAY
      tt-lin-prod.cod-estabel FORMAT "x(5)":U
      tt-lin-prod.nr-linha FORMAT ">>9":U
      tt-lin-prod.descricao FORMAT "x(30)":U
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
...
/* Settings for THIS-PROCEDURE
   ...
   Temp-Tables and Buffers:
      TABLE: tt-lin-prod T "?" NO-UNDO mgcad lin-prod
      ADDITIONAL-FIELDS:
          field r-rowid as rowid
      END-FIELDS.
   END-TABLES.
...
/* Query rebuild information for BROWSE brTable1
     _TblList          = "Temp-Tables.tt-lin-prod"
     _Options          = "NO-LOCK"
     _FldNameList[1]   = Temp-Tables.tt-lin-prod.cod-estabel
     _FldNameList[2]   = Temp-Tables.tt-lin-prod.nr-linha
     _FldNameList[3]   = Temp-Tables.tt-lin-prod.descricao
     _Query            is OPENED
*/  /* BROWSE brTable1 */
&ANALYZE-RESUME
...
------------------------------------------------------------------------------*/
    ...
    IF NOT VALID-HANDLE({&hDBOTable1}) OR
       ...
       {&hDBOTable1}:FILE-NAME <> "inbo/boin186.p":U THEN DO:
       
        {btb/btb008za.i1 inbo/boin186.p YES}
        {btb/btb008za.i2 inbo/boin186.p '' {&hDBOTable1}} 
    END.
...
------------------------------------------------------------------------------*/
    ...
    {zoom/openqueries.i &Query="ByFiltroNrLinha"
                        &PageNumber="1"}
...
------------------------------------------------------------------------------*/
    ...
    CASE pPageNumber:
        WHEN 1 THEN
            ...
            RUN setConstraintFiltroNrLinha IN {&hDBOTable1} (INPUT string(fnIniRangeIntPage(INPUT 1, INPUT 1)),
