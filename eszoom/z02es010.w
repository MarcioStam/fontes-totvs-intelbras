...
&Scoped-define FIELDS-IN-QUERY-brTable1 ttae-item.nr-ae ttae-item.sequencia ~
...
"nr-ae" "Nr§ AE" ? "integer" ? ? ? ? ? ? no ? no no ? yes no no "U" "" ""
     _FldNameList[2]   > Temp-Tables.ttae-item.sequencia
"sequencia" "Sequˆncia" ? "integer" ? ? ? ? ? ? no ? no no ? yes no no "U" "" ""
     _FldNameList[3]   > Temp-Tables.ttae-item.data
"data" "Data entrada" ? "date" ? ? ? ? ? ? no ? no no ? yes no no "U" "" ""
     _FldNameList[4]   > Temp-Tables.ttae-item.data-validade
"data-validade" "Data validade" ? "date" ? ? ? ? ? ? no ? no no ? yes no no "U" "" ""
     _Query            is OPENED
*/  /* BROWSE brTable1 */
&ANALYZE-RESUME
...
------------------------------------------------------------------------------*/
    ...
    RUN setConstraintByCod IN {&hDBOTable1} (input v_cod_estab_usuar, INPUT 0, INPUT 9999999, INPUT 0, INPUT 999).
...
------------------------------------------------------------------------------*/
    ...
    CASE pPageNumber:
        WHEN 1 THEN
            ...
            RUN setConstraintByAE IN {&hDBOTable1} 
