...
DEFINE TEMP-TABLE tt-natureza-ped-fiscal NO-UNDO LIKE natureza-ped-fiscal
...
*******************************************************************************/
{include/i-prgvrs.i z01es741 1.00.00.000}
...
&GLOBAL-DEFINE Program           z01es741
...
&GLOBAL-DEFINE FieldsRangePage1  mgesp.natureza-ped-fiscal.natureza
&GLOBAL-DEFINE FieldsAnyKeyPage1 NO

&GLOBAL-DEFINE ttTable1          tt-natureza-ped-fiscal
&GLOBAL-DEFINE hDBOTable1        h-boes741
&GLOBAL-DEFINE DBOTable1         boes741
...
&Scoped-define INTERNAL-TABLES tt-natureza-ped-fiscal

/* Definitions for BROWSE brTable1                                      */
&Scoped-define FIELDS-IN-QUERY-brTable1 tt-natureza-ped-fiscal.natureza tt-natureza-ped-fiscal.descricao 
&Scoped-define ENABLED-FIELDS-IN-QUERY-brTable1 
&Scoped-define QUERY-STRING-brTable1 FOR EACH tt-natureza-ped-fiscal NO-LOCK
&Scoped-define OPEN-QUERY-brTable1 OPEN QUERY brTable1 FOR EACH tt-natureza-ped-fiscal NO-LOCK.
&Scoped-define TABLES-IN-QUERY-brTable1 tt-natureza-ped-fiscal
&Scoped-define FIRST-TABLE-IN-QUERY-brTable1 tt-natureza-ped-fiscal
...
DEFINE QUERY brTable1 FOR 
      tt-natureza-ped-fiscal SCROLLING.
&ANALYZE-RESUME
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS brTable1 wZoom _STRUCTURED
  QUERY brTable1 NO-LOCK DISPLAY
      tt-natureza-ped-fiscal.natureza FORMAT ">>9":U
      tt-natureza-ped-fiscal.descricao FORMAT "x(30)":U
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
...
/* Settings for THIS-PROCEDURE
   ...
   Temp-Tables and Buffers:
      TABLE: tt-natureza-ped-fiscal T "?" NO-UNDO mgcad natureza-ped-fiscal
      ADDITIONAL-FIELDS:
          field r-rowid as rowid
      END-FIELDS.
   END-TABLES.
...
/* Query rebuild information for BROWSE brTable1
     _TblList          = "Temp-Tables.tt-natureza-ped-fiscal"
     _Options          = "NO-LOCK"
     _FldNameList[1]   = Temp-Tables.tt-natureza-ped-fiscal.natureza
     _FldNameList[2]   = Temp-Tables.tt-natureza-ped-fiscal.descricao
     _Query            is OPENED
*/  /* BROWSE brTable1 */
&ANALYZE-RESUME
...
------------------------------------------------------------------------------*/
    ...
    IF NOT VALID-HANDLE({&hDBOTable1}) OR
       ...
       {&hDBOTable1}:FILE-NAME <> "esbo/boes741.p":U THEN DO:
       
        {btb/btb008za.i1 esbo/boes741.p YES}
        {btb/btb008za.i2 esbo/boes741.p '' {&hDBOTable1}} 
    END.
...
------------------------------------------------------------------------------*/
    ...
    {zoom/openqueries.i &Query="ByNat"
                        &PageNumber="1"}
...
------------------------------------------------------------------------------*/
    ...
    IF AVAILABLE {&ttTable1} THEN DO:
        CASE pcField:
            WHEN "natureza":U THEN
                ASSIGN pcFieldValue = STRING({&ttTable1}.natureza).
...
------------------------------------------------------------------------------*/
    ...
    CASE pPageNumber:
        WHEN 1 THEN
            ...
            RUN setConstraintbyNat IN {&hDBOTable1} (INPUT string(fnIniRangeIntPage(INPUT 1, INPUT 1)),
                                                     INPUT string(fnEndRangeIntPage(INPUT 1, INPUT 1))).
