...
*******************************************************************************/
{include/i-prgvrs.i z01es272 1.00.00.000}

CREATE WIDGET-POOL.

/* Preprocessors Definitions ---                                      */
&GLOBAL-DEFINE Program           z01es272
&GLOBAL-DEFINE Version           1.00.00.000

&GLOBAL-DEFINE InitialPage       1
&GLOBAL-DEFINE FolderLabels      Movimento

&GLOBAL-DEFINE Range             YES

&GLOBAL-DEFINE FieldsRangePage1  mgesp.mov-comis.cod-mov
&GLOBAL-DEFINE FieldsAnyKeyPage1 NO

&GLOBAL-DEFINE ttTable1          TTmov-comis
&GLOBAL-DEFINE hDBOTable1        HDBOTTmov-comis
&GLOBAL-DEFINE DBOTable1         mov-comis
...
&Scoped-define INTERNAL-TABLES ttmov-comis

/* Definitions for BROWSE brTable1                                      */
&Scoped-define FIELDS-IN-QUERY-brTable1 ttmov-comis.cod-mov ~
ttmov-comis.descricao 
&Scoped-define ENABLED-FIELDS-IN-QUERY-brTable1 
&Scoped-define QUERY-STRING-brTable1 FOR EACH ttmov-comis NO-LOCK
&Scoped-define OPEN-QUERY-brTable1 OPEN QUERY brTable1 FOR EACH ttmov-comis NO-LOCK.
&Scoped-define TABLES-IN-QUERY-brTable1 ttmov-comis
&Scoped-define FIRST-TABLE-IN-QUERY-brTable1 ttmov-comis
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS brTable1 wZoom _STRUCTURED
  QUERY brTable1 NO-LOCK DISPLAY
      ttmov-comis.cod-mov FORMAT ">>9":U
      ttmov-comis.descricao FORMAT "x(30)":U
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
...
/* Query rebuild information for BROWSE brTable1
     _TblList          = "Temp-Tables.ttmov-comis"
     _Options          = "NO-LOCK"
     _FldNameList[1]   = Temp-Tables.ttmov-comis.cod-mov
     _FldNameList[2]   = Temp-Tables.ttmov-comis.descricao
     _Query            is OPENED
*/  /* BROWSE brTable1 */
&ANALYZE-RESUME
...
------------------------------------------------------------------------------*/
    ...
    IF NOT VALID-HANDLE({&hDBOTable1}) OR
       ...
       {&hDBOTable1}:FILE-NAME <> "esbo/boes272.p":U THEN DO:
       
        {btb/btb008za.i1 esbo/boes272.p YES}
        {btb/btb008za.i2 esbo/boes272.p '' {&hDBOTable1}} 
    END.
...
------------------------------------------------------------------------------*/
    ...
    IF AVAILABLE {&ttTable1} THEN DO:
        CASE pcField:
            WHEN "cod-mov":U THEN
                ASSIGN pcFieldValue = STRING({&ttTable1}.cod-mov).
