...
DEFINE TEMP-TABLE tt-item-segmentos NO-UNDO LIKE item-segmentos
...
*******************************************************************************/
{include/i-prgvrs.i z01es744 1.00.00.000}
...
&GLOBAL-DEFINE Program           z01es744
&GLOBAL-DEFINE Version           1.00.00.000

&GLOBAL-DEFINE InitialPage       1
&GLOBAL-DEFINE FolderLabels      ItemSegmento

&GLOBAL-DEFINE Range             YES

&GLOBAL-DEFINE FieldsRangePage1  mgesp.item-segmentos.it-codigo
&GLOBAL-DEFINE FieldsAnyKeyPage1 NO

&GLOBAL-DEFINE ttTable1          tt-item-segmentos
&GLOBAL-DEFINE hDBOTable1        h-boes744
&GLOBAL-DEFINE DBOTable1         boes744
...
&Scoped-define INTERNAL-TABLES tt-item-segmentos

/* Definitions for BROWSE brTable1                                      */
&Scoped-define FIELDS-IN-QUERY-brTable1 tt-item-segmentos.it-codigo tt-item-segmentos.cod-segmento 
&Scoped-define ENABLED-FIELDS-IN-QUERY-brTable1 
&Scoped-define QUERY-STRING-brTable1 FOR EACH tt-item-segmentos NO-LOCK
&Scoped-define OPEN-QUERY-brTable1 OPEN QUERY brTable1 FOR EACH tt-item-segmentos NO-LOCK.
&Scoped-define TABLES-IN-QUERY-brTable1 tt-item-segmentos
&Scoped-define FIRST-TABLE-IN-QUERY-brTable1 tt-item-segmentos
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS brTable1 wZoom _STRUCTURED
  QUERY brTable1 NO-LOCK DISPLAY
      tt-item-segmentos.it-codigo
      tt-item-segmentos.cod-segmento 
      tt-item-segmentos.val-percentual
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
...
/* Settings for THIS-PROCEDURE
   ...
   Temp-Tables and Buffers:
      TABLE: tt-item-segmentos T "?" NO-UNDO mgcad item-segmentos
      ADDITIONAL-FIELDS:
          field r-rowid as rowid
      END-FIELDS.
   END-TABLES.
...
/* Query rebuild information for BROWSE brTable1
     _TblList          = "Temp-Tables.tt-item-segmentos"
     _Options          = "NO-LOCK"
...
------------------------------------------------------------------------------*/
    ...
    IF NOT VALID-HANDLE({&hDBOTable1}) OR
       ...
       {&hDBOTable1}:FILE-NAME <> "esbo/boes744.p":U THEN DO:
       
        {btb/btb008za.i1 esbo/boes744.p YES}
        {btb/btb008za.i2 esbo/boes744.p '' {&hDBOTable1}} 
    END.
    ...
    IF AVAILABLE {&ttTable1} THEN DO:
        CASE pcField:
            ...
            WHEN "cod-segmento":U THEN
                ASSIGN pcFieldValue = STRING({&ttTable1}.cod-segmento).
        END CASE.
    END.
