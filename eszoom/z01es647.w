...
*******************************************************************************/
{include/i-prgvrs.i z01es647 2.00.00.000}
...
&GLOBAL-DEFINE Program           z01es647
...
&GLOBAL-DEFINE ttTable1          tt-mot-aprov-auto-ped
&GLOBAL-DEFINE hDBOTable1        escdp063
&GLOBAL-DEFINE DBOTable1         mot-aprov-auto-ped
...
/*
DEF VAR atendente-ini LIKE mgesp.mot-aprov-auto-ped.atendente.
DEF VAR atendente-fim LIKE mgesp.mot-aprov-auto-ped.atendente.*/
...
&Scoped-define INTERNAL-TABLES tt-mot-aprov-auto-ped

/* Definitions for BROWSE brTable1                                      */
&Scoped-define FIELDS-IN-QUERY-brTable1 tt-mot-aprov-auto-ped.atendente ~
tt-mot-aprov-auto-ped.cod-emitente tt-mot-aprov-auto-ped.c-motivo 
&Scoped-define ENABLED-FIELDS-IN-QUERY-brTable1 
&Scoped-define QUERY-STRING-brTable1 FOR EACH tt-mot-aprov-auto-ped NO-LOCK
&Scoped-define OPEN-QUERY-brTable1 OPEN QUERY brTable1 FOR EACH tt-mot-aprov-auto-ped NO-LOCK.
&Scoped-define TABLES-IN-QUERY-brTable1 tt-mot-aprov-auto-ped
&Scoped-define FIRST-TABLE-IN-QUERY-brTable1 tt-mot-aprov-auto-ped
...
DEFINE QUERY brTable1 FOR 
      tt-mot-aprov-auto-ped SCROLLING.
&ANALYZE-RESUME
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS brTable1 wZoom _STRUCTURED
  QUERY brTable1 NO-LOCK DISPLAY
      tt-mot-aprov-auto-ped.atendente FORMAT ">9":U
      tt-mot-aprov-auto-ped.cod-emitente FORMAT ">>>>>>>>9":U
      tt-mot-aprov-auto-ped.c-motivo FORMAT "x(99)":U
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
...
DEFINE FRAME fPage1
     fi-atendente-ini AT ROW 1.25 COL 25 COLON-ALIGNED WIDGET-ID 6
     fi-atendente-fim AT ROW 1.25 COL 51 COLON-ALIGNED NO-LABEL WIDGET-ID 8
...
/* Query rebuild information for BROWSE brTable1
     _TblList          = "Temp-Tables.tt-mot-aprov-auto-ped"
     _Options          = "NO-LOCK"
     _FldNameList[1]   = Temp-Tables.tt-mot-aprov-auto-ped.atendente
     _FldNameList[2]   = Temp-Tables.tt-mot-aprov-auto-ped.cod-emitente
     _FldNameList[3]   = Temp-Tables.tt-mot-aprov-auto-ped.c-motivo
     _Query            is OPENED
*/  /* BROWSE brTable1 */
&ANALYZE-RESUME
...
DO:
    ASSIGN INPUT FRAME fpage1
        fi-atendente-ini fi-atendente-fim.
    /*
...
------------------------------------------------------------------------------*/
    ...
    DISP fi-atendente-ini
         fi-atendente-fim
         WITH FRAME fPage1.

    ENABLE fi-atendente-ini  
           fi-atendente-fim  
           btCheck 
           WITH FRAME fPage1.

    APPLY "choose" TO btCheck IN FRAME fPage1.
    APPLY "entry" TO fi-atendente-ini IN FRAME fPage1.
...
------------------------------------------------------------------------------*/
    ...
    IF NOT VALID-HANDLE({&hDBOTable1}) OR
       ...
       {&hDBOTable1}:FILE-NAME <> "esbo/boes647.p":U THEN DO:
       
        {btb/btb008za.i1 esbo/boes647.p YES}
        {btb/btb008za.i2 esbo/boes647.p '' {&hDBOTable1}} 
    END.
    ...
    IF AVAILABLE {&ttTable1} THEN DO:
        CASE pcField:
            WHEN "atendente":U THEN
                ASSIGN pcFieldValue = STRING({&ttTable1}.atendente).
...
------------------------------------------------------------------------------*/
    ...
    CASE pPageNumber:
        WHEN 1 THEN
            ...
            RUN setConstraintMot IN {&hDBOTable1}(INPUT fi-atendente-ini,
                                                            INPUT fi-atendente-fim).
