...
&GLOBAL-DEFINE FolderLabels      gerente
...
&GLOBAL-DEFINE ttTable1          ttgerente
&GLOBAL-DEFINE hDBOTable1        HDBOttgerente
&GLOBAL-DEFINE DBOTable1         gerente
...
&Scoped-define INTERNAL-TABLES ttgerente

/* Definitions for BROWSE brTable1                                      */
&Scoped-define FIELDS-IN-QUERY-brTable1 ttgerente.cod-gerente ~
ttgerente.nome ttgerente.matricula ttgerente.e-mail 
&Scoped-define ENABLED-FIELDS-IN-QUERY-brTable1 
&Scoped-define QUERY-STRING-brTable1 FOR EACH ttgerente NO-LOCK
&Scoped-define OPEN-QUERY-brTable1 OPEN QUERY brTable1 FOR EACH ttgerente NO-LOCK.
&Scoped-define TABLES-IN-QUERY-brTable1 ttgerente
&Scoped-define FIRST-TABLE-IN-QUERY-brTable1 ttgerente
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS brTable1 wZoom _STRUCTURED
  QUERY brTable1 NO-LOCK DISPLAY
      ttgerente.cod-gerente FORMAT ">>9":U
      ttgerente.nome FORMAT "X(30)":U
      ttgerente.matricula FORMAT "x(10)":U
      ttgerente.e-mail FORMAT "x(40)":U
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
...
DEFINE FRAME fPage1
     ...
     fi-ini-cod-gerente AT ROW 2.75 COL 23 COLON-ALIGNED
     fi-fim-cod-gerente AT ROW 2.75 COL 45 COLON-ALIGNED NO-LABEL
...
/* SETTINGS FOR FRAME fPage1
                                                                        */
/* BROWSE-TAB brTable1 fi-fim-cod-gerente fPage1 */
...
/* Query rebuild information for BROWSE brTable1
     _TblList          = "Temp-Tables.ttgerente"
     _Options          = "NO-LOCK"
     _FldNameList[1]   = Temp-Tables.ttgerente.cod-gerente
     _FldNameList[2]   = Temp-Tables.ttgerente.nome
     _FldNameList[3]   = Temp-Tables.ttgerente.matricula
     _FldNameList[4]   = Temp-Tables.ttgerente.e-mail
     _Query            is OPENED
*/  /* BROWSE brTable1 */
&ANALYZE-RESUME
...
------------------------------------------------------------------------------*/
    ...
    DISP fi-ini-cod-gerente
         fi-fim-cod-gerente
         WITH FRAME fPage1.

    ENABLE fi-ini-cod-gerente
           fi-fim-cod-gerente
           btCheck
           WITH FRAME fPage1.
    ...
    APPLY "entry" TO fi-ini-cod-gerente IN FRAME fPage1.
...
------------------------------------------------------------------------------*/
    ...
    IF NOT VALID-HANDLE({&hDBOTable1}) OR
       ...
       {&hDBOTable1}:FILE-NAME <> "esbo/boes382.p":U THEN DO:
       
        {btb/btb008za.i1 esbo/boes382.p YES}
        {btb/btb008za.i2 esbo/boes382.p '' {&hDBOTable1}} 
    END.
...
------------------------------------------------------------------------------*/
    ...
    IF AVAILABLE {&ttTable1} THEN DO:
        CASE pcField:
            WHEN "cod-gerente":U THEN
                ASSIGN pcFieldValue = STRING({&ttTable1}.cod-gerente).
            WHEN "nome":U THEN
                ASSIGN pcFieldValue = STRING({&ttTable1}.nome).
            WHEN "matricula":U THEN
                ASSIGN pcFieldValue = STRING({&ttTable1}.matricula).
        END CASE.
    END.
