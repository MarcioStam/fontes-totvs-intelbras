...
*******************************************************************************/
{include/i-prgvrs.i z01es642 9.99.99.999}

CREATE WIDGET-POOL.

/* Preprocessors Definitions ---                                      */
&GLOBAL-DEFINE Program           z01es642
...
&GLOBAL-DEFINE FieldsRangePage1  emsfnd.usuar_mestre.cod_usuario
&GLOBAL-DEFINE FieldsAnyKeyPage1 NO

&GLOBAL-DEFINE ttTable1          tt-usuar_mestre
&GLOBAL-DEFINE hDBOTable1        hdboun178
...
&Scoped-define INTERNAL-TABLES tt-usuar_mestre

/* Definitions for BROWSE brTable1                                      */
&Scoped-define FIELDS-IN-QUERY-brTable1 tt-usuar_mestre.cod_usuario ~
tt-usuar_mestre.nom_usuario 
&Scoped-define ENABLED-FIELDS-IN-QUERY-brTable1 
&Scoped-define QUERY-STRING-brTable1 FOR EACH tt-usuar_mestre NO-LOCK
&Scoped-define OPEN-QUERY-brTable1 OPEN QUERY brTable1 FOR EACH tt-usuar_mestre NO-LOCK.
&Scoped-define TABLES-IN-QUERY-brTable1 tt-usuar_mestre
&Scoped-define FIRST-TABLE-IN-QUERY-brTable1 tt-usuar_mestre
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS brTable1 wZoom _STRUCTURED
  QUERY brTable1 NO-LOCK DISPLAY
      tt-usuar_mestre.cod_usuario COLUMN-LABEL "C¢digo do Usu rio" FORMAT "x(12)":U
            WIDTH 19.43
      tt-usuar_mestre.nom_usuario FORMAT "x(50)":U WIDTH 58.43
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
...
/* Query rebuild information for BROWSE brTable1
     _TblList          = "Temp-Tables.tt-usuar_mestre"
     _Options          = "NO-LOCK"
     _FldNameList[1]   > Temp-Tables.tt-usuar_mestre.cod_usuario
"tt-usuar_mestre.cod_usuario" "C¢digo do Usu rio" ? "character" ? ? ? ? ? ? no ? no no "19.43" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[2]   > Temp-Tables.tt-usuar_mestre.nom_usuario
"tt-usuar_mestre.nom_usuario" ? ? "character" ? ? ? ? ? ? no ? no no "58.43" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _Query            is OPENED
*/  /* BROWSE brTable1 */
&ANALYZE-RESUME
...
------------------------------------------------------------------------------*/
    ...
    IF NOT VALID-HANDLE({&hDBOTable1}) OR
       ...
       {&hDBOTable1}:FILE-NAME <> "unbo/boun178na.p":U THEN DO:
       
        {btb/btb008za.i1 unbo/boun178na.p YES}
        {btb/btb008za.i2 unbo/boun178na.p '' {&hDBOTable1}} 
    END.
    
    RUN setConstraintusuarios IN {&hDBOTable1} (INPUT "":U,
                                               INPUT "ZZZZZZZZZZZZ":U) NO-ERROR.
...
------------------------------------------------------------------------------*/
    ...
    {zoom/openqueries.i &Query="usuarios"
                        &PageNumber="1"}
...
------------------------------------------------------------------------------*/
    ...
    CASE pPageNumber:
        WHEN 1 THEN
            ...
            RUN setConstraintusuarios IN {&hDBOTable1} (INPUT fniniRangeCharPage(1,1),
