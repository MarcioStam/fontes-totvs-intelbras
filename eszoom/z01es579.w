...
DEFINE TEMP-TABLE ttminimos-faturamento NO-UNDO LIKE minimos-faturamento
...
*******************************************************************************/
{include/i-prgvrs.i z01es579 1.00.00.000}

CREATE WIDGET-POOL.

/* Preprocessors Definitions ---                                      */
&GLOBAL-DEFINE Program           z01es579
&GLOBAL-DEFINE Version           1.00.00.000

&GLOBAL-DEFINE InitialPage       1
&GLOBAL-DEFINE FolderLabels      Mestre
...
&GLOBAL-DEFINE ttTable1          TTminimos-faturamento
&GLOBAL-DEFINE hDBOTable1        HDBOMinimos
&GLOBAL-DEFINE DBOTable1         minimos-faturamento
...
&Scoped-define INTERNAL-TABLES ttminimos-faturamento

/* Definitions for BROWSE brTable1                                      */
&Scoped-define FIELDS-IN-QUERY-brTable1 ttminimos-faturamento.cod-estabel ~
ttminimos-faturamento.oper-mestre ttminimos-faturamento.peso-bruto-min ~
ttminimos-faturamento.vl-parc-minima ttminimos-faturamento.vl-fatur-minimo 
&Scoped-define ENABLED-FIELDS-IN-QUERY-brTable1 
&Scoped-define QUERY-STRING-brTable1 FOR EACH ttminimos-faturamento NO-LOCK
&Scoped-define OPEN-QUERY-brTable1 OPEN QUERY brTable1 FOR EACH ttminimos-faturamento NO-LOCK.
&Scoped-define TABLES-IN-QUERY-brTable1 ttminimos-faturamento
&Scoped-define FIRST-TABLE-IN-QUERY-brTable1 ttminimos-faturamento
...
DEFINE VARIABLE fi-fim-oper-mestre AS INTEGER FORMAT ">9" INITIAL 99 
     VIEW-AS FILL-IN 
     SIZE 9 BY .88.
...
DEFINE VARIABLE fi-ini-oper-mestre AS INTEGER FORMAT ">9" INITIAL 0 
     LABEL "C¢digo Mestre":R17 
     VIEW-AS FILL-IN 
     SIZE 9 BY .88.
...
DEFINE QUERY brTable1 FOR 
      ttminimos-faturamento SCROLLING.
&ANALYZE-RESUME
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS brTable1 wZoom _STRUCTURED
  QUERY brTable1 NO-LOCK DISPLAY
      ttminimos-faturamento.cod-estabel FORMAT "x(3)":U
      ttminimos-faturamento.oper-mestre FORMAT ">9":U
      ttminimos-faturamento.peso-bruto-min FORMAT ">>>,>>>,>>9.9999":U
      ttminimos-faturamento.vl-parc-minima FORMAT "->>>,>>>,>>9.99":U
      ttminimos-faturamento.vl-fatur-minimo FORMAT "->>>,>>>,>>9.99":U
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
...
DEFINE FRAME fPage1
     fi-ini-cod-estabel AT ROW 1.46 COL 20.72 COLON-ALIGNED WIDGET-ID 8
     fi-fim-cod-estabel AT ROW 1.46 COL 45.14 COLON-ALIGNED NO-LABEL WIDGET-ID 6
     btCheck AT ROW 1.5 COL 77
     fi-ini-oper-mestre AT ROW 2.38 COL 20.72 COLON-ALIGNED
     fi-fim-oper-mestre AT ROW 2.38 COL 45.14 COLON-ALIGNED NO-LABEL
     brTable1 AT ROW 4.25 COL 2
     btImplant1 AT ROW 13 COL 2
     IMAGE-1 AT ROW 1.46 COL 32
     IMAGE-2 AT ROW 1.46 COL 44
     IMAGE-3 AT ROW 2.38 COL 32 WIDGET-ID 2
     IMAGE-4 AT ROW 2.38 COL 44 WIDGET-ID 4
...
/* Settings for THIS-PROCEDURE
   ...
   Temp-Tables and Buffers:
      TABLE: ttminimos-faturamento T "?" NO-UNDO mgesp minimos-faturamento
      ADDITIONAL-FIELDS:
          field r-rowid as rowid
      END-FIELDS.
   END-TABLES.
...
/* SETTINGS FOR FRAME fPage1
                                                                        */
/* BROWSE-TAB brTable1 fi-fim-oper-mestre fPage1 */
...
/* Query rebuild information for BROWSE brTable1
     _TblList          = "Temp-Tables.ttminimos-faturamento"
     _Options          = "NO-LOCK"
     _FldNameList[1]   = Temp-Tables.ttminimos-faturamento.cod-estabel
     _FldNameList[2]   = Temp-Tables.ttminimos-faturamento.oper-mestre
     _FldNameList[3]   = Temp-Tables.ttminimos-faturamento.peso-bruto-min
     _FldNameList[4]   = Temp-Tables.ttminimos-faturamento.vl-parc-minima
     _FldNameList[5]   = Temp-Tables.ttminimos-faturamento.vl-fatur-minimo
     _Query            is OPENED
*/  /* BROWSE brTable1 */
&ANALYZE-RESUME
...
DO:
  ASSIGN INPUT FRAME fpage1
         fi-ini-cod-estabel fi-fim-cod-estabel fi-ini-oper-mestre fi-fim-oper-mestre.
...
------------------------------------------------------------------------------*/
    ...
    DISP   fi-ini-cod-estabel fi-fim-cod-estabel fi-ini-oper-mestre fi-fim-oper-mestre WITH FRAME fPage1.
    ENABLE fi-ini-cod-estabel fi-fim-cod-estabel fi-ini-oper-mestre fi-fim-oper-mestre btCheck WITH FRAME fPage1.
...
------------------------------------------------------------------------------*/
    ...
    IF NOT VALID-HANDLE({&hDBOTable1}) OR
       ...
       {&hDBOTable1}:FILE-NAME <> "esbo/boes579.p":U THEN DO:
       
        {btb/btb008za.i1 esbo/boes579.p YES}
        {btb/btb008za.i2 esbo/boes579.p '' {&hDBOTable1}} 
    END.
...
------------------------------------------------------------------------------*/
    ...
    IF AVAILABLE {&ttTable1} THEN DO:
        CASE pcField:
            ...
            WHEN "oper-mestre":U THEN
                ASSIGN pcFieldValue = STRING({&ttTable1}.oper-mestre).
        END CASE.
    END.
    ...
    CASE pPageNumber:
        WHEN 1 THEN
            ...
            RUN setConstraintByCod IN {&hDBOTable1} (INPUT fi-ini-cod-estabel,
                                                     ...
                                                     INPUT fi-ini-oper-mestre,
                                                     INPUT fi-fim-oper-mestre).
    END CASE.
