...
*******************************************************************************/
{include/i-prgvrs.i Z01ES654 1.00.00.000}
...
&GLOBAL-DEFINE Program           Z01ES654
...
&GLOBAL-DEFINE FieldsRangePage1  mgesp.falha-mqa.cod-falha,mgesp.falha-mqa.descricao
&GLOBAL-DEFINE FieldsAnyKeyPage1 YES,YES

&GLOBAL-DEFINE ttTable1          tt-falha-mqa
&GLOBAL-DEFINE hDBOTable1        h-boes654
&GLOBAL-DEFINE DBOTable1         falha-mqa
...
&Scoped-define INTERNAL-TABLES tt-falha-mqa

/* Definitions for BROWSE brTable1                                      */
&Scoped-define FIELDS-IN-QUERY-brTable1 tt-falha-mqa.cod-falha ~
tt-falha-mqa.descricao 
&Scoped-define ENABLED-FIELDS-IN-QUERY-brTable1 
&Scoped-define QUERY-STRING-brTable1 FOR EACH tt-falha-mqa NO-LOCK
&Scoped-define OPEN-QUERY-brTable1 OPEN QUERY brTable1 FOR EACH tt-falha-mqa NO-LOCK.
&Scoped-define TABLES-IN-QUERY-brTable1 tt-falha-mqa
&Scoped-define FIRST-TABLE-IN-QUERY-brTable1 tt-falha-mqa
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS brTable1 wZoom _STRUCTURED
  QUERY brTable1 NO-LOCK DISPLAY
      tt-falha-mqa.cod-falha FORMAT ">>9":U
      tt-falha-mqa.descricao FORMAT "x(60)":U
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
...
/* Query rebuild information for BROWSE brTable1
     _TblList          = "Temp-Tables.tt-falha-mqa"
     _Options          = "NO-LOCK"
     _FldNameList[1]   = Temp-Tables.tt-falha-mqa.cod-falha
     _FldNameList[2]   = Temp-Tables.tt-falha-mqa.descricao
     _Query            is OPENED
*/  /* BROWSE brTable1 */
&ANALYZE-RESUME
...
------------------------------------------------------------------------------*/
    ...
    IF NOT VALID-HANDLE({&hDBOTable1}) OR
       ...
       {&hDBOTable1}:FILE-NAME <> "esbo/boes654.p":U THEN DO:
       
        {btb/btb008za.i1 esbo/boes654.p YES}
        {btb/btb008za.i2 esbo/boes654.p '' {&hDBOTable1}} 
    END.
...
------------------------------------------------------------------------------*/
    ...
    IF AVAILABLE {&ttTable1} THEN DO:
        CASE pcField:
            WHEN "cod-falha":U THEN
                ASSIGN pcFieldValue = STRING({&ttTable1}.cod-falha).
            WHEN "descricao" THEN
