...
*******************************************************************************/
{include/i-prgvrs.i z01es468 2.04.00.000}

CREATE WIDGET-POOL.

/* Preprocessors Definitions ---                                      */
&GLOBAL-DEFINE Program           z01es468
...
&GLOBAL-DEFINE ttTable1          tt-juridico-tipos
&GLOBAL-DEFINE hDBOTable1        hboes468
&GLOBAL-DEFINE DBOTable1         tt-juridico-tipos
...
&Scoped-define INTERNAL-TABLES tt-juridico-tipos

/* Definitions for BROWSE brTable1                                      */
&Scoped-define FIELDS-IN-QUERY-brTable1 tt-juridico-tipos.codigo ~
tt-juridico-tipos.descricao 
&Scoped-define ENABLED-FIELDS-IN-QUERY-brTable1 
&Scoped-define QUERY-STRING-brTable1 FOR EACH tt-juridico-tipos NO-LOCK
&Scoped-define OPEN-QUERY-brTable1 OPEN QUERY brTable1 FOR EACH tt-juridico-tipos NO-LOCK.
&Scoped-define TABLES-IN-QUERY-brTable1 tt-juridico-tipos
&Scoped-define FIRST-TABLE-IN-QUERY-brTable1 tt-juridico-tipos
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS brTable1 wZoom _STRUCTURED
  QUERY brTable1 NO-LOCK DISPLAY
      tt-juridico-tipos.codigo FORMAT ">>>>>>9":U WIDTH 9.43
      tt-juridico-tipos.descricao FORMAT "x(40)":U WIDTH 68.86
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
...
/* Query rebuild information for BROWSE brTable1
     _TblList          = "Temp-Tables.tt-juridico-tipos"
     _Options          = "NO-LOCK"
     _TblOptList       = ", FIRST USED"
     _FldNameList[1]   > Temp-Tables.tt-juridico-tipos.codigo
"tt-juridico-tipos.codigo" ? ? "integer" ? ? ? ? ? ? no ? no no "9.43" yes no no "U" "" ""
     _FldNameList[2]   > Temp-Tables.tt-juridico-tipos.descricao
"tt-juridico-tipos.descricao" ? ? "character" ? ? ? ? ? ? no ? no no "68.86" yes no no "U" "" ""
     _Query            is OPENED
*/  /* BROWSE brTable1 */
&ANALYZE-RESUME
...
------------------------------------------------------------------------------*/
    ...
    IF NOT VALID-HANDLE({&hDBOTable1}) OR
       ...
       {&hDBOTable1}:FILE-NAME <> "esbo/boes468.p":U THEN DO:
       
        {btb/btb008za.i1 esbo/boes468.p YES}
        {btb/btb008za.i2 esbo/boes468.p '' {&hDBOTable1}} 
    END.
