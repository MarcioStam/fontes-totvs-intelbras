...
*******************************************************************************/
{include/i-prgvrs.i z01es745.w 1.00.00.001}
...
&GLOBAL-DEFINE Program           z01es745
...
/*&GLOBAL-DEFINE FieldsRangePage1  tt-int-item-layout-qrcode.it-codigo
...
&GLOBAL-DEFINE ttTable1          tt-int-item-layout-qrcode
&GLOBAL-DEFINE hDBOTable1        h-boes745
&GLOBAL-DEFINE DBOTable1         int-item-layout-qrcode
...
&Scoped-define INTERNAL-TABLES tt-int-item-layout-qrcode

/* Definitions for BROWSE brTable1                                      */
&Scoped-define FIELDS-IN-QUERY-brTable1 tt-int-item-layout-qrcode.it-codigo ~
fn-retorna-desc(tt-int-item-layout-qrcode.it-codigo) @ c-desc-item 
&Scoped-define ENABLED-FIELDS-IN-QUERY-brTable1 
&Scoped-define QUERY-STRING-brTable1 FOR EACH tt-int-item-layout-qrcode NO-LOCK
&Scoped-define OPEN-QUERY-brTable1 OPEN QUERY brTable1 FOR EACH tt-int-item-layout-qrcode NO-LOCK.
&Scoped-define TABLES-IN-QUERY-brTable1 tt-int-item-layout-qrcode
&Scoped-define FIRST-TABLE-IN-QUERY-brTable1 tt-int-item-layout-qrcode
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _FUNCTION-FORWARD fn-retorna-desc wZoom 
FUNCTION fn-retorna-desc RETURNS CHARACTER
  ( INPUT c-item AS CHAR )  FORWARD.
...
DEFINE QUERY brTable1 FOR 
      tt-int-item-layout-qrcode SCROLLING.
&ANALYZE-RESUME
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS brTable1 wZoom _STRUCTURED
  QUERY brTable1 NO-LOCK DISPLAY
      tt-int-item-layout-qrcode.it-codigo COLUMN-LABEL "Item" FORMAT "x(16)":U
      fn-retorna-desc(tt-int-item-layout-qrcode.it-codigo) @ c-desc-item COLUMN-LABEL "Descri‡Æo" FORMAT "x(60)":U
            WIDTH 60
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
...
DEFINE FRAME fPage1
     c-item-ini AT ROW 1.25 COL 17 COLON-ALIGNED WIDGET-ID 2
     c-item-fim AT ROW 1.25 COL 45 COLON-ALIGNED NO-LABEL WIDGET-ID 4
     btSearch AT ROW 1.25 COL 72 WIDGET-ID 6
...
/* Query rebuild information for BROWSE brTable1
     _TblList          = "Temp-Tables.tt-int-item-layout-qrcode"
     _Options          = "NO-LOCK"
     _FldNameList[1]   > Temp-Tables.tt-int-item-layout-qrcode.it-codigo
"it-codigo" "Item" ? "character" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[2]   > "_<CALC>"
"fn-retorna-desc(tt-int-item-layout-qrcode.it-codigo) @ c-desc-item" "Descri‡Æo" "x(60)" ? ? ? ? ? ? ? no ? no no "60" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _Query            is OPENED
*/  /* BROWSE brTable1 */
&ANALYZE-RESUME
...
ASSIGN c-item-ini:SENSITIVE    IN FRAME fpage1 = YES
       c-item-fim:SENSITIVE    IN FRAME fpage1 = YES
       c-item-fim:SCREEN-VALUE IN FRAME fpage1 = FILL("Z",16)
       btSearch  :SENSITIVE    IN FRAME fpage1 = YES.
...
------------------------------------------------------------------------------*/
    ...
    IF NOT VALID-HANDLE({&hDBOTable1}) OR
       ...
       {&hDBOTable1}:FILE-NAME <> "h-boes745":U THEN DO:
       
        {btb/btb008za.i1 esbo/boes745.p YES}
        {btb/btb008za.i2 esbo/boes745.p '' {&hDBOTable1}} 
    END.
    
    RUN setConstraintZoom IN {&hDBOTable1} ("",
...
------------------------------------------------------------------------------*/
    ...
    ASSIGN INPUT FRAME fpage1 c-item-ini c-item-fim.
    
    /*:T--- Seta constraints conforme n£mero da p gina ---*/
    CASE pPageNumber:
        WHEN 1 THEN
            /*:T--- Seta Constraints para o DBO Table1 ---*/
            RUN setConstraintZoom IN {&hDBOTable1} (INPUT c-item-ini,
                                                    INPUT c-item-fim).
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _FUNCTION fn-retorna-desc wZoom 
FUNCTION fn-retorna-desc RETURNS CHARACTER
