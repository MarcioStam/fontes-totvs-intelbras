...
*******************************************************************************/
{include/i-prgvrs.i z01es520 2.04.00.000}

CREATE WIDGET-POOL.

/* Preprocessors Definitions ---                                      */
&GLOBAL-DEFINE Program           z01es520
&GLOBAL-DEFINE Version           2.04.00.000

&GLOBAL-DEFINE InitialPage       1
&GLOBAL-DEFINE FolderLabels      Resgate

&GLOBAL-DEFINE Range             YES

&GLOBAL-DEFINE FieldsRangePage1  mgesp.resgate-premios.cpf-cnpj,mgesp.resgate-premios.data-movto,mgesp.resgate-premios.sequencia
&GLOBAL-DEFINE FieldsAnyKeyPage1 NO,NO,NO

&GLOBAL-DEFINE ttTable1          ttresgate-premios
&GLOBAL-DEFINE hDBOTable1        hboes520
&GLOBAL-DEFINE DBOTable1         resgate-premios
...
&Scoped-define INTERNAL-TABLES ttresgate-premios

/* Definitions for BROWSE brTable1                                      */
&Scoped-define FIELDS-IN-QUERY-brTable1 ttresgate-premios.cpf-cnpj ~
ttresgate-premios.data-movto ttresgate-premios.sequencia ~
ttresgate-premios.concluido ttresgate-premios.pontos 
&Scoped-define ENABLED-FIELDS-IN-QUERY-brTable1 
&Scoped-define QUERY-STRING-brTable1 FOR EACH ttresgate-premios NO-LOCK
&Scoped-define OPEN-QUERY-brTable1 OPEN QUERY brTable1 FOR EACH ttresgate-premios NO-LOCK.
&Scoped-define TABLES-IN-QUERY-brTable1 ttresgate-premios
&Scoped-define FIRST-TABLE-IN-QUERY-brTable1 ttresgate-premios
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS brTable1 wZoom _STRUCTURED
  QUERY brTable1 NO-LOCK DISPLAY
      ttresgate-premios.cpf-cnpj FORMAT "x(16)":U
      ttresgate-premios.data-movto FORMAT "99/99/9999":U
      ttresgate-premios.sequencia FORMAT ">>>>>>>>9":U
      ttresgate-premios.concluido FORMAT "yes/no":U
      ttresgate-premios.pontos FORMAT ">>>,>>>,>>9":U
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
...
/* Query rebuild information for BROWSE brTable1
     _TblList          = "Temp-Tables.ttresgate-premios"
     _Options          = "NO-LOCK"
     _FldNameList[1]   = Temp-Tables.ttresgate-premios.cpf-cnpj
     _FldNameList[2]   = Temp-Tables.ttresgate-premios.data-movto
     _FldNameList[3]   = Temp-Tables.ttresgate-premios.sequencia
     _FldNameList[4]   = Temp-Tables.ttresgate-premios.concluido
     _FldNameList[5]   = Temp-Tables.ttresgate-premios.pontos
     _Query            is OPENED
*/  /* BROWSE brTable1 */
&ANALYZE-RESUME
...
------------------------------------------------------------------------------*/
    ...
    IF NOT VALID-HANDLE({&hDBOTable1}) OR
       ...
       {&hDBOTable1}:FILE-NAME <> "esbo/boes520.p":U THEN DO:
       
        {btb/btb008za.i1 esbo/boes520.p YES}
        {btb/btb008za.i2 esbo/boes520.p '' {&hDBOTable1}} 
    END.
