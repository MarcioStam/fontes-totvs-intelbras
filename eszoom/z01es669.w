...
*******************************************************************************/
{include/i-prgvrs.i Z01ES669 2.00.00.000}
...
&GLOBAL-DEFINE Program           Z01ES669
&GLOBAL-DEFINE Version           2.00.00.000

&GLOBAL-DEFINE InitialPage       1
&GLOBAL-DEFINE FolderLabels      Auditoria Procedimentos

&GLOBAL-DEFINE Range             YES

&GLOBAL-DEFINE FieldsRangePage1  mgesp.aud-procedimento.cod-estabel,mgesp.aud-procedimento.nr-seq-aud-proced
&GLOBAL-DEFINE FieldsAnyKeyPage1 NO,NO

&GLOBAL-DEFINE ttTable1          tt-aud-procedimento
&GLOBAL-DEFINE hDBOTable1        h-boes669
&GLOBAL-DEFINE DBOTable1         aud-procedimento
...
&Scoped-define INTERNAL-TABLES tt-aud-procedimento

/* Definitions for BROWSE brTable1                                      */
&Scoped-define FIELDS-IN-QUERY-brTable1 tt-aud-procedimento.cod-estabel ~
tt-aud-procedimento.nr-seq-aud-proced 
&Scoped-define ENABLED-FIELDS-IN-QUERY-brTable1 
&Scoped-define QUERY-STRING-brTable1 FOR EACH tt-aud-procedimento NO-LOCK
&Scoped-define OPEN-QUERY-brTable1 OPEN QUERY brTable1 FOR EACH tt-aud-procedimento NO-LOCK.
&Scoped-define TABLES-IN-QUERY-brTable1 tt-aud-procedimento
&Scoped-define FIRST-TABLE-IN-QUERY-brTable1 tt-aud-procedimento
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS brTable1 wZoom _STRUCTURED
  QUERY brTable1 NO-LOCK DISPLAY
      tt-aud-procedimento.cod-estabel COLUMN-LABEL "Estabelecimento" FORMAT "x(5)":U
            WIDTH 15.43
      tt-aud-procedimento.nr-seq-aud-proced COLUMN-LABEL "Auditoria" FORMAT ">>>>>9":U
            WIDTH 11.43
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
...
/* Query rebuild information for BROWSE brTable1
     _TblList          = "Temp-Tables.tt-aud-procedimento"
     _Options          = "NO-LOCK"
     _FldNameList[1]   > Temp-Tables.tt-aud-procedimento.cod-estabel
"tt-aud-procedimento.cod-estabel" "Estabelecimento" ? "character" ? ? ? ? ? ? no ? no no "15.43" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[2]   > Temp-Tables.tt-aud-procedimento.nr-seq-aud-proced
"tt-aud-procedimento.nr-seq-aud-proced" "Auditoria" ? "integer" ? ? ? ? ? ? no ? no no "11.43" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _Query            is OPENED
*/  /* BROWSE brTable1 */
&ANALYZE-RESUME
...
DO:
    {zoom/implant.i &ProgramImplant="esp\aqp\esaqp009.w"
                    &PageNumber="1"}
END.
...
------------------------------------------------------------------------------*/
    ...
    IF NOT VALID-HANDLE({&hDBOTable1}) OR
       ...
       {&hDBOTable1}:FILE-NAME <> "esbo/boes669.p":U THEN DO:
       
        {btb/btb008za.i1 esbo/boes669.p YES}
        {btb/btb008za.i2 esbo/boes669.p '' {&hDBOTable1}} 
    END.
...
------------------------------------------------------------------------------*/
    ...
    IF AVAILABLE {&ttTable1} THEN DO:
        CASE pcField:
            ...
            WHEN "nr-seq-aud-proced" THEN
                ASSIGN pcFieldValue = STRING({&ttTable1}.nr-seq-aud-proced).
        END CASE.
    END.
...
------------------------------------------------------------------------------*/
    ...
    CASE pPageNumber:
        WHEN 1 THEN
            ...
            RUN setConstraintNC IN {&hDBOTable1} (INPUT FnIniRangeCharPage(1,1),
