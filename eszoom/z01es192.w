...
*******************************************************************************/
{include/i-prgvrs.i Z01ES192 2.04.00.001}

CREATE WIDGET-POOL.

/* Preprocessors Definitions ---                                      */
&GLOBAL-DEFINE Program           Z01ES192
...
&GLOBAL-DEFINE FieldsRangePage1  mgesp.tipo-pend.tipo
&GLOBAL-DEFINE FieldsAnyKeyPage1 YES

&GLOBAL-DEFINE ttTable1          tttipo-pend
&GLOBAL-DEFINE hDBOTable1        hboes192
&GLOBAL-DEFINE DBOTable1         tipo-pend
...
&Scoped-define INTERNAL-TABLES tttipo-pend

/* Definitions for BROWSE brTable1                                      */
&Scoped-define FIELDS-IN-QUERY-brTable1 tttipo-pend.tipo ~
tttipo-pend.descricao 
&Scoped-define ENABLED-FIELDS-IN-QUERY-brTable1 
&Scoped-define QUERY-STRING-brTable1 FOR EACH tttipo-pend NO-LOCK
&Scoped-define OPEN-QUERY-brTable1 OPEN QUERY brTable1 FOR EACH tttipo-pend NO-LOCK.
&Scoped-define TABLES-IN-QUERY-brTable1 tttipo-pend
&Scoped-define FIRST-TABLE-IN-QUERY-brTable1 tttipo-pend
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS brTable1 wZoom _STRUCTURED
  QUERY brTable1 NO-LOCK DISPLAY
      tttipo-pend.tipo FORMAT ">9":U
      tttipo-pend.descricao FORMAT "x(30)":U
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
...
/* Query rebuild information for BROWSE brTable1
     _TblList          = "Temp-Tables.tttipo-pend"
     _Options          = "NO-LOCK"
     _FldNameList[1]   = Temp-Tables.tttipo-pend.tipo
     _FldNameList[2]   = Temp-Tables.tttipo-pend.descricao
     _Query            is OPENED
*/  /* BROWSE brTable1 */
&ANALYZE-RESUME
...
------------------------------------------------------------------------------*/
    ...
    IF NOT VALID-HANDLE({&hDBOTable1}) OR
       ...
       {&hDBOTable1}:FILE-NAME <> "esbo/boes192.p":U THEN DO:
       
        {btb/btb008za.i1 esbo/boes192.p YES}
        {btb/btb008za.i2 esbo/boes192.p '' {&hDBOTable1}} 
    END.
