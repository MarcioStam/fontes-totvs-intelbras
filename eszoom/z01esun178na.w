...
DEFINE TEMP-TABLE tt-usuar-mestre NO-UNDO LIKE usuar_mestre
...
*******************************************************************************/
{include/i-prgvrs.i Z01UN178NA 2.00.00.000}  /*** 010000 ***/

&IF "{&EMSFND_VERSION}" >= "1.00"
&THEN
{include/i-license-manager.i Z01UN178NA MUT}
&ENDIF
...
&GLOBAL-DEFINE Program           Z01ESUN178NA
...
&GLOBAL-DEFINE FieldsRangePage1  emsfnd.usuar_mestre.cod_usuario,emsfnd.usuar_mestre.nom_usuario
&GLOBAL-DEFINE FieldsAnyKeyPage1 YES,YES

&GLOBAL-DEFINE ttTable1          tt-usuar-mestre
&GLOBAL-DEFINE hDBOTable1        h-boun178
...
&Scoped-define INTERNAL-TABLES tt-usuar-mestre

/* Definitions for BROWSE brTable1                                      */
&Scoped-define FIELDS-IN-QUERY-brTable1 tt-usuar-mestre.nom_usuario ~
tt-usuar-mestre.cod_usuario 
&Scoped-define ENABLED-FIELDS-IN-QUERY-brTable1 
&Scoped-define QUERY-STRING-brTable1 FOR EACH tt-usuar-mestre NO-LOCK ~
    BY tt-usuar-mestre.cod_usuario
&Scoped-define OPEN-QUERY-brTable1 OPEN QUERY brTable1 FOR EACH tt-usuar-mestre NO-LOCK ~
    BY tt-usuar-mestre.cod_usuario.
&Scoped-define TABLES-IN-QUERY-brTable1 tt-usuar-mestre
&Scoped-define FIRST-TABLE-IN-QUERY-brTable1 tt-usuar-mestre
...
/* Settings for THIS-PROCEDURE
   ...
   Temp-Tables and Buffers:
      TABLE: tt-usuar-mestre T "?" NO-UNDO mguni usuar_mestre
      ADDITIONAL-FIELDS:
          field r-rowid as rowid
      END-FIELDS.
   END-TABLES.
...
/* Query rebuild information for BROWSE brTable1
     _TblList          = "Temp-Tables.tt-usuar-mestre"
     _Options          = "NO-LOCK"
     _OrdList          = "Temp-Tables.tt-usuar-mestre.cod_usuario|yes"
     _FldNameList[1]   = Temp-Tables.tt-usuar-mestre.nom_usuario
     _FldNameList[2]   = Temp-Tables.tt-usuar-mestre.cod_usuario
     _Query            is OPENED
*/  /* BROWSE brTable1 */
&ANALYZE-RESUME
...
------------------------------------------------------------------------------*/
    ...
    IF  NOT VALID-HANDLE({&hDBOTable1}) OR
        ...
        {&hDBOTable1}:FILE-NAME <> "esbo/esboun178na.p":U THEN DO:
        {btb/btb008za.i1 esbo/esboun178na.p YES}
        {btb/btb008za.i2 esbo/esboun178na.p '' {&hDBOTable1}} 
    END.
    
    RUN setConstraintZoom IN {&hDBOTable1} (INPUT "",
                                            INPUT "ZZZZZZZZZZZZ",
                                            INPUT "",
                                            INPUT "ZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZ") NO-ERROR.
...
------------------------------------------------------------------------------*/
    ...
    CASE pPageNumber:
        WHEN 1 THEN
            ...
            RUN setConstraintZoom IN {&hDBOTable1} (INPUT fnIniRangeCharPage(INPUT 1, INPUT 1),
