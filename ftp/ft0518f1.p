...
DEF INPUT PARAM l-reimp      AS LOG  NO-UNDO.
...
DEFINE VARIABLE c-reimprime AS CHARACTER   NO-UNDO.
...
FOR FIRST ttDanfe:
    ...
    ELSE DO:
       ...
       END.
    END.
    OUTPUT TO c:\temp\dir_layouts.txt.
    PUT "Modelo Danfe: " cModeloDanfe FORMAT "x(100)" CHR(13) gcDiretorioDanfe FORMAT "x(100)" CHR(13) gcDiretorioDanfeIt FORMAT "X(100)".
    OUTPUT CLOSE.
    ...
    REPEAT:                         
        ...
        IF  INDEX(cLinha,"#":U) > 0 THEN DO:
            ...
            IF l-reimp = YES THEN DO:
                ASSIGN cLinha = REPLACE(cLinha, "#notareimpressa":U,"DANFE REIMPRESSO").
            END.
            ELSE DO:
               ASSIGN cLinha = REPLACE(cLinha, "#notareimpressa":U,"").
            END.
        END.
