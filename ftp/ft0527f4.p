...
*******************************************************************************/
{include/i-prgvrs.i FT0527F4 2.00.00.037 } /*** "010037" ***/
...
FOR FIRST ped-venda NO-LOCK
    ...
    IF AVAIL int-ped-venda2 AND int-ped-venda2.PedidoeCommerce <> "" THEN DO:
        ...
        IF  AVAIL int-nota-fiscal THEN
            ASSIGN ttDest.xNome = int-nota-fiscal.nome-emit.
    END.
END.
...
FOR FIRST ttEntrega NO-LOCK: /*S¢ haver† registro na ttEntrega na condiá∆o de o local de entrega ser diferente do endereáo do destinatario/cliente da nota*/
    ...
    FIND emitente NO-LOCK
     ...
     IF  AVAIL emitente AND emitente.natureza = 1 /*F°sica*/
     AND INDEX(ttDanfe.informacoescomplementares, "Local de Entrega") <> 0 THEN
         LEAVE.
...
FOR EACH ttDet NO-LOCK:
    ...
    ASSIGN ttDanfeItem.iSeq           = i-cont-itens
           ...
           ttDanfeItem.descitem       = ttDet.xProd + " ":U + ttDet.infAdProd
