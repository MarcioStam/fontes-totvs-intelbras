...
*******************************************************************************/
{include/i-prgvrs.i CD0420A1 2.00.00.006}  /*** 010006 ***/

&IF "{&EMSFND_VERSION}" >= "1.00" &THEN
{include/i-license-manager.i cd0420a1 MCD}
&ENDIF
...
DEFINE VARIABLE c-estab-fim AS CHARACTER FORMAT "X(3)":U INITIAL "101" 
     VIEW-AS FILL-IN 
     SIZE 5 BY .88 NO-UNDO.

DEFINE VARIABLE c-estab-ini AS CHARACTER FORMAT "X(3)":U INITIAL "101" 
...
------------------------------------------------------------------------------*/
  ...
  ASSIGN c-comp-ini:SCREEN-VALUE IN FRAME {&frame-name} = c-seg-usuario
         c-comp-fim:SCREEN-VALUE IN FRAME {&frame-name} = c-seg-usuario.

  
  /* Dispatch standard ADM method.                             */
{utp/ut9000.i "CD0420A1" "2.00.00.006"}
